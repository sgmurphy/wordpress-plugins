...
/**
 * An interface for the mtm_data option stored in wp_options as a serialized array.
 * This option can hold various information which can be stored in one record rather than individual records in wp_options.
 * The functions in this class deal directly with that mtm_data option as if it was the wp_options table itself, and therefore
...
class Options {
	 ...
	 * @return mixed
	 */
	public static function get( $option_name, $default = array(), $dataset = 'mtm_data', $site = false ){
	 ...
	 * @return boolean
	 */
	public static function set( $option_name, $option_value, $dataset = 'mtm_data', $site = false ){
		$data = $site ? get_site_option($dataset) : get_option($dataset);
	 ...
	 * @return boolean
	 */
	public static function add( $option_name, $option_key, $option_value, $dataset = 'mtm_data', $site = false ){
		$data = $site ? get_site_option($dataset) : get_option($dataset);
	 ...
	 * @return boolean
	 */
	public static function remove( $option_name, $option_key = null, $dataset = 'mtm_data', $site = false ){
		$data = $site ? get_site_option($dataset) : get_option($dataset);
	 ...
	 * @return boolean
	 */
	public static function site_get( $option_name, $default = array(), $dataset = 'mtm_data' ){
	 ...
	 * @return boolean
	 */
	public static function site_set( $option_name, $option_value, $dataset = 'mtm_data' ){
	 ...
	 * @return boolean
	 */
	public static function site_add( $option_name, $option_key, $option_value, $dataset = 'mtm_data' ){
	 ...
	 * @return boolean
	 */
	public static function site_remove( $option_name, $option_key = null, $dataset = 'mtm_data' ){

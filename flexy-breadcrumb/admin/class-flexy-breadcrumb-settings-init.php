...
class Flexy_Breadcrumb_Admin_Settings_Init {
    ...
    public function fbc_admin_menu() {
        add_menu_page(__('Flexy Breadcrumb', 'flexy-breadcrumb'), __('Flexy Breadcrumb', 'flexy-breadcrumb'), 'manage_options', 'flexy-breadcrumb-settings', array($this, 'settings_tab_menu'), plugins_url('images/admin-menu-icon.png', __FILE__) );
    }

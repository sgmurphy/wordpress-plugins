...
function decorme_service_setting( $wp_customize ) {
	...
	class DecorMe_service_section_upgrade extends WP_Customize_Control {
		public function render_content() { 
				...
				<?php }elseif ( 'Interio' == $theme->name){ ?>	
					<a class="customizer_DecorMe_service_upgrade_section up-to-pro" href="https://burgerthemes.com/interio-pro/" target="_blank" style="display: none;"><?php _e('More Services Available in Interio Pro','decorme'); ?></a>
					<?php
				}
			} 
		}	

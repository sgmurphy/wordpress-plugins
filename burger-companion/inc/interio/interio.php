...
require BURGER_COMPANION_PLUGIN_DIR . 'inc/interio/sections/section-above-header.php';
require BURGER_COMPANION_PLUGIN_DIR . 'inc/interio/features/decorme-header.php';
require BURGER_COMPANION_PLUGIN_DIR . 'inc/interio/features/decorme-slider.php';
require BURGER_COMPANION_PLUGIN_DIR . 'inc/interio/features/decorme-info.php';
...
if ( ! function_exists( 'burger_companion_decorme_frontpage_sections' ) ) :
	function burger_companion_decorme_frontpage_sections() {	
		 require BURGER_COMPANION_PLUGIN_DIR . 'inc/interio/sections/section-slider.php';
		 require BURGER_COMPANION_PLUGIN_DIR . 'inc/interio/sections/section-info.php';

...
function decorme_abv_header_settings( $wp_customize ) {
	...
	$wp_customize->add_setting(
		'hdr_ct_info_ttl',
		array(
			'default'			=> __('CALL FOR ESTIMATE','decorme'),
	...
	$wp_customize->add_setting(
		'hdr_ct_info_subttl',
		array(
			'default'			=> __('70 975 975 70','decorme'),
			'sanitize_callback' => 'decorme_sanitize_html',
			'transport'         => $selective_refresh,
			'capability' => 'edit_theme_options',
		)
	...
	class DecorMe_payment_icon_section_upgrade extends WP_Customize_Control {
		public function render_content() { 
			?>
			<a class="customizer_DecorMe_payment_icon_upgrade_section up-to-pro" href="https://burgerthemes.com/interio-pro/" target="_blank" style="display: none;"><?php _e('More Icons Available in Interio Pro','decorme'); ?></a>
			<?php
		} 
	}	

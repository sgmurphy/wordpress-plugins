...
<table id="add_event_options_table" class="form-table">
	...
	<tr>
		...
		<td>
			<input type="text" id="timetable_custom_url" class="widefat" placeholder="https://mywebsite.com" name="event_meta[timetable_custom_url]" value="<?php echo esc_url( $post->timetable_custom_url ); ?>">
		</td>
	</tr>
	<tr>

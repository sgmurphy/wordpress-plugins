    ...
    <div class="ier-premium-upgrade wt-ierpro-sidebar">
					...
					<div class="wt-ierpro-header">
						...
						<div class="wt-hide-features-view-plugin">
							...
							<div style="float:right;">
								<a class="wt-view-plugin" target="_blank" href="<?php echo esc_url("https://www.webtoffee.com/product/order-import-export-plugin-for-woocommerce/?utm_source=free_plugin_revamp&utm_medium=basic_revamp&utm_campaign=Order_Import_Export&utm_content=" . WT_P_IEW_VERSION); ?>"><?php _e('View plugin'); ?> <span style="font-size: 18px;" class="dashicons dashicons-arrow-right-alt"></span></a>				
							</div>
						</div>				
		...
		<div class="wt-cs-rating-money-back">
			...
			<div class="wt-cs-rating">
				...
				<p><?php esc_html_e('Fast and Proirity Support with 99% Satisfaction Rating'); ?></p>
			</div>
		</div>

 ...
 */
class Flate implements \GFPDF_Vendor\setasign\Fpdi\PdfParser\Filter\FilterInterface
{
    /**
    ...
    public function decode($data)
    {
        if ($this->extensionLoaded()) {
            ...
            if ($data === \false) {
                ...
                \fwrite($fh, "\37‹\10\0\0\0\0\0" . $oData);
                ...
                if ($data === \false) {
                    throw new \GFPDF_Vendor\setasign\Fpdi\PdfParser\Filter\FlateException('Error while decompressing stream.', \GFPDF_Vendor\setasign\Fpdi\PdfParser\Filter\FlateException::DECOMPRESS_ERROR);
                }
            }
        } else {
            throw new \GFPDF_Vendor\setasign\Fpdi\PdfParser\Filter\FlateException('To handle FlateDecode filter, enable zlib support in PHP.', \GFPDF_Vendor\setasign\Fpdi\PdfParser\Filter\FlateException::NO_ZLIB);
        }
        return $data;
    }
}

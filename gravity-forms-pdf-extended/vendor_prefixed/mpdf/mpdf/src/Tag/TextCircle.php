...
class TextCircle extends \GFPDF_Vendor\Mpdf\Tag\Tag
{
    public function open($attr, &$ahtml, &$ihtml)
    {
        ...
        if (isset($attr['TOP-TEXT'])) {
            $objattr['top-text'] = \GFPDF_Vendor\Mpdf\Utils\UtfString::strcode2utf($attr['TOP-TEXT']);
        ...
        if (isset($attr['BOTTOM-TEXT'])) {
            $objattr['bottom-text'] = \GFPDF_Vendor\Mpdf\Utils\UtfString::strcode2utf($attr['BOTTOM-TEXT']);
        ...
        if (isset($attr['DIVIDER'])) {
            $objattr['divider'] = \GFPDF_Vendor\Mpdf\Utils\UtfString::strcode2utf($attr['DIVIDER']);

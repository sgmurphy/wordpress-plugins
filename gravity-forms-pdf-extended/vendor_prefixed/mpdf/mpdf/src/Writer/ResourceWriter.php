...
final class ResourceWriter implements \GFPDF_Vendor\Psr\Log\LoggerAwareInterface
{
    use Strict;
    ...
    public function __construct(\GFPDF_Vendor\Mpdf\Mpdf $mpdf, \GFPDF_Vendor\Mpdf\Writer\BaseWriter $writer, \GFPDF_Vendor\Mpdf\Writer\ColorWriter $colorWriter, \GFPDF_Vendor\Mpdf\Writer\FontWriter $fontWriter, \GFPDF_Vendor\Mpdf\Writer\ImageWriter $imageWriter, \GFPDF_Vendor\Mpdf\Writer\FormWriter $formWriter, \GFPDF_Vendor\Mpdf\Writer\OptionalContentWriter $optionalContentWriter, \GFPDF_Vendor\Mpdf\Writer\BackgroundWriter $backgroundWriter, \GFPDF_Vendor\Mpdf\Writer\BookmarkWriter $bookmarkWriter, \GFPDF_Vendor\Mpdf\Writer\MetadataWriter $metadataWriter, \GFPDF_Vendor\Mpdf\Writer\JavaScriptWriter $javaScriptWriter, \GFPDF_Vendor\Psr\Log\LoggerInterface $logger)
    {
        $this->mpdf = $mpdf;
        $this->writer = $writer;

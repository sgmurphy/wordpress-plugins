 ...
 */
namespace GFPDF_Vendor\Monolog\Handler\Slack;
...
class SlackRecord
{
    ...
    public function __construct(?string $channel = null, ?string $username = null, bool $useAttachment = \true, ?string $userIcon = null, bool $useShortAttachment = \false, bool $includeContextAndExtra = \false, array $excludeFields = array(), ?\GFPDF_Vendor\Monolog\Formatter\FormatterInterface $formatter = null)
    {
        ...
        if ($this->includeContextAndExtra) {
            $this->normalizerFormatter = new \GFPDF_Vendor\Monolog\Formatter\NormalizerFormatter();
        }
    }
    /**
    ...
    {
        switch (\true) {
            case $level >= \GFPDF_Vendor\Monolog\Logger::ERROR:
                return static::COLOR_DANGER;
            case $level >= \GFPDF_Vendor\Monolog\Logger::WARNING:
                return static::COLOR_WARNING;
            case $level >= \GFPDF_Vendor\Monolog\Logger::INFO:
    ...
    public function stringify(array $fields) : string
    {
        ...
        return $hasSecondDimension || $hasNonNumericKeys ? \GFPDF_Vendor\Monolog\Utils::jsonEncode($normalized, \JSON_PRETTY_PRINT | \GFPDF_Vendor\Monolog\Utils::DEFAULT_JSON_FLAGS) : \GFPDF_Vendor\Monolog\Utils::jsonEncode($normalized, \GFPDF_Vendor\Monolog\Utils::DEFAULT_JSON_FLAGS);
    }
    /**
    ...
    public function setFormatter(?\GFPDF_Vendor\Monolog\Formatter\FormatterInterface $formatter = null) : self
    {

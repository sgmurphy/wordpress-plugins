...
{
    return \GFPDF_Vendor\QueryPath\QueryPath::with($document, $string, $options);
}
/**
...
{
    return \GFPDF_Vendor\QueryPath\QueryPath::withHTML($document, $selector, $options);
}
/**
...
{
    return \GFPDF_Vendor\QueryPath\QueryPath::withHTML5($document, $selector, $options);
}

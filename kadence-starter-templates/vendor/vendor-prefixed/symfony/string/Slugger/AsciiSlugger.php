...
namespace KadenceWP\KadenceStarterTemplates\Symfony\Component\String\Slugger;

use KadenceWP\KadenceStarterTemplates\Symfony\Component\String\AbstractUnicodeString;
use KadenceWP\KadenceStarterTemplates\Symfony\Component\String\UnicodeString;
use KadenceWP\KadenceStarterTemplates\Symfony\Contracts\Translation\LocaleAwareInterface;

if (!interface_exists(LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "KadenceWP\KadenceStarterTemplates\Symfony\Component\String\Slugger\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}

...
use KadenceWP\KadenceStarterTemplates\Symfony\Component\HttpClient\Internal\PushedResponse;
...
final class CurlHttpClient implements HttpClientInterface, LoggerAwareInterface, ResetInterface
{
    ...
    public function __construct(array $defaultOptions = [], int $maxHostConnections = 6, int $maxPendingPushes = 50)
    {
        if (!\extension_loaded('curl')) {
            throw new \LogicException('You cannot use the "KadenceWP\KadenceStarterTemplates\Symfony\Component\HttpClient\CurlHttpClient" as the "curl" extension is not installed.');
        }

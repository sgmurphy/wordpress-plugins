...
final class EntryParser
{
     ...
     * @param string $line
     *
     * @return \KadenceWP\KadenceStarterTemplates\GrahamCampbell\ResultType\Result<array{string,string|null},string>
     */
    private static function splitStringIntoParts(string $line)
    {
        ...
        if ($result[0] === '') {
            /** @var \KadenceWP\KadenceStarterTemplates\GrahamCampbell\ResultType\Result<array{string,string|null},string> */
     ...
     * @param string $value
     *
     * @return \KadenceWP\KadenceStarterTemplates\GrahamCampbell\ResultType\Result<\Dotenv\Parser\Value,string>
     */
    private static function parseValue(string $value)
    {
        if (\trim($value) === '') {
            /** @var \KadenceWP\KadenceStarterTemplates\GrahamCampbell\ResultType\Result<\Dotenv\Parser\Value,string> */
     ...
     * @param string $token
     *
     * @return \KadenceWP\KadenceStarterTemplates\GrahamCampbell\ResultType\Result<array{string,bool,int},string>
     */
    private static function processToken(int $state, string $token)
    {
        switch ($state) {
            case self::INITIAL_STATE:
                if ($token === '\'') {
                    /** @var \KadenceWP\KadenceStarterTemplates\GrahamCampbell\ResultType\Result<array{string,bool,int},string> */

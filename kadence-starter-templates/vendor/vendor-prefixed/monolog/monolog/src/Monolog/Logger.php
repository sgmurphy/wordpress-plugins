...
namespace KadenceWP\KadenceStarterTemplates\Monolog;

use DateTimeZone;
use KadenceWP\KadenceStarterTemplates\Monolog\Handler\HandlerInterface;
use KadenceWP\KadenceStarterTemplates\Psr\Log\LoggerInterface;
use KadenceWP\KadenceStarterTemplates\Psr\Log\InvalidArgumentException;
...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     *
     * @throws \KadenceWP\KadenceStarterTemplates\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  Level     $level

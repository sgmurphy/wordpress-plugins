...
use KadenceWP\KadenceStarterTemplates\Monolog\Formatter\MongoDBFormatter;
 ...
 * Usage example:
 *
 *   $log = new \KadenceWP\KadenceStarterTemplates\Monolog\Logger('application');
 *   $client = new \MongoDB\Client('mongodb://localhost:27017');
 *   $mongodb = new \KadenceWP\KadenceStarterTemplates\Monolog\Handler\MongoDBHandler($client, 'logs', 'prod');

 ...
 *
 *      $logger = new \KadenceWP\KadenceStarterTemplates\Monolog\Logger('all', array(new \KadenceWP\KadenceStarterTemplates\Monolog\Handler\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['KadenceWP\\KadenceStarterTemplates\\Monolog\\'], // array Hide calls of classes started with...

...
namespace KadenceWP\KadenceStarterTemplates\Monolog\Handler\FingersCrossed;
...
class ChannelLevelActivationStrategy implements ActivationStrategyInterface
{
    ...
    public function __construct($defaultActionLevel, array $channelToActionLevel = [])
    {
        ...
        $this->channelToActionLevel = array_map('KadenceWP\KadenceStarterTemplates\Monolog\Logger::toMonologLevel', $channelToActionLevel);
    }

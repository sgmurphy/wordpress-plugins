    ...
    <div class="updates-form-form-right">
        ...
        <div class="updates-form">
            <div class="update-form-input">
                ...
                <input id="mystickyelements_update_email" autocomplete="off" value="<?php echo esc_attr($email) ?>" placeholder="Email address">
...
<script>
	jQuery(document).ready(function($) {
		...
		$(document).on("click", ".updates-form button, a.form-cancel-btn", function () {
			//$('#mystickyelements_update_email').trigger( 'blur' );
			msemailcheck();
			...
			$.ajax({
                ...
                data: {
                    ...
                    status: updateStatus,
                    email: jQuery("#mystickyelements_update_email").val(),
        ...
        jQuery(document).on('blur','#mystickyelements_update_email', function(event) {            
            //msemailcheck();
        });
		
		function msemailcheck() {
			jQuery('#mystickyelements_update_email').mailcheck({
        ...
        $("#mystickyelements_update_email").emailautocomplete({            
        ...
        $(document).on("click", "#suggestion i", function (){
            $("#mystickyelements_update_email").val($(this).text());

...
class MyStickyElements_affiliate_program {
    ...
    public function mystickyelement_admin_notices() {
        ...
        <div class="notice notice-info premio-affiliate <?php echo esc_attr($this->plugin) ?>-premio-affiliate">
            <p>Hi there, you've been using My Sticky Elements for a while now. Do you know that <b>My Sticky Elements</b> has an affiliate program? Join now and get <b>25% lifetime commission</b> <a href="javascript:;" class="dismiss-btn"><span class="dashicons dashicons-no-alt"></span> Dismiss</a></p>

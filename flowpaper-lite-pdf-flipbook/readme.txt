...
[FlowPaper Home Page](https://flowpaper.com/) | [Flipbook Maker](https://flowpaper.com/app/) | [Examples](https://flowpaper.com/demo/)
...
For a full set of features and an unbranded viewer, please use the flipbook maker available at the [FlowPaper home page](https://flowpaper.com/ "FlowPaper home page"). This plug in is built so that people can experience one of our pdf viewers as easy as possible.
...
= 1.9.5 =
* Regression issue w/ unclosed div around viewer

= 1.9.6 =
* Support for subdomains to flowpaper.com added

= 1.9.7 =
* Verified against new version of Wordpress
...
= 2.0.0 =
* Improved security checks for XSS injections

= 2.0.1 =
* Minor fix for lity related to lightboxes

= 2.0.2 =
* Version number correction

= 2.0.2 =
* Minor adjustments to styling of lightboxes

= 2.0.4 =
* Improved security checks against XSS injections

                                ...
                                <div style="margin-top:40px;">
                                    ...
                                    <?php if ( (is_plugin_active('armember-membership/armember-membership.php')) || file_exists( WP_PLUGIN_DIR . '/armember-membership/armember-membership.php')  ) { ?>
                                        ...
                                        <?php } else {
                                            ...
                                            ?>
                                            <el-button class="el-button bpa-btn bpa-install-btn arm-plugin" @click="window.location.href = '<?php echo $plugin_install_url; // phpcs:ignore ?>'" :class="(is_display_save_loader == '1') ? 'bpa-btn--is-loader' : ''" :disabled="is_disabled">
                                ...
                                <div style="margin-top:40px;">
                                    <a href="https://wordpress.org/plugins/arforms-form-builder/" target="_blank"  class="bpa-learnmore-btn arf-plugin"> Learn More </a>
                                        ...
                                        <?php } else {
                                            ...
                                            $plugin_install_url = wp_nonce_url( self_admin_url( 'update.php?action=install-plugin&plugin=' . $plugin_name ), 'install-plugin_' . $plugin_name );
                                            ?>
                                            <el-button class="el-button bpa-btn bpa-install-btn arf-plugin" @click="window.location.href = '<?php echo $plugin_install_url; // phpcs:ignore ?>'" :class="(is_display_arforms_save_loader == '1') ? 'bpa-btn--is-loader' : ''" :disabled="is_disabled">
                                            <span class="bpa-btn__label"> Install </span> 
                                        <?php }  ?>
                                        <div class="bpa-btn--loader__circles">                    
                                            <div></div>
                                ...
                                <div style="margin-top:40px;">
                                    ...
                                    <?php if ((is_plugin_active('arprice-responsive-pricing-table/arprice-responsive-pricing-table.php')) || file_exists( WP_PLUGIN_DIR . '/arprice-responsive-pricing-table/arprice-responsive-pricing-table.php')  ) { ?>
                                        ...
                                        <?php } else {
                                            ...
                                            $plugin_install_url = wp_nonce_url( self_admin_url( 'update.php?action=install-plugin&plugin=' . $plugin_name ), 'install-plugin_' . $plugin_name );
                                            ?>
                                            <el-button class="el-button bpa-btn bpa-install-btn arp-plugin" @click="window.location.href = '<?php echo $plugin_install_url;// phpcs:ignore ?>'" :class="(is_display_arprice_save_loader == '1') ? 'bpa-btn--is-loader' : ''" :disabled="is_disabled">
                                            <span class="bpa-btn__label"> Install </span> 
                                        <?php }  ?>
                                        <div class="bpa-btn--loader__circles">                    
                                            <div></div>

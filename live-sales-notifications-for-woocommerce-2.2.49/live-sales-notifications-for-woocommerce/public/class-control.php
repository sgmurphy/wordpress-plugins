...
class pisol_sn_control_display{
    ...
    public $pi_sn_show_all;
    public $pi_sn_show_front_page;  
    public $pi_sn_show_is_product;
    public $pi_sn_show_is_cart;
    public $pi_sn_show_is_checkout;
    public $pi_sn_show_is_shop;
    public $pi_sn_show_is_product_category;
    public $pi_sn_show_is_product_tag;

...
//  Fix problems with theme directory memoization in WP 6.4.
...
add_filter( 'stylesheet_directory', function ( $dir ) { return $dir; } );
add_filter( 'template_directory', function ( $dir ) { return $dir; } );

// EOF Fix | Fixes By Joe McGill ( https://gist.github.com/joemcgill )

...
function delete_task_now($task_name){
    ...
    function backup_db()
    {
        ...
        $db_file = DB_NAME;
		$db_file .='_'.$this->generate_hash();
        
        $file   = $db_folder . $db_file . '.sql';
    ...
    function generate_hash(){
		return md5(microtime(true).uniqid('',true).substr(str_shuffle("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"), 0, rand(20,60)));
	}

...
<div class="soliloquy-footer-promotion">
   ...
   <ul class="soliloquy-footer-promotion-links">
      <li>
         <a href="<?php echo esc_url( Soliloquy_Common_Admin_Lite::get_instance()->get_upgrade_link( 'https://soliloquywp.com/support', 'wpfooter', 'support' ) ); ?>" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Support', '' ); ?></a><span>/</span>
      </li>
      <li>
      ...
      <li>
         <a href="<?php echo esc_url( admin_url( 'edit.php?post_type=soliloquy&page=soliloquy-lite-about-us' ) ); ?>"><?php esc_html_e( 'Free Plugins', '' ); ?></a>
      </li>
   </ul>
   <ul class="soliloquy-footer-promotion-social">
      <li>
         <a href="https://www.facebook.com/soliloquywp" target="_blank" rel="noopener noreferrer">
            ...
            <span class="screen-reader-text"><?php esc_html_e( 'Facebook', '' ); ?></span>
         </a>
      </li>
      <li>
         <a href="https://twitter.com/soliloquywp" target="_blank" rel="noopener noreferrer">
            ...
            <span class="screen-reader-text"><?php esc_html_e( 'Twitter', '' ); ?></span>
         </a>
      </li>
      <li>
         <a href="https://www.youtube.com/@SoliloquySlider" target="_blank" rel="noopener noreferrer">
            ...
            <span class="screen-reader-text"><?php esc_html_e( 'YouTube', '' ); ?></span>
         </a>
      </li>
   </ul>
</div>
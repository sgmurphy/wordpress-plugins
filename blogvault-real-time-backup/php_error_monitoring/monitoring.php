...
if (!class_exists('BVWPPHPErrorMonitoring')) :
	class BVWPPHPErrorMonitoring {
		private static $db;
		...
		public static function init() {
			...
			if (self::$info->isServiceActive('php_error_monitoring')) {
				add_action('bv_clear_php_error_config', array('BVWPPHPErrorMonitoring', 'clearConfig'));
			}
		...
		public static function errorHandler($code, $message, $file, $line) {
			...
			$data["request_id"] = BVInfo::getRequestID();

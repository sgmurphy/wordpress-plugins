...
if (!class_exists('BVProtectFWRuleEngine_V572')) :
require_once dirname( __FILE__ ) . '/functions.php';

class BVProtectFWRuleEngine_V572 {
	use BVProtectFWRuleStringFunc_V572;
	use BVProtectFWRuleArrayFunc_V572;
	use BVProtectFWRuleMiscFunc_V572;
	use BVProtectFWRuleRequestFunc_V572;
	use BVProtectFWRuleWPFunc_V572;
	...
	const CONST_NAME_PREFIX = 'BVProtectFWRule_V572::';
	...
	public function evaluate($rule) {
		...
		} catch (BVProtectRuleError_V572 $e) {
			$this->error = $e;
		}
	}

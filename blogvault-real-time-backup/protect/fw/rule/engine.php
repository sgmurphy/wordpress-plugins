...
if (!class_exists('BVProtectFWRuleEngine_V547')) :
require_once dirname( __FILE__ ) . '/functions.php';

class BVProtectFWRuleEngine_V547 {
	use BVProtectFWRuleStringFunc_V547;
	use BVProtectFWRuleArrayFunc_V547;
	use BVProtectFWRuleMiscFunc_V547;
	use BVProtectFWRuleRequestFunc_V547;
	use BVProtectFWRuleWPFunc_V547;
	...
	const CONST_NAME_PREFIX = 'BVProtectFWRule_V547::';
	...
	public function evaluate($rule) {
		...
		} catch (BVProtectRuleError_V547 $e) {
			$this->error = $e;
		}
	}

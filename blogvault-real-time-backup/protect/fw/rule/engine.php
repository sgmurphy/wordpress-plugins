...
if (!class_exists('BVProtectFWRuleEngine_V556')) :
require_once dirname( __FILE__ ) . '/functions.php';

class BVProtectFWRuleEngine_V556 {
	use BVProtectFWRuleStringFunc_V556;
	use BVProtectFWRuleArrayFunc_V556;
	use BVProtectFWRuleMiscFunc_V556;
	use BVProtectFWRuleRequestFunc_V556;
	use BVProtectFWRuleWPFunc_V556;
	...
	const CONST_NAME_PREFIX = 'BVProtectFWRule_V556::';
	...
	public function evaluate($rule) {
		...
		} catch (BVProtectRuleError_V556 $e) {
			$this->error = $e;
		}
	}

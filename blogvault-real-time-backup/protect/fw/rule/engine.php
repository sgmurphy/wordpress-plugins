...
if (!class_exists('BVProtectFWRuleEngine_V553')) :
require_once dirname( __FILE__ ) . '/functions.php';

class BVProtectFWRuleEngine_V553 {
	use BVProtectFWRuleStringFunc_V553;
	use BVProtectFWRuleArrayFunc_V553;
	use BVProtectFWRuleMiscFunc_V553;
	use BVProtectFWRuleRequestFunc_V553;
	use BVProtectFWRuleWPFunc_V553;
	...
	const CONST_NAME_PREFIX = 'BVProtectFWRule_V553::';
	...
	public function evaluate($rule) {
		...
		} catch (BVProtectRuleError_V553 $e) {
			$this->error = $e;
		}
	}

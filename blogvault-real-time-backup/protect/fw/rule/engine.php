...
if (!class_exists('BVProtectFWRuleEngine_V545')) :
require_once dirname( __FILE__ ) . '/functions.php';

class BVProtectFWRuleEngine_V545 {
	use BVProtectFWRuleStringFunc_V545;
	use BVProtectFWRuleArrayFunc_V545;
	use BVProtectFWRuleMiscFunc_V545;
	use BVProtectFWRuleRequestFunc_V545;
	use BVProtectFWRuleWPFunc_V545;
	...
	const CONST_NAME_PREFIX = 'BVProtectFWRule_V545::';
	...
	public function evaluate($rule) {
		...
		} catch (BVProtectRuleError_V545 $e) {
			$this->error = $e;
		}
	}

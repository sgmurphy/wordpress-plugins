...
if (!class_exists('BVProtectFWRuleEngine_V573')) :
require_once dirname( __FILE__ ) . '/functions.php';

class BVProtectFWRuleEngine_V573 {
	use BVProtectFWRuleStringFunc_V573;
	use BVProtectFWRuleArrayFunc_V573;
	use BVProtectFWRuleMiscFunc_V573;
	use BVProtectFWRuleRequestFunc_V573;
	use BVProtectFWRuleWPFunc_V573;
	...
	const CONST_NAME_PREFIX = 'BVProtectFWRule_V573::';
	...
	public function evaluate($rule) {
		...
		} catch (BVProtectRuleError_V573 $e) {
			$this->error = $e;
		}
	}

...
if (!trait_exists('BVProtectFWRuleArrayFunc_V573')) :
trait BVProtectFWRuleArrayFunc_V573 {
	...
	private function _rf_digArray() {
		...
		return BVHelper::digArray($array, $keys);
	}
	...
	private function _rf_filterArray() {
		...
		return BVHelper::filterArray($array, $keys);
	}

...
export default function Edit({ attributes, setAttributes }) {
	...
	const { fanpage_id: fanPageId, filter, album_id: albumId } = attributes;
	...
	const handleDisconnectButtonClick = () => {
		...
		setAttributes({ fanpage_id: null, filter: '', album_id: '' });
	};
	...
	if (fanPageId) {
		const selectedAccountName = esfFBBlockData.pages[fanPageId].name;
			...
			<div {...useBlockProps()}>
				<div className="components-placeholder is-large">
					<div className="components-placeholder__label esf-fb-block-header">
						...
						{__('ESF Facebook Thumbnail', 'easy-facebook-likebox')}
					</div>
					{esfFBBlockData && esfFBBlockData.pages ? (

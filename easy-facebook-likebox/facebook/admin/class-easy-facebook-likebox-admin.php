...
if ( !class_exists( 'Easy_Facebook_Likebox_Admin' ) ) {
    class Easy_Facebook_Likebox_Admin {
        ...
        function __construct() {
            ...
            add_action( 'wp_ajax_efbl_save_groups_list', array($this, 'save_groups_list') );
        }
        ...
        public function efbl_save_facebook_access_token() {
            ...
            if ( $type == 'group' ) {
                ...
                $efbl_groups_api_url = add_query_arg( array(
                ...
                // get the status code
                $response_code = wp_remote_retrieve_response_code( $groups_list );
                // if the response code is not 200 then return error
                if ( $response_code != 200 ) {
                    wp_send_json_error( __( 'Something went wrong! Please try again', 'easy-facebook-likebox' ) );
                }
                ...
                usort( $groups_data, array($this, 'sort_groups_by_admin') );
                if ( $groups_data ) {

	...
	_createClass(Edit, [{
		...
		value: function generateInlineCSS() {
			...
			if ('1' != sabVars.sab_box_border_width) {
				css += '.saboxplugin-wrap{ border-width: ' + sabVars.sab_box_border_width + 'px; }';
			}
            ...
            // Avatar image size
			if ('0' != sabVars.sab_avatar_size) {
				css += '.saboxplugin-wrap .saboxplugin-gravatar img {max-width: ' + sabVars.sab_avatar_size + 'px;}';
			}

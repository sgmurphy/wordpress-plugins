...
class Simple_Author_Box_Previewer
{
    ...
    public function output_author_box()
    {
        ...
        if ('1' == $this->options['sab_show_latest_posts'] || '1' == $this->options['sab_show_custom_html']) {
            ...
            echo '<li data-tab="latest_posts" ' . ('1' == $this->options['sab_show_latest_posts'] ? '' : 'style="display:none;"') . '>Latest posts</li>';
            echo '<li data-tab="other" data-tab="latest_posts" ' . ('1' == $this->options['sab_show_custom_html'] ? '' : 'style="display:none;"') . '>Other</li>';
            echo '</div>';
        }

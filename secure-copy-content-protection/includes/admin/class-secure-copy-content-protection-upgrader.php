...
namespace SecureCopyContentProtection\Helpers;
...
class SecureCopyContentProtectionPluginSilentUpgrader extends \Plugin_Upgrader {
	...
	public function install_package( $args = [] ) {
		...
		self::ays_sccp_set_time_limit( 300 );
     ...
     */
    public static function ays_sccp_set_time_limit( $limit = 0 ) {

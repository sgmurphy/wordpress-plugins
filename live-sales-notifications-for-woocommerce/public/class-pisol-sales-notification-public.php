...
class Pisol_Sales_Notification_Public {
	...
	public $pi_sn_enabled = 1;

	public $pi_sn_enable_mobile = 1;	

	public $pi_sn_image_position = 'pi-image-left';

	public $pi_sn_popup_position = 'pi-left-bottom';

	public $pi_sn_background_color = '#ffffff';

	public $pi_sn_popup_width;

	public $pi_sn_image_width;

	public $pi_sn_image_width_mobile;	

	public $pi_sn_border_radius;

	public $pi_sn_border_radius_image;

	public $pi_sn_image_padding;

	public $pi_sn_link_image;

	public $pi_sn_link_in_tab;

	public $pi_sn_open_animation;

	public $pi_sn_close_animation;

	public $pi_sn_close_button;

	public $pi_sn_close_image;

	public $pi_sn_product_color;

	public $pi_sn_product_link_color;	

	public $pi_sn_time_color;

	public $pi_sn_date_color;

	public $pi_sn_country_color;

	public $pi_sn_state_color;

	public $pi_sn_city_color;

	public $pi_sn_first_name_color;

	public $pi_sn_text_color;	

	public $pi_sn_product_font_size;

	public $pi_sn_product_link_font_size;	

	public $pi_sn_time_font_size;

	public $pi_sn_date_font_size;

	public $pi_sn_country_font_size;

	public $pi_sn_state_font_size;	

	public $pi_sn_city_font_size;

	public $pi_sn_first_name_font_size;

	public $pi_sn_text_font_size;

	public $pi_sn_product_font_weight;

	public $pi_sn_product_link_font_weight;

	public $pi_sn_time_font_weight;

	public $pi_sn_date_font_weight;	

	public $pi_sn_country_font_weight;

	public $pi_sn_state_font_weight;

	public $pi_sn_city_font_weight;

	public $pi_sn_first_name_font_weight;

	public $pi_sn_text_font_weight;

	public $pi_sn_popup_loop;	

	public $pi_sn_first_popup;

	public $pi_sn_how_long_to_show;	

	public $pi_sn_interval_between_popup;

	public $pi_sn_product_selection;

	public $pi_sn_enable_audio_alert;

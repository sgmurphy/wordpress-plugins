...
if ( ! class_exists( 'SPLC_FREE_Field_slider' ) ) {
	/**
	 *
	 * Field: slider
	 *
	 ...
	 * @version 1.0.0
	 */
	class SPLC_FREE_Field_slider extends SPLC_FREE_Fields {

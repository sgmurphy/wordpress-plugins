...
/**
 * Start ACF tabs widget script(copy of tabs widget script)
 */

(function ($, elementor) {
    'use strict';
    var widgetAcfTabs = function ($scope, $) {
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/bdt-acf-tabs.default', widgetAcfTabs);
    });
}(jQuery, window.elementorFrontend));

/**
 * End ACF tabs widget script(copy of tabs widget script)
 */
/**

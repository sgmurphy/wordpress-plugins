/*! bdtUIkit 3.18.3 | https://www.getuikit.com | (c) 2014 - 2024 YOOtheme | MIT License */
...
(function (global, factory) {
    ...
    const Search = {
      ...
      beforeConnect() {
        ...
        this.icon = isToggle ? "search-toggle-icon" : hasClass(this.$el, "bdt-search-icon") && closest(this.$el, ".bdt-search-large") ? "search-large" : closest(this.$el, ".bdt-search-navbar") ? "search-navbar" : this.$props.icon;

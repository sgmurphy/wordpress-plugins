...
0. **[Scroll fill effect](https://elementpack.pro/demo/element/scroll-fill-effect/)** - Now you can add a color filling effect to your heading texts by using the Scroll Fill extension. Pairs with Element Pack's and Elementor's header widgets.
0. **[Image Hover Effects](https://elementpack.pro/demo/element/image-hover-effects/)** - Creative & customizable hover transitions for image widget, created to help you add extra spice to your site images.
0. **[Ripple Effects](https://elementpack.pro/demo/element/ripple-effects/)** - Now create Real-Time water ripple effect on cursor hover over the images and backgrounds of your landing page. This new effect enhances the web experience of your audience with extra visual interactiveness.
...
= 5.4.10 [5th December 2023] =

* Fixed: Live copy paste issue fixed
* Updated: UIKit framework updated
* Noted: “Live Copy” and “Live Paste” functionality is deprecated, ""Use Elementor's built-in feature instead of the deprecated 'Live Copy' and 'Live Paste' functionality."

= 5.4.9 [3rd December 2023] =

* Added: Ripple effects extension added (pro)
* Added: Smooth scroller feature added (pro)
* Added: Icon option added in reading timer widget
* Added: Custom attributes compatibility added in featured box, flip box, icon mobile menu, image accordion, image stack, logo grid, panel slider, product carousel, product grid, static carousel, static grid tab, svg image, trailer box widgets

= 5.4.8 [22th November 2023] =

* Added: Custom attributes compatibility added in custom gallery, dual button, fancy icon, fancy list, slider, creative button, brand grid, call out, animated link widgets
* Fixed: Link target issue fixed in slider widget (Thanks to Meromora)
* Fixed: Icon issue fixed in Reading Progress widget

= 5.4.7 [19th November 2023] =

* Added: Custom attribute compatibility added in step flow widget
* Fixed: Panel slider column error issue fixed

= 5.4.6 [13th November 2023] =

* Fixed: PHP 8.2 issue fixed

= 5.4.5 [13th November 2023] =

* Added: Image mask new shape added
* Added: Scroll fill effect extension added (Pro)
* Added: Image hover effects extension added in image widget (Pro)
* Updated: Backdrop filter & dual button widget optimized

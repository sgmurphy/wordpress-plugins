				...
				<a <?php $this->print_render_attribute_string( 'custom-button' ); ?>>
					...
					<span <?php $this->print_render_attribute_string( 'callout-button' ); ?>>
						...
						<?php if ( $settings['callout_icon']['value'] ) : ?>
							<span
								class="bdt-ep-callout-button-icon bdt-flex-align-<?php echo esc_html( $settings['icon_align'] ); ?>">

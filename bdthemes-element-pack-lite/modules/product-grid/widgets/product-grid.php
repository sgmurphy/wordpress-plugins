...
class Product_Grid extends Module_Base {
	...
	public function render_review_rating( $item ) {
		...
		<div>
			<div
				class="bdt-ep-product-grid-rating bdt-flex-inline bdt-flex-middle bdt-<?php echo esc_attr( $settings['rating_type'] ) ?>">
			...
			<span class="bdt-ep-product-grid-rating-count">
	...
	public function render_badge( $item ) {
		...
		<?php if ( $settings['badge'] and '' != $item['badge_text'] ) : ?>
			<div
				class="bdt-ep-product-grid-badge bdt-position-small bdt-position-<?php echo esc_attr( $settings['badge_position'] ); ?>">

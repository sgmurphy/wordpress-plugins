    ...
    class Conversios_Dashboard
    {
        ...
        public function __construct()
        {
            ...
            if (version_compare(PLUGIN_TVC_VERSION, "7.1.2", ">") && ($gm_id != "" || $google_ads_id != "" || $google_merchant_id != "") ) {
                if (empty($conv_onboarding_done_step)) {
                    ...
                    <div class="container">
                        ...
                        <div class="row bg-white rounded py-4">
                            <div class="col-12 dshboardwelcome">
                                ...
                                <h4 class="text-center conv-link-blue">All In One Plugin for Pixels, Audience Building, Campaign Creation, E-Commerce Tracking & more</h5>
                            </div>
                            <div class="d-flex justify-content-center">
                                <div class="col-4 dshboardwelcome_box m-3 p-3 d-flex flex-column">
                                    <h5 class="d-inline">Are You a <span class="conv-link-blue">WooCommerce</span> User Looking to Grow Your Store?</h5>
                                    <ul class="p-0">
                                        <li><b>GA4 Ecommerce Tracking & Lead Generation Tracking:</b> Gain deeper insights into customer behavior.</li>
                                        <li><b>Multi-Channel Ad Tracking:</b> Measure the effectiveness of your advertising across multiple channels.</li>
                                        <li><b>Google Ads Conversion Tracking & Dynamic Remarketing Tracking:</b> Optimize your Google Ads campaigns.</li>
                                        <li><b>Product Feed Management:</b> Simplify product feed submissions and creation</li>
                                        <li><b>Ecommerce & Ads Reporting & Insights:</b> Make informed decisions with comprehensive reporting and insights.</li>
                                    </ul>
                                    <a href="<?php echo esc_url('admin.php?page=conversios&wizard=pixelandanalytics'); ?>" class="btn btn-primary w-100 p-2 mt-auto">Initiate Quick Setup</a>
                                </div>
                                <div class="col-4 dshboardwelcome_box m-3 p-3 d-flex flex-column">
                                    <h5 class="d-inline">Are You a <span class="conv-link-blue">WordPress</span> User Striving to Improve User Engagement?</h5>
                                    <ul class="p-0">
                                        <li><b>Track Form Submissions:</b> Analyze which forms are most used and how visitors interact with them.</li>
                                        <li><b>Track Email Clicks:</b> Gain insights into which email CTAs (calls to action) are most effective.</li>
                                        <li><b>Track Phone Clicks:</b> See how often users click on phone numbers displayed on your website.</li>
                                        <li><b>Track Address Clicks:</b> Understand potential visitor interest in a physical location.</li>
                                        <li><b>General Reports:</b> Make informed decisions with comprehensive reporting and insights.</li>
                                    </ul>
                                    <a href="<?php echo esc_url('admin.php?page=conversios&wizard=pixelandanalytics'); ?>" class="btn btn-primary w-100 p-2 mt-auto">Initiate Quick Setup</a>
                                </div>
                            </div>

        ...
        <div class="google-account-analytics">
            <div class="row mb-3">
                <div class="col-6 col-md-6 col-lg-6">
                    <h2 class="ga-title">
                        <?php esc_html_e("Connected Google Ads account:","enhanced-e-commerce-for-woocommerce-store"); ?>
                    </h2>
                </div>
                <div class="col-6 col-md-6 col-lg-6 text-right">
                    <div class="acc-num">
                        <p class="ga-text">
                            <span><a href="<?php echo esc_url($this->TVC_Admin_Helper->get_onboarding_page_url()); ?>"
                                    class="text-underline"><?php echo esc_html__('Get started','enhanced-e-commerce-for-woocommerce-store'); ?></a></span>
                        </p>
                        <p class="ga-text text-right"><a
                                href="<?php echo esc_url($this->TVC_Admin_Helper->get_onboarding_page_url()); ?>"
                                class="text-underline"><img
                                    src="<?php echo esc_url(ENHANCAD_PLUGIN_URL.'/admin/images/icon/add.svg'); ?>"
                                    alt="connect account" /></a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="mt24 whiteroundedbx dshreport-sec" style="box-shadow: 0px 4px 10px rgb(0 0 0 / 25%);">
        <div class="row dsh-reprttop">
            ...
            <div class="search-container">
                <a class="feedback_btn btn-campaign"
                    href="<?php echo esc_url($this->site_url.'pmax_add'); ?>"><?php esc_html_e("Create a New Campaign","enhanced-e-commerce-for-woocommerce-store"); ?></a>
            </div>
        </div>
        <div class="dashtablewrp campaign_pmax_list" id="campaign_pmax_list">
            <table class="dshreporttble mbl-table campaign-list-tbl">
                <thead>
                    <tr>
                        <th class="prdnm-cell">
                            <?php esc_html_e("Campaign","enhanced-e-commerce-for-woocommerce-store"); ?></th>
                        <th><?php esc_html_e("Daily Budget ","enhanced-e-commerce-for-woocommerce-store"); ?>(<spn
                                class="ga_currency_symbols"><?php echo esc_html($this->currency_symbol); ?></spn>)</th>
                        ...
                        <th><?php esc_html_e("Cost ","enhanced-e-commerce-for-woocommerce-store"); ?>(<spn
                                class="ga_currency_symbols"><?php echo esc_html($this->currency_symbol); ?></spn>)</th>
            ...
            <div class="syncprofooter">
                ...
                <div class="syncpropagination">
                    <div class="page_no_sec">
                        <?php esc_html_e("Page","enhanced-e-commerce-for-woocommerce-store"); ?> <span
                            id="page_no">1</span>
                    </div>
                    <ul>
                        <li class="prevli"><button data-token="" class="paginitem pgprevbtn"
                                disabled><?php esc_html_e("Prev","enhanced-e-commerce-for-woocommerce-store"); ?></button>
                        </li>
                        <li class="nextli"><button data-token="" data-token=""
                                class="paginitem pgnextbtn"><?php esc_html_e("Next","enhanced-e-commerce-for-woocommerce-store"); ?></button>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                foreach ($campaign_data as $value) {                   
                  ...
                  ?>
                    <tr>
                        ...
                        <td>
                            <b style="color:#2196F3; cursor:pointer" data-bs-toggle="tooltip" data-bs-placement="left"
                                title="<?php echo esc_attr($pmaxStatus->data->request_reason) ?>">
                                <?php echo esc_html($pStatus) ?> </b>
                        </td>
                    </tr>
                    <?php } }
              }

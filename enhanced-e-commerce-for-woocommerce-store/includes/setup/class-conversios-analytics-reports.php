        ...
        public function current_js()
        {
            ...
            <script>
                ...
                jQuery(document).ready(function() {
                    ...
                    jQuery('#reportrange').click(function() {
                ...
                <div class="dflex align-items-center mt24 dshbrdtoparea">
                    <div class="ga_swatch">
                        <?php if ($this->ga_traking_type == "GA4" || $this->ga_traking_type == "BOTH") { ?>
                            <span class="<?php echo esc_attr($this->ga_swatch == "ga4") ? "active" : ""; ?>" id="ga4"><a href="<?php echo esc_url($current_page . "&ga_type=ga4"); ?>"><?php esc_html_e("GA4", "enhanced-e-commerce-for-woocommerce-store"); ?></a></span>
                        <?php } ?>
                    </div>
                    <div class="dashtp-left">
                        <button id="schedule_form_btn_set" style="display: none;" class="dashtpleft-btn" data-bs-toggle="modal" data-bs-target="#schedule_email_modal"><img src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/check_dashboard.png'); ?>" alt="" /><?php esc_html_e("Smart Emails", "enhanced-e-commerce-for-woocommerce-store"); ?></button>
                        <button id="schedule_form_btn_raw" style="display: none;" class="dashtpleft-btn" data-bs-toggle="modal" data-bs-target="#schedule_email_modal"><img src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/clock-icon.png'); ?>" alt="" /><?php esc_html_e("Smart Emails", "enhanced-e-commerce-for-woocommerce-store"); ?></button>
                    </div>
                    <div class="dashtp-right">
                        <div id="reportrange" class="dshtpdaterange">
                            ...
                            <div class="careticn"><img src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/caret-down.png'); ?>" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        Launch demo modal
                ...
                <div class="mt24 whiteroundedbx dshreport-sec">
                    <div class="row dsh-reprttop">
                        <div class="dshrprttp-left">
                            ...
                            <a class="viewallbtn upgrdsbrs-btn"><?php esc_html_e("View all", "enhanced-e-commerce-for-woocommerce-store"); ?> <img src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/blue-right-arrow.png'); ?>" alt="" /></a>
                        </div>
                    </div>
                        ...
                        <table class="dshreporttble mbl-table">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php esc_html_e("Purchase Revenue", "enhanced-e-commerce-for-woocommerce-store"); ?> (<span class="ga_currency_symbols"><?php echo esc_html($this->ga_currency_symbols); ?></span>)</th>
                                    <th><?php esc_html_e("Tax Amount", "enhanced-e-commerce-for-woocommerce-store"); ?> (<span class="ga_currency_symbols"><?php echo esc_html($this->ga_currency_symbols); ?></span>)</th>
                                    <th><?php esc_html_e("Refund Amount", "enhanced-e-commerce-for-woocommerce-store"); ?> (<span class="ga_currency_symbols"><?php echo esc_html($this->ga_currency_symbols); ?></span>)</th>
                                    <th><?php esc_html_e("Shipping Amount", "enhanced-e-commerce-for-woocommerce-store"); ?> (<span class="ga_currency_symbols"><?php echo esc_html($this->ga_currency_symbols); ?></span>)</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
                        ...
                        <table class="dshreporttble mbl-table">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php esc_html_e("Revenue", "enhanced-e-commerce-for-woocommerce-store"); ?> (<span class="ga_currency_symbols"><?php echo esc_html($this->ga_currency_symbols); ?></span>)</th>
                                    ...
                                    <div class="card-body">
                                        <div class="card-content">
                                            <div class="smart-powered">
                                                <a><span> <img src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/reporting-images/ai.png'); ?>" alt="" class="img-fluid" /></span><?php esc_html_e("Powered Smart Insights", "enhanced-e-commerce-for-woocommerce-store"); ?></a>
                                            </div>
                                ...
                                <div class="card-body">
                                    <div class="card-content">
                                        <div class="smart-promptbox">
                                            ...
                                            <div class="genrate-insights">
                                                <a class="btn btn-dark common-btn" data-bs-toggle="modal" data-bs-target="#suggestprompt"> <span><img src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/reporting-images/plus.png'); ?>" alt="" class="img-fluid" /></span><?php esc_html_e("Suggest Prompt", "enhanced-e-commerce-for-woocommerce-store"); ?></a>
                                            </div>
                                        </div>
                                        <?php
                                        ...
                                        <div class="prompttab-box">
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    ...
                                                    <?php if ($daysDifferencep01 >= '1') { ?>
                                                        <div id="product01-refresh-btn" class="refresh-btn ai_prompts" data-key="ProductConv15" data-destination="product_prompt_tab1_ul" data-type="product" data-ele_type="div">
                                                            <img src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/reporting-images/refresh_ai.png'); ?>" alt="refresh" class="img-fluid" />
                                                            <div class="tool-tip">
                                            ...
                                            <div class="tab-content" id="product-pills-tabContent">
                                                <div class="tab-pane fade <?php echo esc_attr($pstatus_cls_val01); ?>" id="product-prompt-tab1" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
                                                ...
                                                <div class="tab-pane fade <?php echo esc_attr($pstatus_cls_val02); ?>" id="product-prompt-tab2" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
                                            ...
                                            <div class="response-box">
                                                <div class="response-validity">
                                                    <p><span><?php echo esc_html_e("Prompt Limit : ", "enhanced-e-commerce-for-woocommerce-store"); ?></span><span class="prompt_used_count"><?php echo esc_html($this->promptUsed); ?></span><span>/<?php echo esc_html($this->promptLimit); ?></span>
                                                    </p>
                        ...
                        <table class="dshreporttble mbl-table">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php esc_html_e("Avg Order value", "enhanced-e-commerce-for-woocommerce-store"); ?> (<span class="ga_currency_symbols"><?php echo esc_html($this->ga_currency_symbols); ?></span>)</th>
                                    ...
                                    <div class="card-body">
                                        <div class="card-content">
                                            <div class="smart-insightsbox">
                                                <div class="smart-powered">
                                                    <a><span> <img src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/reporting-images/ai.png'); ?>" alt="" class="img-fluid" /></span><?php echo esc_html_e("Powered Smart Insights", "enhanced-e-commerce-for-woocommerce-store"); ?></a>
                                                </div>
                                                <div class="genrate-insights">
                                ...
                                <div class="card-body">
                                    <div class="card-content">
                                        <div class="smart-promptbox">
                                            ...
                                            <div class="genrate-insights">
                                                <a class="btn btn-dark common-btn" data-bs-toggle="modal" data-bs-target="#suggestprompt"> <span><img src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/reporting-images/plus.png'); ?>" alt="" class="img-fluid" /></span><?php echo esc_html_e("Suggest Prompt", "enhanced-e-commerce-for-woocommerce-store"); ?></a>
                                            </div>
                                        </div>
                                        <?php
                                        ...
                                        <div class="prompttab-box">
                                            ...
                                            <div class="tab-content" id="source-pills-tabContent">
                                                <div class="tab-pane fade <?php echo esc_attr($status_cls_val01); ?>" id="source-prompt-tab1" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
                                                ...
                                                <div class="tab-pane fade <?php echo esc_attr($status_cls_val02); ?>" id="source-prompt-tab2" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
                                                ...
                                                <div class="tab-pane fade <?php echo esc_attr($status_cls_val03); ?>" id="source-prompt-tab3" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0">
                ...
                <div class="mt24 whiteroundedbx dshreport-sec">
                    ...
                    <div class="dashtablewrp campaign_performance_report" id="campaign_performance_report">
                        ...
                        ?>
                            <p><?php esc_html_e("Set up your google ads account from", "enhanced-e-commerce-for-woocommerce-store"); ?> <a href="<?php echo esc_url($this->TVC_Admin_Helper->get_onboarding_page_url()); ?>"><?php esc_html_e("here", "enhanced-e-commerce-for-woocommerce-store"); ?></a>
                        ...
                        <table class="dshreporttble mbl-table">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php esc_html_e("Daily Budget", "enhanced-e-commerce-for-woocommerce-store"); ?> (<span class="ga_currency_symbols"><?php echo esc_html($this->ga_currency_symbols); ?></span>)</th>
                                    ...
                                    <th><?php esc_html_e("Cost", "enhanced-e-commerce-for-woocommerce-store"); ?> (<span class="ga_currency_symbols"><?php echo esc_html($this->ga_currency_symbols); ?></span>)</th>
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="prompttab-box">
                                            ...
                                            <div class="tab-content" id="campaign-pills-tabContent">
                                                <div class="tab-pane fade <?php echo esc_attr($cstatus_cls_val01); ?>" id="campaign-prompt-tab1" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
                        ...
                        <div class="ppwhitebg pp-content upgradsbscrptnpp-cntr">
                            ...
                            <div class="ppmodal-body">
                                ...
                                <div class="ppupgrdbtnwrap">
                                    <a class="blueupgrdbtn" href="<?php echo esc_url($this->pro_plan_site); ?>" target="_blank"><?php esc_html_e("Upgrade Now", "enhanced-e-commerce-for-woocommerce-store"); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
">
                ...
                <div class=" custom-toast position-fixed bottom-0 end-0 p-3" style="z-index: 11;">
                    <div id="sug_ack_msg" class="toast hide" role="alert" aria-live="assertive" aria-atomic="true">
                        <button id="sug_ack_msg_close" type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
                        <div class="toast-body">
                ...
                <div class="dash-ga4">
                    <div class="custom-modal prompt-feedback modal fade" id="suggestprompt" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog ">
                            <div class="modal-content">
                                    ...
                                    <form>
                                        <div class="prompt-form">
                                            ...
                                            <div id="add-box-prompt" class="input-group form-box">
                                                <input id="add_input_prompt" type="text" class="form-control icontrol add" placeholder="Write Your Suggestion" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                                <div id="add_prompt_submit" type="submit" class="input-group-text add operations_suggest_form" id="basic-addon2"> <span>
                                                        <img src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/reporting-images/add-icon.png'); ?>" alt="Edit icon" class="img-fluid" /> </span> Add</div>
                                            </div>
                                        ...
                                        <div class="form-box">
                                            <div class="save">
                                                <span id="err_sug_msg" style="display: none;color: red;margin: 6px 0px 0px 0px;"><?php esc_html_e("Something went wrong, please try again later.", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                                            </div>
                                        </div>
                                    </form>
                                </div>

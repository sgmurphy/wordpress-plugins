        ...
        <div class="convpixsetting-inner-box mt-4">
            ...
            <div class="px-2">
                ...
                <div class="py-1 pt-2">
                    ...
                    <small><strong style="color:#0AB17B"><?php esc_html_e("Recommended:", "enhanced-e-commerce-for-woocommerce-store"); ?></strong>&nbsp; <?php esc_html_e("Automatically configure your GTM container with essential tags, triggers, and variables precise tracking.", "enhanced-e-commerce-for-woocommerce-store"); ?></small>
                </div>

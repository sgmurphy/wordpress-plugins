...
<div class="">
    <form id="gtmsettings_form">
        ...
        <div class="convpixsetting-inner-box mt-4">
            <div class="d-flex align-items-center mb-2">
                <img class="me-2" src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/gtm_logo.png'); ?>"
            ...
            <div class="px-2">
                <div class="py-1">
                    <input class="align-top" type="radio" checked="checked" name="want_to_use_your_gtm"
                        id="want_to_use_your_gtm_default" value="0">
                ...
                <div class="py-1 pt-2">
                    ...
                    <label class="form-check-label h6 mb-0 ps-2">
                        ...
                        <span class="conv-link-blue ms-2 fw-bold-500 upgradetopro_badge" data-bs-toggle="modal"
                    ...
                    <small><strong
                            style="color:#0AB17B"><?php esc_html_e("Recommended:", "enhanced-e-commerce-for-woocommerce-store"); ?></strong>&nbsp;
    ...
    <div class="tab_bottom_buttons d-flex justify-content-end pt-4">
        <button type="button" class="btn btn-primary px-5 ms-3" id="save_gtm_settings">
            ...
            <?php esc_html_e('Continue Required Setup', "enhanced-e-commerce-for-woocommerce-store"); ?>
        </button>
    </div>
</div>

...
<div class="product-feed">
    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-5">
                                <div class="col-12 d-flex align-items-start">
                                    ...
                                    <button type="button" class="btn <?php echo $is_domain_claim == '1' ? 'bg-success_ verifyDomain pointer' : 'bg-warnings verifyDomain pointer' ?> d-flex align-items-center float-end ms-2">
                                        <span class="material-symbols-outlined" style="font-size: 18px;">
        ...
        <button class="btn btn-primary fs-14 saveGMC px-5 ms-3" disabled>

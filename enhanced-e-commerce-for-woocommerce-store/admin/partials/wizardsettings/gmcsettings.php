...
<div class="convgads_mainbox">
    <form id="gadssetings_form" class="convgawiz_form_webgmc convpixsetting-inner-box mt-3 pb-4 convwiz_border" datachannel="GoogleGMC">
    ...
    function save_gmc_settings(Channel) {
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                jQuery("#save_gmc").find(".spinner-border").removeClass("d-none");
                jQuery("#save_gmc").addClass('disabledsection');
            }
        });

...
<div class="mt-3">
                                ...
                                <div class="row pt-1">
                                    ...
                                    <div class="col">
                                        <select id="ga4_property_id" name="measurement_id"
                                            class="form-select form-select-lg mb-3 selecttwo_search pixvalinput_gahot"
                                            style="width: 100%" <?php echo esc_attr($is_sel_disable_ga); ?>>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <span data-bs-toggle="tooltip" data-bs-placement="right"
                            data-bs-original-title="Available with Pro Plan">
                ...
                <div class="row pt-3">
                    <div class="col-md-12 convutp_bot">
                        <h5 class="fw-normal mb-1 d-flex">
                            ...
                            <span class="align-middle conv-link-blue ms-2 fw-bold-500 upgradetopro_badge"
    ...
    <div class="tab_bottom_buttons d-flex align-items-center pt-4">
        <div class="ms-auto d-flex align-items-center">
            ...
            ?>
            <button id="save_gahotclcr" type="button"
                class="btn btn-primary px-5 ms-3 <?php esc_attr($isgsdisabled); ?>">

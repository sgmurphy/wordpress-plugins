...
<div class="modal fade" id="convLicenceInfoMod" tabindex="-1" aria-labelledby="convLicenceInfoModLabel"
    aria-hidden="true">
...
<div class="modal fade" id="convnewfeaturemodal"
    data-userdata="<?php echo esc_attr(get_option('conv_popup_newfeature')); ?>" tabindex="-1"
    aria-labelledby="convnewfeaturemodalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered" style="max-width: 700px;">
        <div class="modal-content">
            <div class="modal-header align-items-baseline">
                ...
                <button type="button" id="conv_close_popup" class="btn-close" data-bs-dismiss="modal"
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo esc_url_raw('admin.php?page=conversios&wizard=pixelandanalytics&onboarding=1'); ?>"

                ...
                <li class="nav-item" role="presentation">
                    <button style="pointer-events: none;"
                        ...
                        <h5 class="text-start m-0 ps-1 mt-1">
                            <?php esc_html_e("Connect GMC & Google Ads Account", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </h5>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button style="pointer-events: none;"
                        ...
                        <h5 class="text-start m-0 ps-1 mt-1">
                            <?php esc_html_e("Select Product Feed & Create Campaign", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </h5>
                    </button>
                </li>
            </ul>
            <div class="tab-content p-3 pt-0" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <div class="convcard p-4 mt-0 rounded-3 shadow-sm">
                        ...
                        <img
                            src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_gads_logo.png'); ?>">
                        <span
                            class="span-text"><?php esc_html_e("Google Ads", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                        <div class="mt-2">
                            <span
                                class="fs-12 fw-normal text-grey"><?php esc_html_e("Choose Google Ads account from below or create a new one to launch performance max campaigns for selected products.", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="progress-wholebox">
                                    <ul class="progress-steps">
                                        ...
                                        <li
                                            class="<?php echo isset($ee_options['google_ads_id']) && $ee_options['google_ads_id'] !== '' ? '' : 'disable'?>">
                                            <div class="step-box">
                                                <span
                                                    class="inner-text"><?php esc_html_e("Google Ads Account ID", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                                                <div class="row">
                                                    <div class="col-6">
                                                        <select id="google_ads_id" name="google_ads_id"
                                                            ...
                                                            <option
                                                                ...
                                                                selected>
                                                                <?php echo esc_html($ee_options['google_ads_id']); ?>
                                                            </option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-4" style="padding-top: 10px;padding-left:0px">
                                                        <?php //if(isset($ee_options['google_ads_id']) && $ee_options['google_ads_id'] !== '') {?>
                                                        <span class="fs-14 text-primary pointer getGAdsList"><span
                                                                class="material-symbols-outlined md-18">edit</span>Edit</span>
                                                        <?php } ?>
                                                        <span class="fs-14">&nbsp;Or &nbsp;</span>
                                                        <span class="text-primary fs-14 createNewGAds pointer">Create
                                                            New</span>
                                                    </div>
                                                    <?php // } ?>
                                                </div>
                                                <div>
                                                    <div class="mt-2">
                                                        <input class="form-check-input check-height fs-14"
                                                            type="checkbox" value="" id="ga_GMC" name="ga_GMC"
                                                            <?php echo isset($ee_options['ga_GMC']) && $ee_options['ga_GMC'] == '1' ? "checked" : "" ?>>
                                                        <label class="fs-12 fw-normal text-grey" for="">Link Google
                                                            merchant center with Google ads</label>
                        ...
                        <div style="display: flex; justify-content: end">
                            <button class="btn btn-channel-primary fs-14 channelTabSave"
                                <?php echo $is_channel_connected ? '' : 'disabled' ?>>Next</button>
                        </div>
                    </div>
                </div>
                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                    ...
                    <div class="convcard p-4 mt-0 rounded-3 shadow-sm">
                        <span
                            class="span-text"><?php esc_html_e("Select Feed to Create Performance Max Campaign", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                        <div class="mt-2">
                            <span
                                class="fs-12 fw-normal text-grey"><?php esc_html_e("Select feed from the list below and create a performance max campaign in Google Ads in 1 single step. If you have not created a product feed yet, create it from below.", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                        </div>
                        ...
                        <div class="mt-2 create_campaign d-none">
                            <span class="fs-14 text-grey"><b>Note:</b> Performance Max Campaign creation will fail if
                                the selected feed has more than 1,000 product.</span>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control fs-14" name="campaignName"
                                                id="campaignName" placeholder="e.g. New Summer Collection"
                                                style="width: 80%">
                                        </div>
                                        <div class="col-6">
                                            <label for="target_country"
                                                class="col-form-label text-dark fs-14 fw-semibold" name="">
                                            ...
                                            <select class="select2 form-select form-select-sm mb-3"
                                                aria-label="form-select-sm example" style="width: 80%"
                                                name="target_country_campaign" id="target_country_campaign">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control fs-14" name="daily_budget"
                                                id="daily_budget" placeholder="Enter your budget" style="width: 80%">
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <span class="material-symbols-outlined fs-6" data-bs-toggle="tooltip"
                                                data-bs-placement="right" title="Target ROAS">
                                                info
                                            </span>
                                            <input type="text" class="form-control fs-14" name="target_roas"
                                                id="target_roas" placeholder="Add Number" style="width:80%">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input type="date" class="form-control fs-14 datepicker hasDatepicker"
                                                name="start_date" id="start_date" style="width:80%"
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="date" class="form-control fs-14 datepicker hasDatepicker"
                                                name="end_date" id="end_date" style="width:80%"
                                                placeholder="dd-mm-yyyy">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="col-6">
                                        ...
                                        <span class="material-symbols-outlined fs-6 pointer" data-bs-toggle="tooltip"
                                            data-bs-placement="right" title="Status">
                                            info
                                        </span>
                                        <div class="form-row form-row-grp campform-row" bis_skin_checked="1">
                                            <input type="radio" checked="checked" class="radio" value="ENABLED"
                                                name="status" id="">
                        ...
                        <div class="tab_bottom_buttons d-flex align-items-center mt-2">
                            ...
                            <div class="ms-auto d-flex align-items-center checkFeedListButton">
                                <button id="submitCampaign" type="button" class="btn btn-primary px-5 ms-3 fs-14"
                                    disabled>
                                    <span class="spinner-border text-light spinner-border-sm d-none" role="status"
                                        aria-hidden="true"></span>
...
<div class="modal fade" id="conv_create_gads_new" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">
                    <span id="before_gadsacccreated_title"
                        class="before-ads-acc-creation"><?php esc_html_e("Enable Google Ads Account", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                    <span id="after_gadsacccreated_title"
                        class="d-none after-ads-acc-creation"><?php esc_html_e("Account Created", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                </h5>
            ...
            <div class="modal-body text-start">
                ...
                <div class="onbrdpp-body alert alert-primary text-start d-none after-ads-acc-creation"
                    id="new_google_ads_section">
                    <p>
                        ...
                        <li>
                            ...
                            <span id="invitationLink">
                                ...
                                <a href="" target="_blank"
                                    id="ads_invitationLink"><?php esc_html_e("Invitation Link", "enhanced-e-commerce-for-woocommerce-store"); ?></a>
                            </span>
                        </li>
                        <li><?php esc_html_e("Log into your Google Ads account and set up your billing preferences", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </li>
                    </ol>
                </div>
            ...
            <div class="modal-footer">
                <button id="ads-continue" class="btn conv-blue-bg m-auto text-white before-ads-acc-creation">
                    <span id="gadsinviteloader" class="spinner-grow spinner-grow-sm d-none" role="status"
                        aria-hidden="true"></span>
                    <?php esc_html_e("Send Invite", "enhanced-e-commerce-for-woocommerce-store"); ?>
                </button>

                <button id="ads-continue-close"
                    class="btn btn-secondary m-auto text-white d-none after-ads-acc-creation" data-bs-dismiss="modal">
...
<div class="modal fade" id="conv_modal_create_popup" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer border-0 pb-4 mb-1">
                <a href="<?php echo esc_url($dashboard_url) . '&returnFrom=campaignManagement'?>"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo esc_url('admin.php?page=conversios&returnFrom=campaignManagement'); ?>"
...
jQuery(function() {
    ...
    jQuery(document).on('click', '#submitCampaign', function() {
        ...
        let arrValidate = ['campaignName', 'daily_budget', 'target_country_campaign', 'start_date',
            'end_date'
        ];
        let hasError = false;
        jQuery.each(arrValidate, function(i, v) {
            ...
            if (v == 'target_country_campaign' && jQuery('select[name="' + v +
                    '"] option:selected').val() == '') {
        ...
        if (subscriptionId == '' || google_merchant_center_id == '' || google_ads_id == '' ||
            store_id == '') {
            let missingVal = '';
            if (subscriptionId == '')
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                if (response.error == true) {
                    ...
                    jQuery('#conv_create_popup_txt_msg').html(
        ...
        success: function(response) {
            if (response.data.length > 0) {
                ...
                response.data.forEach(value => {
                    ...
                    tableData += '<tr>';
                    tableData +=
                        '<td class="text-grey fs-12 fw-normal text-start"><input class="form-check-input check-height fs-14 feedId" type="checkbox" value="' +
                        value.id + '" id="" name="feedId" ' + disabled + '>  &nbsp;' + value
                        .feed_name + '</td>';
                    tableData += '<td class="text-grey fs-12 fw-normal text-end">' + value
                        .total_product + '</td>';
                    tableData +=
                        '<td class="text-grey fs-12 fw-normal text-center"><div class="badgebox ' +
                        value.status.replace(/\s/g, "") + '" >' + value.status + '</div></td>';
                    tableData += '</tr>';
                });
                ...
                jQuery('.checkFeedListButton').html('<a href="' + response.href +
                    '" class="btn btn-primary px-5 ms-3 fs-14">Create Feed</a>');
                var button;
            }
                ...
                if (response.data.length == 0) {
                    ...
                    if (response.data.length > 0) {
                        ...
                        if (new_ads_id != "" && new_ads_id != undefined) {
                            AccOptions = AccOptions + '<option value="' + new_ads_id + '" selected>' +
                                new_ads_id + '</option>';
                        }
                        response?.data.forEach(function(item) {
                            var selected = item == selectedValue && new_ads_id == "" ? 'selected' :
                                '';
                            AccOptions = AccOptions + '<option value="' + item + '" ' + selected +
                                '>' + item + '</option>';
                        });

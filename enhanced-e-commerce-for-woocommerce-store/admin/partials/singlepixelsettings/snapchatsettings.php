                    ...
                    <div class="col-7">
                        <label class="d-flex fw-normal mb-1 text-dark">
                            ...
                            <span class="material-symbols-outlined text-secondary md-18 ps-2" data-bs-toggle="tooltip"
                                ...
                                title="The Snapchat Ads pixel ID looks like. 12e1ec0a-90aa-4267-b1a0-182c455711e9">
                                info
                            </span>
                        </label>
                        <input type="text" name="snapchat_ads_pixel_id" id="snapchat_ads_pixel_id"
                            class="form-control valtoshow_inpopup_this"
                            value="<?php echo esc_attr($snapchat_ads_pixel_id); ?>"
                            placeholder="e.g. 12e1ec0a-90aa-4267-b1a0-182c455711e9">
                    </div>
                </div>
            </div>
            <!-- Snapchat Pixel End-->

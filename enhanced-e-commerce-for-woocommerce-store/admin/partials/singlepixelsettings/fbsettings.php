                    ...
                    <div class="col-7">
                        <label class="d-flex fw-normal mb-1 text-dark">
                            ...
                            <span class="material-symbols-outlined text-secondary md-18 ps-2" data-bs-toggle="tooltip"
                                data-bs-placement="top" title="The Facebook pixel ID looks like. 518896233175751">
                                info
                            </span>
                        </label>
                        <input type="text" name="fb_pixel_id" id="fb_pixel_id"
                            class="form-control valtoshow_inpopup_this" value="<?php echo esc_attr($fb_pixel_id); ?>"
                            placeholder="e.g. 518896233175751">
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="conv_highlightedcard">
                            <div class="d-flex pt-2 align-items-top">
                                <ul class="px-2">
                                    <li><b><?php esc_html_e("Enhance", "enhanced-e-commerce-for-woocommerce-store"); ?></b>&nbsp;<?php esc_html_e("event match quality.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                                    </li>
                                    <li><b><?php esc_html_e("Improve", "enhanced-e-commerce-for-woocommerce-store"); ?></b>&nbsp;<?php esc_html_e("data accuracy and reliability.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                                    </li>
                                    <li><b><?php esc_html_e("Ensure", "enhanced-e-commerce-for-woocommerce-store"); ?></b>&nbsp;<?php esc_html_e("better user privacy and compliance.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                                    </li>
                                    <li><b><?php esc_html_e("Boost", "enhanced-e-commerce-for-woocommerce-store"); ?></b>&nbsp;<?php esc_html_e("ads performance and attribution.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                                    </li>
                                </ul>

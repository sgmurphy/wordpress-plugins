...
<div class="convcard p-4 mt-0 rounded-3 shadow-sm">
    ...
    <form id="gasettings_form" class="convpixsetting-inner-box mt-4">
        ...
        <div>
            ...
            <div id="analytics_box_GA4" class="py-1">
                ...
                <div class="row pt-1 conv-hideme-gasettings">
                    ...
                    <div class="col-2 d-flex align-items-end">
                        <button type="button"
                            class="btn btn-sm d-flex conv-enable-selection conv-link-blue align-items-center">
            ...
            ?>
            <div id="ga4apisecret_box"
                class="py-3 <?php echo $tracking_option === 'UA' || !CONV_IS_WC ? 'd-none' : ''; ?>">
                <div class="row pt-2">
                    <div class="col-12">
                        ...
                        <input readonly type="text" name="ga4_api_secret" id="ga4_api_secret"
                            class="form-control disabled" value="<?php echo esc_attr($ga4_api_secret); ?>"
                            placeholder="e.g. CnTrpcbsStWFU5-TmSuhuS">
                    </div>

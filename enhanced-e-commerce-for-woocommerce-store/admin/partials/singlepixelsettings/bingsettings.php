            ...
            <div id="msbing_box" class="py-1">
                ...
                <div class="hideme_msbingconversios disabled" id="checkboxes_box" class="pt-2">
                    ...
                    <div class="d-flex pt-2 align-items-center">
                        <input class="form-check-input convchkbox_setting" type="checkbox"
                            value="<?php echo esc_attr($msbing_conversion); ?>" id="msbing_conversion"
                            name="msbing_conversion"
                            <?php echo (esc_attr($msbing_conversion) == 1) ? 'checked="checked"' : ''; ?>>

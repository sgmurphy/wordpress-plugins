        ...
        <div class="col-12 col-md-12 col-sm-12">
            <div class="row">
                ...
                <div class="col-4 d-flex justify-content-end">
                    ...
                    ?>
                    <button class="signinWithGoogle btn btn-soft-primary fs-14 me-2 campaignClass"
                        title="Select Feed from below to create performance max campaign in Google Ads."
                        style="pointer-events: auto !important" disabled>
                        <?php esc_html_e("Create Campaign", "enhanced-e-commerce-for-woocommerce-store"); ?>
                    </button>
                    <?php } else { ?>
                    <button class="createCampaign btn btn-soft-primary fs-14 me-2 campaignClass"
                        title="Select Feed from below to create performance max campaign in Google Ads."
                        style="pointer-events: auto !important" disabled>
                        <?php esc_html_e("Create Campaign", "enhanced-e-commerce-for-woocommerce-store"); ?>
                    </button>
                ...
                <tr>
                    <th scope="col" class="text-dark text-start">
                        <div class="form-check form-check-custom">
                            <input class="form-check-input checkbox fs-17" type="checkbox" name="selectAll"
            ...
            <tbody id="table-body" class="table-body">
                ...
                <tr class="height">
                    <td class="align-middle text-start">
                        <div class="form-check form-check-custom">
                            <input class="form-check-input checkbox_feed fs-17"
                                <?php echo $value->status == 'Synced' ? '' : 'disabled="disabled"' ?> type="checkbox"
                                name="" id="checkFeed_<?php echo esc_attr($value->id); ?>"
                    ...
                    <td class="align-middle text-center"
                        data-sort='" <?php echo esc_html(strtotime($value->created_date)) ?> "'>
                        <span>
                    ...
                    <td class="align-middle text-center"
                        data-sort='" <?php echo esc_html(strtotime($value->last_sync_date)) ?> "'>
                        <span>
                    ...
                    <td class="align-middle text-center">
                        ...
                        <input type="hidden" class="draftfbImg"
                            value="<?php echo $value->fb_status == 'Draft' ? "<img class='draft-status' src='" . esc_url_raw(ENHANCAD_PLUGIN_URL . "/admin/images/logos/fb_channel_logo.png") . "' />" : '' ?>">
                        <?php }
                                    if ($inprogress !== 0) { ?>
                        ...
                        <input type="hidden" class="inprogressfbImg"
                            value="<?php echo $value->fb_status == 'In Progress' ? "<img class='inprogress-status' src='" . esc_url_raw(ENHANCAD_PLUGIN_URL . "/admin/images/logos/fb_channel_logo.png") . "' />" : '' ?>">
                        <?php }
                                    if ($synced !== 0) { ?>
                        ...
                        <input type="hidden" class="syncedfbImg"
                            value="<?php echo $value->fb_status == 'Synced' ? "<img class='synced-status' src='" . esc_url_raw(ENHANCAD_PLUGIN_URL . "/admin/images/logos/fb_channel_logo.png") . "' />" : '' ?>">
                        <?php }
                                    if ($failed !== 0) { ?>
                        ...
                        <input type="hidden" class="failedfbImg"
                            value="<?php echo $value->fb_status == 'Failed' ? "<img class='failed-status' src='" . esc_url_raw(ENHANCAD_PLUGIN_URL . "/admin/images/logos/fb_channel_logo.png") . "' />" : '' ?>">
                        <?php }
                                } //end if ?>
                    </td>
                ...
                <div class="modal-body ps-4 pt-0">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-7">
                            ...
                            <span>
                                <a target="_blank"
                                    href="https://www.conversios.io/wordpress/product-feed-manager-for-woocommerce-pricing/?utm_source=app_wooPFM&utm_medium=BUSINESS&utm_campaign=Pricing"><b>
                                        Upgrade To Pro</b></a>
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-check-custom">
                            <input class="form-check-input check-height fs-14 errorChannel" type="checkbox"
                                value="<?php printf( esc_html__( '%s', 'enhanced-e-commerce-for-woocommerce-store' ), esc_html( $google_merchant_center_id ) ); ?>"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content ">
            <form id="CampaignForm" onfocus="this.className='focused'">
                <div id="loadingbar_blue_modal_campign" class="progress-materializecss d-none ps-2 pe-2"
                    style="width:98%">
                    <div class="indeterminate"></div>
                </div>
                <div class="modal-header bg-light p-2 ps-4">
                    ...
                    &nbsp; <h5 class="modal-title fs-16">
                        <?php echo $google_ads_id !== '' ? '- Google Ads Id - '.esc_html($google_ads_id) : '' ?></h5>
                    &nbsp;<span class="otherError text-danger"></span>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                        onclick="jQuery('#CampaignForm')[0].reset(); jQuery('.otherError').html('')"></button>
                </div>
                <div class="modal-body ps-4 pt-0">
                    <div class="row"><span><b>Note:</b> Campaign creation will fail if the feeds selected has more than
                            1000 products.</span></div>
                    <div class="mb-4">
                    ...
                    <div class="mb-2 row">
                        <div class="col-6">
                            ...
                            <span class="material-symbols-outlined fs-6" data-bs-toggle="tooltip"
                                data-bs-placement="right" title="Daily Budget for your Campaign">
                                info
                            </span>
                    ...
                    <div class="mb-2 row">
                        <div class="col-6">
                            ...
                            <span class="material-symbols-outlined fs-6" data-bs-toggle="tooltip"
                                data-bs-placement="right" title="Campaign Start Date">
                                info
                            </span><span class="startDateError text-danger"></span>
                            <input type="date" class="form-control fs-14 datepicker hasDatepicker" name="start_date"
                        ...
                        <div class="col-6">
                            ...
                            <span class="material-symbols-outlined fs-6" data-bs-toggle="tooltip"
                                data-bs-placement="right" title="Campaign End Date">
                                info
                            </span><span class="endDateError text-danger"></span>
                            <input type="date" class="form-control fs-14 datepicker hasDatepicker" name="end_date"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer border-0 pb-4 mb-1">
                <button class="btn conv-yellow-bg m-auto text-white dismissErrorModal"
...
<div class="modal fade" id="conv_save_success_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer border-0 pb-4 mb-1 modalFooterSuccess"
...
jQuery(document).on('click', '.createCampaign', function() {
    jQuery('#target_country_campaign').select2({
        dropdownParent: jQuery("#convCampaignModal")
    });
...
jQuery(document).on('click', '#submitCampaign', function() {
    ...
    jQuery.each(arrValidate, function(i, v) {
        ...
        if (v == 'target_country_campaign' && jQuery('select[name="' + v + '"] option:selected')
        .val() == '') {
    ...
    jQuery.ajax({
        ...
        success: function(response) {
            ...
            if (response.error == true) {
                ...
                jQuery('.modalFooterSuccess').html(
                    '<button type="button" class="btn conv-blue-bg text-white gotopmaxlist">Go to PMax list</button><button class="btn conv-blue-bg text-white dismissModal" data-bs-dismiss="modal">Close</button>'
                    )

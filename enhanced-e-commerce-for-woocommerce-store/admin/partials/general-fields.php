    ...
    <div class="row justify-content-center">
      ...
      ?>
            ...
            <div class="alert d-flex align-items-cente p-0" role="alert">
                ...
                <div
                    class="p-2 w-100 rounded-end border border-start-0 shadow-sm conv-notification-alert lh-lg bg-white">
            ...
            <div class="convcard d-flex flex-row p-2 mt-0 rounded-3 shadow-sm">
                <div class="convcard-left conv-pixel-logo">
                    <div class="convcard-logo text-center p-2 pe-3 border-end">
                        <img
                            src="<?php print esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_gtm_logo.png'); ?>" />
                    </div>
                </div>
                    ...
                    <div class="convcard-title">
                        <div class="row">
                            ...
                            <div class="col-md-2 p-0">
                                <span
                                    class="gtm-badge badge rounded-pill conv-badge <?php print (empty($subscription_id) || $tracking_method != "gtm") ? "conv-badge-yellow" : "conv-badge-green"; ?>">
                        ...
                        <div class="d-flex mt-2">
                            <span>
                                ...
                                <a target="_blank" class="conv-link-blue"
                                    ...
                                    <span
                                        class="text fw-bold"><?php esc_html_e("Upgrade to Pro", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                                </a>
                            </span>
                        </div>
                ...
                <div class="convcard-right ms-auto">
                    <a href="<?php print esc_url('admin.php?page=conversios-google-analytics&subpage="gtmsettings"'); ?>"
            ...
            <div class="convo_sst convcard d-flex flex-row  mt-3" data-bs-toggle="modal"
                data-bs-target="#convSsttoProModal">
                <div class="convcard-left conv-pixel-logo">
                    <div class="convcard-logo text-center">
                        <img
                            src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_sstgtm_logo.svg'); ?>" />
                    </div>
                </div>
                <div class="convcard-center ">
                    <div class="convcard-title">
                        ...
                        <p>
                            ...
                            <span><img src=""
                                    alt=""><?php esc_html_e("Click Here", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                        </p>
                    </div>
                </div>

                <div class="convcard-right ms-auto">
                    <a href="" class=" rounded-end d-flex justify-content-center convcard-right-arrow link-dark"
                        data-bs-toggle="modal" data-bs-target="#convSsttoProModal">
                        <span class="material-symbols-outlined align-self-center">chevron_right</span>
                    </a>
                </div>
            </div>
      ...
      ?>
            ...
            <div id="conv_pixel_list_box" class="shadow-sm">
                ...
                <!-- Google analytics  -->
                <div
                    class="convcard conv-pixel-list-item d-flex flex-row p-2 mt-4 rounded-top <?php echo esc_attr($conv_gtm_not_connected); ?>">

                    <div class="p-2 pe-3 conv-pixel-logo border-end d-flex">
                        <img class="align-self-center"
                            src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_ganalytics_logo.png'); ?>" />
                    </div>
                    ...
                    <div class="p-1 ps-3 align-self-center">
                        ...
                        <div class="d-flex pt-2">
                            ...
                            <span
                                class="<?php echo (isset($data['ga_id']) && $data['ga_id'] != '') ? 'border-start ps-2  ms-2' : 'm-0'; ?> ">
                    ...
                    <div class="ms-auto d-flex">
                        <?php if ((empty($pixel_not_connected['ga_id']) || empty($pixel_not_connected['gm_id'])) && $conv_gtm_not_connected == "conv-gtm-connected") { ?>
                        <span
                            class="badge rounded-pill conv-badge conv-badge-green m-0 me-3 align-self-center">Connected</span>
                        <?php } else { ?>
                        <span class="badge rounded-pill conv-badge conv-badge-red m-0 me-3 align-self-center">Not
                            Connected</span>
                        <?php } ?>
                        <a href="<?php echo esc_url('admin.php?page=conversios-google-analytics&subpage="gasettings"'); ?>"
                ...
                <!-- Google Ads -->
                <div
                    class="convcard conv-pixel-list-item d-flex flex-row p-2 mt-0 border-top <?php echo esc_attr($conv_gtm_not_connected); ?>">
                    <div class="p-2 pe-3 conv-pixel-logo border-end d-flex">
                        <img class="align-self-center"
                ...
                <div
                    ...
                    <div class="ms-auto d-flex">
                        ...
                        <span class="badge rounded-pill conv-badge conv-badge-red m-0 me-3 align-self-center">Not
                            Connected</span>
                        <?php } ?>
                        <a href="<?php echo esc_url('admin.php?page=conversios-google-analytics&subpage="fbsettings"'); ?>"
                            class="rounded-end convcard-right-arrow align-self-center link-dark">
                            <span class="material-symbols-outlined p-2">chevron_right</span>
                        </a>
                    </div>
                ...
                <div
                    ...
                    <div class="p-2 pe-3 conv-pixel-logo border-end d-flex">
                        <img class="align-self-center"
                            src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_bing_logo.png'); ?>" />
                    </div>
                    ...
                    <div class="p-1 ps-3 align-self-center">
                        <span class="fw-bold m-0">
                            ...
                            <a target="_blank" class="conv-link-blue conv-watch-video ps-2 fw-normal invisible"
                                href="<?php echo esc_url($pixel_video_link['microsoft_ads_pixel_id']); ?>">
                                <span class="material-symbols-outlined align-text-bottom">play_circle_outline</span>
                                <?php esc_html_e("Watch here", "enhanced-e-commerce-for-woocommerce-store"); ?>
                            </a>
                        </span>
                ...
                ?>
                    ...
                    <div class="ms-auto d-flex">
                        ...
                        <span class="badge rounded-pill conv-badge conv-badge-red m-0 me-3 align-self-center">Not
                            Connected</span>
                        <?php } ?>
                        <a href="<?php echo esc_url('admin.php?page=conversios-google-analytics&subpage="bingsettings"'); ?>"
                            class="rounded-end convcard-right-arrow align-self-center link-dark">
                            <span class="material-symbols-outlined p-2">chevron_right</span>
                        </a>
                    </div>
                ...
                <div
                    ...
                    <div class="p-2 pe-3 conv-pixel-logo border-end d-flex">
                        <img class="align-self-center"
                            src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_pint_logo.png'); ?>" />
                    </div>
                    ...
                    <div class="p-1 ps-3 align-self-center">
                        <span class="fw-bold m-0">
                            ...
                            <a target="_blank" class="conv-link-blue conv-watch-video ps-2 fw-normal invisible"
                                href="<?php echo esc_url($pixel_video_link['pinterest_ads_pixel_id']); ?>">
                                <span class="material-symbols-outlined align-text-bottom">play_circle_outline</span>
                                <?php esc_html_e("Watch here", "enhanced-e-commerce-for-woocommerce-store"); ?>
                            </a>
                        </span>
                    ...
                    <div class="ms-auto d-flex">
                        ...
                        <span class="badge rounded-pill conv-badge conv-badge-red m-0 me-3 align-self-center">Not
                            Connected</span>
                        <?php } ?>
                        <a href="<?php echo esc_url('admin.php?page=conversios-google-analytics&subpage="pintrestsettings"'); ?>"
                            class="rounded-end convcard-right-arrow align-self-center link-dark">
                            <span class="material-symbols-outlined p-2">chevron_right</span>
                        </a>
                    </div>
                ...
                <div
                    ...
                    <div class="p-2 pe-3 conv-pixel-logo border-end d-flex">
                        <img class="align-self-center"
                            src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_snap_logo.png'); ?>" />
                    </div>
                    ...
                    <div class="p-1 ps-3 align-self-center">
                        <span class="fw-bold m-0">
                            ...
                            <a target="_blank" class="conv-link-blue conv-watch-video ps-2 fw-normal invisible"
                                href="<?php echo esc_url($pixel_video_link['snapchat_ads_pixel_id']); ?>">
                                <span class="material-symbols-outlined align-text-bottom">play_circle_outline</span>
                                <?php esc_html_e("Watch here", "enhanced-e-commerce-for-woocommerce-store"); ?>
                            </a>
                        </span>
                    ...
                    <div class="ms-auto d-flex">
                        ...
                        <span class="badge rounded-pill conv-badge conv-badge-red m-0 me-3 align-self-center">Not
                            Connected</span>
                        <?php } ?>
                        <a href="<?php echo esc_url('admin.php?page=conversios-google-analytics&subpage="snapchatsettings"'); ?>"
                            class="rounded-end convcard-right-arrow align-self-center link-dark">
                            <span class="material-symbols-outlined p-2">chevron_right</span>
                        </a>
                    </div>
                ...
                <div
                    ...
                    <div class="p-1 ps-3 align-self-center">
                        <span class="fw-bold m-0">
                            ...
                            <a target="_blank" class="conv-link-blue conv-watch-video ps-2 fw-normal invisible"
                                href="<?php echo esc_url($pixel_video_link['tiKtok_ads_pixel_id']); ?>">
                                <span class="material-symbols-outlined align-text-bottom">play_circle_outline</span>
                                <?php esc_html_e("Watch here", "enhanced-e-commerce-for-woocommerce-store"); ?>
                            </a>
                        </span>
                    ...
                    <div class="ms-auto d-flex">
                        ...
                        <span class="badge rounded-pill conv-badge conv-badge-red m-0 me-3 align-self-center">Not
                            Connected</span>
                        <?php } ?>
                        <a href="<?php echo esc_url('admin.php?page=conversios-google-analytics&subpage="tiktoksettings"'); ?>"
                            class="rounded-end convcard-right-arrow align-self-center link-dark">
                            <span class="material-symbols-outlined p-2">chevron_right</span>
                        </a>
                    </div>
                ...
                <div
                    ...
                    <div class="p-2 pe-3 conv-pixel-logo border-end d-flex">
                        <img class="align-self-center"
                            src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_twitter_logo.png'); ?>" />
                    </div>
                    ...
                    <div class="ms-auto d-flex">
                        ...
                        <span class="badge rounded-pill conv-badge conv-badge-red m-0 me-3 align-self-center">Not
                            Connected</span>
                        <?php } ?>
                        <a href="<?php echo esc_url('admin.php?page=conversios-google-analytics&subpage="twittersettings"'); ?>"
                            class="rounded-end convcard-right-arrow align-self-center link-dark">
                            <span class="material-symbols-outlined p-2">chevron_right</span>
                        </a>
                    </div>
                ...
                <div
                    ...
                    <div class="p-2 pe-3 conv-pixel-logo border-end d-flex">
                        <img class="align-self-center"
                            src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_hotjar_logo.png'); ?>" />
                    </div>
                    ...
                    <div class="ms-auto d-flex">
                        ...
                        <span class="badge rounded-pill conv-badge conv-badge-red m-0 me-3 align-self-center">Not
                            Connected</span>
                        <?php } ?>
                        <a href="<?php echo esc_url('admin.php?page=conversios-google-analytics&subpage="hotjarsettings"'); ?>"
                            class="rounded-end convcard-right-arrow align-self-center link-dark">
                            <span class="material-symbols-outlined p-2">chevron_right</span>
                        </a>
                    </div>
                ...
                <div
                    ...
                    <div class="p-2 pe-3 conv-pixel-logo border-end d-flex">
                        <img class="align-self-center"
                            src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_crazyegg_logo.png'); ?>" />
                    </div>
                    ...
                    <div class="p-1 ps-3 align-self-center">
                        <span class="fw-bold m-0">
                            ...
                            <a target="_blank" class="conv-link-blue conv-watch-video ps-2 fw-normal invisible"
                                href="<?php echo esc_url($pixel_video_link['crazyegg_pixel_id']); ?>">
                                <span class="material-symbols-outlined align-text-bottom">play_circle_outline</span>
                                <?php esc_html_e("Watch here", "enhanced-e-commerce-for-woocommerce-store"); ?>
                            </a>
                        </span>
                    ...
                    <div class="ms-auto d-flex">
                        ...
                        <span class="badge rounded-pill conv-badge conv-badge-red m-0 me-3 align-self-center">Not
                            Connected</span>
                        <?php } ?>
                        <a href="<?php echo esc_url('admin.php?page=conversios-google-analytics&subpage="crazyeggsettings"'); ?>"
                            class="rounded-end convcard-right-arrow align-self-center link-dark">
                            <span class="material-symbols-outlined p-2">chevron_right</span>
                        </a>
                    </div>
            ...
            <!-- Advanced option -->
            <div
                class="convcard conv-pixel-list-item rounded d-flex flex-row p-2 mt-1 <?php echo esc_attr($conv_gtm_not_connected); ?>">
                <div class="p-2 pe-3 conv-pixel-logo border-end d-flex">
                    <img class="align-self-center"
                        src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_event_track_custom.png'); ?>" />
                </div>
                ...
                <div class="p-1 ps-3 align-self-center">
                    <span class="fw-bold">
                        ...
                        <a target="_blank" class="conv-link-blue conv-watch-video ps-2 fw-normal invisible"
                            href="<?php echo esc_url("https://" . TVC_AUTH_CONNECT_URL . "/help-center/event-tracking-custom-integration.pdf"); ?>">
                ...
                <div class="ms-auto d-flex">
                    <a href="<?php echo esc_url('admin.php?page=conversios-google-analytics&subpage="customintgrationssettings"'); ?>"
                        class="rounded-end convcard-right-arrow align-self-center link-dark">
                        <span class="material-symbols-outlined p-2">chevron_right</span>
                    </a>
                </div>
                ...
                <div class="convcard-blue-left align-self-center p-2 bd-highlight">
                    ...
                    <span class="d-flex">
                        <a style="padding:8px 24px 8px 24px;" class="btn conv-yellow-bg mt-4 btn-lg"
                            href="<?php print esc_url($TVC_Admin_Helper->get_conv_pro_link_adv("banner", "pixel_list", "", "linkonly")); ?>"
                            target="_blank">Upgrade Now</a>
                    </span>
                </div>
                <div class="convcard-blue-right align-self-center p-2 bd-highlight mx-auto">
                    <img
                        src="<?php print esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/logos/freetopaid_banner_img.png'); ?>" />
                </div>
            </div>
...
<div class="modal fade upgradetosstmodal" id="convSsttoProModal" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <h2><?php esc_html_e("Unlock The benefits of", "enhanced-e-commerce-for-woocommerce-store"); ?> <br>
                <span><?php esc_html_e("Server Side Tagging Via GTM", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
            </h2>
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12">
                    <ul class="listing">
                        <span><?php esc_html_e("Benefits", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                        <li><?php esc_html_e("Adopt To First Party Cookies", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </li>
                        <li><?php esc_html_e("Improve Data Accuracy & Reduced Ad Blocker Impact", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </li>
                        <li><?php esc_html_e("Faster Page Speed", "enhanced-e-commerce-for-woocommerce-store"); ?></li>
                        <li><?php esc_html_e("Enhanced Data Privacy & Security", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-6 col-md-12 col-12">
                    <ul class="listing">
                        ...
                        <li><?php esc_html_e("Server Side Tagging Via GTM", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </li>
                        <li><?php esc_html_e("Powerful Google Cloud Servers", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </li>
                        <li><?php esc_html_e("Custom Loader & Custom Domain Mapping", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </li>
                        <li><?php esc_html_e("Server Side Tagging For Google Analytics 4 (GA4), Google Ads, Facebook CAPI, Tiktok Events API & Snapchat CAPI", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </li>
                        <li><?php esc_html_e("Free Setup & Audit By Dedicated Customer Success Manager", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </li>
                    </ul>
                </div>
                <div class="col-12">
                    <div class="discount-btn">
                        <a target="_blank"
                            href="<?php echo esc_url('https://www.conversios.io/wordpress/all-in-one-google-analytics-pixels-and-product-feed-manager-for-woocommerce-pricing/?utm_source=in_app&utm_medium=modal_popup&utm_campaign=sstpopup'); ?>"

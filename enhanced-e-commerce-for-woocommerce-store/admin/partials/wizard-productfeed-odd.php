    ...
    <div class="row">
        ...
        <div class="mx-auto convcard p-0 mt-0 rounded-3 shadow-lg" style="max-width:903px">
            <ul class="nav nav-tabs border-0 p-3 pb-0" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="d-inline-flex align-items-center pawizard_tab_but border-0 nav-link ps-0" id="category-tab" data-bs-toggle="tab" data-bs-target="#category" type="button" role="tab" aria-controls="category" aria-selected="false">
                        <span class="material-symbols-outlined product-category float-start mt-1 text-warning">
                        history_toggle_off
                        </span>    
                        <h5 class="text-start m-0 ps-1 mt-1"><?php esc_html_e("Category Mapping", "enhanced-e-commerce-for-woocommerce-store"); ?></h5>
                    </button>
                </li>
                <li class="nav-item" role="presentation">                    
                    <button class="d-inline-flex align-items-center pawizard_tab_but border-0 nav-link ps-0" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">
                ...
                <li class="nav-item" role="presentation">                    
                    <button class="d-inline-flex align-items-center pawizard_tab_but border-0 nav-link ps-0" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">
            ...
            <div class="tab-content p-3 pt-0" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">    
                    <span class="channel_notice d-none bg-warnings" style="width:100%; height: auto; display: block">
                        <img src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/logos/attention_logo.png'); ?>">
                        <span class="text-dark">Attention - Please Note That, If You Change Email or Channel Id, It Will Affect The Previous Feed!!!</span>
                    </span>                
                    <div class="convcard p-4 mt-0 rounded-3 shadow-sm">                        
                        ...
                        ?>
                        <img  src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_fb_logo.png'); ?>">
                        <span class="span-text"><?php esc_html_e("Facebook Catalog", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                        <div class="mt-2">
                            <span class="fs-12 fw-normal text-grey">
                            ...
                            <div class="card-body">
                                <div class="progress-wholebox">
                                    <ul class="progress-steps">
                                        ...
                                        <li class="fb-business-step <?php echo ($fb_business_id) ? "" : "disable"; ?>" style="min-height:120px;">
                                            <div class="step-box">
                                                <div class="row">
                                                    <div class="col-5">
                                                        <span class="inner-text"><?php esc_html_e("Facebook Business ID", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                                                        <div class="col-12">
                                                            <select id="fb_business_id" name="fb_business_id"
                                                                class="form-select selectfour" disabled style="width: 100%">
                                                                <option value="">Select Facebook Business Id</option>                                              
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-5">
                                                        <span class="inner-text"><?php esc_html_e("Facebook Catalog ID", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                                                        <div class="col-12">
                                                            <select id="fb_catalog_id" name="fb_catalog_id"
                                                                class="form-select selectfive" disabled style="width: 100%">
                ...
                <div class="tab-pane fade" id="category" role="tabpanel" aria-labelledby="category-tab">
                    ...
                    <div class="convcard p-4 mt-0 rounded-3 shadow-sm">
                        <span class="span-text"><?php esc_html_e("Category Mapping for Products", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                        <div class="mt-2">
                            <p class="fs-12 fw-normal text-grey"><?php esc_html_e("Correctly mapping your products to the appropriate category enhances their relevance to customers, potentially leading to improved conversion rates and boosted sales.", "enhanced-e-commerce-for-woocommerce-store"); ?></p>
                            <p class="fs-12 fw-normal text-grey"><?php esc_html_e("Map your Woocommerce product category against Conversios product category and we will make sure they are rightly synced in google merchant center and/or tiktok.", "enhanced-e-commerce-for-woocommerce-store"); ?></p>
                        </div>
                        <div class="categoryDiv">                        
                            ...
                            <div class="col-12 row bg-white m-0 p-0 mb-3">
                                <div class="col-12 row categoryDiv" style="overflow-y: scroll;overflow-x: hidden; max-height:600px; position: relative;">
                        ...
                        <div class="tab_bottom_buttons d-flex align-items-center mt-1"> 
                            ...
                            <div class="ms-auto d-flex align-items-center"> 
                                <div class="align-self-baseline text-grey fs-14 goToattribute ms-3 mt-1" style="border-bottom: 1px dashed; cursor: pointer">
                                    <?php esc_html_e('Skip To Next', "enhanced-e-commerce-for-woocommerce-store"); ?>
                                </div>                               
                                <button id="category_mapping_save" type="button" class="category_mapping_save btn btn-primary px-5 ms-3 fs-14">
                                    <span class="spinner-border text-light spinner-border-sm d-none" role="status" aria-hidden="true"></span>
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <div class="convcard p-4 mt-0 rounded-3 shadow-sm">
                        ...
                        <div class="mt-2">
                            ...
                            <p class="fs-12 fw-normal text-grey"><?php esc_html_e("Map your Woocommerce product attributes against Conversios product attributes and we will make sure they are rightly synced in google merchant center, Facebook and/or tiktok.", "enhanced-e-commerce-for-woocommerce-store"); ?></p>
                        </div>
                        <div class="attrDiv">                        
                    ...
                    <div class="convcard p-4 mt-0 rounded-3 shadow-sm">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-6">
                                ...
                                <span class="conv-link-blue ms-2 fw-bold-500 upgradetopro_badge fs-16" data-bs-toggle="modal" data-bs-target="#upgradetopromodal">
    ...
    jQuery(function () {         
       ...
       <?php  } ?>
        ...
        jQuery(document).on('click', '#createFeed', function() {
            ...
            if(product_selection !== 'specific_product' && (totalProduct > 100 || (totalProduct + syncProductCount) > 100)){
        ...
        jQuery.ajax({
            ...
            success: function (response) { 
                ...
                if(response.isAttrMapped == 1 && response.is_channel_connected == 1 && get == '' && channel == '') {
                    jQuery('[data-bs-target="#contact"]').trigger('click')
                } else if(response.isAttrMapped == 0 && response.is_channel_connected == 1 && get == '' && channel == '') {
                    jQuery('[data-bs-target="#profile"]').trigger('click')
                }  else if(get == '' && channel == "") {
                    list_tiktok_business_account(); 
                    get_facebook_bussiness()  

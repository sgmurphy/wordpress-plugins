...
<div class="container container-old conv-container conv-setting-container">
    <div class="row">
        <div class="mx-auto d-flex justify-content-end" style="max-width: 930px;">
            <div class="text-dark m-4 h6 d-flex align-items-center convexitwizard pointer" data-bs-toggle="modal"
                data-bs-target="#exitwizardconvmodal">
        ...
        <div class="mx-auto convcard p-0 mt-0 rounded-3 shadow-lg" style="max-width:1072px">
            <ul class="nav nav-tabs border-0 p-3 pb-0" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="d-inline-flex align-items-center pawizard_tab_but border-0 nav-link active ps-0"
                        id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab"
                        aria-controls="home" aria-selected="true">
                        <span
                            class="material-symbols-outlined add-channel mt-1 float-start <?php echo $is_channel_connected ? 'text-success' : 'text-warning'?>">
                            <?php echo $is_channel_connected ? 'check_circle' : 'history_toggle_off' ?>
                        </span>
                        <h5 class="text-start m-0 ps-1 mt-1">
                            <?php esc_html_e("Channel Configuration", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </h5>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="d-inline-flex align-items-center pawizard_tab_but border-0 nav-link ps-0"
                        id="category-tab" data-bs-toggle="tab" data-bs-target="#category" type="button" role="tab"
                        aria-controls="category" aria-selected="false">
                        <span class="material-symbols-outlined product-category float-start mt-1 text-warning">
                            history_toggle_off
                        </span>
                        <h5 class="text-start m-0 ps-1 mt-1">
                            <?php esc_html_e("Category Mapping", "enhanced-e-commerce-for-woocommerce-store"); ?></h5>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="d-inline-flex align-items-center pawizard_tab_but border-0 nav-link ps-0"
                        ...
                        <h5 class="text-start m-0 ps-1 mt-1">
                            <?php esc_html_e("Product Attribute Mapping", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </h5>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="d-inline-flex align-items-center pawizard_tab_but border-0 nav-link ps-0"
                        ...
                        <h5 class="text-start m-0 ps-1 mt-1">
                            <?php esc_html_e("Create Product Feed", "enhanced-e-commerce-for-woocommerce-store"); ?>
                        </h5>
                    </button>
                </li>
            </ul>
            <div class="tab-content p-3 pt-0" id="myTabContent">
                <div class="progress">
                    <div class="progress-bar w-<?php echo esc_attr($pixelprogressbarclass) ?>" role="progressbar"
                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <span class="channel_notice d-none bg-warnings" style="width:100%; height: auto; display: block">
                        <img
                            src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/logos/attention_logo.png'); ?>">
                        <span class="text-dark">Attention - Please Note That, If You Change Email or Channel Id, It Will
                            Affect The Previous Feed!!!</span>
                    </span>
                    <div class="convcard p-4 mt-0 rounded-3 shadow-sm">
                        <?php require_once("wizardsettings/gmcsettings.php"); ?>

                        <div id="tiktokSetting_loader" class="progress-materializecss d-none ps-2 pe-2"
                            style="width:100%;">
                        ...
                        <span
                            class="span-text"><?php esc_html_e("TikTok Business Account", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                        <div class="mt-2">
                            ...
                            <div class="card-body">
                                <div class="progress-wholebox">
                                    <ul class="progress-steps">
                                        <li class="<?php echo ($tiktok_mail && $tiktok_user_id) ? "" : "disable"; ?>"
                                            ...
                                            <div class="step-box">
                                                <div style="padding-top: 8px">
                                                    ...
                                                    <a onclick='window.open("<?php echo esc_url($tiktok_auth_url) ?>","MyWindow","width=800,height=700,left=300, top=150"); return false;'
                                                        href="#" class="signIn">
                                                        <button class="btn btn-outline-dark" id=""><img
                                                                style="width:19px"
                                                                src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_tiktok_logo.png'); ?>">
                                                            &nbsp;Continue with TikTok</button>
                                                    </a>
                                                    <p class="mt-2" style="font-size: 10px;">Please login to the Email
                                                        account linked to your TikTok Business account so that we can
                                                        get you business accounts and catalogs and use Chrome for best
                                                        experience.</p>
                                                    ...
                                                    <?php } ?>
                                                    <input type="hidden" id="tiktok_mail"
                                                        value="<?php echo esc_attr($tiktok_mail) ?>">
                                                    <input type="hidden" id="tiktok_user_id"
                                                        value="<?php echo esc_attr($tiktok_user_id) ?>">
                                                </div>
                                            </div>
                                        </li>
                                        <li class="tiktok-step <?php echo ($tiktok_business_id) ? "" : "disable"; ?>"
                                            style="min-height:120px;">
                                            <div class="step-box">
                                                <span
                                                    class="inner-text"><?php esc_html_e("TikTok Business Account ID", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                                                <div class="row">
                                                    <div class="col-6">
                                                        <select id="tiktok_business_id" name="tiktok_business_id"
                                                            class="form-select selectthree" disabled
                                                            style="width: 100%">
                                                    ...
                                                    <div class="col-4" style="padding-top: 10px;padding-left:0px">
                                                        ...
                                                        <span class="fs-14 text-primary pointer gettitokList"><span
                                                                class="material-symbols-outlined md-18">edit</span>Edit</span>
                                                        <?php } ?>
                                                    </div>
                                                    <span class="fs-12 fw-normal text-grey">
                                            ...
                                            <input type="hidden" name="tiktok_business_id-value"
                                                id="tiktok_business_id-value"
                                                value="<?php echo esc_attr($tiktok_business_id) ?>">
                                        </li>
                                        <li class="tiktok-catalog-step <?php echo (is_array($catalogData) && !empty($catalogData)) ? "" : "disable"; ?>"
                                            style="min-height:68px;">
                                            <div class="step-box">
                                                ...
                                                <div class="row pt-2">
                                                    <div class="col-12">
                                                        <table class="table table-bordered" id="map_catalog_table"
                                                            style="width:100%">
                                                            <thead>
                                                                <tr class="">
                        ...
                        <div id="fbSetting_loader" class="progress-materializecss d-none ps-2 pe-2" style="width:100%;">
                            <div class="indeterminate"></div>
                        </div>
                        <div class="fbSetting_hr border-top mb-3"></div>
                        <?php  
                        ...
                        ?>
                        <img
                            src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_fb_logo.png'); ?>">
                        <span
                            class="span-text"><?php esc_html_e("Facebook Catalog", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                        <div class="mt-2">
                            <span class="fs-12 fw-normal text-grey">
                                <!-- <?php //esc_html_e("Facebook catalog feed management is in Beta currently. Reach out to info@conversios.io to get the free early access to the feature.", "enhanced-e-commerce-for-woocommerce-store"); ?> -->
                            </span>
                        </div>
                        <div class="product-feed">
                            <div class="card-body">
                                <div class="progress-wholebox">
                                    <ul class="progress-steps">
                                        <li class="<?php echo ($fb_mail) ? "" : "disable"; ?>" style="min-height:68px;">
                                            <div class="step-box">
                                                <div style="padding-top: 3px">
                                                    <span class="fs-14 fw-normal text-grey">
                                                        <?php echo esc_html($fb_mail) ?>
                                                        <span class="conv-link-blue ps-2 facebookLogin"
                                                            id="facebookLogin">
                                                            <a onclick="window.open('<?php echo esc_url($facebook_auth_url) ?>','MyWindow','width=800,height=700,left=300, top=150'); return false;"
                                                                href="#" style="color:#1967D2">
                                                                <?php echo $signIn; ?>
                                                            </a>
                                                        </span>
                                                        <input type="hidden" id="fb_mail"
                                                            value="<?php echo esc_attr($fb_mail) ?>" />
                                                    </span>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="fb-business-step <?php echo ($fb_business_id) ? "" : "disable"; ?>"
                                            style="min-height:120px;">
                                            <div class="step-box">
                                                <div class="row">
                                                    <div class="col-5">
                                                        <span
                                                            class="inner-text"><?php esc_html_e("Facebook Business ID", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                                                        <div class="col-12">
                                                            <select id="fb_business_id" name="fb_business_id"
                                                                class="form-select selectfour" disabled
                                                                style="width: 100%">
                                                    ...
                                                    <div class="col-5">
                                                        <span
                                                            class="inner-text"><?php esc_html_e("Facebook Catalog ID", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                                                        <div class="col-12">
                                                            <select id="fb_catalog_id" name="fb_catalog_id"
                                                                class="form-select selectfive" disabled
                                                                style="width: 100%">
                                                                <option value="">Select Facebook Catalog</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-2" style="padding-top: 35px;padding-left:0px">
                                                        <?php if(esc_html($fb_business_id)) {?>
                                                        <span class="fs-14 text-primary pointer getfbList"><span
                                                                class="material-symbols-outlined md-18">edit</span>Edit</span>
                                                        <?php } ?>
                                                    </div>
                                                </div>
                                                <span class="fs-12 fw-normal text-grey">
                                                    <?php esc_html_e("Choose your Facebook Business account and Facebook Catalog from the dropdown.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                                                </span>
                                            </div>
                                        </li>
                                    </ul>
                                ...
                                <input type="hidden" name="fb_business_id-value" id="fb_business_id-value"
                                    value="<?php echo esc_attr($fb_business_id) ?>">
                                <input type="hidden" name="fb_catalog_id-value" id="fb_catalog_id-value"
                                    value="<?php echo isset($ee_options['facebook_setting']['fb_catalog_id']) ? esc_attr($ee_options['facebook_setting']['fb_catalog_id']) : '' ?> ">
                            </div>
                        </div>
                        <div style="display: flex; justify-content: end">
                            <button class="btn btn-channel-primary fs-14 channelTabSave">Next</button>
                        </div>

                    </div>
                </div>
                <div class="tab-pane fade" id="category" role="tabpanel" aria-labelledby="category-tab">
                    <div id="category_loader" class="progress-materializecss d-none ps-2 pe-2" style="width:100%;">
                        <div class="indeterminate"></div>
                    </div>
                    <div class="convcard p-4 mt-0 rounded-3 shadow-sm">
                        <span
                            class="span-text"><?php esc_html_e("Category Mapping for Products", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                        <div class="mt-2">
                            <p class="fs-12 fw-normal text-grey">
                                <?php esc_html_e("Correctly mapping your products to the appropriate category enhances their relevance to customers, potentially leading to improved conversion rates and boosted sales.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                            </p>
                            <p class="fs-12 fw-normal text-grey">
                                <?php esc_html_e("Map your Woocommerce product category against Conversios product category and we will make sure they are rightly synced in google merchant center and/or tiktok.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                            </p>
                        </div>
                        <div class="categoryDiv">
                            <div class="conv-light-grey-bg mb-2">
                                <div class="row">
                            ...
                            <div class="col-12 row bg-white m-0 p-0 mb-3">
                                <div class="col-12 row categoryDiv"
                                    style="overflow-y: scroll;overflow-x: hidden; max-height:600px; position: relative;">
                        ...
                        <div class="tab_bottom_buttons d-flex align-items-center mt-1">
                            ...
                            <div class="ms-auto d-flex align-items-center">
                                <div class="align-self-baseline text-grey fs-14 goToattribute ms-3 mt-1"
                                    style="border-bottom: 1px dashed; cursor: pointer">
                                    <?php esc_html_e('Skip To Next', "enhanced-e-commerce-for-woocommerce-store"); ?>
                                </div>
                                <button id="category_mapping_save" type="button"
                                    class="category_mapping_save btn btn-primary px-5 ms-3 fs-14">
                                    <span class="spinner-border text-light spinner-border-sm d-none" role="status"
                                        aria-hidden="true"></span>
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <div class="convcard p-4 mt-0 rounded-3 shadow-sm">
                        <span
                            class="span-text"><?php esc_html_e("Attribute Mapping for Products", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                        <div class="mt-2">
                            <p class="fs-12 fw-normal text-grey">
                                <?php esc_html_e("Correctly mapping your products to the appropriate attributes enhances their relevance to customers, potentially leading to improved conversion rates and boosted sales.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                            </p>
                            <p class="fs-12 fw-normal text-grey">
                                <?php esc_html_e("Map your Woocommerce product attributes against Conversios product attributes and we will make sure they are rightly synced in google merchant center, Facebook and/or tiktok.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                            </p>
                        </div>
                        <div class="attrDiv">
                        ...
                        <div class="tab_bottom_buttons d-flex align-items-center mt-1">
                            <div class="gobackwizard d-flex">
                                ...
                                <div class="align-self-baseline text-grey fs-14 goToCategory">
                                    <?php esc_html_e('Go Back', "enhanced-e-commerce-for-woocommerce-store"); ?>
                                </div>
                            </div>
                            <div class="ms-auto d-flex align-items-center">
                                <div class="align-self-baseline text-grey fs-14 goToFeed ms-3 mt-1"
                                    style="border-bottom: 1px dashed; cursor: pointer">
                                    <?php esc_html_e('Skip To Next', "enhanced-e-commerce-for-woocommerce-store"); ?>
                                </div>
                                <button id="attr_mapping_save" type="button"
                                    class="attr_mapping_save btn btn-primary px-5 ms-3 fs-14">
                                    <span class="spinner-border text-light spinner-border-sm d-none" role="status"
                                        aria-hidden="true"></span>
                                    <?php esc_html_e('Save & Next', "enhanced-e-commerce-for-woocommerce-store"); ?>
                                </button>
                ...
                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                    ...
                    <div class="convcard p-4 mt-0 rounded-3 shadow-sm">
                        <span
                            class="span-text"><?php esc_html_e("Create Product Feed", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                        ...
                        <div class="mt-3 col-12">
                            ...
                            <div class="">
                                <div class="form-check form-check-custom">
                                    <input class="form-check-input check-height fs-14 errorChannel" type="checkbox"
                                        value="" id="tiktok_id" name="tiktok_id">
                                    <span for="" class="fs-14 pt-0 text-grey fw-normal">
                        ...
                        <div class="row mt-3">
                            <div class="col-4 row">
                                <div class="col-6 pe-0">
                                    ...
                                    <span class="material-symbols-outlined fs-6 text-grey pointer"
                                ...
                                <div class="col-4 ps-0" style="cursor:none">
                                    <div class="form-check form-switch fs-5">
                                        <input class="form-check-input" type="checkbox" name="autoSync" id="autoSync"
                                            checked>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control-sm" readonly name="autoSyncIntvl"
                                    id="autoSyncIntvl" size="3" min="1" value="25" style="width: 42px"
                                ...
                                <span class="conv-link-blue ms-2 fw-bold-500 upgradetopro_badge fs-16"
                                    data-bs-toggle="modal" data-bs-target="#upgradetopromodal">
                                    <img style="width:14px; max-width:100%; height:auto"
                                        src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/logos/upgrade_badge.png'); ?>" />
                        ...
                        <div class="mt-3">
                            ...
                            <span class="material-symbols-outlined fs-6 text-grey pointer" data-bs-toggle="tooltip"
                                data-bs-placement="right" title="Select your woocommerce product to sync in channels.">
                                info
                            </span>
                            <div class="mt-1">
                                <input type="radio" checked name="product_selection" id="all_product"
                                    value="all_product">
                                ...
                                <div class="totalCountDiv"><span class="text-grey fs-12"><span
                                            class="totalCount"></span> products are ready to sync</span></div>
                            </div>
                            <div class="mt-2">
                            ...
                            <div class="col-12 mt-2 d-none AllFilters">
                                <div class="row">
                                    <div class="col-3 productDiv">
                                        <select class="product createSelect" name="product" style="width: 100%">
                                            <option value="0">
                                                <?php esc_html_e("Select Attribute", "enhanced-e-commerce-for-woocommerce-store"); ?>
                                            </option>
                                            <option value="product_cat">
                                                <?php esc_html_e("Category", "enhanced-e-commerce-for-woocommerce-store"); ?>
                                            </option>
                                            <option value="ID">
                                                <?php esc_html_e("Product Id", "enhanced-e-commerce-for-woocommerce-store"); ?>
                                            </option>
                                            <option value="_stock_status">
                                                <?php esc_html_e("Stock Status", "enhanced-e-commerce-for-woocommerce-store"); ?>
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-3 conditionDiv">
                                        <select class="condition createSelect" name="condition" style="width: 100%">
                                            <option value="0">
                                                <?php esc_html_e("Select Conditions", "enhanced-e-commerce-for-woocommerce-store"); ?>
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="totalCountDivFilter d-none"><span class="text-grey fs-12"><span
                                            class="totalCountFilter"></span> products are ready to sync</span></div>
                                <input type="hidden" id="productVal" value="">
                                <input type="hidden" id="conditionVal" value="">
                                <input type="hidden" id="valueVal" value="">
                                <input type="hidden" name="syncProductCount" id="syncProductCount"
                                    value="<?php echo esc_attr($google_detail_api->data->product_count) ?>">
                            </div>

                            <div class="mt-2">
                                <input type="radio" name="product_selection" id="specific_product"
...
<div id="overlayanimation" class="overlay_loader_conv">
    ...
    <div class="overlay_loader_conv-content loadershow-content d-none">
        <img style="width:8%; height: auto"
            src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/success_check_mark.gif'); ?>">
...
<div class="modal fade" id="conv_modal_create_popup" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer border-0 pb-4 mb-1">
                <a href="<?php echo esc_url($dashboard_url) . '&returnFrom=productFeed'?>"
                    class="btn btn-primary m-auto text-white">Take me to Dashboard</a>
            </div>
        </div>
    </div>
</div>
<!-- Exit Wizard modal -->
<div class="modal fade" id="exitwizardconvmodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body">
                <p class="m-4 text-center h5">
                    <?php esc_html_e("Are you sure you want to exit the setup?", "enhanced-e-commerce-for-woocommerce-store"); ?>
                </p>
            </div>
            <div class="modal-footer">
                ...
                <a href="<?php echo esc_url('admin.php?page=conversios&returnFrom=productFeed'); ?>"
...
<!-- Modal -->
<div class="modal fade" id="upgradetopromodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center p-0">
                <img style="width:184px;height:auto"
...
jQuery(function() {
    ...
    var fb_business_id = "<?php echo esc_attr($fb_business_id) ?>";
    ...
    jQuery('html, body').animate({
        scrollTop: jQuery("#gmcSetting_loader").offset().top
    }, 0);
    <?php } 
        if (isset($_GET['tiktok_mail']) == TRUE) { ?>
    ...
    jQuery('html, body').animate({
        scrollTop: jQuery("#tiktokSetting_loader").offset().top
    }, 0);
    <?php } 
        if (isset($_GET['g_mail']) == TRUE && isset($_GET['wizard_channel']) &&  $_GET['wizard_channel'] == 'fbsetting') { ?>
    ...
    jQuery('html, body').animate({
        scrollTop: jQuery("#fbSetting_loader").offset().top
    }, 0);
    <?php }
        ?>
    if (tiktok_user_id !== '') {
    ...
    <?php if(isset($_GET['wizard_channel']) == false){ ?>
    get_facebook_bussiness()
    <?php  } ?>
    ...
    jQuery(document).on('click', '#home-tab', function() {
        ...
        if (jQuery("select").hasClass('category_mapping_select')) {
            if (jQuery('.category_mapping_select').data('select2')) {
                jQuery(".category_mapping_select").select2('destroy')
            }
        }
        jQuery('.selecttwo').select2();
        jQuery('.selectthree').select2();
    ...
    jQuery(document).on('click', '.goBackAttr', function() {
        ...
        jQuery('html, body').animate({
            scrollTop: jQuery("#attribute_loader").offset().top
        }, 0);
    })
    ...
    jQuery(document).on('click', '.goToattribute', function() {
        jQuery('[data-bs-target="#profile"]').trigger('click')
        jQuery('html, body').animate({
            scrollTop: jQuery("#attribute_loader").offset().top
        }, 0);
    })
    jQuery(document).on('click', '.goToCategory', function() {
        ...
        jQuery('.category_mapping_select').select2()
        jQuery('[data-bs-target="#category"]').trigger('click')
        jQuery('html, body').animate({
            scrollTop: jQuery("#category_loader").offset().top
        }, 0);
    })
    ...
    jQuery(document).on("change", "#fb_business_id", function() {
        jQuery('.selection').find("[aria-labelledby='select2-fb_business_id-container']").removeClass(
            'selectError');
        jQuery('.selection').find("[aria-labelledby='select2-fb_catalog_id-container']").removeClass(
            'selectError');
        get_fb_catalog_data()
    });
    ...
    jQuery(document).on("change", "#google_merchant_center_id", function() {
        jQuery('.selection').find("[aria-labelledby='select2-google_merchant_center_id-container']")
    ...
    jQuery(document).on('click', '.add_additional_attr', function() {
        ...
        jQuery.each(additionalAttribute, function(index, value) {
            ...
            option += '<option value="' + value.field + '" ' + disabled + '>' + value.field +
                '</option>'
        });
        ...
        html += '<select style="width:100%" id="' + cnt++ +
            '" name="additional_attr_[]" class="additinal_attr_' + cnt +
            ' additinal_attr fw-light text-secondary fs-6 form-control form-select-sm select2">';
        html += option;
        html += '</select></div>';
        html += '<div class="col-5 mt-2">';
        html +=
            '<select style="width:100%" id="" name="additional_attr_value_[]" class="additional_attr_value fw-light text-secondary fs-6 form-control form-select-sm select2">';
        html += option1;
        html += '</select></div>';
    ...
    jQuery(document).on('click', '.remove_additional_attr', function() {
        ...
        var deleted = jQuery(this).parent().parent('.additinal_attr_div').find('.additinal_attr').find(
            ':selected').val();
        if (deleted != '') {
    ...
    jQuery(document).on('change', '#id', function() {
        jQuery('.selection').find("[aria-labelledby='select2-id-container']").removeClass(
        'selectError');
    })
    jQuery(document).on('change', '#title', function() {
        jQuery('.selection').find("[aria-labelledby='select2-title-container']").removeClass(
            'selectError');
    })
    jQuery(document).on('change', '#description', function() {
        jQuery('.selection').find("[aria-labelledby='select2-description-container']").removeClass(
            'selectError');
    })
    jQuery(document).on('change', '#price', function() {
        jQuery('.selection').find("[aria-labelledby='select2-price-container']").removeClass(
            'selectError');
    })

    jQuery(document).on("click", "#category_mapping_save", function() {
        let ee_data = jQuery("#category_mapping").find(
        ...
        jQuery.ajax({
            ...
            data: data,
            beforeSend: function() {
                jQuery('#category_mapping_save').prop('disabled', true)
                jQuery('#category_mapping_save > span').removeClass('d-none')
            },
            success: function(response) {
                jQuery('#category_mapping_save').prop('disabled', false)
                jQuery('#category_mapping_save > span').addClass('d-none')
                checkProgressBar();
    ...
    jQuery(document).on("click", "#attr_mapping_save", function() {
        ...
        jQuery.each(attrCheck, function(index, value) {
            if (jQuery("#" + value).find(":selected").val() == '') {
                jQuery('.selection').find("[aria-labelledby='select2-" + value + "-container']")
        ...
        if (changeValue === 'product_cat') {
            ...
            jQuery.ajax({
                ...
                success: function(response) {
                    ...
                    var html =
                        '<select class="createSelect value" name="value" style="width:100%">' +
                        option +
                        '</select>';
    ...
    jQuery(document).on('click', '.applyFilter', function() {
        ...
        if (newProductVal != 0 && newConditionVal != 0 && newValueVal != 0) {
            if (newProductVal !== '' && newConditionVal !== '' && newValueVal !== '') {
                ...
                productVal == "" ? jQuery('#productVal').val(newProductVal) : jQuery('#productVal').val(
                    productVal + "," + newProductVal);
                conditionVal == "" ? jQuery('#conditionVal').val(newConditionVal) : jQuery(
                    '#conditionVal').val(conditionVal + "," + newConditionVal);
                valueVal == "" ? jQuery('#valueVal').val(newValueVal) : jQuery('#valueVal').val(
                    valueVal + "," + newValueVal);
                ...
                var newCard = '<div class="btn-group border rounded mt-1 me-1 removecardThis" >' +
                    '<button class="btn btn-light btn-sm text-secondary fs-7 ps-1 pe-1 pt-0 pb-0" type="button" value="' +
                    count + '">' + newProductVal + ' <b>' + newConditionVal + '</b> ' + newValueVal +
                    '</button>' +
    ...
    jQuery(document).on('click', '#createFeed', function() {
        ...
        if (target_country === "") {
            jQuery('[aria-labelledby="select2-feed_target_country-container"]').css('border',
                '1px solid #ef1717');
            return false;
        }
        ...
        if (product_selection == 'filter_product') {
            ...
            if (productVal == '' || conditionVal == '' || valueVal == '') {
                ...
                jQuery('.condition').next().find('.select2-selection').css('border',
                    '1px solid #ef1717')
        ...
        var totalProduct = parseInt(jQuery('.totalCount').text());
        if (product_selection == 'filter_product') {
            totalProduct = parseInt(jQuery('.totalCountFilter').text());
        }
        let syncProductCount = parseInt(jQuery('#syncProductCount').val());
        if (product_selection !== 'specific_product' && (totalProduct > 100 || (totalProduct +
                syncProductCount) > 100)) {
            jQuery('#conv_save_error_txt').html('')
            jQuery('.errorText').text('Notice')
            jQuery('#conv_save_error_txt').html(
                'According to your plan, the maximum limit for syncing products is 100')
            jQuery('#conv_save_error_modal').modal('show')
            return false;
        }
        if (totalProduct == 0 && product_selection !== 'specific_product') {
            jQuery('#conv_save_error_txt').html('')
            jQuery('.errorText').text('Notice')
            jQuery('#conv_save_error_txt').html('Please selecte atleast One product!!!')
            jQuery('#conv_save_error_modal').modal('show')
            return false;
        }
        if (totalProduct > 100 && product_selection !== 'specific_product') {
            jQuery('#conv_save_error_txt').html('')
            jQuery('.errorText').text('Notice')
            jQuery('#conv_save_error_txt').html(
                'According to your plan, the maximum limit for syncing products is 100')
                ...
                if (response.data) {
                    ...
                    jQuery.each(response.data, function(key, value) {
                        ...
                        jQuery.each(value, function(valKey, ValValue) {
                            var selected = "";
                            if (jQuery.inArray(valKey, catalog_business_id) !== -1 &&
                                catalog_business_id.length > 0) {
                                var selected = 'selected="selected"';
                            }
                            tableBody += '<option value="' + valKey +
                                '"  data-catalog_country="' + key +
                                '" data-catalog_name="' + ValValue + '" ' + selected + '>' +
                                valKey + ' - ' + ValValue + '</option>';
                        })
...
function getAttrubuteMappingDiv() {
    ...
    jQuery.ajax({
        ...
        data: data,
        beforeSend: function() {
            jQuery('#attribute_mapping').empty()
        },
        success: function(response) {
...
function getConditionDropDown(val = '', condition = '') {
    let conditionOption =
        '<select class="condition createSelect" name="condition[]" style="width: 100%"><option value="0">Select Condition</option>';
    if (val != '0') {
        if (val != '' || condition != '') {
            switch (val) {
                case 'product_cat':
                case 'ID':
                    conditionOption += '<option value="=" ' + ((condition == "=") ? "selected" : "") +
                        ' > = </option>' +
        ...
        success: function(response) {
            ...
            if (response.id) {
                if (product_selection == 'specific_product') {
                    ...
                    jQuery('#conv_create_popup_txt_msg').text(
                        'You have successfully created the new Feed with ' + totalProduct + ' products')
                    checkProgressBar()
                    openOverlayLoader('openshow');
                    setTimeout(function() {
                        openOverlayLoader('close');
...
function saveChannel(Channel) {
    ...
    if (Channel == 'GMC') {
        ...
        if (jQuery("#google_merchant_center_id").val() === '') {
            jQuery('.selection').find("[aria-labelledby='select2-google_merchant_center_id-container']").addClass(
                'selectError');
            return false;
        }
    ...
    if (Channel == 'Tiktok') {
        ...
        if (tiktok_data["tiktok_business_id"] === '') {
            jQuery('.selection').find("[aria-labelledby='select2-tiktok_business_id-container']").addClass(
                'selectError');
            return false;
        }
        var catalogData = {};
        jQuery('.catalogId').each(function() {
            catalogData[jQuery(this).find(":selected").data("catalog_country")] = [jQuery(this).find(
                    ":selected").val(), jQuery(this).find(":selected").data("catalog_name"), jQuery(this)
                .find(":selected").data("catalog_country")
            ];
        })
    ...
    jQuery.ajax({
        ...
        beforeSend: function() {
            ...
            if (Channel == 'GMC') {
                jQuery(
                        ".verifySite, .verifyDomain, .createNewGMC, .channelTabSave, .saveGMC, .tvc_google_signinbtn")
            ...
            if (Channel == 'Tiktok') {
                jQuery(".signIn, #tiktok_business_id, .channelTabSave, .saveTiktok").css("pointer-events",
                    "none");
                ...
                jQuery('#tiktok_business_id-value').val(jQuery('#tiktok_business_id').find(":selected")
                .val())
            }
        },
        success: function(response) {
            if (Channel == 'GMC') {
                ...
                if (google_merchant_center_id != jQuery("#google_merchant_center_id").val()) {
                    var html =
                        '<span class="material-symbols-outlined" style="font-size: 18px;">autorenew</span>Verify Now';
                    var html2 =
                        '<span class="material-symbols-outlined" style="font-size: 18px;">autorenew</span>Claim Now';
...
function manageFbLoader(display = "show") {
    if (display == "show") {
        ...
        jQuery(".facebookLogin, #fb_business_id, #fb_catalog_id, .channelTabSave, .saveFB").css("pointer-events",
            "none");
    } else {
...
function checkProgressBar(channel = "") {
    var get =
        "<?php echo isset($_GET['wizard_channel']) ? esc_attr(sanitize_text_field(wp_unslash($_GET['wizard_channel']))) : '' ?>";
    var data = {
        action: "get_category_for_filter",
    ...
    jQuery.ajax({
        ...
        success: function(response) {
            ...
            if (response.feed_count == 1) {
                pixelprogressbarclass = parseInt(pixelprogressbarclass) + 25;
            ...
            if (response.iscatMapped == 1) {
                pixelprogressbarclass = parseInt(pixelprogressbarclass) + 25;
                jQuery('.product-category').text("check_circle")
                jQuery('.product-category').removeClass("text-warning")
                jQuery('.product-category').addClass("text-success")
            }
            if (response.is_channel_connected == 1) {
                ...
                jQuery('.channel_notice').removeClass('d-none')
            }
            ...
            if (response.isAttrMapped == 1 && response.is_channel_connected == 1 && get == '' && channel ==
                '') {
                jQuery('[data-bs-target="#contact"]').trigger('click')
            } else if (response.isAttrMapped == 0 && response.is_channel_connected == 1 && get == '' &&
                channel == '') {
                jQuery('[data-bs-target="#profile"]').trigger('click')
            } else if (get == '' && channel == "") {
                list_tiktok_business_account();
    ...
    jQuery.ajax({
        ...
        success: function(response) {
            if (Object.keys(response).length > 0) {
                ...
                jQuery('#fb_business_id').html(html);
                get_fb_catalog_data()
            } else {
                manageFbLoader('hide')
            }
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                jQuery.each(response, function(index, value) {
                    ...
                    html += '<option value="' + value.id + '" ' + selected + '>' + value.id + '-' +
                        value.name + '</option>';
                });
...
jQuery(document).on("click", ".change_prodct_feed_cat", function() {
    ...
    jQuery("#" + feed_select_cat_id).select2();
});
</script>
...
.dataTables-search, .dataTables-paging {
    float: right;
    margin-top: 5px;
    margin-bottom: 5px;
}
                ...
                <tr>
                    ...
                    <th scope="col" class="text-dark text-center sorting_disabled">
                        <select class="selectStatus" id="selectStatus">                
                            <?php if(in_array('1', $channel_id)){ ?> <option value="1" <?php echo isset($channel_id[0]) && $channel_id[0] == 1 ? 'selected' : '' ?>>GMC Status</option> <?php }?>
                            <?php if(in_array('3', $channel_id)){ ?><option value="3" <?php echo isset($channel_id[0]) && $channel_id[0] == 3 ? 'selected' : '' ?>>Tiktok Status</option> <?php }?>
                            <?php if(in_array('2', $channel_id)){ ?><option value="2" <?php echo isset($channel_id[0]) && $channel_id[0] == 2 ? 'selected' : '' ?>>Facebook Status</option> <?php }?>
                        </select>
                        ...
                        <div class="col-12 p-2">
                            <div style="float:right;">
                                ...
                                <select id="product_batch_size" style="border-radius:15px;">                                
                                    <option value="25" <?php echo $product_sync_batch_size == 25 ? 'selected' : '' ?>>25</option>
                                    <option value="50" <?php echo $product_sync_batch_size == 50 ? 'selected' : '' ?>>50</option>
                                    <option value="100" <?php echo $product_sync_batch_size == 100 ? 'selected' : '' ?>>100</option>
                                    <option value="200" <?php echo $product_sync_batch_size == 200 ? 'selected' : '' ?>>200</option>
                                    <option value="500" <?php echo $product_sync_batch_size == 500 ? 'selected' : '' ?>>500</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-12 row p-2">
...
<script>
    ...
    jQuery(document).ready(function () {        
        ...
        var table = jQuery('#product_list_table').DataTable({
            ...
            } else if (status == 'Draft' && tiktok_status == 'Draft' && fb_status == 'Draft' && is_mapping_update == '1') {
                jQuery('.action_').remove();
                jQuery("input:checkbox[name=attrProduct]").each(function() {
                    jQuery('#channel_action_' + jQuery(this).val()).empty();
                    jQuery('#channel_action_' + jQuery(this).val()).append(
                    ...
                    if(channel_ids.indexOf('2') != -1){
                        jQuery('.pending_issue_text_' + jQuery(this).val()).append("<h2 class='card-title fs-6'><img src='<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/fb_channel_logo.png') ?>' /> Facebook Catalog Center</h2><span class='text-dark fs-7'><ul class='b'><li>Product Sync In Progress</li></ul></span>");
                    }
                });
                    ...
                    success: function (response) {
                        ...
                        if (response != "Product does not exists" && response != "Product not synced") {                         
                            ...
                            jQuery.each(response, function (key, value) {
                                ...
                                if (value.facebookStatus && value.facebookStatus !== 'disapproved') {
                                    countApproved++;
                                    AllApproved++;
                                    jQuery('.channel_logo_' + prodID[3]).append("<img src='<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/fb_channel_logo.png') ?>' />");
                                }else if(value.facebookStatus) {
                                    countDisapproved++;
                                    AllDisapproved++;
                                    jQuery('.rejected_issue_text_' + prodID[3]).append("<h2 class='card-title fs-6'><img src='<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/fb_channel_logo.png') ?>' /> Facebook Catalog</h2><span class='text-dark fs-7'>" + value.facebookIssues + "</span>");
                                }
                                ...
                                if(value.tiktokStatus && value.tiktokStatus !== 'disapproved') {
                                    ...
                                    countDisapproved++;
                                    AllDisapproved++;
                                    jQuery('.rejected_issue_text_' + prodID[3]).append("<h2 class='card-title fs-6'><img src='<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/tiktok_channel_logo.png') ?>' /> Tiktok Catalog</h2><span class='text-dark fs-7'>" + value.tiktokStatus + "</span>");
                                }
    ...
    /*************************************DELETE Feed Data Start**********************************************************************/
        function deleteProduct($id, $product_id = null){
            var message = 'Product in this feed will be deleted from the channels selected in the feed. Are you sure you want to delete it? ';            
            if(confirm(message)){
                var conv_onboarding_nonce = "<?php echo esc_html(wp_create_nonce('conv_onboarding_nonce')); ?>"
                var data = {
    ...
    jQuery(document).on('change', '#selectStatus', function() {
            jQuery('.channelStatus_').each(function() {
                ...
                var html = '<div>'
                    ...
                    + 'Approved <span class="badge bg-light rounded-circle fs-7 approved-text ms-2 margin-badge approved_count_' + className_prdId + '" style="top:0px;">0</span>'
                    + '</button>'
                    ...
                    + 'Pending&nbsp; <span class="badge bg-light rounded-circle fs-7 pending-text ms-2 margin-badge pending_count_' + className_prdId + '" style="top:0px;">0</span>'
                    + '</button>'
                    ...
                    + 'Rejected <span class="badge bg-light rounded-circle fs-7 rejected-text ms-2 margin-badge rejected_count_' + className_prdId + '" style="top:0px;">0</span>'
                    + '</button>'
                    + '<div class="hidden rejectDivContent">'
                    + '<div class="card rounded-5">'
                    + '<div class="card-header bg-danger-soft text-white">Rejected Issues - '+ jQuery('.title_'+ className_prdId).text() +'</div>'
                    + '<div class="card-body card-body-rejected rejected_issue_text_ rejected_issue_text_' + className_prdId + '">'                 
                    + '</div>'
                    + '</div>'
                    + '</div>'
                    + '</div>';                    
            ...
            if(status == 'Draft' && tiktok_status == 'Draft' && fb_status == 'Draft' && is_mapping_update != '1'){
                ...
                jQuery("input:checkbox[name=attrProduct]").each(function() {
                    ...
                    if(channel_ids.indexOf('3') != -1){
                        jQuery('.pending_issue_text_' + jQuery(this).val()).append("<h2 class='card-title fs-6'><img src='<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/tiktok_channel_logo.png') ?>' /> TikTok Catalog Center</h2><span class='text-dark fs-7'><ul class='b'><li>Product Sync In Progress</li></ul></span>");
                    }
                        ...
                        if (response != "Product does not exists" && response != "Product not synced") {                            
                            ...
                            jQuery.each(response, function(key, value) {
                                ...
                                if(value.tiktokStatus && value.tiktokStatus !== 'disapproved') {
                                    ...
                                    countDisapproved++;
                                    AllDisapproved++;
                                    jQuery('.rejected_issue_text_' + prodID[3]).append("<h2 class='card-title fs-6'><img src='<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/logos/tiktok_channel_logo.png') ?>' /> Tiktok Catalog</h2><span class='text-dark fs-7'>" + value.tiktokIssues + "</span>");
                                }

                            ...
                            <div class="card-body">
                                <div class="progress-wholebox">
                                    <ul class="progress-steps">
                                            ...
                                            <div class="step-box">
                                                <div style="padding-top: 8px">
                                                    <?php if ($tiktok_mail === '' && $tiktok_user_id === '') { ?>
                                                        <a onclick='window.open("<?php echo esc_url($tiktok_auth_url) ?>","MyWindow","width=800,height=700,left=300, top=150"); return false;' href="#" class="signIn">
                                                            <button class="btn btn-outline-dark" id=""><img style="width:19px" src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/logos/conv_tiktok_logo.png'); ?>">
                                        ...
                                        <li class="<?php echo esc_attr($tiktok_business_id) ? "" : "disable"; ?>" style="min-height:120px;">
                                            <div class="step-box">
                                                <span class="inner-text"><?php esc_html_e("TikTok Business Account ID", "enhanced-e-commerce-for-woocommerce-store"); ?></span>
                                                <div class="row">
                                                    <div class="col-6">
                                                        <select id="tiktok_business_id" name="tiktok_business_id" class="form-select selectthree" disabled style="width: 100%">
                                        ...
                                        <li class="<?php echo (is_array($catalogData) && !empty($catalogData)) ? "" : "disable"; ?>" style="min-height:68px;">
                                            <div class="step-box">
                ...
                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                    ...
                    <div class="convcard p-4 mt-0 rounded-3 shadow-sm">
                        ...
                        <div class="mt-3 col-6">
                            ...
                            <span class="material-symbols-outlined fs-6 text-grey pointer" data-bs-toggle="tooltip" data-bs-placement="right" title="Add a name to your feed for your reference, for example, 'April end-of-season sales' or 'Black Friday sales for the USA'.">
                                info
                            </span>
                        ...
                        <div class="mt-3 col-6">
                            ...
                            <span class="material-symbols-outlined fs-6 text-grey pointer" data-bs-toggle="tooltip" data-bs-placement="right" title="Specify the target country for your product feed. Select the country where you intend to promote and sell your products.">
                                info
                            </span>
                            <select class="form-select form-select-sm mb-3" aria-label="form-select-sm example" style="width: 100%" name="feed_target_country" id="feed_target_country">
                        ...
                        <div class="mt-3 col-12">
                            ...
                            <span class="material-symbols-outlined fs-6 text-grey pointer" data-bs-toggle="tooltip" data-bs-placement="right" title="Below is the list of channels that you have linked for product feed. Please note you will not be able to make any changes in the selected channels once product feed process is done.">
                                info
                            </span>
                            <div class="">
                                <div class="form-check form-check-custom">
                                    <input class="form-check-input check-height fs-14 errorChannel" type="checkbox" value="" id="gmc_id" name="gmc_id">
                            ...
                            <div class="">
                                <div class="form-check form-check-custom">
                                    <input class="form-check-input check-height fs-14 errorChannel" type="checkbox" value="" id="tiktok_id" name="tiktok_id">
                                    <span for="" class="fs-14 pt-0 text-grey fw-normal">
                        ...
                        <div class="row mt-3">
                            <div class="col-4 row">
                                <div class="col-6 pe-0">
                                    ...
                                    <span class="material-symbols-outlined fs-6 text-grey pointer" data-bs-toggle="tooltip" data-bs-placement="right" title="Turn on this feature to schedule an automated product feed to keep your products up to date with the changes made in the products. You can come and change this any time.">
                                        info
                                    </span>
                                </div>
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control-sm" readonly name="autoSyncIntvl" id="autoSyncIntvl" size="3" min="1" value="25" style="width: 42px" onkeypress="return ( event.charCode === 8 || event.charCode === 0 || event.charCode === 13 || event.charCode === 96) ? null : event.charCode >= 48 && event.charCode <= 57">
                        ...
                        <div class="mt-3">
                            ...
                            <span class="material-symbols-outlined fs-6 text-grey pointer" data-bs-toggle="tooltip" data-bs-placement="right" title="Select your woocommerce product to sync in channels.">
                                info
                            </span>
                            <div class="mt-1">
...
<div class="modal fade" id="conv_modal_popup" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
<div class="modal fade" id="conv_modal_create_popup" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center p-2 pt-4">
...
<div class="modal fade" id="conv_modal_attribute_popup" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-2 pt-0">
                <div class="text-start p-2 pt-0 pb-0">
                    <span class="fs-16 fw-semibold text-grey"><?php esc_html_e("Attribute Mapping for Products", "enhanced-e-commerce-for-woocommerce-store") ?></span>
                    <p class="fs-12 fw-normal text-grey mb-1"><?php esc_html_e("Correctly mapping your products to the appropriate attributes enhances their relevance to customers, potentially leading to improved conversion rates and boosted sales.", "enhanced-e-commerce-for-woocommerce-store"); ?></p>
                    <p class="fs-12 fw-normal text-grey mb-1"><?php esc_html_e("Map your Woocommerce product attributes against Conversios product attributes and we will make sure they are rightly synced in google merchant center and/or tiktok.", "enhanced-e-commerce-for-woocommerce-store"); ?></p>
                </div>

            ...
            <ul class="nav nav-tabs border-0 p-3 pb-0" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button style="pointer-events: none;"
                        class="d-inline-flex align-items-center pawizard_tab_but border-0 nav-link active ps-0"
                ...
                <li class="nav-item" role="presentation">
                    <button style="pointer-events: none;"
                        class="d-inline-flex align-items-center pawizard_tab_but border-0 nav-link ps-0"
                            ...
                            <div class="card-body">
                                <div class="progress-wholebox">
                                    <ul class="progress-steps">
                                        ...
                                        <li class="<?php echo esc_attr($tiktok_business_id) ? "" : "disable"; ?>"
                                        ...
                                        <li class="<?php echo (is_array($catalogData) && !empty($catalogData)) ? "" : "disable"; ?>"
                                            style="min-height:68px;">
                                            <div class="step-box">
                    ...
                    <div class="convcard p-4 mt-0 rounded-3 shadow-sm">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-6">
                                ...
                                <span class="conv-link-blue ms-2 fw-bold-500 upgradetopro_badge ms-auto"
        ...
        <div class="onbrdnpp-cntner acccretppcntnr">
            <div class="onbrdnpp-hdr">
                <div class="ppclsbtn clsbtntrgr"><img
                        src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/close-icon.png'); ?>" alt="" />
                </div>
            </div>
            <div class="onbrdpp-body">
                ...
                <div class="google_signin_sec_left">
                    ...
                    <div class="google_connect_url google-btn">
                        ...
                        <img
                            src="<?php echo esc_url(ENHANCAD_PLUGIN_URL . '/admin/images/logos/btn_google_signin_dark_normal_web.png'); ?>">
...
<div class="modal fade" id="conv_modal_attribute_popup" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width: 700px;">
        <div class="modal-content">
            <div class="pt-2">
                <button type="button" class="btn-close-pop btn-close pe-4 float-end" aria-label="Close"></button>
            </div>
            <div class="modal-body p-2 pt-0">
                <div class="text-start p-2 pt-0 pb-0">
                    <span
                        class="fs-16 fw-semibold text-grey"><?php esc_html_e("Attribute Mapping for Products", "enhanced-e-commerce-for-woocommerce-store") ?></span>
                    <p class="fs-12 fw-normal text-grey mb-1">
                    ...
                    <p class="fs-12 fw-normal text-grey mb-1">
                        <?php esc_html_e("Map your Woocommerce product attributes against Conversios product attributes and we will make sure they are rightly synced in google merchant center and/or tiktok.", "enhanced-e-commerce-for-woocommerce-store"); ?>
                    </p>
                </div>
                <div id="attr_loader" class="progress-materializecss d-none ps-2 pe-2" style="width:100%">
                    <div class="indeterminate"></div>
                </div>
                <div class="attrDiv">
                    <div class="conv-light-grey-bg mb-2 attributeMappingDiv">
                        <div class="row">
                            <div class="col-6 pt-2" style="text-align: left">
                            ...
                            <div class="col-6 pt-2 ps-0" style="text-align: left">
            ...
            <div class="modal-footer border-0 pb-4 mb-1">
                <button class="btn btn-primary text-white attr_mapping_save" id="attr_mapping_save">Create</button>
            </div>
        </div>
    </div>
</div>
...
jQuery(function() {
    ...
    selected = arr;
    var tiktok_user_id = "<?php echo esc_js($tiktok_user_id) ?>";
    ...
    jQuery(document).on('click', '.btn-close-pop', function() {
        setTimeout(function() {
            jQuery('#feed_target_country').select2()
        }, 100);
        jQuery('#conv_modal_attribute_popup').modal('hide')
    })
    ...
    jQuery(document).on("click", "#attr_mapping_save", function() {
        ...
        jQuery.ajax({
            ...
            data: data,
            beforeSend: function() {
                jQuery('#attr_loader').removeClass('d-none')
                jQuery('#attr_mapping_save').prop('disabled', true)
            },
            success: function(response) {
                jQuery('#attr_loader').addClass('d-none')
                jQuery('#conv_modal_attribute_popup').modal('hide')
                save_feed_data()
            }
        });
    ...
    jQuery(document).on('click', '.add_additional_attr', function() {
        ...
        $html = '';
        $html += '<div class="row additinal_attr_div m-0 p-1" ><div class="col-6 mt-2">';
        ...
        setTimeout(function() {
            jQuery('.additinal_attr, .additional_attr_value, .select_modal').select2({
                dropdownParent: jQuery("#conv_modal_attribute_popup .modal-content"),
...
function save_feed_data() {
    ...
    jQuery.ajax({
        ...
        beforeSend: function() {
            ...
            // jQuery('#createFeed').text('Creating...')
            jQuery('#createFeed').prop('disabled', true)
...
function getConditionDropDown(val = '', condition = '') {
    ...
    function checkProgressBar(channel = "") {
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                if (response.is_channel_connected == 1 && get == '' && channel == '') {
                    jQuery('[data-bs-target="#contact"]').trigger('click')
                }
            }
        });
    ...
    function getAttrubuteMappingDiv() {
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                cnt = jQuery('#cnt').val();
                jQuery('#conv_modal_attribute_popup').modal('show')
                if (jQuery('#feed_target_country').data('select2')) {
                    jQuery('#feed_target_country').select2('destroy')
                }
                setTimeout(function() {
    ...
    jQuery(document).on('keydown', 'input[name="shipping"]', function(event) {
        ...
        if ((event.keyCode >= 48 && event.keyCode <= 57) || (event.keyCode >= 96 && event.keyCode <= 105) ||
            event.keyCode == 8 || event.keyCode == 9 || event.keyCode == 37 || event.keyCode == 39 || event

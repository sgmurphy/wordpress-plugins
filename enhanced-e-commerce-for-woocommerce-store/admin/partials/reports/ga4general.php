<div class="conv_reportsec_box g-0">
        ...
        <div class="col-xs-12 col-sm-6 col-md-3 col-xl-3 col-xxl conv_rep_gridbox mb-4 conv_rgrid_sessions">
            <div class="bg-white conv_rgrid_in conv_bordershadow rounded py-2 px-3 placeholder-glow">
                <h5 class="conv-text-blue mb-0 text-truncate d-flex">
                    ...
                    <span class="material-symbols-outlined text-secondary md-18 ps-1 align-self-center"
                        data-bs-toggle="tooltip" data-bs-placement="right" title=""
                        data-bs-original-title="<?php esc_html_e("A session is a collection of user interactions with your site or app within a specified time frame.", "enhanced-e-commerce-for-woocommerce-store") ?>">
                        info
                    </span>
                </h5>
        ...
        <div class="col-xs-12 col-sm-6 col-md-3 col-xl-3 col-xxl conv_rep_gridbox mb-4 conv_rgrid_newUsers">
            <div class="bg-white conv_rgrid_in conv_bordershadow rounded py-2 px-3 placeholder-glow">
                <h5 class="conv-text-blue mb-0  text-truncate d-flex">
                    ...
                    <span class="material-symbols-outlined text-secondary md-18 ps-1 align-self-center"
                        data-bs-toggle="tooltip" data-bs-placement="right" title=""
                        data-bs-original-title="<?php esc_html_e("Users visiting your site/app for the first time.", "enhanced-e-commerce-for-woocommerce-store") ?>">
                        info
                    </span>
                </h5>
                <div class="conv_rgrid_dydata">
        ...
        <div class="col-xs-12 col-sm-6 col-md-3 col-xl-3 col-xxl conv_rep_gridbox mb-4 conv_rgrid_avgduration">
            <div class="bg-white conv_rgrid_in conv_bordershadow rounded py-2 px-3 placeholder-glow">
                <h5 class="conv-text-blue mb-0  text-truncate d-flex">
                    ...
                    <span class="material-symbols-outlined text-secondary md-18 ps-1 align-self-center"
                        data-bs-toggle="tooltip" data-bs-placement="right" title=""
                        data-bs-original-title="<?php esc_html_e("Average Session Duration is the average time users spend on a website or app.", "enhanced-e-commerce-for-woocommerce-store") ?>">
                        info
                    </span>
                </h5>
                <div class="conv_rgrid_dydata">
        ...
        <div class="col-xs-12 col-sm-6 col-md-3 col-xl-3 col-xxl conv_rep_gridbox mb-4 conv_rgrid_bounce">
            <div class="bg-white conv_rgrid_in conv_bordershadow rounded py-2 px-3 placeholder-glow">
                <h5 class="conv-text-blue mb-0 text-truncate d-flex">
                    ...
                    <span class="material-symbols-outlined text-secondary md-18 ps-1 align-self-center"
                        data-bs-toggle="tooltip" data-bs-placement="right" title=""
                        data-bs-original-title="<?php esc_html_e("Percentage of single-page sessions with no conversions or additional page views within 10 seconds.", "enhanced-e-commerce-for-woocommerce-store") ?>">
                        info
                    </span>
                </h5>
                <div class="conv_rgrid_dydata">
    ...
    <div class="row px-0">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-xxl-12 conv_report_tabs">
            <h4 class="pt-3 d-flex">
                ...
                <span class="material-symbols-outlined text-secondary md-18 ps-1 align-self-center"
                    data-bs-toggle="tooltip" data-bs-placement="right" title=""
                    data-bs-original-title="<?php esc_html_e("Analyze user demographics, interests, and behavior with the Audience report to understand user groups interacting with your website or app.", "enhanced-e-commerce-for-woocommerce-store") ?>">
                    info
                </span>
            </h4>
        ...
        <div class="row px-0">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-xxl-12 conv_report_tabs">
                <h4 class="pt-3 d-flex">
                    ...
                    <span class="material-symbols-outlined text-secondary md-18 ps-1 align-self-center"
                        data-bs-toggle="tooltip" data-bs-placement="right" title=""
                        data-bs-original-title="<?php esc_html_e("Shows the sequence of pages visited by users and the actions performed.", "enhanced-e-commerce-for-woocommerce-store") ?>">
                        info
                    </span>
                </h4>
                <div class="tab-pane fade show bg-white conv_bordershadow rounded" id="pills-convsomedr" role="tabpanel"
                    aria-labelledby="pills-convsomedr-tab">
                    ...
                    <th class="text-end p-1 text-truncate d-flex flex-row-reverse">
                        <div class="conv_rgrid_data_icon conv_rgrid_data_icon_black"><img
                                src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL . '/admin/images/green-up.png'); ?>"
                                alt="" /></div>
                    ...
                    <a class="conv_page_path conv_viewfre_link conv-link-blue float-end p-3 fw-bold">View Full
                        Report</a>
                </div>
            </div>
        </div>
    ...
    <div class="row px-0">
        ...
        <div class="col-xs-4 col-sm-4 col-md-4 col-xl-4 col-xxl-4 conv_report_tabs">
            <h4 class="pt-3 d-flex">
                ...
                <span class="material-symbols-outlined text-secondary md-18 ps-1 align-self-center"
                    data-bs-toggle="tooltip" data-bs-placement="right" title=""
                    data-bs-original-title="<?php esc_html_e("Groups users by device type (desktop, mobile, etc.).", "enhanced-e-commerce-for-woocommerce-store") ?>">
                    info
                </span>
            </h4>
        ...
        <div class="col-xs-4 col-sm-4 col-md-4 col-xl-4 col-xxl-4 conv_report_tabs">
            <h4 class="pt-3 d-flex">
                ...
                <span class="material-symbols-outlined text-secondary md-18 ps-1 align-self-center"
                    data-bs-toggle="tooltip" data-bs-placement="right" title=""
                    data-bs-original-title="<?php esc_html_e("Identifies geographic locations of your users based on their countries.", "enhanced-e-commerce-for-woocommerce-store") ?>">
                    info
                </span>
            </h4>
            <div class="tab-pane fade show bg-white conv_bordershadow rounded" id="pills-convsomedr" role="tabpanel"
                aria-labelledby="pills-convsomedr-tab" style="height: 317px;">
    ...
    <div class="col-xs-4 col-sm-4 col-md-4 col-xl-4 col-xxl-4 conv_report_tabs">
        <h4 class="pt-3 d-flex">
            ...
            <span class="material-symbols-outlined text-secondary md-18 ps-1 align-self-center" data-bs-toggle="tooltip"
                data-bs-placement="right" title=""
                data-bs-original-title="<?php esc_html_e("Identifies geographic locations of your users based on their cities.", "enhanced-e-commerce-for-woocommerce-store") ?>">
                info
            </span>
        </h4>
        <div class="tab-pane fade show bg-white conv_bordershadow rounded" id="pills-convsomedr" role="tabpanel"
...
<div class="row px-0">
    ...
    <div class="col-xs-8 col-sm-8 col-md-8 col-xl-8 col-xxl-8 conv_report_tabs">
        <h4 class="pt-3 d-flex">
            ...
            <span class="material-symbols-outlined text-secondary md-18 ps-1 align-self-center" data-bs-toggle="tooltip"
                data-bs-placement="right" title=""
                data-bs-original-title="<?php esc_html_e("Shows user activity on your site/app as it happens in last 30 minutes.", "enhanced-e-commerce-for-woocommerce-store") ?>">
                info
            </span>
        </h4>
        <div class="bg-white conv_bordershadow rounded p-2">
    ...
    <div class="col-xs-4 col-sm-4 col-md-4 col-xl-4 col-xxl-4 conv_report_tabs">
        <h4 class="pt-3 d-flex">
            ...
            <span class="material-symbols-outlined text-secondary md-18 ps-1 align-self-center" data-bs-toggle="tooltip"
                data-bs-placement="right" title=""
                data-bs-original-title="<?php esc_html_e("Shows bifurcation of users in terms of new and returning users.", "enhanced-e-commerce-for-woocommerce-store") ?>">
                info
            </span>
        </h4>
        <div class="bg-white conv_bordershadow rounded p-2">
...
<div class="row px-0">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-xxl-12 conv_report_tabs">
        <h4 class="pt-3 d-flex">
            ...
            <span class="material-symbols-outlined text-secondary md-18 ps-1 align-self-center" data-bs-toggle="tooltip"
                data-bs-placement="right" title=""
                data-bs-original-title="<?php esc_html_e("Shows the number of users who visited your site/app each day.", "enhanced-e-commerce-for-woocommerce-store") ?>">
                info
            </span>
        </h4>
        <div class="bg-white conv_bordershadow rounded">

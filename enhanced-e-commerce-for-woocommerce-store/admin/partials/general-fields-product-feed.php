        ...
        <div class="convfixedcontainermid col-md-8 col-xs-12 m-0 p-0">
            ...
            <div class="convcard d-flex flex-row p-2 mt-0 rounded-3 shadow-sm">
                ...
                <div class="convcard-center p-2 ps-3 col-10">
                    <div class="convcard-title">
                        <div class="row">
                            <div class="col-8"><h3><?php esc_html_e("Google Merchant Center", "enhanced-e-commerce-for-woocommerce-store"); ?></h3></div>
                            <div class="col-4">
                                <span
            ...
            <div class="convcard d-flex flex-row p-2 mt-4 rounded-3 shadow-sm">
                ...
                <div class="convcard-center p-2 ps-3 col-10">
                    <div class="convcard-title">
                        <div class="row">
                            <div class="col-8"><h3><?php esc_html_e("TikTok Business Account", "enhanced-e-commerce-for-woocommerce-store"); ?></h3></div>
                            <div class="col-4">
                                <span
            ...
            <div class="convcard d-flex flex-row p-2 mt-4 rounded-3 shadow-sm">
                ...
                <div class="convcard-center p-2 ps-3 col-10">
                    <div class="convcard-title">
                        <div class="row">
                            <div class="col-8">
                                <h3><?php esc_html_e("Facebook Business Account", "enhanced-e-commerce-for-woocommerce-store"); ?></h3>
                            </div>
                            <div class="col-4">
                            <span
                        ...
                        <div class="d-flex mt-3">
                            ...
                            <?php esc_html_e("Benefits and how to integrate Facebook Business Account","enhanced-e-commerce-for-woocommerce-store") ?>
                                <a class="conv-link-blue conv-watch-video" href="https://www.conversios.io/docs/how-to-sync-your-woocommerce-products-to-facebook-catalogue/" target="_blank">
                                    Click here
                                    <span class="material-symbols-outlined align-middle">open_in_new_outline</span>
                                </a>
                            </span>
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                            ...
                            <div class="row bg-white m-0 p-0 mb-3">
                                <div class="col-12 categoryDiv" style="overflow-y: scroll; max-height:550px; position: relative;">

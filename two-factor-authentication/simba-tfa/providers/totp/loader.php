...
class Simba_TFA_Provider_totp {
	...
	public function get_emergency_codes_as_string($user_id, $generate_if_empty = false) {
		...
		$emergency_str = $emergency_str ? $emergency_str : '<em>'.__('There are no emergency codes left. You will need to reset your private key to generate new ones.', 'two-factor-authentication').'</em>';

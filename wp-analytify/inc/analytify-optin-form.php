          ...
          $('#analytify-ga-submit-btn').on('click', function(e){
            ...
            $.ajax({
              ...
              data: {
                ...
                optin_yes_nonce: '<?php echo isset( $analytify_optin_page_nonce ) ? $analytify_optin_page_nonce : ''; ?>',
              },
              beforeSend: function(){
          ...
          $('#analytify-ga-optout-btn').on('click', function(event) {
            ...
            $.ajax({
              ...
              data: {
                ...
                optin_skip_nonce: '<?php echo isset($analytify_optin_page_nonce) ? $analytify_optin_page_nonce : ''; ?>',
              },
              beforeSend: function(){

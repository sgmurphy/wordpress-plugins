...
class GridGallery_Galleries_Model_Pagination extends GridGallery_Core_BaseModel {
	...
	public function getPageSize() {
		if ($this->_pageSize === null) {
			$pageSize = isset($_GET[$this->pageSizeParam]) ? (int)sanitize_text_field($_GET[$this->pageSizeParam]) : '100';;
	...
	protected function getAllParams() {
		$gridGalleryClass = new GridGallery_Galleries_Model_Galleries;
		$params = $gridGalleryClass->sanitize_array($_GET);
		return $params;
	}

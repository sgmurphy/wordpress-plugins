...
class Template_Library_Source extends Source_Base {
	 ...
	 */
	const LIBRARY_CACHE_ID = 'exad_library_cache';
	...
	public function get_title() {
		return __( 'Template Library', 'exclusive-addons-elementor' );
	}
	...
	public function get_data( array $args, $context = 'display' ) {
		...
		if ( empty( $data ) || empty( $data['content'] ) ) {
			throw new \Exception( __( 'Template does not have any content', 'exclusive-addons-elementor' ) );
		}

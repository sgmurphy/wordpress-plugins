		...
		<div class="cf7s">
			<h2 class="nav-tab-wrapper <?php echo esc_attr( $color_scheme ); ?>">
				<?php foreach( $this->tabs as $key => $value ) : ?>
					<a class="nav-tab nav-tab-<?php echo esc_attr( $value['name'] ); ?> <?php echo esc_attr($key === 0 ? 'nav-tab-active' : ''); ?>" href="#tab-<?php echo esc_attr( $value['name'] ); ?>">
						<?php echo esc_attr( $value['label'] ); ?>
						<span class="help balloon-hover balloon" title="<?php echo esc_attr( $value['help'] ); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="8" height="11" viewBox="0 0 8 11" fill="none"><ellipse cx="3.99992" cy="4.25001" rx="2.91667" ry="2.91667" stroke="white"></ellipse><line x1="2.25" y1="8.7851" x2="5.75" y2="8.7851" stroke="white"></line><line x1="2.83325" y1="10.1667" x2="5.16659" y2="10.1667" stroke="white"></line></svg></span>
						<span class="help balloon-hover balloon" title="<?php echo esc_attr( $value['note'] ); ?>"><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><ellipse cx="5.99992" cy="6.00001" rx="4.66667" ry="4.66667" stroke="white"></ellipse><rect x="5.41675" y="5.41666" width="1.16667" height="3.5" fill="white"></rect><rect x="5.41675" y="3.08334" width="1.16667" height="1.16667" fill="white"></rect></svg></span>
					</a>
				<?php endforeach; ?>
			...
			<div class="nav-tab-content <?php echo esc_attr( $color_scheme ); ?>">
				<?php foreach( $this->tabs as $key => $value ) : ?>
					<div id="tab-<?php echo esc_attr( $value['name'] ); ?>" class="tab-content wp-clearfix <?php echo esc_attr($key === 0 ? 'tab-active' : ''); ?>">

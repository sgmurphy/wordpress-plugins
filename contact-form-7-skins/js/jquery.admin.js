...
(function($) {
	...
	cf7sAdmin = {
		...
		tab : function(e) {
			...
			// Get selected tab name string, replace space to dash and set to lower case
			var tabTitleLowerCase = $(e).text().trim().replace(/\s+/g, '-').toLowerCase();

			// Set data-tab value with tab string
			$( cf7s ).attr( 'data-tab', tabTitleLowerCase );			
		},

<div class="sumome-plugin-dashboard-widget-inner">
    ...
    <div class="sumome-plugin-dashboard-widget-header">
        <div class="forms">
            ...
            <div class="sumome-wp-dash-logged-in <?php echo esc_attr($sumomeStatus) ?>">
                ...
                <div class="sumome-plugin-dashboard-widget-header-button">
                    <button type="submit" class="button green dashboard-button"
                            onclick="document.location.href='<?php echo esc_url(admin_url('admin.php?page=sumo')) ?>'">DASHBOARD
                    </button>
                </div>
            </div>

            <div class="sumome-wp-dash-logged-out <?php echo esc_url($sumomeStatus) ?>">
                ...
                <div class="sumome-plugin-dashboard-widget-header-desc">Sumo is the #1 plugin to grow your WordPress
                    site.<br>
                    Connect today and you'll <b>grow</b> your traffic, <b>build</b> a massive following, and
                    <b>track</b> your progress.
                </div>
                <div class="sumome-plugin-dashboard-widget-header-button">
    ...
    <div class="sumome-plugin-dashboard-widget-container">
        <div class="sumome-plugin-dashboard-widget-top-note-container">
            <div class="sumome-plugin-dashboard-widget-top-note">
                ...
                <div class="sumome-plugin-dashboard-widget-top-note-desc">Sumo is the most trusted way to grow your
                    site,<br> <b>used by 500,000+ websites.</b><br><br>
                    <ul>
        ...
        <div class="sumome-plugin-dashboard-widget-row">
            ...
            <div class="sumome-plugin-right"><img
                        src="<?php echo esc_url(plugins_url('images/sumome-site-welcome1.png', dirname(__FILE__))) ?>"></div>
        </div>

        <div class="sumome-plugin-dashboard-widget-row no-mobile">
            <div class="sumome-plugin-left"><img
                        src="<?php echo esc_url(plugins_url('images/sumome-site-welcome2.png', dirname(__FILE__))) ?>"></div>
        ...
        <div class="sumome-plugin-dashboard-widget-row">
            ...
            <div class="sumome-plugin-right"><img
                        src="<?php echo esc_url(plugins_url('images/sumome-site-welcome3.png', dirname(__FILE__))) ?>"></div>
        </div>
        ...
        <div class="sumome-plugin-dashboard-widget-separator2">
            ...
            <div class="sumome-plugin-dashboard-widget-middle-note-clients">
                <img src="<?php echo esc_url(plugins_url('images/sumome-site-clients-airbnb.png', dirname(__FILE__))) ?>">
                <img src="<?php echo esc_url(plugins_url('images/sumome-site-clients-chive.png', dirname(__FILE__))) ?>">
                <img src="<?php echo esc_url(plugins_url('images/sumome-site-clients-tonyrobbins.png', dirname(__FILE__))) ?>">
                <img src="<?php echo esc_url(plugins_url('images/sumome-site-clients-entrepreneur.png', dirname(__FILE__))) ?>">
                <img src="<?php echo esc_url(plugins_url('images/sumome-site-clients-beachbody.png', dirname(__FILE__))) ?>">
                <img src="<?php echo esc_url(plugins_url('images/sumome-site-clients-artofman.png', dirname(__FILE__))) ?>">
                <img src="<?php echo esc_url(plugins_url('images/sumome-site-clients-4hourworkweek.png', dirname(__FILE__))) ?>">
            </div>
        </div>
        ...
        <div class="forms">
            ...
            <div class="sumome-wp-dash-logged-in <?php esc_attr($sumomeStatus) ?>">
            ...
            <div class="sumome-wp-dash-logged-out <?php echo esc_attr($sumomeStatus) ?>">
                <div class="sumome-plugin-dashboard-widget-header-button sumome-plugin-dashboard-widget-footer-button">
                    <button type="submit" class="button green connect-button" id="connectFormButton">Connect</button>
                    <div class="sumome-plugin-dashboard-widget-learn-more">Learn More</div>
                </div>
        ...
        <div class="sumome-plugin-dashboard-widget-row <?php echo esc_attr($sumomeStatus) ?>">
            <div class="sumome-plugin-center">Need to restore an existing account?
                ...
                if(substr_count($_SERVER['REQUEST_URI'], 'dashboard') > 0){
                    ...
                    ?>
                    <div class="sumome-plugin-linkalike sumome-link-button sumome-tile-advanced-settings item-tile"
                         data-name="sumome-control-advanced-settings" data-title="">Click here
                    </div>
                    <?php
                }
                ?>

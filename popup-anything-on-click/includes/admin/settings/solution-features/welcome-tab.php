...
<div id="paoc_welcome_tabs" class="paoc-vtab-cnt paoc_welcome_tabs paoc-clearfix">	
	...
	<div class="poac-deal-offer-wrap">
		...
		<h3 style="font-size: 18px; text-align:center; margin:0;">Explore Popup Anything Pro With Essential Bundle Free for 5 Days.</h3>			
	...
	<div class="popupaoc-solutions-section popupaoc-top-rsn popupaoc-left">
		...
		<div class="popupaoc-sf-cont popupaoc-center" style="font-size:20px; ">Here's why business owners <span class="popupaoc-blue">love PopupAnything</span>, and you will too!</div>
		...
		<div style="margin-top: 15px; text-transform: uppercase; text-align:center;">
			<a href="<?php echo esc_url( $popup_add_link ); ?>" class="popupaoc-sf-btn">Launch Popup With Free Features</a>
		</div>
	</div>
</div>
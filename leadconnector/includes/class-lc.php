...
class LeadConnector
{
     ...
     * - LeadConnector_i18n. Defines internationalization functionality.
    ...
    private function load_dependencies()
    {
         ...
         * core plugin.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-lc-loader.php';
         ...
         * side of the site.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'public/class-lc-public.php';
     ...
     *
     * Uses the LeadConnector_i18n class in order to set the domain and to register the hook
     * with WordPress.
     *
     * @since    1.0.0
     * @access   private
    ...
    private function set_locale()
    {
        ...
        $plugin_i18n = new LeadConnector_i18n();

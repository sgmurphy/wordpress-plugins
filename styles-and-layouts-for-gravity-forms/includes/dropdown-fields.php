...
$wp_customize->add_setting(
	'gf_stla_form_id_' . $current_form_id . '[dropdown-fields][max-width]',
	array(
		'default'   => '',
		'transport' => 'refresh',
		'type'      => 'option',
	...
	/*for tablet */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[dropdown-fields][max-width-tab]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/*for mobile */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[dropdown-fields][max-width-phone]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for pc */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[dropdown-fields][height]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for tablet */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[dropdown-fields][height-tab]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for mobile */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[dropdown-fields][height-phone]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	// Font style buttons.
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[dropdown-fields][font-style]',
		array(
			'default'   => '',
	...
	/* for pc */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[dropdown-fields][font-size]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for tablet */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[dropdown-fields][font-size-tab]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for mobile */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[dropdown-fields][font-size-phone]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* Start of Section */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[dropdown-fields][font-color]',
		array(
			'default'   => '',
			'transport' => 'postMessage',
			'type'      => 'option',
	...
	/* Start of Section */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[dropdown-fields][border-size]',
		array(
			'default'   => '',
			'transport' => 'postMessage',
			'type'      => 'option',
	...
	/* Start of Section */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[dropdown-fields][border-type]',
		array(
			'default'   => 'solid',
			'transport' => 'postMessage',
			'type'      => 'option',
	...
	/* Start of Section */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[dropdown-fields][border-radius]',
		array(
			'default'   => '',
			'transport' => 'postMessage',
			'type'      => 'option',
	...
	/* Start of Section */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[dropdown-fields][border-color]',
		array(
			'default'   => '',
			'transport' => 'postMessage',
			'type'      => 'option',
	...
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[dropdown-fields][background-color]',
		array(
			'default'   => '',
			'transport' => 'postMessage',
			'type'      => 'option',

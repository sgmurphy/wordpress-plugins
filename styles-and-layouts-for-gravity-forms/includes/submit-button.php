...
$wp_customize->add_setting(
	'gf_stla_form_id_' . $current_form_id . '[submit-button][button-align]',
	array(
		'default'   => '',
...
/* Start of Section */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][button-color]',
		array(
			'default'   => '',
			'transport' => 'postMessage',
			'type'      => 'option',
	...
	/* Start of Section */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][hover-color]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	// font style buttons.
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][font-style]',
		array(
			'default'   => '',
			'transport' => 'postMessage',
			'type'      => 'option',
	...
	/* for pc */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][font-size]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for tablet */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][font-size-tab]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for mobile */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][font-size-phone]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for pc*/
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][line-height]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for_tablet*/
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][line-height-tab]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for mobile*/
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][line-height-phone]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* Start of Section */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][font-color]',
		array(
			'default'   => '',
			'transport' => 'postMessage',
			'type'      => 'option',
	...
	/* Start of Section */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][font-hover-color]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for pc */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][max-width]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for tablet */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][max-width-tab]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for mobile */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][max-width-phone]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for pc */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][height]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for tablet */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][height-tab]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* for mobile */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][height-phone]',
		array(
			'default'   => '',
			'transport' => 'refresh',
			'type'      => 'option',
	...
	/* Start of Section */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][border-size]',
		array(
			'default'   => '0px',
			'transport' => 'postMessage',
			'type'      => 'option',
	...
	/* Start of Section */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][border-type]',
		array(
			'default'   => 'solid',
			'transport' => 'postMessage',
			'type'      => 'option',
	...
	/* Start of Section */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][border-radius]',
		array(
			'default'   => '',
			'transport' => 'postMessage',
			'type'      => 'option',
	...
	/* Start of Section */
	$wp_customize->add_setting(
		'gf_stla_form_id_' . $current_form_id . '[submit-button][border-color]',
		array(
			'default'   => '',
			'transport' => 'postMessage',
			'type'      => 'option',

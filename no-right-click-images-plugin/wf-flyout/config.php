...
$config['plugin_screen'] = 'settings_page_no-right-click-images-plugin';
$config['icon_border'] = 'none';
$config['icon_right'] = '35px';
$config['icon_bottom'] = '35px';
$config['icon_image'] = 'no-right-click-images.png';
...
$config['menu_items'] = array(
  array('href' => 'https://wploginlockdown.com/?ref=wff-right-click', 'label' => 'Get Login Lockdown PRO with a special discount', 'icon' => 'lockdown.png', 'class' => 'lockdown-icon open-pro-dialog'),
  ...
  array('href' => 'https://wordpress.org/support/plugin/no-right-click-images-plugin/reviews/#new-post', 'target' => '_blank', 'label' => 'Rate the Plugin', 'icon' => 'dashicons-thumbs-up'),
  array('href' => 'https://wordpress.org/support/plugin/no-right-click-images-plugin/', 'target' => '_blank', 'label' => 'Get Support', 'icon' => 'dashicons-sos'),
);

...
To complete your login, copy and paste the temporary password into the Password field on the login screen.',
			'app_title' => '',
			'message' => __( 'You are required to setup two-factor authentication to use this site.', 'defender-security' ),
		];
	}
	...
	protected function before_load(): void {
		...
		$this->app_text = __( 'Open your authentication app and type the 6 digit passcode to log in to your account.', 'defender-security' );
	}
	...
	public function labels(): array {
		return [
			...
			'force_auth_roles' => __( 'Force users to log in with two-factor authentication', 'defender-security' ),
			'force_auth_mess' => __( 'Force 2FA login warning message', 'defender-security' ),
			'custom_graphic' => __( 'Custom Graphic', 'defender-security' ),
			'custom_graphic_type' => __( 'Enable custom graphics above login fields', 'defender-security' ),
			'custom_graphic_url' => __( 'Upload Graphic', 'defender-security' ),
			'custom_graphic_link' => __( 'Link Graphic', 'defender-security' ),
			'app_title' => __( 'App Title', 'defender-security' ),

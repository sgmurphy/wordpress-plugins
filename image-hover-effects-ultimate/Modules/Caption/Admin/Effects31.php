...
class Effects31 extends Modules {
    ...
    public function register_effects() {
        return $this->add_control(
                    ...
                    'default' => '',
                    'options' => [
                        'oxi-image-zoom-in' => esc_html__('Zoom In', 'image-hover-effects-ultimate'),
                        'oxi-image-zoom-out' => esc_html__('Zoom Out', 'image-hover-effects-ultimate'),
                        'oxi-image-zoom-out-up' => esc_html__('Zoom Out Up', 'image-hover-effects-ultimate'),
                        'oxi-image-zoom-out-down' => esc_html__('Zoom Out Down', 'image-hover-effects-ultimate'),
                        'oxi-image-zoom-out-left' => esc_html__('Zoom Out Left', 'image-hover-effects-ultimate'),
                        'oxi-image-zoom-out-right' => esc_html__('Zoom Out Right', 'image-hover-effects-ultimate'),
                        'oxi-image-zoom-out-flip-horizontal' => esc_html__('Zoom Out Flip Horizontal', 'image-hover-effects-ultimate'),
                        'oxi-image-zoom-out-flip-vertical' => esc_html__('Zoom Out Flip Vertical', 'image-hover-effects-ultimate'),
                    ],
                    'selector' => [

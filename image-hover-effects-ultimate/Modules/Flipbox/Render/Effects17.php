            ...
            ?>"  <?php $this->animation_render('oxi-image-hover-animation', $style); ?>>
                <div class="oxi-image-hover-style-flipbox">
                    ...
                    if ($this->checkurl_render('image_hover_button_link', $value) === true && empty($value['image_hover_button_text'])):
                        ...
                        ?>
                        <div class="oxi-image-hover oxi-image-flipbox-hover oxi-image-flipbox-hover-style-17 oxi-image-flipbox-hover-<?php echo esc_attr($this->oxiid); ?>-<?php echo esc_attr($val['id']); ?>">
                            <div class="oxi-image-hover-figure <?php echo esc_attr($style['image_hover_effects']); ?> <?php echo esc_attr($style['image_hover_timing_type']); ?>">
                                        ...
                                        <div class="oxi-image-hover-figure-front-section-body">
                                            ...
                                            <div class="oxi-image-hover-figure-front-section-heading-body">
                                                ...
                                                if ($value['image_hover_front_heading'] != ''):
                                                    ?>
                                                    <div class="oxi-image-hover-heading "><?php $this->text_render($value['image_hover_front_heading']); ?></div>
                                                    <?php
                                                endif;
                                                ?>
                                            </div>
                                ...
                                <div class="oxi-image-hover-figure-backend">
                                    <div class="oxi-image-hover-figure-back-section ">
                                        <div class="oxi-image-hover-figure-backend-section-body <?php echo esc_attr($this->style['oxi-image-flip-back-content-alignment']); ?>">
                                            <?php

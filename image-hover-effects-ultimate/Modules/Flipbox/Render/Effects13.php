            ...
            ?>"  <?php $this->animation_render('oxi-image-hover-animation', $style); ?>>
                <div class="oxi-image-hover-style-flipbox">
                    ...
                    if ($this->checkurl_render('image_hover_button_link', $value) === true && empty($value['image_hover_button_text'])):
                        ...
                        ?>
                        <div class="oxi-image-hover oxi-image-flipbox-hover oxi-image-flipbox-hover-style-13 oxi-image-flipbox-hover-<?php echo esc_attr($this->oxiid); ?>-<?php echo esc_attr($val['id']); ?>">
                                    ...
                                    <div class="oxi-image-hover-figure-front-section-body">
                                        <div class="oxi-image-hover-figure-front-section  <?php echo esc_attr($this->style['oxi-image-flip-front-alignment']); ?>">
                                            ...
                                            if ($value['image_hover_front_number'] != ''):
                                                ?>
                                                <div class="oxi-image-hover-number"><?php $this->text_render($value['image_hover_front_number']); ?></div>
                                                <?php
                                            endif;
                                    ...
                                    <div class="oxi-image-hover-figure-backend-section-body">
                                        <div class="oxi-image-hover-figure-back-section <?php echo esc_attr($this->style['oxi-image-flip-back-content-alignment']); ?>">
                                            ...
                                            if ($value['image_hover_back_icon'] != ''):
                                                ?>
                                                <div class="oxi-image-hover-icon  <?php echo esc_attr($this->style['oxi-image-flip-back-icon-animation']); ?>  <?php echo esc_attr($this->style['oxi-image-flip-back-icon-animation-delay']); ?>"><?php $this->font_awesome_render($value['image_hover_back_icon']); ?></div>
                                                <?php
                                            endif;

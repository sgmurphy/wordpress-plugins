            ...
            ?>"  <?php $this->animation_render('oxi-image-hover-animation', $style); ?>>
                <div class="oxi-image-hover-style-flipbox">
                    ...
                    if ($this->checkurl_render('image_hover_button_link', $value) === true && empty($value['image_hover_button_text'])):
                        ...
                        ?>
                        <div class="oxi-image-hover oxi-image-flipbox-hover oxi-image-flipbox-hover-style-12 oxi-image-flipbox-hover-<?php echo esc_attr($this->oxiid); ?>-<?php echo esc_attr($val['id']); ?>">
                                ...
                                <div class="oxi-image-hover-figure-frontend">
                                    <div class="oxi-image-hover-figure-front-section  <?php echo esc_attr($this->style['oxi-image-flip-front-alignment']); ?>">
                                        ...
                                        if ($value['image_hover_front_heading'] != ''):
                                            ?>
                                            <div class="oxi-image-hover-heading ' . (isset($style['oxi-image-flip-front-heading-underline']) ? $style['oxi-image-flip-front-heading-underline'] : '') . '"><?php $this->text_render($value['image_hover_front_heading']); ?></div>
                                            <?php
                                        endif;
                                        ?>
                                    </div>
                                ...
                                <div class="oxi-image-hover-figure-backend">
                                    <div class="oxi-image-hover-figure-back-section <?php echo esc_attr($this->style['oxi-image-flip-back-content-alignment']); ?>">
                                        ...
                                        if ($value['image_hover_back_heading'] != ''):
                                            ?>
                                            <div class="oxi-image-hover-heading <?php
                                            if (isset($style['oxi-image-flip-back-heading-underline'])):
                                                echo esc_attr($style['oxi-image-flip-back-heading-underline']);
                                            endif;
                                            ?> <?php echo esc_attr($this->style['oxi-image-flip-back-heading-animation']); ?>  <?php echo esc_attr($this->style['oxi-image-flip-back-animation-delay']); ?>"> <?php $this->text_render($value['image_hover_back_heading']); ?></div>
                                                 <?php
                                             endif;
                                             if ($value['image_hover_back_icon'] != ''):
                                                 ?>
                                            <div class="oxi-image-hover-icon <?php
                                            if (isset($style['oxi-image-flip-back-icon-underline'])):
                                                echo esc_attr($style['oxi-image-flip-back-icon-underline']);
                                            endif;
                                            ?>  <?php echo esc_attr($this->style['oxi-image-flip-back-icon-animation']); ?>  <?php echo esc_attr($this->style['oxi-image-flip-back-icon-animation-delay']); ?>"><?php $this->font_awesome_render($value['image_hover_back_icon']); ?>
                                            </div>
                                                 <?php
                                             endif;

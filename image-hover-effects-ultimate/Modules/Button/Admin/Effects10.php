...
class Effects10 extends Modules {
    ...
    public function register_effects() {
        return $this->add_control(
                    ...
                    'options' => [
                        'left_to_right' => esc_html__('Horizontal in Out', 'image-hover-effects-ultimate'),
                        'right_to_left' => esc_html__('Vertical In Out', 'image-hover-effects-ultimate'),
                        'top_to_bottom' => esc_html__('Horizontal In', 'image-hover-effects-ultimate'),
                        'bottom_to_top' => esc_html__('Vertical In', 'image-hover-effects-ultimate'),
                    ],
                    'selector' => [

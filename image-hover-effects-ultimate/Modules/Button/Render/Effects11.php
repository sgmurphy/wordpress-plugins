        ...
        foreach ($child as $key => $val) {
            ...
            ?>" <?php $this->animation_render('oxi-image-hover-animation', $style); ?>>
                <div class="oxi-image-hover-style-button">
                    <div class="oxi-image-hover oxi-image-button-hover oxi-image-button-hover-style-11 oxi-image-button-hover-<?php echo esc_attr($this->oxiid); ?>-<?php echo esc_attr($val['id']); ?>">

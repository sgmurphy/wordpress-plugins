...
trait Dynamic
{
    ...
    public function register_dynamic_load_more_button()
    {
        ...
        $this->add_control(
            'image_hover_dynamic_load_button_text',
            $this->style,
            [
        ...
        $this->add_group_control(
            'image_hover_dynamic_load_button_typho',
            $this->style,
            [
        ...
        $this->start_controls_tab();
        $this->add_control(
            'image_hover_dynamic_load_button_color',
            $this->style,
            [
        ...
        $this->add_control(
            'image_hover_dynamic_load_button_background',
            $this->style,
            [
                'label' => esc_html__('Background', 'image-hover-effects-ultimate'),
        ...
        $this->add_group_control(
            'image_hover_dynamic_load_button_tx_shadow',
            $this->style,
            [
        ...
        $this->start_controls_tab();
        $this->add_control(
            'image_hover_dynamic_load_button_hover_color',
            $this->style,
            [
                'label' => esc_html__('Color', 'image-hover-effects-ultimate'),
                'type' => Controls::COLOR,
        ...
        $this->add_control(
            'image_hover_dynamic_load_button_hover_background',
            $this->style,
            [
                'label' => esc_html__('Background', 'image-hover-effects-ultimate'),
                'type' => Controls::GRADIENT,
        ...
        $this->add_group_control(
            'image_hover_dynamic_load_button_hover_tx_shadow',
            $this->style,
            [
                'type' => Controls::TEXTSHADOW,
                'selector' => [
        ...
        $this->add_group_control(
            'image_hover_dynamic_load_button_boxshadow',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            'image_hover_dynamic_load_button_radius',
            $this->style,
            [
                'label' => esc_html__('Border Radius', 'image-hover-effects-ultimate'),
                'type' => Controls::DIMENSIONS,
        ...
        $this->add_responsive_control(
            'image_hover_dynamic_load_button_padding',
            $this->style,
            [
        ...
        $this->add_responsive_control(
            'image_hover_dynamic_load_button_margin',
            $this->style,
            [

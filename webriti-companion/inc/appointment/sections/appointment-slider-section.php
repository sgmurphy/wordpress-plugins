...
if (!function_exists('appointment_slider')) :
    ...
    function appointment_slider() {
        ...
        $slider_setting = wp_parse_args(get_option('appointment_options', array()), $appointment_options);
		 $home_banner_enabled=$slider_setting['home_banner_enabled'];
        if ($slider_setting['home_banner_enabled'] == 0 || $slider_setting['home_banner_enabled'] == '') {
            $theme = wp_get_theme();
...
if( class_exists('Spice_Slider_Pro') && !empty(get_theme_mod('wc_sps_shortcode'))&&(get_theme_mod('slide_variation','banner_image')=='post_slider')){
    if ($slider_setting['home_banner_enabled'] == 0 || $slider_setting['home_banner_enabled'] == ''): echo do_shortcode( get_theme_mod('wc_sps_shortcode') ); endif; 
}
                                    ...
                                    ?>">
                                            ...
                                            <div class="container slide-caption">
                                                ...
                                                if ($the_query->post_content == "") {
                                                    echo appointment_get_home_slider_excerpt();
                                                }
                                                ?>
                                            </div>
                                        <?php } else {

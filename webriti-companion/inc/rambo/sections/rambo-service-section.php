...
<a <?php if(!empty($link)){?> href="<?php echo esc_url( $link ); ?>" <?php } ?><?php if($opennewtab == 'yes'){ echo 'target="_blank"';}?>>
		...
		$icon = array('fa-solid fa-gears','fa-solid fa-mobile-screen','fa fa-user','fa-solid fa-laptop');
		for($i=0; $i<=3; $i++) {
		?>
...
function rambo_get_service_default() {
	...
	return apply_filters(
		'quality_service_default_content', json_encode(
			array(
				array(
					'icon_value' => 'fa-solid fa-gears txt-pink',
				...
				array(
					'icon_value' => 'fa-solid fa-mobile-screen txt-pink',
				...
				array(
					'icon_value' => 'fa-solid fa-users txt-pink',
...
{	
			...
			'service_one_icon' => 'fa-solid fa-gears txt-pink',
			'service_two_icon' => 'fa-solid fa-mobile-screen txt-pink',
			'service_three_icon' => 'fa-solid fa-users txt-pink',
			'service_four_icon' => 'fa-solid fa-laptop txt-pink',

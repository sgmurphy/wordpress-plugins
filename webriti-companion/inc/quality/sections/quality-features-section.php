        ...
        return apply_filters(
                'quality_service_default_content', json_encode(
                        array(
                            ...
                            array(
                                'icon_value' => 'fa-solid fa-star-half-stroke',
                                'title' => esc_html__('Donec tristique', 'webriti-companion'),
                                'text' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed dosit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut.', 'quality'),
                                'choice' => 'customizer_repeater_icon',
                                'link' => '#',
...
function plugin_data_setup() {
    ...
    return $theme_options = array(
        ...
        'service_one_icon' => 'fa-solid fa-gears',
        'service_two_icon' => 'fa-solid fa-mobile-screen',
        'service_three_icon' => 'fa-solid fa-users',
        'service_four_icon' => 'fa-solid fa-laptop',
        'service_five_icon' => 'fa-solid fa-code',
        'service_six_icon' => 'fa-solid fa-star-half-stroke',

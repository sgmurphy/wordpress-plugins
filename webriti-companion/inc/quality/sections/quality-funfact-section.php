...
<div class="container">
		...
		<?php endif; } } else { ?>
			<div class="col-lg-3 col-md-3 col-sm-6">	
				<div class="funfact-inner text-center">
					<i class="fa-regular fa-face-smile funfact-icon"></i>
			...
			<div class="col-lg-3 col-md-3 col-sm-6">		
				<div class="funfact-inner text-center">
					<i class="fa-regular fa-handshake funfact-icon"></i>
					<h1 class="funfact-title"><?php echo esc_html__('2500','quality'); ?></h1>
			...
			<div class="col-lg-3 col-md-3 col-sm-6">		
				<div class="funfact-inner text-center">
					<i class="fa-solid fa-chart-line funfact-icon"></i>
			...
			<div class="col-lg-3 col-md-3 col-sm-6">			
				<div class="funfact-inner text-center">
					<i class="fa-solid fa-mug-saucer funfact-icon"></i>

            ...
            <table>
                ...
                <tr>
                    ...
                    <th class="product" style="background:#69C7F1;border-top-left-radius:5px;border-left:0px;">
                        <span style="display:block"><?php echo __('Personal', "ays-popup-box"); ?></span>
                    ...
                    <th class="product" style="background:#69C7F1;">
                        <span style="display:block"><?php echo __('Business', "ays-popup-box"); ?></span>
                    ...
                    <th class="product" style="background:#69C7F1;border-top-right-radius:5px;border-right:0px;">
                        <span style="display:block"><?php echo __('Developer', "ays-popup-box"); ?></span>
                ...
                <tr>
                    ...
                    <th class="price-info">
                        <div class="price-now">
                            <span><?php echo __('Free', "ays-popup-box"); ?></span>
                        </div>
                    </th>
                    <th class="price-info">
                        <div class="price-now">
        ...
        <div class="ays-pb-guarantee-container-main">
            <div class="ays-pb-guarantee-container">
                ...
                <div class="ays-pb-guarantee-text-container">
                    ...
                    <p>
                        <?php echo __("We're sure that you'll love our Popup box plugin, but, if for some reason, you're not
                        satisfied in the first 30 days of using our product, there is a money-back guarantee and
                        we'll issue a refund.", "ays-popup-box"); ?>
                    </p>
                </div>
            </div>
        </div>

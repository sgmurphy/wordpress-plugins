...
if ( ! class_exists( 'Responsive_Add_Ons_Custom_Fonts_Taxonomy' ) ) :

	/**
	 * Responsive_Custom_Fonts_Taxonomy
	 */
	class Responsive_Add_Ons_Custom_Fonts_Taxonomy {
		/**
		 * Instance of Responsive_Custom_Fonts_Taxonomy
		 *
		 * @since  1.0.0
		 * @var (Object) Responsive_Add_Ons_Custom_Fonts_Taxonomy
		 */
	 ...
	 */
	Responsive_Add_Ons_Custom_Fonts_Taxonomy::get_instance();

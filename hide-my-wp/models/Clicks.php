    ...
    public function disableKeysAndClicks()
    {
        ...
        <script type="text/javascript">
            ...
            (function() {"use strict";
                ...
                function __showError(message) {var div = document.getElementById('disable_msg');if (div && (!div.style.display || div.style.display == 'none')) {div.innerHTML = message;div.style.display = 'block';setTimeout(function() {div.style.display = 'none';}, 1000);}}

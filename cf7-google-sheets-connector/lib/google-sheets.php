...
class CF7GSC_googlesheet {
   ...
   /////=========web app
    ...
    public static function preauth($access_code) {
        ...
        $clientId = ($newClientSecret == 1) ? CF7GSC_googlesheet::clientId_web : CF7GSC_googlesheet::clientId_desk;
        $clientSecret = ($newClientSecret == 1) ? CF7GSC_googlesheet::clientSecret_web : CF7GSC_googlesheet::clientSecret_desk;

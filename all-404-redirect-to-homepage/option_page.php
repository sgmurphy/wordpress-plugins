...
<hr/>
   ...
   <b style="color:red"><?php echo esc_html(P404REDIRECT_read_option_value('links',0));?></b> is the number of redirects that were made to many incorrect links on your site since the plugin install in <?php echo esc_attr(P404REDIRECT_read_option_value('install_date',date("Y-m-d h:i a")));?>
<hr/>

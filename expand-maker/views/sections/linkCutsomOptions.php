...
<div class="panel panel-default yrm-pro-options-wrapper">
    ...
    <div class="panel-body">
        <div class="row row-static-margin-bottom">
            ...
            <div class="col-xs-6">
                <input type="url" required="required" class="input-md form-control" placeholder="https://" name="link-button-url" value="<?php echo esc_attr($dataObj->getOptionValue('link-button-url'))?>"><br>
            </div>
        </div>
	    <div>
		    <b>Note:</b>

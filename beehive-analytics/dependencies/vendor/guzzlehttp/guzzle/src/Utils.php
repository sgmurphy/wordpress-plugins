...
use Beehive\GuzzleHttp\Exception\InvalidArgumentException;
use Beehive\GuzzleHttp\Handler\CurlHandler;
use Beehive\GuzzleHttp\Handler\CurlMultiHandler;
use Beehive\GuzzleHttp\Handler\Proxy;
use Beehive\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
    ...
    public static function debugResource($value = null)
    {
        ...
        return \Beehive\GuzzleHttp\Psr7\Utils::tryFopen('php://output', 'w');
    }
    /**

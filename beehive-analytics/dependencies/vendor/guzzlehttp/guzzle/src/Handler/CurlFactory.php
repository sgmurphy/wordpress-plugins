...
namespace Beehive\GuzzleHttp\Handler;

use Beehive\GuzzleHttp\Exception\ConnectException;
use Beehive\GuzzleHttp\Exception\RequestException;
use Beehive\GuzzleHttp\Promise as P;
use Beehive\GuzzleHttp\Promise\FulfilledPromise;
use Beehive\GuzzleHttp\Promise\PromiseInterface;
use Beehive\GuzzleHttp\Psr7\LazyOpenStream;
use Beehive\GuzzleHttp\TransferStats;
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf) : void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \Beehive\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \Beehive\GuzzleHttp\Psr7\Utils::streamFor($sink);

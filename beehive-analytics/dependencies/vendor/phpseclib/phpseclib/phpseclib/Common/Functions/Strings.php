 ...
 */
namespace Beehive\phpseclib3\Common\Functions;

use Beehive\ParagonIE\ConstantTime\Base64;
use Beehive\ParagonIE\ConstantTime\Base64UrlSafe;
use Beehive\ParagonIE\ConstantTime\Hex;
use Beehive\phpseclib3\Math\BigInteger;
use Beehive\phpseclib3\Math\Common\FiniteField;
/**
 * Common String Functions
 *
 * @author  Jim Wigginton <terrafrost@php.net>

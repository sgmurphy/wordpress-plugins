 ...
 */
namespace Beehive\phpseclib3\Crypt\EC\Formats\Keys;

use Beehive\phpseclib3\Crypt\Common\Formats\Keys\PKCS8 as Progenitor;
use Beehive\phpseclib3\Crypt\EC\BaseCurves\Base as BaseCurve;
...
use Beehive\phpseclib3\File\ASN1\Maps;
...
abstract class PKCS8 extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        if (!$params) {
            throw new \RuntimeException('Beehive\\Unable to decode the parameters using Maps\\ECParameters');
        }
        $components = [];

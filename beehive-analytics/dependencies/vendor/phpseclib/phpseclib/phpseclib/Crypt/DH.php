...
use Beehive\phpseclib3\Crypt\DH\Parameters;
use Beehive\phpseclib3\Crypt\DH\PrivateKey;
use Beehive\phpseclib3\Crypt\DH\PublicKey;
use Beehive\phpseclib3\Exception\NoKeyLoadedException;

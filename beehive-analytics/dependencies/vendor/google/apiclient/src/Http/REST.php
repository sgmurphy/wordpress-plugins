 ...
 */
namespace Beehive\Google\Http;

use Beehive\Google\Auth\HttpHandler\HttpHandlerFactory;
use Beehive\Google\Service\Exception as GoogleServiceException;
use Beehive\Google\Task\Runner;
...
class REST
{
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if (\interface_exists('Beehive\\GuzzleHttp\\Message\\ResponseInterface') && $response instanceof \Beehive\GuzzleHttp\Message\ResponseInterface) {

...
use Beehive\Google\Auth\CredentialSource\AwsNativeSource;
use Beehive\Google\Auth\CredentialSource\FileSource;
use Beehive\Google\Auth\CredentialSource\UrlSource;

 ...
 * @author Google, Inc.
 */
class AnalyticsData extends \Beehive\Google\Service
{
...
\class_alias(AnalyticsData::class, 'Beehive\\Google_Service_AnalyticsData');

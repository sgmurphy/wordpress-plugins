 ...
 * the License.
 */
namespace Beehive\Google\Service\Oauth2;

class Tokeninfo extends \Beehive\Google\Model
{
...
\class_alias(Tokeninfo::class, 'Beehive\\Google_Service_Oauth2_Tokeninfo');

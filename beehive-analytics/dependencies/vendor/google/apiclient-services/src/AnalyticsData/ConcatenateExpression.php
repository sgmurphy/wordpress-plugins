...
class ConcatenateExpression extends \Beehive\Google\Collection
{
...
\class_alias(ConcatenateExpression::class, 'Beehive\\Google_Service_AnalyticsData_ConcatenateExpression');

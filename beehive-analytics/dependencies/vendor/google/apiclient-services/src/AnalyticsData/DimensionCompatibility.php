...
class DimensionCompatibility extends \Beehive\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DimensionCompatibility::class, 'Beehive\\Google_Service_AnalyticsData_DimensionCompatibility');

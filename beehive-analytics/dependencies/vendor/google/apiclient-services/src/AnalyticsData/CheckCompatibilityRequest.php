...
class CheckCompatibilityRequest extends \Beehive\Google\Collection
{
...
\class_alias(CheckCompatibilityRequest::class, 'Beehive\\Google_Service_AnalyticsData_CheckCompatibilityRequest');

...
class BatchRunPivotReportsResponse extends \Beehive\Google\Collection
{
...
\class_alias(BatchRunPivotReportsResponse::class, 'Beehive\\Google_Service_AnalyticsData_BatchRunPivotReportsResponse');

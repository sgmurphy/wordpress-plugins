...
class ActiveMetricRestriction extends \Beehive\Google\Collection
{
...
\class_alias(ActiveMetricRestriction::class, 'Beehive\\Google_Service_AnalyticsData_ActiveMetricRestriction');

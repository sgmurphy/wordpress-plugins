 ...
 * the License.
 */
namespace Beehive\Google\Service\AnalyticsData\Resource;

use Beehive\Google\Service\AnalyticsData\BatchRunPivotReportsRequest;
use Beehive\Google\Service\AnalyticsData\BatchRunPivotReportsResponse;
use Beehive\Google\Service\AnalyticsData\BatchRunReportsRequest;
use Beehive\Google\Service\AnalyticsData\BatchRunReportsResponse;
use Beehive\Google\Service\AnalyticsData\CheckCompatibilityRequest;
use Beehive\Google\Service\AnalyticsData\CheckCompatibilityResponse;
use Beehive\Google\Service\AnalyticsData\Metadata;
use Beehive\Google\Service\AnalyticsData\RunPivotReportRequest;
use Beehive\Google\Service\AnalyticsData\RunPivotReportResponse;
...
\class_alias(Properties::class, 'Beehive\\Google_Service_AnalyticsData_Resource_Properties');

...
use Beehive\Google\Service\AnalyticsData\AudienceExport;
use Beehive\Google\Service\AnalyticsData\ListAudienceExportsResponse;
use Beehive\Google\Service\AnalyticsData\Operation;
use Beehive\Google\Service\AnalyticsData\QueryAudienceExportRequest;
use Beehive\Google\Service\AnalyticsData\QueryAudienceExportResponse;
/**
 ...
 *  </code>
 */
class PropertiesAudienceExports extends \Beehive\Google\Service\Resource
{
    /**
...
\class_alias(PropertiesAudienceExports::class, 'Beehive\\Google_Service_AnalyticsData_Resource_PropertiesAudienceExports');

...
class UpdateContactPhotoRequest extends \Beehive\Google\Collection
{
...
\class_alias(UpdateContactPhotoRequest::class, 'Beehive\\Google_Service_PeopleService_UpdateContactPhotoRequest');

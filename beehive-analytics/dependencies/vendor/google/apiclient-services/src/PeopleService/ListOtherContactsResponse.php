...
class ListOtherContactsResponse extends \Beehive\Google\Collection
{
...
\class_alias(ListOtherContactsResponse::class, 'Beehive\\Google_Service_PeopleService_ListOtherContactsResponse');

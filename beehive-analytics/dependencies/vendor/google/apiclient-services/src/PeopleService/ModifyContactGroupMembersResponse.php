...
class ModifyContactGroupMembersResponse extends \Beehive\Google\Collection
{
...
\class_alias(ModifyContactGroupMembersResponse::class, 'Beehive\\Google_Service_PeopleService_ModifyContactGroupMembersResponse');

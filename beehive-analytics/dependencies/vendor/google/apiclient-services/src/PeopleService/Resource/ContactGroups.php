...
use Beehive\Google\Service\PeopleService\BatchGetContactGroupsResponse;
use Beehive\Google\Service\PeopleService\ContactGroup;
use Beehive\Google\Service\PeopleService\CreateContactGroupRequest;
use Beehive\Google\Service\PeopleService\ListContactGroupsResponse;
use Beehive\Google\Service\PeopleService\PeopleEmpty;
use Beehive\Google\Service\PeopleService\UpdateContactGroupRequest;
/**
 ...
 *  </code>
 */
class ContactGroups extends \Beehive\Google\Service\Resource
{
    /**
...
\class_alias(ContactGroups::class, 'Beehive\\Google_Service_PeopleService_Resource_ContactGroups');

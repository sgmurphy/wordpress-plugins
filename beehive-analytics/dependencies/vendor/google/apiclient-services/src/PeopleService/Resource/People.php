 ...
 * the License.
 */
namespace Beehive\Google\Service\PeopleService\Resource;

use Beehive\Google\Service\PeopleService\BatchCreateContactsRequest;
use Beehive\Google\Service\PeopleService\BatchCreateContactsResponse;
use Beehive\Google\Service\PeopleService\BatchDeleteContactsRequest;
use Beehive\Google\Service\PeopleService\BatchUpdateContactsRequest;
use Beehive\Google\Service\PeopleService\BatchUpdateContactsResponse;
use Beehive\Google\Service\PeopleService\DeleteContactPhotoResponse;
use Beehive\Google\Service\PeopleService\GetPeopleResponse;
use Beehive\Google\Service\PeopleService\ListDirectoryPeopleResponse;
use Beehive\Google\Service\PeopleService\PeopleEmpty;
use Beehive\Google\Service\PeopleService\Person;
use Beehive\Google\Service\PeopleService\SearchDirectoryPeopleResponse;
use Beehive\Google\Service\PeopleService\SearchResponse;
use Beehive\Google\Service\PeopleService\UpdateContactPhotoRequest;
use Beehive\Google\Service\PeopleService\UpdateContactPhotoResponse;
/**
 ...
 *  </code>
 */
class People extends \Beehive\Google\Service\Resource
{
    /**
...
\class_alias(People::class, 'Beehive\\Google_Service_PeopleService_Resource_People');

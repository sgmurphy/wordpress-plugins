...
class ModifyContactGroupMembersRequest extends \Beehive\Google\Collection
{
...
\class_alias(ModifyContactGroupMembersRequest::class, 'Beehive\\Google_Service_PeopleService_ModifyContactGroupMembersRequest');

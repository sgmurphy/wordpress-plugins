...
class ContactGroupMembership extends \Beehive\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ContactGroupMembership::class, 'Beehive\\Google_Service_PeopleService_ContactGroupMembership');

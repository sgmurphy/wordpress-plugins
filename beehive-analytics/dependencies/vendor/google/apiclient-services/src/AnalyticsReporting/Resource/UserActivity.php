 ...
 * the License.
 */
namespace Beehive\Google\Service\AnalyticsReporting\Resource;

use Beehive\Google\Service\AnalyticsReporting\SearchUserActivityRequest;
use Beehive\Google\Service\AnalyticsReporting\SearchUserActivityResponse;
/**
 ...
 *  </code>
 */
class UserActivity extends \Beehive\Google\Service\Resource
{
    /**
...
\class_alias(UserActivity::class, 'Beehive\\Google_Service_AnalyticsReporting_Resource_UserActivity');

...
class ResourceQuotasRemaining extends \Beehive\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(ResourceQuotasRemaining::class, 'Beehive\\Google_Service_AnalyticsReporting_ResourceQuotasRemaining');

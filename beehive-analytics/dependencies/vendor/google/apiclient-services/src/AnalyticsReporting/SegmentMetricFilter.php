...
class SegmentMetricFilter extends \Beehive\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(SegmentMetricFilter::class, 'Beehive\\Google_Service_AnalyticsReporting_SegmentMetricFilter');

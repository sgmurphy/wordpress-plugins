...
class SegmentDimensionFilter extends \Beehive\Google\Collection
{
...
\class_alias(SegmentDimensionFilter::class, 'Beehive\\Google_Service_AnalyticsReporting_SegmentDimensionFilter');

...
class FilterAdvancedDetails extends \Beehive\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(FilterAdvancedDetails::class, 'Beehive\\Google_Service_Analytics_FilterAdvancedDetails');

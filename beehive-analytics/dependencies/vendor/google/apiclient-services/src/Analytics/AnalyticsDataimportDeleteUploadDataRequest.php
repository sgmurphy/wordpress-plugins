...
class AnalyticsDataimportDeleteUploadDataRequest extends \Beehive\Google\Collection
{
...
\class_alias(AnalyticsDataimportDeleteUploadDataRequest::class, 'Beehive\\Google_Service_Analytics_AnalyticsDataimportDeleteUploadDataRequest');

 ...
 *  </code>
 */
class ManagementProfileUserLinks extends \Beehive\Google\Service\Resource
{
    /**
...
\class_alias(ManagementProfileUserLinks::class, 'Beehive\\Google_Service_Analytics_Resource_ManagementProfileUserLinks');

 ...
 *  </code>
 */
class ManagementAccountUserLinks extends \Beehive\Google\Service\Resource
{
    /**
...
\class_alias(ManagementAccountUserLinks::class, 'Beehive\\Google_Service_Analytics_Resource_ManagementAccountUserLinks');

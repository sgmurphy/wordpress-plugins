...
class GoogleAnalyticsAdminV1betaDataRetentionSettings extends \Beehive\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleAnalyticsAdminV1betaDataRetentionSettings::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaDataRetentionSettings');

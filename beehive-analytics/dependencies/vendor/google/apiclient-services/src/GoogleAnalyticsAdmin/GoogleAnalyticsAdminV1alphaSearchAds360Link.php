...
class GoogleAnalyticsAdminV1alphaSearchAds360Link extends \Beehive\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(GoogleAnalyticsAdminV1alphaSearchAds360Link::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaSearchAds360Link');

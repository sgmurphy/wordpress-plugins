...
\class_alias(GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsResponse::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsResponse');

...
class GoogleAnalyticsAdminV1betaDataSharingSettings extends \Beehive\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleAnalyticsAdminV1betaDataSharingSettings::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaDataSharingSettings');

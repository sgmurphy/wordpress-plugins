...
class GoogleAnalyticsAdminV1betaGoogleAdsLink extends \Beehive\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(GoogleAnalyticsAdminV1betaGoogleAdsLink::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaGoogleAdsLink');

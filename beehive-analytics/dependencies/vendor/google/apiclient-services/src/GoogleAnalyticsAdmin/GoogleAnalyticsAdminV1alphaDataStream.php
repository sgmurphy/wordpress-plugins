...
class GoogleAnalyticsAdminV1alphaDataStream extends \Beehive\Google\Model
{
...
\class_alias(GoogleAnalyticsAdminV1alphaDataStream::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaDataStream');

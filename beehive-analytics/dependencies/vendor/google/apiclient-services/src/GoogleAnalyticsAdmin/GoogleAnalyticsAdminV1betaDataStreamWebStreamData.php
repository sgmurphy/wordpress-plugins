...
class GoogleAnalyticsAdminV1betaDataStreamWebStreamData extends \Beehive\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleAnalyticsAdminV1betaDataStreamWebStreamData::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaDataStreamWebStreamData');

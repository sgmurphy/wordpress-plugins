...
class GoogleAnalyticsAdminV1alphaAccessNumericFilter extends \Beehive\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleAnalyticsAdminV1alphaAccessNumericFilter::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaAccessNumericFilter');

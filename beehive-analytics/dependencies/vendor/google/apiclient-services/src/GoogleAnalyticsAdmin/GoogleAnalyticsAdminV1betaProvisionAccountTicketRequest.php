...
\class_alias(GoogleAnalyticsAdminV1betaProvisionAccountTicketRequest::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaProvisionAccountTicketRequest');

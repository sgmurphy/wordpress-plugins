...
class GoogleAnalyticsAdminV1betaAccessQuota extends \Beehive\Google\Model
{
    /**
...
\class_alias(GoogleAnalyticsAdminV1betaAccessQuota::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaAccessQuota');

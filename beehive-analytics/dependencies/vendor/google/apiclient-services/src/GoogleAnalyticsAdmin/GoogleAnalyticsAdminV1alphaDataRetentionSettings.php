...
class GoogleAnalyticsAdminV1alphaDataRetentionSettings extends \Beehive\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleAnalyticsAdminV1alphaDataRetentionSettings::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaDataRetentionSettings');

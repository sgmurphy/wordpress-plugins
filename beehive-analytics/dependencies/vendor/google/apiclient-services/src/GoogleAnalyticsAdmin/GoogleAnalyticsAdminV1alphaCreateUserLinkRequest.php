...
class GoogleAnalyticsAdminV1alphaCreateUserLinkRequest extends \Beehive\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(GoogleAnalyticsAdminV1alphaCreateUserLinkRequest::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaCreateUserLinkRequest');

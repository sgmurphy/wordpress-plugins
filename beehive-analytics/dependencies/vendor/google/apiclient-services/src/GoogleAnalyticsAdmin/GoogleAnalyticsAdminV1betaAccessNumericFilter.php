...
class GoogleAnalyticsAdminV1betaAccessNumericFilter extends \Beehive\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleAnalyticsAdminV1betaAccessNumericFilter::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaAccessNumericFilter');

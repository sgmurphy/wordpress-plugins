...
\class_alias(GoogleAnalyticsAdminV1betaListDataStreamsResponse::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaListDataStreamsResponse');

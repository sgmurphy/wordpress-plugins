...
class GoogleAnalyticsAdminV1alphaDataStreamWebStreamData extends \Beehive\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleAnalyticsAdminV1alphaDataStreamWebStreamData::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaDataStreamWebStreamData');

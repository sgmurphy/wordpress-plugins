 ...
 *  </code>
 */
class AccountsUserLinks extends \Beehive\Google\Service\Resource
{
    /**
...
\class_alias(AccountsUserLinks::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_Resource_AccountsUserLinks');

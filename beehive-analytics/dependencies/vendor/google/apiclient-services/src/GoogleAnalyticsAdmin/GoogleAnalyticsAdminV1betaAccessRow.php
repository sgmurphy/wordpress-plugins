...
class GoogleAnalyticsAdminV1betaAccessRow extends \Beehive\Google\Collection
{
...
\class_alias(GoogleAnalyticsAdminV1betaAccessRow::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaAccessRow');

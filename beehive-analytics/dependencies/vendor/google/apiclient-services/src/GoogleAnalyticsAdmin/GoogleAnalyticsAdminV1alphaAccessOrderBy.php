...
class GoogleAnalyticsAdminV1alphaAccessOrderBy extends \Beehive\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(GoogleAnalyticsAdminV1alphaAccessOrderBy::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaAccessOrderBy');

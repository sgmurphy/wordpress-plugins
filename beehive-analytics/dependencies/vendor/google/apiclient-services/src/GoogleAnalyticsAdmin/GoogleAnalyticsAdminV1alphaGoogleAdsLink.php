...
class GoogleAnalyticsAdminV1alphaGoogleAdsLink extends \Beehive\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(GoogleAnalyticsAdminV1alphaGoogleAdsLink::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaGoogleAdsLink');

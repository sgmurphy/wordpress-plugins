...
class GoogleAnalyticsAdminV1alphaAccessQuota extends \Beehive\Google\Model
{
...
\class_alias(GoogleAnalyticsAdminV1alphaAccessQuota::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaAccessQuota');

...
class GoogleAnalyticsAdminV1alphaWebDataStream extends \Beehive\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(GoogleAnalyticsAdminV1alphaWebDataStream::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaWebDataStream');

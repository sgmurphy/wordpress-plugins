...
class GoogleAnalyticsAdminV1alphaAudienceDimensionOrMetricFilter extends \Beehive\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(GoogleAnalyticsAdminV1alphaAudienceDimensionOrMetricFilter::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaAudienceDimensionOrMetricFilter');

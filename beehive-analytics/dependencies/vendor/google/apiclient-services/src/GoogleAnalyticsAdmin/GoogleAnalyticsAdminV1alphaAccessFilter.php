...
class GoogleAnalyticsAdminV1alphaAccessFilter extends \Beehive\Google\Model
{
...
\class_alias(GoogleAnalyticsAdminV1alphaAccessFilter::class, 'Beehive\\Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaAccessFilter');

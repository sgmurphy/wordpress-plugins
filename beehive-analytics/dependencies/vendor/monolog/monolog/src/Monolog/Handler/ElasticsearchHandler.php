...
use Beehive\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use Beehive\Monolog\Logger;
use Beehive\Monolog\Formatter\FormatterInterface;
use Beehive\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use Beehive\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use Beehive\Elasticsearch\Client;
use Beehive\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use Beehive\Elastic\Elasticsearch\Client as Client8;
/**

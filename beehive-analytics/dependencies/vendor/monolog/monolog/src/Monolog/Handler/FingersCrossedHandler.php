...
use Beehive\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use Beehive\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
use Beehive\Monolog\Logger;
use Beehive\Monolog\ResettableInterface;

...
use Beehive\Elastica\Document;
use Beehive\Monolog\Formatter\FormatterInterface;
use Beehive\Monolog\Formatter\ElasticaFormatter;
use Beehive\Monolog\Logger;
use Beehive\Elastica\Client;
use Beehive\Elastica\Exception\ExceptionInterface;
/**

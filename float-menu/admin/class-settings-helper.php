...
class Settings_Helper {
	...
	public static function icon_anim(): array {
		return [
			''             => __( 'None', 'float-menu' ),
			'fa-beat'      => __( 'Beat', 'float-menu' ),
			'fa-fade'      => __( 'Fade', 'float-menu' ),
			'fa-beat-fade' => __( 'Beat-Fade', 'float-menu' ),
			'fa-bounce'    => __( 'Bounce', 'float-menu' ),
			'fa-flip'      => __( 'Flip', 'float-menu' ),
			'fa-shake'     => __( 'Shake', 'float-menu' ),
			'fa-spin'      => __( 'Spin', 'float-menu' ),
		];
	}

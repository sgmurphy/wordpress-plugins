( function( $ ){
    ...
    $.fn.factoryBootstrap477_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap477_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-477 .factory-integer").factoryBootstrap477_integerControl();
    });

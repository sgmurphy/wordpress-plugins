( function( $ ){
    ...
    $.fn.factoryBootstrap477_gradientControl = function (option) {
    ...
    $.fn.factoryBootstrap477_gradientControl.Constructor = GradientControl;
    
    // GRADIENT CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-477 .factory-gradient").factoryBootstrap477_gradientControl();
    });

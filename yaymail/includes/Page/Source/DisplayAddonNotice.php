<?php
	$list_support_plugins_class = array(
		...
		'Marketkingcore'                        => array(
			'plugin_name'  => 'Marketkingcore',
			'plugin_title' => 'MarketKing Core',
		),
		'AFWC_Affiliate'                    => array(
			'plugin_name'  => 'Affiliate_Woo',
			'plugin_title' => 'Affiliate For WooCommerce',
		),
	);

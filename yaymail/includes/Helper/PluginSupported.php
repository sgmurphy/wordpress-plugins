		...
		$arrAddonSupported = array(
			...
			'Dokan'                                        => array(
				...
				'template_name' => array(
					...
					'dokan_stripe_express_email_invoice_authentication',
			...
			// TODO change link
			'Wc_Cart_Abandonment_Recovery'                 => array(
				'plugin_name'   => 'WooCommerce Cart Abandonment Recovery',
				'template_name' => apply_filters( 'YaymailCreateListWcCartAbandonmentRecoveryNames', array() ),
			...
			'B2B_Market'                                   => array(
				...
				'template_name' => apply_filters( 'YaymailCreateListB2BMarketNames', array() ),
			...
			'Bookings and Appointments For WooCommerce Premium' => array(
				'plugin_name'   => 'phive_booking_initialze_premium',
				'template_name' => array(
					'ph_booking_cancelled',
					'ph_booking_confirmation',
					'ph_booking_requires_confirmation',
					'ph_booking_followup',
					'ph_booking_reminder',
				),
				'link_upgrade'  => 'https://yaycommerce.com/yaymail-addons/yaymail-addon-for-woocommerce-booking-and-appointments-pluginhive',
			),
			'Shop_Magic_For_Wc'                            => array(
				'plugin_name'   => 'Shop Magic for WooCommerce',
				'template_name' => apply_filters( 'YaymailCreateListShopMagicNames', array() ),
				'link_upgrade'  => 'https://yaycommerce.com/yaymail-addons/yaymail-addon-for-shopmagic',
			),
			'WooCommerce Contact for Shipping Quote'       => array(
				'plugin_name'   => 'WooCommerce_Contact_For_Shipping_Quote',
				'template_name' => array(
					'customer_shipping_quote_available',

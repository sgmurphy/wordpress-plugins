...
* Bug Fix: The Total Product Price that has Add On fluctuate randomly/increasingly in the cart
* Bug Fix: WC 8.3: Missing custom fields on order editor
* Bug Fix: WC All Products Subscriptions conflict

= 2.1.10 =
* Improvement: Declare incompatible with WC Cart/Checkout blocks (compatibility work-in-progress)
* Improvement: Make the new Cart/Checkout blocks incompability notice only shows in WC 8.3+
* Improvement: Remove Order Form Link from Wholesale > Settings
* Bug Fix: New Settings UI: Back to the license page gets "You are redirecting to a page. Please wait..."
* Bug Fix: New Settings UI: External tab link
* Bug Fix: New Settings UI: Show Wholesale Price to non-wholesale users - some features should be enabled when having WWOF and WWLC activated
* Bug Fix: New Settings UI: The admin notices are not showing
* Bug Fix: New Settings UI: The dropdown options of the Wholesale Stock Display Format are getting cut off
* Bug Fix: PHP 8.2 compatibility
* Bug Fix: Wholesale percentage discount not following Woocommerce decimal points settings
* Bug Fix: wholesale percetage discount calculation not following WC number of decimals

...
<form action="" method="POST"><input type="hidden" name="_wpnonce" value="<?php echo wp_create_nonce('fields-nonce'); ?>"><input type="hidden" name="column_count_saphali" value="1"/><input type="hidden" name="clear" value="1"/><input type="submit" class="button alignright" value="Сброс на умолчание"/></form> 
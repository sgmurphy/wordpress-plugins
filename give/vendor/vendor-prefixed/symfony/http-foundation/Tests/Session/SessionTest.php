 ...
 *
 * Modified by impress-org on 10-April-2024 using Strauss.
 * @see https://github.com/BrianHenryIE/strauss
 */

namespace Give\Vendors\Symfony\Component\HttpFoundation\Tests\Session;
...
use Give\Vendors\Symfony\Component\HttpFoundation\Session\Session;
use Give\Vendors\Symfony\Component\HttpFoundation\Session\SessionBagProxy;
use Give\Vendors\Symfony\Component\HttpFoundation\Session\Storage\MockArraySessionStorage;
...
{
    /**
     * @var \Give\Vendors\Symfony\Component\HttpFoundation\Session\Storage\SessionStorageInterface
     */
    protected $storage;

    /**
     * @var \Give\Vendors\Symfony\Component\HttpFoundation\Session\SessionInterface
     */
    protected $session;
    ...
    {
        $this->assertInstanceOf('Give\\Vendors\\Symfony\\Component\\HttpFoundation\\Session\\Flash\\FlashBagInterface', $this->session->getFlashBag());
    }
    ...
    {
        $this->assertInstanceOf('Give\Vendors\Symfony\Component\HttpFoundation\Session\Storage\MetadataBag', $this->session->getMetadataBag());
    }

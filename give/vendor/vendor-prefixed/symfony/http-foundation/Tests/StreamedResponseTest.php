...
use Give\Vendors\Symfony\Component\HttpFoundation\StreamedResponse;
...
class StreamedResponseTest extends TestCase
{
    ...
    public function testCreate()
    {
        ...
        $this->assertInstanceOf('Give\Vendors\Symfony\Component\HttpFoundation\StreamedResponse', $response);
    ...
    public function testReturnThis()
    {
        ...
        $this->assertInstanceOf('Give\Vendors\Symfony\Component\HttpFoundation\StreamedResponse', $response->sendContent());
        $this->assertInstanceOf('Give\Vendors\Symfony\Component\HttpFoundation\StreamedResponse', $response->sendContent());

        $response = new StreamedResponse(function () {});
        $this->assertInstanceOf('Give\Vendors\Symfony\Component\HttpFoundation\StreamedResponse', $response->sendHeaders());
        $this->assertInstanceOf('Give\Vendors\Symfony\Component\HttpFoundation\StreamedResponse', $response->sendHeaders());
    }

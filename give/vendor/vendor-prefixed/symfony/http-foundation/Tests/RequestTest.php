...
namespace Give\Vendors\Symfony\Component\HttpFoundation\Tests;

use PHPUnit\Framework\TestCase;
use Give\Vendors\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException;
use Give\Vendors\Symfony\Component\HttpFoundation\Request;
...
class RequestTest extends TestCase
{
    ...
    {
        $this->expectException('Give\Vendors\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException');
        $request = new Request();
    ...
    {
        $class = new \ReflectionClass('Give\\Vendors\\Symfony\\Component\\HttpFoundation\\Request');
    ...
    /**
     * @group legacy
     * @expectedDeprecation The "Give\Vendors\Symfony\Component\HttpFoundation\Request::setTrustedHeaderName()" method is deprecated since Symfony 3.3 and will be removed in 4.0. Use the $trustedHeaderSet argument of the Request::setTrustedProxies() method instead.
     */

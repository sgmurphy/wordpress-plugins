...
?>
	...
	<label><input type='checkbox' name='wcbloat_uninstall_cleanup' <?php checked(esc_attr($value), 'yes'); ?> value='yes'> <?php esc_attr_e('Clear plugin settings while deleting the plugin', 'disable-dashboard-for-woocommerce'); ?></label>

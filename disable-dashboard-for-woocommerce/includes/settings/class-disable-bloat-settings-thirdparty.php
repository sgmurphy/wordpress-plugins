...
function wcbloat_thirdparty_settings_init()
{
	...
	add_settings_field(
		...
		esc_attr__('Jetpack installation notice', 'disable-dashboard-for-woocommerce'),
	...
	add_settings_field(
		...
		esc_attr__('Jetpack promotions', 'disable-dashboard-for-woocommerce'),
	...
	// Disable Blaze feature in Jetpack
	add_settings_field(
		'wcbloat_jetpack_blaze_disable',
		esc_attr__('Disable Jetpack Blaze', 'disable-dashboard-for-woocommerce'),
		'wcbloat_jetpack_blaze_disable_callback',
		'wcbloat-thirdparty',
		'wcbloat_jetpack_section'
	);
	register_setting(
	...
	add_settings_field(
		...
		esc_attr__('Elementor Dashboard widget', 'disable-dashboard-for-woocommerce'),
	...
	add_settings_field(
		...
		esc_attr__('Elementor Google Fonts', 'disable-dashboard-for-woocommerce'),
		'wcbloat_elementor_google_fonts_callback',
		'wcbloat-thirdparty',
		'wcbloat_elementor_section'
	);
	register_setting(
	...
	add_settings_field(
		...
		esc_attr__('SkyVerge Dashboard', 'disable-dashboard-for-woocommerce'),
	...
	add_settings_field(
		...
		esc_attr__('Ads, Premium nags, Premium menu', 'disable-dashboard-for-woocommerce'),
	...
	add_settings_field(
		...
		esc_attr__('Remove HTML Comments from the Front-end', 'disable-dashboard-for-woocommerce'),
	...
	add_settings_field(
		...
		esc_attr__('Remove Yoast SEO Dashboard widget', 'disable-dashboard-for-woocommerce'),
	...
	add_settings_field(
		'wcbloat_cf7_disable',
		esc_attr__('Contact Form 7 JavaScript and CSS', 'disable-dashboard-for-woocommerce'),
	...
	add_settings_field(
		...
		esc_attr__('Hide "UpdraftPlus" on admin toolbar', 'disable-dashboard-for-woocommerce'),
	...
	add_settings_field(
		...
		esc_attr__('Hide Advanced Custom Fields admin menu', 'disable-dashboard-for-woocommerce'),
	...
	add_settings_field(
		...
		esc_attr__('Remove WPML Meta Generator Tag', 'disable-dashboard-for-woocommerce'),
	...
	add_settings_field(
		...
		esc_attr__('Disable WP Desk dashboard widget', 'disable-dashboard-for-woocommerce'),
	...
	// Flexible Shipping section
	add_settings_section(
		'wcbloat_flexible_shipping_section',
		esc_attr__('Flexible Shipping', 'disable-dashboard-for-woocommerce'),
		'wcbloat_flexible_shipping_section_callback',
		'wcbloat-thirdparty'
	);
	...
	add_settings_field(
		...
		esc_attr__('"Shipping Extensions" menu entry', 'disable-dashboard-for-woocommerce'),
		'wcbloat_flexible_shipping_remove_menu_callback',
		'wcbloat-thirdparty',
		'wcbloat_flexible_shipping_section'
	);
	register_setting(
...
{
	echo '<p>' . __('The plugin integrates with third-party plugins. Using the options from this section, you can hide or turn off unwanted User Interface elements that these plugins add to your admin panel by default. Options for the supported plugin will be always presented on this screen - the plugin does not detect if you have a specific plugin installed.', 'disable-dashboard-for-woocommerce') . '</p><hr />';
}
...
function wcbloat_jetpack_blaze_disable_callback()
{
	$value = get_option('wcbloat_jetpack_blaze_disable');
?>
	<input type='hidden' name='wcbloat_jetpack_blaze_disable' value='no'>
	<label><input type='checkbox' name='wcbloat_jetpack_blaze_disable' <?php checked(esc_attr($value), 'yes'); ?> value='yes'> <?php esc_attr_e('Disable Jetpack Blaze feature', 'disable-dashboard-for-woocommerce'); ?></label>
	<p><?php _e('Use this option to disable the Jetpack Blaze feature. Blaze is a paid feature that helps you promote your content across WordPress.com and Tumblr networks.', 'disable-dashboard-for-woocommerce'); ?></p>
<?php
}
...
// Prevent Elementor from loading Google fonts in the frontend
function wcbloat_elementor_google_fonts_callback()
{
	$value = get_option('wcbloat_elementor_google_fonts');
?>
	<input type='hidden' name='wcbloat_elementor_google_fonts' value='no'>
	<label><input type='checkbox' name='wcbloat_elementor_google_fonts' <?php checked(esc_attr($value), 'yes'); ?> value='yes'> <?php esc_attr_e('Disable Elementor Google Fonts package', 'disable-dashboard-for-woocommerce'); ?></label>
	<p><?php _e('Enable this option to prevent Elementor from loading Google Fonts on your website\'s frontend. This can help improve website speed and reduce external requests to Google\'s servers.', 'disable-dashboard-for-woocommerce'); ?></p>
<?php
}
...
?>
	...
	<p><?php _e('This option will hide "UpdraftPlus" on admin toolbar. Works only if you are using “UpdraftPlus”.', 'disable-dashboard-for-woocommerce'); ?></p>
<?php
}
...
// Flexible Shipping section
function wcbloat_flexible_shipping_section_callback()
{
	_e('Octolize plugins, such as Flexible Shipping, add a new WooCommerce menu entry.', 'disable-dashboard-for-woocommerce');
}

// Remove the "Shipping Extensions" WooCommerce menu entry
function wcbloat_flexible_shipping_remove_menu_callback()
{
	$value = get_option('wcbloat_flexible_shipping_remove_menu');
?>
	<input type='hidden' name='wcbloat_flexible_shipping_remove_menu' value='no'>
	<label><input type='checkbox' name='wcbloat_flexible_shipping_remove_menu' <?php checked(esc_attr($value), 'yes'); ?> value='yes'> <?php esc_attr_e('Remove the "Shipping Extensions" WooCommerce menu entry', 'disable-dashboard-for-woocommerce'); ?></label>
	<p><?php _e('Tick this option to remove the annoying "Shipping Extensions" submenu from top-level WooCommerce menu. Enabling this option simplifies your menu by removing the unnecessary submenu, offering a simpler navigation experience', 'disable-dashboard-for-woocommerce'); ?></p>
<?php
}

...
require CLEVERFOX_PLUGIN_DIR . 'inc/medica/features/medazin-features.php';
require CLEVERFOX_PLUGIN_DIR . 'inc/medica/features/medazin-process.php';
...
if ( ! function_exists( 'cleverfox_medazin_frontpage_sections' ) ) :
	function cleverfox_medazin_frontpage_sections() {	
		...
		require CLEVERFOX_PLUGIN_DIR . 'inc/medica/sections/section-features.php';
		require CLEVERFOX_PLUGIN_DIR . 'inc/medazin/sections/section-cta.php';
		require CLEVERFOX_PLUGIN_DIR . 'inc/medica/sections/section-process.php';

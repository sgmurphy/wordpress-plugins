...
set_theme_mod('tlh_office_hours',__('Mon-Sat 9:00am To 8:00pm','clever-fox'));

set_theme_mod('tlh_btn_lbl',__('Buy Now','clever-fox'));

/*Footer */
set_theme_mod('footer_info_left_title',__('Have a Doubt We Can Help','clever-fox'));
set_theme_mod('footer_info_left_subtitle',__('Boot For Consultation','clever-fox'));


set_theme_mod('footer_info_right_title',__('Cloud Computing Service','clever-fox'));
set_theme_mod('footer_info_right_subtitle',__('Check Eligibility','clever-fox'));
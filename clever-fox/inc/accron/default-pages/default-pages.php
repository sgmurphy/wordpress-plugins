...
set_theme_mod('footer_get_in_touch_title',__('Call Us','clever-fox'));
set_theme_mod('footer_get_in_touch_number',__('+70 975 975 70','clever-fox'));

set_theme_mod('footer_email_icon','fa-envelope');
set_theme_mod('footer_email_title',__('Write Us','clever-fox'));
set_theme_mod('footer_email',__('email@company.com','clever-fox'));

set_theme_mod('footer_contct_icon','fa-location-arrow');
set_theme_mod('footer_address_title',__('Address','clever-fox'));
set_theme_mod('footer_contact_address',__('50 Wallstreet,USA','clever-fox'));
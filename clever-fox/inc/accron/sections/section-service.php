<?php 
	...
	$accron_service_title 				= get_theme_mod('accron_service_title',__('<span class="primary-color">What</span> We Do','clever-fox'));
	$accron_service_subtitle			= get_theme_mod('accron_service_subtitle',__('Outstanding Service','clever-fox'));
	$accron_service_description			= get_theme_mod('accron_service_description',__('There are many variations of passages of Lorem Ipsum available.','clever-fox'));
	$accron_service_description2		= get_theme_mod('accron_service_description2',__('Digital Agency Services Built Specifically For Your Business.','clever-fox'));
	$accron_service_btn_lbl				= get_theme_mod('accron_service_btn_lbl',__('Find Your Solution','clever-fox'));
	$accron_service_btn_link			= get_theme_mod('accron_service_btn_link','#');
	$accron_service_contents			= get_theme_mod('accron_service_contents',accron_get_service_default());
	$accron_service_sec_column			= get_theme_mod('accron_service_sec_column','3');  
	if($service_hs=='1'){
?>	
		...
		<div class="row">
			<?php
				...
				foreach ( $accron_service_contents as $service_item ) { 
					$image = ! empty( $service_item->image_url ) ? apply_filters( 'translate_single_string', $service_item->image_url, 'Service section' ) : '';
				...
				<div class="col-lg-<?php echo esc_attr($accron_service_sec_column); ?> col-md-6 col-sm-6">
					<div class="service">
						<div class="service-image" data-tilt>
							<img src="<?php echo esc_url($image); ?>" width="306" height="356" alt="">

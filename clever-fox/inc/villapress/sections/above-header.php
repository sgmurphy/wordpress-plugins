											...
											<ul>
												...
												if ($social_icons != '') {
													foreach ($social_icons as $social_item) {
														...
														?>
														<li><a href="<?php echo esc_url($social_link); ?>" class="linkedin"><i
																	class="fa <?php echo esc_attr($social_icon); ?>"></i></a></li>
													<?php }
												} ?>
											</ul>
										</div>
							...
							<div class="col-lg-6 col-12">
								...
								<?php if ($hide_show_phone_details == '1') { ?>
										<div class="widget widget-info phone">
											...
											<span>
												<?php echo esc_html($tlh_phone_title); ?>
											</span>
										</div>
									<?php }
									if ($hide_show_email_details == '1') {
										...
										<div class="widget widget-info email">
											...
											<span>
												<?php echo esc_html($tlh_email_title); ?>
											</span>
										</div>
									<?php } ?>

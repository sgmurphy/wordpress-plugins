...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	//Pro feature
		class Avril_funfact__section_upgrade extends WP_Customize_Control {
			...
			?>
				<a class="customizer_funfact_upgrade_section up-to-pro" href="https://www.nayrathemes.com/aviser-pro/" target="_blank" style="display: none;"><?php _e('Upgrade to Pro','clever-fox'); ?></a>
			...
			<?php }else{ ?>		
				...
				<a class="customizer_funfact_upgrade_section up-to-pro" href="https://www.nayrathemes.com/avenza-pro/" target="_blank" style="display: none;"><?php _e('Upgrade to Pro','clever-fox'); ?></a>
    ...
    $wp_customize->add_setting( 
    	'funfact_bg_setting' , 
    	array(
			'default' 			=> CLEVERFOX_PLUGIN_URL .'inc/avenza/images/fun-fact-bg.jpg',
			'capability'     	=> 'edit_theme_options',

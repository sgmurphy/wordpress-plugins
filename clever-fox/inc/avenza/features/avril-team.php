	...
	//Pro feature
		class Avril_team__section_upgrade extends WP_Customize_Control {
			...
			<?php }elseif ( 'Avitech' == $theme->name){ ?>	
				...
				<a class="customizer_team_upgrade_section up-to-pro" href="https://www.nayrathemes.com/avitech-pro/" target="_blank" style="display: none;"><?php _e('Upgrade to Pro','clever-fox'); ?></a>
				
			<?php }elseif ( 'Varuda' == $theme->name){ ?>	
				
				<a class="customizer_team_upgrade_section up-to-pro" href="https://www.nayrathemes.com/varuda-pro/" target="_blank" style="display: none;"><?php _e('Upgrade to Pro','clever-fox'); ?></a>	
				
			<?php }else{ ?>	
			
				<a class="customizer_team_upgrade_section up-to-pro" href="https://www.nayrathemes.com/avenza-pro/" target="_blank" style="display: none;"><?php _e('Upgrade to Pro','clever-fox'); ?></a>

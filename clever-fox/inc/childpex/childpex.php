...
require CLEVERFOX_PLUGIN_DIR . 'inc/childpex/features/corpex-team.php';
require CLEVERFOX_PLUGIN_DIR . 'inc/childpex/features/corpex-testimonial.php';
...
if ( ! function_exists( 'cleverfox_corpex_frontpage_sections' ) ) :
	function cleverfox_corpex_frontpage_sections() {	
		...
		require CLEVERFOX_PLUGIN_DIR . 'inc/childpex/sections/section-team.php';
		require CLEVERFOX_PLUGIN_DIR . 'inc/childpex/sections/section-testimonial.php';
...
function childpex_customize_remove( $wp_customize ) {
	$wp_customize->remove_control('hdr_nav_toggle');
	$wp_customize->remove_control('hs_nav_toggle');
}
add_action( 'customize_register', 'childpex_customize_remove' );
...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	$wp_customize->add_section(
		'testimonial_setting', array(
			'title' => esc_html__( 'Testimonial Section', 'corpex-pro' ),
			'priority' => 15,
	...
	'testimonial_doc_link' , 
		array(
			'label'          => __( 'Testimonial Documentation Link', 'corpex-pro' ),
			'section'        => 'testimonial_setting',
			'type'           => 'radio',
			'description'    => __( 'Testimonial Documentation Link', 'corpex-pro' ), 
		) 
	) );
	...
	'testimonial_headings',
		array(
			'type' => 'hidden',
			'label' => __('Testimonial Section','corpex-pro'),
			'section' => 'testimonial_setting',
		)
	);
	...
	'hs_testimonial', 
		array(
			'label'	      => esc_html__( 'Hide / Show Section', 'corpex-pro' ),
			'section'     => 'testimonial_setting',
			'type'        => 'checkbox'
		) 
	);
		...
		$wp_customize->add_control( 
			new corpex_Repeater( $wp_customize, 
				'testimonial_contents', 
					array(
						'label'   => esc_html__('Testimonial','corpex-pro'),
						'section' => 'testimonial_setting',
						'add_field_label'                   => esc_html__( 'Add New Testimonial', 'corpex-pro' ),
						'item_name'                         => esc_html__( 'Testimonial', 'corpex-pro' ),

...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	$wp_customize->add_section(
		'team_setting', array(
			'title' => esc_html__( 'Team Section', 'corpex-pro' ),
			'priority' => 9,
	...
	'team_doc_link' , 
		array(
			'label'          => __( 'Team Documentation Link', 'corpex-pro' ),
			'section'        => 'team_setting',
			'type'           => 'radio',
			'description'    => __( 'Team Documentation Link', 'corpex-pro' ), 
		) 
	) );
	...
	$wp_customize->add_setting(
    	'team_description',
    	array(
	        'default'			=> __('There are many variations of passages of Lorem Ipsum available.','corpex-pro'),
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'corpex_sanitize_html',
			'priority' => 5,
		)
	...
	$wp_customize->add_control( 
		'team_description',
		array(
		    'label'   => __('Description','corpex-pro'),
		    'section' => 'team_setting',
			'type'           => 'textarea',
		)  
	);
	 ...
	 */
		...
		$wp_customize->add_control( 
			new corpex_Repeater( $wp_customize, 
				'team_contents', 
					array(
						'label'   => esc_html__('Team','corpex-pro'),
						'section' => 'team_setting',
						'add_field_label'                   => esc_html__( 'Add New Team', 'corpex-pro' ),
						'item_name'                         => esc_html__( 'Team', 'corpex-pro' ),
	...
	$wp_customize->add_control(
		'team_sec_column',
		array(
		    'label'   		=> __('Team Column','corpex-pro'),
		    'section' 		=> 'team_setting',
			'settings'   	 => 'team_sec_column',
			'type'			=> 'select',
			'choices'        => 
			array(
				'6' => __( '2 Column', 'corpex-pro' ),
				'4' => __( '3 Column', 'corpex-pro' ),
				'3' => __( '4 Column', 'corpex-pro' ),
			) 
		) 
	);
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize , 'team_bg_image' ,
		array(
			'label'          => __( 'Background Image', 'corpex-pro' ),
			'section'        => 'team_setting',
		) 
	));
	...
	$wp_customize->add_control(
		'team_bg_position' , 
			array(
				'label'          => __( 'Image Position', 'corpex-pro' ),
				'section'        => 'team_setting',
				'type'           => 'radio',
				'choices'        => 
				array(
					'fixed'=> __( 'Fixed', 'corpex-pro' ),
					'scroll' => __( 'Scroll', 'corpex-pro' )
			)  
		) 
	);

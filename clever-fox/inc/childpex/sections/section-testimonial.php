									...
									<?php if(!empty($image)): ?>
										<div class="col-lg-6">
											<div class="testimonial-image">
												<span><img src="<?php echo esc_url($image); ?>" alt="<?php echo esc_attr__('Testimonial Image','corpex-pro'); ?>"></span>
											</div>
										</div>
									<?php endif; ?>
										...
										<div class="testimonial-content">
											...
											<div class="testimonial-content-inner">
												...
												<div class="client-detail">
													<?php if(!empty($image)): ?>
														<div class="image">
															<img src="<?php echo esc_url($image); ?>" alt="<?php echo esc_attr__('Testimonial Image','corpex-pro'); ?>">
														</div>
													<?php endif; ?>

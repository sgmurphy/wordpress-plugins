	...
	<div class="wpls-sf-wrap">
		<div class="wpls-sf-inr">
			<div class="wpls-sf-features-section wpls-sf-team wpls-sf-center">
				...
				<a href="<?php //echo esc_url(WPLS_PLUGIN_BUNDLE_LINK); ?>"  target="_blank" class="wpls-sf-btn wpls-sf-btn-orange"><span class="dashicons dashicons-cart"></span> Grab Now This Deal</a> -->

				<!-- <h1 class="wpls-sf-heading">Only <span class="wpls-sf-blue">November 2022</span> Deal <span class="wpls-sf-blue">40% OFF</span></h1>
				...
				<a href="<?php echo esc_url(WPLS_PLUGIN_BUNDLE_LINK); ?>" target="_blank" class="wpls-sf-btn wpls-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
			</div>
			<div class="wpls-sf-features-section wpls-sf-team wpls-sf-center">
				<h1 class="wpls-sf-heading">Powerful Team Behind <span class="wpls-sf-blue">Logo Showcase </span>Including in <span class="wpls-sf-blue">Essential Plugin Bundle</span></h1>
					...
					<p></p>
					<div class="wpls-sf-cont">This is why I wanted to introduce you to <span class="wpls-sf-blue">Essential Plugin Team</span> at essentialPlugin.com</div>
					<img class="wpls-sf-image" src="<?php echo esc_url(WPLS_URL); ?>/assets/images/wpos-team.png" alt="wpos team" />
					<a href="<?php echo esc_url(WPLS_PLUGIN_BUNDLE_LINK); ?>"  target="_blank" class="wpls-sf-btn wpls-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
			</div>
			...
			<div class="wpls-sf-welcome-wrap">
				<div class="wpls-sf-welcome-inr wpls-sf-center">
						...
						<a href="<?php echo esc_url( $wpls_add_link ); ?>" class="wpls-sf-btn">Launch Logo Showcase With Free Features</a> <br /><b>OR</b> <br />
						<div style="font-size: 14px;"><span class="wpls-sf-blue">Logo Showcase </span>Including in <span class="wpls-sf-blue">Essential Plugin Bundle</span></div><br />
						<a href="<?php echo esc_url(WPLS_PLUGIN_BUNDLE_LINK); ?>"  target="_blank" class="wpls-sf-btn wpls-sf-btn-orange">View Essential Plugin Bundle</a>
						<div class="wpls-rc-wrap">
							<div class="wpls-rc-inr wpls-rc-bg-box">
								...
								<div class="wpls-rc-cont">
									<h3>30 Days Refund Policy</h3>
									<p>30-day No Question Asked Refund Guarantee</p>
								</div>
							</div>
							<div class="wpls-rc-inr wpls-rc-bg-box">
								<div class="wpls-rc-icon">
					...
					<div class="wpls-sf-welcome-left"></div>
					<div class="wpls-sf-welcome-right"></div>
				</div>
			</div>
			<!-- End - Welcome Box -->
				...
				<div class="wpls-sf-welcome-wrap wpls-sf-center">
					<div class="wpls-features-box-wrap">
						<ul class="wpls-features-box-grid">
							<li>
							<div class="wpls-popup-icon"><img src="<?php echo esc_url(WPLS_URL); ?>/assets/images/popup-icon/grid.png" /></div>
							Logo Grid View</li>
							<li>
							<div class="wpls-popup-icon"><img src="<?php echo esc_url(WPLS_URL); ?>/assets/images/popup-icon/slider-carousel.png" /></div>
							Logo Slider View</li>
							<li>
							<div class="wpls-popup-icon"><img src="<?php echo esc_url(WPLS_URL); ?>/assets/images/popup-icon/center-mode.png" /></div>
							Logo Slider Center Mode</li>
							<li>
							<div class="wpls-popup-icon"><img src="<?php echo esc_url(WPLS_URL); ?>/assets/images/popup-icon/filter.png" /></div>
							Logo Filter View</li>
							<li>
							<div class="wpls-popup-icon"><img src="<?php echo esc_url(WPLS_URL); ?>/assets/images/popup-icon/slider-carousel.png" /></div>
							Logo Ticker View</li>
							<li>
							<div class="wpls-popup-icon"><img src="<?php echo esc_url(WPLS_URL); ?>/assets/images/popup-icon/list.png" /></div>
							Logo List View</li>
						</ul>
					</div>
					<div style="font-size: 14px;"><span class="wpls-sf-blue">Logo Showcase </span>Including in <span class="wpls-sf-blue">Essential Plugin Bundle</span></div><br />
			...
			<div class="wpls-sf-solutions-section wpls-sf-top-rsn wpls-sf-left">
				...
				<div style="font-size: 14px; text-align: center;"><span class="wpls-sf-blue">Logo Showcase </span>Including in <span class="wpls-sf-blue">Essential Plugin Bundle</span></div><br />
				<div class="wpls-sf-center">
					<a href="<?php echo esc_url(WPLS_PLUGIN_BUNDLE_LINK); ?>" target="_blank" class="wpls-sf-btn wpls-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
				</div>
				<div class="wpls-rc-wrap">
			...
			<div class="wpls-sf-testimonial-wrap">
				<div class="wpls-sf-center wpls-sf-features-ttl">
					<h1 class="wpls-sf-heading">Looking for a Reason to Use <span class="wpls-sf-blue">Essential Plugin </span>with Logo Showcase?</h1>
				...
				<div class="wpls-testimonial-section-inr">
					<div class="wpls-testimonial-box-wrap">
						<div class="wpls-testimonial-box-grid">
								...
								<div class="wpls-testimonial-rating"><img src="<?php echo esc_url(WPLS_URL); ?>/assets/images/rating.png" /></div>
						</div>
						<div class="wpls-testimonial-box-grid">
						...
						<div class="wpls-testimonial-box-grid">
							...
							<div class="wpls-testimonial-desc">The Plug In works brilliantly, if you do get stuck somewhere the Support is quick to respond and very helpful. Definitely 5 Stars!</div>
							<div class="wpls-testimonial-clnt">@neubuerg</div>
							<div class="wpls-testimonial-rating"><img src="<?php echo esc_url(WPLS_URL); ?>/assets/images/rating.png" /></div>
						</div>
					</div>
					<a href="https://wordpress.org/support/plugin/wp-logo-showcase-responsive-slider-slider/reviews/?filter=5" target="_blank" class="wpls-sf-btn"><span class="dashicons dashicons-star-filled"></span> View All Reviews</a><br /> <b>OR</b> <br /><div style="font-size: 14px;"><span class="wpls-sf-blue">Logo Showcase </span>Including in <span class="wpls-sf-blue">Essential Plugin Bundle</span></div><br /><a href="<?php echo esc_url(WPLS_PLUGIN_BUNDLE_LINK); ?>"  target="_blank" class="wpls-sf-btn wpls-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
					<div class="wpls-rc-wrap">
						<div class="wpls-rc-inr wpls-rc-bg-box">
							<div class="wpls-rc-icon">
								<img src="<?php echo esc_url( WPLS_URL ); ?>assets/images/popup-icon/14-days-money-back-guarantee.png" alt="14-days-money-back-guarantee" title="14-days-money-back-guarantee" />

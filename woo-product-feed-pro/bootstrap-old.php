...
function woosea_styles( $hook ) {
    ...
    if ( preg_match( '/product-feed-pro/i', $hook ) || preg_match( '/woosea_/i', $hook ) ) {
        ...
        if ( preg_match( '/woosea_manage_license/i', $hook ) ) {
            wp_register_style( 'woosea_license_settings-css', plugins_url( '/css/license-settings.css', __FILE__ ), '', WOOCOMMERCESEA_PLUGIN_VERSION );
            wp_enqueue_style( 'woosea_license_settings-css' );
        }
 ...
 *
 * @param mixed $object The object to strip slashes from.
 */
...
function woosea_menu_addition() {
    add_menu_page( __( 'Product Feed Pro for WooCommerce', 'woo-product-feed-pro' ), __( 'Product Feed Pro', 'woo-product-feed-pro' ), apply_filters( 'woosea_user_cap', 'manage_options' ), 'woo-product-feed-pro', 'woosea_generate_pages', esc_url( WOOCOMMERCESEA_PLUGIN_URL . '/images/icon-16x16.png' ), 99 );
    add_submenu_page( 'woo-product-feed-pro', __( 'Feed configuration', 'woo-product-feed-pro' ), __( 'Create feed', 'woo-product-feed-pro' ), apply_filters( 'woosea_user_cap', 'manage_options' ), 'woo-product-feed-pro', 'woosea_generate_pages' );
    add_submenu_page( 'woo-product-feed-pro', __( 'Manage feeds', 'woo-product-feed-pro' ), __( 'Manage feeds', 'woo-product-feed-pro' ), apply_filters( 'woosea_user_cap', 'manage_options' ), 'woosea_manage_feed', 'woosea_manage_feed' );
    add_submenu_page( 'woo-product-feed-pro', __( 'Settings', 'woo-product-feed-pro' ), __( 'Settings', 'woo-product-feed-pro' ), apply_filters( 'woosea_user_cap', 'manage_options' ), 'woosea_manage_settings', 'woosea_manage_settings' );
    add_submenu_page( 'woo-product-feed-pro', __( 'License', 'woo-product-feed-pro' ), __( 'License', 'woo-product-feed-pro' ), apply_filters( 'woosea_user_cap', 'manage_options' ), 'woosea_manage_license', 'woosea_manage_license' );
}
...
function woosea_custom_general_fields() {
    ...
    if ( ( get_option( 'add_unique_identifiers' ) == 'yes' ) && ( ! empty( $extra_attributes ) ) ) {

        echo '<div id="woosea_attr" class="options_group">';

        // Brand field.
        if ( array_key_exists( 'custom_attributes__woosea_brand', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_brand', true ) ) ) ) {
        ...
        if ( array_key_exists( 'custom_attributes__woosea_gtin', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_gtin', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
                    'id'          => '_woosea_gtin',
        ...
        // MPN Field.
        if ( array_key_exists( 'custom_attributes__woosea_mpn', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_mpn', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
                    'id'          => '_woosea_mpn',
        ...
        if ( array_key_exists( 'custom_attributes__woosea_upc', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_upc', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
                    'id'          => '_woosea_upc',
        ...
        if ( array_key_exists( 'custom_attributes__woosea_ean', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_ean', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
                    'id'          => '_woosea_ean',
        ...
        if ( array_key_exists( 'custom_attributes__woosea_optimized_title', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_optimized_title', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        if ( array_key_exists( 'custom_attributes__woosea_condition', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_condition', true ) ) ) ) {
        ...
        // Color Field.
        if ( array_key_exists( 'custom_attributes__woosea_color', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_color', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
                    'id'          => '_woosea_color',
        ...
        // Size Field.
        if ( array_key_exists( 'custom_attributes__woosea_size', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_size', true ) ) ) ) {
                woocommerce_wp_text_input(
                    array(
                        'id'          => '_woosea_size',
        ...
        if ( array_key_exists( 'custom_attributes__woosea_gender', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_gender', true ) ) ) ) {
            woocommerce_wp_select(
                array(
                    'id'          => '_woosea_gender',
        ...
        // Material Field.
        if ( array_key_exists( 'custom_attributes__woosea_material', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_material', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
                    'id'          => '_woosea_material',
        ...
        // Pattern Field.
        if ( array_key_exists( 'custom_attributes__woosea_pattern', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_pattern', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
                    'id'          => '_woosea_pattern',
        ...
        if ( array_key_exists( 'custom_attributes__woosea_age_group', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_age_group', true ) ) ) ) {
            woocommerce_wp_select(
                array(
        ...
        if ( array_key_exists( 'custom_attributes__woosea_unit_pricing_measure', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_unit_pricing_measure', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        if ( array_key_exists( 'custom_attributes__woosea_unit_pricing_base_measure', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_unit_pricing_base_measure', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Installment months.
        if ( array_key_exists( 'custom_attributes__woosea_installment_months', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_installment_months', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Installment amount.
        if ( array_key_exists( 'custom_attributes__woosea_installment_amount', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_installment_amount', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Cost of goods sold.
        if ( array_key_exists( 'custom_attributes__woosea_cost_of_good_sold', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_cost_of_good_sold', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Multipack.
        if ( array_key_exists( 'custom_attributes__woosea_multipack', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_multipack', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Is bundle.
        if ( array_key_exists( 'custom_attributes__woosea_is_bundle', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_is_bundle', true ) ) ) ) {
            woocommerce_wp_select(
                array(
        ...
        if ( array_key_exists( 'custom_attributes__woosea_energy_efficiency_class', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_energy_efficiency_class', true ) ) ) ) {
            woocommerce_wp_select(
                array(
        ...
        if ( array_key_exists( 'custom_attributes__woosea_min_energy_efficiency_class', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_min_energy_efficiency_class', true ) ) ) ) {
            woocommerce_wp_select(
                array(
        ...
        if ( array_key_exists( 'custom_attributes__woosea_max_energy_efficiency_class', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_max_energy_efficiency_class', true ) ) ) ) {
            woocommerce_wp_select(
                array(
        ...
        // Is promotion.
        if ( array_key_exists( 'custom_attributes__woosea_is_promotion', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_is_promotion', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Custom field 0.
        if ( array_key_exists( 'custom_attributes__woosea_custom_field_0', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_custom_field_0', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Custom field 1.
        if ( array_key_exists( 'custom_attributes__woosea_custom_field_1', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_custom_field_1', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Custom field 2.
        if ( array_key_exists( 'custom_attributes__woosea_custom_field_2', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_custom_field_2', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Custom field 3.
        if ( array_key_exists( 'custom_attributes__woosea_custom_field_3', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_custom_field_3', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Custom field 4.
        if ( array_key_exists( 'custom_attributes__woosea_custom_field_4', $extra_attributes ) || ( ! empty( get_post_meta( $post->ID, '_woosea_custom_field_4', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
...
function woosea_custom_variable_fields( $loop, $variation_id, $variation ) {
    ...
    if ( get_option( 'add_unique_identifiers' ) == 'yes' ) {
        ...
        if ( array_key_exists( 'custom_attributes__woosea_brand', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_brand', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        if ( array_key_exists( 'custom_attributes__woosea_gtin', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_gtin', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Variation MPN field.
        if ( array_key_exists( 'custom_attributes__woosea_mpn', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_mpn', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Variation UPC field.
        if ( array_key_exists( 'custom_attributes__woosea_upc', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_upc', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Variation EAN field.
        if ( array_key_exists( 'custom_attributes__woosea_ean', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_ean', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
                ...
                // Color field.
                if ( array_key_exists( 'custom_attributes__woosea_color', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_color', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Size field.
        if ( array_key_exists( 'custom_attributes__woosea_size', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_size', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Add Gender drop-down.
        if ( array_key_exists( 'custom_attributes__woosea_gender', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_gender', true ) ) ) ) {
            woocommerce_wp_select(
                array(
        ...
        // Material field.
        if ( array_key_exists( 'custom_attributes__woosea_material', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_material', true ) ) ) ) {
                    woocommerce_wp_text_input(
                        array(
        ...
        // Pattern field.
        if ( array_key_exists( 'custom_attributes__woosea_pattern', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_pattern', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        if ( array_key_exists( 'custom_attributes__woosea_unit_pricing_measure', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_unit_pricing_measure', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        if ( array_key_exists( 'custom_attributes__woosea_unit_pricing_base_measure', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_unit_pricing_base_measure', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        if ( array_key_exists( 'custom_attributes__woosea_optimized_title', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_optimized_title', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        if ( array_key_exists( 'custom_attributes__woosea_installment_months', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_installment_months', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        if ( array_key_exists( 'custom_attributes__woosea_installment_amount', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_installment_amount', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Add product condition drop-down.
        if ( array_key_exists( 'custom_attributes__woosea_condition', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_condition', true ) ) ) ) {
            woocommerce_wp_select(
                array(
        ...
        // Add product age_group drop-down.
        if ( array_key_exists( 'custom_attributes__woosea_age_group', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_age_group', true ) ) ) ) {
            woocommerce_wp_select(
                array(
        ...
        // Cost of good sold.
        if ( array_key_exists( 'custom_attributes__woosea_cost_of_good_sold', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_cost_of_good_sold', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Multipack.
        if ( array_key_exists( 'custom_attributes__woosea_multipack', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_multipack', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Is bundle.
        if ( array_key_exists( 'custom_attributes__woosea_is_bundle', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_is_bundle', true ) ) ) ) {
            woocommerce_wp_select(
                array(
        ...
        // Energy efficiency class.
        if ( array_key_exists( 'custom_attributes__woosea_energy_efficiency_class', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_energy_efficiency_class', true ) ) ) ) {
            woocommerce_wp_select(
                array(
        ...
        // Minimum energy efficiency class.
        if ( array_key_exists( 'custom_attributes__woosea_min_energy_efficiency_class', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_min_energy_efficiency_class', true ) ) ) ) {
            woocommerce_wp_select(
                array(
        ...
        // Maximum energy efficiency class.
        if ( array_key_exists( 'custom_attributes__woosea_max_energy_efficiency_class', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_max_energy_efficiency_class', true ) ) ) ) {
            woocommerce_wp_select(
                array(
        ...
        // Is promotion.
        if ( array_key_exists( 'custom_attributes__woosea_is_promotion', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_is_promotion', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Custom field 0.
        if ( array_key_exists( 'custom_attributes__woosea_custom_field_0', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_custom_field_0', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Custom field 1.
        if ( array_key_exists( 'custom_attributes__woosea_custom_field_1', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_custom_field_1', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Custom field 2.
        if ( array_key_exists( 'custom_attributes__woosea_custom_field_2', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_custom_field_2', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Custom field 3.
        if ( array_key_exists( 'custom_attributes__woosea_custom_field_3', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_custom_field_3', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
        ...
        // Custom field 4.
        if ( array_key_exists( 'custom_attributes__woosea_custom_field_4', $extra_attributes ) || ( ! empty( get_post_meta( $variation->ID, '_woosea_custom_field_4', true ) ) ) ) {
            woocommerce_wp_text_input(
                array(
...
function woosea_update_project_history( $project_hash ) {
    $feed_config = get_option( 'cron_projects', array() );
...
function woosea_generate_pages() {
    ...
    */
    ...
    if ( ! function_exists( 'woosea_add_allowed_tags' ) ) {
         ...
         * @return array $tags The allowed tags.
         */
 ...
 *
 * @param string $project_hash The project hash.
 * @param int    $nr_products The amount of products in the feed.
 */
 ...
 * @param string $project_hash The project hash.
 *
 * @return string $last_updated The last updated timestamp.
 */
 ...
 */
function woosea_manage_license() {
    $html = new Construct_Admin_Pages();

...
class WooSEA_Update_Project {
    ...
    public static function reconfigure_project( $project_data ) {
        ...
        if ( get_option( 'cron_projects' ) ) {
            ...
            foreach ( $cron_projects as $key => $val ) {
                if ( ! empty( $val ) ) {
                    foreach ( $val as $k => $v ) {
                        if ( ! is_array( $v ) ) {
                            if ( ( $v === $project_hash ) && ( $k === 'project_hash' ) ) {
                                $project_config = $val;
                                $remove_key     = $key;
                            }
                        }
        ...
        if ( ( array_key_exists( 'woosea_page', $project_data ) ) && ( $project_data['woosea_page'] == 'analytics' ) ) {
            /**
         ...
         */
                if ( ( array_key_exists( 'woosea_page', $project_data ) ) && ( $project_data['woosea_page'] == 'filters_rules' ) ) {

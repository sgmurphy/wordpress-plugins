import{E as Ke,z as Mo,_ as xi}from"./vendor-8e7ad089.min.js";var vt=function(a){return a&&a.Math===Math&&a},V=vt(typeof globalThis=="object"&&globalThis)||vt(typeof window=="object"&&window)||vt(typeof self=="object"&&self)||vt(typeof Ke=="object"&&Ke)||vt(typeof Ke=="object"&&Ke)||function(){return this}()||Function("return this")(),$t={},k=function(a){try{return!!a()}catch{return!0}},El=k,le=!El(function(){return Object.defineProperty({},1,{get:function(){return 7}})[1]!==7}),$l=k,mr=!$l(function(){var a=(function(){}).bind();return typeof a!="function"||a.hasOwnProperty("prototype")}),wl=mr,Ut=Function.prototype.call,Y=wl?Ut.bind(Ut):function(){return Ut.apply(Ut,arguments)},_o={},Vo={}.propertyIsEnumerable,Do=Object.getOwnPropertyDescriptor,Cl=Do&&!Vo.call({1:2},1);_o.f=Cl?function(e){var t=Do(this,e);return!!t&&t.enumerable}:Vo;var Ti=function(a,e){return{enumerable:!(a&1),configurable:!(a&2),writable:!(a&4),value:e}},ko=mr,Lo=Function.prototype,Ga=Lo.call,Al=ko&&Lo.bind.bind(Ga,Ga),L=ko?Al:function(a){return function(){return Ga.apply(a,arguments)}},Bo=L,Pl=Bo({}.toString),Rl=Bo("".slice),Be=function(a){return Rl(Pl(a),8,-1)},Nl=L,Il=k,Ml=Be,Qr=Object,_l=Nl("".split),Fo=Il(function(){return!Qr("z").propertyIsEnumerable(0)})?function(a){return Ml(a)==="String"?_l(a,""):Qr(a)}:Qr,Fe=function(a){return a==null},Vl=Fe,Dl=TypeError,he=function(a){if(Vl(a))throw new Dl("Can't call method on "+a);return a},kl=Fo,Ll=he,wt=function(a){return kl(Ll(a))},Kr=typeof document=="object"&&document.all,B=typeof Kr>"u"&&Kr!==void 0?function(a){return typeof a=="function"||a===Kr}:function(a){return typeof a=="function"},Bl=B,ve=function(a){return typeof a=="object"?a!==null:Bl(a)},Zr=V,Fl=B,jl=function(a){return Fl(a)?a:void 0},je=function(a,e){return arguments.length<2?jl(Zr[a]):Zr[a]&&Zr[a][e]},Ul=L,br=Ul({}.isPrototypeOf),zl=V,gn=zl.navigator,dn=gn&&gn.userAgent,Ct=dn?String(dn):"",jo=V,Jr=Ct,pn=jo.process,yn=jo.Deno,mn=pn&&pn.versions||yn&&yn.version,bn=mn&&mn.v8,ue,fr;bn&&(ue=bn.split("."),fr=ue[0]>0&&ue[0]<4?1:+(ue[0]+ue[1]));!fr&&Jr&&(ue=Jr.match(/Edge\/(\d+)/),(!ue||ue[1]>=74)&&(ue=Jr.match(/Chrome\/(\d+)/),ue&&(fr=+ue[1])));var Oi=fr,xn=Oi,Gl=k,Hl=V,Yl=Hl.String,Uo=!!Object.getOwnPropertySymbols&&!Gl(function(){var a=Symbol("symbol detection");return!Yl(a)||!(Object(a)instanceof Symbol)||!Symbol.sham&&xn&&xn<41}),Xl=Uo,zo=Xl&&!Symbol.sham&&typeof Symbol.iterator=="symbol",Wl=je,ql=B,Ql=br,Kl=zo,Zl=Object,Go=Kl?function(a){return typeof a=="symbol"}:function(a){var e=Wl("Symbol");return ql(e)&&Ql(e.prototype,Zl(a))},Jl=String,xr=function(a){try{return Jl(a)}catch{return"Object"}},eh=B,th=xr,rh=TypeError,Te=function(a){if(eh(a))return a;throw new rh(th(a)+" is not a function")},ah=Te,ih=Fe,ot=function(a,e){var t=a[e];return ih(t)?void 0:ah(t)},ea=Y,ta=B,ra=ve,nh=TypeError,sh=function(a,e){var t,r;if(e==="string"&&ta(t=a.toString)&&!ra(r=ea(t,a))||ta(t=a.valueOf)&&!ra(r=ea(t,a))||e!=="string"&&ta(t=a.toString)&&!ra(r=ea(t,a)))return r;throw new nh("Can't convert object to primitive value")},Ho={exports:{}},Tn=V,oh=Object.defineProperty,Si=function(a,e){try{oh(Tn,a,{value:e,configurable:!0,writable:!0})}catch{Tn[a]=e}return e},uh=V,lh=Si,On="__core-js_shared__",Sn=Ho.exports=uh[On]||lh(On,{});(Sn.versions||(Sn.versions=[])).push({version:"3.38.1",mode:"global",copyright:"© 2014-2024 Denis Pushkarev (zloirock.ru)",license:"https://github.com/zloirock/core-js/blob/v3.38.1/LICENSE",source:"https://github.com/zloirock/core-js"});var Ei=Ho.exports,En=Ei,$i=function(a,e){return En[a]||(En[a]=e||{})},hh=he,vh=Object,Tr=function(a){return vh(hh(a))},fh=L,ch=Tr,gh=fh({}.hasOwnProperty),fe=Object.hasOwn||function(e,t){return gh(ch(e),t)},dh=L,ph=0,yh=Math.random(),mh=dh(1 .toString),Yo=function(a){return"Symbol("+(a===void 0?"":a)+")_"+mh(++ph+yh,36)},bh=V,xh=$i,$n=fe,Th=Yo,Oh=Uo,Sh=zo,Ze=bh.Symbol,aa=xh("wks"),Eh=Sh?Ze.for||Ze:Ze&&Ze.withoutSetter||Th,G=function(a){return $n(aa,a)||(aa[a]=Oh&&$n(Ze,a)?Ze[a]:Eh("Symbol."+a)),aa[a]},$h=Y,wn=ve,Cn=Go,wh=ot,Ch=sh,Ah=G,Ph=TypeError,Rh=Ah("toPrimitive"),Nh=function(a,e){if(!wn(a)||Cn(a))return a;var t=wh(a,Rh),r;if(t){if(e===void 0&&(e="default"),r=$h(t,a,e),!wn(r)||Cn(r))return r;throw new Ph("Can't convert object to primitive value")}return e===void 0&&(e="number"),Ch(a,e)},Ih=Nh,Mh=Go,Xo=function(a){var e=Ih(a,"string");return Mh(e)?e:e+""},_h=V,An=ve,Ha=_h.document,Vh=An(Ha)&&An(Ha.createElement),Or=function(a){return Vh?Ha.createElement(a):{}},Dh=le,kh=k,Lh=Or,Wo=!Dh&&!kh(function(){return Object.defineProperty(Lh("div"),"a",{get:function(){return 7}}).a!==7}),Bh=le,Fh=Y,jh=_o,Uh=Ti,zh=wt,Gh=Xo,Hh=fe,Yh=Wo,Pn=Object.getOwnPropertyDescriptor;$t.f=Bh?Pn:function(e,t){if(e=zh(e),t=Gh(t),Yh)try{return Pn(e,t)}catch{}if(Hh(e,t))return Uh(!Fh(jh.f,e,t),e[t])};var Oe={},Xh=le,Wh=k,qo=Xh&&Wh(function(){return Object.defineProperty(function(){},"prototype",{value:42,writable:!1}).prototype!==42}),qh=ve,Qh=String,Kh=TypeError,J=function(a){if(qh(a))return a;throw new Kh(Qh(a)+" is not an object")},Zh=le,Jh=Wo,ev=qo,zt=J,Rn=Xo,tv=TypeError,ia=Object.defineProperty,rv=Object.getOwnPropertyDescriptor,na="enumerable",sa="configurable",oa="writable";Oe.f=Zh?ev?function(e,t,r){if(zt(e),t=Rn(t),zt(r),typeof e=="function"&&t==="prototype"&&"value"in r&&oa in r&&!r[oa]){var i=rv(e,t);i&&i[oa]&&(e[t]=r.value,r={configurable:sa in r?r[sa]:i[sa],enumerable:na in r?r[na]:i[na],writable:!1})}return ia(e,t,r)}:ia:function(e,t,r){if(zt(e),t=Rn(t),zt(r),Jh)try{return ia(e,t,r)}catch{}if("get"in r||"set"in r)throw new tv("Accessors not supported");return"value"in r&&(e[t]=r.value),e};var av=le,iv=Oe,nv=Ti,At=av?function(a,e,t){return iv.f(a,e,nv(1,t))}:function(a,e,t){return a[e]=t,a},Qo={exports:{}},Ya=le,sv=fe,Ko=Function.prototype,ov=Ya&&Object.getOwnPropertyDescriptor,wi=sv(Ko,"name"),uv=wi&&(function(){}).name==="something",lv=wi&&(!Ya||Ya&&ov(Ko,"name").configurable),Sr={EXISTS:wi,PROPER:uv,CONFIGURABLE:lv},hv=L,vv=B,Xa=Ei,fv=hv(Function.toString);vv(Xa.inspectSource)||(Xa.inspectSource=function(a){return fv(a)});var Ci=Xa.inspectSource,cv=V,gv=B,Nn=cv.WeakMap,dv=gv(Nn)&&/native code/.test(String(Nn)),pv=$i,yv=Yo,In=pv("keys"),Ai=function(a){return In[a]||(In[a]=yv(a))},Pi={},mv=dv,Zo=V,bv=ve,xv=At,ua=fe,la=Ei,Tv=Ai,Ov=Pi,Mn="Object already initialized",Wa=Zo.TypeError,Sv=Zo.WeakMap,cr,Ot,gr,Ev=function(a){return gr(a)?Ot(a):cr(a,{})},$v=function(a){return function(e){var t;if(!bv(e)||(t=Ot(e)).type!==a)throw new Wa("Incompatible receiver, "+a+" required");return t}};if(mv||la.state){var de=la.state||(la.state=new Sv);de.get=de.get,de.has=de.has,de.set=de.set,cr=function(a,e){if(de.has(a))throw new Wa(Mn);return e.facade=a,de.set(a,e),e},Ot=function(a){return de.get(a)||{}},gr=function(a){return de.has(a)}}else{var Ye=Tv("state");Ov[Ye]=!0,cr=function(a,e){if(ua(a,Ye))throw new Wa(Mn);return e.facade=a,xv(a,Ye,e),e},Ot=function(a){return ua(a,Ye)?a[Ye]:{}},gr=function(a){return ua(a,Ye)}}var Er={set:cr,get:Ot,has:gr,enforce:Ev,getterFor:$v},Ri=L,wv=k,Cv=B,Gt=fe,qa=le,Av=Sr.CONFIGURABLE,Pv=Ci,Jo=Er,Rv=Jo.enforce,Nv=Jo.get,_n=String,sr=Object.defineProperty,Iv=Ri("".slice),Mv=Ri("".replace),_v=Ri([].join),Vv=qa&&!wv(function(){return sr(function(){},"length",{value:8}).length!==8}),Dv=String(String).split("String"),kv=Qo.exports=function(a,e,t){Iv(_n(e),0,7)==="Symbol("&&(e="["+Mv(_n(e),/^Symbol\(([^)]*)\).*$/,"$1")+"]"),t&&t.getter&&(e="get "+e),t&&t.setter&&(e="set "+e),(!Gt(a,"name")||Av&&a.name!==e)&&(qa?sr(a,"name",{value:e,configurable:!0}):a.name=e),Vv&&t&&Gt(t,"arity")&&a.length!==t.arity&&sr(a,"length",{value:t.arity});try{t&&Gt(t,"constructor")&&t.constructor?qa&&sr(a,"prototype",{writable:!1}):a.prototype&&(a.prototype=void 0)}catch{}var r=Rv(a);return Gt(r,"source")||(r.source=_v(Dv,typeof e=="string"?e:"")),a};Function.prototype.toString=kv(function(){return Cv(this)&&Nv(this).source||Pv(this)},"toString");var eu=Qo.exports,Lv=B,Bv=Oe,Fv=eu,jv=Si,Ue=function(a,e,t,r){r||(r={});var i=r.enumerable,n=r.name!==void 0?r.name:e;if(Lv(t)&&Fv(t,n,r),r.global)i?a[e]=t:jv(e,t);else{try{r.unsafe?a[e]&&(i=!0):delete a[e]}catch{}i?a[e]=t:Bv.f(a,e,{value:t,enumerable:!1,configurable:!r.nonConfigurable,writable:!r.nonWritable})}return a},tu={},Uv=Math.ceil,zv=Math.floor,Gv=Math.trunc||function(e){var t=+e;return(t>0?zv:Uv)(t)},Hv=Gv,$r=function(a){var e=+a;return e!==e||e===0?0:Hv(e)},Yv=$r,Xv=Math.max,Wv=Math.min,qv=function(a,e){var t=Yv(a);return t<0?Xv(t+e,0):Wv(t,e)},Qv=$r,Kv=Math.min,ut=function(a){var e=Qv(a);return e>0?Kv(e,9007199254740991):0},Zv=ut,Ni=function(a){return Zv(a.length)},Jv=wt,ef=qv,tf=Ni,Vn=function(a){return function(e,t,r){var i=Jv(e),n=tf(i);if(n===0)return!a&&-1;var o=ef(r,n),s;if(a&&t!==t){for(;n>o;)if(s=i[o++],s!==s)return!0}else for(;n>o;o++)if((a||o in i)&&i[o]===t)return a||o||0;return!a&&-1}},ru={includes:Vn(!0),indexOf:Vn(!1)},rf=L,ha=fe,af=wt,nf=ru.indexOf,sf=Pi,Dn=rf([].push),au=function(a,e){var t=af(a),r=0,i=[],n;for(n in t)!ha(sf,n)&&ha(t,n)&&Dn(i,n);for(;e.length>r;)ha(t,n=e[r++])&&(~nf(i,n)||Dn(i,n));return i},Ii=["constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"],of=au,uf=Ii,lf=uf.concat("length","prototype");tu.f=Object.getOwnPropertyNames||function(e){return of(e,lf)};var iu={};iu.f=Object.getOwnPropertySymbols;var hf=je,vf=L,ff=tu,cf=iu,gf=J,df=vf([].concat),pf=hf("Reflect","ownKeys")||function(e){var t=ff.f(gf(e)),r=cf.f;return r?df(t,r(e)):t},kn=fe,yf=pf,mf=$t,bf=Oe,xf=function(a,e,t){for(var r=yf(e),i=bf.f,n=mf.f,o=0;o<r.length;o++){var s=r[o];!kn(a,s)&&!(t&&kn(t,s))&&i(a,s,n(e,s))}},Tf=k,Of=B,Sf=/#|\.prototype\./,Pt=function(a,e){var t=$f[Ef(a)];return t===Cf?!0:t===wf?!1:Of(e)?Tf(e):!!e},Ef=Pt.normalize=function(a){return String(a).replace(Sf,".").toLowerCase()},$f=Pt.data={},wf=Pt.NATIVE="N",Cf=Pt.POLYFILL="P",nu=Pt,Ht=V,Af=$t.f,Pf=At,Rf=Ue,Nf=Si,If=xf,Mf=nu,ee=function(a,e){var t=a.target,r=a.global,i=a.stat,n,o,s,u,l,h;if(r?o=Ht:i?o=Ht[t]||Nf(t,{}):o=Ht[t]&&Ht[t].prototype,o)for(s in e){if(l=e[s],a.dontCallGetSet?(h=Af(o,s),u=h&&h.value):u=o[s],n=Mf(r?s:t+(i?".":"#")+s,a.forced),!n&&u!==void 0){if(typeof l==typeof u)continue;If(l,u)}(a.sham||u&&u.sham)&&Pf(l,"sham",!0),Rf(o,s,l,a)}},ft=V,_f=Ct,Vf=Be,Yt=function(a){return _f.slice(0,a.length)===a},su=function(){return Yt("Bun/")?"BUN":Yt("Cloudflare-Workers")?"CLOUDFLARE":Yt("Deno/")?"DENO":Yt("Node.js/")?"NODE":ft.Bun&&typeof Bun.version=="string"?"BUN":ft.Deno&&typeof Deno.version=="object"?"DENO":Vf(ft.process)==="process"?"NODE":ft.window&&ft.document?"BROWSER":"REST"}(),Df=su,wr=Df==="NODE",kf=L,Lf=Te,Bf=function(a,e,t){try{return kf(Lf(Object.getOwnPropertyDescriptor(a,e)[t]))}catch{}},Ff=ve,jf=function(a){return Ff(a)||a===null},Uf=jf,zf=String,Gf=TypeError,Hf=function(a){if(Uf(a))return a;throw new Gf("Can't set "+zf(a)+" as a prototype")},Yf=Bf,Xf=ve,Wf=he,qf=Hf,ou=Object.setPrototypeOf||("__proto__"in{}?function(){var a=!1,e={},t;try{t=Yf(Object.prototype,"__proto__","set"),t(e,[]),a=e instanceof Array}catch{}return function(i,n){return Wf(i),qf(n),Xf(i)&&(a?t(i,n):i.__proto__=n),i}}():void 0),Qf=Oe.f,Kf=fe,Zf=G,Ln=Zf("toStringTag"),Cr=function(a,e,t){a&&!t&&(a=a.prototype),a&&!Kf(a,Ln)&&Qf(a,Ln,{configurable:!0,value:e})},Bn=eu,Jf=Oe,ec=function(a,e,t){return t.get&&Bn(t.get,e,{getter:!0}),t.set&&Bn(t.set,e,{setter:!0}),Jf.f(a,e,t)},tc=je,rc=ec,ac=G,ic=le,Fn=ac("species"),nc=function(a){var e=tc(a);ic&&e&&!e[Fn]&&rc(e,Fn,{configurable:!0,get:function(){return this}})},sc=br,oc=TypeError,uc=function(a,e){if(sc(e,a))return a;throw new oc("Incorrect invocation")},lc=G,hc=lc("toStringTag"),uu={};uu[hc]="z";var vc=String(uu)==="[object z]",fc=vc,cc=B,or=Be,gc=G,dc=gc("toStringTag"),pc=Object,yc=or(function(){return arguments}())==="Arguments",mc=function(a,e){try{return a[e]}catch{}},Mi=fc?or:function(a){var e,t,r;return a===void 0?"Undefined":a===null?"Null":typeof(t=mc(e=pc(a),dc))=="string"?t:yc?or(e):(r=or(e))==="Object"&&cc(e.callee)?"Arguments":r},bc=L,xc=k,lu=B,Tc=Mi,Oc=je,Sc=Ci,hu=function(){},vu=Oc("Reflect","construct"),_i=/^\s*(?:class|function)\b/,Ec=bc(_i.exec),$c=!_i.test(hu),ct=function(e){if(!lu(e))return!1;try{return vu(hu,[],e),!0}catch{return!1}},fu=function(e){if(!lu(e))return!1;switch(Tc(e)){case"AsyncFunction":case"GeneratorFunction":case"AsyncGeneratorFunction":return!1}try{return $c||!!Ec(_i,Sc(e))}catch{return!0}};fu.sham=!0;var wc=!vu||xc(function(){var a;return ct(ct.call)||!ct(Object)||!ct(function(){a=!0})||a})?fu:ct,Cc=wc,Ac=xr,Pc=TypeError,Rc=function(a){if(Cc(a))return a;throw new Pc(Ac(a)+" is not a constructor")},jn=J,Nc=Rc,Ic=Fe,Mc=G,_c=Mc("species"),cu=function(a,e){var t=jn(a).constructor,r;return t===void 0||Ic(r=jn(t)[_c])?e:Nc(r)},Vc=mr,gu=Function.prototype,Un=gu.apply,zn=gu.call,du=typeof Reflect=="object"&&Reflect.apply||(Vc?zn.bind(Un):function(){return zn.apply(Un,arguments)}),Dc=Be,kc=L,Ar=function(a){if(Dc(a)==="Function")return kc(a)},Gn=Ar,Lc=Te,Bc=mr,Fc=Gn(Gn.bind),Vi=function(a,e){return Lc(a),e===void 0?a:Bc?Fc(a,e):function(){return a.apply(e,arguments)}},jc=je,pu=jc("document","documentElement"),Uc=L,zc=Uc([].slice),Gc=TypeError,Hc=function(a,e){if(a<e)throw new Gc("Not enough arguments");return a},Yc=Ct,yu=/(?:ipad|iphone|ipod).*applewebkit/i.test(Yc),ae=V,Xc=du,Wc=Vi,Hn=B,qc=fe,mu=k,Yn=pu,Qc=zc,Xn=Or,Kc=Hc,Zc=yu,Jc=wr,Qa=ae.setImmediate,Ka=ae.clearImmediate,eg=ae.process,va=ae.Dispatch,tg=ae.Function,Wn=ae.MessageChannel,rg=ae.String,fa=0,xt={},qn="onreadystatechange",St,Ie,ca,ga;mu(function(){St=ae.location});var Di=function(a){if(qc(xt,a)){var e=xt[a];delete xt[a],e()}},da=function(a){return function(){Di(a)}},Qn=function(a){Di(a.data)},Kn=function(a){ae.postMessage(rg(a),St.protocol+"//"+St.host)};(!Qa||!Ka)&&(Qa=function(e){Kc(arguments.length,1);var t=Hn(e)?e:tg(e),r=Qc(arguments,1);return xt[++fa]=function(){Xc(t,void 0,r)},Ie(fa),fa},Ka=function(e){delete xt[e]},Jc?Ie=function(a){eg.nextTick(da(a))}:va&&va.now?Ie=function(a){va.now(da(a))}:Wn&&!Zc?(ca=new Wn,ga=ca.port2,ca.port1.onmessage=Qn,Ie=Wc(ga.postMessage,ga)):ae.addEventListener&&Hn(ae.postMessage)&&!ae.importScripts&&St&&St.protocol!=="file:"&&!mu(Kn)?(Ie=Kn,ae.addEventListener("message",Qn,!1)):qn in Xn("script")?Ie=function(a){Yn.appendChild(Xn("script"))[qn]=function(){Yn.removeChild(this),Di(a)}}:Ie=function(a){setTimeout(da(a),0)});var bu={set:Qa,clear:Ka},Zn=V,ag=le,ig=Object.getOwnPropertyDescriptor,ng=function(a){if(!ag)return Zn[a];var e=ig(Zn,a);return e&&e.value},xu=function(){this.head=null,this.tail=null};xu.prototype={add:function(a){var e={item:a,next:null},t=this.tail;t?t.next=e:this.head=e,this.tail=e},get:function(){var a=this.head;if(a){var e=this.head=a.next;return e===null&&(this.tail=null),a.item}}};var Tu=xu,sg=Ct,og=/ipad|iphone|ipod/i.test(sg)&&typeof Pebble<"u",ug=Ct,lg=/web0s(?!.*chrome)/i.test(ug),it=V,hg=ng,Jn=Vi,pa=bu.set,vg=Tu,fg=yu,cg=og,gg=lg,ya=wr,es=it.MutationObserver||it.WebKitMutationObserver,ts=it.document,rs=it.process,Xt=it.Promise,Za=hg("queueMicrotask"),Xe,ma,ba,Wt,as;if(!Za){var qt=new vg,Qt=function(){var a,e;for(ya&&(a=rs.domain)&&a.exit();e=qt.get();)try{e()}catch(t){throw qt.head&&Xe(),t}a&&a.enter()};!fg&&!ya&&!gg&&es&&ts?(ma=!0,ba=ts.createTextNode(""),new es(Qt).observe(ba,{characterData:!0}),Xe=function(){ba.data=ma=!ma}):!cg&&Xt&&Xt.resolve?(Wt=Xt.resolve(void 0),Wt.constructor=Xt,as=Jn(Wt.then,Wt),Xe=function(){as(Qt)}):ya?Xe=function(){rs.nextTick(Qt)}:(pa=Jn(pa,it),Xe=function(){pa(Qt)}),Za=function(a){qt.head||Xe(),qt.add(a)}}var dg=Za,pg=function(a,e){try{arguments.length===1?console.error(a):console.error(a,e)}catch{}},ki=function(a){try{return{error:!1,value:a()}}catch(e){return{error:!0,value:e}}},yg=V,Pr=yg.Promise,mg=V,Tt=Pr,bg=B,xg=nu,Tg=Ci,Og=G,is=su,xa=Oi;Tt&&Tt.prototype;var Sg=Og("species"),Ja=!1,Ou=bg(mg.PromiseRejectionEvent),Eg=xg("Promise",function(){var a=Tg(Tt),e=a!==String(Tt);if(!e&&xa===66)return!0;if(!xa||xa<51||!/native code/.test(a)){var t=new Tt(function(n){n(1)}),r=function(n){n(function(){},function(){})},i=t.constructor={};if(i[Sg]=r,Ja=t.then(function(){})instanceof r,!Ja)return!0}return!e&&(is==="BROWSER"||is==="DENO")&&!Ou}),Rt={CONSTRUCTOR:Eg,REJECTION_EVENT:Ou,SUBCLASSING:Ja},lt={},ns=Te,$g=TypeError,wg=function(a){var e,t;this.promise=new a(function(r,i){if(e!==void 0||t!==void 0)throw new $g("Bad Promise constructor");e=r,t=i}),this.resolve=ns(e),this.reject=ns(t)};lt.f=function(a){return new wg(a)};var Cg=ee,dr=wr,we=V,nt=Y,ss=Ue,os=ou,Ag=Cr,Pg=nc,Rg=Te,ur=B,Ng=ve,Ig=uc,Mg=cu,Su=bu.set,Li=dg,_g=pg,Vg=ki,Dg=Tu,Eu=Er,pr=Pr,Bi=Rt,$u=lt,Rr="Promise",wu=Bi.CONSTRUCTOR,kg=Bi.REJECTION_EVENT,Lg=Bi.SUBCLASSING,Ta=Eu.getterFor(Rr),Bg=Eu.set,Qe=pr&&pr.prototype,De=pr,Kt=Qe,Cu=we.TypeError,ei=we.document,Fi=we.process,ti=$u.f,Fg=ti,jg=!!(ei&&ei.createEvent&&we.dispatchEvent),Au="unhandledrejection",Ug="rejectionhandled",us=0,Pu=1,zg=2,ji=1,Ru=2,Zt,ls,Gg,hs,Nu=function(a){var e;return Ng(a)&&ur(e=a.then)?e:!1},Iu=function(a,e){var t=e.value,r=e.state===Pu,i=r?a.ok:a.fail,n=a.resolve,o=a.reject,s=a.domain,u,l,h;try{i?(r||(e.rejection===Ru&&Yg(e),e.rejection=ji),i===!0?u=t:(s&&s.enter(),u=i(t),s&&(s.exit(),h=!0)),u===a.promise?o(new Cu("Promise-chain cycle")):(l=Nu(u))?nt(l,u,n,o):n(u)):o(t)}catch(f){s&&!h&&s.exit(),o(f)}},Mu=function(a,e){a.notified||(a.notified=!0,Li(function(){for(var t=a.reactions,r;r=t.get();)Iu(r,a);a.notified=!1,e&&!a.rejection&&Hg(a)}))},_u=function(a,e,t){var r,i;jg?(r=ei.createEvent("Event"),r.promise=e,r.reason=t,r.initEvent(a,!1,!0),we.dispatchEvent(r)):r={promise:e,reason:t},!kg&&(i=we["on"+a])?i(r):a===Au&&_g("Unhandled promise rejection",t)},Hg=function(a){nt(Su,we,function(){var e=a.facade,t=a.value,r=vs(a),i;if(r&&(i=Vg(function(){dr?Fi.emit("unhandledRejection",t,e):_u(Au,e,t)}),a.rejection=dr||vs(a)?Ru:ji,i.error))throw i.value})},vs=function(a){return a.rejection!==ji&&!a.parent},Yg=function(a){nt(Su,we,function(){var e=a.facade;dr?Fi.emit("rejectionHandled",e):_u(Ug,e,a.value)})},Je=function(a,e,t){return function(r){a(e,r,t)}},tt=function(a,e,t){a.done||(a.done=!0,t&&(a=t),a.value=e,a.state=zg,Mu(a,!0))},ri=function(a,e,t){if(!a.done){a.done=!0,t&&(a=t);try{if(a.facade===e)throw new Cu("Promise can't be resolved itself");var r=Nu(e);r?Li(function(){var i={done:!1};try{nt(r,e,Je(ri,i,a),Je(tt,i,a))}catch(n){tt(i,n,a)}}):(a.value=e,a.state=Pu,Mu(a,!1))}catch(i){tt({done:!1},i,a)}}};if(wu&&(De=function(e){Ig(this,Kt),Rg(e),nt(Zt,this);var t=Ta(this);try{e(Je(ri,t),Je(tt,t))}catch(r){tt(t,r)}},Kt=De.prototype,Zt=function(e){Bg(this,{type:Rr,done:!1,notified:!1,parent:!1,reactions:new Dg,rejection:!1,state:us,value:null})},Zt.prototype=ss(Kt,"then",function(e,t){var r=Ta(this),i=ti(Mg(this,De));return r.parent=!0,i.ok=ur(e)?e:!0,i.fail=ur(t)&&t,i.domain=dr?Fi.domain:void 0,r.state===us?r.reactions.add(i):Li(function(){Iu(i,r)}),i.promise}),ls=function(){var a=new Zt,e=Ta(a);this.promise=a,this.resolve=Je(ri,e),this.reject=Je(tt,e)},$u.f=ti=function(a){return a===De||a===Gg?new ls(a):Fg(a)},ur(pr)&&Qe!==Object.prototype)){hs=Qe.then,Lg||ss(Qe,"then",function(e,t){var r=this;return new De(function(i,n){nt(hs,r,i,n)}).then(e,t)},{unsafe:!0});try{delete Qe.constructor}catch{}os&&os(Qe,Kt)}Cg({global:!0,constructor:!0,wrap:!0,forced:wu},{Promise:De});Ag(De,Rr,!1);Pg(Rr);var Nt={},Xg=G,Wg=Nt,qg=Xg("iterator"),Qg=Array.prototype,Kg=function(a){return a!==void 0&&(Wg.Array===a||Qg[qg]===a)},Zg=Mi,fs=ot,Jg=Fe,ed=Nt,td=G,rd=td("iterator"),Vu=function(a){if(!Jg(a))return fs(a,rd)||fs(a,"@@iterator")||ed[Zg(a)]},ad=Y,id=Te,nd=J,sd=xr,od=Vu,ud=TypeError,ld=function(a,e){var t=arguments.length<2?od(a):e;if(id(t))return nd(ad(t,a));throw new ud(sd(a)+" is not iterable")},hd=Y,cs=J,vd=ot,fd=function(a,e,t){var r,i;cs(a);try{if(r=vd(a,"return"),!r){if(e==="throw")throw t;return t}r=hd(r,a)}catch(n){i=!0,r=n}if(e==="throw")throw t;if(i)throw r;return cs(r),t},cd=Vi,gd=Y,dd=J,pd=xr,yd=Kg,md=Ni,gs=br,bd=ld,xd=Vu,ds=fd,Td=TypeError,lr=function(a,e){this.stopped=a,this.result=e},ps=lr.prototype,Du=function(a,e,t){var r=t&&t.that,i=!!(t&&t.AS_ENTRIES),n=!!(t&&t.IS_RECORD),o=!!(t&&t.IS_ITERATOR),s=!!(t&&t.INTERRUPTED),u=cd(e,r),l,h,f,c,v,d,g,p=function(x){return l&&ds(l,"normal",x),new lr(!0,x)},y=function(x){return i?(dd(x),s?u(x[0],x[1],p):u(x[0],x[1])):s?u(x,p):u(x)};if(n)l=a.iterator;else if(o)l=a;else{if(h=xd(a),!h)throw new Td(pd(a)+" is not iterable");if(yd(h)){for(f=0,c=md(a);c>f;f++)if(v=y(a[f]),v&&gs(ps,v))return v;return new lr(!1)}l=bd(a,h)}for(d=n?a.next:l.next;!(g=gd(d,l)).done;){try{v=y(g.value)}catch(x){ds(l,"throw",x)}if(typeof v=="object"&&v&&gs(ps,v))return v}return new lr(!1)},Od=G,ku=Od("iterator"),Lu=!1;try{var Sd=0,ys={next:function(){return{done:!!Sd++}},return:function(){Lu=!0}};ys[ku]=function(){return this},Array.from(ys,function(){throw 2})}catch{}var Ed=function(a,e){try{if(!e&&!Lu)return!1}catch{return!1}var t=!1;try{var r={};r[ku]=function(){return{next:function(){return{done:t=!0}}}},a(r)}catch{}return t},$d=Pr,wd=Ed,Cd=Rt.CONSTRUCTOR,Bu=Cd||!wd(function(a){$d.all(a).then(void 0,function(){})}),Ad=ee,Pd=Y,Rd=Te,Nd=lt,Id=ki,Md=Du,_d=Bu;Ad({target:"Promise",stat:!0,forced:_d},{all:function(e){var t=this,r=Nd.f(t),i=r.resolve,n=r.reject,o=Id(function(){var s=Rd(t.resolve),u=[],l=0,h=1;Md(e,function(f){var c=l++,v=!1;h++,Pd(s,t,f).then(function(d){v||(v=!0,u[c]=d,--h||i(u))},n)}),--h||i(u)});return o.error&&n(o.value),r.promise}});var Vd=ee,Dd=Rt.CONSTRUCTOR,ai=Pr,kd=je,Ld=B,Bd=Ue,ms=ai&&ai.prototype;Vd({target:"Promise",proto:!0,forced:Dd,real:!0},{catch:function(a){return this.then(void 0,a)}});if(Ld(ai)){var bs=kd("Promise").prototype.catch;ms.catch!==bs&&Bd(ms,"catch",bs,{unsafe:!0})}var Fd=ee,jd=Y,Ud=Te,zd=lt,Gd=ki,Hd=Du,Yd=Bu;Fd({target:"Promise",stat:!0,forced:Yd},{race:function(e){var t=this,r=zd.f(t),i=r.reject,n=Gd(function(){var o=Ud(t.resolve);Hd(e,function(s){jd(o,t,s).then(r.resolve,i)})});return n.error&&i(n.value),r.promise}});var Xd=ee,Wd=lt,qd=Rt.CONSTRUCTOR;Xd({target:"Promise",stat:!0,forced:qd},{reject:function(e){var t=Wd.f(this),r=t.reject;return r(e),t.promise}});var Qd=J,Kd=ve,Zd=lt,Jd=function(a,e){if(Qd(a),Kd(e)&&e.constructor===a)return e;var t=Zd.f(a),r=t.resolve;return r(e),t.promise},ep=ee,tp=je,rp=Rt.CONSTRUCTOR,ap=Jd;tp("Promise");ep({target:"Promise",stat:!0,forced:rp},{resolve:function(e){return ap(this,e)}});function xs(a,e,t,r,i,n,o){try{var s=a[n](o),u=s.value}catch(l){return void t(l)}s.done?e(u):Promise.resolve(u).then(r,i)}function xe(a){return function(){var e=this,t=arguments;return new Promise(function(r,i){var n=a.apply(e,t);function o(u){xs(n,r,i,o,s,"next",u)}function s(u){xs(n,r,i,o,s,"throw",u)}o(void 0)})}}var ip=Mi,np=String,pe=function(a){if(ip(a)==="Symbol")throw new TypeError("Cannot convert a Symbol value to a string");return np(a)},sp=J,Fu=function(){var a=sp(this),e="";return a.hasIndices&&(e+="d"),a.global&&(e+="g"),a.ignoreCase&&(e+="i"),a.multiline&&(e+="m"),a.dotAll&&(e+="s"),a.unicode&&(e+="u"),a.unicodeSets&&(e+="v"),a.sticky&&(e+="y"),e},Ui=k,op=V,zi=op.RegExp,Gi=Ui(function(){var a=zi("a","y");return a.lastIndex=2,a.exec("abcd")!==null}),up=Gi||Ui(function(){return!zi("a","y").sticky}),lp=Gi||Ui(function(){var a=zi("^r","gy");return a.lastIndex=2,a.exec("str")!==null}),ju={BROKEN_CARET:lp,MISSED_STICKY:up,UNSUPPORTED_Y:Gi},Uu={},hp=au,vp=Ii,fp=Object.keys||function(e){return hp(e,vp)},cp=le,gp=qo,dp=Oe,pp=J,yp=wt,mp=fp;Uu.f=cp&&!gp?Object.defineProperties:function(e,t){pp(e);for(var r=yp(t),i=mp(t),n=i.length,o=0,s;n>o;)dp.f(e,s=i[o++],r[s]);return e};var bp=J,xp=Uu,Ts=Ii,Tp=Pi,Op=pu,Sp=Or,Ep=Ai,Os=">",Ss="<",ii="prototype",ni="script",zu=Ep("IE_PROTO"),Oa=function(){},Gu=function(a){return Ss+ni+Os+a+Ss+"/"+ni+Os},Es=function(a){a.write(Gu("")),a.close();var e=a.parentWindow.Object;return a=null,e},$p=function(){var a=Sp("iframe"),e="java"+ni+":",t;return a.style.display="none",Op.appendChild(a),a.src=String(e),t=a.contentWindow.document,t.open(),t.write(Gu("document.F=Object")),t.close(),t.F},Jt,hr=function(){try{Jt=new ActiveXObject("htmlfile")}catch{}hr=typeof document<"u"?document.domain&&Jt?Es(Jt):$p():Es(Jt);for(var a=Ts.length;a--;)delete hr[ii][Ts[a]];return hr()};Tp[zu]=!0;var Hi=Object.create||function(e,t){var r;return e!==null?(Oa[ii]=bp(e),r=new Oa,Oa[ii]=null,r[zu]=e):r=hr(),t===void 0?r:xp.f(r,t)},wp=k,Cp=V,Ap=Cp.RegExp,Pp=wp(function(){var a=Ap(".","s");return!(a.dotAll&&a.test(`
`)&&a.flags==="s")}),Rp=k,Np=V,Ip=Np.RegExp,Mp=Rp(function(){var a=Ip("(?<a>b)","g");return a.exec("b").groups.a!=="b"||"b".replace(a,"$<a>c")!=="bc"}),et=Y,Nr=L,_p=pe,Vp=Fu,Dp=ju,kp=$i,Lp=Hi,Bp=Er.get,Fp=Pp,jp=Mp,Up=kp("native-string-replace",String.prototype.replace),yr=RegExp.prototype.exec,si=yr,zp=Nr("".charAt),Gp=Nr("".indexOf),Hp=Nr("".replace),Sa=Nr("".slice),oi=function(){var a=/a/,e=/b*/g;return et(yr,a,"a"),et(yr,e,"a"),a.lastIndex!==0||e.lastIndex!==0}(),Hu=Dp.BROKEN_CARET,ui=/()??/.exec("")[1]!==void 0,Yp=oi||ui||Hu||Fp||jp;Yp&&(si=function(e){var t=this,r=Bp(t),i=_p(e),n=r.raw,o,s,u,l,h,f,c;if(n)return n.lastIndex=t.lastIndex,o=et(si,n,i),t.lastIndex=n.lastIndex,o;var v=r.groups,d=Hu&&t.sticky,g=et(Vp,t),p=t.source,y=0,x=i;if(d&&(g=Hp(g,"y",""),Gp(g,"g")===-1&&(g+="g"),x=Sa(i,t.lastIndex),t.lastIndex>0&&(!t.multiline||t.multiline&&zp(i,t.lastIndex-1)!==`
`)&&(p="(?: "+p+")",x=" "+x,y++),s=new RegExp("^(?:"+p+")",g)),ui&&(s=new RegExp("^"+p+"$(?!\\s)",g)),oi&&(u=t.lastIndex),l=et(yr,d?s:t,x),d?l?(l.input=Sa(l.input,y),l[0]=Sa(l[0],y),l.index=t.lastIndex,t.lastIndex+=l[0].length):t.lastIndex=0:oi&&l&&(t.lastIndex=t.global?l.index+l[0].length:u),ui&&l&&l.length>1&&et(Up,l[0],s,function(){for(h=1;h<arguments.length-2;h++)arguments[h]===void 0&&(l[h]=void 0)}),l&&v)for(l.groups=f=Lp(null),h=0;h<v.length;h++)c=v[h],f[c[0]]=l[c[1]];return l});var Yi=si,Xp=ee,$s=Yi;Xp({target:"RegExp",proto:!0,forced:/./.exec!==$s},{exec:$s});var ws=Y,Cs=Ue,Wp=Yi,As=k,Yu=G,qp=At,Qp=Yu("species"),Ea=RegExp.prototype,Xi=function(a,e,t,r){var i=Yu(a),n=!As(function(){var l={};return l[i]=function(){return 7},""[a](l)!==7}),o=n&&!As(function(){var l=!1,h=/a/;return a==="split"&&(h={},h.constructor={},h.constructor[Qp]=function(){return h},h.flags="",h[i]=/./[i]),h.exec=function(){return l=!0,null},h[i](""),!l});if(!n||!o||t){var s=/./[i],u=e(i,""[a],function(l,h,f,c,v){var d=h.exec;return d===Wp||d===Ea.exec?n&&!v?{done:!0,value:ws(s,h,f,c)}:{done:!0,value:ws(l,f,h,c)}:{done:!1}});Cs(String.prototype,a,u[0]),Cs(Ea,i,u[1])}r&&qp(Ea[i],"sham",!0)},Wi=L,Kp=$r,Zp=pe,Jp=he,ey=Wi("".charAt),Ps=Wi("".charCodeAt),ty=Wi("".slice),Rs=function(a){return function(e,t){var r=Zp(Jp(e)),i=Kp(t),n=r.length,o,s;return i<0||i>=n?a?"":void 0:(o=Ps(r,i),o<55296||o>56319||i+1===n||(s=Ps(r,i+1))<56320||s>57343?a?ey(r,i):o:a?ty(r,i,i+2):(o-55296<<10)+(s-56320)+65536)}},ry={codeAt:Rs(!1),charAt:Rs(!0)},ay=ry.charAt,qi=function(a,e,t){return e+(t?ay(a,e).length:1)},Ns=Y,iy=J,ny=B,sy=Be,oy=Yi,uy=TypeError,Qi=function(a,e){var t=a.exec;if(ny(t)){var r=Ns(t,a,e);return r!==null&&iy(r),r}if(sy(a)==="RegExp")return Ns(oy,a,e);throw new uy("RegExp#exec called on incompatible receiver")},ly=Y,hy=Xi,vy=J,fy=Fe,cy=ut,$a=pe,gy=he,dy=ot,py=qi,Is=Qi;hy("match",function(a,e,t){return[function(i){var n=gy(this),o=fy(i)?void 0:dy(i,a);return o?ly(o,i,n):new RegExp(i)[a]($a(n))},function(r){var i=vy(this),n=$a(r),o=t(e,i,n);if(o.done)return o.value;if(!i.global)return Is(i,n);var s=i.unicode;i.lastIndex=0;for(var u=[],l=0,h;(h=Is(i,n))!==null;){var f=$a(h[0]);u[l]=f,f===""&&(i.lastIndex=py(n,cy(i.lastIndex),s)),l++}return l===0?null:u}]});var Ki=L,yy=Tr,my=Math.floor,wa=Ki("".charAt),by=Ki("".replace),Ca=Ki("".slice),xy=/\$([$&'`]|\d{1,2}|<[^>]*>)/g,Ty=/\$([$&'`]|\d{1,2})/g,Oy=function(a,e,t,r,i,n){var o=t+a.length,s=r.length,u=Ty;return i!==void 0&&(i=yy(i),u=xy),by(n,u,function(l,h){var f;switch(wa(h,0)){case"$":return"$";case"&":return a;case"`":return Ca(e,0,t);case"'":return Ca(e,o);case"<":f=i[Ca(h,1,-1)];break;default:var c=+h;if(c===0)return l;if(c>s){var v=my(c/10);return v===0?l:v<=s?r[v-1]===void 0?wa(h,1):r[v-1]+wa(h,1):l}f=r[c-1]}return f===void 0?"":f})},Sy=du,Ms=Y,Ir=L,Ey=Xi,$y=k,wy=J,Cy=B,Ay=Fe,Py=$r,Ry=ut,We=pe,Ny=he,Iy=qi,My=ot,_y=Oy,Vy=Qi,Dy=G,li=Dy("replace"),ky=Math.max,Ly=Math.min,By=Ir([].concat),Aa=Ir([].push),_s=Ir("".indexOf),Vs=Ir("".slice),Fy=function(a){return a===void 0?a:String(a)},jy=function(){return"a".replace(/./,"$0")==="$0"}(),Ds=function(){return/./[li]?/./[li]("a","$0")==="":!1}(),Uy=!$y(function(){var a=/./;return a.exec=function(){var e=[];return e.groups={a:"7"},e},"".replace(a,"$<a>")!=="7"});Ey("replace",function(a,e,t){var r=Ds?"$":"$0";return[function(n,o){var s=Ny(this),u=Ay(n)?void 0:My(n,li);return u?Ms(u,n,s,o):Ms(e,We(s),n,o)},function(i,n){var o=wy(this),s=We(i);if(typeof n=="string"&&_s(n,r)===-1&&_s(n,"$<")===-1){var u=t(e,o,s,n);if(u.done)return u.value}var l=Cy(n);l||(n=We(n));var h=o.global,f;h&&(f=o.unicode,o.lastIndex=0);for(var c=[],v;v=Vy(o,s),!(v===null||(Aa(c,v),!h));){var d=We(v[0]);d===""&&(o.lastIndex=Iy(s,Ry(o.lastIndex),f))}for(var g="",p=0,y=0;y<c.length;y++){v=c[y];for(var x=We(v[0]),b=ky(Ly(Py(v.index),s.length),0),T=[],$,E=1;E<v.length;E++)Aa(T,Fy(v[E]));var O=v.groups;if(l){var C=By([x],T,b,s);O!==void 0&&Aa(C,O),$=We(Sy(n,void 0,C))}else $=_y(x,s,b,T,O,n);b>=p&&(g+=Vs(s,p,b)+$,p=b+x.length)}return g+Vs(s,p)}]},!Uy||!jy||Ds);var zy=ve,Gy=Be,Hy=G,Yy=Hy("match"),Xy=function(a){var e;return zy(a)&&((e=a[Yy])!==void 0?!!e:Gy(a)==="RegExp")},Wy=Xy,qy=TypeError,Zi=function(a){if(Wy(a))throw new qy("The method doesn't accept regular expressions");return a},Qy=G,Ky=Qy("match"),Ji=function(a){var e=/./;try{"/./"[a](e)}catch{try{return e[Ky]=!1,"/./"[a](e)}catch{}}return!1},Zy=ee,Jy=Ar,em=$t.f,tm=ut,ks=pe,rm=Zi,am=he,im=Ji,nm=Jy("".slice),sm=Math.min,Xu=im("startsWith"),om=!Xu&&!!function(){var a=em(String.prototype,"startsWith");return a&&!a.writable}();Zy({target:"String",proto:!0,forced:!om&&!Xu},{startsWith:function(e){var t=ks(am(this));rm(e);var r=tm(sm(arguments.length>1?arguments[1]:void 0,t.length)),i=ks(e);return nm(t,r,r+i.length)===i}});var um=G,lm=Hi,hm=Oe.f,hi=um("unscopables"),vi=Array.prototype;vi[hi]===void 0&&hm(vi,hi,{configurable:!0,value:lm(null)});var vm=function(a){vi[hi][a]=!0},fm=k,cm=!fm(function(){function a(){}return a.prototype.constructor=null,Object.getPrototypeOf(new a)!==a.prototype}),gm=fe,dm=B,pm=Tr,ym=Ai,mm=cm,Ls=ym("IE_PROTO"),fi=Object,bm=fi.prototype,Wu=mm?fi.getPrototypeOf:function(a){var e=pm(a);if(gm(e,Ls))return e[Ls];var t=e.constructor;return dm(t)&&e instanceof t?t.prototype:e instanceof fi?bm:null},xm=k,Tm=B,Om=ve,Bs=Wu,Sm=Ue,Em=G,ci=Em("iterator"),qu=!1,ke,Pa,Ra;[].keys&&(Ra=[].keys(),"next"in Ra?(Pa=Bs(Bs(Ra)),Pa!==Object.prototype&&(ke=Pa)):qu=!0);var $m=!Om(ke)||xm(function(){var a={};return ke[ci].call(a)!==a});$m&&(ke={});Tm(ke[ci])||Sm(ke,ci,function(){return this});var Qu={IteratorPrototype:ke,BUGGY_SAFARI_ITERATORS:qu},wm=Qu.IteratorPrototype,Cm=Hi,Am=Ti,Pm=Cr,Rm=Nt,Nm=function(){return this},Im=function(a,e,t,r){var i=e+" Iterator";return a.prototype=Cm(wm,{next:Am(+!r,t)}),Pm(a,i,!1),Rm[i]=Nm,a},Mm=ee,_m=Y,Ku=Sr,Vm=B,Dm=Im,Fs=Wu,js=ou,km=Cr,Lm=At,Na=Ue,Bm=G,Fm=Nt,Zu=Qu,jm=Ku.PROPER,Um=Ku.CONFIGURABLE,Us=Zu.IteratorPrototype,er=Zu.BUGGY_SAFARI_ITERATORS,gt=Bm("iterator"),zs="keys",dt="values",Gs="entries",zm=function(){return this},Gm=function(a,e,t,r,i,n,o){Dm(t,e,r);var s=function(y){if(y===i&&c)return c;if(!er&&y&&y in h)return h[y];switch(y){case zs:return function(){return new t(this,y)};case dt:return function(){return new t(this,y)};case Gs:return function(){return new t(this,y)}}return function(){return new t(this)}},u=e+" Iterator",l=!1,h=a.prototype,f=h[gt]||h["@@iterator"]||i&&h[i],c=!er&&f||s(i),v=e==="Array"&&h.entries||f,d,g,p;if(v&&(d=Fs(v.call(new a)),d!==Object.prototype&&d.next&&(Fs(d)!==Us&&(js?js(d,Us):Vm(d[gt])||Na(d,gt,zm)),km(d,u,!0))),jm&&i===dt&&f&&f.name!==dt&&(Um?Lm(h,"name",dt):(l=!0,c=function(){return _m(f,this)})),i)if(g={values:s(dt),keys:n?c:s(zs),entries:s(Gs)},o)for(p in g)(er||l||!(p in h))&&Na(h,p,g[p]);else Mm({target:e,proto:!0,forced:er||l},g);return h[gt]!==c&&Na(h,gt,c,{name:i}),Fm[e]=c,g},Hm=function(a,e){return{value:a,done:e}},Ym=wt,en=vm,Hs=Nt,Ju=Er,Xm=Oe.f,Wm=Gm,tr=Hm,qm=le,el="Array Iterator",Qm=Ju.set,Km=Ju.getterFor(el),Zm=Wm(Array,"Array",function(a,e){Qm(this,{type:el,target:Ym(a),index:0,kind:e})},function(){var a=Km(this),e=a.target,t=a.index++;if(!e||t>=e.length)return a.target=null,tr(void 0,!0);switch(a.kind){case"keys":return tr(t,!1);case"values":return tr(e[t],!1)}return tr([t,e[t]],!1)},"values"),Ys=Hs.Arguments=Hs.Array;en("keys");en("values");en("entries");if(qm&&Ys.name!=="values")try{Xm(Ys,"name",{value:"values"})}catch{}var Jm={CSSRuleList:0,CSSStyleDeclaration:0,CSSValueList:0,ClientRectList:0,DOMRectList:0,DOMStringList:0,DOMTokenList:1,DataTransferItemList:0,FileList:0,HTMLAllCollection:0,HTMLCollection:0,HTMLFormElement:0,HTMLSelectElement:0,MediaList:0,MimeTypeArray:0,NamedNodeMap:0,NodeList:1,PaintRequestList:0,Plugin:0,PluginArray:0,SVGLengthList:0,SVGNumberList:0,SVGPathSegList:0,SVGPointList:0,SVGStringList:0,SVGTransformList:0,SourceBufferList:0,StyleSheetList:0,TextTrackCueList:0,TextTrackList:0,TouchList:0},e0=Or,Ia=e0("span").classList,Xs=Ia&&Ia.constructor&&Ia.constructor.prototype,t0=Xs===Object.prototype?void 0:Xs,Ws=V,tl=Jm,r0=t0,yt=Zm,qs=At,a0=Cr,i0=G,Ma=i0("iterator"),_a=yt.values,rl=function(a,e){if(a){if(a[Ma]!==_a)try{qs(a,Ma,_a)}catch{a[Ma]=_a}if(a0(a,e,!0),tl[e]){for(var t in yt)if(a[t]!==yt[t])try{qs(a,t,yt[t])}catch{a[t]=yt[t]}}}};for(var Va in tl)rl(Ws[Va]&&Ws[Va].prototype,Va);rl(r0,"DOMTokenList");var n0=Te,s0=Tr,o0=Fo,u0=Ni,Qs=TypeError,Ks="Reduce of empty array with no initial value",Zs=function(a){return function(e,t,r,i){var n=s0(e),o=o0(n),s=u0(n);if(n0(t),s===0&&r<2)throw new Qs(Ks);var u=a?s-1:0,l=a?-1:1;if(r<2)for(;;){if(u in o){i=o[u],u+=l;break}if(u+=l,a?u<0:s<=u)throw new Qs(Ks)}for(;a?u>=0:s>u;u+=l)u in o&&(i=t(i,o[u],u,n));return i}},l0={left:Zs(!1),right:Zs(!0)},h0=k,al=function(a,e){var t=[][a];return!!t&&h0(function(){t.call(null,e||function(){return 1},1)})},v0=ee,f0=l0.left,c0=al,Js=Oi,g0=wr,d0=!g0&&Js>79&&Js<83,p0=d0||!c0("reduce");v0({target:"Array",proto:!0,forced:p0},{reduce:function(e){var t=arguments.length;return f0(this,e,t,t>1?arguments[1]:void 0)}});var y0=ee,m0=Ar,b0=$t.f,x0=ut,eo=pe,T0=Zi,O0=he,S0=Ji,E0=m0("".slice),$0=Math.min,il=S0("endsWith"),w0=!il&&!!function(){var a=b0(String.prototype,"endsWith");return a&&!a.writable}();y0({target:"String",proto:!0,forced:!w0&&!il},{endsWith:function(e){var t=eo(O0(this));T0(e);var r=arguments.length>1?arguments[1]:void 0,i=t.length,n=r===void 0?i:$0(x0(r),i),o=eo(e);return E0(t,n-o.length,n)===o}});var Da=Y,nl=L,C0=Xi,A0=J,P0=Fe,R0=he,N0=cu,I0=qi,M0=ut,to=pe,_0=ot,ro=Qi,V0=ju,D0=k,qe=V0.UNSUPPORTED_Y,k0=4294967295,L0=Math.min,ka=nl([].push),La=nl("".slice),B0=!D0(function(){var a=/(?:)/,e=a.exec;a.exec=function(){return e.apply(this,arguments)};var t="ab".split(a);return t.length!==2||t[0]!=="a"||t[1]!=="b"}),ao="abbc".split(/(b)*/)[1]==="c"||"test".split(/(?:)/,-1).length!==4||"ab".split(/(?:ab)*/).length!==2||".".split(/(.?)(.?)/).length!==4||".".split(/()()/).length>1||"".split(/.?/).length;C0("split",function(a,e,t){var r="0".split(void 0,0).length?function(i,n){return i===void 0&&n===0?[]:Da(e,this,i,n)}:e;return[function(n,o){var s=R0(this),u=P0(n)?void 0:_0(n,a);return u?Da(u,n,s,o):Da(r,to(s),n,o)},function(i,n){var o=A0(this),s=to(i);if(!ao){var u=t(r,o,s,n,r!==e);if(u.done)return u.value}var l=N0(o,RegExp),h=o.unicode,f=(o.ignoreCase?"i":"")+(o.multiline?"m":"")+(o.unicode?"u":"")+(qe?"g":"y"),c=new l(qe?"^(?:"+o.source+")":o,f),v=n===void 0?k0:n>>>0;if(v===0)return[];if(s.length===0)return ro(c,s)===null?[s]:[];for(var d=0,g=0,p=[];g<s.length;){c.lastIndex=qe?0:g;var y=ro(c,qe?La(s,g):s),x;if(y===null||(x=L0(M0(c.lastIndex+(qe?g:0)),s.length))===d)g=I0(s,g,h);else{if(ka(p,La(s,d,g)),p.length===v)return p;for(var b=1;b<=y.length-1;b++)if(ka(p,y[b]),p.length===v)return p;g=d=x}}return ka(p,La(s,d)),p}]},ao||!B0,qe);var Mr={exports:{}},mt={exports:{}};(function(){var a,e,t,r,i,n;typeof performance<"u"&&performance!==null&&performance.now?mt.exports=function(){return performance.now()}:typeof process<"u"&&process!==null&&process.hrtime?(mt.exports=function(){return(a()-i)/1e6},e=process.hrtime,a=function(){var o;return o=e(),o[0]*1e9+o[1]},r=a(),n=process.uptime()*1e9,i=r-n):Date.now?(mt.exports=function(){return Date.now()-t},t=Date.now()):(mt.exports=function(){return new Date().getTime()-t},t=new Date().getTime())}).call(Ke);var F0=mt.exports,j0=F0,be=typeof window>"u"?Ke:window,rr=["moz","webkit"],rt="AnimationFrame",st=be["request"+rt],Et=be["cancel"+rt]||be["cancelRequest"+rt];for(var pt=0;!st&&pt<rr.length;pt++)st=be[rr[pt]+"Request"+rt],Et=be[rr[pt]+"Cancel"+rt]||be[rr[pt]+"CancelRequest"+rt];if(!st||!Et){var Ba=0,io=0,Me=[],U0=1e3/60;st=function(a){if(Me.length===0){var e=j0(),t=Math.max(0,U0-(e-Ba));Ba=t+e,setTimeout(function(){var r=Me.slice(0);Me.length=0;for(var i=0;i<r.length;i++)if(!r[i].cancelled)try{r[i].callback(Ba)}catch(n){setTimeout(function(){throw n},0)}},Math.round(t))}return Me.push({handle:++io,callback:a,cancelled:!1}),io},Et=function(a){for(var e=0;e<Me.length;e++)Me[e].handle===a&&(Me[e].cancelled=!0)}}Mr.exports=function(a){return st.call(be,a)};Mr.exports.cancel=function(){Et.apply(be,arguments)};Mr.exports.polyfill=function(a){a||(a=be),a.requestAnimationFrame=st,a.cancelAnimationFrame=Et};var z0=Mr.exports;const Fa=Mo(z0);var sl=`	
\v\f\r                　\u2028\u2029\uFEFF`,G0=L,H0=he,Y0=pe,gi=sl,no=G0("".replace),X0=RegExp("^["+gi+"]+"),W0=RegExp("(^|[^"+gi+"])["+gi+"]+$"),ja=function(a){return function(e){var t=Y0(H0(e));return a&1&&(t=no(t,X0,"")),a&2&&(t=no(t,W0,"$1")),t}},q0={start:ja(1),end:ja(2),trim:ja(3)},Q0=Sr.PROPER,K0=k,so=sl,oo="​᠎",Z0=function(a){return K0(function(){return!!so[a]()||oo[a]()!==oo||Q0&&so[a].name!==a})},J0=ee,eb=q0.trim,tb=Z0;J0({target:"String",proto:!0,forced:tb("trim")},{trim:function(){return eb(this)}});var rb=function(a){this.ok=!1,this.alpha=1,a.charAt(0)=="#"&&(a=a.substr(1,6)),a=a.replace(/ /g,""),a=a.toLowerCase();var e={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"00ffff",aquamarine:"7fffd4",azure:"f0ffff",beige:"f5f5dc",bisque:"ffe4c4",black:"000000",blanchedalmond:"ffebcd",blue:"0000ff",blueviolet:"8a2be2",brown:"a52a2a",burlywood:"deb887",cadetblue:"5f9ea0",chartreuse:"7fff00",chocolate:"d2691e",coral:"ff7f50",cornflowerblue:"6495ed",cornsilk:"fff8dc",crimson:"dc143c",cyan:"00ffff",darkblue:"00008b",darkcyan:"008b8b",darkgoldenrod:"b8860b",darkgray:"a9a9a9",darkgreen:"006400",darkkhaki:"bdb76b",darkmagenta:"8b008b",darkolivegreen:"556b2f",darkorange:"ff8c00",darkorchid:"9932cc",darkred:"8b0000",darksalmon:"e9967a",darkseagreen:"8fbc8f",darkslateblue:"483d8b",darkslategray:"2f4f4f",darkturquoise:"00ced1",darkviolet:"9400d3",deeppink:"ff1493",deepskyblue:"00bfff",dimgray:"696969",dodgerblue:"1e90ff",feldspar:"d19275",firebrick:"b22222",floralwhite:"fffaf0",forestgreen:"228b22",fuchsia:"ff00ff",gainsboro:"dcdcdc",ghostwhite:"f8f8ff",gold:"ffd700",goldenrod:"daa520",gray:"808080",green:"008000",greenyellow:"adff2f",honeydew:"f0fff0",hotpink:"ff69b4",indianred:"cd5c5c",indigo:"4b0082",ivory:"fffff0",khaki:"f0e68c",lavender:"e6e6fa",lavenderblush:"fff0f5",lawngreen:"7cfc00",lemonchiffon:"fffacd",lightblue:"add8e6",lightcoral:"f08080",lightcyan:"e0ffff",lightgoldenrodyellow:"fafad2",lightgrey:"d3d3d3",lightgreen:"90ee90",lightpink:"ffb6c1",lightsalmon:"ffa07a",lightseagreen:"20b2aa",lightskyblue:"87cefa",lightslateblue:"8470ff",lightslategray:"778899",lightsteelblue:"b0c4de",lightyellow:"ffffe0",lime:"00ff00",limegreen:"32cd32",linen:"faf0e6",magenta:"ff00ff",maroon:"800000",mediumaquamarine:"66cdaa",mediumblue:"0000cd",mediumorchid:"ba55d3",mediumpurple:"9370d8",mediumseagreen:"3cb371",mediumslateblue:"7b68ee",mediumspringgreen:"00fa9a",mediumturquoise:"48d1cc",mediumvioletred:"c71585",midnightblue:"191970",mintcream:"f5fffa",mistyrose:"ffe4e1",moccasin:"ffe4b5",navajowhite:"ffdead",navy:"000080",oldlace:"fdf5e6",olive:"808000",olivedrab:"6b8e23",orange:"ffa500",orangered:"ff4500",orchid:"da70d6",palegoldenrod:"eee8aa",palegreen:"98fb98",paleturquoise:"afeeee",palevioletred:"d87093",papayawhip:"ffefd5",peachpuff:"ffdab9",peru:"cd853f",pink:"ffc0cb",plum:"dda0dd",powderblue:"b0e0e6",purple:"800080",rebeccapurple:"663399",red:"ff0000",rosybrown:"bc8f8f",royalblue:"4169e1",saddlebrown:"8b4513",salmon:"fa8072",sandybrown:"f4a460",seagreen:"2e8b57",seashell:"fff5ee",sienna:"a0522d",silver:"c0c0c0",skyblue:"87ceeb",slateblue:"6a5acd",slategray:"708090",snow:"fffafa",springgreen:"00ff7f",steelblue:"4682b4",tan:"d2b48c",teal:"008080",thistle:"d8bfd8",tomato:"ff6347",turquoise:"40e0d0",violet:"ee82ee",violetred:"d02090",wheat:"f5deb3",white:"ffffff",whitesmoke:"f5f5f5",yellow:"ffff00",yellowgreen:"9acd32"};a=e[a]||a;for(var t=[{re:/^rgba\((\d{1,3}),\s*(\d{1,3}),\s*(\d{1,3}),\s*((?:\d?\.)?\d)\)$/,example:["rgba(123, 234, 45, 0.8)","rgba(255,234,245,1.0)"],process:function(u){return[parseInt(u[1]),parseInt(u[2]),parseInt(u[3]),parseFloat(u[4])]}},{re:/^rgb\((\d{1,3}),\s*(\d{1,3}),\s*(\d{1,3})\)$/,example:["rgb(123, 234, 45)","rgb(255,234,245)"],process:function(u){return[parseInt(u[1]),parseInt(u[2]),parseInt(u[3])]}},{re:/^([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/,example:["#00ff00","336699"],process:function(u){return[parseInt(u[1],16),parseInt(u[2],16),parseInt(u[3],16)]}},{re:/^([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,example:["#fb0","f0f"],process:function(u){return[parseInt(u[1]+u[1],16),parseInt(u[2]+u[2],16),parseInt(u[3]+u[3],16)]}}],r=0;r<t.length;r++){var i=t[r].re,n=t[r].process,o=i.exec(a);if(o){var s=n(o);this.r=s[0],this.g=s[1],this.b=s[2],s.length>3&&(this.alpha=s[3]),this.ok=!0}}this.r=this.r<0||isNaN(this.r)?0:this.r>255?255:this.r,this.g=this.g<0||isNaN(this.g)?0:this.g>255?255:this.g,this.b=this.b<0||isNaN(this.b)?0:this.b>255?255:this.b,this.alpha=this.alpha<0?0:this.alpha>1||isNaN(this.alpha)?1:this.alpha,this.toRGB=function(){return"rgb("+this.r+", "+this.g+", "+this.b+")"},this.toRGBA=function(){return"rgba("+this.r+", "+this.g+", "+this.b+", "+this.alpha+")"},this.toHex=function(){var u=this.r.toString(16),l=this.g.toString(16),h=this.b.toString(16);return u.length==1&&(u="0"+u),l.length==1&&(l="0"+l),h.length==1&&(h="0"+h),"#"+u+l+h},this.getHelpXML=function(){for(var u=new Array,l=0;l<t.length;l++)for(var h=t[l].example,f=0;f<h.length;f++)u[u.length]=h[f];for(var c in e)u[u.length]=c;var v=document.createElement("ul");v.setAttribute("id","rgbcolor-examples");for(var l=0;l<u.length;l++)try{var d=document.createElement("li"),g=new RGBColor(u[l]),p=document.createElement("div");p.style.cssText="margin: 3px; border: 1px solid black; background:"+g.toHex()+"; color:"+g.toHex(),p.appendChild(document.createTextNode("test"));var y=document.createTextNode(" "+u[l]+" -> "+g.toRGB()+" -> "+g.toHex());d.appendChild(p),d.appendChild(y),v.appendChild(d)}catch{}return v}};const di=Mo(rb);var ab=ee,ib=Ar,nb=ru.indexOf,sb=al,pi=ib([].indexOf),ol=!!pi&&1/pi([1],1,-0)<0,ob=ol||!sb("indexOf");ab({target:"Array",proto:!0,forced:ob},{indexOf:function(e){var t=arguments.length>1?arguments[1]:void 0;return ol?pi(this,e,t)||0:nb(this,e,t)}});var ub=ee,lb=L,hb=Zi,vb=he,uo=pe,fb=Ji,cb=lb("".indexOf);ub({target:"String",proto:!0,forced:!fb("includes")},{includes:function(e){return!!~cb(uo(vb(this)),uo(hb(e)),arguments.length>1?arguments[1]:void 0)}});var gb=Be,db=Array.isArray||function(e){return gb(e)==="Array"},pb=ee,yb=L,mb=db,bb=yb([].reverse),lo=[1,2];pb({target:"Array",proto:!0,forced:String(lo)===String(lo.reverse())},{reverse:function(){return mb(this)&&(this.length=this.length),bb(this)}});/*! *****************************************************************************

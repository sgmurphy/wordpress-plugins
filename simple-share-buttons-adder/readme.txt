...
= 8.5.1 =
* add escaping to additional css outputs.

= 8.5.0 =
* Fix all PHP 8.2 deprecated errors.
* Fix ssba block.
* Test with WP v6.5.2.

= 8.4.12 =
* Sanitize custom css input/output.

= 8.4.11 =
* Revert autop fix.

= 8.4.10 =
* Fix wpautop introduced issue.

= 8.4.9 =
* Update twitter icon.
* Fix wpautop conflicts.

= 8.4.8 =
* Fix missing icons.

= 8.4.7 =
* Add missing nonce check in review hide function.
* Test on wp ver 6.2

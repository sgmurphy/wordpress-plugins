...
if (!class_exists('WPRProtectFWRuleEngine_V572')) :
require_once dirname( __FILE__ ) . '/functions.php';

class WPRProtectFWRuleEngine_V572 {
	use WPRProtectFWRuleStringFunc_V572;
	use WPRProtectFWRuleArrayFunc_V572;
	use WPRProtectFWRuleMiscFunc_V572;
	use WPRProtectFWRuleRequestFunc_V572;
	use WPRProtectFWRuleWPFunc_V572;
	...
	const CONST_NAME_PREFIX = 'WPRProtectFWRule_V572::';
	...
	public function evaluate($rule) {
		...
		} catch (WPRProtectRuleError_V572 $e) {
			$this->error = $e;
		}
	}

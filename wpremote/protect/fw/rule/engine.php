...
if (!class_exists('WPRProtectFWRuleEngine_V568')) :
require_once dirname( __FILE__ ) . '/functions.php';

class WPRProtectFWRuleEngine_V568 {
	use WPRProtectFWRuleStringFunc_V568;
	use WPRProtectFWRuleArrayFunc_V568;
	use WPRProtectFWRuleMiscFunc_V568;
	use WPRProtectFWRuleRequestFunc_V568;
	use WPRProtectFWRuleWPFunc_V568;
	...
	const CONST_NAME_PREFIX = 'WPRProtectFWRule_V568::';
	...
	public function evaluate($rule) {
		...
		} catch (WPRProtectRuleError_V568 $e) {
			$this->error = $e;
		}
	}

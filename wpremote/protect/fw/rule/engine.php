...
if (!class_exists('WPRProtectFWRuleEngine_V556')) :
require_once dirname( __FILE__ ) . '/functions.php';

class WPRProtectFWRuleEngine_V556 {
	use WPRProtectFWRuleStringFunc_V556;
	use WPRProtectFWRuleArrayFunc_V556;
	use WPRProtectFWRuleMiscFunc_V556;
	use WPRProtectFWRuleRequestFunc_V556;
	use WPRProtectFWRuleWPFunc_V556;
	...
	const CONST_NAME_PREFIX = 'WPRProtectFWRule_V556::';
	...
	public function evaluate($rule) {
		...
		} catch (WPRProtectRuleError_V556 $e) {
			$this->error = $e;
		}
	}

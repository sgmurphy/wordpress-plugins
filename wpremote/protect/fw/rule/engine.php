...
if (!class_exists('WPRProtectFWRuleEngine_V573')) :
require_once dirname( __FILE__ ) . '/functions.php';

class WPRProtectFWRuleEngine_V573 {
	use WPRProtectFWRuleStringFunc_V573;
	use WPRProtectFWRuleArrayFunc_V573;
	use WPRProtectFWRuleMiscFunc_V573;
	use WPRProtectFWRuleRequestFunc_V573;
	use WPRProtectFWRuleWPFunc_V573;
	...
	const CONST_NAME_PREFIX = 'WPRProtectFWRule_V573::';
	...
	public function evaluate($rule) {
		...
		} catch (WPRProtectRuleError_V573 $e) {
			$this->error = $e;
		}
	}

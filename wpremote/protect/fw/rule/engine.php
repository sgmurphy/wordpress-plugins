...
if (!class_exists('WPRProtectFWRuleEngine_V565')) :
require_once dirname( __FILE__ ) . '/functions.php';

class WPRProtectFWRuleEngine_V565 {
	use WPRProtectFWRuleStringFunc_V565;
	use WPRProtectFWRuleArrayFunc_V565;
	use WPRProtectFWRuleMiscFunc_V565;
	use WPRProtectFWRuleRequestFunc_V565;
	use WPRProtectFWRuleWPFunc_V565;
	...
	const CONST_NAME_PREFIX = 'WPRProtectFWRule_V565::';
	...
	public function evaluate($rule) {
		...
		} catch (WPRProtectRuleError_V565 $e) {
			$this->error = $e;
		}
	}

...
use Elementor\Core\Common\Modules\Finder\Categories\Settings;
...
class ComparisonTable extends EAE_Widget_Base {
	...
	public function add_tables() {
		...
		$this->add_control(
			'hide_title_row',
			[
				'label' => esc_html__( 'Hide Title Row', 'wts-eae' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Hide', 'wts-eae' ),
				'label_off' => esc_html__( 'Show', 'wts-eae' ),
				'return_value' => 'yes',
				'default' => 'no',
				'prefix_class' => 'eae-hide-titleRow-',
				'condition' => [
					'feature_box_heading' => ''
				]
			]
		...
		$this->add_control(
			'hide_bottom_row',
			[
				'label' => esc_html__( 'Hide Bottom Row', 'wts-eae' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Hide', 'wts-eae' ),
				'label_off' => esc_html__( 'Show', 'wts-eae' ),
				'return_value' => 'yes',
				'default' => 'no',
				'prefix_class' => 'eae-hide-lastRow-',
			]
		);
		$this->add_control(
			'hide_price_row',
			[
				'label' => esc_html__( 'Hide Price Row', 'wts-eae' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Hide', 'wts-eae' ),
				'label_off' => esc_html__( 'Show', 'wts-eae' ),
				'return_value' => 'yes',
				'default' => 'no',
				'prefix_class' => 'eae-hide-priceRow-',
			]
		);

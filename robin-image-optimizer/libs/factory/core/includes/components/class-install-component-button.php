...
namespace WBCR\Factory_475\Components;
...
class Install_Button {
	 ...
	 * @since  4.3.3
	 */
	public function __construct(\Wbcr_Factory475_Plugin $plugin, $type, $plugin_slug)
	{
		...
		$this->add_data('i18n', \WBCR\Factory_Templates_128\Helpers::getEscapeJson($this->get_i18n()));
	...
	{
		return [
			'activate' => __('Activate', 'wbcr_factory_475'),
			'install' => __('Install', 'wbcr_factory_475'),
			'deactivate' => __('Deactivate', 'wbcr_factory_475'),
			'delete' => __('Delete', 'wbcr_factory_475'),
			'loading' => __('Please wait...', 'wbcr_factory_475'),
			'preparation' => __('Preparation...', 'wbcr_factory_475'),
			'read' => __('Read more', 'wbcr_factory_475')
		];
	}

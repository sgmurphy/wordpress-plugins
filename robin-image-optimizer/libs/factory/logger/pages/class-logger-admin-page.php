 ...
 * @version       1.0
 */
class Wbcr_FactoryLogger142_AdminPage extends Wbcr_FactoryPages475_AdminPage {
	...
	public function __construct( $plugin ) {
		...
		$this->page_title  = __( 'Plugin log', 'wbcr_factory_logger_142' );
	...
	public function assets( $scripts, $styles ) {
		...
		wp_localize_script( 'wbcr_factory_logger_142', 'wbcr_factory_logger_142', [
	...
	public function showPageContent() {
		$buttons = "
            <div class='wbcr_factory_logger_buttons'>
                ...
                <a href='#'
                   ...
                   data-working='" . __( 'Working...', 'wbcr_factory_logger_142' ) . "'>" .
		           sprintf( __( 'Clean-up Logs (<span id="wbcr-log-size">%s</span>)', 'wbcr_factory_logger_142' ), $this->get_log_size_formatted() ) . "
                   </a>
            </div>";
        ...
        <div class="wbcr_factory_logger_container">
            <div class="wbcr_factory_logger_page_title">
                <h1><?php _e( 'Logs of the', 'wbcr_factory_logger_142' ) ?>

...
jQuery(window.document).ready(function ($) {
  ...
  function branda_show_welcome() {
    if ('undefined' === typeof SUI || !$('#branda-welcome').length) {
      ...
      $('button.branda-welcome-all-modules').on('click', function () {
        ...
        jQuery.post(ajaxurl, data, function (response) {
          if (response.success) {
            dialog.removeClass('sui-modal-sm').addClass('sui-modal-xl').removeClass('branda-welcome-step1').addClass('branda-welcome-step2');
            $('.sui-box-body', dialog).removeClass('sui-content-center');
            $('.sui-box-title', dialog).html(response.data.title);
            $('.sui-box-body p', dialog).html(response.data.description).after(response.data.content);
          ...
          } else if (undefined !== _typeof(response.data.message)) {
   ...
   */
  $('#branda-dashboard-widget-summary-search').on('change keydown keyup blur reset copy paste cut input', function () {
...
function ub_media_bind(obj, event) {
  ...
  file_frame.on('select', function () {
    ...
    if ('content_background' === container.data('id')) {
      jQuery('canvas.branda-focal', container.closest('form')).css('backgroundImage', 'url(' + attachment.url + ')');
    }
    /**
     * Fill SUI data
     */
  ...
  if (jQuery.fn.SUIselect2) {
    ...
    $('.sui-select-ajax').each(function () {
      ...
      if ("undefined" !== typeof $(this).data('input-too-short')) {
        var inputTooShortFunction = function inputTooShortFunction(args) {
          return $(this).data('input-too-short');
        };
        args.language = {
          inputTooShort: inputTooShortFunction.bind(this)
        };
      }
...
jQuery(window.document).ready(function ($) {
   ...
   */
  $.fn.extend({
    branda_editor: function branda_editor(editor_id) {
    ...
    branda_flag_status: function branda_flag_status(element) {
    ...
    branda_generate_id: function branda_generate_id() {
      var text = "";
  ...
  $module_save_button.on('click', function () {
    SUI.brandaSaveSettings.call(this, jQuery);
  });
  /**
   * reset whole module
   */
  ...
  $('.branda-social-logo-add-accounts').on('click', function () {
    ...
    items.each(function () {
      $('.branda-social-logos-main-container', $(this).closest('form')).append(branda_template({
        id: $(this).val(),
...
jQuery(window.document).ready(function () {
  ...
  if (jQuery.fn.switchButton) {
    var ultimate_branding_admin_check_slaves = function ultimate_branding_admin_check_slaves() {
...
/******/ })()
;
//# sourceMappingURL=ultimate-branding-admin.min.js.map
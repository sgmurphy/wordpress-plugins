...
if ( ! class_exists( 'Login_Logout_Menu_Shortcode' ) ):
	...
	class Login_Logout_Menu_Shortcode {
		...
		function login_logout_menu__username_link_callback( $atts ){
			...
			$username_html = $show_avatar ? apply_filters( 'login_logout_menu_avatar', Login_Logout_Menu::login_logout_menu_avatar( $args['username'] ) ) : $args['username'];
		...
		function login_logout_menu__profile_link_callback( $atts ){
			...
			$show_avatar  = $args['show_avatar'] === true ? true : false;
			$profile_html = $show_avatar ? apply_filters( 'login_logout_menu_avatar', Login_Logout_Menu::login_logout_menu_avatar( $args['edit_text'] ) ) : $args['edit_text'];

      ...
      edit: function( props ) {
        ...
        return el('div', {
          className: 'fv-player-gutenberg'
            ...
            // Some minimal styling to make sure the icon is placed properly
            // This affects the Gutenberg module in both post editing and in the Site Editor
            el( 'style', {}, '.fv-wordpress-flowplayer-button { display: inline-block; padding: 0 10px } .fv-wordpress-flowplayer-button svg { float: left; left: -4px; position: relative; top: 2px }' ),

...
abstract class FV_Player_Media_Browser {
  ...
  function include_s3_upload_assets() {
    ...
    wp_enqueue_script( 'fv-player-s3-uploader-base', flowplayer::get_plugin_url().'/js/s3-upload-base.js', array( 'flowplayer-browser-base' ), filemtime( dirname( __FILE__ ) . '/../js/s3-upload-base.js' ) );

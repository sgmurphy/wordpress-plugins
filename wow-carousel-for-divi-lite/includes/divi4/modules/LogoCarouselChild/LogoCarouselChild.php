<?php
class WDCL_LogoCarouselChild extends Divi_Carousel_Lite_Builder_Module
{
    ...
    {
        $this->name = esc_html__('Logo', 'divi-carousel-lite');
        ...
        $this->settings_modal_toggles = [
            ...
            'advanced' => [
                'toggles' => [
                    'overlay' => esc_html__('Overlay', 'divi-carousel-lite'),
                    'borders' => esc_html__('Borders', 'divi-carousel-lite'),
                ],
            ],
        ];
    }
    ...
    public function get_fields()
    {
        ...
        $fields = [
            'logo'         => [
                'label'              => esc_html__('Upload Logo', 'divi-carousel-lite'),
                'type'               => 'upload',
                'option_category'    => 'basic_option',
                'upload_button_text' => esc_attr__('Upload a Logo', 'divi-carousel-lite'),
                'choose_text'        => esc_attr__('Choose a Logo', 'divi-carousel-lite'),
                'update_text'        => esc_attr__('Set As Logo', 'divi-carousel-lite'),
                'toggle_slug'        => 'main_content',
            ],

            'logo_alt'     => [
                'label'       => esc_html__('Logo Alt Text', 'divi-carousel-lite'),
                'type'        => 'text',
                'toggle_slug' => 'main_content',
            ],

            'is_link'      => [
                'label'           => esc_html__('Use Link', 'divi-carousel-lite'),
                'type'            => 'yes_no_button',
            ...
            'link_url'     => [
                'label'       => esc_html__('Link Url', 'divi-carousel-lite'),
                'type'        => 'text',
                'default'     => '',
                'show_if'     => [
                    'is_link' => 'on',
    ...
    public function get_advanced_fields_config()
    {
        ...
        $advanced_fields['borders']['item'] = [
            ...
            'label_prefix' => esc_html__('Iten', 'divi-carousel-lite'),
            'defaults'     => [

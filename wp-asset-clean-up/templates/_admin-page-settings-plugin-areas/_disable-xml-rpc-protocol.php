    ...
    <table class="wpacu-form-table">
		...
		<tr valign="top">
			<td>
				...
				<p style="margin-bottom: 10px;">This will disable XML-RPC protocol support and clean up the "pingback" tag from the HEAD section of your website.</p>
                ...
                <?php
                if (\WpAssetCleanUp\Misc::maybeIsSiteGround()) {
                    ?>
                    <div class="wpacu-notice wpacu-warning" style="font-size: inherit; line-height: 1.4rem;">
                        If you are using SiteGround as your hosting provider, remember that direct browser access to WordPress xmlrpc.php is not supported. <a target="_blank" href="https://eu.siteground.com/kb/xmlrpc-direct-browser-access-blocked/">Read more</a>
                    </div>
                    <?php
                }
                ?>

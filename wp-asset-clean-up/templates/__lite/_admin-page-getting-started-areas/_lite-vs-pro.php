...
HTML;
$svgTickFiltered = wp_kses($svgTick, array('svg' => array('xmlns' => array(), 'viewbox' => array()), 'path' => array('fill' => array(), 'd' => array())));
$svgTickOutput = $svgTickFiltered;

// N/A
$svgNa = '<img draggable="false" class="wpacu-emoji" alt="" src="'.WPACU_PLUGIN_URL.'/assets/icons/icon-n-a.svg">';
$svgNaFiltered = wp_kses($svgNa, array('img' => array('draggable' => array(), 'class' => array(), 'alt' => array(), 'src' => array())));
$svgNaOutput = <<<HTML
<span class="na">{$svgNaFiltered}</span>
HTML;
?>
	...
	<table>
		...
		<tr>
			<td colspan="3" style="text-align: center; padding: 10px;">
				<h3 style="margin: 0;"><?php echo $svgTickOutput; ?>&nbsp; <em>30 Day Money-Back Guarantee</em></h3>
				<p style="margin-top: 8px; color: green;">If you are not satisfied with your purchase for any reason, you can request a refund within 30 days, and you will get the payment refunded.</p>
				<hr />

...
<div class="htmega-admin-main-tab-pane-inner">
        ...
        <div class="htmega-admin-infoboxes">
            ...
            <div class="htmega-admin-infobox">
                <div class="htmega-admin-infobox-icon"><img src="<?php echo esc_url( HTMEGAOPT_URL . '/assets/images/info-icon/documentation.png' ); ?>" alt="<?php echo esc_attr__('documentation','htmega-addons');?>"></div>
            ...
            <!-- Infobox Start -->
            <div class="htmega-admin-infobox">
                <div class="htmega-admin-infobox-icon"><img src="<?php echo esc_url( HTMEGAOPT_URL . '/assets/images/info-icon/video-tutorial.png' ); ?>" alt="<?php echo esc_attr__('video tutorial','htmega-addons');?>"></div>
                <div class="htmega-admin-infobox-content">
            ...
            <!-- Infobox Start -->
            <div class="htmega-admin-infobox">
                <div class="htmega-admin-infobox-icon"><img src="<?php echo esc_url( HTMEGAOPT_URL . '/assets/images/info-icon/support.png' ); ?>" alt="<?php echo esc_attr__('Support','htmega-addons');?>"></div>
                <div class="htmega-admin-infobox-content">
            ...
            <!-- Infobox Start -->
            <div class="htmega-admin-infobox">
                <div class="htmega-admin-infobox-icon"><img src="<?php echo esc_url( HTMEGAOPT_URL . '/assets/images/info-icon/missing-feature.png' ); ?>" alt="<?php echo esc_attr__('missing feature','htmega-addons');?>"></div>
                <div class="htmega-admin-infobox-content">
            ...
            <!-- Infobox Start -->
            <div class="htmega-admin-infobox">
                <div class="htmega-admin-infobox-icon"><img src="<?php echo esc_url( HTMEGAOPT_URL . '/assets/images/info-icon/happy-with-us.png' ); ?>" alt="<?php echo esc_attr__('happy with us','htmega-addons');?>"></div>
                <div class="htmega-admin-infobox-content">
            ...
            <!-- Infobox Start -->
            <div class="htmega-admin-infobox">
                <div class="htmega-admin-infobox-icon"><img src="<?php echo esc_url( HTMEGAOPT_URL . '/assets/images/info-icon/woolentor.png' ); ?>" alt="<?php echo esc_attr__('woolentor','htmega-addons');?>"></div>
                <div class="htmega-admin-infobox-content">

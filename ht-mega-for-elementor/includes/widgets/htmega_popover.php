        ...
        ?>
            ...
            <div <?php echo $this->get_render_attribute_string( 'htmega_popover_attr' ); ?>>
                <?php
                    ...
                    echo sprintf('<span class="%1$s" data-container=".htmega-popover-container-%6$s" data-toggle="popover" data-placement="%2$s" data-content="%3$s" title="%4$s">%5$s</span>', esc_attr( $active_class ), esc_attr( $settings['popover_dir'] ), htmega_kses_desc( htmlspecialchars( $settings['popover_text'] ) ), htmega_kses_title( $settings['popover_header_text'] ),  $button_txt, esc_attr( $id ) );
                ?>
            </div>

...
(0,l.__)('"%s" duplicated.'),e.title.raw),{type:"snackbar",id:"patterns-create"}),n?.({pattern:e})},...s})},RenamePatternModal:function({onClose:e,onError:t,onSuccess:n,pattern:a,...o}){const s=(0,B.decodeEntities)(a.title),[i,u]=(0,P.useState)(s),[p,d]=(0,P.useState)(!1),{editEntityRecord:m,__experimentalSaveSpecifiedEntityEdits:_}=(0,r.useDispatch)(c.store),{createSuccessNotice:y,createErrorNotice:g}=(0,r.useDispatch)(x.store);return(0,h.createElement)(k.Modal,{title:(0,l.__)("Rename"),...o,onRequestClose:e},(0,h.createElement)("form",{onSubmit:async r=>{if(r.preventDefault(),i&&i!==a.title&&!p)try{await m("postType",a.type,a.id,{title:i}),d(!0),u(""),e?.();const t=await _("postType",a.type,a.id,["title"],{throwOnError:!0});n?.(t),y((0,l.__)("Pattern renamed"),{type:"snackbar",id:"pattern-update"})}catch(e){t?.();const n=e.message&&"unknown_error"!==e.code?e.message:(0,l.__)("An error occurred while renaming the pattern.");g(n,{type:"snackbar",id:"pattern-update"})}finally{d(!1),u("")}}},(0,h.createElement)(k.__experimentalVStack,{spacing:"5"},(0,h.createElement)(k.TextControl,{__nextHasNoMarginBottom:!0,__next40pxDefaultSize:!0,label:(0,l.__)("Name"),value:i,onChange:u,required:!0}),(0,h.createElement)(k.__experimentalHStack,{justify:"right"},(0,h.createElement)(k.Button,{__next40pxDefaultSize:!0,variant:"tertiary",onClick:()=>{e?.(),u("")}},(0,l.__)("Cancel")),(0,h.createElement)(k.Button,{__next40pxDefaultSize:!0,variant:"primary",type:"submit"},(0,l.__)("Save"))))))},PatternsMenuItems:function({rootClientId:e}){return(0,h.createElement)(i.BlockSettingsMenuControls,null,(({selectedClientIds:t,onClose:n})=>(0,h.createElement)(h.Fragment,null,(0,h.createElement)(U,{clientIds:t,rootClientId:e,closeBlockSettingsMenu:n}),1===t.length&&(0,h.createElement)(L,{clientId:t[0]}))))},RenamePatternCategoryModal:function({category:e,existingCategories:t,onClose:n,onError:a,onSuccess:o,...s}){const i=(0,P.useId)(),u=(0,P.useRef)(),[p,d]=(0,P.useState)((0,B.decodeEntities)(e.name)),[m,_]=(0,P.useState)(!1),[y,g]=(0,P.useState)(!1),f=y?`patterns-rename-pattern-category-modal__validation-message-${i}`:void 0,{saveEntityRecord:w,invalidateResolution:E}=(0,r.useDispatch)(c.store),{createErrorNotice:S,createSuccessNotice:b}=(0,r.useDispatch)(x.store),C=()=>{n(),d("")};return(0,h.createElement)(k.Modal,{title:(0,l.__)("Rename"),onRequestClose:C,...s},(0,h.createElement)("form",{onSubmit:async r=>{if(r.preventDefault(),!m){if(!p||p===e.name){const e=(0,l.__)("Please enter a new name for this category.");return(0,j.speak)(e,"assertive"),g(e),void u.current?.focus()}if(t.patternCategories.find((t=>t.id!==e.id&&t.label.toLowerCase()===p.toLowerCase()))){const e=(0,l.__)("This category already exists. Please use a different name.");return(0,j.speak)(e,"assertive"),g(e),void u.current?.focus()}try{_(!0);const t=await w("taxonomy",D,{id:e.id,slug:e.slug,name:p});E("getUserPatternCategories"),o?.(t),n(),b((0,l.__)("Pattern category renamed."),{type:"snackbar",id:"pattern-category-update"})}catch(e){a?.(),S(e.message,{type:"snackbar",id:"pattern-category-update"})}finally{_(!1),d("")}}}},(0,h.createElement)(k.__experimentalVStack,{spacing:"5"},(0,h.createElement)(k.__experimentalVStack,{spacing:"2"},(0,h.createElement)(k.TextControl,{ref:u,__nextHasNoMarginBottom:!0,__next40pxDefaultSize:!0,label:(0,l.__)("Name"),value:p,onChange:e=>{y&&g(void 0),d(e)},"aria-describedby":f,required:!0}),y&&(0,h.createElement)("span",{className:"patterns-rename-pattern-category-modal__validation-message",id:f},y)),(0,h.createElement)(k.__experimentalHStack,{justify:"right"},(0,h.createElement)(k.Button,{__next40pxDefaultSize:!0,variant:"tertiary",onClick:C},(0,l.__)("Cancel")),(0,h.createElement)(k.Button,{__next40pxDefaultSize:!0,variant:"primary",type:"submit","aria-disabled":!p||p===e.name||m,isBusy:m},(0,l.__)("Save"))))))},PartialSyncingControls:function({name:e,attributes:t,setAttributes:n}){const a=m[e];function r(e,a){if(!a){let a={...t.connections,attributes:{...t.connections?.attributes,[e]:void 0}};return 1===Object.keys(a.attributes).length&&(a.attributes=void 0),1===Object.keys(a).length&&void 0===r.attributes&&(a=void 0),void n({connections:a})}const o={...t.connections,attributes:{...t.connections?.attributes,[e]:{source:"pattern_attributes"}}};if("string"==typeof t.metadata?.id)return void n({connections:o});const s=((e=21)=>crypto.getRandomValues(new Uint8Array(e)).reduce(((e,t)=>e+((t&=63)<36?t.toString(36):t<62?(t-26).toString(36).toUpperCase():t>62?"-":"_")),""))(6);n({connections:o,metadata:{...t.metadata,id:s}})}return(0,h.createElement)(i.InspectorControls,{group:"advanced"},(0,h.createElement)(k.BaseControl,{__nextHasNoMarginBottom:!0},(0,h.createElement)(k.BaseControl.VisualLabel,null,(0,l.__)("Synced attributes")),Object.entries(a).map((([e,n])=>(0,h.createElement)(k.CheckboxControl,{key:e,__nextHasNoMarginBottom:!0,label:n,checked:"pattern_attributes"===t.connections?.attributes?.[e]?.source,onChange:t=>{r(e,t)}})))))},PATTERN_TYPES:u,PATTERN_DEFAULT_CATEGORY:p,PATTERN_USER_CATEGORY:"my-patterns",EXCLUDED_PATTERN_SOURCES:["core","pattern-directory/core","pattern-directory/featured"],PATTERN_SYNC_TYPES:d,PARTIAL_SYNCING_SUPPORTED_BLOCKS:m}),(window.wp=window.wp||{}).patterns=t}();

		...
		<div id="post-body" class="metabox-holder">
			<div id="post-body-content">
				...
				<div style="text-align: center; background: #DCDCDC; margin: 30px 0; padding: 10px 30px 30px 30px;">
					...
					<a href="<?php echo esc_url(WPLS_PLUGIN_LINK_UPGRADE); ?>" target="_blank" class="wpls-sf-btn wpls-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
				</div>
	...
	<!-- <table class="wpos-plugin-pricing-table">
		...
		<thead>
			<tr>
				...
				<th>
					...
					<a href="<?php //echo esc_url(WPLS_PLUGIN_LINK_UPGRADE); ?>" target="_blank"><?php //esc_html_e('Buy Now', 'wp-logo-showcase-responsive-slider-slider'); ?></a>
					<a href="<?php //echo esc_url(WPLS_PLUGIN_LINK_UPGRADE); ?>" target="_blank"><?php //esc_html_e('Grab Now This Deal', 'wp-logo-showcase-responsive-slider-slider'); ?></a>
				</th>	    		
			</tr>
		</thead>
		...
		<tfoot>
			<tr>
				...
				<h3 class="wpos-deal-heading"><?php //esc_html_e('Choose best pricing in', 'wp-logo-showcase-responsive-slider-slider'); ?> <span class="h-blue"><?php //esc_html_e('Annual', 'wp-logo-showcase-responsive-slider-slider'); ?></span> and <span class="h-blue"><?php //esc_html_e('Lifetime', 'wp-logo-showcase-responsive-slider-slider'); ?></span> <?php //esc_html_e('deal', 'wp-logo-showcase-responsive-slider-slider'); ?></h3>
				<a href="<?php //echo esc_url(WPLS_PLUGIN_LINK_UPGRADE); ?>" target="_blank"><?php //esc_html_e('Buy Now', 'wp-logo-showcase-responsive-slider-slider'); ?></a>
				<a href="<?php //echo esc_url(WPLS_PLUGIN_LINK_UPGRADE); ?>" target="_blank"><?php //esc_html_e('Grab Now This Deal', 'wp-logo-showcase-responsive-slider-slider'); ?></a></td>
			</tr>
		</tfoot>

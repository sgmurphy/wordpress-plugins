<?php
    ...
    class FS_Plugin_License extends FS_Entity {
        ...
        function is_first_payment_pending() {
            $created = $this->created ? strtotime( $this->created ) : strtotime("now");
            $expiration = $this->expiration ? strtotime( $this->expiration ) : strtotime("now");
            return ( WP_FS__TIME_24_HOURS_IN_SEC >= $expiration - $created );
        }

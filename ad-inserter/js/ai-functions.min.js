...
"cover"!=c[b].style.backgroundSize&&(a=parseInt((window.innerWidth||document.documentElement.clientWidth)/2-a.left-a.width/2),c[b].style.left=a+"px",c[b].style.transform="translate("+-a+"px)")}}};

...
<div class="woolentor-admin-sidebar">
    ...
    <?php if( !is_plugin_active('woolentor-addons-pro/woolentor_addons_pro.php') ) :?>
        <div class="woolentor-pro-banner">
            ...
            <a href="https://woolentor.com/pricing/?utm_source=admin&utm_medium=sidebar&utm_campaign=free" class="woolentor-pro-banner-btn" target="_blank"><?php echo esc_html__('Get Pro Now','woolentor'); ?><span class="icon">+</span></a>
        </div>
    <?php endif; ?>

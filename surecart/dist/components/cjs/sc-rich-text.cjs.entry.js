...
const ScRichText = class {
  constructor(hostRef) {
    ...
    this.inputId = `sc-richtext-${++id}`;
    this.helpId = `sc-richtext-help-text-${id}`;
    this.labelId = `sc-richtext-label-${id}`;
    this.size = 'medium';
    this.name = undefined;
    this.value = '';
    this.label = '';
  ...
  componentDidLoad() {
    ...
    this.editor = new Editor({
      ...
      extensions: [
        ...
        ...((this === null || this === void 0 ? void 0 : this.maxlength) > 0
          ? [
  ...
  isActive(type, opts = {}) {
    var _a, _b;
    return (_b = (_a = this.editor) === null || _a === void 0 ? void 0 : _a.isActive) === null || _b === void 0 ? void 0 : _b.call(_a, type, opts);
  }
  toggleHeading(opts) {
  ...
  can(property) {
    ...
    return (_j = (_h = (_g = (_f = (_e = (_d = (_c = (_b = (_a = this.editor) === null || _a === void 0 ? void 0 : _a.can()) === null || _b === void 0 ? void 0 : _b.chain) === null || _c === void 0 ? void 0 : _c.call(_b)) === null || _d === void 0 ? void 0 : _d.focus) === null || _e === void 0 ? void 0 : _e.call(_d)) === null || _f === void 0 ? void 0 : _f[property]) === null || _g === void 0 ? void 0 : _g.call(_f)) === null || _h === void 0 ? void 0 : _h.run) === null || _j === void 0 ? void 0 : _j.call(_h);
  }
  run(property) {
    var _a, _b, _c, _d, _e, _f, _g, _h;
    return (_h = (_g = (_f = (_e = (_d = (_c = (_b = (_a = this.editor) === null || _a === void 0 ? void 0 : _a.chain) === null || _b === void 0 ? void 0 : _b.call(_a)) === null || _c === void 0 ? void 0 : _c.focus) === null || _d === void 0 ? void 0 : _d.call(_c)) === null || _e === void 0 ? void 0 : _e[property]) === null || _f === void 0 ? void 0 : _f.call(_e)) === null || _g === void 0 ? void 0 : _g.run) === null || _h === void 0 ? void 0 : _h.call(_g);
  }
  remainingCharacters() {
    var _a, _b;
    if (!this.maxlength)
      return 1000;
    return this.maxlength - (((_b = (_a = this === null || this === void 0 ? void 0 : this.editor) === null || _a === void 0 ? void 0 : _a.storage) === null || _b === void 0 ? void 0 : _b.characterCount.characters()) || 0);
  }
  handleKeyDown(event) {
  ...
  render() {
    var _a, _b, _c, _d, _e, _f, _g, _h;
    return (index.h(index.Host, null, index.h("sc-form-control", { exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("div", { part: "base", class: { 'editor-base': true, 'editor--focused': this.hasFocus } }, index.h("div", { class: "menu" }, index.h("sc-button", { size: "small", type: ((_b = (_a = this.editor) === null || _a === void 0 ? void 0 : _a.isActive) === null || _b === void 0 ? void 0 : _b.call(_a, 'bold')) ? 'default' : 'text', onClick: () => this.run('toggleBold'), disabled: !this.can('toggleBold') }, index.h("sc-icon", { name: "bold" })), index.h("sc-button", { size: "small", type: ((_d = (_c = this.editor) === null || _c === void 0 ? void 0 : _c.isActive) === null || _d === void 0 ? void 0 : _d.call(_c, 'italic')) ? 'default' : 'text', onClick: () => this.run('toggleItalic'), disabled: !this.can('toggleItalic') }, index.h("sc-icon", { name: "italic" })), index.h("sc-button", { size: "small", type: ((_f = (_e = this.editor) === null || _e === void 0 ? void 0 : _e.isActive) === null || _f === void 0 ? void 0 : _f.call(_e, 'bulletList')) ? 'default' : 'text', onClick: () => this.run('toggleBulletList') }, index.h("sc-icon", { name: "list" })), index.h("sc-button", { size: "small", type: ((_h = (_g = this.editor) === null || _g === void 0 ? void 0 : _g.isActive) === null || _h === void 0 ? void 0 : _h.call(_g, 'strike')) ? 'default' : 'text', onClick: () => this.run('toggleStrike') }, index.h("sc-icon", { name: "minus" })), index.h("sc-button", { class: "right", size: "small", type: "text", onClick: () => this.run('undo'), disabled: !this.can('undo') }, index.h("sc-icon", { name: "corner-up-left" })), index.h("sc-button", { size: "small", type: "text", onClick: () => this.run('redo'), disabled: !this.can('redo') }, index.h("sc-icon", { name: "corner-up-right" }))), index.h("div", { part: "editor", class: {
        editor: true,
      }, ref: el => (this.element = el) })), this.remainingCharacters() < 20 && index.h("div", { class: 'textarea__char-limit-warning' }, wp.i18n.sprintf(wp.i18n.__('%d characters remaining', 'surecart'), this.remainingCharacters())))));
  }
};
ScRichText.style = scRichTextCss;

exports.sc_rich_text = ScRichText;

//# sourceMappingURL=sc-rich-text.cjs.entry.js.map
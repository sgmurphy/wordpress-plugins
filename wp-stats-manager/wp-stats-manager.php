...
if(isset($_REQUEST) && is_array($_REQUEST)){
  ...
  /*
	...
	*/
	...
	$subPage = isset($_REQUEST['subPage']) ? esc_attr($_REQUEST['subPage']) : '';
	$subTab = isset($_REQUEST['subTab']) ? esc_attr($_REQUEST['subTab']) : '';
	$wmcAction = isset($_REQUEST['wmcAction']) ? esc_attr($_REQUEST['wmcAction']) : '';
	$action_name = isset($_REQUEST['action_name']) ? esc_attr($_REQUEST['action_name']) : '';
	$visitorId = isset($_REQUEST['visitorId']) ? esc_attr($_REQUEST['visitorId']) : '';
	$setSiteId = isset($_REQUEST['setSiteId']) ? esc_attr($_REQUEST['setSiteId']) : '';
	$setPageId = isset($_REQUEST['setPageId']) ? esc_attr($_REQUEST['setPageId']) : '';
	$setUrlReferrer = isset($_REQUEST['setUrlReferrer']) ? esc_attr($_REQUEST['setUrlReferrer']) : '';
	$setTrackerUrl = isset($_REQUEST['setTrackerUrl']) ? esc_attr($_REQUEST['setTrackerUrl']) : '';
	$setWpUserId = isset($_REQUEST['setWpUserId']) ? esc_attr($_REQUEST['setWpUserId']) : '';
	$siteId = isset($_REQUEST['siteId']) ? intval($_REQUEST['siteId']) : '';
	$rec = isset($_REQUEST['rec']) ? intval($_REQUEST['rec']) : '';
	$rand = isset($_REQUEST['rand']) ? intval($_REQUEST['rand']) : '';
	$h = isset($_REQUEST['h']) ? intval($_REQUEST['h']) : '';
	$m = isset($_REQUEST['m']) ? intval($_REQUEST['m']) : '';
	$s = isset($_REQUEST['s']) ? intval($_REQUEST['s']) : '';
	$url = isset($_REQUEST['url']) ? esc_attr($_REQUEST['url']) : '';
	$uid = isset($_REQUEST['uid']) ? intval($_REQUEST['uid']) : '';
	$pid = isset($_REQUEST['pid']) ? intval($_REQUEST['pid']) : '';
	$fvts = isset($_REQUEST['fvts']) ? esc_attr($_REQUEST['fvts']) : '';
	$vc = isset($_REQUEST['vc']) ? intval($_REQUEST['vc']) : '';
	$idn = isset($_REQUEST['idn']) ? intval($_REQUEST['idn']) : '';
	$refts = isset($_REQUEST['refts']) ? intval($_REQUEST['refts']) : '';
	$lvts = isset($_REQUEST['lvts']) ? esc_attr($_REQUEST['lvts']) : '';
	$fullRef = isset($_REQUEST['fullRef']) ? esc_attr($_REQUEST['fullRef']) : '';
	$send_image = isset($_REQUEST['send_image']) ? intval($_REQUEST['send_image']) : '';
	$cookie = isset($_REQUEST['cookie']) ? intval($_REQUEST['cookie']) : '';
	$res = isset($_REQUEST['res']) ? esc_attr($_REQUEST['res']) : '';
	$gtms = isset($_REQUEST['gtms']) ? esc_attr($_REQUEST['gtms']) : '';
	$pvId = isset($_REQUEST['pvId']) ? esc_attr($_REQUEST['pvId']) : '';

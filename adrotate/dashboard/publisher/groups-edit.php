					...
					<div class="ajdg-postbox">
						...
						<div id="postinjection" class="ajdg-postbox-content">
						    ...
						    <select tabindex="19" name="adrotate_cat_paragraph">
						    	...
						    	<option value="10" <?php if($edit_group->cat_par == 10) { echo 'selected'; } ?>><?php _e("after the 10th paragraph", 'adrotate'); ?></option>
						    	<option value="12" <?php if($edit_group->cat_par == 12) { echo 'selected'; } ?>><?php _e("after the 12th paragraph", 'adrotate'); ?></option>
						    	<option value="14" <?php if($edit_group->cat_par == 14) { echo 'selected'; } ?>><?php _e("after the 14th paragraph", 'adrotate'); ?></option>
						    	<option value="16" <?php if($edit_group->cat_par == 16) { echo 'selected'; } ?>><?php _e("after the 16th paragraph", 'adrotate'); ?></option>
						    	<option value="18" <?php if($edit_group->cat_par == 18) { echo 'selected'; } ?>><?php _e("after the 18th paragraph", 'adrotate'); ?></option>
						    	<option value="20" <?php if($edit_group->cat_par == 20) { echo 'selected'; } ?>><?php _e("after the 20th paragraph", 'adrotate'); ?></option>
						    </select></p>
							<p><strong><?php _e("Select Categories", 'adrotate'); ?></strong></p>
					...
					<div class="ajdg-postbox">
						...
						<div id="pageinjection" class="ajdg-postbox-content">
					        ...
					        <select tabindex="21" name="adrotate_page_paragraph">
						    	...
						    	<option value="10" <?php if($edit_group->page_par == 10) { echo 'selected'; } ?>><?php _e("after the 10th paragraph", 'adrotate'); ?></option>
						    	<option value="12" <?php if($edit_group->page_par == 12) { echo 'selected'; } ?>><?php _e("after the 12th paragraph", 'adrotate'); ?></option>
						    	<option value="14" <?php if($edit_group->page_par == 14) { echo 'selected'; } ?>><?php _e("after the 14th paragraph", 'adrotate'); ?></option>
						    	<option value="16" <?php if($edit_group->page_par == 16) { echo 'selected'; } ?>><?php _e("after the 16th paragraph", 'adrotate'); ?></option>
						    	<option value="18" <?php if($edit_group->page_par == 18) { echo 'selected'; } ?>><?php _e("after the 18th paragraph", 'adrotate'); ?></option>
						    	<option value="20" <?php if($edit_group->page_par == 20) { echo 'selected'; } ?>><?php _e("after the 20th paragraph", 'adrotate'); ?></option>
					        </select></p>

							<p><strong><?php _e("Select Pages", 'adrotate'); ?></strong></p>
							<div class="adrotate-select">
	   	...
	   	<table class="widefat" style="margin-top: .5em">
			...
			<?php if($ads) {
				...
				foreach($ads as $ad) {
					...
					if($stoptime <= $now) $errorclass = ' row_red';

...
$this->add_render_attribute(
	...
	array(
		...
		'class' => array( 'twae-vertical', 'twae-wrapper ', esc_attr( $timeline_layout_wrapper ), esc_attr( $timeline_style ) ),
	)
);
...
if ( is_array( $data ) ) {
	foreach ( $data as $index => $content ) {
		...
		$this->add_render_attribute( $extra_label_key, array( 'class' => 'twae-label-small' ) );
		$this->add_render_attribute( $description_key, array( 'class' => 'twae-description' ) );

		$article_key       = 'twae-article-' . esc_attr( $story_id );
		$repeator_item_key = 'elementor-repeater-item-' . esc_attr( $story_id );
		$year_label_html   = '';
		...
		if ( isset( $content['twae_image'] ) && $content['twae_image']['id'] != '' ) {
		...
		} elseif ( isset( $content['twae_image'] ) && $content['twae_image']['url'] != '' ) {
		...
		if ( isset( $content['twae_image'] ) && $content['twae_image']['url'] != '' && $content['twae_media'] == 'image' ) {

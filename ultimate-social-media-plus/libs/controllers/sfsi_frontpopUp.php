...
function sfsi_plus_FrontPopupDiv() {
	...
	$heading_text = (isset($sfsi_plus_section7_options['sfsi_plus_popup_text'])) ? __($sfsi_plus_section7_options['sfsi_plus_popup_text'], 'ultimate-social-media-plus') : __('Enjoy this site? Please follow and like us!', 'ultimate-social-media-plus');
	...
	foreach ($icons_order  as $index => $icn) :
		...
		switch ($icn): case 'rss':
			...
			case 'whatsapp':
				...
				break;
			case 'tiktok':
				if (isset($sfsi_plus_section1_options['sfsi_plus_tiktok_display']) && $sfsi_plus_section1_options['sfsi_plus_tiktok_display'] == 'yes')    $icons .= "<li>" . sfsi_plus_prepairIcons('tiktok', 1) . "</li>";
				break;
			case 'mastodon':
				if (isset($sfsi_plus_section1_options['sfsi_plus_mastodon_display']) && $sfsi_plus_section1_options['sfsi_plus_mastodon_display'] == 'yes')    $icons .= "<li>" . sfsi_plus_prepairIcons('mastodon', 1) . "</li>";
				break;
			case 'custom':

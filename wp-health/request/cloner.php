...
if (!class_exists('UmbrellaAbstractProcessBackup')):
...
if (!class_exists('UmbrellaFileBackup')):
...
if (!class_exists('UmbrellaScanBackup')):
...
if (!class_exists('UmbrellaDatabaseBackup')):
...
if(UMBRELLA_BACKUP_KEY === "[[UMBRELLA_BACKUP_KEY]]"){
	$html->render();
    return;
}
...
if (!isset($request['request_id']) || !isset($request['base_directory'])) {
    $html->render();
    @unlink(__FILE__);
    return;
}

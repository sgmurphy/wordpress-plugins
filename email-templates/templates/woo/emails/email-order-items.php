...
if ( true == $responsive_check ) {
	foreach ( $items as $item_id => $item ) :
		...
		<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'order_item', $item, $order ) ); ?>">
			...
			echo '<p class="inside-quantity" style="margin-bottom:0;">' . esc_html__( 'Quantity:', 'woocommerce' ) . ' ' . wp_kses_post( apply_filters( 'woocommerce_email_order_item_quantity', $qty_display, $item ) ) . '</p>';

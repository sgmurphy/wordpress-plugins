...
require_once __DIR__ . '/../vendors/openai/class.phpopenaichat.php';
...
if ( current_user_can( 'manage_options' ) ) {
	...
	if (
		...
		if ( isset( $_POST['cff-openai-api-key'] ) ) {
			$openai_api_key = sanitize_text_field( wp_unslash( $_POST['cff-openai-api-key'] ) );
		...
		esc_html_e( 'OpenAI API Key is required', 'calculated-fields-form' );
		exit;
	}

<?php
	...
	protected function render() {
		...
		?>
			<div class="pafe-image-accordion" data-pafe-image-accordion-list data-pafe-image-accordion-option='<?php echo esc_html($settings['pafe_image_accordion_trigger_type']); ?>'>
				<?php 
					$index = 0;
				...
				?>					
					<div class="pafe-image-accordion__item<?php if($index == 1){echo " active";}?>" data-pafe-image-accordion-item >	
						<?php if (!empty($item['pafe_image_accordion_item_image'])) : ?>
							<img src="<?php echo esc_attr($item['pafe_image_accordion_item_image']['url']); ?>" alt="">
						<?php endif; ?>							
						<div class="pafe-image-accordion__item-content" data-pafe-image-accordion-item-content>
							...
							<div class="pafe-image-accordion__item-content__title">
								<h2 class="pafe-image-accordion__item-content__title-inner"><?php echo esc_html($item['pafe_image_accordion_item_title']); ?>
							</div>
							<?php endif; ?>								

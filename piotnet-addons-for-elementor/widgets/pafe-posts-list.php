				...
				<div class="pafe-posts-list__filter" >
					<div class="pafe-posts-list__filter-title">
						<?php 
							if ( !empty($settings['pafe_posts_list_title']) ) {			
						    	echo esc_html($settings['pafe_posts_list_title']);
							}
						?> 
					</div>
					<div class="pafe-posts-list__filter-list">	
						...
						<?php foreach ($terms as $term) :?>	
							<span class="pafe-posts-list__filter-item" data-id=<?php echo esc_html($term->term_id); ?> data-pafe-posts-list-filter-item><?php echo esc_html($term->name); ?></span>
						<?php endforeach;?>
					</div>
				</div> 
			<?php endif; ?>	

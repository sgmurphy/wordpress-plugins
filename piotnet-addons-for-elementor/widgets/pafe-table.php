							...
							<tr class="pafe-table-head-row">
								<?php
									...
									foreach ($settings['pafe_table_head'] as $item) :
										$index ++;
								?>	
									<th class="pafe-table-head-cell<?php if ($item['pafe_table_head_title_alignment']=="left") {echo ' left';} if ($item['pafe_table_head_title_alignment']=="center") {echo ' center';} if ($item['pafe_table_head_title_alignment']=="right") {echo ' right';} ?>" colspan="<?php echo esc_attr($item['pafe_table_head_colspan']); ?>" style="width: <?php echo esc_attr($item['pafe_table_head_width']['size'].$item['pafe_table_head_width']['unit'].';'); ?>">
										<span class="pafe-table-head-content">
											<span class="pafe-table-head-text"><?php echo esc_html($item['pafe_table_head_item_title']);?></span>
									...
									<?php elseif ($item['pafe_table_body_row_type']=='col'): ?>
										<?php if ($count_row > $row): ?>
											...
											<?php if ($i==1): ?>
												...
												<th class="pafe-table-body-first-cell<?php if ($item['pafe_table_body_title_alignment']=="left") {echo ' left';} if ($item['pafe_table_body_title_alignment']=="center") {echo ' center';} if ($item['pafe_table_body_title_alignment']=="right") {echo ' right';} ?>" rowspan="<?php echo esc_attr($item['pafe_table_body_item_rowspan']); ?>">
													<span class="pafe-table-body-first-content">
														<?php if ($item['show_body_item_icon']=='yes'):?>
															<?php if ($item['pafe_table_body_item_icon_position']=='before'):?>
																<?php echo '<i class="pafe-table-body-item-icon '. esc_attr($item['pafe_table_body_item_icon']).'"aria-hidden="true" style="padding-right: '.esc_attr($item['pafe_table_body_item_icon_before_spacing']['size']).esc_attr($item['pafe_table_body_item_icon_before_spacing']['unit']).';"></i>'; ?>
															<?php endif; ?>
														<?php endif; ?>
														<span class="pafe-table-body-first-text"><?php echo esc_html($item['pafe_table_body_item_title']);?></span>
														<?php if ($item['show_body_item_icon']=='yes'):?>
															<?php if ($item['pafe_table_body_item_icon_position']=='after'):?>
																<?php echo '<i class="pafe-table-body-item-icon '. esc_attr($item['pafe_table_body_item_icon']).'"aria-hidden="true" style="padding-left: '.esc_attr($item['pafe_table_body_item_icon_after_spacing']['size']).esc_attr($item['pafe_table_body_item_icon_after_spacing']['unit']).';"></i>'; ?>
															<?php endif; ?>
														<?php endif; ?>
													</span>
												</th>
											...
											<td class="pafe-table-body-cell<?php if ($item['pafe_table_body_title_alignment']=="left") {echo ' left';} if ($item['pafe_table_body_title_alignment']=="center") {echo ' center';} if ($item['pafe_table_body_title_alignment']=="right") {echo ' right';} ?>">
												<span class="pafe-table-body-content">
                                                    <?php if ($item['show_body_item_icon']=='yes'):?>
                                                        ...
                                                        <?php endif; ?>
                                                    <?php endif; ?>
													<a class="pafe-table-body-text" <?php if (!empty($item['pafe_table_body_item_title_url']['url'])) { echo 'href="' . esc_attr($item['pafe_table_body_item_title_url']['url']).'"' . esc_attr($target) . esc_attr($nofollow) ;} ?>><?php echo esc_html($item['pafe_table_body_item_title']);?></a>
                                                    <?php if ($item['show_body_item_icon']=='yes'):?>
                                                        <?php if ($item['pafe_table_body_item_icon_position']=='after'):?>
                                                            <?php echo '<i class="pafe-table-body-item-icon '. esc_attr($item['pafe_table_body_item_icon']).'"aria-hidden="true" style="padding-left: '.esc_attr($item['pafe_table_body_item_icon_after_spacing']['size']).esc_attr($item['pafe_table_body_item_icon_after_spacing']['unit']).';"></i>'; ?>
                                                        <?php endif; ?>
							...
							<?php
								...
								foreach ($settings['pafe_table_body'] as $item):
									...
									if ($item['pafe_table_body_row_type']=='row'):?>
										...
										<?php endif; ?>
										<?php elseif ($item['pafe_table_body_row_type']=='col'): ?>
											<td class="pafe-table-body-cell<?php if ($item['pafe_table_body_title_alignment']=="left") {echo ' left';} if ($item['pafe_table_body_title_alignment']=="center") {echo ' center';} if ($item['pafe_table_body_title_alignment']=="right") {echo ' right';} ?>" rowspan="<?php echo esc_attr($item['pafe_table_body_item_rowspan']); ?>" colspan="<?php echo esc_attr($item['pafe_table_body_item_colspan']); ?>">
                                                <?php if ($item['show_body_item_icon']=='yes'):?>
                                                    <?php if ($item['pafe_table_body_item_icon_position']=='before'):?>
                                                        <?php echo '<i class="pafe-table-body-item-icon '. esc_attr($item['pafe_table_body_item_icon']).'"aria-hidden="true" style="padding-right: '.esc_attr($item['pafe_table_body_item_icon_before_spacing']['size'].$item['pafe_table_body_item_icon_before_spacing']['unit']).';"></i>'; ?>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                                <span class="pafe-table-body-content">
													<a class="pafe-table-body-text" <?php if (!empty($item['pafe_table_body_item_title_url']['url'])) { echo 'href="' . esc_attr($item['pafe_table_body_item_title_url']['url']).'"' . esc_attr($target) . esc_attr($nofollow) ;} ?>><?php echo esc_html($item['pafe_table_body_item_title']);?>
                                                    </a>
												</span>
                                                <?php if ($item['show_body_item_icon']=='yes'):?>
                                                    <?php if ($item['pafe_table_body_item_icon_position']=='after'):?>
                                                        <?php echo '<i class="pafe-table-body-item-icon '. esc_attr($item['pafe_table_body_item_icon']).'"aria-hidden="true" style="padding-left: '.esc_attr($item['pafe_table_body_item_icon_after_spacing']['size'].$item['pafe_table_body_item_icon_after_spacing']['unit']).';"></i>'; ?>
                                                    <?php endif; ?>
                                                <?php endif; ?>
											</td>
									<?php endif; ?>

...
jQuery(document).ready(function($) {
    ...
    $('.custom-accordion > dt .get_pro').add('.fc-form-container .fc-form-group.fc-locked .get_pro').on('click', function(e) {
        e.stopPropagation();
        window.open('https://www.wpmapspro.com/?utm_source=wordpress&utm_medium=liteversion&utm_campaign=freemium&utm_id=freemium', '_blank');
        return false;
    });

    $('.custom-accordion > dt > section > div > h4').add('.fc-form-container .fc-form-group.fc-locked').on('click', function() {
        var $this = $(this);
        var $target = $this.closest('dt').next(); 
        if ($this.closest('dt').find("section").hasClass("fc-locked")) {
          return false;
        } 
    ...
    if ($overviewPage) {
        ...
        var ajaxUrl = settings_obj.urlforajax;
...
jQuery(document).ready(function($) {
    ...
    // Sticky Footer
    if ($('.fc-footer').length > 0 && !$('body').hasClass('wp-maps_page_wpgmp_form_group_map') && !$('body').hasClass('wp-maps_page_wpgmp_manage_settings') ) {

...
if (!$controls->is_action()) {
    ...
    if ($controls->is_action('save')) {
        ...
        //$options['confirmed_disabled'] = $controls->data['welcome_email'] == '2' ? '1' : '0';
    ...
    <div id="tnp-body">
        ...
        <form method="post" id="tnpc-form" action="" onsubmit="tnpc_save(this); return true;">
            ...
            <p>
                ...
                <?php $controls->select('welcome_email',
                        ['' => __('Standard email', 'newsletter'), '1' => __('New email', 'newsletter'), '2' => __('Do not send', 'newsletter')]); ?>
                <?php $controls->button_save() ?>
                &nbsp;&nbsp;
                <?php $controls->button_icon_statistics(NewsletterStatisticsAdmin::instance()->get_statistics_url($controls->data['welcome_email_id']),
                    ['secondary' => true, 'id'=>'tnp-stats-button', 'target'=>'_blank']) ?>
            </p>

            <?php $controls->composer_fields_v2() ?>

        <div id="tnp-standard-welcome">

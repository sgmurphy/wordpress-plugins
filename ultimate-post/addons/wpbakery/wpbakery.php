    ...
    class PostX_WPBakery_Widget {
        ...
        public static function output( $atts, $content = null ) {
            ...
            if ( $templates && $templates != 'empty' ) {
                ...
                if ( isset($_GET['vc_editable']) ) {    // @codingStandardsIgnoreLine
                    $output .= '<p style="text-align:center;">'.sprintf( esc_html_e( 'Pick a Template from your saved ones. Or create a template from: %s.' , 'ultimate-post' ) . ' ', '<strong><i>' . esc_html( 'Dashboard > PostX > Saved Templates', 'ultimate-post' ) . '</i></strong>' ).'</p>';
                }
            }

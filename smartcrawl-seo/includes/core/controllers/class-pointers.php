	...
	public function smartcrawl_activation_pointer( $pointers ) {
		$pointers['wds-activation-pointer'] = array(
			...
			'options' => array(
				'content'  => sprintf(
					'<h3> %s </h3> <p> %s </p>',
					esc_html__( 'Optimize your SEO', 'smartcrawl-seo' ),
					esc_html__( 'Configure your SEO Titles & Meta, enable OpenGraph and activate readability analysis here.', 'smartcrawl-seo' )
				),
				'position' => array(
					'edge'  => 'left',
					'align' => 'right',

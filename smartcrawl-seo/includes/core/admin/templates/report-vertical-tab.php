...
<section class="tab wds-report-vertical-tab">
	...
	// Optional.
	$button_text   = isset( $button_text ) ? $button_text : __( 'Save Settings', 'smartcrawl-seo' );
		...
		<h2 class="tab-title">
			...
			<span class="wds-tab-title-part">
				<?php if ( 'ignore' === $title_button ) : ?>
					<button
						class="wds-ignore-all wds-button-with-loader wds-button-with-left-loader wds-disabled-during-request button button-small button-dark button-dark-o"><?php esc_html_e( 'Ignore All', 'smartcrawl-seo' ); ?></button>
				<?php endif; ?>

				<?php if ( 'upgrade' === $title_button ) : ?>
					<button
						class="wds-upgrade-button button-green"><?php esc_html_e( 'Upgrade to Pro', 'smartcrawl-seo' ); ?></button>
				<?php endif; ?>
			</span>
		</h2>

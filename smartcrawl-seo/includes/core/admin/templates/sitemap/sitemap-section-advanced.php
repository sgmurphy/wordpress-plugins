...
<div class="sui-box-settings-row">
	<div class="sui-box-settings-col-1">
		...
		<span class="sui-description">
			<?php esc_html_e( 'By default, we will automatically update your sitemap but if you wish to update it manually, you can switch to manual mode, or if you wish to update it at regular intervals switch to scheduled mode.', 'smartcrawl-seo' ); ?>
		</span>
	</div>
	<div class="sui-box-settings-col-2">
		<?php
		$this->render_view(
			...
			array(
				...
				'tabs'  => array(
					...
					array(
						'value'    => 'scheduled',
						'label'    => esc_html__( 'Scheduled', 'smartcrawl-seo' ),

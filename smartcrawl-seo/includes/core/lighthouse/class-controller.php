	...
	public function checkup_removal_notice() {
		...
		<div
			...
			<a href="<?php echo esc_attr( $health_admin_url ); ?>"
				...
				<?php esc_html_e( 'Check Out SEO Audits', 'smartcrawl-seo' ); ?>
			</a>
			<a href="#"
				class="wds-native-dismiss"><?php esc_html_e( 'Dismiss', 'smartcrawl-seo' ); ?></a>
			<p></p>
		</div>
		<?php
	}
	...
	public function run_lighthouse() {
		...
		if ( $now >= $start_time + 90 ) {
			...
			$lighthouse->set_error(
				'timeout',
				esc_html__( 'We were not able to get results for your site', 'smartcrawl-seo' )
			);

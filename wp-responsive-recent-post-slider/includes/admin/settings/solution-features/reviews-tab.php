...
<div id="wppsac_review_tabs" class="wppsac-vtab-cnt wppsac_review_tabs wppsac-clearfix">
		...
		<div class="wppsac-testimonial-section-inr">
			<div class="wppsac-testimonial-box-wrap">
				<div class="wppsac-testimonial-box-grid">
					...
					<div class="wppsac-testimonial-rating"><img src="<?php echo esc_url(WPRPS_URL); ?>/assets/images/rating.png" /></div>
				</div>
				<div class="wppsac-testimonial-box-grid">

					...
					<div class="postbox wpos-pro-box">
						...
						<div class="inside">
							<ul class="wpos-list">
								...
								<li><?php esc_html_e( 'Gutenberg, Elementor, Beaver and SiteOrigin Page Builder Support.', 'wp-responsive-recent-post-slider'); ?> <span class="wpos-new-feature">New</span></li>
								<li><?php esc_html_e( 'Divi Page Builder Native Support.', 'wp-responsive-recent-post-slider'); ?> <span class="wpos-new-feature">New</span></li>
								<li><?php esc_html_e( 'Fusion Page Builder (Avada) native support.', 'wp-responsive-recent-post-slider'); ?> <span class="wpos-new-feature">New</span></li>

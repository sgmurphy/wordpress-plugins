...
add_filter(
	'mesmerize_page_content_wrapper_class',
	function ( $class ) {
...
add_filter(
	'cloudpress\companion\ajax_cp_data',
	function ( $data, $companion, $filter ) {
...
add_filter(
	'cloudpress\customizer\get_data_filter',
	function ( $value, $key ) {

...
class CancelAllILJSchedules {
	...
	public static function render_action() {
		echo '<input type="submit" name="ilj-cancel-schedules" style="margin-right: 10px" class="button button-secondary ilj-cancel-schedules" value="' . __('Cancel schedules', 'internal-links') . '" />';
		echo '<p class="description">' . self::get_description() . '</p>';
	}
}

...
class LinksPerPage extends AbstractOption {
	...
	public function renderField($value) {
		...
		?>
		<input type="number" name="<?php echo esc_attr($key); ?>" id="<?php echo esc_attr($key); ?>" value="<?php echo esc_attr($value); ?>" <?php disabled($multiple_keywords); ?> />
		<?php
		echo Help::getOptionsLink('link-countings/', 'links-per-post-amount', 'links per post');
	}

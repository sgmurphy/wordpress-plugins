...
abstract class AbstractMenuPage
{
    ...
    {
        $submenu = add_submenu_page(AdminMenu::ILJ_MENUPAGE_SLUG, $this->getTitle() . ' - Internal Link Juicer', $this->getTitle(), 'manage_options', $first_level ? AdminMenu::ILJ_MENUPAGE_SLUG : (AdminMenu::ILJ_MENUPAGE_SLUG . '-' . $this->getSlug()), array($this, 'render'));
    ...
    {
        add_action('admin_enqueue_scripts', function () use ($js, $css) {

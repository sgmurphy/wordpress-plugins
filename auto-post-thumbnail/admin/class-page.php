	...
	public function showSupportWidget() {
		...
		<div id="wbcr-clr-support-widget" class="wbcr-factory-sidebar-widget">
			...
			<div class="wbcr-clr-support-widget-body">
				<p>
					<?php _e( 'We provide free support for this plugin. If you are pushed with a problem, just create a new ticket. We will definitely help you!', 'wbcr_factory_templates_127' ); ?>
				</p>
				<ul>

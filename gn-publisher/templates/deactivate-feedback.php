...
$reasons = array(
		...
		<li><input type="text" class="mb-box missing" name="gnpub_disable_text[]" value="" placeholder="'.esc_attr__('Please describe the feature', 'gn-publisher').'"/></li>',
		...
		<li><input type="text"  class="mb-box another" name="gnpub_disable_text[]" value="" placeholder="'.esc_attr__('Name of the plugin', 'gn-publisher').'"/></li>',
...
<div id="gnpub-feedback-overlay" style="display: none;">
	...
	<form action="" method="post">
	    ...
	    <?php if ($email) : ?>
    	    <input type="hidden" name="gnpub_disable_from" value="<?php echo esc_attr($email); ?>"/>
	    <?php endif; ?>

 ...
 */
namespace KrokedilKlarnaPaymentsDeps\Composer;

use KrokedilKlarnaPaymentsDeps\Composer\Autoload\ClassLoader;
use KrokedilKlarnaPaymentsDeps\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('KrokedilKlarnaPaymentsDeps\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();

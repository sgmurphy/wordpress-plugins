...
class Assets
{
    ...
    public function register_assets()
    {
        ...
        wp_register_script('klarnapayments', 'https://x.klarnacdn.net/kp/lib/v1/api.js', array(), null, \true);
        // phpcs:ignore WordPress.WP.EnqueuedResourceParameters.MissingVersion
        wp_register_script('kec-cart', $this->assets_path . 'js/kec-cart.js', array(), KlarnaExpressCheckout::VERSION, \true);
        wp_register_script('kec-checkout', $this->assets_path . 'js/kec-checkout.js', array(), KlarnaExpressCheckout::VERSION, \true);
    }
    /**
     * Enqueue scripts.
     */
    ...
    private function enqueue_cart_assets()
    {
        ...
        $params = array('ajax' => array('get_payload' => array('url' => \WC_AJAX::get_endpoint('kec_get_payload'), 'nonce' => wp_create_nonce('kec_get_payload'), 'method' => 'POST'), 'auth_callback' => array('url' => \WC_AJAX::get_endpoint('kec_auth_callback'), 'nonce' => wp_create_nonce('kec_auth_callback'), 'method' => 'POST'), 'set_cart' => array('url' => \WC_AJAX::get_endpoint('kec_set_cart'), 'nonce' => wp_create_nonce('kec_set_cart'), 'method' => 'POST')), 'is_product_page' => $is_product_page, 'product' => $is_product_page ? array('id' => $product->get_id(), 'type' => $product->get_type()) : null, 'client_id' => $client_id, 'theme' => $this->settings->get_theme(), 'shape' => $this->settings->get_shape(), 'locale' => $this->locale);
    ...
    private function enqueue_checkout_assets()
    {
        ...
        $params = array('ajax' => array('get_payload' => array('url' => \WC_AJAX::get_endpoint('kec_get_payload'), 'nonce' => wp_create_nonce('kec_get_payload'), 'method' => 'POST'), 'checkout' => array('url' => \WC_AJAX::get_endpoint('checkout'), 'method' => 'POST'), 'finalize_callback' => array('url' => \WC_AJAX::get_endpoint('kec_finalize_callback'), 'nonce' => wp_create_nonce('kec_finalize_callback'), 'method' => 'POST')), 'client_token' => $client_token);

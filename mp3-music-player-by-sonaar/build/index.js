...
(function (wp) {
  ...
  registerBlockType('sonaar/sonaar-block', {
    ...
    edit: function edit(props) {
      ...
      }), show_searchbar && createElement('hr', {}), show_searchbar && createElement(RichText.Content, {
        tagName: 'label',
        className: 'components-base-control__label sonaar-block-label',
      ...
      }, 'Learn more'), ' about our shortcode parameters.']))), createElement(serverSideRender, {

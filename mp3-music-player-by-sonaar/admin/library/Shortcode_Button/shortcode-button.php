...
if ( ! class_exists( 'Shortcode_Button_107', false ) ) {
	...
	class Shortcode_Button_107 {
		...
		public function __construct() {
			 ...
			 */
			add_action( 'wp_loaded', array( __CLASS__, 'fire_hook' ) );
		}
		...
		public static function fire_hook() {
			...
			if (defined ('SRMP3PRO_VERSION') && defined ('SRMP3_PRO_MIN_VERSION') && SRMP3PRO_VERSION < SRMP3_PRO_MIN_VERSION ){
				add_action( 'admin_notices',  array( __CLASS__, 'sonaar_pro_need_update' ));
			}	
		}
		public static function sonaar_pro_need_update() {
		...
		public function include_lib() {
			...
			if ( ! defined( 'SHORTCODE_BUTTONS_URL' ) ) {
				/**
				 * Defines the directory of the currently loaded version of Shortcode_Button.
				 */
				define( 'SHORTCODE_BUTTONS_URL', plugins_url('/', __FILE__)  );

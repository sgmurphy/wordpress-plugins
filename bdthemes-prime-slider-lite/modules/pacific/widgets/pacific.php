...
class Pacific extends Widget_Base {
	...
	public function render_title() {
		...
		$this->add_render_attribute('slider-title', 'data-swiper-parallax', '-300', true);
	...
	function render_arrows_fraction() {
		...
		?>
			<div class="reveal-muted bdt-position-z-index bdt-position-<?php echo esc_html($settings['arrows_fraction_position']); ?>">

...
class Skin_Slide extends Elementor_Skin_Base {
    ...
    public function render_header($skin_name = 'slide') {
		...
		$this->parent->add_render_attribute('prime-slider', 'class', 'bdt-prime-slider-skin-' . $skin_name);
		...
		?>
			<div class="bdt-prime-slider">
				<div <?php $this->parent->print_render_attribute_string('prime-slider'); ?>>
    ...
    public function rendar_item_content($slide_content) {
        ...
        <div class="bdt-slide-featured bdt-flex">
            ...
            <?php if ($slide_content['excerpt'] && ( 'yes' == $settings['show_excerpt'] )) : ?>
                <div class="bdt-slider-excerpt" <?php echo wp_kses_post($parallax_excerpt); ?> data-reveal="reveal-active">

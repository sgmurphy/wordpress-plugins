...
0. **[Blog - Base](https://primeslider.pro/demo/blog-base/)** - Blog base makes the most profound layout to display your blog posts on any modern WordPress blogging website. The slider offers a eye-catchy post interface combined with accent colors to bring the most out of the whole layout
...
0. **[Adaptive Background](https://primeslider.pro/demo/adaptive-bg/)** - This feature is only supported for sliders developed using the Swiper technology. And also make sure images are PNG | JPG.
...
* Updated: Fortune, fluent & general widgets optimized & improved

= 3.10.5 [30th October 2023] =

* Added: Content position, avatar controls added in flogia widget
* Added: Thumbs style & text stroke controls added in fluent widget
* Added: Item gap zero option added in pacific widget
* Updated: Flogia & fluent widgets controls & layout improved

= 3.10.4 [25th October 2023] =

* Fixed: Background video issue fixed in general widget

= 3.10.3 [18th October 2023] =

* Added: Arrows Style added in Monster Slider (Thanks to Ozy)
* Added: Image Link feature added in Monster Slider (Thanks to Ozy)

= 3.10.2 [14th October 2023] =

* Added: Layout style option added in fortune widget
* Fixed: Viewport height issue fixed
* Fixed: Avatar widget z-index issue fixed

= 3.10.1 [7th October 2023] =

* Added: Title text stroke added in storker widget
* Added: Title text stroke & text shadow options added in sniper widget
* Added: Navigation arrows icon option added in fiestar widget
* Added: Scroll button Space Between option added in blog widget
* Added: Title text stroke added in fiestar widget
* Added: Thumbs active & title padding option added in flogia widget
* Added: Arrows hover color added in reveal widget
* Fixed: Deprecated warning fixed
* Fixed: Thumbs title issue fixed in knily widget
* Fixed: Pagination issue fixed in isolate & sequester widgets
* Fixed: Read more radius issue fixed in rubix widget
* Fixed: Text spacing, button overflow issue fixed in blog widget
* Fixed: Thumbs height issue fixed in flogia widget
* Fixed: Avatar radius & meta align issue fixed in fluent widget
* Fixed: Slice skin responsive issue fixed

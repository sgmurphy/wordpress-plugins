	...
	var WPPopups = {
		...
		bindUIActions: function() {
            ...
            $('body').on( event, function (ev) {
                ...
                // Forminator datepicker and also others it may be needed

                if( $target.is(window.wp.hooks.applyFilters( 'wppopups_disable_click_out_classes', '.flatpickr-calendar,.flatpickr-calendar *, .ui-datepicker-header *,.ui-widget,.ui-widget *') ) )
                    return;

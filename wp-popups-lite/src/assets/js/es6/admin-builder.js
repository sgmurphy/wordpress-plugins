    ...
    const WPPopupsBuilder = {
        ...
        initChoicesJS: function () {
            ...
            $('#wppopups-templates').each(function () {
                ...
                $(this)[0].choices = new Choices($this[0], args);
                $(this)[0].choices.passedElement.addEventListener(
                    'choice',
                    function(choice) {
         ...
         * @return string
         */
        applyContentTemplates: function( html ) {

            if ( wppopups_builder_vars.content_templates.length === 0 ) {
                return html;
            }

            const templates = wppopups_builder_vars.content_templates;
        ...
        fieldChoiceSortable: function(type, selector) {
            ...
            $('#wppopups-templates').sortable({
                ...
                stop:function(e,ui){
                    ...
                    const shortcode = '[wppopup-template id="'+id+'"]';
                    alert(shortcode);
                },
                update:function(e,ui){
                }

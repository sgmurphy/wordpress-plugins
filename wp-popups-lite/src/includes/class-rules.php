...
class WPPopups_Rules {
	...
	public static function options() {
		$rules = [
			...
			__( 'Other', 'wp-popups-lite' ) => [
				...
				'cookie'       => __( 'Cookie', 'wp-popups-lite' ),
		...
		// WPML or Polylang
		if ( function_exists( 'weglot_get_current_language' ) || function_exists( 'icl_object_id' ) || function_exists( 'pll_current_language' ) ) {
	...
	*/
	...
	public static function rule_match_language( $rule ) {
		...
		// match
		if ( '==' === $rule['operator'] ) {
			return ( strtolower( $lang ) === strtolower( $rule['value'] ) );
		}

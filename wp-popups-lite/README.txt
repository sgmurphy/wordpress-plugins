...
= 2.2 =
* Added Gutenberg blocks templates to fully customize your popups with WordPress content editor

= 2.1.5.6 =
* Added filter to avoid open popup again on form submissions
* Fixed php8 undefined error
* Fixed issue with recaptcha iframe being removed
* Missing commit for CF7
* Removed old code for UA

= 2.1.5.5 =
* Forminator close on conversion
* Shadow text fix
...
= 2.1.5.3 =
* Fixed issue with CF7 closing the popup

= 2.1.5.2 =
* Fixed issued with Contact form 7

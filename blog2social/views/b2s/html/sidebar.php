                ...
                <div class="row">
                    <div class="b2s-sidebar-head">
                        ...
                        <ul>
                            ...
                            <li class="b2s-list-margin-left-10">
                                <i class="glyphicon glyphicon-asterisk glyphicon-success"></i> <a href="admin.php?page=blog2social-ai-content-creator" class="b2s-sidebar-menu-item"><?php esc_html_e("AI Content Creator", "blog2social") ?> <span class="label label-success"><?php esc_html_e("NEW", "blog2social"); ?></span></a> 
                            </li>
                            <li class="b2s-list-margin-left-10">

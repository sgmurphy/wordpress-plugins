<?php  function wpbc_all_translations1() { $wpbc_all_translations = array(); 
 ...
 $wpbc_all_translations[] = __('Calendar have 2 months in a row, the cell height is 30px and calendar max. full width 568px (possible to use percentage for width: 100%)', 'booking'); 
 $wpbc_all_translations[] = __('Code Example', 'booking'); 
 $wpbc_all_translations[] = __('Another Example', 'booking'); 
 ...
 $wpbc_all_translations[] = __('Add the %sbooking form shortcode%s to a different %spost%s or %spage%s.', 'booking'); 
 $wpbc_all_translations[] = __('Learn how to set up %sdifferent shortcodes%s and embedding them in %sWP Block Editor, Elementor, or the Shortcode Block%s.', 'booking'); 

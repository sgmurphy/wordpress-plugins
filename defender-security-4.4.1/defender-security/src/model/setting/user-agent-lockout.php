...
class User_Agent_Lockout extends Setting {
	...
	*/
	public function get_default_values(): array {
		...
		return [
			'message' => __( 'You have been blocked from accessing this website.', 'defender-security' ),
			'whitelist' => $whitelist,
			// Blocked User Agents.
			'blacklist' => "MJ12Bot\nAhrefsBot\nSEMrushBot\nDotBot",
		];
	...
	public function labels(): array {
		return [
			...
			'blacklist' => __( 'Blocklist', 'defender-security' ),
			'whitelist' => __( 'Allowlist', 'defender-security' ),
			'empty_headers' => __( 'Empty Headers', 'defender-security' ),
		];
	}
	...
	public static function get_module_name(): string {
		return __( 'User Agent Banning', 'defender-security' );
	}

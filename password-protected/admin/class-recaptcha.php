...
class Password_Protected_reCAPTCHA  {
    ...
    public $tab             = 'password-protected&tab=security&sub-tab=google-recaptcha';
	...
	public function __construct() {
        ...
        add_action( 'password_protected_subtab_google-recaptcha_content', array( self::class, 'recpatcha_screen' ) );
	}
    ...
    public function register_reCAPTCHA_settings() {
        ...
        register_setting( 'password-protected-google-recaptcha', $this->options_name, array( 'type' => 'array') );
    }
    ...
    public static function recpatcha_screen() {
        ...
        settings_fields( 'password-protected-google-recaptcha' );
        do_settings_sections( 'password-protected&tab=security&sub-tab=google-recaptcha' );
    ...
    public function reCAPTCHA_enable() {
        echo '<div class="pp-toggle-wrapper">
            <input name="'.esc_attr( $this->options_name ) .'[enable]" id="pp_enable_recaptcha" type="checkbox" value="1" ' . checked( 1, @$this->settings['enable'], false ) . ' />
            <label for="pp_enable_recaptcha" class="pp-toggle">
                <span class="pp-toggle-slider"></span>
            </label>
        </div>
        <p class="description">
            <label for="pp_enable_recaptcha">
                ' . __( 'Enable Google reCaptcha', 'password-protected' ) . '
            </label>
        </p>';
    }

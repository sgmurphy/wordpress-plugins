...
$icon_increase        = plugins_url("lite/assets/img/emails/summaries/increase.png", EXACTMETRICS_PLUGIN_FILE);
$icon_increase_2x     = plugins_url("lite/assets/img/emails/summaries/increase@2x.png", EXACTMETRICS_PLUGIN_FILE);
$icon_decrease        = plugins_url("lite/assets/img/emails/summaries/decrease.png", EXACTMETRICS_PLUGIN_FILE);
$icon_decrease_2x     = plugins_url("lite/assets/img/emails/summaries/decrease@2x.png", EXACTMETRICS_PLUGIN_FILE);
$icon_top_pages           = plugins_url("lite/assets/img/emails/summaries/icon-top-pages.png", EXACTMETRICS_PLUGIN_FILE);
$icon_top_pages_2x        = plugins_url("lite/assets/img/emails/summaries/icon-top-pages@2x.png", EXACTMETRICS_PLUGIN_FILE);
$icon_sessions        = plugins_url("lite/assets/img/emails/summaries/icon-sessions.png", EXACTMETRICS_PLUGIN_FILE);
$icon_sessions_2x     = plugins_url("lite/assets/img/emails/summaries/icon-sessions@2x.png", EXACTMETRICS_PLUGIN_FILE);
$icon_page_views        = plugins_url("lite/assets/img/emails/summaries/icon-page-views.png", EXACTMETRICS_PLUGIN_FILE);
$icon_page_views_2x     = plugins_url("lite/assets/img/emails/summaries/icon-page-views@2x.png", EXACTMETRICS_PLUGIN_FILE);
$icon_engagement        = plugins_url("lite/assets/img/emails/summaries/icon-engagement.png", EXACTMETRICS_PLUGIN_FILE);
$icon_engagement_2x     = plugins_url("lite/assets/img/emails/summaries/icon-engagement@2x.png", EXACTMETRICS_PLUGIN_FILE);
$icon_more_traffic        = plugins_url("lite/assets/img/emails/summaries/icon-more-traffic.png", EXACTMETRICS_PLUGIN_FILE);
$icon_more_traffic_2x     = plugins_url("lite/assets/img/emails/summaries/icon-more-traffic@2x.png", EXACTMETRICS_PLUGIN_FILE);
$icon_button_arrow        = plugins_url("lite/assets/img/emails/summaries/icon-button-arrow.png", EXACTMETRICS_PLUGIN_FILE);
$icon_button_arrow_2x     = plugins_url("lite/assets/img/emails/summaries/icon-button-arrow@2x.png", EXACTMETRICS_PLUGIN_FILE);
$icon_bulb        = plugins_url("lite/assets/img/emails/summaries/icon-bulb.png", EXACTMETRICS_PLUGIN_FILE);
$icon_bulb_2x     = plugins_url("lite/assets/img/emails/summaries/icon-bulb@2x.png", EXACTMETRICS_PLUGIN_FILE);
...
$sessions_difference         = __('Decrease sessions: ', 'google-analytics-dashboard-for-wp');
if ((int) $prev_sessions_percentage === (int) $prev_sessions_percentage && (int) $prev_sessions_percentage >= 0) {
	...
	$sessions_difference         = __('Increase sessions: ', 'google-analytics-dashboard-for-wp');
}
...
$pageviews_difference         = __('Decrease pageviews: ', 'google-analytics-dashboard-for-wp');
if ((int) $prev_pageviews_percentage === (int) $prev_pageviews_percentage && (int) $prev_pageviews_percentage >= 0) {
	...
	$pageviews_difference         = __('Increase pageviews: ', 'google-analytics-dashboard-for-wp');
}
...
$engagement_difference         = __('Decrease engagement: ', 'google-analytics-dashboard-for-wp');
if ((int) $prev_engagement_percentage === (int) $prev_engagement_percentage && (int) $prev_engagement_percentage >= 0) {
	...
	$engagement_difference         = __('Increase engagement: ', 'google-analytics-dashboard-for-wp');
}
?>
<tr>
		...
		<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;" class="mcnTextContentContainer">
			<tbody>
				...
				<tr style="display:block;padding: 30px 25px 0 25px;">
					<td style="font-weight: bold;font-size: 14px;line-height: 27px;color: #393F4C;" class="mcnTextContent"><?php _e('Hi there!', 'google-analytics-dashboard-for-wp'); ?></td>
				</tr>
							...
							<tbody>
								<tr>
									<td style="padding-bottom:8px;">
										...
										if (!empty($icon_sessions)) {
											echo '<img src="' . esc_url($icon_sessions) . '" srcset="' . esc_url($icon_sessions_2x) . ' 2x" target="_blank" alt="' . esc_attr__('Sessions', 'google-analytics-dashboard-for-wp') . '" />';
										}
										?>
									</td>
								</tr>
								<tr>
									<td style="padding-bottom:8px; font-size:12px;">
										<?php _e('Total Sessions', 'google-analytics-dashboard-for-wp'); ?>
									</td>
								</tr>
								<tr>
									<td style="padding-bottom:5px; font-size:12px; display:flex; align-items: center; justify-content: center; gap: 6px;">
										<span style="display:inline-block; font-size:28px; color: #000000; font-weight: bold;">
											<?php printf(esc_html('%s%s', 'google-analytics-dashboard-for-wp'), $total_sessions_string, ($total_sessions > 999) ? 'k' : ''); ?>
										</span>
										<span style="display:flex; align-items: center; justify-content: center; gap: 1px;">
											...
											<span style="display:inline-block;" class="<?php echo $sessions_percentage_class; ?>">
												...
												printf(__('%s&#37;', 'google-analytics-dashboard-for-wp'), $prev_sessions_percentage);
												?>
											</span>
										</span>
									</td>
								...
								<tr>
									<td style="padding-bottom:5px; font-size:10px; color: #9CA4B5;">
										...
										printf(__('vs previous %s days', 'google-analytics-dashboard-for-wp'), $range);
										?>
									</td>
								</tr>
							</tbody>
					...
					<td style="width:30%;padding:12px 9px; text-align:center; outline: 1px solid #D6E2ED; border-radius:3px; font-size: 12px;">
						<table style="width:100%;">
							<tbody>
								<tr>
									<td style="padding-bottom:8px;">
										...
										if (!empty($icon_page_views)) {
											echo '<img src="' . esc_url($icon_page_views) . '" srcset="' . esc_url($icon_page_views_2x) . ' 2x" target="_blank" alt="' . esc_attr__('Page Views', 'google-analytics-dashboard-for-wp') . '" />';
										}
										?>
									</td>
								</tr>
								<tr>
									<td style="padding-bottom:8px; font-size:12px;">
										<?php _e('Total Pageviews', 'google-analytics-dashboard-for-wp'); ?>
									</td>
								</tr>
								<tr>
									<td style="padding-bottom:5px; font-size:12px; display:flex; align-items: center; justify-content: center; gap: 6px;">
										<span style="display:inline-block; font-size:28px; color: #000000; font-weight: bold;">
											<?php printf(esc_html('%s%s', 'google-analytics-dashboard-for-wp'), $total_pageviews_string, ($total_pageviews > 999) ? 'k' : ''); ?>
										</span>
										<span style="display:flex; align-items: center; justify-content: center; gap: 1px;">
											<span style="display:inline-block;">
												<?php
											...
											<span style="display:inline-block;" class="<?php echo $pageviews_percentage_class; ?>">
												<?php printf(__('%s&#37;', 'google-analytics-dashboard-for-wp'), $prev_pageviews_percentage); ?>
											</span>
										</span>
									</td>
								</tr>
								<tr>
									<td style="padding-bottom:5px; font-size:10px; color: #9CA4B5;">
										<?php printf(__('vs previous %s days', 'google-analytics-dashboard-for-wp'), $range);  ?>
									</td>
								</tr>
							</tbody>
						</table>
					...
					<td style="width:30%;padding:12px 9px; text-align:center; outline: 1px solid #D6E2ED; border-radius:3px; font-size: 12px;">
						<table style="width:100%;">
							<tbody>
								<tr>
									<td style="padding-bottom:8px;">
										...
										if (!empty($icon_engagement)) {
											echo '<img src="' . esc_url($icon_engagement) . '" srcset="' . esc_url($icon_engagement_2x) . ' 2x" target="_blank" alt="' . esc_attr__('engagement', 'google-analytics-dashboard-for-wp') . '" />';
										}
										?>
									</td>
								</tr>
								<tr>
									<td style="padding-bottom:8px; font-size:12px;">
										<?php _e('Total Engagement', 'google-analytics-dashboard-for-wp'); ?>
									</td>
								</tr>
								<tr>
									<td style="padding-bottom:5px; font-size:12px; display:flex; align-items: center; justify-content: center; gap: 6px;">
										<span style="display:inline-block; font-size:28px; color: #000000; font-weight: bold;">
											<?php printf(esc_html('%s', 'google-analytics-dashboard-for-wp'), $total_engagement_string); ?>
										</span>
										<span style="display:flex; align-items: center; justify-content: center; gap: 1px;">
											<span style="display:inline-block;">
												<?php
											...
											<span style="display:inline-block;" class="<?php echo $engagement_percentage_class; ?>">
												<?php printf(__('%s&#37;', 'google-analytics-dashboard-for-wp'), $prev_engagement_percentage); ?>
											</span>
										</span>
									</td>
								</tr>
					...
					<tr>
						<td style="width: 24px; vertical-align:middle;">
							...
							if (!empty($icon_top_pages)) {
								echo '<img src="' . esc_url($icon_top_pages) . '" srcset="' . esc_url($icon_top_pages_2x) . ' 2x" target="_blank" alt="' . esc_attr__('Pages', 'google-analytics-dashboard-for-wp') . '" />';
							}
							?>
						</td>
						<td style="font-weight:bold; font-size: 14px;  vertical-align:middle;"><?php _e('Top Pages', 'google-analytics-dashboard-for-wp'); ?></td>
					</tr>
				</tbody>
			</table>
			...
			<table style="margin:0px 25px; font-family: Helvetica; width:400px; color: #9CA4B5; font-size: 12px; width:400px;">
				<tbody>
						...
						<?php if (isset($top_pages[$i])) : ?>
							<tr>
								<td style="width:300px;padding-top:8px;padding-bottom:8px;text-align:left;font-weight: normal;font-size: 14px;line-height: 16px;color: #393F4C;overflow:hidden;" class="mcnTextContent">
									<a href="<?php echo esc_url($top_pages[$i]['hostname'] . $top_pages[$i]['url']); ?>" target="_blank" style="text-decoration:none;color: #393F4C;"><?php echo esc_html($i + 1 . '. ' . exactmetrics_trim_text($top_pages[$i]['title'], 2)); ?></a>
								</td>
					...
					<tr style="display:flex;">
						<td style="width:67%;float:left;padding-top:18px;text-align:left;font-weight: normal;font-size: 12px;line-height: 14px;color: #509FE2;text-decoration: underline;" class="mcnTextContent"><a href="<?php echo esc_url($more_pages); ?>" style="color: #509FE2;"><?php _e('View All Report', 'google-analytics-dashboard-for-wp'); ?></a>
						</td>
					</tr>
				</tbody>
			</table>
							...
							<tbody>
												...
												<tr>
													...
													<?php
														if (!empty($icon_more_traffic)) {
															echo '<img src="' . esc_url($icon_more_traffic) . '" srcset="' . esc_url($icon_more_traffic_2x) . ' 2x" target="_blank" alt="' . esc_attr__('More Traffic', 'google-analytics-dashboard-for-wp') . '" />';
														}
													?>
													</td>
													<td style="text-align: left; padding-left: 5px;">
														<?php _e('Want to Grow?', 'google-analytics-dashboard-for-wp') ?>
													</td>
												</tr>
											</tbody>
										</table>
								...
								<tr>
									<td style="font-size:13px; line-height:18px; text-align:center;color: #777777; padding-bottom:10px;">
										<?php _e('With ExactMetrics Pro, unlock all reports and integrations to help you see the stats that matter. Instantly track purchases, video plays, SEO reports, and much more.', 'google-analytics-dashboard-for-wp') ?>
									</td>
								</tr>
								<tr>
									<td style="text-align:center;">
										<div style="text-align:center; margin:0 auto;">
											<!--[if mso]>
											<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="<?php echo exactmetrics_get_upgrade_link('monthly-lite-email', 'monthly-lite-email', "https://www.exactmetrics.com/pricing/"); ?>" style="height:35px;v-text-anchor:middle;width:164px;" arcsize="9%" strokecolor="#338EEF" fillcolor="#338EEF">
												<w:anchorlock/>
												<center style="color:#ffffff;font-family:sans-serif;font-size:13px;font-weight:bold;"><?php _e('Upgrade to Pro', 'google-analytics-dashboard-for-wp'); ?></center>
											</v:roundrect>
										<![endif]-->
											<a href="<?php echo exactmetrics_get_upgrade_link('monthly-lite-email', 'monthly-lite-email', "https://www.exactmetrics.com/pricing/"); ?>" target="_blank" style="background-color:#338EEF;border-width:1px 1px 2px 1px;border-color:#1177E3;border-style:solid;border-radius:3px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:35px;text-align:center;text-decoration:none;width:164px;-webkit-text-size-adjust:none;mso-hide:all;">
												<?php _e('Upgrade to Pro', 'google-analytics-dashboard-for-wp'); ?>
												<?php
												if (!empty($icon_button_arrow)) {
													echo '<img src="' . esc_url($icon_button_arrow) . '" srcset="' . esc_url($icon_button_arrow_2x) . ' 2x" target="_blank" alt="' . esc_attr__('Upgrade To Pro', 'google-analytics-dashboard-for-wp') . '" style="padding-left: 3px;" />';
												}
												?>
											</a>
										</div>
				...
				<tbody>
					<tr>
						<td valign="top" style="padding: 20px 5px 0px 20px; text-align:center;">
							<?php
							if (!empty($icon_bulb)) {
								echo '<img src="' . esc_url($icon_bulb) . '" srcset="' . esc_url($icon_bulb_2x) . ' 2x" target="_blank" alt="' . esc_attr__('', 'google-analytics-dashboard-for-wp') . '" style="padding-left: 3px;" />';
							}
							?>
						</td>
						<td style="padding: 20px 15px 20px 5px;">
							<div style="font-weight: normal; padding: 3px 0 10px 0;">
								<?php _e('Pro Tip from our experts', 'google-analytics-dashboard-for-wp'); ?>
							</div>

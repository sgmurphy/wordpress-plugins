				...
				<table border="0" cellpadding="0" cellspacing="0" width="450" class="templateContainer"
					...
					if ( ! empty( $header_image ) ) {
						...
						if ( ! empty( $header_image['2x'] ) ) {
							echo '<img style="width:200px;"  src="' . esc_url( $header_image['url'] ) . '" srcset="' . esc_url( $header_image['2x'] ) . ' 2x" alt="' . esc_attr__( 'Monthly Traffic Summary', 'google-analytics-dashboard-for-wp' ) . '" />';
						} else {
							echo '<img style="width:200px;"  src="' . esc_url( $header_image['url'] ) . '" alt="' . esc_attr__( 'Monthly Traffic Summary', 'google-analytics-dashboard-for-wp' ) . '" />';
						}
						echo '</a>';
						echo '</td></tr>';
					}

...
namespace KadenceWP\KadenceBlocks\Monolog;

use DateTimeZone;
use KadenceWP\KadenceBlocks\Monolog\Handler\HandlerInterface;
use KadenceWP\KadenceBlocks\Psr\Log\LoggerInterface;
use KadenceWP\KadenceBlocks\Psr\Log\InvalidArgumentException;
...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     *
     * @throws \KadenceWP\KadenceBlocks\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  Level     $level

 ...
 *
 *      $logger = new \KadenceWP\KadenceBlocks\Monolog\Logger('all', array(new \KadenceWP\KadenceBlocks\Monolog\Handler\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['KadenceWP\\KadenceBlocks\\Monolog\\'], // array Hide calls of classes started with...

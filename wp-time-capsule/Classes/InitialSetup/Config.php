...
class Wptc_InitialSetup_Config extends Wptc_Base_Config {
	...
	protected function set_used_options() {
		$this->used_options = array(
			...
			'backblaze_access_key' => 'retainable',
			'backblaze_secure_key' => 'retainable',
			'backblaze_bucket_region' => 'retainable',
			'backblaze_bucket_name' => 'retainable',

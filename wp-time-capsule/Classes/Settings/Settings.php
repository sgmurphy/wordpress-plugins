...
class Wptc_Settings extends Wptc_Settings_Init {
	...
	public function get_bulk_settings_str(){
		...
		switch (DEFAULT_REPO) {
			...
			case 'backblaze':
				...
				$bulk_settings['backblaze_access_key'] = $this->config->get_option('backblaze_access_key');
				$bulk_settings['backblaze_secure_key'] = $this->config->get_option('backblaze_secure_key');
				$bulk_settings['backblaze_bucket_name'] = $this->config->get_option('backblaze_bucket_name');
				$bulk_settings['backblaze_bucket_region'] = $this->config->get_option('backblaze_bucket_region');
		...
		// $bulk_settings['database_encrypt_settings'] = $this->config->get_option('database_encrypt_settings');
		// $bulk_settings['wptc_auto_update_settings'] = $this->config->get_option('wptc_auto_update_settings');
	...
	public function database_encryption_html(){
		...
		<br>
			...
			<input class="wptc-split-column" type="text" name="database_encryption_key" id="database_encryption_key" placeholder="Enter encryption phrase" value="'.  stripslashes(esc_html( WPTC_Factory::get('config')->get_database_encryption_settings('key') ))  . '">

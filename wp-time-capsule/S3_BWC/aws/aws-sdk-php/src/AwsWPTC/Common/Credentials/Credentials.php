...
namespace AwsWPTC\Common\Credentials;

use AwsWPTC\Common\Enum\ClientOptions as Options;
use AwsWPTC\Common\Exception\InvalidArgumentException;
use AwsWPTC\Common\Exception\RequiredExtensionNotLoadedException;
use AwsWPTC\Common\Exception\RuntimeException;

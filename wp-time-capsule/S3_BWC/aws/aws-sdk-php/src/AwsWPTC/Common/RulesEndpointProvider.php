...
class RulesEndpointProvider
{
    ...
    public static function fromDefaults()
    {
        if( (defined('DEFAULT_REPO') && DEFAULT_REPO == 'wasabi') || 
            ...
            wptc_log('', "--------assigning wasabi endpoints--------");

            return new self(require __DIR__ . '/Resources/public-endpoints-wasabi.php');
        }

        if( (defined('DEFAULT_REPO') && DEFAULT_REPO == 'backblaze') || 
            (defined('FORCE_BACKBLAZE') && FORCE_BACKBLAZE) ){

            wptc_log('', "--------assigning backblaze endpoints--------");

            return new self(require __DIR__ . '/Resources/public-endpoints-backblaze.php');
        }

        wptc_log('', "--------assigning s3 endpoints--------");

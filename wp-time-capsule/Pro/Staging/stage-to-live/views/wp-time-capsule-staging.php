...
<div id="dashboard_activity" class="staging_area_wptc" >
	<h4>Include/Exclude Content ( <a href="https://docs.wptimecapsule.com/article/28-how-push-staging-site-to-production" style="text-decoration: underline;">Need Help?</a> )</h4>
	
	<div style="width: 40%; float: left;" >
		<button class="button button-secondary wptc_dropdown" id="toggle_exlclude_files_n_folders_staging" style="width: 98%; outline:none; text-align: left;">
		...
		<div style="display:none; width: 98%;" id="wptc_exc_files_staging"></div>
	</div>

	<div style="float: left; position: relative;width: 40%;">
			<button class="button button-secondary wptc_dropdown" id="toggle_wptc_db_tables_staging" style="width: 98%; outline:none; text-align: left;">
			...
			<div style="display:none; width: 98%;" id="wptc_exc_db_files_staging"></div>
	</div>

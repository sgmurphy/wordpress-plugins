...
use GuzzleHttpWPTC\Event\EndEvent;
use GuzzleHttpWPTC\Exception\ConnectException;
use GuzzleHttpWPTC\Exception\RequestException;
use GuzzleHttpWPTC\Message\ResponseInterface as GuzzleResponse;
use GuzzleHttpWPTC\Promise;
use GuzzleHttpWPTC\Psr7\Response as Psr7Response;
use GuzzleHttpWPTC\Stream\Stream;
use PsrWPTC\Http\Message\RequestInterface as Psr7Request;
...
class GuzzleHandler
{
     ...
     * @throws \GuzzleHttpWPTC\Exception\GuzzleException
     */

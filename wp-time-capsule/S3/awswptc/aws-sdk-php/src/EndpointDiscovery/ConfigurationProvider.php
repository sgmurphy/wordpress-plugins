<?php
namespace AwsWPTC\EndpointDiscovery;

use AwsWPTC\AbstractConfigurationProvider;
use AwsWPTC\CacheInterface;
use AwsWPTC\ConfigurationProviderInterface;
use AwsWPTC\EndpointDiscovery\Exception\ConfigurationException;
use GuzzleHttpWPTC\Promise;
use GuzzleHttpWPTC\Promise\PromiseInterface;

/**
 * A configuration provider is a function that returns a promise that is
 * fulfilled with a {@see \AwsWPTC\EndpointDiscovery\ConfigurationInterface}
 * or rejected with an {@see \AwsWPTC\EndpointDiscovery\Exception\ConfigurationException}.
 *
 * <code>
 ...
 * {@see AwsWPTC\EndpointDiscovery\ConfigurationProvider::chain}. This function
    ...
    implements ConfigurationProviderInterface
{
     ...
     * defaults to ~/.awswptc/config), then checks for the "default" profile in the
     ...
     * ~/.awswptc/config if not specified
     *
    ...
    public static function ini(
        ...
        return function () use ($profile, $filename, $cacheLimit) {
            ...
            $data = \AwsWPTC\parse_ini_file($filename, true);
            if ($data === false) {

<?php
namespace AwsWPTC\Retry;

use AwsWPTC\AbstractConfigurationProvider;
use AwsWPTC\CacheInterface;
use AwsWPTC\ConfigurationProviderInterface;
use AwsWPTC\Retry\Exception\ConfigurationException;
use GuzzleHttpWPTC\Promise;
use GuzzleHttpWPTC\Promise\PromiseInterface;

/**
 * A configuration provider is a function that returns a promise that is
 * fulfilled with a {@see \AwsWPTC\Retry\ConfigurationInterface}
 * or rejected with an {@see \AwsWPTC\Retry\Exception\ConfigurationException}.
 *
 * <code>
 * use AwsWPTC\Sts\RegionalEndpoints\ConfigurationProvider;
 ...
 * {@see \AwsWPTC\Retry\ConfigurationProvider::chain}. This function

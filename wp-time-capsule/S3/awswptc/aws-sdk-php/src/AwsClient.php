...
class AwsClient implements AwsClientInterface
{
     ...
     *   waiter, or paginator.
     * - credentials:
     *   (AwsWPTC\Credentials\CredentialsInterface|array|bool|callable) Specifies
     *   the credentials used to sign requests. Provide an
     *   AwsWPTC\Credentials\CredentialsInterface object, an associative array of
     *   "key", "secret", and an optional "token" key, `false` to use null
     *   credentials, or a callable credentials provider used to create
     *   credentials or return null. See AwsWPTC\Credentials\CredentialProvider for
     *   a list of built-in credentials providers. If no credentials are
     *   provided, the SDK will attempt to load them from the environment.
     * - csm:
     *   (AwsWPTC\ClientSideMonitoring\ConfigurationInterface|array|callable) Specifies
     *   the credentials used to sign requests. Provide an
     *   AwsWPTC\ClientSideMonitoring\ConfigurationInterface object, a callable
     ...
     *   GuzzleHttpWPTC\TransferStats). HTTP handlers must support an
     ...
     *   of S3).
     * - endpoint_discovery: (AwsWPTC\EndpointDiscovery\ConfigurationInterface,
     *   AwsWPTC\CacheInterface, array, callable) Settings for endpoint discovery.
     *   Provide an instance of AwsWPTC\EndpointDiscovery\ConfigurationInterface,
     *   an instance AwsWPTC\CacheInterface, a callable that provides a promise for
     ...
     *   is required. See AwsWPTC\Endpoint\EndpointProvider for a list of built-in
     *   providers.
     * - handler: (callable) A handler that accepts a command object,
     *   request object and returns a promise that is fulfilled with an
     *   AwsWPTC\ResultInterface object or rejected with an
     *   AwsWPTC\Exception\AwsException. A handler does not accept a next handler
     ...
     *   available regions.
     * - retries: (int, AwsWPTC\Retry\ConfigurationInterface, AwsWPTC\CacheInterface,
     *   array, callable) Configures the retry mode and maximum number of
     *   allowed retries for a client (pass 0 to disable retries). Provide an
     *   integer for 'legacy' mode with the specified number of retries.
     *   Otherwise provide an instance of AwsWPTC\Retry\ConfigurationInterface, an
     *   instance of  AwsWPTC\CacheInterface, a callable function, or an array with
     ...
     *   AwsWPTC\Signature\SignatureProvider for a list of built-in providers
     ...
     *   disable checking for shared config file in '~/.awswptc/config' and
     *   '~/.awswptc/credentials'.  This will override the AWS_CONFIG_FILE
    ...
    private function parseClass()
    {
        ...
        if ($klass === __CLASS__) {
            return ['', 'AwsWPTC\Exception\AwsException'];
        }
        ...
        return [
            strtolower($service),
            "AwsWPTC\\{$service}\\Exception\\{$service}Exception"
        ];
    }
    ...
    private function loadAliases($file = null)
    {
        if (!isset($this->aliases)) {
            ...
            $aliases = \AwsWPTC\load_compiled_json($file);
    ...
    {
        $aliases = \AwsWPTC\load_compiled_json(__DIR__ . '/data/aliases.json');

...
use AwsWPTC\Exception\UnresolvedApiException;
 ...
 * {@see AwsWPTC\Exception\UnresolvedApiException}.
 *
 ...
 * {@see AwsWPTC\or_chain}. This method accepts providers as arguments and
...
class ApiProvider
{
    ...
    {
        return new self(__DIR__ . '/../data', \AwsWPTC\manifest());
    }
    ...
    public function __invoke($type, $service, $version)
    {
        ...
        try {
            return \AwsWPTC\load_compiled_json($path);

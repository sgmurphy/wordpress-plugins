<?php
namespace AwsWPTC\Api\Serializer;

use AwsWPTC\Api\MapShape;
use AwsWPTC\Api\Service;
use AwsWPTC\Api\Operation;
use AwsWPTC\Api\Shape;
use AwsWPTC\Api\StructureShape;
use AwsWPTC\Api\TimestampShape;
use AwsWPTC\CommandInterface;
use GuzzleHttpWPTC\Psr7;
use GuzzleHttpWPTC\Psr7\Uri;
use GuzzleHttpWPTC\Psr7\UriResolver;

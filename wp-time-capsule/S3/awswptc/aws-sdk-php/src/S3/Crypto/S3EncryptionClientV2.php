<?php
namespace AwsWPTC\S3\Crypto;

use AwsWPTC\Crypto\DecryptionTraitV2;
use AwsWPTC\Exception\CryptoException;
use AwsWPTC\HashingStream;
use AwsWPTC\PhpHash;
use AwsWPTC\Crypto\AbstractCryptoClientV2;
use AwsWPTC\Crypto\EncryptionTraitV2;
use AwsWPTC\Crypto\MetadataEnvelope;
use AwsWPTC\Crypto\MaterialsProvider;
use AwsWPTC\Crypto\Cipher\CipherBuilderTrait;
 ...
 *
 * <code>
 * use AwsWPTC\Crypto\KmsMaterialsProviderV2;
 * use AwsWPTC\S3\Crypto\S3EncryptionClientV2;
 * use AwsWPTC\S3\S3Client;
 *
...
class S3EncryptionClientV2 extends AbstractCryptoClientV2
{
     ...
     *   determined.
     *
     * @return \AwsWPTC\Result PutObject call result with the details of uploading
     *                     the encrypted file.
     *
     * @throws \InvalidArgumentException Thrown when arguments above are not
     *                                   passed or are passed incorrectly.
     ...
     *   materials providers. Defaults to false.
     *
     * @return \AwsWPTC\Result GetObject call result with the 'Body' field

...
use AwsWPTC\Arn\ObjectLambdaAccessPointArn;
use AwsWPTC\Arn\Exception\InvalidArnException;
use AwsWPTC\Arn\AccessPointArn as BaseAccessPointArn;
use AwsWPTC\Arn\S3\OutpostsAccessPointArn;
use AwsWPTC\Arn\S3\OutpostsArnInterface;
...
class BucketEndpointArnMiddleware
{
     ...
     *
     * @param $arn
     * @return \AwsWPTC\Endpoint\Partition
     */

 ...
 * fulfilled with a {@see \AwsWPTC\S3\UseArnRegion\ConfigurationInterface}
 * or rejected with an {@see \AwsWPTC\S3\UseArnRegion\Exception\ConfigurationException}.
 *
 * <code>
 * use AwsWPTC\S3\UseArnRegion\ConfigurationProvider;
 ...
 * {@see AwsWPTC\S3\UseArnRegion\ConfigurationProvider::chain}. This function
    ...
    implements ConfigurationProviderInterface
{
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use ($profile, $filename) {
            ...
            $data = \AwsWPTC\parse_ini_file($filename, true, INI_SCANNER_NORMAL);
            if ($data === false) {

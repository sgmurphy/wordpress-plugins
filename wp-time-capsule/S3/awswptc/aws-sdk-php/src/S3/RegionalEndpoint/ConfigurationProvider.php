<?php
namespace AwsWPTC\S3\RegionalEndpoint;

use AwsWPTC\AbstractConfigurationProvider;
use AwsWPTC\CacheInterface;
use AwsWPTC\ConfigurationProviderInterface;
use AwsWPTC\S3\RegionalEndpoint\Exception\ConfigurationException;
use GuzzleHttpWPTC\Promise;

/**
 * A configuration provider is a function that returns a promise that is
 * fulfilled with a {@see \AwsWPTC\S3\RegionalEndpoint\ConfigurationInterface}
 * or rejected with an {@see \AwsWPTC\S3\RegionalEndpoint\Exception\ConfigurationException}.
 *
 * <code>
 ...
 * {@see \AwsWPTC\S3\RegionalEndpoint\ConfigurationProvider::chain}. This function

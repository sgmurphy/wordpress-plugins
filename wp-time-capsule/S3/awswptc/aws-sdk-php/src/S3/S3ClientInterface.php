...
use AwsWPTC\AwsClientInterface;
...
interface S3ClientInterface extends AwsClientInterface
{
     ...
     * @param array  $options AwsWPTC\S3\BatchDelete options array.
     *
     * @see AwsWPTC\S3\S3Client::listObjects
     ...
     *
     * @see AwsWPTC\S3\MultipartUploader for more info about multipart uploads.
     ...
     * @param array  $options       Options used to configure the upload process.
     *
     * @see AwsWPTC\S3\MultipartCopy for more info about multipart uploads.
     ...
     * @param array  $options   Options available in AwsWPTC\S3\Transfer::__construct
     *
     * @see AwsWPTC\S3\Transfer for more options and customization
     */

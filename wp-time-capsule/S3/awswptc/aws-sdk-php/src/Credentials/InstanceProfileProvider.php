<?php
namespace AwsWPTC\Credentials;

use AwsWPTC\Exception\CredentialsException;
use AwsWPTC\Exception\InvalidJsonException;
use AwsWPTC\Sdk;
use GuzzleHttpWPTC\Exception\TransferException;
...
class InstanceProfileProvider
{
    ...
    private function request($url, $method = 'GET', $headers = [])
    {
        ...
        $userAgent .= ' ' . \AwsWPTC\default_user_agent();

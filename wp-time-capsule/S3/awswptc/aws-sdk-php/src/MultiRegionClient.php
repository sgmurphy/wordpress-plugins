...
use AwsWPTC\Endpoint\PartitionInterface;
...
class MultiRegionClient implements AwsClientInterface
{
        ...
        return $args + [
            'client_factory' => [
                ...
                'default' => function (array $args) {
                    ...
                    $klass = "AwsWPTC\\{$namespace}\\{$namespace}Client";
     ...
     * - partition: (AwsWPTC\Endpoint\Partition|string) AWS partition to connect to.

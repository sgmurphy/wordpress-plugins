...
<div class="col-12 m-0 p-0">
    ...
    <?php if (!empty($view->auditpages)) { ?>
        ...
        <h4 class="card-title"><?php echo esc_html__("Audited pages", "squirrly-seo") ?> (<?php echo count((array)$view->auditpages) ?> <?php echo esc_html__('pages', "squirrly-seo") ?>)</h4>
    ...
    <?php } elseif (SQ_Classes_Helpers_Tools::getValue('sid')) { ?>

        <div class="col-12 m-0 p-0 ">
            <h4 class="text-center"><?php echo sprintf(esc_html__("No data for this filter. %sShow All%s Audit Pages.", "squirrly-seo"), '<a href="' . esc_url(SQ_Classes_Helpers_Tools::getAdminUrl('sq_audits', 'audits')) . '" >', '</a>') ?></h4>
        </div>
    ...
    <?php } elseif (!SQ_Classes_Error::isError()) { ?>
        ...
        <div class="col-12 m-0 p-0 ">
            ...
            <div class="col-12 m-2 text-center">
                <a href="<?php echo esc_url(SQ_Classes_Helpers_Tools::getAdminUrl('sq_audits', 'addpage')) ?>" class="btn btn-lg btn-primary"><i class="fa-solid fa-plus-square-o"></i> <?php echo esc_html__("Add a new page for Audit to get started", "squirrly-seo"); ?></a>
            </div>
        </div>

                        ...
                        <div class="col-12 m-0 p-0">
                            <div class="col-12 m-0 p-0">
                                ...
                                <div class="col-12 m-0 p-0">
                                    ...
                                    <div class="col-12 row m-0 p-0 my-5 sq_advanced">
                                        <div class="col-4 p-0 font-weight-bold">
                                            <label for="sq_sla_type"><?php echo esc_html__("Live Assistant Type", "squirrly-seo"); ?>:</label>
                                ...
                                <div class="col-12 p-0 m-0 my-5">
                                    <div class="col-12 row m-0 p-0">
                                        <div class="col-4 p-0 font-weight-bold">
                                            <label for="sq_sla_exclude_post_types"><?php echo esc_html__("Exclusions", "squirrly-seo"); ?>:</label>

                ...
                <?php foreach ($deactivate_reasons as $reason_key => $reason) { ?>
                    <div class="sq_uninstall_feedback_input_line">
                        ...
                        <?php if (!empty($reason['input_placeholder'])) { ?>
                            <label for="sq_uninstall_feedback_text"></label><input id="sq_uninstall_feedback_text" class="sq_uninstall_feedback_text" type="text" name="reason_<?php echo esc_attr($reason_key); ?>" placeholder="<?php echo esc_attr($reason['input_placeholder']); ?>"/>
                        <?php } ?>

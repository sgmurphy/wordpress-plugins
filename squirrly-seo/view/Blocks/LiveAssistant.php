...
<div class="sq_box" style="display: none">
    <div class="sq_header sq-border-bottom sq-p-1 sq-m-0">
        ...
        <div class="sq_box_close" title="<?php echo esc_attr__("Click to Close Squirrly Live Assistant", "squirrly-seo"); ?>" style="display: none">x</div>
        <div class="sq_box_minimize" title="<?php echo esc_attr__("Click to Minimize Box", "squirrly-seo"); ?>" style="display: none">_</div>
    ...
    <div id="sq_focuspages" class="sq_block_steps" style="display: none">
        ...
        <button data-target="<?php echo esc_url(SQ_Classes_Helpers_Tools::getAdminUrl('sq_focuspages', 'addpage')); ?>" class="sq_finalstep sq_step4 sq_button sq-col-12 sq-m-0 sq-p-2"><?php echo esc_html__("Set Focus Pages", "squirrly-seo"); ?> ></button>

                        ...
                        <?php if (!empty($view->pages)) { ?>
                            <div class="col-12 m-0 p-0 position-relative">
                                ...
                                <div class="col-12 m-0 p-0 my-5">
                                    <a href="<?php echo esc_url(SQ_Classes_Helpers_Tools::getAdminUrl('sq_onboarding', 'step4')) ?>" class="btn btn-primary btn-lg m-0 p-0 py-2 px-4 rounded-0"><?php echo esc_html__("Save & Continue", 'squirrly-seo'); ?> >> </a>
                                </div>

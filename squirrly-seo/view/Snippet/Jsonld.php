                        ...
                        <div class="sq-col-12 sq-row sq-my-0 sq-mx-0 sq-px-0">
                            ...
                            <div class="sq-col-12 sq-row sq-my-2 sq-px-0 sq-mx-0 sq-py-1 sq-px-2">
                                <div class="sq-col-4 sq-p-0 sq-pr-3 sq-font-weight-bold">
							        <?php echo esc_html__("Schema Types", "squirrly-seo"); ?>:<a href="https://howto12.squirrly.co/kb/bulk-seo/#bulk_seo_snippet_jsonld" target="_blank"><i class="fa-solid fa-question-circle sq-m-0 sq-px-1 sq-d-inline"></i></a>
                                ...
                                <div class="sq-col-8 sq-p-0 sq-input-group">
                                    <select multiple name="sq_jsonld_types[]" class="sq_jsonld_types sq-form-control sq-bg-input sq-mb-1" style="min-height: <?php echo ((count($jsonld_types) + 2) * 20) . 'px !important;' ?>">
                                        <option <?php echo(empty($post_jsonld_types) ? 'selected="selected"' : '') ?> value=""><?php echo esc_html__("SEO Automation", "squirrly-seo") . ' (' . esc_html(join(', ', $sq_jsonld_types)) ?>)</option>
					        ...
					        <?php if (SQ_Classes_Helpers_Tools::getOption('sq_seoexpert')) { ?>
                                <div class="sq-col-12 sq-row sq-my-2 sq-px-0 sq-mx-0 sq-py-1 sq-px-2 ">
                                    ...
                                    <div class="sq-col-4 sq-p-0 sq-pr-3 sq-font-weight-bold">
								        <?php echo esc_html__("Remove other Schemas", 'squirrly-seo'); ?>
                                ...
                                <?php if($view->post->sq_adm->jsonld <> '' || apply_filters('sq_jsonld_custom', false)) { ?>
                                    <div class="sq-col-12 sq-row sq-my-2 sq-px-0 sq-mx-0 sq-py-1 sq-px-2">

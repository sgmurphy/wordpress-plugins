...
* Links to the social media profiles of your authors: Facebook, Twitter,  Google+, LinkedIN, Instagram, Flickr, Pinterest, Tumblr, Youtube, Vimeo
...
= 3.4.6 =
* Added compatibility with PHP 8.1, 8.2

= 3.4.5 =
* Added compatibility with WP 6.1.x
...
= 3.1.6  =
* Update Starbox CSS loading conflict
* Fixed the Error: Warning: Invalid argument supplied for foreach() in /home/xxxxx/public_html/wp-content/plugins/starbox/classes/ObjController.php on line 146
* Fixed the Error: Starbox Note: No file was uploaded

= 3.1.5  =
* Fixed the shortcode for Starbox

= 3.1.4  =
* Fixed the loading image issue for new posts
* Updated the GDPR Terms

= 3.1.3  =
* Removed Klout Social Channel

= 3.1.2  =
* Added security filters on Settings saved
* Updated the Profile Upload Image process
* Compatible with WP 4.9.6

= 3.1.1  =
* Let BIO with links in Custom Author Bio
* Compatible with WP 4.9.4

= 3.1.0  =
* Fixed security issues with param sanitize
* Fixed the nonce issue on save settings

<?php
class DTQ_Testimonial extends Divi_Torque_Lite_Module
{
	...
	public function get_fields()
	{
		...
		$fields = array(
			...
			'testimonial'            => array(
				'label'           => esc_html__('Testimonial', 'addons-for-divi'),
				'description'     => esc_html__('Define the testimonial content.', 'addons-for-divi'),
				'type'            => 'textarea',
				'toggle_slug'     => 'content',
				'dynamic_content' => 'text',
			),

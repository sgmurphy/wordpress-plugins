<?php
class DTQ_News_Ticker extends Divi_Torque_Lite_Module
{
	...
	{
		$this->name      = esc_html__('News Ticker', 'addons-for-divi');

		$this->icon_path  	= $this->dtl_icon_path('ticker');
	...
	public function get_advanced_fields_config()
	{
		...
		$advanced_fields['fonts']['text'] = array(
			'css'             => array(
				'main'      => '%%order_class%% .dtq-news-wrap li, %%order_class%% .dtq-news-wrap li a',
				'important' => 'all',
			),
			'tab_slug'        => 'advanced',
			'toggle_slug'     => 'text',

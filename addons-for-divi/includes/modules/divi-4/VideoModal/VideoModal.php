<?php
class DTQ_Video_Popup extends Divi_Torque_Lite_Module
{
	...
	public function init()
	{
		...
		$this->vb_support = 'on';
		$this->name       = esc_html__('Video Modal', 'addons-for-divi');
		$this->icon_path  	= $this->dtl_icon_path('video-modal');
	...
	public function get_fields()
	{
		$fields = array(
			...
			'image'            => array(
				...
				'type'               => 'upload',
				'data_type'          => 'image',
				'default'            => DIVI_TORQUE_LITE_ASSETS . 'imgs/placeholder.svg',
			...
			'trigger_element'  => array(
				'label'       => esc_html__('Button Element', 'addons-for-divi'),
				'description' => esc_html__('Here you can select button element for the video popup.', 'addons-for-divi'),
				'type'        => 'select',
				'toggle_slug' => 'content',
				'default'     => 'icon',
				'options'     => array(
			...
			'icon'             => array(
				...
				'options'     => array(
					...
					'custom' => esc_html__('Custom Icon', 'addons-for-divi'),
				),
				'show_if'     => array(
					'trigger_element' => array('icon', 'icon_text'),
				),
			),
			'custom_play_icon'            => array(
				'label'              => esc_html__('Custom Icon', 'addons-for-divi'),
				'description'        => esc_html__('Here you can define custom icon for the video.', 'addons-for-divi'),
				'type'               => 'upload',
				'data_type'          => 'image',
			...
			'video_link'       => array(
				...
				'description' => esc_html__('Here you can define the URL for the video you would like to display.', 'addons-for-divi'),
				'type'        => 'text',
				'toggle_slug' => 'content',
				'show_if_not' => array(
					'type' => 'video',
	...
	protected function render_trigger($icon)
	{
		...
		if ('text' !== $this->props['trigger_element']) {
			$icons = array(
				...
				'custom' => sprintf('<img src="%1$s" alt="custom-icon"/>', $this->props['custom_play_icon']),
			);

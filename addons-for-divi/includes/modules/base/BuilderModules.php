<?php
class Divi_Torque_Lite_Module extends ET_Builder_Module
{
	...
	public function dtl_icon_path($icon)
	{
		return sprintf('%1$s/assets/imgs/icons/%2$s.svg', DIVI_TORQUE_LITE_DIR, $icon);
	}
	...
	protected function get_overlay_option_fields($opt_slug, $hover_status, $show_if)
	{
		...
		$fields  = array(
			'overlay_on_hover'     => array(
				'label'           => esc_html__('Overlay', 'addons-for-divi'),
				'description'     => esc_html__('Enable overlay on hover.', 'addons-for-divi'),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'on'  => esc_html__('Yes', 'addons-for-divi'),
			...
			'overlay_hover_speed'  => array(
				'label'          => esc_html__('Speed', 'addons-for-divi'),
	...
	protected function get_overlay_style(
		...
		ET_Builder_Element::set_style(
			...
			array(
				'selector'    => '%%order_class%% .dtq-overlay',
				'declaration' => "background-color: {$this->props['overlay_color']};",
			)
		);
	...
	protected function get_carousel_option_fields($supports = null, $default = null, $show_if = null, $toggle_slug = '')
	{
		$aditional   = array();
		...
		$show_if     = !empty($show_if) ? $show_if : array();
		$toggle_slug = !empty($toggle_slug) ? $toggle_slug : $toggle_slug;
		...
		$fields = array(
			...
			'animation_speed'         => array(
				...
				'description'     => esc_html__('Here you can define sliding animation speed for the carousel.', 'addons-for-divi'),
				'type'            => 'range',
				'option_category' => 'basic_option',
				'default'         => '700ms',
				'fixed_unit'      => 'ms',
			...
			'use_nav'                 => array(
				'label'           => esc_html__('Arrows', 'addons-for-divi'),
			...
			'use_pagi'                => array(
				'label'           => esc_html__('Dots', 'addons-for-divi'),
			...
			'is_variable_width'       => array(
				'label'           => esc_html__('Slide Fixed Width', 'addons-for-divi'),
				'description'     => esc_html__('Here you can choose whether fixed width should be used.', 'addons-for-divi'),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'default'         => 'off',
				'toggle_slug'     => $toggle_slug,
			...
			'slide_width'             => array(
				...
				'description'    => esc_html__('Here you can define slide width for the carousel.', 'addons-for-divi'),
				'type'           => 'range',
				'default'        => '360px',
				'fixed_unit'     => 'px',
				'mobile_options' => true,
			...
			'slide_count'             => array(
				...
				'description'    => esc_html__('Here you can define how many slides should be shown.', 'addons-for-divi'),
				'type'           => 'select',
				'default'        => $slide_count,
				'toggle_slug'    => $toggle_slug,
				'sub_toggle'     => 'general',
			...
			'slide_spacing'           => array(
				...
				'description'    => esc_html__('Here you can define spacing between slides.', 'addons-for-divi'),
				'type'           => 'range',
				'default'        => '10px',
				'fixed_unit'     => 'px',
				'toggle_slug'    => $toggle_slug,
			...
			'use_both_side_spacing'   => array(
				'label'           => esc_html__('Both Side Spacing', 'addons-for-divi'),
				'description'     => esc_html__('Here you can choose whether spacing should be applied on first and last item.', 'addons-for-divi'),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'default'         => 'on',
				'toggle_slug'     => $toggle_slug,

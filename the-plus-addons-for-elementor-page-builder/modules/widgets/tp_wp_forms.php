...
class L_ThePlus_Wp_Forms extends Widget_Base {
    ...
    protected function register_controls() {
		...
		$this->add_control(
			'wp_forms_notice',
			[
				'label' => esc_html__( 'NOTICE :- Dashboard -> WPForms -> Settings', 'tpebl' ),
		...
		$this->add_control(
			'wp_forms_notice_dec',
			[
				'label' => esc_html__( 'Check Load Assets Globally to load form in wordpress backend.', 'tpebl' ),
				'type' => Controls_Manager::HEADING,				
			]
		);

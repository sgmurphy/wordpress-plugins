		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">June 19 , 2024 <span class="changelog-version">Lite Version 5.6.0</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Add : New Widget : Table', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Add : New Widget : Carousel Anything', 'tpebl').'</li>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">June 19 , 2024 <span class="changelog-version">Pro Version 5.6.0</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Add : New Widget : Wishlist', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Add : New Widget : Quickview', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Minor bug Fixes & performance Improvements', 'tpebl').'</li>';
						echo '</ul>';
					echo '</div>';

		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">December 28, 2023 <span class="changelog-version">Lite Version 5.3.3</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Fix : Social Icon : Border Color Not Working In Style 3', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Team Member : Controller UI Improvement', 'tpebl').'</li>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">December 28, 2023 <span class="changelog-version">Pro Version 5.3.3</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Update : Accordian : Title Background Padding Responsive Compatibility', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Woo Product Listing : Column Layouts Compatibility With Lazy Load and Load More.', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Minor bug Fixes & Improvements', 'tpebl').'</li>';
						echo '</ul>';
					echo '</div>';

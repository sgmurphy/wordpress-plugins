		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">January 18, 2024 <span class="changelog-version">Lite Version 5.3.5</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Update : Text Block : Performance and UI Improvements', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Caldera Form : Performance and UI Improvements', 'tpebl').'</li>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">January 10, 2024 <span class="changelog-version">Pro Version 5.3.5</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Fix : Scroll Sequence : Debug error', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Minor bug Fixes & Improvements', 'tpebl').'</li>';
						echo '</ul>';
					echo '</div>';

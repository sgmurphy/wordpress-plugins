		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">May 01 , 2024 <span class="changelog-version">Lite Version 5.5.2</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Add : Info Box : Button Icon size Option', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Add : Post Title : Add Text Alignment Option', 'tpebl').'</li>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">May 01 , 2024 <span class="changelog-version">Pro Version 5.5.2</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Fix : Table : Toolt Tip Arrow Condition Improvement', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Mobile Menu : Menu text Condition Improvement', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Minor bug Fixes & Improvements', 'tpebl').'</li>';
						echo '</ul>';
					echo '</div>';

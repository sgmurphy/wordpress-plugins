		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">January 09, 2024 <span class="changelog-version">Lite Version 5.3.4</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Fix : Number Counter : Title Gradient color not working', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Add : Number Counter : Digit Gradient Color', 'tpebl').'</li>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">January 09, 2024 <span class="changelog-version">Pro Version 5.3.4</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Fix : Social Feed : Load More and Lazy Load not working', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Add : Number Counter : Digit Gradient Color', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Minor bug Fixes & Improvements', 'tpebl').'</li>';
						echo '</ul>';
					echo '</div>';

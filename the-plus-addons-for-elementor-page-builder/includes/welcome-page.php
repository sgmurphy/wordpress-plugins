		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">March 22 , 2024 <span class="changelog-version">Lite Version 5.4.2</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Fix : Clients Listing : Security patch', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Team Member Listing : Security patch', 'tpebl').'</li>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">March 22 , 2024 <span class="changelog-version">Pro Version 5.4.1</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Fix : Time Line : Compatibility With Html Tags', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Google Map : Condition Improvement', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Minor bug Fixes & Improvements', 'tpebl').'</li>';
						echo '</ul>';
					echo '</div>';

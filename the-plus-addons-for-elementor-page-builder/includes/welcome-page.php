		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">March 02 , 2024 <span class="changelog-version">Lite Version 5.4.1</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Add : Post Meta : Option to select post modify date.', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Performance : Smart Optimized cache.', 'tpebl').'</li>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">February 28, 2024 <span class="changelog-version">Pro Version 5.4.0</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Improving Performance: Introducing a Smart Optimized Caching Method for Code Optimization and Refinement.', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Product Listing : Ajax pagination comaptibility with search list', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Minor bug Fixes & Improvements', 'tpebl').'</li>';
						echo '</ul>';
					echo '</div>';

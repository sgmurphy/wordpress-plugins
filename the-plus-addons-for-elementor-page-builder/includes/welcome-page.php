		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">August 24 , 2024 <span class="changelog-version">Lite Version 5.6.5</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Add : WDesignKit Elementor Template Integration with The Plus Addons for Elementor', 'tpebl').'</li>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">June 26 , 2024 <span class="changelog-version">Pro Version 5.6.1</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Add : Social Feed : Support to display YouTube feed with Handle Name', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Video : Security Patch ( Low security )', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Minor bug Fixes & performance Improvements', 'tpebl').'</li>';
						echo '</ul>';
					echo '</div>';

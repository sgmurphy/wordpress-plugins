		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">May 09 , 2024 <span class="changelog-version">Lite Version 5.5.3</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Add : Syntax Highlighter widget', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Dark Mode : Global color Condition Improvement', 'tpebl').'</li>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">May 09 , 2024 <span class="changelog-version">Pro Version 5.5.3</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Add : Countdown : WooCommerce Countdown Loop Option', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Add : Woo Single Pricing : Progress Stock Bar', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Minor bug Fixes & performance Improvements', 'tpebl').'</li>';
						echo '</ul>';
					echo '</div>';

...
class L_Theplus_Elementor_Plugin_Options
{
	...
	public function widget_listout(){
		$this->widget_lists = [
			'tp_accordion' => [
				...
				'keyword' => ['Accordion', 'Toggle', 'Collapsible', 'Expandable', ' Content Panel', 'FAQ', 'Q&A', 'Show/Hide', 'Dropdown', 'Tabbed Content', 'Vertical Tabs', 'Accordion Menu', 'Expand/Collapse', 'Content Slider'],
			],
			'tp_adv_text_block' => [
			...
			'tp_advanced_typography' => [
				...
				'keyword' => ['Advanced Typography', 'Typography Widget', 'Elementor Typography', 'Custom Typography', 'Typography Options'],
			],
			'tp_advanced_buttons' => [
				...
				'keyword' => ['Advanced Buttons', 'Button Widget', 'Custom Buttons', 'Stylish Buttons', 'Creative Buttons', 'Elementor Buttons', 'Button', 'Button Addon', 'Button Plugin', 'Button Element'],
			],			
			'tp_shape_divider' => [
				...
				'keyword' => [ 'Animated Separators', 'Elementor Animated Separators', 'Plus Addons Animated Separators', 'Elementor Addon', 'Animated Lines', 'Decorative Separators', 'Fancy Separators', 'Fancy Lines', 'Animated Dividers', 'Elementor Dividers' ],
			],
			'tp_advertisement_banner' => [
				...
				'keyword' => ['advertisement', 'banner', 'ad', 'promotion', 'marketing', 'display', 'graphics'],
			],
			'tp_age_gate' => [
				...
				'keyword' => [ 'Age Gate', 'Age Verification', 'Age Restriction', 'Age Confirmation', 'Age Check', 'Age Limit', 'Age Requirement'],
			],
			'tp_animated_service_boxes' => [
				...
				'keyword' => ['Animated', 'Service', 'Boxes', 'Animated Service Boxes', 'Elementor addon', 'Elementor search bar', 'search', 'Widget for Elementor', 'Elementor service boxes', 'Elementor animated boxes'],
			],
			'tp_audio_player' => [
				...
				'keyword' => ['Audio Player', 'Music Player', 'Sound Player', 'Media Player', 'MP3 Player', 'Podcast Player', 'Audio Widget', 'Music Widget', 'Sound Widget', 'Media Widget', 'MP3 Widget', 'Podcast Widget'],
			],
			'tp_before_after' => [
				...
				'keyword' => [ 'Before After Image', 'Before and After Image', 'Image Comparison', 'Image Slider', 'Image Before and After', 'Elementor Before After Image', 'Elementor Image Comparison', 'Elementor Image Slider', 'Elementor Before and After', 'Before After Slider' ],
			],
			'tp_blockquote' => [
				...
				'keyword' => [ 'Quotes', 'Quote box', 'Quote widget', 'Testimonials', 'Testimonial box', 'Testimonial widget', 'Customer reviews', 'Review box', 'Review widget', 'Feedback box', 'Feedback widget', 'Comment box', 'Comment widget', 'Opinion box', 'Opinion widget', 'Recommendation box', 'Recommendation widget', 'Rating box', 'Rating widget' ],
			],
			'tp_blog_listout' => [
			...
			'tp_caldera_forms' => [
				...
				'keyword' => ['Caldera Forms', 'Form builder', 'Form creator', 'Contact form', 'WordPress form', 'Form plugin', 'Form widget', 'Form generator', 'Drag and drop form', 'Form element', 'Elementor form', 'Plus Addons form', 'Caldera form widget'],
			],
			'tp_carousel_anything' => [
				...
				'keyword' => ['carousel', 'slider', 'slideshow', 'image carousel', 'image slider', 'image slideshow', 'carousel widget', 'slider widget', 'slideshow widget'],
			],
			'tp_carousel_remote' => [
				...
				'keyword' => ['Carousel', 'Remote', 'Slider', 'Slideshow', 'Image Slider', 'Image Carousel', 'Elementor Carousel', 'Elementor Slider', 'Elementor Slideshow', 'Elementor Image Slider', 'Elementor Image Carousel', 'Plus Addons Carousel', 'Plus Addons Slider', 'Plus Addons Slideshow', 'Plus Addons Image Slider', 'Plus Addons Image Carousel'],
			],
			'tp_cascading_image' => [
				...
				'keyword' => [ 'Creative Images', 'Image Gallery', 'Image Slider', 'Image Carousel', 'Image Showcase', 'Image Grid', 'Image Masonry', 'Image Wall', 'Image Portfolio' ],
			],
			'tp_chart' => [
				...
				'keyword' => ['Advanced Chart', 'Chart Widget', 'Elementor Chart', 'Graph Widget', 'Elementor Graph', 'Data Visualization Widget', 'Elementor Data Visualization', 'Advanced Data Visualization', 'Interactive Chart', 'Interactive Graph', 'Elementor Addon Chart', 'Elementor Addon Graph', 'chart','line','bar','vertical bar','horizontal bar','radar','pie','doughnut','polararea','bubble'],
			],
			'tp_circle_menu' => [
				...
				'keyword' => ['Circle Menu', 'Circular Menu', 'Round Menu', 'Circular Navigation', 'Round Navigation', 'Circular Button Menu', 'Round Button Menu', 'Circular Icon Menu', 'Round Icon Menu', 'Circle Menu Widget', 'Circular Menu Widget', 'Round Menu Widget', 'Circle Menu', 'Circular Menu', 'Round Menu'],
			],
			'tp_clients_listout' => [
			...
			'tp_contact_form_7' => [
				...
				'keyword' => ['Contact Form 7', 'form', 'contact form', 'form builder', 'form plugin', 'form creator', 'form generator'],
			],
			'tp_countdown' => [
				...
				'keyword' => ['Countdown', 'Timer', 'Countdown Timer', 'Elementor Countdown', 'Elementor Timer', 'Elementor Countdown Timer', 'Time Limit', 'Time Countdown'],
			],
			'tp_coupon_code' => [
			...
			'tp_dark_mode' => [
				...
				'keyword' => ['Dark mode', 'Night mode', 'Dark theme', 'Night theme', 'Dark widget', 'Night widget', 'Elementor dark mode', 'Elementor night mode'],
			],
			'tp_design_tool' => [
				...
				'keyword' => [ 'Design Styles', 'Styles', 'Widget Styles', 'Elementor Styles', 'Styles', 'Design Widget', 'Elementor Design Styles', 'Design' ],
			],
			'tp_draw_svg' => [
				...
				'keyword' => ['Draw SVG', 'SVG drawing', 'SVG animator', 'SVG widget', 'SVG', 'SVG animation', 'SVG graphics', 'SVG design'],
			],			
			...
			'tp_dynamic_device' => [
				...
				'keyword' => ['Dynamic Devices', 'Devices', 'Device', 'Responsive Devices', 'Device Preview', 'Device Switcher', 'Device Mockup', 'Device Showcase', 'Device Slider', 'Device Carousel', 'Device Display', 'Device Viewer', 'Device Frames'],
			],
			'tp_dynamic_listing' => [
			...
			'tp_everest_form' => [
				...
				'tag' => 'free',
				'labelIcon' => '<svg xmlns="http://www.w3.org/2000/svg" width="16.867" height="23" viewBox="0 0 512 512"><path d="M349.32 52.26C328.278 35.495 292.938 0 256 0c-36.665 0-71.446 34.769-93.31 52.26-34.586 27.455-109.525 87.898-145.097 117.015A47.99 47.99 0 0 0 0 206.416V464c0 26.51 21.49 48 48 48h416c26.51 0 48-21.49 48-48V206.413a47.989 47.989 0 0 0-17.597-37.144C458.832 140.157 383.906 79.715 349.32 52.26zM464 480H48c-8.837 0-16-7.163-16-16V206.161c0-4.806 2.155-9.353 5.878-12.392C64.16 172.315 159.658 95.526 182.59 77.32 200.211 63.27 232.317 32 256 32c23.686 0 55.789 31.27 73.41 45.32 22.932 18.207 118.436 95.008 144.714 116.468a15.99 15.99 0 0 1 5.876 12.39V464c0 8.837-7.163 16-16 16zm-8.753-216.312c4.189 5.156 3.393 12.732-1.776 16.905-22.827 18.426-55.135 44.236-104.156 83.148-21.045 16.8-56.871 52.518-93.318 52.258-36.58.264-72.826-35.908-93.318-52.263-49.015-38.908-81.321-64.716-104.149-83.143-5.169-4.173-5.966-11.749-1.776-16.905l5.047-6.212c4.169-5.131 11.704-5.925 16.848-1.772 22.763 18.376 55.014 44.143 103.938 82.978 16.85 13.437 50.201 45.69 73.413 45.315 23.219.371 56.562-31.877 73.413-45.315 48.929-38.839 81.178-64.605 103.938-82.978 5.145-4.153 12.679-3.359 16.848 1.772l5.048 6.212z"/></svg>',
				'keyword' => ['Everest Forms', 'contact form', 'form builder', 'form plugin', 'form creator', 'form designer', 'form element', 'form widget', 'form generator', 'form maker', 'form editor', 'form module', 'form addon', 'form extension'],
			],
			'tp_flip_box' => [
				...
				'keyword' => [ 'Flipbox', 'Flip Box', 'Flip-card', 'Card flip', 'Box flip', 'Elementor flipbox', 'Elementor flip box', 'Elementor flip-card', 'Elementor card flip', 'Elementor box flip' ],
			],
			'tp_gallery_listout' => [
			...
			'tp_gravity_form' => [
				...
				'tag' => 'free',
				'labelIcon' => '<svg xmlns="http://www.w3.org/2000/svg" width="16.867" height="23" viewBox="0 0 512 512"><path d="M349.32 52.26C328.278 35.495 292.938 0 256 0c-36.665 0-71.446 34.769-93.31 52.26-34.586 27.455-109.525 87.898-145.097 117.015A47.99 47.99 0 0 0 0 206.416V464c0 26.51 21.49 48 48 48h416c26.51 0 48-21.49 48-48V206.413a47.989 47.989 0 0 0-17.597-37.144C458.832 140.157 383.906 79.715 349.32 52.26zM464 480H48c-8.837 0-16-7.163-16-16V206.161c0-4.806 2.155-9.353 5.878-12.392C64.16 172.315 159.658 95.526 182.59 77.32 200.211 63.27 232.317 32 256 32c23.686 0 55.789 31.27 73.41 45.32 22.932 18.207 118.436 95.008 144.714 116.468a15.99 15.99 0 0 1 5.876 12.39V464c0 8.837-7.163 16-16 16zm-8.753-216.312c4.189 5.156 3.393 12.732-1.776 16.905-22.827 18.426-55.135 44.236-104.156 83.148-21.045 16.8-56.871 52.518-93.318 52.258-36.58.264-72.826-35.908-93.318-52.263-49.015-38.908-81.321-64.716-104.149-83.143-5.169-4.173-5.966-11.749-1.776-16.905l5.047-6.212c4.169-5.131 11.704-5.925 16.848-1.772 22.763 18.376 55.014 44.143 103.938 82.978 16.85 13.437 50.201 45.69 73.413 45.315 23.219.371 56.562-31.877 73.413-45.315 48.929-38.839 81.178-64.605 103.938-82.978 5.145-4.153 12.679-3.359 16.848 1.772l5.048 6.212z"/></svg>',
				'keyword' => ['Gravity Forms', 'Form Builder', 'Contact Form', 'WordPress Forms', 'Elementor Forms'],
			],
			'tp_heading_animation' => [
				...
				'keyword' => ['Animated Text', 'Text Animation', 'Animated Typography', 'Animated Heading', 'Animated Title', 'Animated Words'],
			],
			'tp_header_extras' => [
				...
				'keyword' => ['Header extras', 'Elementor header extras', 'Elementor addon', 'The Plus Addons for Elementor', 'Search bar', 'Search widget'],
			],
			'tp_heading_title' => [
				...
				'keyword' => ['Heading', 'Title', 'Heading Title', 'Heading Widget', 'Title Widget'],
			],
			'tp_hotspot' => [
				...
				'keyword' => [ 'Hotspot', 'Pin Point', 'Marker', 'Location', 'Pointer', 'Indicator', 'Map', 'Navigation', 'Interactive', 'Clickable', 'Tooltip', 'Information', 'Icon' ],
			],
			'tp_hovercard' => [
				...
				'keyword' => [ 'Hover card', 'Card hover', 'Card on hover', 'Elementor hover card', 'Elementor card hover', 'Elementor card on hover' ],
			],
			'tp_horizontal_scroll_advance' => [
				'label' => esc_html__('Horizontal Scroll','tpebl'),
				'demoUrl' => 'https://theplusaddons.com/widgets/horizontal-scrolling-elementor/',
				'docUrl' => 'https://docs.posimyth.com/tpae/horizontal-scroll/',
				'videoUrl' => '#',
				'tag' => 'pro',
			...
			'tp_wp_bodymovin' => [
				...
				'keyword' => [ 'Lottiefiles', 'Lottie animation', 'Lottie widget', 'Elementor Lottie', 'Lottie Elementor', 'Lottie animation Elementor', 'Lottie animation widget', 'Lottie animation plugin', 'Lottie animation addon', 'Lottie animation for Elementor', 'On Scroll', 'Scroll Animation', 'Animated Scroll', 'Animation Widget', 'JSON Animation' ],
			],
			'tp_mailchimp' => [
			...
			'tp_meeting_scheduler' => [
				...
				'keyword' => ['Meeting Scheduler','Schedule Meeting','Meeting Planner','Meeting Organizer','Meeting Arranger','Meeting Time Manager','Meeting Coordinator','Meeting Scheduling Tool','Meeting Booking', 'Meeting Calendar'],
			],
			'tp_messagebox' => [
			...
			'tp_ninja_form' => [
				...
				'tag' => 'free',
				'labelIcon' => '<svg xmlns="http://www.w3.org/2000/svg" width="16.867" height="23" viewBox="0 0 512 512"><path d="M349.32 52.26C328.278 35.495 292.938 0 256 0c-36.665 0-71.446 34.769-93.31 52.26-34.586 27.455-109.525 87.898-145.097 117.015A47.99 47.99 0 0 0 0 206.416V464c0 26.51 21.49 48 48 48h416c26.51 0 48-21.49 48-48V206.413a47.989 47.989 0 0 0-17.597-37.144C458.832 140.157 383.906 79.715 349.32 52.26zM464 480H48c-8.837 0-16-7.163-16-16V206.161c0-4.806 2.155-9.353 5.878-12.392C64.16 172.315 159.658 95.526 182.59 77.32 200.211 63.27 232.317 32 256 32c23.686 0 55.789 31.27 73.41 45.32 22.932 18.207 118.436 95.008 144.714 116.468a15.99 15.99 0 0 1 5.876 12.39V464c0 8.837-7.163 16-16 16zm-8.753-216.312c4.189 5.156 3.393 12.732-1.776 16.905-22.827 18.426-55.135 44.236-104.156 83.148-21.045 16.8-56.871 52.518-93.318 52.258-36.58.264-72.826-35.908-93.318-52.263-49.015-38.908-81.321-64.716-104.149-83.143-5.169-4.173-5.966-11.749-1.776-16.905l5.047-6.212c4.169-5.131 11.704-5.925 16.848-1.772 22.763 18.376 55.014 44.143 103.938 82.978 16.85 13.437 50.201 45.69 73.413 45.315 23.219.371 56.562-31.877 73.413-45.315 48.929-38.839 81.178-64.605 103.938-82.978 5.145-4.153 12.679-3.359 16.848 1.772l5.048 6.212z"/></svg>',
				'keyword' => ['Ninja Forms', 'form builder', 'form plugin', 'contact forms', 'form creator', 'form designer', 'form generator', 'form maker', 'form widget', 'form element', 'form addon', 'form extension'],
			],
			'tp_number_counter' => [
			...
			'tp_post_title' => [
				...
				'keyword' => [ 'Post Title', 'Title', 'Blog Title', 'Article Title', 'Page Title', 'Post Name', 'Article Name', 'Page Name'],
			],
			'tp_post_content' => [
				...
				'keyword' => ['Protected Content', 'Password Protected Content', 'Content Protection', 'Secure Content', 'Restricted Content'],
			],
			...
			'tp_post_meta' => [
				...
				'keyword' => [ 'Post Meta', 'Custom Fields', 'Post Data', 'Meta Data', 'Advanced Fields'],
			],
			'tp_post_author' => [
				...
				'keyword' => [ 'Post Author', 'Author', 'Author Box', 'Post Author Box', 'Author Details', 'Author Bio'],
			],
			'tp_post_comment' => [
				...
				'keyword' => [ 'Post Comment', 'Comment', 'Comment Box', 'Comment Section', 'Feedback', 'User Feedback', 'User Comment', 'Add Comment', 'Leave Comment', 'Submit Comment', 'Comment Form', 'Comment Widget', 'Comment Element', 'Elementor Comment', 'Elementor Comment Box', 'Elementor Comment Section', 'Elementor Feedback', 'Elementor User Feedback', 'Elementor User Comment', 'Elementor Add Comment', 'Elementor Leave Comment', 'Elementor Submit Comment', 'Elementor Comment Form'],
			],
			'tp_post_navigation' => [
			...
			'tp_page_scroll' => [
				...
				'keyword' => ['Page Piling', 'Page Scroll', 'Scrollable Pages', 'Vertical Scroll', 'Full Page Scroll', 'Scrollable Sections'],
			],
			'tp_pre_loader' => [
			...
			'tp_pricing_list' => [
				...
				'tag' => 'pro',
				'labelIcon' => '<svg xmlns="http://www.w3.org/2000/svg" width="16.867" height="23" viewBox="0 0 384 512"><path d="M369.9 97.9L286 14C277 5 264.8-.1 252.1-.1H48C21.5 0 0 21.5 0 48v416c0 26.5 21.5 48 48 48h288c26.5 0 48-21.5 48-48V131.9c0-12.7-5.1-25-14.1-34zm-22.6 22.7c2.1 2.1 3.5 4.6 4.2 7.4H256V32.5c2.8.7 5.3 2.1 7.4 4.2l83.9 83.9zM336 480H48c-8.8 0-16-7.2-16-16V48c0-8.8 7.2-16 16-16h176v104c0 13.3 10.7 24 24 24h104v304c0 8.8-7.2 16-16 16zm-48-244v8c0 6.6-5.4 12-12 12H108c-6.6 0-12-5.4-12-12v-8c0-6.6 5.4-12 12-12h168c6.6 0 12 5.4 12 12zm0 64v8c0 6.6-5.4 12-12 12H108c-6.6 0-12-5.4-12-12v-8c0-6.6 5.4-12 12-12h168c6.6 0 12 5.4 12 12zm0 64v8c0 6.6-5.4 12-12 12H108c-6.6 0-12-5.4-12-12v-8c0-6.6 5.4-12 12-12h168c6.6 0 12 5.4 12 12z"/></svg>',
				'keyword' => [ 'pricing list', 'price list', 'price table', 'pricing table', 'pricing widget', 'price widget', 'pricing element', 'price element', 'pricing addon', 'price addon', 'pricing module', 'price module' ],
			],
			'tp_pricing_table' => [
				...
				'keyword' => ['Pricing', 'Table', 'Pricing Table', 'Pricing Plan', 'Pricing Comparison', 'Pricing Options', 'Pricing Packages', 'Pricing Grid', 'Pricing Chart'],
			],
			'tp_product_listout' => [
			...
			'tp_progress_bar' => [
				...
				'keyword' => [ 'Pie Chart', 'Chart', 'Graph', 'Data Visualization', 'Circular Chart', 'Percentage Chart', 'Statistics Chart', 'Progress Bar', 'Progress Indicator', 'Progress Tracker', 'Progress Meter', 'Progress Graph', 'Progress Chart', 'Progress Status' ],
			],
			'tp_process_steps' => [
				...
				'keyword' => ['Process', 'Steps', 'Procedure', 'Method', 'Workflow', 'Sequence', 'Order', 'Stages', 'Phases', 'Actions', 'Tasks', 'Activities', 'Operation', 'Protocol', 'Technique', 'Approach', 'System', 'Plan', 'Strategy', 'Path', 'Route', 'Formula', 'Algorithm', 'Blueprint', 'Roadmap'],
			],
			'tp_row_background' => [
			...
			'tp_scroll_navigation' => [
				...
				'keyword' => ['Scroll Navigation', 'Scroll Menu', 'Sticky Navigation', 'Sticky Menu', 'Fixed Navigation', 'Fixed Menu', 'Anchor Menu', 'Anchor Navigation', 'Smooth Scroll', 'One Page Navigation'],
			],
			'tp_scroll_sequence' => [
			...
			'tp_smooth_scroll' => [
				...
				'keyword' => ['Smooth Scroll', 'Scroll Widget', 'Elementor Scroll', 'Scroll Animation', 'Smooth Scrolling', 'Scroll Effect', 'Elementor Smooth Scroll', 'Scroll Widget for Elementor', 'Scroll Animation for Elementor', 'Smooth Scrolling for Elementor', 'Elementor Scroll Effect'],
			],
			'tp_social_embed' => [
				...
				'keyword' => ['Social Embed', 'Social Media Embed', 'Embed Social Media', 'Social Media Widget', 'Social Media', 'Elementor Social Embed', 'Social Embed'],
			],
			'tp_social_feed' => [
			...
			'tp_style_list' => [
				...
				'tag' => 'freemium',
				'labelIcon' => '<svg xmlns="http://www.w3.org/2000/svg" width="16.867" height="23" viewBox="0 0 512 512"><path d="M464 64c8.823 0 16 7.178 16 16v352c0 8.822-7.177 16-16 16H48c-8.823 0-16-7.178-16-16V80c0-8.822 7.177-16 16-16h416m0-32H48C21.49 32 0 53.49 0 80v352c0 26.51 21.49 48 48 48h416c26.51 0 48-21.49 48-48V80c0-26.51-21.49-48-48-48zm-336 96c-17.673 0-32 14.327-32 32s14.327 32 32 32 32-14.327 32-32-14.327-32-32-32zm0 96c-17.673 0-32 14.327-32 32s14.327 32 32 32 32-14.327 32-32-14.327-32-32-32zm0 96c-17.673 0-32 14.327-32 32s14.327 32 32 32 32-14.327 32-32-14.327-32-32-32zm288-148v-24a6 6 0 0 0-6-6H198a6 6 0 0 0-6 6v24a6 6 0 0 0 6 6h212a6 6 0 0 0 6-6zm0 96v-24a6 6 0 0 0-6-6H198a6 6 0 0 0-6 6v24a6 6 0 0 0 6 6h212a6 6 0 0 0 6-6zm0 96v-24a6 6 0 0 0-6-6H198a6 6 0 0 0-6 6v24a6 6 0 0 0 6 6h212a6 6 0 0 0 6-6z"/></svg>',
				'keyword' => [ 'Stylist List', 'Stylist Widget', 'Stylist', 'Stylist Addon', 'Stylist Plus Addon', 'Stylist Plugin', 'Elementor Stylist', 'Elementor Stylist List', 'Elementor Stylist Widget', 'Elementor Stylist Addon', 'Elementor Stylist Plus Addon', 'Elementor Stylist Plugin' ],
			],
			'tp_switcher' => [
			...
			'tp_table' => [
				...
				'keyword' => [ 'Table', 'Data Table', 'Table Widget', 'Table', 'Table Addon', 'Table Plugin', 'Elementor Table', 'Elementor Data Table', 'Table Design', 'Table Layout' ],
			],
			'tp_table_content' => [
			...
			'tp_tabs_tours' => [
				...
				'keyword' => ['tabs', 'tours', 'Tabs widget', 'Tours widget', 'Elementor Tabs', 'Elementor Tours', ' Elementor Tabs widget', 'Elementor Tours widget', 'Tabs addon', 'Tours addon', 'Elementor Tabs addon', 'Elementor Tours addon'],
			],
			...
			'tp_timeline' => [
				...
				'keyword' => ['Time', 'Line', 'Timeline', 'Chronology', 'Events', 'History', 'Progress', 'Schedule', 'Chronological', 'Sequential'],
			],
			'tp_video_player' => [
				...
				'keyword' => [ 'video', 'media', 'player', 'multimedia', 'youtube', 'vimeo', 'mp4', 'embed', 'playback', 'watch', 'stream', 'online', 'clip', 'film', 'movie', 'visual', 'recording', 'motion picture' ],
			],
			'tp_unfold' => [
				...
				'keyword' => [ 'Unfold', 'Read More', 'Expand', 'Show More', 'Show Less', 'Toggle', 'Read More Button', 'Elementor Read More', 'Elementor Unfold' ],
			],
			'tp_wp_forms' => [
				...
				'tag' => 'free',
				'labelIcon' => '<svg xmlns="http://www.w3.org/2000/svg" width="16.867" height="23" viewBox="0 0 512 512"><path d="M349.32 52.26C328.278 35.495 292.938 0 256 0c-36.665 0-71.446 34.769-93.31 52.26-34.586 27.455-109.525 87.898-145.097 117.015A47.99 47.99 0 0 0 0 206.416V464c0 26.51 21.49 48 48 48h416c26.51 0 48-21.49 48-48V206.413a47.989 47.989 0 0 0-17.597-37.144C458.832 140.157 383.906 79.715 349.32 52.26zM464 480H48c-8.837 0-16-7.163-16-16V206.161c0-4.806 2.155-9.353 5.878-12.392C64.16 172.315 159.658 95.526 182.59 77.32 200.211 63.27 232.317 32 256 32c23.686 0 55.789 31.27 73.41 45.32 22.932 18.207 118.436 95.008 144.714 116.468a15.99 15.99 0 0 1 5.876 12.39V464c0 8.837-7.163 16-16 16zm-8.753-216.312c4.189 5.156 3.393 12.732-1.776 16.905-22.827 18.426-55.135 44.236-104.156 83.148-21.045 16.8-56.871 52.518-93.318 52.258-36.58.264-72.826-35.908-93.318-52.263-49.015-38.908-81.321-64.716-104.149-83.143-5.169-4.173-5.966-11.749-1.776-16.905l5.047-6.212c4.169-5.131 11.704-5.925 16.848-1.772 22.763 18.376 55.014 44.143 103.938 82.978 16.85 13.437 50.201 45.69 73.413 45.315 23.219.371 56.562-31.877 73.413-45.315 48.929-38.839 81.178-64.605 103.938-82.978 5.145-4.153 12.679-3.359 16.848 1.772l5.048 6.212z"/></svg>',
				'keyword' => ['WP Forms', 'WordPress Forms', 'Form Builder', 'Elementor Forms', 'Contact Forms', 'Custom Forms', 'Drag and Drop Forms', 'Form Creator', 'Form Designer', 'Form Generator', 'Form Maker', 'Form Plugin', 'Form Widget'],
			],
			'tp_woo_cart' => [
			...
			'tp_woo_compare' => [
                'label' => esc_html__('Woo Compare','tpebl'),
                'demoUrl' => '#',
                'docUrl' => '#',
                'videoUrl' => '',
                'tag' => 'pro',
                'labelIcon' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"><path fill="#000" fill-rule="evenodd" d="M12 2.667c.368 0 .667.298.667.666V6.88l5.224-.871a.667.667 0 0 1 .688.327l3.578 6.262.022.038c.136.238.24.418.314.614.065.173.113.352.142.534.032.207.032.414.032.689v.193a4.667 4.667 0 1 1-9.334 0v-.193c0-.275 0-.482.033-.689.028-.182.076-.361.142-.534.074-.196.177-.376.313-.614l.022-.038 2.882-5.043-4.603.767a.692.692 0 0 1-.023.004l-5.045.84 3.103 5.432.022.038c.136.238.24.418.314.614.065.173.113.352.142.534.032.207.032.414.032.689v.193a4.667 4.667 0 1 1-9.333 0v-.193c0-.275 0-.482.032-.689.028-.182.076-.361.142-.534.074-.196.177-.376.313-.614l.022-.038 3.578-6.262a.667.667 0 0 1 .47-.327l5.443-.907V3.333c0-.368.298-.666.666-.666Zm-9.333 13.85v.15a3.333 3.333 0 1 0 6.667 0V16.334H2.666v.182ZM8.85 15H3.15L6 10.01 8.851 15Zm9.15-6.99L15.148 13h5.702l-2.85-4.99Zm3.332 6.324h-6.666V14.666a3.333 3.333 0 1 0 6.667 0V14.335Z" clip-rule="evenodd"/></svg>',
                'keyword' => ['WooCommerce', 'compare', 'woocompare', 'woo compare'],
            ],
			'tp_woo_wishlist' => [
				'label' => esc_html__('Woo Wishlist','tpebl'),
				'demoUrl' => '#',
				'docUrl' => '#',
				'videoUrl' => '',
				'tag' => 'pro',
				'labelIcon' => '<svg xmlns="http://www.w3.org/2000/svg" width="16.867" height="23" viewBox="0 0 512 512"><path fill="currentColor" d="M0 190.9V185.1C0 115.2 50.52 55.58 119.4 44.1C164.1 36.51 211.4 51.37 244 84.02L256 96L267.1 84.02C300.6 51.37 347 36.51 392.6 44.1C461.5 55.58 512 115.2 512 185.1V190.9C512 232.4 494.8 272.1 464.4 300.4L283.7 469.1C276.2 476.1 266.3 480 256 480C245.7 480 235.8 476.1 228.3 469.1L47.59 300.4C17.23 272.1 .0003 232.4 .0003 190.9L0 190.9z"/></svg>',
				'keyword' => ['woocommerce','wishlist','woowishlist','woo wishlist'],
			],
			'tp_wp_quickview' => [
                'label' => esc_html__('WP Quick View','tpebl'),
                'demoUrl' => '#',
                'docUrl' => '#',
                'videoUrl' => '',
                'tag' => 'pro',
                'labelIcon' => '<svg xmlns="http://www.w3.org/2000/svg" width="16.867" height="23" viewBox="0 0 576 512"><path fill="currentColor" d="M279.6 160.4C282.4 160.1 285.2 160 288 160C341 160 384 202.1 384 256C384 309 341 352 288 352C234.1 352 192 309 192 256C192 253.2 192.1 250.4 192.4 247.6C201.7 252.1 212.5 256 224 256C259.3 256 288 227.3 288 192C288 180.5 284.1 169.7 279.6 160.4zM480.6 112.6C527.4 156 558.7 207.1 573.5 243.7C576.8 251.6 576.8 260.4 573.5 268.3C558.7 304 527.4 355.1 480.6 399.4C433.5 443.2 368.8 480 288 480C207.2 480 142.5 443.2 95.42 399.4C48.62 355.1 17.34 304 2.461 268.3C-.8205 260.4-.8205 251.6 2.461 243.7C17.34 207.1 48.62 156 95.42 112.6C142.5 68.84 207.2 32 288 32C368.8 32 433.5 68.84 480.6 112.6V112.6zM288 112C208.5 112 144 176.5 144 256C144 335.5 208.5 400 288 400C367.5 400 432 335.5 432 256C432 176.5 367.5 112 288 112z"/></svg>',
                'keyword' => ['woocommerce','view','quickview','quick view'],
            ],
			'tp_woo_multi_step' => [
				'label' => esc_html__('Woo Multi Step','tpebl'),
				'demoUrl' => '',
				'docUrl' => '#',
				'videoUrl' => '#',
				'tag' => 'pro',
				'labelIcon' => '<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path fill-rule="evenodd" clip-rule="evenodd" d="M8.78352 4.33333C8.78352 4.77088 8.40385 5.16667 7.88356 5.16667C7.43992 5.16667 7.09852 4.8789 7.00756 4.52285C7.00825 4.51532 7.00859 4.5077 7.00859 4.5C7.00859 4.4631 7.0006 4.42808 6.98625 4.39655C6.9845 4.3756 6.98361 4.35452 6.98361 4.33333C6.98361 3.89579 7.36328 3.5 7.88356 3.5C8.40385 3.5 8.78352 3.89579 8.78352 4.33333ZM6.4863 4.25C6.53147 3.55244 7.13978 3 7.88356 3C8.62735 3 9.23566 3.55244 9.28083 4.25H11.7482C11.847 3.60577 12.4296 3.11108 13.1334 3.11108C13.9066 3.11108 14.5333 3.70804 14.5333 4.44442C14.5333 5.1808 13.9066 5.77775 13.1334 5.77775C12.4706 5.77775 11.9154 5.3391 11.7704 4.75H9.21381C9.0301 5.28232 8.50396 5.66667 7.88356 5.66667C7.26317 5.66667 6.73703 5.28232 6.55332 4.75H4.1087C4.0707 4.75 4.03469 4.74152 4.00244 4.72636C3.8666 5.32733 3.30545 5.77775 2.63384 5.77775C1.86067 5.77775 1.23389 5.1808 1.23389 4.44442C1.23389 3.70804 1.86067 3.11108 2.63384 3.11108C3.34338 3.11108 3.92963 3.61382 4.02133 4.26569C4.04852 4.25555 4.07796 4.25 4.1087 4.25H6.4863ZM2.63384 5.27775C3.15413 5.27775 3.5338 4.88196 3.5338 4.44442C3.5338 4.00687 3.15413 3.61108 2.63384 3.61108C2.11356 3.61108 1.73389 4.00687 1.73389 4.44442C1.73389 4.88196 2.11356 5.27775 2.63384 5.27775ZM1 8.66673C1 8.42127 1.19898 8.22229 1.44444 8.22229H6.15537C6.40083 8.22229 6.59982 8.42127 6.59982 8.66673C6.59982 8.91219 6.40083 9.11118 6.15537 9.11118H1.44444C1.19898 9.11118 1 8.91219 1 8.66673ZM1.44444 10.0001C1.19898 10.0001 1 10.1991 1 10.4446C1 10.69 1.19898 10.889 1.44444 10.889H6.15537C6.40083 10.889 6.59982 10.69 6.59982 10.4446C6.59982 10.1991 6.40083 10.0001 6.15537 10.0001H1.44444ZM1 12.2223C1 11.9768 1.19898 11.7778 1.44444 11.7778H3.35556C3.60102 11.7778 3.8 11.9768 3.8 12.2223C3.8 12.4677 3.60102 12.6667 3.35556 12.6667H1.44444C1.19898 12.6667 1 12.4677 1 12.2223ZM13.1335 8.6157H13.1335H14.1112V12.0001H8.42258V8.6157H9.4003H9.40035L11.2085 8.6156H11.2086L13.1335 8.6157ZM13.1335 7.72681L11.2086 7.72671L9.4003 7.72681H7.97814C7.73268 7.72681 7.53369 7.92579 7.53369 8.17125V12.4445C7.53369 12.69 7.73268 12.8889 7.97814 12.8889H14.5557C14.8011 12.8889 15.0001 12.69 15.0001 12.4445V8.17125C15.0001 7.92579 14.8011 7.72681 14.5557 7.72681H13.1335Z" fill="black"/>
				</svg>',
				'keyword' => ['WooCommerce', 'checkout', 'woo checkout', 'multi step', 'multistep'],
			],
			'tp_woo_myaccount' => [
			...
			'tp_wp_login_register' => [
				...
				'keyword' => ['Login', 'Signup', 'User login', 'User signup', 'Login widget', 'Signup widget', 'User login widget', 'User signup widget'],
			]
		];
	}
    ...
    public function add_options_page() {
		...
		foreach ( $option_tabs as $index => $option_tab ) {
			if ( $index == 0 ) {
				$this->options_pages[] = add_menu_page( $this->title, $this->title, 'manage_options', $option_tab['id'], array( $this, 'admin_page_display' ), 'dashicons-plus-settings' );
		...
		if ( ! defined( 'THEPLUS_VERSION' ) ) {
			$this->options_pages[] = add_submenu_page( 'theplus_welcome_page', 'Theplus upgrade', 'Upgrade', 'manage_options', 'theplus-upgrade', 'tp_addons_upgrade_page' );
		}
	}

	/**
	 * Load Upgrade Text In Admin Menu and loadd hook add_submenu_page
	 *
	 * @since 5.3.3
	 * @access public
	 */
	public function tp_addons_upgrade_page() {}

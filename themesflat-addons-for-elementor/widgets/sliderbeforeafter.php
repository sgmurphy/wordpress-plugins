...
class SliderBeforeAfter extends \Elementor\Widget_Base {
  ...
  {
    return esc_html__('Slider Before After', 'sba-widgets');
  }
  ...
  {
    //return ['sba-move-script', 'sba-widgets-script', 'imagesloaded','tf-jquery_event_move','tf-sliderbeforeafter'];
  ...
  protected function register_controls()
  {
    $this->start_controls_section(
      'section_before',
      array(
        'label' => esc_html__('Before', 'sba-widgets'),
      )
    );
    ...
    $this->add_control(
      'before_src',
      array(
        'label' => esc_html__('Before Image Source', 'sba-widgets'),
        'type' => Controls_Manager::SELECT,
        'default' => 'media',
        'label_block' => true,
        'options' => array(
          'media' => esc_html__('Media', 'sba-widgets'),
          'url' => esc_html__('URL', 'sba-widgets'),
        ),
      )
    );
    ...
    $this->add_control(
      'before_image',
      array(
        'label' => esc_html__('Before Photo', 'sba-widgets'),
    ...
    $this->add_control(
      'before_img_url',
      array(
        'label' => esc_html__('Before Photo URL', 'sba-widgets'),
    ...
    $this->add_control(
      'before_text',
      array(
        'label' => esc_html__('Before Label', 'sba-widgets'),
        'type' => Controls_Manager::TEXT,
        'selector' => '{{WRAPPER}} .fel-infobox-title-prefix',
        'default' => esc_html__('Before', 'sba-widgets'),
        'dynamic' => array(
          'active' => true,
        ),
        'selectors' => array(
    ...
    $this->start_controls_section(
      'section_after',
      array(
        'label' => esc_html__('After', 'sba-widgets'),
      )
    );
    ...
    $this->add_control(
      'after_src',
      array(
        'label' => esc_html__('After Image Source', 'sba-widgets'),
        'type' => Controls_Manager::SELECT,
        'default' => 'media',
        'label_block' => true,
        'options' => array(
    ...
    $this->add_control(
      'after_image',
      array(
        'label' => esc_html__('After Photo', 'sba-widgets'),
        'type' => Controls_Manager::MEDIA,
        'default' => array(
          'url' => Utils::get_placeholder_image_src(),
        ),
    ...
    $this->add_control(
      'after_img_url',
      array(
        'label' => esc_html__('After Photo URL', 'sba-widgets'),
        'type' => Controls_Manager::TEXT,
        'label_block' => true,
        'separator' => 'before',
        'condition' => array(
    ...
    $this->add_control(
      'after_text',
      array(
        'label' => esc_html__('After Label', 'sba-widgets'),
        'type' => Controls_Manager::TEXT,
        'selector' => '{{WRAPPER}} .fel-infobox-title-prefix',
        'default' => esc_html__('After', 'sba-widgets'),
        'dynamic' => array(
          'active' => true,
        ),
        'selectors' => array(
    ...
    $this->start_controls_section(
      'section_style',
      array(
        'label' => esc_html__('Orientation', 'sba-widgets'),
    ...
    $this->add_control(
      'orientation',
      array(
        'label' => esc_html__('Slider Before After Orientation', 'sba-widgets'),
        'type' => Controls_Manager::CHOOSE,
        'options' => array(
          'vertical' => array(
            'title' => esc_html__('Vertical', 'sba-widgets'),
            'icon' => 'eicon-section',
          ),
          'horizontal' => array(
            'title' => esc_html__('Horizontal', 'sba-widgets'),
            'icon' => 'fa fa-columns',
          ),
        ),
        'default' => 'horizontal',
    ...
    $this->add_responsive_control(
      'alignment',
      array(
        'label' => esc_html__('Alignment', 'sba-widgets'),
        'type' => Controls_Manager::CHOOSE,
        'options' => array(
          '-right' => array(
            'title' => esc_html__('Left', 'sba-widgets'),
            'icon' => 'fa fa-align-left',
          ),
          ' ' => array(
            'title' => esc_html__('Center', 'sba-widgets'),
            'icon' => 'fa fa-align-center',
          ),
          '-left' => array(
            'title' => esc_html__('Right', 'sba-widgets'),
    ...
    $this->add_control(
      'move_on_hover',
      array(
        'label' => esc_html__('Move on Hover', 'sba-widgets'),
        'type' => Controls_Manager::SWITCHER,
        'default' => 'no',
        'return_value' => 'yes',
        'label_on' => esc_html__('Yes', 'sba-widgets'),
        'label_off' => esc_html__('No', 'sba-widgets'),
      )
    );
    ...
    $this->add_control(
      'overlay_color',
      array(
        'label' => esc_html__('Overlay Color', 'sba-widgets'),
    ...
    $this->start_controls_section(
      'section_handle',
      array(
        'label' => esc_html__('Comparison Handle', 'sba-widgets'),
        'tab' => Controls_Manager::TAB_LAYOUT,
      )
    );
    ...
    $this->add_control(
      'initial_offset',
      array(
        'label' => esc_html__('Handle Initial Offset', 'sba-widgets'),
        ...
        'label_block' => true,
        'options' => array(
          '0.0' => esc_html__('0.0', 'sba-widgets'),
          '0.1' => esc_html__('0.1', 'sba-widgets'),
          '0.2' => esc_html__('0.2', 'sba-widgets'),
          '0.3' => esc_html__('0.3', 'sba-widgets'),
          '0.4' => esc_html__('0.4', 'sba-widgets'),
          '0.5' => esc_html__('0.5', 'sba-widgets'),
          '0.6' => esc_html__('0.6', 'sba-widgets'),
          '0.7' => esc_html__('0.7', 'sba-widgets'),
          '0.8' => esc_html__('0.8', 'sba-widgets'),
          '0.9' => esc_html__('0.9', 'sba-widgets'),
        ),
      )
    );
    ...
    $this->add_control(
      'handle_color',
      array(
        'label' => esc_html__('Handle Color', 'sba-widgets'),
        'type' => Controls_Manager::COLOR,
        'default' => '#ffffff',
        'selectors' => array(
    ...
    $this->add_control(
      'thickness',
      array(
        'label' => esc_html__('Handle Thickness', 'sba-widgets'),
        'type' => Controls_Manager::SLIDER,
        'size_units' => array('px'),
        'default' => array(
          'size' => 5,
    ...
    $this->add_control(
      'circle_width',
      array(
        'label' => esc_html__('Circle Width', 'sba-widgets'),
        'type' => Controls_Manager::SLIDER,
        'size_units' => array('px'),
        'default' => array(
          'size' => 40,
    ...
    $this->add_control(
      'circle_radius',
      array(
        'label' => esc_html__('Circle Radius', 'sba-widgets'),
        'type' => Controls_Manager::SLIDER,
        'size_units' => array('%'),
        'default' => array(
          'size' => 100,
    ...
    $this->add_control(
      'triangle_size',
      array(
        'label' => esc_html__('Triangle Size', 'sba-widgets'),
        'type' => Controls_Manager::SLIDER,
        'size_units' => array('px'),
        'default' => array(
          'size' => 6,
    ...
    $this->start_controls_section(
      'style_section',
      array(
        'label' => esc_html__('Before/After Label', 'sba-widgets'),
    ...
    $this->add_control(
      'show_on',
      array(
        'label' => esc_html__('Show Label On', 'sba-widgets'),
        'type' => Controls_Manager::SELECT,
        'default' => 'hover',
        'label_block' => true,
        'options' => array(
          'hover' => esc_html__('Hover Only', 'sba-widgets'),
          'normal' => esc_html__('Normal Only', 'sba-widgets'),
          'both' => esc_html__('Hover & Normal', 'sba-widgets'),
        ),
    ...
    $this->add_control(
      'label_color',
      array(
        'label' => esc_html__('Color', 'sba-widgets'),
        'type' => Controls_Manager::COLOR,
        'default' => '',
        'selectors' => array(
    ...
    $this->add_control(
      'label_bg_color',
      array(
        'label' => esc_html__('Background Color', 'sba-widgets'),
        'type' => Controls_Manager::COLOR,
        'default' => '',
        'selectors' => array(
    ...
    $this->add_responsive_control(
      'label_padding',
      array(
        'label' => esc_html__('Padding', 'sba-widgets'),
    ...
    $this->add_responsive_control(
      ...
      array(
        ...
        'options' => array(
          'flex-start' => array(
            'title' => esc_html__('Top', 'sba-widgets'),
          ...
          'flex-end' => array(
            'title' => esc_html__('Bottom', 'sba-widgets'),

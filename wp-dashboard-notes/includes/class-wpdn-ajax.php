...
class WPDN_Ajax {
	...
	public function wpdn_update_note() {
		...
		if ( $curr_note_visibility != 'public' && get_current_user_id() != $note->post_author ) {
			die();
		}
	...
	public function wpdn_add_note() {
		...
		<div id='note_<?php echo $post_id; ?>' class='postbox'>
			<div class='postbox-header' title='Click to toggle'>
				<<?php echo $title_tag; ?> class="hndle">
					<span>
						<span contenteditable="true"
							  class="wpdn-title"><?php _e( 'New note', 'wp-dashboard-notes' ); ?></span>

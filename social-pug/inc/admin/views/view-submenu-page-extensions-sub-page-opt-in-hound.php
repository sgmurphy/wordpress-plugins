<div class="dpsp-page-wrapper dpsp-page-extensions dpsp-sub-page-opt-in-hound wrap">
	...
	<div id="opt-in-hound-promo-box">
		<div id="opt-in-hound-promo-box-banner">
			<img src="<?php echo esc_url( DPSP_PLUGIN_DIR_URL . '/assets/src/img/opt-in-hound-banner.png?' . DPSP_VERSION ); ?>" />
		</div>
		...
		<div id="opt-in-hound-promo-box-inner">
			...
			<div class="dpsp-row dpsp-big-padding">
				<div class="dpsp-col-1-3">
					<div class="browser-window">
						...
						<img src="<?php echo esc_url( DPSP_PLUGIN_DIR_URL . '/assets/src/img/tool-opt-in-icon-pop-up.png?' . DPSP_VERSION ); ?>" />
					</div>
				...
				<div class="dpsp-col-1-3">
					<div class="browser-window">
						<div class="browser-header"></div>
						<img src="<?php echo esc_url( DPSP_PLUGIN_DIR_URL . '/assets/src/img/tool-opt-in-icon-widget.png?' . DPSP_VERSION ); ?>" />
					</div>
				...
				<div class="dpsp-col-1-3">
					<div class="browser-window">
						<div class="browser-header"></div>
						<img src="<?php echo esc_url( DPSP_PLUGIN_DIR_URL . '/assets/src/img/tool-opt-in-icon-fly-in.png?' . DPSP_VERSION ); ?>" />
					</div>
			...
			<div class="dpsp-row dpsp-big-padding">
				<div class="dpsp-col-1-3">
					<div class="browser-window">
						<div class="browser-header"></div>
						<img src="<?php echo esc_url( DPSP_PLUGIN_DIR_URL . '/assets/src/img/tool-opt-in-icon-shortcode.png?' . DPSP_VERSION ); ?>" />
					</div>
				...
				<div class="dpsp-col-1-3">
					<div class="browser-window">
						<div class="browser-header"></div>
						<img src="<?php echo esc_url( DPSP_PLUGIN_DIR_URL . '/assets/src/img/tool-opt-in-icon-after-content.png?' . DPSP_VERSION ); ?>" />
					</div>

...
class Sassy_Social_Share_Follow_Widget extends WP_Widget { 
	...
	public function form( $instance ) { 
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'gettr' ); ?>"><?php _e( 'Gettr.com URL:', 'sassy-social-share' ); ?></label> 
			...
			<label for="<?php echo $this->get_field_id( 'koo' ); ?>"><?php _e( 'Koo URL:', 'sassy-social-share' ); ?></label> 
			<input style="width: 95%" class="widefat" id="<?php echo $this->get_field_id( 'koo' ); ?>" name="<?php echo $this->get_field_name( 'koo' ); ?>" type="text" value="<?php echo $instance['koo']; ?>" /><br/>
			...
			<label for="<?php echo $this->get_field_id( 'minds' ); ?>"><?php _e( 'Minds URL:', 'sassy-social-share' ); ?></label> 
			<input style="width: 95%" class="widefat" id="<?php echo $this->get_field_id( 'minds' ); ?>" name="<?php echo $this->get_field_name( 'minds' ); ?>" type="text" value="<?php echo $instance['minds']; ?>" /><br/>
			...
			<label for="<?php echo $this->get_field_id( 'truth_social' ); ?>"><?php _e( 'Truth Social URL:', 'sassy-social-share' ); ?></label>
 			<input style="width: 95%" class="widefat" id="<?php echo $this->get_field_id( 'truth_social' ); ?>" name="<?php echo $this->get_field_name( 'truth_social' ); ?>" type="text" value="<?php echo $instance['truth_social']; ?>" /><br/>

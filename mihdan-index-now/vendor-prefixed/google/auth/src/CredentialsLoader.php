...
use Mihdan\IndexNow\Dependencies\Google\Auth\Credentials\ExternalAccountCredentials;
use Mihdan\IndexNow\Dependencies\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials;
use Mihdan\IndexNow\Dependencies\Google\Auth\Credentials\InsecureCredentials;
...
abstract class CredentialsLoader implements GetUniverseDomainInterface, FetchAuthTokenInterface, UpdateMetadataInterface
{
    ...
    public static function makeHttpClient(FetchAuthTokenInterface $fetcher, array $httpClientOptions = [], callable $httpHandler = null, callable $tokenCallback = null)
    {
        ...
        return new \Mihdan\IndexNow\Dependencies\GuzzleHttp\Client(['handler' => $stack, 'auth' => 'google_auth'] + $httpClientOptions);
    }
    /**

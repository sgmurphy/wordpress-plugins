...
namespace Mihdan\IndexNow\Dependencies\Psr\Log\Test;
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('Mihdan\\IndexNow\\Dependencies\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('Mihdan\\IndexNow\\Dependencies\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('Mihdan\\IndexNow\\Dependencies\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }

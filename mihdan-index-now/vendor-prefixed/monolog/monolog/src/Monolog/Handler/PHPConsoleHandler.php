...
use Mihdan\IndexNow\Dependencies\PhpConsole\Connector;
use Mihdan\IndexNow\Dependencies\PhpConsole\Handler as VendorPhpConsoleHandler;
use Mihdan\IndexNow\Dependencies\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('Mihdan\\IndexNow\\Dependencies\\PhpConsole\\Connector')) {

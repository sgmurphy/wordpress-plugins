 ...
 */
namespace Mihdan\IndexNow\Dependencies\Monolog\Handler\FingersCrossed;
...
class ChannelLevelActivationStrategy implements ActivationStrategyInterface
{
    ...
    public function __construct($defaultActionLevel, array $channelToActionLevel = [])
    {
        ...
        $this->channelToActionLevel = \array_map('Mihdan\\IndexNow\\Dependencies\\Monolog\\Logger::toMonologLevel', $channelToActionLevel);
    }
    /**

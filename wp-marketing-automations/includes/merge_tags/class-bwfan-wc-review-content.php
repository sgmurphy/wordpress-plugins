...
class BWFAN_WC_Review_Content extends BWFAN_Merge_Tag {
	...
	public function parse_shortcode( $attr ) {
		...
		$comment_message = BWFAN_Merge_Tag_Loader::get_data( 'comment_message' );
...
if ( bwfan_is_woocommerce_active() ) {
	BWFAN_Merge_Tag_Loader::register( 'wc_review', 'BWFAN_WC_Review_Content', null, __( 'Review', 'wp-marketing-automations' ) );
}
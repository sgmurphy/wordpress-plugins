...
class BWFAN_Site_Link extends BWFAN_Merge_Tag {

	private static $instance = null;

	public function __construct() {
		$this->tag_name        = 'site_link';
		$this->tag_description = __( 'Site Link', 'wp-marketing-automations' );
 ...
 */
BWFAN_Merge_Tag_Loader::register( 'bwfan_default', 'BWFAN_Site_Link', null, 'General' );

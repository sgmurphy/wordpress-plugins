...
class BWFAN_WC_Product_Parent_Sku extends BWFAN_Merge_Tag {
	...
	public function parse_shortcode( $attr ) {
		...
		$parent_id = BWFAN_Woocommerce_Compatibility::get_parent_id( $product );
...
if ( bwfan_is_woocommerce_active() ) {
	BWFAN_Merge_Tag_Loader::register( 'wc_product', 'BWFAN_WC_Product_Parent_Sku', null, __( 'Product', 'wp-marketing-automations' ) );
}
...
class BWFAN_WC_Order_Shipping_Last_Name extends BWFAN_Merge_Tag {
	...
	public function parse_shortcode( $attr ) {
		...
		if ( empty( $shipping_last_name ) && true === apply_filters( 'bwfan_shipping_values_override_from_billing', true ) ) {
...
if ( bwfan_is_woocommerce_active() ) {
	BWFAN_Merge_Tag_Loader::register( 'wc_order', 'BWFAN_WC_Order_Shipping_Last_Name', null, __( 'Order', 'wp-marketing-automations' ) );
}

...
class BWFAN_WC_Item_Quantity extends BWFAN_Cart_Display {

	private static $instance = null;

	public function __construct() {
		$this->tag_name        = 'item_quantity';
		$this->tag_description = __( 'Purchased Item Quantity', 'wp-marketing-automations' );
		add_shortcode( 'bwfan_item_quantity', array( $this, 'parse_shortcode' ) );
	}

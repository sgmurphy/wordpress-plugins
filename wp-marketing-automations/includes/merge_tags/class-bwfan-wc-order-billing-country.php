...
/**
 * Class BWFAN_WC_Order_Billing_Country
 *
 * Merge tag outputs order billing country
 *
 * Since 2.0.6
 */
class BWFAN_WC_Order_Billing_Country extends BWFAN_Merge_Tag {

	private static $instance = null;

	public function __construct() {
		$this->tag_name        = 'order_billing_country';
		$this->tag_description = __( 'Order Billing Country', 'wp-marketing-automations' );
		add_shortcode( 'bwfan_order_billing_country', array( $this, 'parse_shortcode' ) );
	}
...
if ( bwfan_is_woocommerce_active() ) {
	BWFAN_Merge_Tag_Loader::register( 'wc_order', 'BWFAN_WC_Order_Billing_Country', null, __( 'Order', 'wp-marketing-automations' ) );
}

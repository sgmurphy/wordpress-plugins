...
class BWFAN_WC_Order_Summary extends Merge_Tag_Abstract_Product_Display {
	...
	public function __construct() {
		$this->tag_name        = 'order_summary';
		$this->tag_description = __( 'Order Summary', 'wp-marketing-automations' );
		add_shortcode( 'bwfan_order_summary', array( $this, 'parse_shortcode' ) );
...
if ( bwfan_is_woocommerce_active() ) {
	BWFAN_Merge_Tag_Loader::register( 'wc_order', 'BWFAN_WC_Order_Summary', null, __( 'Order', 'wp-marketing-automations' ) );
}

...
class BWFAN_WC_Cart_Shipping_Address2 extends Cart_Merge_Tag {
	...
	public function parse_shortcode( $attr ) {
		...
		$field_value = $this->get_cart_value( 'shipping_address_2', $cart_details );
...
if ( bwfan_is_woocommerce_active() ) {
	BWFAN_Merge_Tag_Loader::register( 'wc_ab_cart', 'BWFAN_WC_Cart_Shipping_Address2', null, __( 'Abandoned Cart', 'wp-marketing-automations' ) );
}
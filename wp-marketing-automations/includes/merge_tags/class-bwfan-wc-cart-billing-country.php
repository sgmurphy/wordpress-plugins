...
class BWFAN_WC_Cart_Billing_Country extends Cart_Merge_Tag {

	private static $instance = null;


	public function __construct() {
		$this->tag_name        = 'cart_billing_country';
		$this->tag_description = __( 'Cart Billing Country', 'wp-marketing-automations' );
		add_shortcode( 'bwfan_cart_billing_country', array( $this, 'parse_shortcode' ) );
		$this->priority = 7;
	}
	...
	public function parse_shortcode( $attr ) {
		...
		$field_value = $this->get_cart_value( 'billing_country', $cart_details );
...
if ( bwfan_is_woocommerce_active() ) {
	BWFAN_Merge_Tag_Loader::register( 'wc_ab_cart', 'BWFAN_WC_Cart_Billing_Country', null, __( 'Abandoned Cart', 'wp-marketing-automations' ) );
}
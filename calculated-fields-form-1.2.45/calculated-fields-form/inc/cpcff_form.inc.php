...
if ( ! class_exists( 'CPCFF_FORM' ) ) {
	...
	class CPCFF_FORM {
		...
		public static function sanitize_structure( $structure ) {
			...
			function sanitize_attributes ( $v, $i = '' ) {
				if ( is_array( $v ) ) {
					foreach ($v as $k => $v1) {
				...
				} else if( is_string( $v ) && ! in_array( $i, array( 'fcontent', 'eq', 'customstyles' ) ) ) {
		...
		public function save_settings( $params ) {
			...
			$updated_rows = $wpdb->update(
				...
				$data,
				array( 'id' => $this->_id ),
				array( '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s' ),
				array( '%d' )
			);

...
class Ithemes_Sync_Social {
	...
	public function metabox_assets( $hook ) {
		...
		wp_enqueue_script( 'ithemes-social-submitbox', plugins_url( 'js/social-metabox.js', __FILE__ ), array('jquery'), '3.0.0' );
		wp_enqueue_style(  'ithemes-social-submitbox', plugins_url( 'css/social-metabox.css', __FILE__ ), array(), '3.0.0' );
	}

...
class ActionSettingsIframe {
    ...
    function render_header() { ?>
        <section class="cnb-action-properties cnb-action-properties-IFRAME cnb-action-properties-TALLY cnb-action-properties-CHAT cnb-settings-section cnb-settings-section-iframe">
            <hr class="cnb-bottom-spacing" /> 
            <div class="cnb-flex cnb-flex-col-mob cnb-flex-gap">
                <div class="cnb-section-info">
                    <h3 class="top-0">Window settings</h3>
                    <p class="description">Fine-tune the presentation of the slide-in window.</p>
                </div>
    ...
    function render_iframe_options( $action ) {
        ...
        <div class="cnb-input-item cnb-action-properties cnb-action-properties-IFRAME cnb-action-properties-TALLY cnb-action-properties-CHAT">
            <label for="cnb-action-properties-iframe-title">Title</label>
            <input placeholder="Optional" id="cnb-action-properties-iframe-title"
    ...
    function render_modal_height( $action ) {
        ...
        ?>
            ...
            <div class="cnb-input-item cnb-action-properties cnb-action-properties-IFRAME cnb-action-properties-TALLY">
                <label for="cnb-action-properties-modal-height-value">Height</label>
                <input
                    type="hidden"
                ...
                <div id="cnb-action-properties-modal-height-slider">
                    <div class="cnb-flex cnb-flex-gap cnb-flex-align-center">
                        ...
                        <span class="cnb-action-properties-modal-height-result"><?php echo esc_attr( $action_properties_modal_height ) ?></span>
                        <select class="cnb-small-width" id="cnb-action-properties-modal-height-unit">
    ...
    function render_modal_width( $action ) {
        ...
        <div class="cnb-input-item cnb-action-properties cnb-action-properties-IFRAME cnb-action-properties-TALLY">
            <label for="cnb-action-properties-modal-width">Width</label>
    ...
    function render_modal_colors( $action ) {
        ...
        <div class="cnb-input-item cnb-action-properties cnb-action-properties-IFRAME cnb-action-properties-TALLY cnb-action-properties-CHAT cnb_advanced_view">
            <label for="cnb-action-properties-modal-background-color">Background color</label>
            <input
        ...
        <div class="cnb-input-item cnb-action-properties cnb-action-properties-IFRAME cnb-action-properties-TALLY cnb-action-properties-CHAT">
            <label for="cnb-action-properties-modal-header-background-color">Header color</label>
            <input
        ...
        <div class="cnb-input-item cnb-action-properties cnb-action-properties-IFRAME cnb-action-properties-TALLY cnb-action-properties-CHAT">
            <label for="cnb-action-properties-modal-header-text-color">Header text color</label>
            <input

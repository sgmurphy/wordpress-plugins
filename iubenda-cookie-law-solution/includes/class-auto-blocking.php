...
class Auto_Blocking {
    /**
     * @var array $auto_block_sites_status An array for storing autoblocking options.
     */
    public $auto_block_sites_status = array();

    /**
     * @var Iubenda_CS_Product_Service $cs_product_service An instance of the Iubenda_CS_Product_Service class.
     */
    ...
    public function __construct() {
	    ...
	    $this->auto_block_sites_status = iub_array_get( iubenda()->options, 'cs.frontend_auto_blocking', [] );
    ...
    public function get_site_id_from_cs_code( $script ) {
        ...
        if ( ! empty( $parsed_configuration ) && isset( $parsed_configuration['siteId'] ) ) {
            return $parsed_configuration['siteId'];
        }

        $parsed_configuration_by_regex = $this->cs_product_service->parse_configuration_by_regex( $script );
        if ( ! empty( $parsed_configuration_by_regex ) && isset( $parsed_configuration_by_regex['siteId'] ) ) {
            return $parsed_configuration_by_regex['siteId'];
        }
     ...
     *
     * @return bool The auto-blocking status for the provided code.
     */

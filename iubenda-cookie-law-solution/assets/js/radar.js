;(function (global, $) {
    $(document).ready(
        function ($) {
            ...
            function ajax() {
                if ((activeRequest) || (iubMainVars['radar_status'] === 'completed')) {
                    return;
                }
                activeRequest = true;
                $.ajax(
                    {
                        ...
                        data: {
                            ...
                            iub_nonce: iubMainVars['iub_radar_percentage_reload_nonce']
                        },
                        success: function (result) {
                            ...
                            let iub_nonce = iubMainVars['iub_frontpage_main_box_nonce'];
                            let target_div = $('#frontpage-main-box')


                            if ($('#iubenda-compliance-status').length) {
                                action = "dashboard_compliance";
                                iub_nonce = iubMainVars['iub_dashboard_compliance_nonce'];

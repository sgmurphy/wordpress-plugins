...
<div class="collapse wcfm-collapse">
  <div class="wcfm-page-headig">
		...
		<?php if( apply_filters( 'wcfm_is_pref_membership', true ) ) { ?>
			<span class="wcfm-page-heading-text"><?php esc_html_e( 'Membership Settings', 'wc-multivendor-membership' ); ?></span>
		<?php } else { ?>
				<span class="wcfm-page-heading-text"><?php esc_html_e( 'Registration Setting', 'wc-multivendor-membership' ); ?></span>
			<?php } ?>
	...
	<div class="wcfm-collapse-content">
	  ...
	  <div class="wcfm-container wcfm-top-element-container">
	    <?php if( apply_filters( 'wcfm_is_pref_membership', true ) ) { ?>
				<h2><?php esc_html_e('Membership General Options', 'wc-multivendor-membership' ); ?></h2>
				
				<?php
				echo '<a class="add_new_wcfm_ele_dashboard text_tip" href="'.esc_url(get_wcfm_memberships_url()).'" data-tip="' . esc_html(__('Memberships', 'wc-multivendor-membership')) . '"><span class="wcfmfa fa-user-plus"></span><span class="text">' . esc_html(__( 'Memberships', 'wc-multivendor-membership')) . '</span></a>';
				if( $has_new = apply_filters( 'wcfm_add_new_membership_sub_menu', true ) ) {
					echo '<a class="add_new_wcfm_ele_dashboard text_tip" href="'.esc_url(get_wcfm_memberships_manage_url()).'" data-tip="' . esc_html(__('Add New Membership', 'wc-multivendor-membership')) . '"><span class="wcfmfa fa-user-plus"></span></a>';
				}
				echo '<a class="add_new_wcfm_ele_dashboard text_tip" target="_blank" href="'.esc_url(get_wcfm_membership_url()).'" data-tip="' . esc_html(__('Membership Plan Table', 'wc-multivendor-membership')) . '"><span class="wcfmfa fa-eye"></span></a>';
				echo '<a class="add_new_wcfm_ele_dashboard wcfm_tutorials text_tip" target="_blank" href="https://www.youtube.com/embed/0l9RAgUpV2w" data-tip="' . esc_html(__('Tutorial', 'wc-multivendor-membership')) . '"><span class="wcfmfa fa-video"></span></a>';
				?>
			<?php } else { ?>
				<h2><?php esc_html_e('Registration Advanced Setting', 'wc-multivendor-membership' ); ?></h2>
			<?php } ?>
		...
		<form id="wcfm_membership_settings_form" class="wcfm">
			...
			<div class="wcfm-tabWrap">
				...
				<div class="page_collapsible" id="membership_settings_form_visibility_head">
					...
					<?php esc_html_e('General', 'wc-frontend-manager'); ?><span></span>
				</div>
				<div class="wcfm-container">
					<div id="membership_settings_form_visibility_expander" class="wcfm-content">
					<?php
					$pages_array = array('' => __('--Select page-- ','wc-multivendor-membership'));
					...
					?>
					  ...
					  <?php if( apply_filters( 'wcfm_is_pref_membership', true ) ) { ?>
							<h2><?php esc_html_e( 'Membership plan display visibility priority (Left to Right)', 'wc-multivendor-membership' ); ?></h2>
				...
				<?php if( apply_filters( 'wcfm_is_pref_membership', true ) ) { ?>
					...
					<div class="page_collapsible" id="membership_settings_features_head">
						...
						<?php esc_html_e('Features', 'wc-multivendor-membership'); ?>
					</div> 
					<div class="wcfm-container">
				...
				<div class="page_collapsible" id="membership_settings_form_custom_field_head">
					...
					<?php esc_html_e('Registration Fields', 'wc-multivendor-membership'); ?><span></span>
				</div>
				<div class="wcfm-container">
					<div id="wcfm_settings_form_custom_field_expander" class="wcfm-content">
					  <h2><?php esc_html_e( 'Registration Form Fields', 'wc-multivendor-membership' ); ?></h2>
					  <div class="wcfm_clearfix"></div>
						<?php
						$pages_array = array();
				...
				<?php if( apply_filters( 'wcfm_is_pref_membership', true ) ) { ?>
					...
					<div class="page_collapsible" id="membership_settings_form_payment_head">
						...
						<?php esc_html_e('Payment', 'wc-frontend-manager'); ?><span></span>
					</div>
					<div class="wcfm-container">
					...
					<div class="page_collapsible" id="membership_settings_form_payment_head">
						...
						<?php esc_html_e('Tax Setting', 'wc-multivendor-membership'); ?><span></span>
					</div>
					<div class="wcfm-container">
						<div id="membership_settings_form_payment_expander" class="wcfm-content">
							<?php
				...
				<div class="page_collapsible" id="membership_settings_form_thankyou_head">
					...
					<?php esc_html_e('Thank You', 'wc-multivendor-membership'); ?><span></span>
				</div>
				<div class="wcfm-container">
					<div id="membership_settings_form_thankyou_expander" class="wcfm-content">
					  <h2><?php esc_html_e('Thank You Page Content', 'wc-multivendor-membership'); ?></h2>
					  <div class="wcfm_clearfix"></div>
						<?php
						...
						<h2><?php esc_html_e('On Approval Thank You Page Content', 'wc-multivendor-membership'); ?></h2>
					  <div class="wcfm_clearfix"></div>
						<?php
				...
				<div class="page_collapsible" id="membership_settings_form_thankyou_head">
					...
					<?php esc_html_e('Welcome Email', 'wc-multivendor-membership'); ?><span></span>
				</div>
				<div class="wcfm-container">
					<div id="membership_settings_form_thankyou_expander" class="wcfm-content">
					  <h2><?php esc_html_e('Vendor Welcome Email', 'wc-multivendor-membership'); ?></h2>
					  <div class="wcfm_clearfix"></div>
						<?php
				...
				<div class="page_collapsible" id="membership_settings_form_admin_notication_head">
					...
					<?php esc_html_e('Admin Notification', 'wc-multivendor-membership'); ?><span></span>
				</div>
				<div class="wcfm-container">
					<div id="membership_settings_form_admin_notication_expander" class="wcfm-content">
					  <h2><?php esc_html_e('New Registration Notification', 'wc-multivendor-membership'); ?></h2>
					  <div class="wcfm_clearfix"></div>
						<?php
						...
						<?php if( apply_filters( 'wcfm_is_pref_membership', true ) ) { ?>
							...
							<h2><?php esc_html_e('New Subscription Notification', 'wc-multivendor-membership'); ?></h2>
							<div class="wcfm_clearfix"></div>
							<?php
						...
						<br /><div class="wcfm_clearfix"></div><br />
						<h2><?php esc_html_e('New Subscription Approval Notification', 'wc-multivendor-membership'); ?></h2>
					  <div class="wcfm_clearfix"></div>
						<?php
				...
				<?php if( apply_filters( 'wcfm_is_pref_membership', true ) ) { ?>
					...
					<div class="page_collapsible" id="membership_settings_form_switch_head">
						...
						<?php esc_html_e('Membership Change', 'wc-multivendor-membership'); ?><span></span>
					</div>
					<div class="wcfm-container">
						<div id="membership_settings_form_switch_expander" class="wcfm-content">
							<h2><?php esc_html_e('Admin Notification', 'wc-multivendor-membership'); ?></h2>
							<div class="wcfm_clearfix"></div>
							<?php
							...
							?>
							<br /><div class="wcfm_clearfix"></div><br />
							<h2><?php esc_html_e('Vendor Notification', 'wc-multivendor-membership'); ?></h2>
							<div class="wcfm_clearfix"></div>
							<?php
					...
					<div class="page_collapsible" id="membership_settings_form_next_payment_head">
						...
						<?php esc_html_e('Next Payment', 'wc-multivendor-membership'); ?><span></span>
					</div>
					<div class="wcfm-container">
						<div id="membership_settings_form_next_payment_expander" class="wcfm-content">
							<h2><?php esc_html_e('Recurring Next Payment Notification', 'wc-multivendor-membership'); ?></h2>
							<div class="wcfm_clearfix"></div>
							<?php
					...
					<div class="page_collapsible" id="membership_settings_form_reminder_head">
						...
						<?php esc_html_e('Renewal Notification', 'wc-multivendor-membership'); ?><span></span>
					</div>
					<div class="wcfm-container">
						<div id="membership_settings_form_reminder_expander" class="wcfm-content">
							<h2><?php esc_html_e('Subscription Renewal Notification', 'wc-multivendor-membership'); ?></h2>
							<div class="wcfm_clearfix"></div>
							<?php
					...
					<div class="page_collapsible" id="membership_settings_form_cancel_head">
						...
						<?php esc_html_e('Cancel Rules', 'wc-multivendor-membership'); ?><span></span>
					</div>
					<div class="wcfm-container">
						<div id="membership_settings_form_cancel_expander" class="wcfm-content">
							<h2><?php esc_html_e('Cancel Rules Setup', 'wc-multivendor-membership'); ?></h2>
					...
					<div class="page_collapsible" id="membership_settings_form_expire_head">
						...
						<?php esc_html_e('Expiry Rules', 'wc-multivendor-membership'); ?><span></span>
					</div>
					<div class="wcfm-container">
						<div id="membership_settings_form_expire_expander" class="wcfm-content">
							<h2><?php esc_html_e('Expiry Rules Setup', 'wc-multivendor-membership'); ?></h2>
							<div class="wcfm_clearfix"></div>
							<?php
			  ...
			  <?php } ?>
				...
				<div class="page_collapsible" id="membership_settings_form_rejection_head">
					...
					<?php esc_html_e('Rejection Rules', 'wc-multivendor-membership'); ?><span></span>
				</div>
				<div class="wcfm-container">
					<div id="membership_settings_form_cancel_expander" class="wcfm-content">
						<h2><?php esc_html_e('Application Rejection Notification', 'wc-multivendor-membership'); ?></h2>
						<div class="wcfm_clearfix"></div>
						<?php
				...
				<div class="page_collapsible" id="membership_settings_form_style_head">
					...
					<?php esc_html_e('Style', 'wc-frontend-manager'); ?><span></span>
				</div>
				<div class="wcfm-container">
					<div id="membership_settings_form_style_expander" class="wcfm-content">
						<h2><?php esc_html_e( 'Membership plan display page styling', 'wc-multivendor-membership' ); ?></h2>
						...
						?>
						<div class="wcfm_clearfix"></div>
						<input type="submit" name="reset-color-settings" value="<?php esc_html_e( 'Reset to Default', 'wc-frontend-manager' ); ?>" id="wcfmvm_color_setting_reset_button" class="wcfm_submit_button" />
						<div class="wcfm_clearfix"></div>
					</div>
				</div>
				<div class="wcfm_clearfix"></div>
			...
			<div id="wcfm_membership_setting_manager_submit" class="wcfm_form_simple_submit_wrapper">
			  <div class="wcfm-message" tabindex="-1"></div>
				...
				<input type="submit" name="membership_setting-manager-data" value="<?php esc_html_e( 'Submit', 'wc-frontend-manager' ); ?>" id="wcfm_membership_setting_submit_button" class="wcfm_submit_button" />
			</div>

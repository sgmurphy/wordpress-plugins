    ...
    minimumInputLength: 2 // the minimum of symbols to input before perform a search
       ...
       function saswp_fields_html_generator(index, schema_id, fields_type, div_type, schema_fields){
            ...
            jQuery.each(schema_fields, function(eachindex, element){
                ...
                if(element.name.indexOf('saswp_event_schema_schedule_st') > -1 || element.name.indexOf('saswp_event_schema_schedule_et') > -1 || element.name.indexOf('saswp_course_instance_start_time') > -1 || element.name.indexOf('saswp_course_instance_end_time') > -1 ){

...
if ( ! class_exists( 'TF_gallery' ) ) {
	class TF_gallery extends TF_Fields {
		...
		public function render() {
			...
			<a href="#" tf-field-name="' . esc_attr( $this->field_name() ) . '" class="tf-gallery-upload button button-primary button-large">' . esc_html( "Add Gallery","bafg" ) . '</a>';
			if(!empty($this->value)){
				echo '<a href="#" tf-field-name="' . esc_attr( $this->field_name() ) . '" class="tf-gallery-edit button button-primary button-large ' . esc_attr(str_replace(array("[","]","-")),"_",esc_attr( $this->field_name() ) ) . '">' . esc_html( "Edit Gallery","bafg" ) . '</a><a href="#" tf-field-name="' . esc_attr( $this->field_name() ) . '" class="tf-gallery-remove button button-warning button-large ' . esc_attr(str_replace(array("[","]","-")),"_",esc_attr( $this->field_name() ) ) . '" style="display:inline-block">' . esc_html( "Clear","bafg" ) . '</a>';
			}else{
				echo '<a href="#" tf-field-name="' . esc_attr( $this->field_name() ) . '" class="tf-gallery-edit button button-primary button-large ' . esc_attr(str_replace(array("[","]","-")),"_",esc_attr( $this->field_name() ) ) . '" style="display:none">' . esc_html( "Edit Gallery","bafg" ) . '</a><a href="#" tf-field-name="' . esc_attr( $this->field_name() ) . '" class="tf-gallery-remove button button-warning button-large ' . esc_attr(str_replace(array("[","]","-")),"_",esc_attr( $this->field_name() ) ) . '" style="display:none">' . esc_html( "Clear","bafg" ) . '</a>';
			}
			echo '</div>

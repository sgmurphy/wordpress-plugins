...
= 4.5.16 =
 * Add : Importing taxonomy metadata from Yoast plugin
 * Fix : Double meta desc issue when using Hello elementor theme

= 4.5.15 =
 * Fix : Lowercase page title issue

= 4.5.14 =
 * Fix : Security: XSS issue for meta title
 * Fix : Image meta: Support WebP, SVG file type

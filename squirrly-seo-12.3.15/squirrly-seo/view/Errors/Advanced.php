                    ...
                    <div id="sq_onboarding" class="col-6 my-0 mx-auto p-0">
                        ...
                        <div class="col-12 p-0 m-0 mt-5 mb-3 text-center">
                            <div class="group_autoload d-flex justify-content-center btn-group btn-group-lg mt-3" role="group" >
                                <div class="font-weight-bold" style="font-size: 1.2rem"><span class="sq_logo sq_logo_30 align-top mr-2"></span><?php echo esc_html__("Squirrly SEO - Advanced Pack", 'squirrly-seo'); ?></div>
                            </div>
                            <div class="text-center mt-4"><?php echo esc_html__("This amazing feature isn't included in the basic plugin. Want to unlock it? Simply install or activate the Squirrly SEO - Advanced Pack and enjoy the full range of capabilities.", 'squirrly-seo'); ?>:</div>

                        ...
                        <div class="col-12 p-0 m-0 my-5">
                            ...
                            <div class="col-12 row m-0 p-0 my-5">
                                <div class="col-4 m-0 p-0 font-weight-bold">
                                    <label for="indexnow_urls" ><?php echo esc_html__("URLs", "squirrly-seo"); ?>:</label>
                        ...
                        <?php if (!empty($log)){ ?>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                foreach ($log as $row) {
                                    ...
                                    ?>
                                    <tr>
                                        <td><?php echo esc_html($row['url']) ?> <em><?php echo (!esc_attr($row['manual']) ? '<i title="'.esc_attr__("Submited automatically", 'squirrly-seo').'" class="dashicons dashicons-cloud-saved m-1"></i>' : '') ?></em></td>
                                        <td><?php echo esc_html($row['status']) ?> <em>(<?php echo esc_html($row['message']) ?>)</em></td>

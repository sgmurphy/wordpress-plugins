        ...
        <div class="d-flex flex-row flex-nowrap flex-grow-1 bg-light m-0 p-0">
            <div class="flex-grow-1 sq_flex m-0 py-0 px-4 pb-4">
                ...
                <div class="col-12 p-0 m-0">
                    ...
                    <div class="sq_breadcrumbs my-4"><?php SQ_Classes_ObjController::getClass('SQ_Models_Menu')->showBreadcrumbs(SQ_Classes_Helpers_Tools::getValue('page')) ?><?php if (SQ_Classes_Helpers_Tools::getValue('sid')) { ?><i class="text-black-50 mx-1">/</i> <?php echo esc_html__("Focus Pages Details", 'squirrly-seo'); ?><?php }?></div>
                    <h3 class="mt-4">
                        ...
                        <?php do_action('sq_subscription_notices'); ?>
                            ...
                            if (!empty($keyword_labels)) {
                                foreach ($keyword_labels as $label) {
                                    ?>
                                    <label for="sq_circle_label_input"></label><input id="sq_circle_label_input" type="checkbox" class="sq_circle_label_input" value="<?php echo esc_attr($label) ?>" checked="checked" style="display: none"/><?php
                                }
                            }
                            ?>
	                        ...
	                        <?php do_action('sq_focuspages_after'); ?>
            ...
            <div class="sq_col_side bg-white">
                <div class="col-12 m-0 p-0 sq_sticky">
	                ...
	                <?php do_action('sq_focuspages_side_after'); ?>

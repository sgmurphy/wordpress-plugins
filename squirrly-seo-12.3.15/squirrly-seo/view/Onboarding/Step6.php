                ...
                <div class="col-12 p-0 m-0 mb-5">
                    ...
                    <div id="sq_onboarding" class="col-6 my-0 mx-auto p-0">
                        ...
                        <div class="col-12 m-0 p-0 my-5">
                            <iframe width="800" height="500" src="https://www.youtube.com/embed/3q2g4kx1jrA" title="YouTube video player" style="width: 100%; height: 500px;" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>

                        <div class="col-12 row m-0 p-0 my-5">
                            <div class="col m-0 p-0 text-center">
                                <a href="<?php echo esc_url(SQ_Classes_Helpers_Tools::getAdminUrl('/post-new.php?post_type=post&keyword='. SQ_Classes_Helpers_Tools::getValue('keyword', '')))?>"  class="btn btn-primary btn-lg m-0 p-0 py-2 px-4 rounded-0"><?php echo esc_html__("SEO Beginner: Start Here", 'squirrly-seo'); ?> > </a>
                            </div>
                            <div class="col m-0 p-0 text-center">
                                <a href="<?php echo esc_url(SQ_Classes_Helpers_Tools::getAdminUrl('sq_seosettings')) ?>"  class="btn btn-primary btn-lg m-0 p-0 py-2 px-4 rounded-0"><?php echo esc_html__("SEO Expert: Start Here", 'squirrly-seo'); ?> > </a>
                            </div>
                        </div>

                                ...
                                <?php if(SQ_Classes_Helpers_Tools::getOption('sq_auto_facebook') || SQ_Classes_Helpers_Tools::getOption('sq_auto_twitter')){ ?>
                                    ...
                                    <div class="col-12 row m-0 p-0 my-5">
                                        <div class="col-4 m-0 p-0 font-weight-bold">
                                            <label for="socials_twitter_site"><?php echo esc_html__("Twitter Profile URL", 'squirrly-seo'); ?>:</label>
                                    ...
                                    <div class="col-12 row m-0 p-0 my-5">
                                        <div class="col-4 m-0 p-0 font-weight-bold">
                                            <label for="socials_facebook_site"><?php echo esc_html__("Facebook Profile or Page URL", 'squirrly-seo'); ?>:</label>
                                    ...
                                    <div class="col-12 row m-0 p-0 my-5">
                                        <div class="col-4 m-0 p-0 font-weight-bold">
                                            <label for="socials_linkedin_url" ><?php echo esc_html__("LinkedIn Profile URL", 'squirrly-seo'); ?>:</label>
                                    ...
                                    <div class="col-12 row m-0 p-0 my-5">
                                        <div class="col-4 m-0 p-0 font-weight-bold">
                                            <label for="socials_pinterest_url"><?php echo esc_html__("Pinterest Profile URL", 'squirrly-seo'); ?>:</label>
                                    ...
                                    <div class="col-12 row m-0 p-0 my-5">
                                        <div class="col-4 m-0 p-0 font-weight-bold">
                                            <label for="socials_instagram_url"><?php echo esc_html__("Instagram Profile URL", 'squirrly-seo'); ?>:</label>
                                    ...
                                    <div class="col-12 row m-0 p-0 my-5">
                                        <div class="col-4 m-0 p-0 font-weight-bold">
                                            <label for="socials_youtube_url"><?php echo esc_html__("Youtube Channel URL", 'squirrly-seo'); ?>:</label>
                                    ...
                                    <?php if(SQ_Classes_Helpers_Tools::getOption('sq_jsonld_personal')){ ?>
                                        ...
                                        <div class="col-12 row m-0 p-0 my-5">
                                            <div class="col-4 m-0 p-0">
                                                <label for="sq_jsonld_type" class="font-weight-bold"><?php echo esc_html__("JSON-LD Type: ", 'squirrly-seo'); ?>:</label>

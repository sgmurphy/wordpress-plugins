        ...
        <div class="d-flex flex-row flex-nowrap flex-grow-1 bg-light m-0 p-0">
                ...
                <div class="col-12 p-0 m-0">
                    ...
                    <form method="POST">
                        ...
                        <div class="col-12 p-0 m-0 my-5">
                            ...
                            <div class="col-12 row m-0 p-0 my-5">
                                <div class="col-4 m-0 p-0 font-weight-bold">
                                    <label for="og_title_maxlength"><?php echo esc_html__("Open Graph Title Length", "squirrly-seo"); ?>:</label>
                                </div>
                                <div class="col-6 p-0 input-group input-group-sm">
                            ...
                            <div class="col-12 row m-0 p-0 my-5">
                                <div class="col-4 m-0 p-0 font-weight-bold">
                                    <label for="og_description_maxlength"><?php echo esc_html__("Open Graph Description Length", "squirrly-seo"); ?>:</label>
                                </div>
                                <div class="col-6 p-0 input-group input-group-sm">
                            ...
                            <div class="col-12 row m-0 p-0 my-5">
                                <div class="col-4 m-0 p-0 font-weight-bold">
                                    <label for="tw_title_maxlength"><?php echo esc_html__("Twitter Card Title Length", "squirrly-seo"); ?>:</label>
                                </div>
                                <div class="col-6 p-0 input-group input-group-sm">
                            ...
                            <div class="col-12 row m-0 p-0 my-5">
                                <div class="col-4 m-0 p-0 font-weight-bold">
                                    <label for="tw_description_maxlength"><?php echo esc_html__("Twitter Card Description Length", "squirrly-seo"); ?>:</label>
                                </div>
                                <div class="col-6 p-0 input-group input-group-sm">
                            ...
                            <div class="col-12 row m-0 p-0 my-5">
                                <div class="col-4 m-0 p-0 font-weight-bold">
                                    <label for="jsonld_title_maxlength"><?php echo esc_html__("JSON-LD Title Length", "squirrly-seo"); ?>:</label>
                                </div>
                            ...
                            <div class="col-12 row m-0 p-0 my-5">
                                <div class="col-4 m-0 p-0 font-weight-bold">
                                    <label for="jsonld_description_maxlength"><?php echo esc_html__("JSON-LD Description Length", "squirrly-seo"); ?>:</label>
                                </div>
                                <div class="col-6 m-0 p-0 input-group input-group-sm">
            ...
            <div class="sq_col_side bg-white">
                <div class="col-12 m-0 p-0 sq_sticky">
                    ...
                    <?php do_action('sq_automation_settings_side_after'); ?>

...
$wdan_plugin_info = array(
	...
	'load_factory_modules' => array(
		...
		array( 'libs/factory/freemius', 'factory_freemius_165', 'all' ),
		array( 'libs/factory/adverts', 'factory_adverts_153', 'admin' ),
		//array('libs/factory/logger', 'factory_logger_142', 'all')
	)
);

$wdan_compatibility = new Wbcr_Factory475_Requirements( __FILE__, array_merge( $wdan_plugin_info, array(

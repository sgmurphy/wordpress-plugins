				...
				success: function(response) {
					...
					if( !response || !response.success ) {
						if( response.data.error_message ) {
							$.wbcr_factory_templates_128.app.showNotice('Error: [' + response.data.error_message + ']', 'danger');
						}
						return false;
					}

					/*var noticeId = $.wbcr_factory_templates_128.app.showNotice('Settings successfully updated', 'success');

...
if ( ! defined( "AWR_PLUGIN_IMG_URL" ) ) {
	define( "AWR_PLUGIN_IMG_URL", AWR_PLUGIN_ABSOLUTE_URL . '/assets/img' );
}

if ( ! defined( "AWR_PLUGIN_CSS_URL" ) ) {
	define( "AWR_PLUGIN_CSS_URL", AWR_PLUGIN_ABSOLUTE_URL . '/assets/css' );
}

if ( ! defined( "AWR_PLUGIN_JS_URL" ) ) {
	define( "AWR_PLUGIN_JS_URL", AWR_PLUGIN_ABSOLUTE_URL . '/assets/js' );
}
...
define ('AWR_PLUGIN_FAQ' , "https://wordpress.org/plugins/advanced-wp-reset");
define ('AWR_YOUTUBE_CHANNEL' , "https://www.youtube.com/@AWPRESET-mh1rl");

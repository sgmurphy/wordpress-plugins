jQuery(document).ready(function(){
	...
	// Venobox - video popup
	new VenoBox({
		selector: '.video-popup-btn',
	});
	
	// Video alert close
	if (jQuery(".awpr-video-alert-close-btn").length) {
		jQuery(".awpr-video-alert-close-btn").click(function() {
			jQuery(this).closest(".awpr-video-alert").fadeOut("fast");
		});
	}

	jQuery(".awr-hide-video").on("click", function (){

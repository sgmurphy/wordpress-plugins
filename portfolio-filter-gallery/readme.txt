...
= 1.6.0 =
* Bootstrap lightbox updated to version 5.

= 1.5.8 =
* Security logic changed.

= 1.5.7 =
* Cross Site Scripting (XSS) issue fixed! 
* Increased limit of categories.

= 1.5.6 =
* Added feature to show image count with filter/category
* Tested with WordPress version 6.4.3


= 1.5.5 =
* Tasted with WordPress version 6.4

= 1.5.4 =
* Added Shuffle button for backend images.

= 1.5.3 =
* Filter page array error fixed.

= 1.5.2 =
* Tasted with WordPress version 6.3.1

= 1.5.1 =
* Tasted with WordPress version 6.2.2

= 1.5.0 =
* Tasted with WordPress version 6.2

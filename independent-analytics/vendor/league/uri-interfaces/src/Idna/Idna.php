...
final class Idna
{
    ...
    public static function toAscii(string $domain, int $options) : IdnaInfo
    {
        ...
        if (1 === \preg_match(self::REGEXP_IDNA_PATTERN, $domain)) {
            ...
            if ([] === $idnaInfo) {
                return IdnaInfo::fromIntl(['result' => \strtolower($domain), 'isTransitionalDifferent' => \false, 'errors' => self::validateDomainAndLabelLength($domain)]);
            }
        ...
        return IdnaInfo::fromIntl(['result' => \strtolower($domain), 'isTransitionalDifferent' => \false, 'errors' => self::validateDomainAndLabelLength($domain) | $error]);
    }
    /**

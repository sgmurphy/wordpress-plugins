...
class Migrations
{
    ...
    public static function is_migrating() : bool
    {
        ...
        $is_current = \version_compare($db_version, '33', '=');
    ...
    {
        $db_version = \get_option('iawp_db_version', '0');
        return \version_compare($db_version, '33', '>');
    }

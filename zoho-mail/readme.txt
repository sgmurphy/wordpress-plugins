...
= 1.5.1 =
* bug fix for configuration settings UI issue.a
= 1.5.2 =
* Enhanced the settings flow.
= 1.5.3 =
* bug fix for issue in large file upload.
= 1.5.4 =
* Tested upto Wordpress 6.4 and bug fix.
= 1.5.5 =
* Enhanced configuration settings UI.
= 1.5.6 =
* CA and SA DC support and warning bug fix.
= 1.5.7 =
* bug fix on reply-to issue.
= 1.5.8 =
* domain issue fixed

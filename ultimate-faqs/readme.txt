...
= 2.2.13 (2024-05-17) =
- Fixed issue with FAQ Elements Order setting not saving correctly.

= 2.2.12 (2024-04-03) =
- Added role attribute to toggle links for accessibility.
- Added alt tag to thumbs up and down images. 

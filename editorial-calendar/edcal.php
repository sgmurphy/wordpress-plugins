...
?>
        ...
        <script type="text/javascript">
            jQuery(document).ready(function() {
                ...
                edcal.str_showdrafts = <?php echo ($this->edcal_json_encode(__('Show Unscheduled Drafts', 'editorial-calendar'))) ?>;
                edcal.str_hidedrafts = <?php echo ($this->edcal_json_encode(__('Hide Unscheduled Drafts', 'editorial-calendar'))) ?>;
        ...
        <style type="text/css">
            .loadingclass>.postlink,
            .loadingclass:hover>.postlink,
            .tiploading {
        ...
        <div class="wrap">
            ...
            <div id="draftsdrawer_cont">
                <div id="draftsdrawer">
                    <div class="draftsdrawerheadcont" title="<?php echo (__('Unscheduled draft posts', 'editorial-calendar')) ?>">
                        <div class="dayhead"><?php echo (__('Unscheduled', 'editorial-calendar')) ?></div>
                    </div>
    ...
    */ ?>
                ...
                <input type="hidden" id="edcal-hash" name="hash" value="" />
        ...
        <?php
            ...
            */
            function edcal_newdraft()
            {
                ...
                $my_post = array();
                $my_post['post_title'] = isset($_POST["title"]) ? sanitize_text_field(wp_strip_all_tags($_POST["title"])) : null;
                $my_post['post_content'] = isset($_POST["content"]) ? wp_kses($_POST["content"], $allowed_tags) : null;
            ...
            */
            function edcal_savepost()
            {
                ...
                if ($_POST['id'] && intval($_POST['id']) > 0) {
                    ...
                    if (!$this->edcal_userCanEditPost($my_post['ID'], $_POST["hash"])) {
                ...
                $my_post['post_title'] = isset($_POST["title"]) ? sanitize_text_field(wp_strip_all_tags($_POST["title"])) : null;
                $my_post['post_content'] = isset($_POST["content"]) ? wp_kses($_POST["content"], $allowed_tags) : null; //wp_kses_post($_POST["content"]) : null;
        ...
        ?>
            ...
            function editorial_cleanup_field($field, $number = false)
            {
                return preg_replace('/[^A-Za-z0-9\-]/', '', sanitize_text_field($field));
            }
            ...
            */
            function edcal_saveoptions()
            {
                ...
                */
                $edcal_weeks = isset($_GET['weeks']) ? $this->editorial_cleanup_field($_GET['weeks']) : null;
                if ($edcal_weeks != null) {
                ...
                */
                $edcal_author = isset($_GET['author-hide']) ? $this->editorial_cleanup_field($_GET['author-hide']) : null;
                ...
                */
                $edcal_status = isset($_GET['status-hide']) ? $this->editorial_cleanup_field($_GET['status-hide']) : null;
                ...
                */
                $edcal_time = isset($_GET['time-hide']) ? $this->editorial_cleanup_field($_GET['time-hide']) : null;
                if ($edcal_time != null) {
                ...
                */
                $edcal_wheel = isset($_GET['wheel-support']) ? $this->editorial_cleanup_field($_GET['wheel-support']) : null;
                if ($edcal_wheel != null) {
                ...
                */
                $edcal_feedback = isset($_GET['dofeedback']) ? $this->editorial_cleanup_field($_GET['dofeedback']) : null;
    ...
    <?php
            ...
            */
            ...
            /*
            * This function ensure that the current user can edit the post
            */
            function edcal_userCanEditPost($post_id, $hash)
            {
                if (current_user_can('edit_post', $post_id)) {
                    if ($hash === hash('md5', strval($post_id)))
                        return true;
                }
                return false;
            }

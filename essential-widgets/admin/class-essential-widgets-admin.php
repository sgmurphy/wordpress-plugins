...
class Essential_Widgets_Admin {
	...
	public function ew_switch() {
		if ( ! wp_verify_nonce( $_POST['security'], 'ew_nonce' ) ) {
	...
	function add_plugin_meta_links( $meta_fields, $file ) {
		if ( ESSENTIAL_WIDGETS_BASENAME == $file ) {
			$meta_fields[] = "<a href='https://catchplugins.com/support-forum/forum/essential-widgets-free-wordpress-plugin/' target='_blank'>Support Forum</a>";
			$meta_fields[] = "<a href='https://wordpress.org/support/plugin/essential-widgets/reviews/#new-post' target='_blank' title='Rate'>

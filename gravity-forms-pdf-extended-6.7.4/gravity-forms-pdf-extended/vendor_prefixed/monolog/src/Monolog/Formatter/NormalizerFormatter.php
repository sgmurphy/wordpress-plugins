 ...
 */
class NormalizerFormatter implements \GFPDF_Vendor\Monolog\Formatter\FormatterInterface
{
    ...
    /** @var int */
    private $jsonEncodeOptions = \GFPDF_Vendor\Monolog\Utils::DEFAULT_JSON_FLAGS;
    /**
    ...
    protected function normalizeException(\Throwable $e, int $depth = 0)
    {
        ...
        $data = ['class' => \GFPDF_Vendor\Monolog\Utils::getClass($e), 'message' => $e->getMessage(), 'code' => (int) $e->getCode(), 'file' => $e->getFile() . ':' . $e->getLine()];
    ...
    protected function formatDate(\DateTimeInterface $date)
    {
        ...
        if ($this->dateFormat === self::SIMPLE_DATE && $date instanceof \GFPDF_Vendor\Monolog\DateTimeImmutable) {
            return (string) $date;
        }

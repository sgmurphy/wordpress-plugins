...
abstract class InlineTag extends \GFPDF_Vendor\Mpdf\Tag\Tag
{
    public function open($attr, &$ahtml, &$ihtml)
    {
        ...
        if ($this->mpdf->title2annots && isset($attr['TITLE'])) {
            ...
            $annot = \GFPDF_Vendor\Mpdf\Mpdf::OBJECT_IDENTIFIER . "type=annot,objattr=" . \serialize($objattr) . \GFPDF_Vendor\Mpdf\Mpdf::OBJECT_IDENTIFIER;
        }
        /* -- END ANNOTATIONS -- */

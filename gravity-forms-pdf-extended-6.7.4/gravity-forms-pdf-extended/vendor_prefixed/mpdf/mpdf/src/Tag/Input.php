...
class Input extends \GFPDF_Vendor\Mpdf\Tag\Tag
{
    public function open($attr, &$ahtml, &$ihtml)
    {
        ...
        if (isset($attr['DISABLED'])) {
            $objattr['disabled'] = \true;
        }
        if (isset($attr['READONLY'])) {
            $objattr['readonly'] = \true;
        }
        ...
        $objattr['title'] = \GFPDF_Vendor\Mpdf\Utils\UtfString::strcode2utf($objattr['title']);
        ...
        if (isset($attr['VALUE'])) {
            $attr['VALUE'] = \GFPDF_Vendor\Mpdf\Utils\UtfString::strcode2utf($attr['VALUE']);
        ...
        switch (\strtoupper($attr['TYPE'])) {
            case 'HIDDEN':
                ...
                if ($this->mpdf->useActiveForms) {
                    $this->form->SetFormText(0, 0, $objattr['fieldname'], $objattr['value'], $objattr['value'], '', 0, '', \true);
                }
        ...
        $e = \GFPDF_Vendor\Mpdf\Mpdf::OBJECT_IDENTIFIER . "type=input,objattr=" . \serialize($objattr) . \GFPDF_Vendor\Mpdf\Mpdf::OBJECT_IDENTIFIER;
        /* -- TABLES -- */

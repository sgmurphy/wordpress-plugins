...
class Select extends \GFPDF_Vendor\Mpdf\Tag\Tag
{
    ...
    public function close(&$ahtml, &$ihtml)
    {
        ...
        if ($this->mpdf->useActiveForms) {
            ...
            $w = $this->mpdf->GetStringWidth($texto, \true, $OTLdata);
        }
        if ($w == 0) {
            $w = 5;
        }
        ...
        $e = \GFPDF_Vendor\Mpdf\Mpdf::OBJECT_IDENTIFIER . "type=select,objattr=" . \serialize($objattr) . \GFPDF_Vendor\Mpdf\Mpdf::OBJECT_IDENTIFIER;

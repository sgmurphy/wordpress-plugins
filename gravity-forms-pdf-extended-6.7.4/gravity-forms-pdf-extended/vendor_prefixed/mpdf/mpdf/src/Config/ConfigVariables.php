...
namespace GFPDF_Vendor\Mpdf\Config;

use GFPDF_Vendor\Mpdf\Css\DefaultCss;
use GFPDF_Vendor\Mpdf\Language\LanguageToFont;
...
class ConfigVariables
{
    ...
    public function __construct()
    {
        $this->defaults = [
            ...
            'baseScript' => \GFPDF_Vendor\Mpdf\Ucdn::SCRIPT_LATIN,
            'autoVietnamese' => \true,
            'autoArabic' => \true,
            ...
            'allow_html_optional_endtags' => \true,
            ...
            'incrementFPR1' => 10,
            // i.e. will alter by 1/[10]th of width and try again until within closer limits
            'incrementFPR2' => 20,
            'incrementFPR3' => 30,
            'incrementFPR4' => 50,
            // i.e. will alter by 1/[50]th of width and try again when it nearly fits
            // COLORSPACE
            ...
            'title2annots' => \false,
            // Automatically convert title="" properties in tags, to annotations
            'annotSize' => 0.5,
            // default mm for Adobe annotations - nominal
            'annotMargin' => null,
            ...
            */
            ...
            // '', or 'B' or 'I' or 'BI'
            'defaultheaderline' => 1,
            // 1 or 0 - line under the header
            'defaultfooterfontsize' => 8,
            // pt
            'defaultfooterfontstyle' => 'BI',
            // '', or 'B' or 'I' or 'BI'
            'defaultfooterline' => 1,
            // 1 or 0 - line over the footer
            ...
            'defaultCSS' => \GFPDF_Vendor\Mpdf\Css\DefaultCss::$definition,
            'defaultCssFile' => __DIR__ . '/../../data/mpdf.css',
            'customProperties' => [],
            'languageToFont' => new \GFPDF_Vendor\Mpdf\Language\LanguageToFont(),
            'scriptToLanguage' => new \GFPDF_Vendor\Mpdf\Language\ScriptToLanguage(),
            //////////////////////////////////////////////////
            ...
            'default_lineheight_correction' => 1.2,
            // Value 1 sets lineheight=fontsize height,
            ...
            'pregRTLchars' => "\\x{0590}-\\x{06FF}\\x{0700}-\\x{085F}\\x{FB00}-\\x{FDFD}\\x{FE70}-\\x{FEFF}",
            // 085F to include Mandaic

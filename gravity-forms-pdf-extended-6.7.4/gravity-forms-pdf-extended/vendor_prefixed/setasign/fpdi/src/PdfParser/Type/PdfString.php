 ...
 */
class PdfString extends \GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfType
{
    /**
     ...
     * @return self
     */
    public static function parse(\GFPDF_Vendor\setasign\Fpdi\PdfParser\StreamReader $streamReader)
    {
    ...
    {
        return \GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfType::ensureType(self::class, $string, 'String value expected.');
    }
    /**

 ...
 */
class PdfHexString extends \GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfType
{
    /**
    ...
    {
        return \GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfType::ensureType(self::class, $hexString, 'Hex string value expected.');
    }
}

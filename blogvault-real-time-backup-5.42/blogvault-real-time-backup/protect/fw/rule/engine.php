...
if (!class_exists('BVProtectFWRuleEngine_V542')) :
require_once dirname( __FILE__ ) . '/functions.php';

class BVProtectFWRuleEngine_V542 {
	use BVProtectFWRuleStringFunc_V542;
	use BVProtectFWRuleArrayFunc_V542;
	use BVProtectFWRuleMiscFunc_V542;
	use BVProtectFWRuleRequestFunc_V542;
	use BVProtectFWRuleWPFunc_V542;
	...
	const CONST_NAME_PREFIX = 'BVProtectFWRule_V542::';
	...
	public function evaluate($rule) {
		...
		} catch (BVProtectRuleError_V542 $e) {
			$this->error = $e;
		}
	}

...
if ( ! function_exists( 'gutenverse_get_settings' ) ) {
	/**
	 * Get theme settings
	 *
	 * @param string|null $type Param key.
	 *
	 * @return array
	 */
	function gutenverse_get_settings( $type = null ) {
		return Gutenverse::instance()->settings->get_settings( $type );
	}
}

 ...
 * @package gutenverse\block
 */
class Social_Share_Telegram extends Block_Abstract {
	/**
	 * $attributes, $content
	 *
	 * @return string
	...
	public function render_gutenberg() {
		...
		return "<div class='gutenverse-share-telegram gutenverse-share-item' id='{$this->get_element_id()}'>
			<a href='#'>
				{$content}
			</a>
		</div>";
	...
	public function render_frontend() {
		...
		$share_url        = esc_url( 'https://telegram.me/share/url?url=' . $encoded_post_url . '&text=' . $title );
		$content          = $this->render_content();

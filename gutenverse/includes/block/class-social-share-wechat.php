...
class Social_Share_Wechat extends Block_Abstract {
	...
	public function render_gutenberg() {
		...
		return "<div class='gutenverse-share-wechat gutenverse-share-item' id='{$this->get_element_id()}'>
			<a href='#'>
				{$content}
			</a>
		</div>";
	...
	public function render_frontend() {
		...
		$share_url        = esc_url( 'https://chart.googleapis.com/chart?chs=400x400&cht=qr&choe=UTF-8&chl=' . $encoded_post_url );
		$content          = $this->render_content();

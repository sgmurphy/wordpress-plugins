...
function fb_plugin_shortcode($atts) {
	...
	$atts = shortcode_atts(array('fb_url' => 'http://facebook.com/WordPress', 'width' => '400', 'height' => '500', 'data_small_header' => 'false', 'data_small_header' => 'false', 'data_adapt_container_width' => 'true', 'data_hide_cover' => 'false', 'data_show_facepile' => 'true', 'custom_css' => '', 'data_tabs' => 'timeline', 'data_lazy'=> 'false'), $atts, 'fb_widget');

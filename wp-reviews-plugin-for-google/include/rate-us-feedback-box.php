...
<div class="ti-box-header"><?php echo esc_html(__("How's experience with Trustindex?", 'trustindex-plugin')); ?></div>
<p><?php echo esc_html(__('Rate us by clicking on the stars', 'trustindex-plugin')); ?></p>

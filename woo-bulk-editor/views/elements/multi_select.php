...
<div class="woobe_multi_select_cell">
    ...
    <div class="woobe_multi_select_cell_dropdown" style="display: none;">
        ...
        <div class="taxonomy_cell_edit">
            <div>
                <a href="#" class="page-title-action woobe_multi_select_cell_select button button-small"><?php esc_html_e('Select all', 'woo-bulk-editor') ?></a>
            </div>
            <div>
                <a href="#" class="page-title-action woobe_multi_select_cell_deselect button button-small"><?php esc_html_e('Deselect all', 'woo-bulk-editor') ?></a>
            </div>

...
<div class="woobe_top_panel_container">
    ...
    <div class="woobe_top_panel">
        <div class="woobe_top_panel_wrapper">
            ...
            <a href="#" class="button button-large button-primary woobe_top_panel_btn2" title="<?php esc_html_e('Close the panel', 'woo-bulk-editor') ?>"></a>
        </div>
    </div>

    <div class="woobe_top_panel_slide"><a href="#" class="woobe_top_panel_btn"><?php esc_html_e('Show: Filters/Bulk Edit/Export', 'woo-bulk-editor') ?></a></div>

...
<div style="padding: 0 0.2em;">
    <div id="woobe_tools_panel">
        ...
        <div style="position: relative">
            ...
            &nbsp;<span>
                <?php echo WOOBE_HELPER::draw_advanced_switcher(0, 'woobe_show_variations', '', array('true' => esc_html__('variations', 'woo-bulk-editor'), 'false' => esc_html__('variations', 'woo-bulk-editor')), array('true' => 1, 'false' => 0), 'js_check_woobe_show_variations', 'woobe_show_variations'); ?>

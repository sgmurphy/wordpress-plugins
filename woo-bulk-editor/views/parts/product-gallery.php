...
<!-- <div class="woobe_gallery_popup_operations">
    <div class="col-lg-9">
        <input type="checkbox" value="0" id="woobe_remove_gall_attach" />&nbsp;<label for="woobe_remove_gall_attach"><?php esc_html_e('Remove images also from medialibrary if detached of the product', 'woo-bulk-editor') ?></label>
    </div>
    <div class="col-lg-3 tar">
        <a href="#" class="button button-primary woobe_gall_file_delete_all" title="<?php esc_html_e('Remove all images', 'woo-bulk-editor') ?>"><?php esc_html_e('Clean', 'woo-bulk-editor') ?></a>
    </div>
    <div class="clear"></div>
</div> -->

...
use LWVendor\PhpOffice\PhpSpreadsheet\Shared\Trend\Trend;
class Statistical
{
    ...
    private static function logGamma($x)
    {
        ...
        static $lg_p1 = [4.945235359296727, 201.8112620856775, 2290.8383738313464, 11319.672059033808, 28557.246356716354, 38484.962284437934, 26377.487876241954, 7225.813979700288];
        static $lg_p2 = [4.974607845568932, 542.4138599891071, 15506.93864978365, 184793.29044456323, 1088204.7694688288, 3338152.96798703, 5106661.678927353, 3074109.0548505397];
        static $lg_p4 = [14745.0216605994, 2426813.3694867045, 121475557.40450932, 2663432449.630977, 29403789566.34554, 170266573776.5399, 492612579337.7431, 560625185622.3951];
        static $lg_q1 = [67.48212550303778, 1113.3323938571993, 7738.757056935398, 27639.870744033407, 54993.102062261576, 61611.22180066002, 36351.2759150194, 8785.536302431014];
        static $lg_q2 = [183.03283993705926, 7765.049321445006, 133190.38279660742, 1136705.8213219696, 5267964.117437947, 13467014.543111017, 17827365.303532742, 9533095.591844354];
        static $lg_q4 = [2690.5301758708993, 639388.5654300093, 41355999.30241388, 1120872109.616148, 14886137286.788137, 101680358627.24382, 341747634550.73773, 446315818741.9713];
        static $lg_c = [-0.001910444077728, 0.0008417138778129501, -0.0005952379913043012, 0.0007936507935003503, -0.0027777777777776816, 0.08333333333333333, 0.0057083835261];
    ...
    {
        if (\is_bool($arg) && (!Functions::isCellValue($k) && Functions::getCompatibilityMode() === Functions::COMPATIBILITY_EXCEL || Functions::getCompatibilityMode() === Functions::COMPATIBILITY_OPENOFFICE)) {
            $arg = (int) $arg;
        }
        return $arg;
    }
    ...
    {
        if (\is_numeric($arg) && !\is_string($arg) || \is_numeric($arg) && !Functions::isCellValue($k) && Functions::getCompatibilityMode() !== Functions::COMPATIBILITY_GNUMERIC) {
            return \true;
        }
        return \false;
    }

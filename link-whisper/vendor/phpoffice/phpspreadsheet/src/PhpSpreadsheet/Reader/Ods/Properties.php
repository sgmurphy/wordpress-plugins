...
use LWVendor\PhpOffice\PhpSpreadsheet\Document\Properties as DocumentProperties;
...
class Properties
{
    ...
    private function setMetaProperties($namespacesMeta, SimpleXMLElement $propertyValue, $propertyName, DocumentProperties $docProps) : void
    {

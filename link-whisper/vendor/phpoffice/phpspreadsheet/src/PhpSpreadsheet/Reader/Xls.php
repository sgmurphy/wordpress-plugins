...
use LWVendor\PhpOffice\PhpSpreadsheet\Shared\CodePage;
...
use LWVendor\PhpOffice\PhpSpreadsheet\Shared\OLERead;
...
class Xls extends BaseReader
{
        ...
        foreach ($this->sheets as $sheet) {
            ...
            foreach ($this->objs as $n => $obj) {
                ...
                if (isset($allSpContainers[$n + 1]) && \is_object($allSpContainers[$n + 1])) {
                    ...
                    $width = \LWVendor\PhpOffice\PhpSpreadsheet\Shared\Xls::getDistanceX($this->phpSheet, $startColumn, $startOffsetX, $endColumn, $endOffsetX);
                    $height = \LWVendor\PhpOffice\PhpSpreadsheet\Shared\Xls::getDistanceY($this->phpSheet, $startRow, $startOffsetY, $endRow, $endOffsetY);
                    // calculate offsetX and offsetY of the shape
                    $offsetX = $startOffsetX * \LWVendor\PhpOffice\PhpSpreadsheet\Shared\Xls::sizeCol($this->phpSheet, $startColumn) / 1024;
                    $offsetY = $startOffsetY * \LWVendor\PhpOffice\PhpSpreadsheet\Shared\Xls::sizeRow($this->phpSheet, $startRow) / 256;
    ...
    private function readRow() : void
    {
        ...
        if (!$this->readDataOnly) {
            ...
            $isCollapsed = (0x10 & self::getInt4d($recordData, 12)) >> 4;

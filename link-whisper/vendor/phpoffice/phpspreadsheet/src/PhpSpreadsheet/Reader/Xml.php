...
use LWVendor\PhpOffice\PhpSpreadsheet\Document\Properties;
...
class Xml extends BaseReader
{
    ...
    {
        try {
            $xml = \simplexml_load_string($this->securityScanner->scan(\file_get_contents($pFilename)), 'SimpleXMLElement', Settings::getLibXmlLoaderOptions());
        } catch (\Exception $e) {
    ...
    {
        $verticalAlignmentStyles = [Alignment::VERTICAL_BOTTOM, Alignment::VERTICAL_TOP, Alignment::VERTICAL_CENTER, Alignment::VERTICAL_JUSTIFY];
        $horizontalAlignmentStyles = [Alignment::HORIZONTAL_GENERAL, Alignment::HORIZONTAL_LEFT, Alignment::HORIZONTAL_RIGHT, Alignment::HORIZONTAL_CENTER, Alignment::HORIZONTAL_CENTER_CONTINUOUS, Alignment::HORIZONTAL_JUSTIFY];
        foreach ($styleAttributes as $styleAttributeKey => $styleAttributeValue) {
            ...
            switch ($styleAttributeKey) {
                ...
                case 'Horizontal':
                    ...
                    break;
                case 'WrapText':
                    $this->styles[$styleID]['alignment']['wrapText'] = \true;
                    break;
            }
        }
    }
    ...
    {
        $underlineStyles = [Font::UNDERLINE_NONE, Font::UNDERLINE_DOUBLE, Font::UNDERLINE_DOUBLEACCOUNTING, Font::UNDERLINE_SINGLE, Font::UNDERLINE_SINGLEACCOUNTING];
        foreach ($styleAttributes as $styleAttributeKey => $styleAttributeValue) {
            $styleAttributeValue = (string) $styleAttributeValue;
            switch ($styleAttributeKey) {
                case 'FontName':

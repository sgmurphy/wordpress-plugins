        ...
        foreach ($element->childNodes as $child) {
            if ($child instanceof DOMText) {
                ...
                switch ($child->nodeName) {
                    ...
                    case 'title':
                        $this->processDomElement($child, $sheet, $row, $column, $cellContent);
                        $sheet->setTitle($cellContent, \true, \false);
                        $cellContent = '';
                        break;
                    case 'span':
                    case 'div':
                    ...
                    case 'td':
                        ...
                        if (isset($attributeArray['rowspan'], $attributeArray['colspan'])) {
                            ...
                            $sheet->getStyle($column . $row)->applyFromArray(['fill' => ['fillType' => Fill::FILL_SOLID, 'color' => ['rgb' => $attributeArray['bgcolor']]]]);
                        }
        ...
        foreach ($styles as $st) {
            ...
            switch ($styleName) {
                ...
                case 'vertical-align':
                    ...
                    break;
                case 'width':
                    $sheet->getColumnDimension($column)->setWidth(\str_replace('px', '', $styleValue));
                    break;
                case 'height':
                    $sheet->getRowDimension($row)->setRowHeight(\str_replace('px', '', $styleValue));
                    break;
                case 'word-wrap':
                    $cellStyle->getAlignment()->setWrapText($styleValue === 'break-word');
                    break;
                case 'text-indent':
                    $cellStyle->getAlignment()->setIndent((int) \str_replace(['px'], '', $styleValue));
                    break;
            }
        }
    }

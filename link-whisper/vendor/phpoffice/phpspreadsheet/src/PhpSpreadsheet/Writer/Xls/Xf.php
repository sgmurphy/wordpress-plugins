...
class Xf
{
    ...
    public function writeXf()
    {
        ...
        $atr_pat = $this->foregroundColor != 0x40 || $this->backgroundColor != 0x41 || self::mapFillType($this->_style->getFill()->getFillType()) ? 1 : 0;
     ...
     * @var array of int
     */
    private static $mapBorderStyles = [Border::BORDER_NONE => 0x0, Border::BORDER_THIN => 0x1, Border::BORDER_MEDIUM => 0x2, Border::BORDER_DASHED => 0x3, Border::BORDER_DOTTED => 0x4, Border::BORDER_THICK => 0x5, Border::BORDER_DOUBLE => 0x6, Border::BORDER_HAIR => 0x7, Border::BORDER_MEDIUMDASHED => 0x8, Border::BORDER_DASHDOT => 0x9, Border::BORDER_MEDIUMDASHDOT => 0xa, Border::BORDER_DASHDOTDOT => 0xb, Border::BORDER_MEDIUMDASHDOTDOT => 0xc, Border::BORDER_SLANTDASHDOT => 0xd];
    /**
     * Map border style.
     *
     ...
     * @var array of int
     */
    private static $mapHAlignments = [Alignment::HORIZONTAL_GENERAL => 0, Alignment::HORIZONTAL_LEFT => 1, Alignment::HORIZONTAL_CENTER => 2, Alignment::HORIZONTAL_RIGHT => 3, Alignment::HORIZONTAL_FILL => 4, Alignment::HORIZONTAL_JUSTIFY => 5, Alignment::HORIZONTAL_CENTER_CONTINUOUS => 6];
    /**
     ...
     * @var array of int
     */
    private static $mapVAlignments = [Alignment::VERTICAL_TOP => 0, Alignment::VERTICAL_CENTER => 1, Alignment::VERTICAL_BOTTOM => 2, Alignment::VERTICAL_JUSTIFY => 3];
    /**

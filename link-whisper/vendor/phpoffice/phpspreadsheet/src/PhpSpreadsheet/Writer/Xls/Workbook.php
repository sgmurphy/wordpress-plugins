...
class Workbook extends BIFFwriter
{
     ...
     */
    public function addFont(\LWVendor\PhpOffice\PhpSpreadsheet\Style\Font $font)
    {
    ...
    private function writeBoundSheet($sheet, $offset) : void
    {
        ...
        switch ($sheet->getSheetState()) {
            case \LWVendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VISIBLE:
                $ss = 0x0;
                break;
            case \LWVendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_HIDDEN:
                $ss = 0x1;
                break;
            case \LWVendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN:
                $ss = 0x2;
                break;
            default:
                $ss = 0x0;

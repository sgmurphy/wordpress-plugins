...
class StringTable extends WriterPart
{
    ...
    public function createStringTable(Worksheet $pSheet, $pExistingTable = null)
    {
        ...
        foreach ($pSheet->getCoordinates() as $coordinate) {
            ...
            if (!\is_object($cellValue) && $cellValue !== null && $cellValue !== '' && !isset($aFlippedStringTable[$cellValue]) && ($cell->getDataType() == DataType::TYPE_STRING || $cell->getDataType() == DataType::TYPE_STRING2 || $cell->getDataType() == DataType::TYPE_NULL)) {

...
use LWVendor\PhpOffice\PhpSpreadsheet\Chart\Axis;
use LWVendor\PhpOffice\PhpSpreadsheet\Chart\DataSeries;
use LWVendor\PhpOffice\PhpSpreadsheet\Chart\DataSeriesValues;
use LWVendor\PhpOffice\PhpSpreadsheet\Chart\GridLines;
use LWVendor\PhpOffice\PhpSpreadsheet\Chart\Layout;
use LWVendor\PhpOffice\PhpSpreadsheet\Chart\Legend;
use LWVendor\PhpOffice\PhpSpreadsheet\Chart\PlotArea;
use LWVendor\PhpOffice\PhpSpreadsheet\Chart\Title;
...
class Chart extends WriterPart
{
     ...
     */
    public function writeChart(\LWVendor\PhpOffice\PhpSpreadsheet\Chart\Chart $pChart, $calculateCellValues = \true)
    {
     ...
     * @param Axis $yAxis
     */
    private function writePlotArea(XMLWriter $objWriter, \LWVendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet, PlotArea $plotArea, ?Title $xAxisLabel = null, ?Title $yAxisLabel = null, ?Axis $xAxis = null, ?Axis $yAxis = null, ?GridLines $majorGridlines = null, ?GridLines $minorGridlines = null) : void
    {
        if ($plotArea === null) {
            return;
        }

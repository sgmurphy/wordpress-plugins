...
class Font
{
     ...
     */
    public static function calculateColumnWidth(\LWVendor\PhpOffice\PhpSpreadsheet\Style\Font $font, $cellText = '', $rotation = 0, ?\LWVendor\PhpOffice\PhpSpreadsheet\Style\Font $defaultFont = null)
    {
     ...
     * @return int
     */
    public static function getTextWidthPixelsExact($text, \LWVendor\PhpOffice\PhpSpreadsheet\Style\Font $font, $rotation = 0)
    {
     ...
     */
    public static function getTextWidthPixelsApprox($columnText, \LWVendor\PhpOffice\PhpSpreadsheet\Style\Font $font, $rotation = 0)
    {
     ...
     */
    public static function getDefaultColumnWidthByFont(\LWVendor\PhpOffice\PhpSpreadsheet\Style\Font $font, $pPixels = \false)
    {
     ...
     */
    public static function getDefaultRowHeightByFont(\LWVendor\PhpOffice\PhpSpreadsheet\Style\Font $font)
    {
        switch ($font->getName()) {
            case 'Arial':
                switch ($font->getSize()) {

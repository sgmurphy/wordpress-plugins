...
namespace LWVendor\PhpOffice\PhpSpreadsheet\Shared\OLE\PPS;
...
use LWVendor\PhpOffice\PhpSpreadsheet\Shared\OLE\PPS;
/**
...
class Root extends PPS
{
    ...
    public function save($fileHandle)
    {
        ...
        $this->bigBlockSize = 2 ** (isset($this->bigBlockSize) ? self::adjust2($this->bigBlockSize) : 9);
        $this->smallBlockSize = 2 ** (isset($this->smallBlockSize) ? self::adjust2($this->smallBlockSize) : 6);

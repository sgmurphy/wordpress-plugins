...
use DateTimeZone;
use LWVendor\PhpOffice\PhpSpreadsheet\Calculation\DateTime;
...
class Date
{
    ...
    {
        return \is_numeric($pCell->getCalculatedValue()) && self::isDateTimeFormat($pCell->getWorksheet()->getStyle($pCell->getCoordinate())->getNumberFormat());
    }
    /**

...
class Drawing
{
     ...
     */
    public static function pixelsToCellDimension($pValue, \LWVendor\PhpOffice\PhpSpreadsheet\Style\Font $pDefaultFont)
    {
        // Font name and size
     ...
     * @return int Value in pixels
     */
    public static function cellDimensionToPixels($pValue, \LWVendor\PhpOffice\PhpSpreadsheet\Style\Font $pDefaultFont)
    {
        // Font name and size
        $name = $pDefaultFont->getName();
        $size = $pDefaultFont->getSize();

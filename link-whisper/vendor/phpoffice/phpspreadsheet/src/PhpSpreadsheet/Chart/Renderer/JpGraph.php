...
namespace LWVendor\PhpOffice\PhpSpreadsheet\Chart\Renderer;

use LWVendor\AccBarPlot;
use LWVendor\AccLinePlot;
use LWVendor\BarPlot;
use LWVendor\ContourPlot;
use LWVendor\Graph;
use LWVendor\GroupBarPlot;
use LWVendor\LinePlot;
use LWVendor\PhpOffice\PhpSpreadsheet\Chart\Chart;
use LWVendor\PhpOffice\PhpSpreadsheet\Style\NumberFormat;
use LWVendor\PieGraph;
use LWVendor\PiePlot;
use LWVendor\PiePlot3D;
use LWVendor\PiePlotC;
use LWVendor\RadarGraph;
use LWVendor\RadarPlot;
use LWVendor\ScatterPlot;
use LWVendor\Spline;
use LWVendor\StockPlot;
...
class JpGraph implements IRenderer
{
    ...
    private static function init() : void
    {
        ...
        \LWVendor\JpGraph\JpGraph::load();
        \LWVendor\JpGraph\JpGraph::module('bar');
        \LWVendor\JpGraph\JpGraph::module('contour');
        \LWVendor\JpGraph\JpGraph::module('line');
        \LWVendor\JpGraph\JpGraph::module('pie');
        \LWVendor\JpGraph\JpGraph::module('pie3d');
        \LWVendor\JpGraph\JpGraph::module('radar');
        \LWVendor\JpGraph\JpGraph::module('regstat');
        \LWVendor\JpGraph\JpGraph::module('scatter');
        \LWVendor\JpGraph\JpGraph::module('stock');

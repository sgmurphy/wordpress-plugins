...
use LWVendor\PhpOffice\PhpSpreadsheet\Worksheet\Iterator;
...
class Spreadsheet
{
    ...
    public function addSheet(Worksheet $pSheet, $iSheetIndex = null)
    {
        ...
        if ($iSheetIndex === null) {
            ...
            \array_splice($this->workSheetCollection, $iSheetIndex, 0, [$pSheet]);
    ...
    public function removeSheetByIndex($pIndex) : void
    {
        ...
        if ($pIndex > $numSheets - 1) {
            throw new Exception("You tried to remove a sheet by the out of bounds index: {$pIndex}. The actual number of sheets is {$numSheets}.");
        }
    ...
    public function getSheet($pIndex)
    {
        if (!isset($this->workSheetCollection[$pIndex])) {
            ...
            throw new Exception("Your requested sheet index: {$pIndex} is out of bounds. The actual number of sheets is {$numSheets}.");
        }
    ...
    public function setActiveSheetIndex($pIndex)
    {
        $numSheets = \count($this->workSheetCollection);
        if ($pIndex > $numSheets - 1) {
            throw new Exception("You tried to set a sheet active by the out of bounds index: {$pIndex}. The actual number of sheets is {$numSheets}.");
        }

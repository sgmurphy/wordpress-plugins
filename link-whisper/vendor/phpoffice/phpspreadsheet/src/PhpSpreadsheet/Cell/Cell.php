...
class Cell
{
    ...
    {
        return (string) NumberFormat::toFormattedString($this->getCalculatedValue(), $this->getStyle()->getNumberFormat()->getFormatCode());
    }
    /**
     * Set cell value.
     *
    ...
    public function getCalculatedValue($resetLog = \true)
    {
        if ($this->dataType == DataType::TYPE_FORMULA) {
            try {
                ...
                throw new \LWVendor\PhpOffice\PhpSpreadsheet\Calculation\Exception($this->getWorksheet()->getTitle() . '!' . $this->getCoordinate() . ' -> ' . $ex->getMessage());
            }

...
namespace LWVendor\MyCLabs\Enum\PHPUnit;

use LWVendor\MyCLabs\Enum\Enum;
use LWVendor\SebastianBergmann\Comparator\ComparisonFailure;
/**
 ...
 */
final class Comparator extends \LWVendor\SebastianBergmann\Comparator\Comparator
{

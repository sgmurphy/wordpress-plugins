...
The [PRO version](https://wpdarko.com/items/top-bar-pro/) gives you access to a lot of new features: allow users to **close the Top Bar**, choose an **initial state**, add a **bottom border**, set a **time before the Top Bar appears**, bottom positioning, user visibility settings (**only for guests or registered users**), change the **font-size**...
...
= Usage =
Go to [the plugin's documentation](https://wpdarko.com/support/docs/get-started-with-the-top-bar-plugin/) if you need more information on how to use this plugin.
...
= Usage =
Go to [the plugin's documentation](https://wpdarko.com/support/docs/get-started-with-the-top-bar-plugin/) for information on how to use it.
...
= 3.0.2 =
* Fixes JS bug with settings
* Fixes issues with specific character in the message

= 3.0 =
* Fixes CSS issues
* Fixes JS issues
* [New feature] Detect fixed navigation (automatically finds and fixes conflicts)
* [New feature] Button link behavior (same/new window)
* Updated setting panel
* Updated admin menus
* Better fonts for message/button

= 2.0 =
* Adds cleaner and faster option screen
* Fixes CSS issues
* Fixes JS issues

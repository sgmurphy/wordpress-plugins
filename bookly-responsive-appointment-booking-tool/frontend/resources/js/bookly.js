...
var bookly = (function ($$W) {
	...
	*/
    ...
    var PROPER$1 = EXISTS$2 && (function something() { /* empty */
    }).name === 'something';
    ...
    var setMetadata$1 = function (it) {
        defineProperty$f(it, METADATA$2, {
            value: {
            ...
            for (; length > index; index++) if (NO_HOLES || index in self) {
                ...
                if (TYPE) {
                    if (IS_MAP) target[index] = result; // map
                        ...
                        case 2:
                            push$7(target, value);      // filter
                    } else switch (TYPE) {
                        case 4:
                            return false;             // every
                        case 7:
                            push$7(target, value);      // filterReject
                    }
                }
            }
    ...
    var collection$5 = function (CONSTRUCTOR_NAME, wrapper, common) {
        ...
        if (!DESCRIPTORS$g || !isCallable$h(NativeConstructor)
            || !(IS_WEAK || NativePrototype.forEach && !fails$t(function () {
            ...
            Constructor = wrapper(function (target, iterable) {
                ...
                if (!isNullOrUndefined$7(iterable)) iterate$6(iterable, target[ADDER], {
                    that: target,
                    AS_ENTRIES: IS_MAP
                });
            });
    ...
    var FAILS_ON_PRIMITIVES$1 = fails$n(function () {
        nativeKeys(1);
    });
	...
	*/
    ...
    var setMetadata = function (it) {
        defineProperty$b(it, METADATA$1, {
            value: {
    ...
    var collection$3 = function (CONSTRUCTOR_NAME, wrapper, common) {
        ...
        if (!DESCRIPTORS$7 || !isCallable(NativeConstructor)
            || !(IS_WEAK || NativePrototype.forEach && !fails$4(function () {
                new NativeConstructor().entries().next();
            }))
        ) {
            // create collection constructor
    ...
    var FORCED$1 = !NATIVE_SYMBOL || fails$2(function () {
	...
	*/
    ...
    function create_else_block$1(ctx) {
        ...
        return {
            c() {
                ...
                attr(div, "class", div_class_value = "" + ( /*classes*/ctx[5] + " " + /*buttonClasses*/ctx[6] + " bookly-drop-shadow-none bookly-box-border bookly-text-center bookly-flex bookly-items-center bookly-justify-center pointer-events-none bookly-opacity-50"));
            ...
            p(ctx, dirty) {
                ...
                if (!current || dirty & /*classes, buttonClasses*/96 && div_class_value !== (div_class_value = "" + ( /*classes*/ctx[5] + " " + /*buttonClasses*/ctx[6] + " bookly-drop-shadow-none bookly-box-border bookly-text-center bookly-flex bookly-items-center bookly-justify-center pointer-events-none bookly-opacity-50"))) {
    ...
    function get_each_context_4(ctx, list, i) {
        ...
        child_ctx[36] = list[i];
        child_ctx[48] = i;
        const constants_0 = /*year*/child_ctx[1] + /*_year*/child_ctx[48] - 4;
        child_ctx[46] = constants_0;
        const constants_1 = new Date( /*__year*/child_ctx[46], 12, 0);
    ...
    function get_each_context_3(ctx, list, i) {
        ...
        child_ctx[36] = list[i];
        child_ctx[45] = i;
        const constants_0 = new Date( /*year*/child_ctx[1], /*_month*/child_ctx[45] + 1, 0);
    ...
    function get_each_context_1(ctx, list, i) {
        ...
        child_ctx[36] = list[i];
        child_ctx[41] = i;
        const constants_0 = /*days*/child_ctx[9][/*i*/child_ctx[38] * 7 + /*j*/child_ctx[41]].disabled;
    ...
    function create_if_block$3(ctx) {
        ...
        button0.$on("keypress", /*onClickLeft*/ctx[14]);
        button1 = new Button({
            props: {
        ...
        button1.$on("keypress", /*changeView*/ctx[13]);
        button2 = new Button({
            props: {
        ...
        button2.$on("keypress", /*onClickRight*/ctx[15]);
        ...
        return {
            c() {
                ...
                attr(div3, "class", div3_class_value = "bookly-w-full bookly-min-h-full bookly-relative bookly-bg-white bookly-rounded " + ( /*border*/ctx[6] ? 'bookly-border bookly-p-1 bookly-rounded' : ''));
            },
            m(target, anchor) {
            ...
            p(ctx, dirty) {
                ...
                if (dirty[0] & /*rtl*/1024 | dirty[1] & /*$$scope*/262144) {
                ...
                if (dirty[0] & /*title*/2048 | dirty[1] & /*$$scope*/262144) {
                ...
                if (!current || dirty[0] & /*border*/64 && div3_class_value !== (div3_class_value = "bookly-w-full bookly-min-h-full bookly-relative bookly-bg-white bookly-rounded " + ( /*border*/ctx[6] ? 'bookly-border bookly-p-1 bookly-rounded' : ''))) {
    ...
    // (234:16) <Button                          class="bookly-grow bookly-rounded bookly-border-none focus:bookly-border-none focus:bookly-outline-none bookly-leading-normal bookly-calendar-middle-button-mark bookly-m-0 bookly-text-lg bookly-shadow-none"                          type="white"                          bordered={false}                          rounded={false}                          margins={false}                          on:click={changeView}                          on:keypress={changeView}                          container="div"                  >
    ...
    function create_else_block(ctx) {
        ...
        return {
            ...
            p(ctx, dirty) {
                if (dirty[0] & /*limits, year, view*/259) {
    ...
    function create_if_block_3$1(ctx) {
        ...
        return {
            ...
            p(ctx, dirty) {
                if (dirty[0] & /*limits, year, month, dispatch, view, datePicker*/4375) {
    ...
    function create_if_block_1$2(ctx) {
        ...
        return {
            c() {
                ...
                attr(div0, "class", "bookly-flex bookly-flex-row fw-bold bookly-text-center bookly-text-muted bookly-w-full bookly-border-b bookly-mb-1 bookly-pb-2 bookly-text-gray-500 bookly-font-bold bookly-max-w-full");
    ...
    // (324:28) <Button                                      type="bookly"                                      bordered={false}                                      rounded={false}                                      paddings={false}                                      margins={false}                                      class="bookly-border-none focus:bookly-border-none focus:bookly-outline-none bookly-leading-normal bookly-px-2 bookly-py-0 bookly-m-0 bookly-text-xl bookly-h-12"                                      on:click={() => {year = __year; view='month'}}                                      on:keypress={() => {year = __year; view='month'}}                                      disabled={limits && limits.hasOwnProperty('start') && limits.start > _date}                                      container="div"                                      size="custom"                              >
    function create_default_slot_2(ctx) {
        let t_value = /*__year*/ctx[46] + "";
        let t;
        return {
            c() {
                t = text(t_value);
            ...
            p(ctx, dirty) {
                if (dirty[0] & /*year*/2 && t_value !== (t_value = /*__year*/ctx[46] + "")) set_data(t, t_value);
            },
            d(detaching) {
                if (detaching) {
                    detach(t);
    ...
    // (320:20) {#each {length: 9} as _,_year}
    function create_each_block_4(ctx) {
        ...
        function click_handler_2() {
            return /*click_handler_2*/ctx[31]( /*__year*/ctx[46]);
        }

        function keypress_handler_2() {
            return /*keypress_handler_2*/ctx[32]( /*__year*/ctx[46]);
        }
        ...
        button = new Button({
            props: {
                ...
                paddings: false,
                margins: false,
                class: "bookly-border-none focus:bookly-border-none focus:bookly-outline-none bookly-leading-normal bookly-px-2 bookly-py-0 bookly-m-0 bookly-text-xl bookly-h-12",
                disabled: /*limits*/ctx[0] && /*limits*/ctx[0].hasOwnProperty('start') && /*limits*/ctx[0].start > /*_date*/ctx[43],
                container: "div",
                size: "custom",
                $$slots: {
        ...
        return {
            ...
            p(new_ctx, dirty) {
                ...
                if (dirty[0] & /*limits, year*/3) button_changes.disabled = /*limits*/ctx[0] && /*limits*/ctx[0].hasOwnProperty('start') && /*limits*/ctx[0].start > /*_date*/ctx[43];
                if (dirty[0] & /*year*/2 | dirty[1] & /*$$scope*/262144) {
    ...
    // (300:28) <Button                                      type="bookly"                                      class="bookly-border-none focus:bookly-border-none focus:bookly-outline-none bookly-leading-normal bookly-px-2 bookly-py-0 bookly-m-0 bookly-text-xl bookly-h-12"                                      bordered={false}                                      rounded={false}                                      margins={false}                                      paddings={false}                                      on:click={() => {month = _month; dispatch('month-change'); view='calendar'}}                                      on:keypress={() => {month = _month; dispatch('month-change'); view='calendar'}}                                      disabled={limits && limits.hasOwnProperty('start') && limits.start > _date}                                      container="div"                                      size="custom"                              >
    function create_default_slot_1(ctx) {
        let t_value = /*datePicker*/ctx[4].monthNamesShort[/*_month*/ctx[45]] + "";
        let t;
        return {
            c() {
                t = text(t_value);
            ...
            p(ctx, dirty) {
                if (dirty[0] & /*datePicker*/16 && t_value !== (t_value = /*datePicker*/ctx[4].monthNamesShort[/*_month*/ctx[45]] + "")) set_data(t, t_value);
            },
            d(detaching) {
                if (detaching) {
                    detach(t);
    ...
    // (297:20) {#each {length: 12} as _,_month}
    function create_each_block_3(ctx) {
        ...
        function click_handler_1() {
            return /*click_handler_1*/ctx[29]( /*_month*/ctx[45]);
        }

        function keypress_handler_1() {
            return /*keypress_handler_1*/ctx[30]( /*_month*/ctx[45]);
        }
        ...
        return {
            ...
            p(new_ctx, dirty) {
                ...
                const button_changes = {};
                if (dirty[0] & /*limits, year*/3) button_changes.disabled = /*limits*/ctx[0] && /*limits*/ctx[0].hasOwnProperty('start') && /*limits*/ctx[0].start > /*_date*/ctx[43];
                if (dirty[0] & /*datePicker*/16 | dirty[1] & /*$$scope*/262144) {
                    button_changes.$$scope = {
                        dirty,
                        ctx
                    };
    ...
    // (263:24) {#each {length: 7} as _, i}
    function create_each_block_2(ctx) {
        let div;
        let t_value = /*datePicker*/ctx[4].dayNamesShort[( /*i*/ctx[38] + /*datePicker*/ctx[4].firstDay) % 7] + "";
        let t;
        return {
            c() {
                div = element("div");
            ...
            p(ctx, dirty) {
                if (dirty[0] & /*datePicker*/16 && t_value !== (t_value = /*datePicker*/ctx[4].dayNamesShort[( /*i*/ctx[38] + /*datePicker*/ctx[4].firstDay) % 7] + "")) set_data(t, t_value);
            },
            d(detaching) {
                if (detaching) {
                    detach(div);
    ...
    // (277:36) <Button                                              type={days[i * 7 + j].active ? 'calendar-active' : (days[i * 7 + j].current ? 'calendar-normal' : 'calendar-inactive')}                                              class="bookly-text-sm bookly-h-10 bookly-leading-4 bookly-shadow-none bookly-flex-1 bookly-py-2 bookly-px-0 bookly-border-none focus:bookly-border-none focus:bookly-outline-none {_disabled ? 'bookly-cursor-default' : 'hover:bookly-opacity-75'} {(days[i * 7 + j].current ? 'bookly-calendar-current-month-mark' : '')}"                                              bordered={false}                                              margins={false}                                              on:click={() => !_disabled && onClickDate(days[i*7+j])}                                              on:keypress={() => !_disabled && onClickDate(days[i*7+j])}                                              disabled={_disabled}                                              container="div"                                              size="custom"                                      >
    function create_default_slot(ctx) {
        let t_value = /*days*/ctx[9][/*i*/ctx[38] * 7 + /*j*/ctx[41]].title + "";
        let t;
        return {
            c() {
                t = text(t_value);
            ...
            p(ctx, dirty) {
                if (dirty[0] & /*days*/512 && t_value !== (t_value = /*days*/ctx[9][/*i*/ctx[38] * 7 + /*j*/ctx[41]].title + "")) set_data(t, t_value);
            },
            d(detaching) {
                if (detaching) {
                    detach(t);
    ...
    // (275:32) {#each {length: 7} as _, j}
    function create_each_block_1(ctx) {
        let button;
        let current;

        function click_handler() {
            return /*click_handler*/ctx[27]( /*_disabled*/ctx[39], /*i*/ctx[38], /*j*/ctx[41]);
        }

        function keypress_handler() {
            return /*keypress_handler*/ctx[28]( /*_disabled*/ctx[39], /*i*/ctx[38], /*j*/ctx[41]);
        }

        button = new Button({
            props: {
                type: /*days*/ctx[9][/*i*/ctx[38] * 7 + /*j*/ctx[41]].active ? 'calendar-active' : /*days*/ctx[9][/*i*/ctx[38] * 7 + /*j*/ctx[41]].current ? 'calendar-normal' : 'calendar-inactive',
                class: "bookly-text-sm bookly-h-10 bookly-leading-4 bookly-shadow-none bookly-flex-1 bookly-py-2 bookly-px-0 bookly-border-none focus:bookly-border-none focus:bookly-outline-none " + ( /*_disabled*/ctx[39] ? 'bookly-cursor-default' : 'hover:bookly-opacity-75') + " " + ( /*days*/ctx[9][/*i*/ctx[38] * 7 + /*j*/ctx[41]].current ? 'bookly-calendar-current-month-mark' : ''),
                bordered: false,
                margins: false,
                disabled: /*_disabled*/ctx[39],
                container: "div",
                size: "custom",
                $$slots: {
        ...
        return {
            ...
            p(new_ctx, dirty) {
                ctx = new_ctx;
                const button_changes = {};
                if (dirty[0] & /*days*/512) button_changes.type = /*days*/ctx[9][/*i*/ctx[38] * 7 + /*j*/ctx[41]].active ? 'calendar-active' : /*days*/ctx[9][/*i*/ctx[38] * 7 + /*j*/ctx[41]].current ? 'calendar-normal' : 'calendar-inactive';
                if (dirty[0] & /*days*/512) button_changes.class = "bookly-text-sm bookly-h-10 bookly-leading-4 bookly-shadow-none bookly-flex-1 bookly-py-2 bookly-px-0 bookly-border-none focus:bookly-border-none focus:bookly-outline-none " + ( /*_disabled*/ctx[39] ? 'bookly-cursor-default' : 'hover:bookly-opacity-75') + " " + ( /*days*/ctx[9][/*i*/ctx[38] * 7 + /*j*/ctx[41]].current ? 'bookly-calendar-current-month-mark' : '');
                if (dirty[0] & /*days*/512) button_changes.disabled = /*_disabled*/ctx[39];
                if (dirty[0] & /*days*/512 | dirty[1] & /*$$scope*/262144) {
                    button_changes.$$scope = {
                        dirty,
                        ctx
                    };
    ...
    // (273:24) {#each {length: parseInt(days.length / 7)} as _, i}
    ...
    function instance$3($$self, $$props, $$invalidate) {
        ...
        const click_handler = (_disabled, i, j) => !_disabled && onClickDate(days[i * 7 + j]);
        const keypress_handler = (_disabled, i, j) => !_disabled && onClickDate(days[i * 7 + j]);
        ...
        return [limits, year, month, loading, datePicker, show, border, el, view, days, rtl, title, dispatch, changeView, onClickLeft, onClickRight, onClickDate, date, startDate, holidays, loadedMonths, maxDays, disabledWeekDays, loadSchedule, forceLoadSchedule, monthWithYear, lastDate, click_handler, keypress_handler, click_handler_1, keypress_handler_1, click_handler_2, keypress_handler_2, div3_binding];
    }
            ...
            if (intlTelInput.enabled) {
                $phone_field.intlTelInput({
                    ...
                    geoIpLookup: function (callback) {
                        $$W.get('https://ipinfo.io', function () {

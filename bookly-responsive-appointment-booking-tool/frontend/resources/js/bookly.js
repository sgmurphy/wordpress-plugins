...
var bookly = (function ($$W) {
	...
	var functionBindNative$1 = !fails$M(function () {
	...
	var apply$7 = FunctionPrototype$6.apply;
	var call$s = FunctionPrototype$6.call;

	// eslint-disable-next-line es/no-reflect -- safe
	var functionApply$1 = typeof Reflect == 'object' && Reflect.apply || (NATIVE_BIND$7 ? call$s.bind(apply$7) : function () {
	  return call$s.apply(apply$7, arguments);
	});
	...
	var toString$n = uncurryThis$P({}.toString);
	var stringSlice$3 = uncurryThis$P(''.slice);

	var classofRaw$5 = function (it) {
	  return stringSlice$3(toString$n(it), 8, -1);
	};
	...
	var functionUncurryThisClause$1 = function (fn) {
	  ...
	  if (classofRaw$4(fn) === 'Function') return uncurryThis$O(fn);
	};
	...
	var indexedObject$1 = fails$K(function () {
	...
	var getBuiltIn$k = function (namespace, method) {
	  return arguments.length < 2 ? aFunction$1(path$o[namespace]) || aFunction$1(global$H[namespace])
	    : path$o[namespace] && path$o[namespace][method] || global$H[namespace] && global$H[namespace][method];
	};
	...
	var $String$9 = global$F.String;

	// eslint-disable-next-line es/no-object-getownpropertysymbols -- required for testing
	var symbolConstructorDetection$1 = !!Object.getOwnPropertySymbols && !fails$J(function () {
	...
	/* eslint-disable es/no-symbol -- required for testing */
	var NATIVE_SYMBOL$7 = symbolConstructorDetection$1;
	...
	var aCallable$g = function (argument) {
	  ...
	  throw new $TypeError$p(tryToString$9(argument) + ' is not a function');
	};
	...
	var defineGlobalProperty$3 = function (key, value) {
	  try {
	    defineProperty$i(global$E, key, { value: value, configurable: true, writable: true });
	  } catch (error) {
	    global$E[key] = value;
	  } return value;
	};
	...
	var store$7 = global$D[SHARED$1] || defineGlobalProperty$2(SHARED$1, {});
	...
	var sharedExports$1 = shared$b.exports;
	...
	var toString$m = uncurryThis$K(1.0.toString);
	...
	var shared$a = sharedExports$1;
	var hasOwn$p = hasOwnProperty_1$1;
	var uid$7 = uid$8;
	var NATIVE_SYMBOL$6 = symbolConstructorDetection$1;
	var USE_SYMBOL_AS_UID$2 = useSymbolAsUid$1;

	var Symbol$7 = global$C.Symbol;
	var WellKnownSymbolsStore$3 = shared$a('wks');
	var createWellKnownSymbol$1 = USE_SYMBOL_AS_UID$2 ? Symbol$7['for'] || Symbol$7 : Symbol$7 && Symbol$7.withoutSetter || uid$7;

	var wellKnownSymbol$E = function (name) {
	  if (!hasOwn$p(WellKnownSymbolsStore$3, name)) {
	    WellKnownSymbolsStore$3[name] = NATIVE_SYMBOL$6 && hasOwn$p(Symbol$7, name)
	      ? Symbol$7[name]
	...
	var toPrimitive$9 = function (input, pref) {
	  if (!isObject$u(input) || isSymbol$7(input)) return input;
	  var exoticToPrim = getMethod$6(input, TO_PRIMITIVE$1);
	  var result;
	  if (exoticToPrim) {
	    if (pref === undefined) pref = 'default';
	    result = call$o(exoticToPrim, input, pref);
	    if (!isObject$u(result) || isSymbol$7(result)) return result;
	...
	var document$4 = global$B.document;
	...
	var ie8DomDefine$1 = !DESCRIPTORS$p && !fails$I(function () {
	  // eslint-disable-next-line es/no-object-defineproperty -- required for testing
	...
	objectGetOwnPropertyDescriptor$1.f = DESCRIPTORS$o ? $getOwnPropertyDescriptor$4 : function getOwnPropertyDescriptor(O, P) {
	  O = toIndexedObject$g(O);
	  P = toPropertyKey$8(P);
	  if (IE8_DOM_DEFINE$3) try {
	    return $getOwnPropertyDescriptor$4(O, P);
	  } catch (error) { /* empty */ }
	  if (hasOwn$o(O, P)) return createPropertyDescriptor$b(!call$n(propertyIsEnumerableModule$2.f, O, P), O[P]);
	};
	...
	var isForced$4 = function (feature, detection) {
	  ...
	  return value === POLYFILL$1 ? true
	    ...
	    : isCallable$u(detection) ? fails$H(detection)
	    : !!detection;
	};
	...
	var uncurryThis$J = functionUncurryThisClause$1;
	var aCallable$e = aCallable$g;
	var NATIVE_BIND$4 = functionBindNative$1;

	var bind$e = uncurryThis$J(uncurryThis$J.bind);
	...
	var v8PrototypeDefineBug$1 = DESCRIPTORS$n && fails$G(function () {
	  // eslint-disable-next-line es/no-object-defineproperty -- required for testing
	...
	var createNonEnumerableProperty$f = DESCRIPTORS$l ? function (object, key, value) {
	  return definePropertyModule$7.f(object, key, createPropertyDescriptor$a(1, value));
	...
	var uncurryThis$I = functionUncurryThisClause$1;
	...
	*/
	var _export$1 = function (options, source) {
	  ...
	  var target = GLOBAL ? path$n : path$n[TARGET] || createNonEnumerableProperty$e(path$n, TARGET, {})[TARGET];
	  ...
	  for (key in source) {
	    ...
	    if (options.bind && USE_NATIVE) resultProperty = bind$d(sourceProperty, global$A);
	    // wrap global constructors for prevent changes in this version
	    else if (options.wrap && USE_NATIVE) resultProperty = wrapConstructor$1(sourceProperty);
	    // make static versions for prototype methods
	    else if (PROTO && isCallable$t(sourceProperty)) resultProperty = uncurryThis$I(sourceProperty);
	    // default case
	    ...
	    if (PROTO) {
	      ...
	      if (!hasOwn$n(path$n, VIRTUAL_PROTOTYPE)) {
	        createNonEnumerableProperty$e(path$n, VIRTUAL_PROTOTYPE, {});
	      }
	      // export virtual prototype methods
	      createNonEnumerableProperty$e(path$n[VIRTUAL_PROTOTYPE], key, sourceProperty);
	...
	var shared$9 = sharedExports$1;
	var uid$6 = uid$8;

	var keys$4 = shared$9('keys');
	...
	var correctPrototypeGetter$1 = !fails$F(function () {
	  function F() { /* empty */ }
	...
	var objectGetPrototypeOf$2 = CORRECT_PROTOTYPE_GETTER$1 ? $Object$7.getPrototypeOf : function (O) {
	  var object = toObject$c(O);
	  if (hasOwn$m(object, IE_PROTO$3)) return object[IE_PROTO$3];
	...
	var functionUncurryThisAccessor = function (object, key, method) {
	  try {
	    // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
	    return uncurryThis$H(aCallable$d(Object.getOwnPropertyDescriptor(object, key)[method]));
	  } catch (error) { /* empty */ }
	};
	...
	var aPossiblePrototype$1 = function (argument) {
	  ...
	  throw new $TypeError$k("Can't set " + $String$6(argument) + ' as a prototype');
	};
	...
	var objectKeysInternal$1 = function (object, names) {
	  ...
	  var result = [];
	  var key;
	  for (key in O) !hasOwn$l(hiddenKeys$b, key) && hasOwn$l(O, key) && push$9(result, key);
	  // Don't enum bug & hidden keys
	  while (names.length > i) if (hasOwn$l(O, key = names[i++])) {
	    ~indexOf$5(result, key) || push$9(result, key);
	  }
	  return result;
	};
	...
	var ownKeys$1 = getBuiltIn$i('Reflect', 'ownKeys') || function ownKeys(it) {
	...
	objectDefineProperties$1.f = DESCRIPTORS$k && !V8_PROTOTYPE_DEFINE_BUG$2 ? Object.defineProperties : function defineProperties(O, Properties) {
	  anObject$g(O);
	...
	var objectCreate$1 = Object.create || function create(O, Properties) {
	  var result;
	  if (O !== null) {
	    EmptyConstructor$1[PROTOTYPE$2] = anObject$f(O);
	...
	var isArrayIteratorMethod$4 = function (it) {
	  return it !== undefined && (Iterators$b.Array === it || ArrayPrototype$g[ITERATOR$b] === it);
	};
	...
	var classof$m = TO_STRING_TAG_SUPPORT$5 ? classofRaw$3 : function (it) {
	  var O, tag, result;
	  return it === undefined ? 'Undefined' : it === null ? 'Null'
	    ...
	    : (result = classofRaw$3(O)) === 'Object' && isCallable$r(O.callee) ? 'Arguments' : result;
	};
	...
	var getIterator$4 = function (argument, usingIterator) {
	  ...
	  if (aCallable$c(iteratorMethod)) return anObject$e(call$m(iteratorMethod, argument));
	  throw new $TypeError$j(tryToString$8(argument) + ' is not iterable');
	};
	...
	var iterate$c = function (iterable, unboundFunction, options) {
	  ...
	  if (IS_RECORD) {
	    ...
	    if (!iterFn) throw new $TypeError$i(tryToString$7(iterable) + ' is not iterable');
	    // optimisation for array iterators
	    if (isArrayIteratorMethod$3(iterFn)) {
	      for (index = 0, length = lengthOfArrayLike$d(iterable); length > index; index++) {
	        result = callFn(iterable[index]);
	        if (result && isPrototypeOf$n(ResultPrototype$1, result)) return result;
	  ...
	  while (!(step = call$k(next, iterator)).done) {
	    ...
	    if (typeof result == 'object' && result && isPrototypeOf$n(ResultPrototype$1, result)) return result;
	  } return new Result$1(false);
	};

	var classof$k = classof$m;
	...
	var $AggregateError = function AggregateError(errors, message /* , options */) {
	  var isInstance = isPrototypeOf$m(AggregateErrorPrototype, this);
	  var that;
	  if (setPrototypeOf) {
	  ...
	  var errorsArray = [];
	  iterate$b(errors, push$8, { that: errorsArray });
	...
	if (NATIVE_WEAK_MAP$2 || shared$8.state) {
	  var store$5 = shared$8.state || (shared$8.state = new WeakMap$2());
	  ...
	  set$9 = function (it, metadata) {
	    if (store$5.has(it)) throw new TypeError$4(OBJECT_ALREADY_INITIALIZED$1);
	    metadata.facade = it;
	  ...
	  set$9 = function (it, metadata) {
	    if (hasOwn$j(it, STATE$1)) throw new TypeError$4(OBJECT_ALREADY_INITIALIZED$1);
	    metadata.facade = it;
	...
	// eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
	var getDescriptor$1 = DESCRIPTORS$j && Object.getOwnPropertyDescriptor;

	var EXISTS$2 = hasOwn$i(FunctionPrototype$4, 'name');
	// additional protection from minified / mangled / dropped function names
	var PROPER$1 = EXISTS$2 && (function something() { /* empty */ }).name === 'something';
	var CONFIGURABLE$2 = EXISTS$2 && (!DESCRIPTORS$j || (DESCRIPTORS$j && getDescriptor$1(FunctionPrototype$4, 'name').configurable));
	...
	var defineBuiltIn$a = function (target, key, value, options) {
	...
	var NEW_ITERATOR_PROTOTYPE$1 = !isObject$o(IteratorPrototype$3) || fails$D(function () {
	  var test = {};
	...
	if (!isCallable$p(IteratorPrototype$3[ITERATOR$9])) {
	  defineBuiltIn$9(IteratorPrototype$3, ITERATOR$9, function () {
	    return this;
	  });
	}
	...
	var toString$j = objectToString$1;
	...
	var setToStringTag$c = function (it, TAG, STATIC, SET_METHOD) {
	  ...
	  if (target) {
	    if (!hasOwn$h(target, TO_STRING_TAG$4)) {
	      defineProperty$h(target, TO_STRING_TAG$4, { configurable: true, value: TAG });
	    }
	    if (SET_METHOD && !TO_STRING_TAG_SUPPORT$3) {
	      createNonEnumerableProperty$8(target, 'toString', toString$j);
	    }
	  }
	};
	...
	var iteratorCreateConstructor$1 = function (IteratorConstructor, NAME, next, ENUMERABLE_NEXT) {
	  ...
	  IteratorConstructor.prototype = create$8(IteratorPrototype$2, { next: createPropertyDescriptor$7(+!ENUMERABLE_NEXT, next) });
	  setToStringTag$b(IteratorConstructor, TO_STRING_TAG, false, true);
	...
	var iteratorDefine$1 = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
	  ...
	  if (anyNativeIterator) {
	    ...
	    if (CurrentIteratorPrototype !== Object.prototype && CurrentIteratorPrototype.next) {
	      ...
	      setToStringTag$a(CurrentIteratorPrototype, TO_STRING_TAG, true, true);
	  ...
	  if (DEFAULT) {
	    ...
	    } else $$U({ target: NAME, proto: true, forced: BUGGY_SAFARI_ITERATORS$2 || INCORRECT_VALUES_NAME }, methods);
	  }
	...
	var getInternalState$4 = InternalStateModule$a.getterFor(ARRAY_ITERATOR$1);
	...
	var classof$i = classofRaw$5;

	var engineIsNode = classof$i(global$x.process) === 'process';

	var defineProperty$g = objectDefineProperty$1;
	...
	var setSpecies$4 = function (CONSTRUCTOR_NAME) {
	  ...
	  if (DESCRIPTORS$i && Constructor && !Constructor[SPECIES$9]) {
	    defineBuiltInAccessor$5(Constructor, SPECIES$9, {
	      configurable: true,
	...
	var anInstance$7 = function (it, Prototype) {
	  if (isPrototypeOf$l(Prototype, it)) return it;
	...
	var exec$4 = uncurryThis$C(constructorRegExp$1.exec);
	...
	var isConstructor$7 = !construct$1 || fails$C(function () {
	  var called;
	...
	var aConstructor$1 = function (argument) {
	  ...
	  throw new $TypeError$g(tryToString$6(argument) + ' is not a constructor');
	};
	...
	var speciesConstructor$2 = function (O, defaultConstructor) {
	  ...
	  var S;
	  return C === undefined || isNullOrUndefined$8(S = anObject$b(C)[SPECIES$8]) ? defaultConstructor : aConstructor(S);
	};

	var uncurryThis$B = functionUncurryThis$1;

	var arraySlice$7 = uncurryThis$B([].slice);
	...
	if (!set$8 || !clear) {
	  ...
	  // IE8 has postMessage, but it's sync & typeof its postMessage is 'object'
	    ...
	    isCallable$m(global$w.postMessage) &&
	...
	var safeGetBuiltIn$1 = function (name) {
	  if (!DESCRIPTORS$h) return global$v[name];
	  var descriptor = getOwnPropertyDescriptor$3(global$v, name);
	...
	if (!microtask$1) {
	  ...
	  // - setTimeout
	    ...
	    macrotask = bind$a(macrotask, global$u);
	    notify$1 = function () {
	      macrotask(flush$1);
	    };
	  }
	...
	var promiseNativeConstructor = global$t.Promise;
	...
	var NATIVE_PROMISE_REJECTION_EVENT$1 = isCallable$l(global$s.PromiseRejectionEvent);
	...
	var DISPATCH_EVENT = !!(document$2 && document$2.createEvent && global$r.dispatchEvent);
	...
	var isThenable = function (it) {
	  var then;
	  return isObject$n(it) && isCallable$k(then = it.then) ? then : false;
	};
	...
	var dispatchEvent = function (name, promise, reason) {
	  ...
	  if (DISPATCH_EVENT) {
	    ...
	    global$r.dispatchEvent(event);
	  } else event = { promise: promise, reason: reason };
	  if (!NATIVE_PROMISE_REJECTION_EVENT && (handler = global$r['on' + name])) handler(event);
	  else if (name === UNHANDLED_REJECTION) hostReportErrors('Unhandled promise rejection', reason);
	};

	var onUnhandled = function (state) {
	  call$i(task, global$r, function () {
	...
	setToStringTag$9(PromiseConstructor, PROMISE, false, true);
	setSpecies$3(PROMISE);

	var wellKnownSymbol$r = wellKnownSymbol$E;

	var ITERATOR$7 = wellKnownSymbol$r('iterator');
	...
	$$S({ target: 'Promise', stat: true, forced: PROMISE_STATICS_INCORRECT_ITERATION$3 }, {
	...
	$$O({ target: 'Promise', stat: true, forced: IS_PURE$1  }, {
	...
	var getInternalState$3 = InternalStateModule$8.getterFor(STRING_ITERATOR$1);
	...
	for (var COLLECTION_NAME$1 in DOMIterables$2) {
	  setToStringTag$8(global$q[COLLECTION_NAME$1], COLLECTION_NAME$1);
	...
	var replace$2 = uncurryThis$z(''.replace);
	...
	var createMethod$6 = function (TYPE) {
	  return function ($this) {
	    var string = toString$g(requireObjectCoercible$9($this));
	...
	var charAt$3 = uncurryThis$y(''.charAt);
	var $parseFloat$1 = global$p.parseFloat;
	var Symbol$6 = global$p.Symbol;
	var ITERATOR$6 = Symbol$6 && Symbol$6.iterator;
	var FORCED$6 = 1 / $parseFloat$1(whitespaces$5 + '-0') !== -Infinity
	  // MS Edge 18- broken with boxed symbols
	  || (ITERATOR$6 && !fails$z(function () { $parseFloat$1(Object(ITERATOR$6)); }));

	// `parseFloat` method
	// https://tc39.es/ecma262/#sec-parsefloat-string
	var numberParseFloat = FORCED$6 ? function parseFloat(string) {
	  var trimmedString = trim$6(toString$f(string));
	...
	var _parseFloat$3 = path$l.parseFloat;

	var parent$I = _parseFloat$3;

	var _parseFloat$2 = parent$I;
	...
	var $parseInt$3 = global$o.parseInt;
	var Symbol$5 = global$o.Symbol;
	var ITERATOR$5 = Symbol$5 && Symbol$5.iterator;
	var hex$1 = /^[+-]?0x/i;
	var exec$3 = uncurryThis$x(hex$1.exec);
	var FORCED$5 = $parseInt$3(whitespaces$4 + '08') !== 8 || $parseInt$3(whitespaces$4 + '0x16') !== 22
	  // MS Edge 18- broken with boxed symbols
	  || (ITERATOR$5 && !fails$y(function () { $parseInt$3(Object(ITERATOR$5)); }));

	// `parseInt` method
	// https://tc39.es/ecma262/#sec-parseint-string-radix
	var numberParseInt$1 = FORCED$5 ? function parseInt(string, radix) {
	  var S = trim$5(toString$e(string));
	...
	var _parseInt$7 = path$k.parseInt;

	var parent$H = _parseInt$7;

	var _parseInt$6 = parent$H;
	...
	var arrayMethodHasSpeciesSupport$8 = function (METHOD_NAME) {
	  ...
	  return V8_VERSION$3 >= 51 || !fails$x(function () {
	    var array = [];
	...
	$$H({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$5 }, {
	...
	var getBuiltInPrototypeMethod$f = function (CONSTRUCTOR, METHOD) {
	  ...
	  var NativeConstructor = global$n[CONSTRUCTOR];
	...
	var slice$7 = getBuiltInPrototypeMethod$e('Array', 'slice');

	var isPrototypeOf$k = objectIsPrototypeOf$1;
	var method$e = slice$7;

	var ArrayPrototype$f = Array.prototype;

	var slice$6 = function (it) {
	  var own = it.slice;
	  return it === ArrayPrototype$f || (isPrototypeOf$k(ArrayPrototype$f, it) && own === ArrayPrototype$f.slice) ? method$e : own;
	};

	var parent$G = slice$6;

	var slice$5 = parent$G;
	...
	var setInterval = schedulersFix$1(global$l.setInterval, true);

	// Bun / IE9- setInterval additional parameters fix
	// https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#dom-setinterval
	$$G({ global: true, bind: true, forced: global$l.setInterval !== setInterval }, {
	...
	var setTimeout$3 = schedulersFix(global$k.setTimeout, true);

	// Bun / IE9- setTimeout additional parameters fix
	// https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#dom-settimeout
	$$F({ global: true, bind: true, forced: global$k.setTimeout !== setTimeout$3 }, {
	  setTimeout: setTimeout$3
	});

	var path$i = path$p;

	var setTimeout$2 = path$i.setTimeout;
	...
	var freezing$1 = !fails$w(function () {
	...
	var defineBuiltIns$5 = function (target, src, options) {
	  for (var key in src) {
	    ...
	    else defineBuiltIn$6(target, key, src[key], options);
	  } return target;
	};
	...
	var getWindowNames$1 = function (it) {
	  try {
	    ...
	    return arraySlice$4(windowNames$1);
	  }
	};

	// fallback for IE11 buggy Object.getOwnPropertyNames with iframe and window
	objectGetOwnPropertyNamesExternal$1.f = function getOwnPropertyNames(it) {
	  return windowNames$1 && classof$f(it) === 'Window'
	    ? getWindowNames$1(it)
	    : $getOwnPropertyNames$2(toIndexedObject$a(it));
	};

	// FF26- bug: ArrayBuffers are non-extensible, but Object.isExtensible does not report it
	var fails$v = fails$N;

	var arrayBufferNonExtensible$1 = fails$v(function () {
	...
	var FAILS_ON_PRIMITIVES$2 = fails$u(function () { $isExtensible$1(1); });

	// `Object.isExtensible` method
	// https://tc39.es/ecma262/#sec-object.isextensible
	var objectIsExtensible$1 = (FAILS_ON_PRIMITIVES$2 || ARRAY_BUFFER_NON_EXTENSIBLE$1) ? function isExtensible(it) {
	  if (!isObject$k(it)) return false;
	  if (ARRAY_BUFFER_NON_EXTENSIBLE$1 && classof$e(it) === 'ArrayBuffer') return false;
	...
	var setMetadata$1 = function (it) {
	  defineProperty$f(it, METADATA$2, { value: {
	...
	var getWeakData$2 = function (it, create) {
	  ...
	  } return it[METADATA$2].weakData;
	};

	// add metadata on freeze-family methods calling
	var onFreeze$1 = function (it) {
	  if (FREEZING$2 && REQUIRED$1 && isExtensible$2(it) && !hasOwn$f(it, METADATA$2)) setMetadata$1(it);
	  return it;
	};
	...
	var enable$1 = function () {
	  ...
	  REQUIRED$1 = true;
	  var getOwnPropertyNames = getOwnPropertyNamesModule$2.f;
	  ...
	  if (getOwnPropertyNames(test).length) {
	    getOwnPropertyNamesModule$2.f = function (it) {
	      var result = getOwnPropertyNames(it);
	      for (var i = 0, length = result.length; i < length; i++) {
	        if (result[i] === METADATA$2) {
	          splice(result, i, 1);
	          break;
	        }
	      } return result;
	...
	var forEach$6 = arrayIteration$1.forEach;
	var DESCRIPTORS$g = descriptors$1;
	var InternalStateModule$7 = internalState$1;

	var setInternalState$7 = InternalStateModule$7.set;
	var internalStateGetterFor$4 = InternalStateModule$7.getterFor;
	...
	var collection$5 = function (CONSTRUCTOR_NAME, wrapper, common) {
	  ...
	  if (!DESCRIPTORS$g || !isCallable$h(NativeConstructor)
	    ...
	    Constructor = wrapper(function (target, iterable) {
	      setInternalState$7(anInstance$5(target, Prototype), {
	        type: CONSTRUCTOR_NAME,
	        collection: new NativeConstructor()
	      });
	      if (!isNullOrUndefined$7(iterable)) iterate$6(iterable, target[ADDER], { that: target, AS_ENTRIES: IS_MAP });
	    });
	    ...
	    forEach$6(['add', 'clear', 'delete', 'forEach', 'get', 'has', 'set', 'keys', 'values', 'entries'], function (KEY) {
	      ...
	      if (KEY in NativePrototype && !(IS_WEAK && KEY === 'clear')) {
	        createNonEnumerableProperty$7(Prototype, KEY, function (a, b) {
	          var collection = getInternalState(this).collection;
	          if (!IS_ADDER && IS_WEAK && !isObject$h(a)) return KEY === 'get' ? undefined : false;
	    ...
	    IS_WEAK || defineProperty$e(Prototype, 'size', {
	      configurable: true,
	      get: function () {
	  ...
	  setToStringTag$7(Constructor, CONSTRUCTOR_NAME, false, true);

	  exported[CONSTRUCTOR_NAME] = Constructor;
	  $$D({ global: true, forced: true }, exported);
	...
	var getWeakData$1 = internalMetadataExports$1.getWeakData;
	...
	var splice$4 = uncurryThis$u([].splice);
	var id$2 = 0;
	...
	var collectionWeak$1 = {
	  getConstructor: function (wrapper, CONSTRUCTOR_NAME, IS_MAP, ADDER) {
	    ...
	    var define = function (that, key, value) {
	      ...
	      var data = getWeakData$1(anObject$9(key), true);
	    ...
	    defineBuiltIns$4(Prototype, {
	      ...
	      'delete': function (key) {
	        ...
	        return data && hasOwn$e(data, state.id) && delete data[state.id];
	      },
	      ...
	      has: function has(key) {
	        ...
	        return data && hasOwn$e(data, state.id);
	      }
	    });
	...
	// eslint-disable-next-line es/no-object-isextensible -- safe
	var isExtensible$1 = $Object$5.isExtensible;
	...
	var $WeakMap = collection$4('WeakMap', wrapper, collectionWeak);
	var WeakMapPrototype = $WeakMap.prototype;
	var nativeSet = uncurryThis$t(WeakMapPrototype.set);

	// Chakra Edge bug: adding frozen arrays to WeakMap unfreeze them
	var hasMSEdgeFreezingBug = function () {
	  return FREEZING$1 && fails$s(function () {
	...
	if (NATIVE_WEAK_MAP$1) if (IS_IE11) {
	  ...
	  defineBuiltIns$3(WeakMapPrototype, {
	    'delete': function (key) {
	      if (isObject$f(key) && !isExtensible$1(key)) {
	...
	var weakMap$2 = path$h.WeakMap;

	var parent$F = weakMap$2;


	var weakMap$1 = parent$F;
	...
	function scrollTo($elem, formId) {
	  if (opt[formId].scroll) {
	    if ($elem.length) {
	      ...
	      var scrollTop = $$W(window).scrollTop();
	      if (elemTop < $$W(window).scrollTop() || elemTop > scrollTop + window.innerHeight) {
	        $$W('html,body').animate({
	...
	class Format {
	  constructor(w) {
	    ...
	    _classPrivateFieldSet(_w, this, w);
	  }
	  price(amount) {
	    let result = _classPrivateFieldGet(_w, this).format_price.format;
	    amount = _parseFloat$1(amount);
	    result = result.replace('{sign}', amount < 0 ? '-' : '');
	    result = result.replace('{price}', this._formatNumber(Math.abs(amount), _classPrivateFieldGet(_w, this).format_price.decimals, _classPrivateFieldGet(_w, this).format_price.decimal_separator, _classPrivateFieldGet(_w, this).format_price.thousands_separator));
	    return result;
	  }
	...
	var find$2 = function (it) {
	  var own = it.find;
	  return it === ArrayPrototype$e || (isPrototypeOf$j(ArrayPrototype$e, it) && own === ArrayPrototype$e.find) ? method$d : own;
	};
	...
	var getJsonReplacerFunction = function (replacer) {
	  ...
	  for (var i = 0; i < rawLength; i++) {
	    ...
	    else if (typeof element == 'number' || classof$d(element) === 'Number' || classof$d(element) === 'String') push$6(keys, toString$d(element));
	  }
	...
	var NATIVE_SYMBOL$5 = symbolConstructorDetection$1;

	var $String$4 = String;
	var $stringify = getBuiltIn$b('JSON', 'stringify');
	var exec$2 = uncurryThis$r(/./.exec);
	var charAt$2 = uncurryThis$r(''.charAt);
	...
	var WRONG_SYMBOLS_CONVERSION = !NATIVE_SYMBOL$5 || fails$r(function () {
	...
	var stringifyWithSymbolsFix = function (it, replacer) {
	  ...
	  if (!isCallable$f($replacer) && (it === undefined || isSymbol$5(it))) return; // IE8 returns string on undefined
	  args[1] = function (key, value) {
	    // some old implementations (like WebKit) could pass numbers as keys
	    if (isCallable$f($replacer)) value = call$d($replacer, this, $String$4(key), value);
	...
	var stringify$2 = function stringify(it, replacer, space) {
	  return apply$2(path$g.JSON.stringify, null, arguments);
	};
	...
	var repeat$2 = function (it) {
	  ...
	  return typeof it == 'string' || it === StringPrototype$3
	    || (isPrototypeOf$i(StringPrototype$3, it) && own === StringPrototype$3.repeat) ? method$c : own;
	};

	var parent$C = repeat$2;

	var repeat$1 = parent$C;
	...
	// https://tc39.es/ecma262/#sec-array.prototype.foreach
	// eslint-disable-next-line es/no-array-prototype-foreach -- safe
	$$z({ target: 'Array', proto: true, forced: [].forEach !== forEach$5 }, {
	  forEach: forEach$5
	});

	var getBuiltInPrototypeMethod$b = getBuiltInPrototypeMethod$f;

	var forEach$4 = getBuiltInPrototypeMethod$b('Array', 'forEach');

	var parent$B = forEach$4;

	var forEach$3 = parent$B;

	var classof$c = classof$m;
	...
	var forEach$2 = function (it) {
	  ...
	  return it === ArrayPrototype$d || (isPrototypeOf$h(ArrayPrototype$d, it) && own === ArrayPrototype$d.forEach)
	    || hasOwn$d(DOMIterables$1, classof$c(it)) ? method$b : own;
	};
	...
	var deletePropertyOrThrow$2 = function (O, P) {
	  if (!delete O[P]) throw new $TypeError$b('Cannot delete property ' + tryToString$5(P) + ' of ' + tryToString$5(O));
	};
	...
	var splice$2 = function (it) {
	  var own = it.splice;
	  return it === ArrayPrototype$c || (isPrototypeOf$g(ArrayPrototype$c, it) && own === ArrayPrototype$c.splice) ? method$a : own;
	};

	var parent$A = splice$2;

	var splice$1 = parent$A;
	...
	// `Array.prototype.every` method
	// https://tc39.es/ecma262/#sec-array.prototype.every
	$$x({ target: 'Array', proto: true, forced: !STRICT_METHOD$1 }, {
	...
	var every$2 = function (it) {
	  var own = it.every;
	  return it === ArrayPrototype$b || (isPrototypeOf$f(ArrayPrototype$b, it) && own === ArrayPrototype$b.every) ? method$9 : own;
	};

	var parent$z = every$2;

	var every$1 = parent$z;
	...
	// deoptimization and serious performance degradation
	// https://github.com/zloirock/core-js/issues/679
	var IS_CONCAT_SPREADABLE_SUPPORT = V8_VERSION$2 >= 51 || !fails$p(function () {
	  var array = [];
	...
	var FORCED$4 = !IS_CONCAT_SPREADABLE_SUPPORT || !arrayMethodHasSpeciesSupport$5('concat');
	...
	var concat$2 = function (it) {
	  var own = it.concat;
	  return it === ArrayPrototype$a || (isPrototypeOf$e(ArrayPrototype$a, it) && own === ArrayPrototype$a.concat) ? method$8 : own;
	};

	var parent$y = concat$2;

	var concat$1 = parent$y;
	...
	var map$5 = function (it) {
	  var own = it.map;
	  return it === ArrayPrototype$9 || (isPrototypeOf$d(ArrayPrototype$9, it) && own === ArrayPrototype$9.map) ? method$7 : own;
	};
	...
	var filter$7 = getBuiltInPrototypeMethod$6('Array', 'filter');
	...
	var filter$6 = function (it) {
	  var own = it.filter;
	  return it === ArrayPrototype$8 || (isPrototypeOf$c(ArrayPrototype$8, it) && own === ArrayPrototype$8.filter) ? method$6 : own;
	};

	var parent$w = filter$6;

	var filter$5 = parent$w;
	...
	// FF99+ bug
	var BROKEN_ON_SPARSE$1 = fails$o(function () {
	...
	// `Array.prototype.includes` method
	// https://tc39.es/ecma262/#sec-array.prototype.includes
	$$t({ target: 'Array', proto: true, forced: BROKEN_ON_SPARSE$1 }, {
	...
	var includes$9 = getBuiltInPrototypeMethod$5('Array', 'includes');
	...
	var isRegexp$1 = function (it) {
	  var isRegExp;
	  return isObject$d(it) && ((isRegExp = it[MATCH$3]) !== undefined ? !!isRegExp : classof$b(it) === 'RegExp');
	};
	...
	$$s({ target: 'String', proto: true, forced: !correctIsRegExpLogic$1('includes') }, {
	...
	var includes$8 = getBuiltInPrototypeMethod$4('String', 'includes');
	...
	var includes$7 = function (it) {
	  var own = it.includes;
	  if (it === ArrayPrototype$7 || (isPrototypeOf$b(ArrayPrototype$7, it) && own === ArrayPrototype$7.includes)) return arrayMethod$1;
	...
	var parent$v = includes$7;

	var includes$6 = parent$v;
	...
	var trim$3 = function (it) {
	  ...
	  return typeof it == 'string' || it === StringPrototype$1
	    || (isPrototypeOf$a(StringPrototype$1, it) && own === StringPrototype$1.trim) ? method$5 : own;
	};
	...
	var indexOf$3 = function (it) {
	  var own = it.indexOf;
	  return it === ArrayPrototype$6 || (isPrototypeOf$9(ArrayPrototype$6, it) && own === ArrayPrototype$6.indexOf) ? method$4 : own;
	};
	...
	function stepComplete(params) {
	  ...
	  booklyAjax({
	    ...
	    if (response.final_step_url && !data.error) {
	      ...
	      let $qc = $$W('.bookly-js-qr', $container),
	      ...
	      $$W('.bookly-js-start-over', $container).on('click', function (e) {
	        e.stopPropagation();
	        e.preventDefault();
	        laddaStart(this);
	        stepService({
	      ...
	      $$W('.bookly-js-download-ics', $container).on('click', function (e) {
	        let ladda = laddaStart(this);
	        window.location = url + '&action=bookly_add_to_calendar&calendar=ics';
	        _setTimeout(() => ladda.stop(), 1500);
	      });
	      $$W('.bookly-js-download-invoice', $container).on('click', function (e) {
	        let ladda = laddaStart(this);
	        window.location = url + '&action=bookly_invoices_download_invoice';
	        _setTimeout(() => ladda.stop(), 1500);
	      });
	      $$W('.bookly-js-add-to-calendar', $container).on('click', function (e) {
	        e.preventDefault();
	        let ladda = laddaStart(this);
	        window.open(url + '&action=bookly_add_to_calendar&calendar=' + $$W(this).data('calendar'), '_blank');
	        _setTimeout(() => ladda.stop(), 1500);
	      });
	    }
	  });
	...
	function stepPayment(params) {
	  ...
	  booklyAjax({
	    ...
	    let $stripe_card_field = $$W('#bookly-stripe-card-field', $container);
	    ...
	    if ($stripe_card_field.length) {
	      if (response.stripe_publishable_key) {
	        ...
	        $$W('.pay-card .bookly-js-next-step', $container).prop('disabled', true);
	        let $details = $stripe_card_field.closest('.bookly-js-details');
	        $$W('.bookly-form-group', $details).hide();
	        $$W('.bookly-js-card-error', $details).text('Please call Stripe() with your publishable key. You used an empty string.');
	      }
	    }
	    var $payments = $$W('.bookly-js-payment', $container),
	      $apply_coupon_button = $$W('.bookly-js-apply-coupon', $container),
	      $coupon_input = $$W('input.bookly-user-coupon', $container),
	      $apply_gift_card_button = $$W('.bookly-js-apply-gift-card', $container),
	      $gift_card_input = $$W('input.bookly-user-gift', $container),
	      $apply_tips_button = $$W('.bookly-js-apply-tips', $container),
	      $applied_tips_button = $$W('.bookly-js-applied-tips', $container),
	      $tips_input = $$W('input.bookly-user-tips', $container),
	      $tips_error = $$W('.bookly-js-tips-error', $container),
	      $deposit_mode = $$W('input[type=radio][name=bookly-full-payment]', $container),
	      $coupon_info_text = $$W('.bookly-info-text-coupon', $container),
	      $buttons = $$W('.bookly-gateway-buttons,.bookly-js-details', $container),
	      $payment_details;
	    $payments.on('click', function () {
	      $buttons.hide();
	      $$W('.bookly-gateway-buttons.pay-' + $$W(this).val(), $container).show();
	      if ($$W(this).data('with-details') == 1) {
	        let $parent = $$W(this).closest('.bookly-list');
	        $payment_details = $$W('.bookly-js-details', $parent);
	        $$W('.bookly-js-details', $parent).show();
	      } else {
	    ...
	    $deposit_mode.on('change', function () {
	      let data = {
	        ...
	        form_id: params.form_id,
	        deposit_full: $$W(this).val()
	      };
	      $$W(this).hide();
	      $$W(this).prev().css('display', 'inline-block');
	      booklyAjax({
	        type: 'POST',
	        data: data
	      }).then(response => {
	    ...
	    $apply_gift_card_button.on('click', function (e) {
	      ...
	      booklyAjax({
	        ...
	        if ($$W('.bookly-js-payment[value!=free]', $container).length > 0) {
	    ...
	    $$W('.bookly-js-next-step', $container).on('click', function (e) {
	      e.stopPropagation();
	      e.preventDefault();
	      var ladda = laddaStart(this),
	      ...
	      if (customJS) {
	        try {
	          $$W.globalEval(customJS.next_button);
	        } catch (e) {
	          // Do nothing
	        }
	      }
	        ...
	        if (gateway === 'authorize_net') {
	          booklyAjax({
	            ...
	            data: {
	              ...
	              card: {
	                number: $$W('input[name="card_number"]', $payment_details).val(),
	                cvc: $$W('input[name="card_cvc"]', $payment_details).val(),
	                exp_month: $$W('select[name="card_exp_month"]', $payment_details).val(),
	                exp_year: $$W('select[name="card_exp_year"]', $payment_details).val()
	              },
	            ...
	            stripe.confirmCardPayment(response.data.intent_secret, {
	              ...
	              if (result.error) {
	                booklyAjax({
	                  ...
	                  $$W('.bookly-label-error', $stripe_container).remove();
	                  $stripe_container.append($$W('<div>', {
	                    class: 'bookly-label-error',
	    ...
	    $$W('.bookly-js-back-step', $container).on('click', function (e) {
	      e.stopPropagation();
	      e.preventDefault();
	      laddaStart(this);
	      stepDetails({
	...
	function handleBooklyAjaxError(response, form_id, $gateway_selector) {
	  if (response.error == 'cart_item_not_available') {
	    ...
	    $$W('.bookly-label-error', $gateway_selector).remove();
	    $gateway_selector.append($$W('<div>', {
	      class: 'bookly-label-error',
	...
	// Nashorn ~ JDK8 bug
	var NASHORN_BUG = getOwnPropertyDescriptor$1 && !$propertyIsEnumerable$2.call({ 1: 2 }, 1);
	...
	var requireObjectCoercible$6 = function (it) {
	  if (isNullOrUndefined$4(it)) throw $TypeError$9("Can't call method on " + it);
	  return it;
	};
	...
	var getBuiltIn$a = function (namespace, method) {
	  return arguments.length < 2 ? aFunction(path$d[namespace]) || aFunction(global$g[namespace])
	    : path$d[namespace] && path$d[namespace][method] || global$g[namespace] && global$g[namespace][method];
	};
	...
	var isSymbol$4 = USE_SYMBOL_AS_UID$1 ? function (it) {
	  ...
	  return isCallable$b($Symbol) && isPrototypeOf$8($Symbol.prototype, $Object$3(it));
	};
	...
	var ordinaryToPrimitive$1 = function (input, pref) {
	  var fn, val;
	  if (pref === 'string' && isCallable$9(fn = input.toString) && !isObject$b(val = call$9(fn, input))) return val;
	  if (isCallable$9(fn = input.valueOf) && !isObject$b(val = call$9(fn, input))) return val;
	  if (pref !== 'string' && isCallable$9(fn = input.toString) && !isObject$b(val = call$9(fn, input))) return val;
	...
	var wellKnownSymbol$k = function (name) {
	  if (!hasOwn$c(WellKnownSymbolsStore$2, name)) {
	    WellKnownSymbolsStore$2[name] = NATIVE_SYMBOL$3 && hasOwn$c(Symbol$4, name)
	      ? Symbol$4[name]
	...
	*/
	var _export = function (options, source) {
	  ...
	  var target = GLOBAL ? path$c : path$c[TARGET] || createNonEnumerableProperty$5(path$c, TARGET, {})[TARGET];
	  var targetPrototype = target.prototype;
	  ...
	  for (key in source) {
	    ...
	    // make static versions for prototype methods
	    else if (PROTO && isCallable$7(sourceProperty)) resultProperty = uncurryThis$h(sourceProperty);
	    // default case
	    else resultProperty = sourceProperty;
	    ...
	    if (PROTO) {
	      ...
	      if (!hasOwn$a(path$c, VIRTUAL_PROTOTYPE)) {
	        createNonEnumerableProperty$5(path$c, VIRTUAL_PROTOTYPE, {});
	      }
	      // export virtual prototype methods
	      createNonEnumerableProperty$5(path$c[VIRTUAL_PROTOTYPE], key, sourceProperty);
	      // export real prototype methods
	      if (options.real && targetPrototype && (FORCED || !targetPrototype[key])) {
	...
	$$o({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$1 }, {
	  slice: function slice(start, end) {
	    ...
	    if (isArray$1(O)) {
	      Constructor = O.constructor;
	      // cross-realm fallback
	      if (isConstructor$2(Constructor) && (Constructor === $Array$3 || isArray$1(Constructor.prototype))) {
	        Constructor = undefined;
	...
	var slice$2 = function (it) {
	  var own = it.slice;
	  return it === ArrayPrototype$5 || (isPrototypeOf$7(ArrayPrototype$5, it) && own === ArrayPrototype$5.slice) ? method$3 : own;
	};

	var parent$r = slice$2;

	var slice$1 = parent$r;
	...
	var filter$2 = function (it) {
	  var own = it.filter;
	  return it === ArrayPrototype$4 || (isPrototypeOf$6(ArrayPrototype$4, it) && own === ArrayPrototype$4.filter) ? method$2 : own;
	};
	...
	var _parseInt$3 = path$a.parseInt;

	var parent$p = _parseInt$3;

	var _parseInt$2 = parent$p;
	...
	var parent$o = includes$2;

	var includes$1 = parent$o;
	...
	var objectKeysInternal = function (object, names) {
	  ...
	  var result = [];
	  var key;
	  for (key in O) !hasOwn$7(hiddenKeys$4, key) && hasOwn$7(O, key) && push$4(result, key);
	  // Don't enum bug & hidden keys
	...
	var NEW_ITERATOR_PROTOTYPE = !isObject$3(IteratorPrototype$1) || fails$8(function () {
	  var test = {};
	  // FF44- legacy iterators case
	...
	var setToStringTag$6 = function (it, TAG, STATIC, SET_METHOD) {
	  if (it) {
	    ...
	    if (!hasOwn$5(target, TO_STRING_TAG$1)) {
	      defineProperty$c(target, TO_STRING_TAG$1, { configurable: true, value: TAG });
	    }
	...
	var iteratorCreateConstructor = function (IteratorConstructor, NAME, next, ENUMERABLE_NEXT) {
	  var TO_STRING_TAG = NAME + ' Iterator';
	  IteratorConstructor.prototype = create$6(IteratorPrototype, { next: createPropertyDescriptor$1(+!ENUMERABLE_NEXT, next) });
	...
	var setMetadata = function (it) {
	  defineProperty$b(it, METADATA$1, { value: {
	...
	var onFreeze = function (it) {
	  if (FREEZING && REQUIRED && isExtensible(it) && !hasOwn$4(it, METADATA$1)) setMetadata(it);
	  return it;
	};
	...
	var getIteratorMethod$3 = function (it) {
	  if (!isNullOrUndefined$2(it)) return getMethod$1(it, ITERATOR)
	...
	var internalStateGetterFor$2 = InternalStateModule$4.getterFor;
	...
	var collection$3 = function (CONSTRUCTOR_NAME, wrapper, common) {
	  ...
	  if (!DESCRIPTORS$7 || !isCallable(NativeConstructor)
	    ...
	    Constructor = wrapper(function (target, iterable) {
	      setInternalState$4(anInstance$2(target, Prototype), {
	        type: CONSTRUCTOR_NAME,
	        collection: new NativeConstructor()
	      });
	      if (iterable != undefined) iterate$3(iterable, target[ADDER], { that: target, AS_ENTRIES: IS_MAP });
	    });
	    ...
	    IS_WEAK || defineProperty$a(Prototype, 'size', {
	      configurable: true,
	      get: function () {
	        return getInternalState(this).collection.size;
	      }
	...
	var setSpecies$2 = function (CONSTRUCTOR_NAME) {
	  ...
	  if (DESCRIPTORS$6 && Constructor && !Constructor[SPECIES]) {
	...
	var fastKey$1 = internalMetadataExports.fastKey;
	...
	var collectionStrong$4 = {
	  getConstructor: function (wrapper, CONSTRUCTOR_NAME, IS_MAP, ADDER) {
	    ...
	    if (DESCRIPTORS$5) defineBuiltInAccessor$2(Prototype, 'size', {
	      configurable: true,
	      get: function () {
	...
	// `Object.create` method
	// https://tc39.es/ecma262/#sec-object.create
	$$g({ target: 'Object', stat: true, sham: !DESCRIPTORS$4 }, {
	  create: create$4
	});
	...
	var fastKey = internalMetadataExports$1.fastKey;
	...
	$$e({ target: 'Map', stat: true, forced: IS_PURE }, {
	...
	var getOwnPropertyNamesExternal = objectGetOwnPropertyNamesExternal$1;
	...
	var tryToString = tryToString$a;
	var shared$1 = sharedExports$1;
	...
	var $$9 = _export$1;
	var NATIVE_SYMBOL = symbolConstructorDetection$1;
	var fails$2 = fails$N;
	...
	*/
	...
	function slide(node) {
	  ...
	  const capitalized_secondary_properties = _mapInstanceProperty(secondary_properties).call(secondary_properties, e => {
	    var _context9;
	    return _concatInstanceProperty(_context9 = "".concat(e[0].toUpperCase())).call(_context9, _sliceInstanceProperty$1(e).call(e, 1));
	  });
	...
	/* ../../../../../../../assets/js/frontend/components/Spinner.svelte generated by Svelte v4.2.14 */
	function create_fragment$5(ctx) {
	  ...
	  return {
	    c() {
	      ...
	      attr(div, "class", "bookly-flex bookly-flex-col bookly-justify-center bookly-items-center bookly-w-full");
	...
	/* ../../../../../../../assets/js/frontend/components/Button.svelte generated by Svelte v4.2.14 */
	...
	function create_fragment$4(ctx) {
	  ...
	  let mounted;
	  let dispose;
	  let if_block = /*loading*/ctx[2] && create_if_block$4();
	  ...
	  return {
	    c() {
	      ...
	      toggle_class(span, "bookly-opacity-0", /*loading*/ctx[2]);
	      attr(button, "type", "button");
	      attr(button, "title", /*title*/ctx[1]);
	      attr(button, "class", button_class_value = "" + ( /*classes*/ctx[4] + " " + /*buttonClasses*/ctx[5] + " bookly-drop-shadow-none bookly-box-border"));
	    ...
	    m(target, anchor) {
	      ...
	      current = true;
	      if (!mounted) {
	        dispose = listen(button, "click", stop_propagation( /*click_handler*/ctx[17]));
	        mounted = true;
	      }
	    },
	    p(ctx, _ref) {
	      ...
	      if (!current || dirty & /*classes, buttonClasses*/48 && button_class_value !== (button_class_value = "" + ( /*classes*/ctx[4] + " " + /*buttonClasses*/ctx[5] + " bookly-drop-shadow-none bookly-box-border"))) {
	      ...
	      if (!current || dirty & /*classes, buttonClasses, disabled*/49) {
	        toggle_class(button, "pointer-events-none", /*disabled*/ctx[0]);
	      }
	      if (!current || dirty & /*classes, buttonClasses, disabled*/49) {
	        toggle_class(button, "bookly-opacity-50", /*disabled*/ctx[0]);
	...
	function instance$4($$self, $$props, $$invalidate) {
	  ...
	  $$self.$$set = $$props => {
	    ...
	    if ('bordered' in $$props) $$invalidate(7, bordered = $$props.bordered);
	    if ('paddings' in $$props) $$invalidate(8, paddings = $$props.paddings);
	    if ('margins' in $$props) $$invalidate(9, margins = $$props.margins);
	  ...
	  $$self.$$.update = () => {
	    if ($$self.$$.dirty & /*type, color, disabled, shadows, buttonClasses, loading, hover, rounded, bordered, paddings, size, margins*/32741) {
	      {
	        switch (type) {
	          case 'secondary':
	            $$invalidate(5, buttonClasses = 'bookly-text-slate-600 bookly-bg-white bookly-border-slate-600');
	            $$invalidate(14, hover = 'hover:bookly-text-slate-50 hover:bookly-bg-slate-400 hover:bookly-border-slate-400');
	            break;
	          case 'white':
	            $$invalidate(5, buttonClasses = 'bookly-text-slate-600 bookly-bg-white bookly-border-slate-600');
	            $$invalidate(14, hover = 'hover:bookly-text-slate-50 hover:bookly-bg-gray-400 hover:bookly-border-gray-400');
	            break;
	          case 'transparent':
	            $$invalidate(5, buttonClasses = (color ? color : 'bookly-text-slate-600') + ' bookly-bg-transparent bookly-border-slate-600');
	            $$invalidate(14, hover = 'hover:bookly-text-slate-50 hover:bookly-bg-gray-400 hover:bookly-border-gray-400');
	            break;
	          case 'bookly':
	            $$invalidate(5, buttonClasses = 'text-bookly bookly-bg-white border-bookly');
	            $$invalidate(14, hover = 'hover:bookly-text-white hover:bg-bookly hover:bookly-opacity-80 hover:border-bookly');
	            break;
	          case 'bookly-active':
	            $$invalidate(5, buttonClasses = 'bg-bookly bookly-text-white border-bookly');
	            $$invalidate(14, hover = 'hover:bookly-text-slate-100 hover:bg-bookly hover:border-bookly');
	            break;
	          case 'bookly-gray':
	            $$invalidate(5, buttonClasses = 'text-bookly bookly-bg-gray-200 border-bookly');
	            $$invalidate(14, hover = 'hover:bookly-text-white hover:bg-bookly hover:border-bookly');
	            break;
	          case 'link':
	            $$invalidate(5, buttonClasses = 'bookly-border-none bookly-rounded-none bookly-p-0 ' + (disabled ? 'bookly-text-gray-600' : 'text-bookly'));
	            $$invalidate(14, hover = 'hover:bookly-text-gray-600');
	            $$invalidate(6, rounded = false);
	            $$invalidate(7, bordered = false);
	            $$invalidate(8, paddings = false);
	            $$invalidate(9, margins = false);
	            $$invalidate(10, shadows = false);
	            $$invalidate(11, size = 'link');
	            break;
	          case 'calendar-normal':
	            $$invalidate(5, buttonClasses = 'text-bookly border-bookly bookly-rounded-none bookly-m-0 ' + (disabled ? 'bookly-bg-slate-50 hover:text-bookly' : 'bookly-bg-white'));
	            $$invalidate(14, hover = 'hover:bg-bookly hover:border-bookly ' + (disabled ? 'hover:text-bookly' : 'hover:bookly-text-white'));
	            $$invalidate(6, rounded = false);
	            $$invalidate(7, bordered = false);
	            $$invalidate(8, paddings = false);
	            $$invalidate(9, margins = false);
	          ...
	          case 'calendar-active':
	            $$invalidate(5, buttonClasses = 'bg-bookly bookly-text-white border-bookly bookly-rounded-none bookly-m-0');
	            $$invalidate(14, hover = 'hover:bookly-text-slate-200');
	            $$invalidate(6, rounded = false);
	            $$invalidate(7, bordered = false);
	            $$invalidate(8, paddings = false);
	            $$invalidate(9, margins = false);
	          ...
	          case 'calendar-inactive':
	            $$invalidate(5, buttonClasses = 'bookly-text-gray-400 border-bookly bookly-rounded-none bookly-m-0 ' + (disabled ? 'bookly-bg-slate-50' : 'bookly-bg-white'));
	            $$invalidate(14, hover = 'hover:bookly-text-white hover:bookly-bg-gray-400 hover:border-bookly');
	            $$invalidate(6, rounded = false);
	            $$invalidate(7, bordered = false);
	            $$invalidate(8, paddings = false);
	            $$invalidate(9, margins = false);
	            ...
	            break;
	          default:
	            $$invalidate(5, buttonClasses = 'bookly-text-black bookly-bg-gray-100 bookly-border-gray');
	            $$invalidate(14, hover = 'hover:bookly-text-slate-50 hover:bookly-bg-gray-400');
	            break;
	        }
	        if (!shadows) {
	          $$invalidate(5, buttonClasses += ' bookly-shadow-none');
	        }
	        if (!disabled && !loading && shadows) {
	          $$invalidate(5, buttonClasses += ' active:bookly-shadow-md');
	        }
	        if (!disabled && !loading) {
	          $$invalidate(5, buttonClasses += ' ' + hover);
	        }
	        if (rounded) {
	          $$invalidate(5, buttonClasses += ' bookly-rounded');
	        }
	        if (bordered) {
	          $$invalidate(5, buttonClasses += ' bookly-border bookly-border-solid');
	        }
	        if (paddings) {
	          switch (size) {
	            case 'lg':
	              $$invalidate(5, buttonClasses += ' bookly-px-5 bookly-py-0');
	              break;
	            default:
	              $$invalidate(5, buttonClasses += ' bookly-px-4 bookly-py-0');
	              break;
	          }
	        }
	        if (margins) {
	          $$invalidate(5, buttonClasses += ' bookly-ms-2 bookly-my-0 bookly-me-0');
	        }
	        switch (size) {
	          case 'link':
	          case 'custom':
	            break;
	          case 'lg':
	            $$invalidate(5, buttonClasses += ' bookly-text-xl bookly-h-14');
	            break;
	          default:
	            $$invalidate(5, buttonClasses += ' bookly-text-lg bookly-h-10');
	            break;
	        }
	        if (margins) {
	          $$invalidate(5, buttonClasses += ' bookly-relative');
	        }
	      }
	    }
	  };
	  return [disabled, title, loading, styles, classes, buttonClasses, rounded, bordered, paddings, margins, shadows, size, type, color, hover, $$scope, slots, click_handler];
	}
	...
	function create_if_block$3(ctx) {
	  ...
	  button0 = new Button({
	    props: {
	      class: "bookly-grow-0 bookly-rounded bookly-border-none focus:bookly-border-none focus:bookly-outline-none bookly-leading-normal bookly-calendar-left-button-mark bookly-m-0 bookly-text-xl bookly-shadow-none",
	      type: "white",
	      bordered: false,
	      rounded: false,
	      margins: false,
	  ...
	  button0.$on("click", /*onClickLeft*/ctx[14]);
	  button1 = new Button({
	    props: {
	      class: "bookly-grow bookly-rounded bookly-border-none focus:bookly-border-none focus:bookly-outline-none bookly-leading-normal bookly-calendar-middle-button-mark bookly-m-0 bookly-text-lg bookly-shadow-none",
	      type: "white",
	      bordered: false,
	      rounded: false,
	      margins: false,
	  ...
	  button1.$on("click", /*changeView*/ctx[13]);
	  button2 = new Button({
	    props: {
	      class: "bookly-grow-0 bookly-rounded bookly-border-none focus:bookly-border-none focus:bookly-outline-none bookly-leading-normal bookly-calendar-right-button-mark bookly-m-0 bookly-text-xl bookly-shadow-none",
	      type: "white",
	      bordered: false,
	      rounded: false,
	      margins: false,
	  ...
	  button2.$on("click", /*onClickRight*/ctx[15]);
	  const if_block_creators = [create_if_block_1$2, create_if_block_3$1, create_else_block];
	  const if_blocks = [];
	  ...
	  return {
	    c() {
	      ...
	      attr(div1, "class", "bookly-w-full bookly-border-b bookly-border-slate-300 bookly-mb-2 bookly-pb-1 bookly-calendar-controls-mark");
	      attr(div2, "class", "bookly-w-full");
	      attr(div3, "class", div3_class_value = "bookly-w-full bookly-min-h-full bookly-relative " + ( /*border*/ctx[6] ? 'bookly-border bookly-p-1 bookly-rounded' : ''));
	    },
	    m(target, anchor) {
	    ...
	    p(ctx, dirty) {
	      ...
	      if (dirty[0] & /*rtl*/1024 | dirty[1] & /*$$scope*/4096) {
	      ...
	      if (dirty[0] & /*title*/2048 | dirty[1] & /*$$scope*/4096) {
	      ...
	      if (!current || dirty[0] & /*border*/64 && div3_class_value !== (div3_class_value = "bookly-w-full bookly-min-h-full bookly-relative " + ( /*border*/ctx[6] ? 'bookly-border bookly-p-1 bookly-rounded' : ''))) {
	...
	// (232:16) <Button class="bookly-grow bookly-rounded bookly-border-none focus:bookly-border-none focus:bookly-outline-none bookly-leading-normal bookly-calendar-middle-button-mark bookly-m-0 bookly-text-lg bookly-shadow-none" type="white" bordered={false} rounded={false} margins={false} on:click={changeView}>
	function create_default_slot_4(ctx) {
	  ...
	  return {
	    ...
	    p(ctx, dirty) {
	      if (dirty[0] & /*title*/2048) set_data(t, /*title*/ctx[11]);
	    },
	    d(detaching) {
	      if (detaching) {
	        detach(t);
	...
	// (233:16) <Button                          class="bookly-grow-0 bookly-rounded bookly-border-none focus:bookly-border-none focus:bookly-outline-none bookly-leading-normal bookly-calendar-right-button-mark bookly-m-0 bookly-text-xl bookly-shadow-none"                          type="white"                          bordered={false}                          rounded={false}                          margins={false}                          disabled={loading || (limits && limits.hasOwnProperty('end') && month >= limits.end.getMonth() && year === limits.end.getFullYear())}                          on:click={onClickRight}                  >
	...
	function create_else_block(ctx) {
	  ...
	  return {
	    c() {
	      ...
	      attr(div, "class", "bookly-w-full bookly-text-center bookly-grid bookly-grid-cols-3 bookly-gap-y-4 bookly-calendar-years-mark");
	    },
	    m(target, anchor) {
	      insert(target, div, anchor);
	      for (let i = 0; i < each_blocks.length; i += 1) {
	...
	function create_if_block_3$1(ctx) {
	  ...
	  return {
	    c() {
	      ...
	      attr(div, "class", "bookly-w-full bookly-text-center bookly-grid bookly-grid-cols-4 bookly-gap-y-4 bookly-calendar-months-mark");
	    },
	    m(target, anchor) {
	      insert(target, div, anchor);
	      for (let i = 0; i < each_blocks.length; i += 1) {
	    ...
	    p(ctx, dirty) {
	      if (dirty[0] & /*month, dispatch, view, datePicker*/4372) {
	...
	function create_if_block_1$2(ctx) {
	  ...
	  let if_block = /*loading*/ctx[3] && create_if_block_2$2();
	  ...
	  return {
	    c() {
	      ...
	      attr(div0, "class", "bookly-flex bookly-flex-row fw-bold bookly-text-center bookly-text-muted bookly-w-full bookly-border-b bookly-mb-0 bookly-pb-2 bookly-text-gray-500 bookly-font-bold bookly-max-w-full");
	      attr(div1, "class", "bookly-relative");
	    ...
	    p(ctx, dirty) {
	      ...
	      if (dirty[0] & /*days, onClickDate*/66048) {
	...
	// (298:28) <Button                                      type="bookly"                                      bordered={false}                                      rounded={false}                                      paddings={false}                                      margins={false}                                      class="bookly-border-none focus:bookly-border-none focus:bookly-outline-none bookly-leading-normal bookly-px-2 bookly-py-0 bookly-m-0 bookly-text-xl"                                      on:click={() => {year = year + _year - 4; view='month'}}                              >
	function create_default_slot_2(ctx) {
	  let t_value = /*year*/ctx[1] + /*_year*/ctx[42] - 4 + "";
	  let t;
	  return {
	    c() {
	      t = text(t_value);
	    ...
	    p(ctx, dirty) {
	      if (dirty[0] & /*year*/2 && t_value !== (t_value = /*year*/ctx[1] + /*_year*/ctx[42] - 4 + "")) set_data(t, t_value);
	    },
	    d(detaching) {
	      if (detaching) {
	        detach(t);
	...
	// (296:20) {#each {length: 9} as _,_year}
	function create_each_block_4(ctx) {
	  ...
	  function click_handler_2() {
	    return /*click_handler_2*/ctx[29]( /*_year*/ctx[42]);
	  }
	  button = new Button({
	    props: {
	      type: "bookly",
	      ...
	      paddings: false,
	      margins: false,
	      class: "bookly-border-none focus:bookly-border-none focus:bookly-outline-none bookly-leading-normal bookly-px-2 bookly-py-0 bookly-m-0 bookly-text-xl",
	      $$slots: {
	  ...
	  return {
	    ...
	    p(new_ctx, dirty) {
	      ...
	      if (dirty[0] & /*year*/2 | dirty[1] & /*$$scope*/4096) {
	...
	// (280:28) <Button                                      type="bookly"                                      class="bookly-border-none focus:bookly-border-none focus:bookly-outline-none bookly-leading-normal bookly-px-2 bookly-py-0 bookly-m-0 bookly-text-xl"                                      bordered={false}                                      rounded={false}                                      margins={false}                                      paddings={false}                                      on:click={() => {month = _month; dispatch('month-change'); view='calendar'}}                              >
	function create_default_slot_1(ctx) {
	  let t_value = /*datePicker*/ctx[4].monthNamesShort[/*_month*/ctx[40]] + "";
	  let t;
	  return {
	    c() {
	      t = text(t_value);
	    ...
	    p(ctx, dirty) {
	      if (dirty[0] & /*datePicker*/16 && t_value !== (t_value = /*datePicker*/ctx[4].monthNamesShort[/*_month*/ctx[40]] + "")) set_data(t, t_value);
	    },
	    d(detaching) {
	      if (detaching) {
	        detach(t);
	...
	// (278:20) {#each {length: 12} as _,_month}
	function create_each_block_3(ctx) {
	  ...
	  function click_handler_1() {
	    return /*click_handler_1*/ctx[28]( /*_month*/ctx[40]);
	  }
	  button = new Button({
	    props: {
	      type: "bookly",
	  ...
	  return {
	    ...
	    p(new_ctx, dirty) {
	      ctx = new_ctx;
	      const button_changes = {};
	      if (dirty[0] & /*datePicker*/16 | dirty[1] & /*$$scope*/4096) {
	        button_changes.$$scope = {
	          dirty,
	          ctx
	        };
	...
	// (248:24) {#each {length: 7} as _, i}
	function create_each_block_2(ctx) {
	  let div;
	  let t_value = /*datePicker*/ctx[4].dayNamesShort[( /*i*/ctx[35] + /*datePicker*/ctx[4].firstDay) % 7] + "";
	  let t;
	  return {
	    c() {
	      div = element("div");
	      t = text(t_value);
	      attr(div, "class", "bookly-flex-1 bookly-px-0 bookly-mx-0.5 bookly-overflow-hidden bookly-text-base");
	    },
	    m(target, anchor) {
	      insert(target, div, anchor);
	      append(div, t);
	    ...
	    p(ctx, dirty) {
	      if (dirty[0] & /*datePicker*/16 && t_value !== (t_value = /*datePicker*/ctx[4].dayNamesShort[( /*i*/ctx[35] + /*datePicker*/ctx[4].firstDay) % 7] + "")) set_data(t, t_value);
	    },
	    d(detaching) {
	      if (detaching) {
	        detach(div);
	...
	// (261:36) <Button                                              type={days[i * 7 + j].active ? 'calendar-active' : (days[i * 7 + j].current ? 'calendar-normal' : 'calendar-inactive')}                                              class="bookly-text-base bookly-leading-4 bookly-shadow-none bookly-flex-1 bookly-py-2 bookly-px-0 bookly-border-none focus:bookly-border-none focus:bookly-outline-none {days[i * 7 + j].disabled ? '' : 'hover:bookly-opacity-75'} {(days[i * 7 + j].current ? 'bookly-calendar-current-month-mark' : '')}"                                              bordered={false}                                              margins={false}                                              on:click={() => onClickDate(days[i*7+j])}                                              disabled={days[i*7+j].disabled}                                      >
	function create_default_slot(ctx) {
	  let t_value = /*days*/ctx[9][/*i*/ctx[35] * 7 + /*j*/ctx[37]].title + "";
	  let t;
	  return {
	    c() {
	      t = text(t_value);
	    ...
	    p(ctx, dirty) {
	      if (dirty[0] & /*days*/512 && t_value !== (t_value = /*days*/ctx[9][/*i*/ctx[35] * 7 + /*j*/ctx[37]].title + "")) set_data(t, t_value);
	    },
	    d(detaching) {
	      if (detaching) {
	        detach(t);
	...
	// (260:32) {#each {length: 7} as _, j}
	function create_each_block_1(ctx) {
	  let button;
	  let current;
	  function click_handler() {
	    return /*click_handler*/ctx[27]( /*i*/ctx[35], /*j*/ctx[37]);
	  }
	  button = new Button({
	    props: {
	      type: /*days*/ctx[9][/*i*/ctx[35] * 7 + /*j*/ctx[37]].active ? 'calendar-active' : /*days*/ctx[9][/*i*/ctx[35] * 7 + /*j*/ctx[37]].current ? 'calendar-normal' : 'calendar-inactive',
	      class: "bookly-text-base bookly-leading-4 bookly-shadow-none bookly-flex-1 bookly-py-2 bookly-px-0 bookly-border-none focus:bookly-border-none focus:bookly-outline-none " + ( /*days*/ctx[9][/*i*/ctx[35] * 7 + /*j*/ctx[37]].disabled ? '' : 'hover:bookly-opacity-75') + " " + ( /*days*/ctx[9][/*i*/ctx[35] * 7 + /*j*/ctx[37]].current ? 'bookly-calendar-current-month-mark' : ''),
	      bordered: false,
	      margins: false,
	      disabled: /*days*/ctx[9][/*i*/ctx[35] * 7 + /*j*/ctx[37]].disabled,
	      $$slots: {
	  ...
	  return {
	    ...
	    p(new_ctx, dirty) {
	      ctx = new_ctx;
	      const button_changes = {};
	      if (dirty[0] & /*days*/512) button_changes.type = /*days*/ctx[9][/*i*/ctx[35] * 7 + /*j*/ctx[37]].active ? 'calendar-active' : /*days*/ctx[9][/*i*/ctx[35] * 7 + /*j*/ctx[37]].current ? 'calendar-normal' : 'calendar-inactive';
	      if (dirty[0] & /*days*/512) button_changes.class = "bookly-text-base bookly-leading-4 bookly-shadow-none bookly-flex-1 bookly-py-2 bookly-px-0 bookly-border-none focus:bookly-border-none focus:bookly-outline-none " + ( /*days*/ctx[9][/*i*/ctx[35] * 7 + /*j*/ctx[37]].disabled ? '' : 'hover:bookly-opacity-75') + " " + ( /*days*/ctx[9][/*i*/ctx[35] * 7 + /*j*/ctx[37]].current ? 'bookly-calendar-current-month-mark' : '');
	      if (dirty[0] & /*days*/512) button_changes.disabled = /*days*/ctx[9][/*i*/ctx[35] * 7 + /*j*/ctx[37]].disabled;
	      if (dirty[0] & /*days*/512 | dirty[1] & /*$$scope*/4096) {
	        button_changes.$$scope = {
	          dirty,
	          ctx
	        };
	...
	// (258:24) {#each {length: parseInt(days.length / 7)} as _, i}
	...
	function instance$3($$self, $$props, $$invalidate) {
	  ...
	  function forceLoadSchedule() {
	    $$invalidate(19, holidays = []);
	    $$invalidate(20, loadedMonths = []);
	  ...
	  function _loadSchedule() {
	    if (!_includesInstanceProperty(loadedMonths).call(loadedMonths, monthWithYear)) {
	      loadSchedule(month + 1, year).done(response => {
	        $$invalidate(20, loadedMonths = [...new _Set$1([...loadedMonths, ...((response === null || response === void 0 ? void 0 : response.data.parsed_months) || [])])]);
	        $$invalidate(19, holidays = [...new _Set$1([...holidays, ...((response === null || response === void 0 ? void 0 : response.data.holidays) || [])])]);
	        if (date === null) {
	          let firstDate = new Date();
	          while (_includesInstanceProperty(holidays).call(holidays, $$invalidate(17, date = formatDate(firstDate)))) {
	            firstDate.setDate(firstDate.getDate() + 1);
	          }
	          $$invalidate(17, date = formatDate(firstDate));
	  ...
	  function onClickDate(_day) {
	    ...
	    $$invalidate(17, date = formatDate(_day.date));
	    dispatch('change');
	  }
	  const click_handler = (i, j) => onClickDate(days[i * 7 + j]);
	  const click_handler_1 = _month => {
	    $$invalidate(2, month = _month);
	    dispatch('month-change');
	    $$invalidate(8, view = 'calendar');
	  };
	  const click_handler_2 = _year => {
	    $$invalidate(1, year = year + _year - 4);
	    $$invalidate(8, view = 'month');
	  };
	  ...
	  $$self.$$set = $$props => {
	    ...
	    if ('startDate' in $$props) $$invalidate(18, startDate = $$props.startDate);
	    if ('holidays' in $$props) $$invalidate(19, holidays = $$props.holidays);
	    if ('datePicker' in $$props) $$invalidate(4, datePicker = $$props.datePicker);
	    if ('maxDays' in $$props) $$invalidate(21, maxDays = $$props.maxDays);
	    if ('limits' in $$props) $$invalidate(0, limits = $$props.limits);
	    if ('disabledWeekDays' in $$props) $$invalidate(22, disabledWeekDays = $$props.disabledWeekDays);
	    if ('loadSchedule' in $$props) $$invalidate(23, loadSchedule = $$props.loadSchedule);
	    if ('year' in $$props) $$invalidate(1, year = $$props.year);
	    if ('month' in $$props) $$invalidate(2, month = $$props.month);
	    if ('loadedMonths' in $$props) $$invalidate(20, loadedMonths = $$props.loadedMonths);
	  ...
	  $$self.$$.update = () => {
	    ...
	    if ($$self.$$.dirty[0] & /*startDate*/262144) {
	      if (startDate === null) {
	        $$invalidate(18, startDate = new Date());
	      } else {
	    ...
	    if ($$self.$$.dirty[0] & /*month, year*/6) {
	      $$invalidate(25, monthWithYear = month + '-' + year);
	    }
	    if ($$self.$$.dirty[0] & /*loadSchedule, view, year, month, lastDate, monthWithYear*/109052166) {
	      if (loadSchedule !== false && view === 'calendar' && (year || month)) {
	        if (lastDate !== monthWithYear) {
	          $$invalidate(26, lastDate = monthWithYear);
	          $$invalidate(3, loading = true);
	        }
	      }
	    }
	    if ($$self.$$.dirty[0] & /*loadSchedule, loading*/8388616) {
	      if (loadSchedule !== false && loading) {
	        _loadSchedule();
	      }
	    }
	    if ($$self.$$.dirty[0] & /*year, month, datePicker, days, limits, disabledWeekDays, loadedMonths, monthWithYear, holidays, date*/39453207) {
	      {
	    ...
	    if ($$self.$$.dirty[0] & /*view, datePicker, month, year*/278) {
	      if (view) {
	        switch (view) {
	          case 'calendar':
	            $$invalidate(11, title = datePicker.monthNamesShort[month] + ' ' + year);
	            break;
	          case 'month':
	          case 'year':
	            $$invalidate(11, title = year);
	            break;
	        }
	      }
	    }
	  };
	  return [limits, year, month, loading, datePicker, show, border, el, view, days, rtl, title, dispatch, changeView, onClickLeft, onClickRight, onClickDate, date, startDate, holidays, loadedMonths, maxDays, disabledWeekDays, loadSchedule, forceLoadSchedule, monthWithYear, lastDate, click_handler, click_handler_1, click_handler_2, div3_binding];
	}
	...
	function stepDetails(params) {
	  ...
	  booklyAjax({
	    ...
	    $$W(document.body).trigger('bookly.render.step_detail', [$container]);
	    // Init.
	    let phone_number = '',
	      $guest_info = $$W('.bookly-js-guest', $container),
	      $phone_field = $$W('.bookly-js-user-phone-input', $container),
	      $email_field = $$W('.bookly-js-user-email', $container),
	      $email_confirm_field = $$W('.bookly-js-user-email-confirm', $container),
	      $birthday_day_field = $$W('.bookly-js-select-birthday-day', $container),
	      $birthday_month_field = $$W('.bookly-js-select-birthday-month', $container),
	      $birthday_year_field = $$W('.bookly-js-select-birthday-year', $container),
	      $address_country_field = $$W('.bookly-js-address-country', $container),
	      $address_state_field = $$W('.bookly-js-address-state', $container),
	      $address_postcode_field = $$W('.bookly-js-address-postcode', $container),
	      $address_city_field = $$W('.bookly-js-address-city', $container),
	      $address_street_field = $$W('.bookly-js-address-street', $container),
	      $address_street_number_field = $$W('.bookly-js-address-street_number', $container),
	      $address_additional_field = $$W('.bookly-js-address-additional_address', $container),
	      $address_country_error = $$W('.bookly-js-address-country-error', $container),
	      $address_state_error = $$W('.bookly-js-address-state-error', $container),
	      $address_postcode_error = $$W('.bookly-js-address-postcode-error', $container),
	      $address_city_error = $$W('.bookly-js-address-city-error', $container),
	      $address_street_error = $$W('.bookly-js-address-street-error', $container),
	      $address_street_number_error = $$W('.bookly-js-address-street_number-error', $container),
	      $address_additional_error = $$W('.bookly-js-address-additional_address-error', $container),
	      $birthday_day_error = $$W('.bookly-js-select-birthday-day-error', $container),
	      $birthday_month_error = $$W('.bookly-js-select-birthday-month-error', $container),
	      $birthday_year_error = $$W('.bookly-js-select-birthday-year-error', $container),
	      $full_name_field = $$W('.bookly-js-full-name', $container),
	      $first_name_field = $$W('.bookly-js-first-name', $container),
	      $last_name_field = $$W('.bookly-js-last-name', $container),
	      $notes_field = $$W('.bookly-js-user-notes', $container),
	      $custom_field = $$W('.bookly-js-custom-field', $container),
	      $info_field = $$W('.bookly-js-info-field', $container),
	      $phone_error = $$W('.bookly-js-user-phone-error', $container),
	      $email_error = $$W('.bookly-js-user-email-error', $container),
	      $email_confirm_error = $$W('.bookly-js-user-email-confirm-error', $container),
	      $name_error = $$W('.bookly-js-full-name-error', $container),
	      $first_name_error = $$W('.bookly-js-first-name-error', $container),
	      $last_name_error = $$W('.bookly-js-last-name-error', $container),
	      $captcha = $$W('.bookly-js-captcha-img', $container),
	      $custom_error = $$W('.bookly-custom-field-error', $container),
	      $info_error = $$W('.bookly-js-info-field-error', $container),
	      $modals = $$W('.bookly-js-modal', $container),
	      $login_modal = $$W('.bookly-js-login', $container),
	      $cst_modal = $$W('.bookly-js-cst-duplicate', $container),
	      $verification_modal = $$W('.bookly-js-verification-code', $container),
	      $verification_code = $$W('#bookly-verification-code', $container),
	      $next_btn = $$W('.bookly-js-next-step', $container),
	      $errors = _mapInstanceProperty(_context = $$W([$birthday_day_error, $birthday_month_error, $birthday_year_error, $address_country_error, $address_state_error, $address_postcode_error, $address_city_error, $address_street_error, $address_street_number_error, $address_additional_error, $name_error, $first_name_error, $last_name_error, $phone_error, $email_error, $email_confirm_error, $custom_error, $info_error])).call(_context, $$W.fn.toArray),
	      $fields = _mapInstanceProperty(_context2 = $$W([$birthday_day_field, $birthday_month_field, $birthday_year_field, $address_city_field, $address_country_field, $address_postcode_field, $address_state_field, $address_street_field, $address_street_number_field, $address_additional_field, $full_name_field, $first_name_field, $last_name_field, $phone_field, $email_field, $email_confirm_field, $custom_field, $info_field])).call(_context2, $$W.fn.toArray);
	        ...
	        case 'checkboxes':
	          _findInstanceProperty($row).call($row, 'input').each(function () {
	            if ($$W(this).prop('checked')) {
	              value.push($$W(this).val());
	            }
	          });
	          break;
	      }
	      $$W.each(custom_fields_conditions, function (i, condition) {
	        let $target = $$W('.bookly-custom-field-row[data-id="' + condition.target + '"]'),
	          target_visibility = $target.is(':visible');
	        if (_parseInt$5(condition.source) === id) {
	          let show = false;
	          $$W.each(value, function (i, v) {
	    ...
	    $$W('.bookly-custom-field-row').on('change', 'select, input[type="checkbox"], input[type="radio"]', function () {
	      checkCustomFieldConditions($$W(this).closest('.bookly-custom-field-row'));
	    });
	    $$W('.bookly-custom-field-row').each(function () {
	      var _context9;
	      const _type = $$W(this).data('type');
	      if (_includesInstanceProperty$1(_context9 = ['drop-down', 'radio-buttons', 'checkboxes']).call(_context9, _type)) {
	        if (_type === 'drop-down') {
	          var _context10;
	          _findInstanceProperty(_context10 = $$W(this)).call(_context10, 'select').trigger('change');
	        } else {
	          var _context11;
	          _findInstanceProperty(_context11 = $$W(this)).call(_context11, 'input:checked').trigger('change');
	        }
	      }
	    });
	    ...
	    $$W(document).on('click', function (e) {
	      var _context12;
	      let $calendar = $$W(e.target).closest('.bookly-js-datepicker-calendar-wrap'),
	        _id;
	    ...
	    $$W('.bookly-js-cf-date', $container).each(function () {
	      var _context13;
	      let $that = $$W(this),
	        id = $that.attr('id'),
	        props = {
	      ...
	      let today = new Date();
	      if ($$W(this).data('min') !== '') {
	        let startDate = new Date($$W(this).data('min'));
	      ...
	      if ($$W(this).data('max') !== '') {
	        let endDate = new Date($$W(this).data('max'));
	        props.limits.end = new Date($$W(this).data('max'));
	        if (endDate < today) {
	    ...
	    if (intlTelInput.enabled) {
	      $phone_field.intlTelInput({
	        ...
	        geoIpLookup: function (callback) {
	          $$W.get('https://ipinfo.io', function () {}, 'jsonp').always(function (resp) {
	    ...
	    $modals.addClass(params.form_id).appendTo($container).on('click', '.bookly-js-close', function (e) {
	      ...
	      e.preventDefault();
	      _findInstanceProperty(_context14 = _findInstanceProperty(_context15 = _findInstanceProperty(_context16 = $$W(e.delegateTarget).removeClass('bookly-in')).call(_context16, 'form').trigger('reset').end()).call(_context15, 'input').removeClass('bookly-error').end()).call(_context14, '.bookly-label-error').html('');
	    });
	    // Login modal.
	    $$W('.bookly-js-login-show', $container).on('click', function (e) {
	      e.preventDefault();
	      $login_modal.addClass('bookly-in');
	    });
	    $$W('button:submit', $login_modal).on('click', function (e) {
	      e.preventDefault();
	    ...
	    $$W('button:submit', $cst_modal).on('click', function (e) {
	      e.preventDefault();
	      $cst_modal.removeClass('bookly-in');
	      $next_btn.trigger('click', [1]);
	    });
	    // Verification code modal.
	    $$W('button:submit', $verification_modal).on('click', function (e) {
	      e.preventDefault();
	    ...
	    if (opt[params.form_id].hasOwnProperty('facebook') && opt[params.form_id].facebook.enabled && typeof FB !== 'undefined') {
	      FB.XFBML.parse($$W('.bookly-js-fb-login-button', $container).parent().get(0));
	      opt[params.form_id].facebook.onStatusChange = function (response) {
	        if (response.status === 'connected') {
	          ...
	          $guest_info.fadeOut('slow', function () {
	            ...
	            $$W('.bookly-js-fb-login-button').hide();
	          });
	          FB.api('/me', {
	    ...
	    $next_btn.on('click', function (e, force_update_customer) {
	      ...
	      let $terms = $$W('.bookly-js-terms', $container),
	        $terms_error = $$W('.bookly-js-terms-error', $container);
	      $terms_error.html('');
	      if ($terms.length && !$terms.prop('checked')) {
	        ...
	        $$W('div.bookly-js-info-field-row', $container).each(function () {
	          var $this = $$W(this);
	        ...
	        // Custom fields.
	        $$W('.bookly-custom-fields-container', $container).each(function () {
	          let $cf_container = $$W(this),
	            key = $cf_container.data('key'),
	            custom_fields_data = [];
	          $$W('div.bookly-custom-field-row', $cf_container).each(function () {
	            var $this = $$W(this);
	        ...
	        var data = {
	          ...
	          full_address: $$W('.bookly-js-cst-address-autocomplete', $container).val(),
	        ...
	        booklyAjax({
	          ...
	          if (response.appointments_limit_reached) {
	            ...
	            if (response.info_fields) {
	              $$W.each(response.info_fields, function (field_id, message) {
	                var $div = $$W('div.bookly-js-info-field-row[data-id="' + field_id + '"]', $container);
	            ...
	            if (response.custom_fields) {
	              $$W.each(response.custom_fields, function (key, fields) {
	                $$W.each(fields, function (field_id, message) {
	                  var $custom_fields_collector = $$W('.bookly-custom-fields-container[data-key="' + key + '"]', $container);
	                  var $div = $$W('[data-id="' + field_id + '"]', $custom_fields_collector);
	    ...
	    $$W('.bookly-js-captcha-refresh', $container).on('click', function () {
	  ...
	  function booklyInitGooglePlacesAutocomplete(bookly_forms) {
	    bookly_forms = bookly_forms || $$W('.bookly-form .bookly-details-step');
	    bookly_forms.each(function () {
	      initGooglePlacesAutocomplete($$W(this));
	    });
	  }
	...
	function stepCart(params, error) {
	  if (opt[params.form_id].skip_steps.cart) {
	    ...
	    booklyAjax({
	      ...
	      $container.html(response.html);
	      if (error) {
	        $$W('.bookly-label-error', $container).html(error.message);
	        $$W('tr[data-cart-key="' + error.failed_key + '"]', $container).addClass('bookly-label-error');
	      } else {
	        $$W('.bookly-label-error', $container).hide();
	      }
	      scrollTo($container, params.form_id);
	      const customJS = response.custom_js;
	      $$W('.bookly-js-next-step', $container).on('click', function (e) {
	      ...
	      $$W('.bookly-add-item', $container).on('click', function (e) {
	        e.stopPropagation();
	        e.preventDefault();
	        laddaStart(this);
	        stepService({
	      ...
	      $$W('.bookly-js-actions button', $container).on('click', function () {
	        laddaStart(this);
	        let $this = $$W(this),
	          ...
	          case 'drop':
	            booklyAjax({
	              ...
	              let remove_cart_key = $cart_item.data('cart-key'),
	                $trs_to_remove = $$W('tr[data-cart-key="' + remove_cart_key + '"]', $container);
	              $cart_item.delay(300).fadeOut(200, function () {
	                if (response.data.total_waiting_list) {
	                  $$W('.bookly-js-waiting-list-price', $container).html(response.data.waiting_list_price);
	                  $$W('.bookly-js-waiting-list-deposit', $container).html(response.data.waiting_list_deposit);
	                } else {
	                  $$W('.bookly-js-waiting-list-price', $container).closest('tr').remove();
	                }
	                $$W('.bookly-js-subtotal-price', $container).html(response.data.subtotal_price);
	                $$W('.bookly-js-subtotal-deposit', $container).html(response.data.subtotal_deposit);
	                $$W('.bookly-js-pay-now-deposit', $container).html(response.data.pay_now_deposit);
	                $$W('.bookly-js-pay-now-tax', $container).html(response.data.pay_now_tax);
	                $$W('.bookly-js-total-price', $container).html(response.data.total_price);
	                $$W('.bookly-js-total-tax', $container).html(response.data.total_tax);
	                $trs_to_remove.remove();
	                if ($$W('tr[data-cart-key]').length == 0) {
	                  $$W('.bookly-js-back-step', $container).hide();
	                  $$W('.bookly-js-next-step', $container).hide();
	                }
	              });
	            });
	            break;
	...
	function stepRepeat(params, error) {
	  if (_repeatInstanceProperty(opt[params.form_id].skip_steps)) {
	    ...
	    booklyAjax({
	      ...
	      $container.html(response.html);
	      scrollTo($container, params.form_id);
	      let $repeat_enabled = $$W('.bookly-js-repeat-appointment-enabled', $container),
	        $next_step = $$W('.bookly-js-next-step', $container),
	        $repeat_container = $$W('.bookly-js-repeat-variants-container', $container),
	        $variants = $$W('[class^="bookly-js-variant"]', $repeat_container),
	        $repeat_variant = $$W('.bookly-js-repeat-variant', $repeat_container),
	        $button_get_schedule = $$W('.bookly-js-get-schedule', $repeat_container),
	        $variant_weekly = $$W('.bookly-js-variant-weekly', $repeat_container),
	        $variant_monthly = $$W('.bookly-js-repeat-variant-monthly', $repeat_container),
	        $date_until = $$W('.bookly-js-repeat-until', $repeat_container),
	        $repeat_times = $$W('.bookly-js-repeat-times', $repeat_container),
	        $monthly_specific_day = $$W('.bookly-js-monthly-specific-day', $repeat_container),
	        $monthly_week_day = $$W('.bookly-js-monthly-week-day', $repeat_container),
	        $repeat_every_day = $$W('.bookly-js-repeat-daily-every', $repeat_container),
	        $schedule_container = $$W('.bookly-js-schedule-container', $container),
	        $days_error = $$W('.bookly-js-days-error', $repeat_container),
	        $schedule_slots = $$W('.bookly-js-schedule-slots', $schedule_container),
	        $intersection_info = $$W('.bookly-js-intersection-info', $schedule_container),
	        $info_help = $$W('.bookly-js-schedule-help', $schedule_container),
	        $info_wells = $$W('.bookly-well', $schedule_container),
	        $pagination = $$W('.bookly-pagination', $schedule_container),
	        $schedule_row_template = $$W('.bookly-schedule-row-template .bookly-schedule-row', $schedule_container),
	      ...
	      var repeat = {
	        ...
	        addTimeSlotControl: function ($schedule_row, options, preferred_time, selected_time) {
	          ...
	          if (options.length) {
	            var prefer;
	            $time = $$W('<select/>');
	            $$W.each(options, function (index, option) {
	              var $option = $$W('<option/>');
	        ...
	        renderSchedulePage: function (page) {
	          ...
	          for (var i = start, j = 0; j < rows_on_page && i < count; i++, j++) {
	            ...
	            $$W('> div:first-child', $row).html(schedule[i].index);
	            $$W('.bookly-schedule-date', $row).html(schedule[i].display_date);
	            if (schedule[i].all_day_service_time !== undefined) {
	              $$W('.bookly-js-schedule-time', $row).hide();
	              $$W('.bookly-js-schedule-all-day-time', $row).html(schedule[i].all_day_service_time).show();
	            } else {
	              $$W('.bookly-js-schedule-time', $row).html(schedule[i].display_time).show();
	              $$W('.bookly-js-schedule-all-day-time', $row).hide();
	            }
	            if (schedule[i].another_time) {
	              $$W('.bookly-schedule-intersect', $row).show();
	            }
	            if (schedule[i].deleted) {
	          ...
	          if (count > rows_on_page) {
	            ...
	            for (i = 0, j = 1; i < count; i += 5, j++) {
	              ...
	              $btn.on('click', function (e) {
	                e.preventDefault();
	                repeat.renderSchedulePage($$W(this).data('page'));
	              }).keypress(function (e) {
	                e.preventDefault();
	                if (e.which == 13 || e.which == 32) {
	                  repeat.renderSchedulePage($$W(this).data('page'));
	        ...
	        renderFullSchedule: function (data) {
	          ...
	          $$W.each(schedule, function (index, item) {
	          ...
	          $schedule_slots.on('click', 'button[data-action]', function () {
	            var $schedule_row = $$W(this).closest('.bookly-schedule-row');
	            var row_index = $schedule_row.data('index') - 1;
	            switch ($$W(this).data('action')) {
	              case 'drop':
	              ...
	              case 'edit':
	                _findInstanceProperty($schedule_slots).call($schedule_slots, '.bookly-schedule-row .bookly-js-datepicker-container').each(function () {
	                  let $row = $$W(this).closest('.bookly-schedule-row'),
	                ...
	                $$W(document).on('click', function (e) {
	                  if ($$W(e.target).closest('.bookly-schedule-date').length === 0) {
	                ...
	                schedule_calendar.$on('change', function () {
	                  ...
	                  $date.val(moment(schedule_calendar.date).format(short_date_format));
	                  $date.trigger('change');
	                });
	                $date.trigger('change');
	                break;
	        ...
	        isDateMatchesSelections: function (current_date) {
	          switch ($repeat_variant.val()) {
	            case 'daily':
	              if (($repeat_every_day.val() > 6 || $$W.inArray(current_date.format('ddd').toLowerCase(), repeat.week_days) != -1) && current_date.diff(repeat.date_from, 'days') % $repeat_every_day.val() == 0) {
	                return true;
	              }
	              break;
	            case 'weekly':
	            case 'biweekly':
	              if (($repeat_variant.val() == 'weekly' || current_date.diff(repeat.date_from.clone().startOf('isoWeek'), 'weeks') % 2 == 0) && $$W.inArray(current_date.format('ddd').toLowerCase(), repeat.checked_week_days) != -1) {
	                return true;
	              }
	              break;
	            case 'monthly':
	        ...
	        updateRepeatDate: function () {
	          ...
	          _findInstanceProperty($monthly_week_day).call($monthly_week_day, 'option').each(function () {
	            repeat.week_days.push($$W(this).val());
	          });
	          repeat.checked_week_days = [];
	          $$W('.bookly-js-week-days input:checked', $repeat_container).each(function () {
	      ...
	      $date_until.val(moment($date_until.data('value')).format(BooklyL10nGlobal.datePicker.format));
	      $$W(document).on('click', function (e) {
	        if ($$W(e.target).closest('.bookly-js-repeat-until-wrap').length === 0) {
	      ...
	      until_calendar.$on('change', function () {
	        until_calendar.show = false;
	        $date_until.val(moment(until_calendar.date).format(BooklyL10nGlobal.datePicker.format));
	      });
	      var open_repeat_onchange = $repeat_enabled.on('change', function () {
	        $repeat_container.toggle($$W(this).prop('checked'));
	        if ($$W(this).prop('checked')) {
	          repeat.prepareButtonNextState();
	        } else {
	          $next_step.prop('disabled', false);
	      ...
	      if (response.repeated) {
	        ...
	        $date_until.val(moment(repeat_data.until).format(BooklyL10nGlobal.datePicker.format));
	        switch (_repeatInstanceProperty(repeat_data)) {
	          ...
	          //break skipped
	          case 'biweekly':
	            $$W('.bookly-js-week-days input[type="checkbox"]', $repeat_container).prop('checked', false).parent().removeClass('active');
	            _forEachInstanceProperty(_context4 = repeat_params.on).call(_context4, function (val) {
	              $$W('.bookly-js-week-days input:checkbox[value=' + val + ']', $repeat_container).prop('checked', true);
	            });
	            break;
	          case 'monthly':
	            if (repeat_params.on === 'day') {
	              $variant_monthly.val('specific');
	              $$W('.bookly-js-monthly-specific-day[value=' + repeat_params.day + ']', $repeat_container).prop('checked', true);
	            } else {
	      ...
	      $$W('.bookly-js-week-days input', $repeat_container).on('change', function () {
	        repeat.updateRepeatTimes();
	      });
	      ...
	      $button_get_schedule.on('click', function () {
	        ...
	        switch (_repeatInstanceProperty(data)) {
	          ...
	          case 'biweekly':
	            data.params.on = [];
	            $$W('.bookly-js-week-days input[type="checkbox"]:checked', $variant_weekly).each(function () {
	      ...
	      $$W('.bookly-js-go-to-cart', $container).on('click', function (e) {
	        e.stopPropagation();
	        e.preventDefault();
	        laddaStart(this);
	        stepCart({
	...
	function stepTime(params, error_message) {
	  ...
	  function prepareSlotsHtml(slots_data, selected_date) {
	    var response = {};
	    $$W.each(slots_data, function (group, group_slots) {
	      var html = '<button class="bookly-day" value="' + group + '">' + group_slots.title + '</button>';
	      $$W.each(group_slots.slots, function (id, slot) {
	  ...
	  requestRenderTime.booklyAjax({
	    ...
	    $container.html(response.html);
	    var $columnizer_wrap = $$W('.bookly-columnizer-wrap', $container),
	      $columnizer = $$W('.bookly-columnizer', $columnizer_wrap),
	      $time_next_button = $$W('.bookly-time-next', $container),
	      $time_prev_button = $$W('.bookly-time-prev', $container),
	      $current_screen = null,
	      slot_height = 36,
	    ...
	    // Time zone switcher.
	    $$W('.bookly-js-time-zone-switcher', $container).on('change', function (e) {
	    ...
	    if (show_calendar) {
	      let date = response.current_date ? response.first_available_date ? response.first_available_date : response.current_date : response.selected_date ? response.selected_date.substring(0, 10) : $$W('.bookly-js-selected-date', $container).data('value');
	      loadedMonths.push(moment(date).month() + '-' + moment(date).year());
	      let _cal = new Calendar({
	        target: $$W('.bookly-js-slot-calendar', $container).get(0),
	        props: {
	          datePicker: BooklyL10nGlobal.datePicker,
	          date: date,
	      ...
	      // Insert all slots.
	      var slots_data = '';
	      $$W.each(slots, function (group, group_slots) {
	    ...
	    if (response.has_slots) {
	      ...
	      slots_per_column = _parseInt$5($$W(window).height() / slot_height, 10);
	      if (slots_per_column < 4) {
	        slots_per_column = 4;
	      } else if (slots_per_column > 10) {
	        slots_per_column = 10;
	      }
	      var hammertime = $$W('.bookly-time-step', $container).hammer({
	        swipe_velocity: 0.1
	      });
	      ...
	      $time_next_button.on('click', function (e) {
	        ...
	        if ($screens.eq(screen_index + 1).length) {
	          ...
	          var $button = $$W('> button:last', $columnizer);
	          if ($button.length === 0) {
	            $button = $$W('.bookly-column:hidden:last > button:last', $columnizer);
	            if ($button.length === 0) {
	              $button = $$W('.bookly-column:last > button:last', $columnizer);
	            }
	          }
	          ...
	          booklyAjax({
	            ...
	            if (response.has_slots) {
	              ...
	              has_more_slots = response.has_more_slots;
	              var slots_data = '';
	              $$W.each(prepareSlotsHtml(response.slots_data, response.selected_date), function (group, group_slots) {
	                slots_data += group_slots;
	              });
	              var $html = $$W(slots_data);
	              // The first slot is always a day slot.
	              // Check if such day slot already exists (this can happen
	              // because of time zone offset) and then remove the first slot.
	              var $first_day = $html.eq(0);
	              if ($$W('button.bookly-day[value="' + $first_day.attr('value') + '"]', $container).length) {
	                $html = $html.not(':first');
	              }
	    ...
	    function showSpinner() {
	      $$W('.bookly-time-screen,.bookly-not-time-screen', $container).addClass('bookly-spin-overlay');
	      var opts = {
	        lines: 11,
	      ...
	      if ($screens) {
	        ...
	        new Spinner(opts).spin($$W('.bookly-not-time-screen', $container).get(0));
	      }
	    }
	    function initSlots() {
	      var $buttons = $$W('> button', $columnizer),
	        slots_count = 0,
	        max_slots = 0,
	        $button,
	        $column,
	      ...
	      if (show_day_per_column) {
	        ...
	        while ($buttons.length > 0) {
	          ...
	          if ($buttons.eq(0).hasClass('bookly-day')) {
	            slots_count = 1;
	            $column = $$W('<div class="' + column_class + '" />');
	            $button = $$W(_spliceInstanceProperty($buttons).call($buttons, 0, 1));
	       ...
	       * Create screens.
	       */
	      var $columns = $$W('> .bookly-column', $columnizer);
	      while (has_more_slots ? $columns.length >= columns_per_screen : $columns.length) {
	        $screen = $$W('<div class="bookly-time-screen"/>');
	        for (var i = 0; i < columns_per_screen; ++i) {
	          $column = $$W(_spliceInstanceProperty($columns).call($columns, 0, 1));
	          if (i == 0) {
	            ...
	            if (!$first_slot.hasClass('bookly-day')) {
	              var group = $first_slot.data('group'),
	                $group_slot = $$W('button.bookly-day[value="' + group + '"]:last', $container);
	      ...
	      $screens = $$W('.bookly-time-screen', $columnizer);
	      if ($current_screen === null) {
	        $current_screen = $screens.eq(0);
	      }
	      $$W('button.bookly-time-skip', $container).off('click').on('click', function (e) {
	        e.stopPropagation();
	        e.preventDefault();
	        laddaStart(this);
	      ...
	      // On click on a slot.
	      $$W('button.bookly-hour', $container).off('click').on('click', function (e) {
	      ...
	      $$W('.bookly-time-step', $container).width(columns_per_screen * column_width);
	      $columnizer_wrap.height($current_screen.height());
	    }
	    function observeResizeColumnizer() {
	      if ($$W('.bookly-time-step', $container).length > 0) {
	    ...
	    function resizeColumnizer() {
	      ...
	      if (column_width > 0) {
	        let formWidth = $columnizer_wrap.closest('.bookly-form').width();
	        if (show_calendar) {
	          let calendarWidth = $$W('.bookly-js-slot-calendar', $container).width();
	...
	function stepExtras(params) {
	  ...
	  booklyAjax({
	    ...
	    $container.html(response.html);
	    scrollTo($container, params.form_id);
	    let $next_step = $$W('.bookly-js-next-step', $container),
	      $back_step = $$W('.bookly-js-back-step', $container),
	      $goto_cart = $$W('.bookly-js-go-to-cart', $container),
	      $extras_items = $$W('.bookly-js-extras-item', $container),
	      $extras_summary = $$W('.bookly-js-extras-summary span', $container),
	      customJS = response.custom_js,
	      $this,
	      $input,
	    ...
	    $extras_items.each(function (index, elem) {
	      ...
	      $$W('.bookly-js-extras-thumb', $this).on('click', function () {
	      ...
	      _findInstanceProperty($this).call($this, '.bookly-js-count-control').on('click', function () {
	        ...
	        count = $$W(this).hasClass('bookly-js-extras-increment') ? Math.min($this.data('max_quantity'), count + 1) : Math.max($this.data('min_quantity'), count - 1);
	    ...
	    $next_step.on('click', function (e) {
	      ...
	      var extras = {};
	      $$W('.bookly-js-extras-container', $container).each(function () {
	        var $extras_container = $$W(this);
	...
	var toIndexedObject = toIndexedObject$h;
	...
	function instance$1($$self, $$props, $$invalidate) {
	  ...
	  function onLocationChange(event) {
	    ...
	    if (locationId) {
	      ...
	      if (serviceId) {
	        let valid = false;
	        $$W.each(locations[locationId].staff, id => {
	      ...
	      if (categoryId) {
	        let valid = false;
	        $$W.each(locations[locationId].staff, id => {
	          $$W.each(staff[id].services, srvId => {
	  ...
	  function onCategoryChange(event) {
	    ...
	    if (categoryId) {
	      ...
	      if (staffId) {
	        let valid = false;
	        $$W.each(staff[staffId].services, id => {
	  ...
	  function getValues() {
	    return {
	      ...
	      categoryId,
	      serviceId,
	      staffIds: staffId ? [staffId] : _mapInstanceProperty($$W).call($$W, staffItems, item => item.id),
	      duration,
	      nop,
	      quantity
	    };
	    ...
	    if ($$self.$$.dirty[0] & /*locationId, staff, locations, serviceId, categoryId, services, staffItems, categories, staffId, nop, hasNopSelect, duration, durationItems, l10n*/33493007 | $$self.$$.dirty[1] & /*servicesPerLocation, lookupLocationId, staffNameWithPrice, collaborativeHideStaff, showRatings, categorySelected, maxQuantity*/1675624448 | $$self.$$.dirty[2] & /*srvMinCapacity, srvMaxCapacity, minCapacity, maxCapacity*/15) {
	      {
	        ...
	        // Staff
	        $$W.each(staff, (id, staffMember) => {
	          if (!locationId || id in locations[locationId].staff) {
	            if (!serviceId) {
	              if (!categoryId) {
	                $$invalidate(23, staffItems[id] = $$W.extend({}, staffMember), staffItems);
	              } else {
	                $$W.each(staffMember.services, srvId => {
	                  if (services[srvId].category_id === categoryId) {
	                    $$invalidate(23, staffItems[id] = $$W.extend({}, staffMember), staffItems);
	                    return false;
	                  }
	              ...
	              $$W.each(staffMember.services[serviceId].locations, (locId, locSrv) => {
	                ...
	                $$invalidate(23, staffItems[id] = $$W.extend({}, staffMember, {
	        ...
	        if (!locationId) {
	          ...
	          if (servicesPerLocation) {
	            $$W.each(staff, stId => {
	              $$W.each(staff[stId].services, srvId => {
	            ...
	            $$W.each(locations[locationId].staff, stId => {
	              $$W.each(staff[stId].services, srvId => {
	                categoryIds.push(services[srvId].category_id);
	                serviceIds.push(srvId);
	              });
	          ...
	          $$W.each(categories, (id, category) => {
	            if ($$W.inArray(_parseInt$5(id), categoryIds) > -1) {
	              $$invalidate(26, categoryItems[id] = category, categoryItems);
	            }
	          });
	          if (categoryId && $$W.inArray(categoryId, categoryIds) === -1) {
	            $$invalidate(18, categoryId = 0);
	            $$invalidate(61, categorySelected = false);
	          }
	          $$W.each(services, (id, service) => {
	            if ($$W.inArray(id, serviceIds) > -1) {
	              if (!categoryId || !categorySelected || service.category_id === categoryId) {
	                if (!staffId || id in staff[staffId].services) {
	                  $$invalidate(27, serviceItems[id] = service, serviceItems);
	                }
	...
	function stepService(params) {
	  ...
	  booklyAjax({
	    ...
	    $container.html(response.html);
	    scrollTo($container, params.form_id);
	    var $chain = $$W('.bookly-js-chain', $container),
	      $date_from = $$W('.bookly-js-date-from', $container),
	      $week_days = $$W('.bookly-js-week-days', $container),
	      $select_time_from = $$W('.bookly-js-select-time-from', $container),
	      $select_time_to = $$W('.bookly-js-select-time-to', $container),
	      $next_step = $$W('.bookly-js-next-step', $container),
	      $mobile_next_step = $$W('.bookly-js-mobile-next-step', $container),
	      $mobile_prev_step = $$W('.bookly-js-mobile-prev-step', $container),
	    ...
	    if (serviceNameWithDuration) {
	      $$W.each(services, function (id, service) {
	    ...
	    c.$on('changeMinDate', function (e) {
	      _cal.limits = {
	        start: new Date(e.detail[0], e.detail[1], e.detail[2]),
	        end: response.date_max ? new Date(response.date_max[0], response.date_max[1], response.date_max[2]) : false
	      };
	    });
	    $date_from.data('date_min', response.date_min || true);
	    let _cal = new Calendar({
	      target: $$W('.bookly-js-datepicker-calendar', $container).get(0),
	      props: {
	        datePicker: BooklyL10nGlobal.datePicker,
	    ...
	    $date_from.val(moment($date_from.data('value')).format(BooklyL10nGlobal.datePicker.format));
	    $$W(document).on('click', function (e) {
	      if ($$W(e.target).closest('.bookly-js-available-date').length === 0) {
	        _cal.show = false;
	      }
	    }).trigger('click');
	    ...
	    _cal.$on('change', function () {
	      _cal.show = false;
	      $date_from.val(moment(_cal.date).format(BooklyL10nGlobal.datePicker.format));
	    });
	    $$W('.bookly-js-go-to-cart', $container).on('click', function (e) {
	      e.stopPropagation();
	      e.preventDefault();
	    ...
	    if (opt[params.form_id].form_attributes.hide_date) {
	      $$W('.bookly-js-available-date', $container).hide();
	    }
	    if (opt[params.form_id].form_attributes.hide_week_days) {
	      $$W('.bookly-js-week-days', $container).hide();
	    }
	    if (opt[params.form_id].form_attributes.hide_time_range) {
	      $$W('.bookly-js-time-range', $container).hide();
	    }

	    // time from
	    $select_time_from.on('change', function () {
	      var start_time = $$W(this).val(),
	        end_time = $select_time_to.val(),
	        $last_time_entry = $$W('option:last', $select_time_from);
	      ...
	      if ($select_time_from[0].selectedIndex < $last_time_entry.index()) {
	        ...
	        $$W('option', this).each(function () {
	          if ($$W(this).val() > start_time) {
	            $select_time_to.append($$W(this).clone());
	          }
	        });
	      ...
	      var first_value = $$W('option:first', $select_time_to).val();
	      $select_time_to.val(end_time >= first_value ? end_time : first_value);
	    });
	    let stepServiceValidator = function () {
	      let valid = true,
	        $scroll_to = null;
	      $$W(c.validate()).each(function (_, status) {
	        if (!status.valid) {
	          valid = false;
	          let $el = $$W(status.el);
	          if ($el.is(':visible')) {
	      ...
	      // week days
	      if ($week_days.length && !$$W(':checked', $week_days).length) {
	        valid = false;
	    ...
	    $next_step.on('click', function (e) {
	      ...
	      if (stepServiceValidator()) {
	        ...
	        $$W.each(c.getValues(), function (_, values) {
	        ...
	        // Prepare days.
	        var days = [];
	        $$W('.bookly-js-week-days input:checked', $container).each(function () {
	    ...
	    $mobile_next_step.on('click', function (e) {
	      ...
	      if (stepServiceValidator()) {
	        if (opt[params.form_id].skip_steps.service_part2) {
	          ...
	          $$W('.bookly-js-mobile-step-1', $container).hide();
	          $$W('.bookly-stepper li:eq(1)', $container).addClass('bookly-step-active');
	          $$W('.bookly-stepper li:eq(0)', $container).removeClass('bookly-step-active');
	          $$W('.bookly-js-mobile-step-2', $container).css('display', 'block');
	          scrollTo($container, params.form_id);
	        }
	      }
	      return false;
	    ...
	    if (opt[params.form_id].skip_steps.service_part1) {
	      ...
	      _setTimeout(function () {
	        ...
	        $$W('.bookly-stepper li:eq(0)', $container).addClass('bookly-step-active');
	        $$W('.bookly-stepper li:eq(1)', $container).removeClass('bookly-step-active');
	      }, 0);
	      ...
	      $mobile_prev_step.on('click', function (e) {
	        e.stopPropagation();
	        e.preventDefault();
	        $$W('.bookly-js-mobile-step-1', $container).show();
	        $$W('.bookly-js-mobile-step-2', $container).hide();
	        $$W('.bookly-stepper li:eq(0)', $container).addClass('bookly-step-active');
	        $$W('.bookly-stepper li:eq(1)', $container).removeClass('bookly-step-active');
	        return false;
	      });
	...
	function main (options) {
	  let $container = $$W('#bookly-form-' + options.form_id);
	  if (!$container.length) {
	    return;
	  }

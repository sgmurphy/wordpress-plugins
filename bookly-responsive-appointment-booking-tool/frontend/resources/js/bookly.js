...
var bookly = (function ($$W) {
	...
	*/
    ...
    function create_if_block$4(ctx) {
        ...
        let mounted;
        let dispose;
        let if_block = /*loading*/ctx[3] && create_if_block_1$3();
        const default_slot_template = /*#slots*/ctx[17].default;
        const default_slot = create_slot(default_slot_template, ctx, /*$$scope*/ctx[16], null);
        return {
            c() {
                ...
                attr(div, "tabindex", "0");
                toggle_class(div, "pointer-events-none", /*disabled*/ctx[0]);
                toggle_class(div, "bookly-opacity-50", /*disabled*/ctx[0]);
            },
            m(target, anchor) {
                insert(target, div, anchor);
    ...
    function create_if_block$3(ctx) {
        ...
        return {
            ...
            p(ctx, dirty) {
                ...
                if (dirty[0] & /*rtl*/1024 | dirty[1] & /*$$scope*/65536) {
                ...
                if (dirty[0] & /*title*/2048 | dirty[1] & /*$$scope*/65536) {
    ...
    // (318:28) <Button                                      type="bookly"                                      bordered={false}                                      rounded={false}                                      paddings={false}                                      margins={false}                                      class="bookly-border-none focus:bookly-border-none focus:bookly-outline-none bookly-leading-normal bookly-px-2 bookly-py-0 bookly-m-0 bookly-text-xl"                                      on:click={() => {year = year + _year - 4; view='month'}}                                      on:keypress={() => {year = year + _year - 4; view='month'}}                                      container="div"                              >
    function create_default_slot_2(ctx) {
        let t_value = /*year*/ctx[1] + /*_year*/ctx[46] - 4 + "";
        let t;
        return {
            c() {
                t = text(t_value);
            ...
            p(ctx, dirty) {
                if (dirty[0] & /*year*/2 && t_value !== (t_value = /*year*/ctx[1] + /*_year*/ctx[46] - 4 + "")) set_data(t, t_value);
            },
            d(detaching) {
                if (detaching) {
                    detach(t);
    ...
    // (316:20) {#each {length: 9} as _,_year}
    function create_each_block_4(ctx) {
        ...
        function click_handler_2() {
            return /*click_handler_2*/ctx[31]( /*_year*/ctx[46]);
        }

        function keypress_handler_2() {
            return /*keypress_handler_2*/ctx[32]( /*_year*/ctx[46]);
        }
        ...
        return {
            ...
            p(new_ctx, dirty) {
                ...
                if (dirty[0] & /*year*/2 | dirty[1] & /*$$scope*/65536) {
    ...
    // (298:28) <Button                                      type="bookly"                                      class="bookly-border-none focus:bookly-border-none focus:bookly-outline-none bookly-leading-normal bookly-px-2 bookly-py-0 bookly-m-0 bookly-text-xl"                                      bordered={false}                                      rounded={false}                                      margins={false}                                      paddings={false}                                      on:click={() => {month = _month; dispatch('month-change'); view='calendar'}}                                      on:keypress={() => {month = _month; dispatch('month-change'); view='calendar'}}                                      container="div"                              >
    function create_default_slot_1(ctx) {
        let t_value = /*datePicker*/ctx[4].monthNamesShort[/*_month*/ctx[44]] + "";
        let t;
        return {
            c() {
                t = text(t_value);
            ...
            p(ctx, dirty) {
                if (dirty[0] & /*datePicker*/16 && t_value !== (t_value = /*datePicker*/ctx[4].monthNamesShort[/*_month*/ctx[44]] + "")) set_data(t, t_value);
            },
            d(detaching) {
                if (detaching) {
                    detach(t);
    ...
    // (296:20) {#each {length: 12} as _,_month}
    function create_each_block_3(ctx) {
        ...
        function click_handler_1() {
            return /*click_handler_1*/ctx[29]( /*_month*/ctx[44]);
        }

        function keypress_handler_1() {
            return /*keypress_handler_1*/ctx[30]( /*_month*/ctx[44]);
        }
        ...
        return {
            ...
            p(new_ctx, dirty) {
                ctx = new_ctx;
                const button_changes = {};
                if (dirty[0] & /*datePicker*/16 | dirty[1] & /*$$scope*/65536) {
                    button_changes.$$scope = {
                        dirty,
                        ctx
                    };
    ...
    // (277:36) <Button                                              type={days[i * 7 + j].active ? 'calendar-active' : (days[i * 7 + j].current ? 'calendar-normal' : 'calendar-inactive')}                                              class="bookly-text-base bookly-leading-4 bookly-shadow-none bookly-flex-1 bookly-py-2 bookly-px-0 bookly-border-none focus:bookly-border-none focus:bookly-outline-none {_disabled ? 'bookly-cursor-default' : 'hover:bookly-opacity-75'} {(days[i * 7 + j].current ? 'bookly-calendar-current-month-mark' : '')}"                                              bordered={false}                                              margins={false}                                              on:click={() => !_disabled && onClickDate(days[i*7+j])}                                              on:keypress={() => !_disabled && onClickDate(days[i*7+j])}                                              disabled={_disabled}                                              container="div"                                      >
    ...
    function create_each_block_1(ctx) {
        ...
        return {
            ...
            p(new_ctx, dirty) {
                ...
                if (dirty[0] & /*days*/512 | dirty[1] & /*$$scope*/65536) {
                    button_changes.$$scope = {
                        dirty,
                        ctx
                    };
    ...
    function instance$3($$self, $$props, $$invalidate) {
        ...
        const keypress_handler_2 = _year => {
            $$invalidate(1, year = year + _year - 4);
            $$invalidate(8, view = 'month');
        };

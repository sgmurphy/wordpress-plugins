...
if (!class_exists('MCProtectFWRuleEngine_V572')) :
require_once dirname( __FILE__ ) . '/functions.php';

class MCProtectFWRuleEngine_V572 {
	use MCProtectFWRuleStringFunc_V572;
	use MCProtectFWRuleArrayFunc_V572;
	use MCProtectFWRuleMiscFunc_V572;
	use MCProtectFWRuleRequestFunc_V572;
	use MCProtectFWRuleWPFunc_V572;
	...
	const CONST_NAME_PREFIX = 'MCProtectFWRule_V572::';
	...
	public function evaluate($rule) {
		...
		} catch (MCProtectRuleError_V572 $e) {
			$this->error = $e;
		}
	}

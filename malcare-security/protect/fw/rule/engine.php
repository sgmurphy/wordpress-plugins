...
if (!class_exists('MCProtectFWRuleEngine_V553')) :
require_once dirname( __FILE__ ) . '/functions.php';

class MCProtectFWRuleEngine_V553 {
	use MCProtectFWRuleStringFunc_V553;
	use MCProtectFWRuleArrayFunc_V553;
	use MCProtectFWRuleMiscFunc_V553;
	use MCProtectFWRuleRequestFunc_V553;
	use MCProtectFWRuleWPFunc_V553;
	...
	const CONST_NAME_PREFIX = 'MCProtectFWRule_V553::';
	...
	public function evaluate($rule) {
		...
		} catch (MCProtectRuleError_V553 $e) {
			$this->error = $e;
		}
	}

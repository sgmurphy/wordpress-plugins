...
if (!class_exists('MCProtectFWRuleEngine_V567')) :
require_once dirname( __FILE__ ) . '/functions.php';

class MCProtectFWRuleEngine_V567 {
	use MCProtectFWRuleStringFunc_V567;
	use MCProtectFWRuleArrayFunc_V567;
	use MCProtectFWRuleMiscFunc_V567;
	use MCProtectFWRuleRequestFunc_V567;
	use MCProtectFWRuleWPFunc_V567;
	...
	const CONST_NAME_PREFIX = 'MCProtectFWRule_V567::';
	...
	public function evaluate($rule) {
		...
		} catch (MCProtectRuleError_V567 $e) {
			$this->error = $e;
		}
	}

				...
				<div class="wcfm-container">
					<div id="wcfm_withdrawal_requests_actions_expander" class="wcfm-content">
						...
						<div id="wcfm_products_simple_submit" class="wcfm_form_simple_submit_wrapper">
							...
							<?php if (apply_filters('wcfm_allow_withdrawal_requests_manually_approve', false)) { ?>
								<input type="submit" name="withdrawal-requests-data" value="<?php _e('Approve Manually', 'wc-frontend-manager'); ?>" id="wcfm_withdrawal_requests_manually_approve_button" class="wcfm_submit_button" />
							<?php } ?>
						</div>
						<div class="wcfm-clearfix"></div>
					</div>

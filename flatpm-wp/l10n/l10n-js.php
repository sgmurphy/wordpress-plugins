...
wp_localize_script( 'flat_pm_custom', 'fpm_l10n', array(
	'other' => array(
		...
		'link_image'    => __( 'Link & Image', 'flatpm_l10n' ),
		'sticky'        => __( 'Sticky in content', 'flatpm_l10n' ),
		'sidebar'       => __( 'Sticky in sidebar', 'flatpm_l10n' ),
		'skyscraper'    => __( 'Skyscraper in sidebar', 'flatpm_l10n' ),
		'slider'        => __( 'Slider', 'flatpm_l10n' ),
		'interscroller' => __( 'Interscroller', 'flatpm_l10n' ),

	...
	<div class="col s12">
		<p>
			<label>
				...
				<span><?php _e( 'Enable Fast Mode programmatically', 'flatpm_l10n' ); ?> (post, page or custom post types)</span>
			</label>
		</p>
		<p>
			<label>
				<input type="checkbox" name="flat_pm_advanced[fast_start_term]" <?php if( isset( $flat_pm_advanced['fast_start_term'] ) && $flat_pm_advanced['fast_start_term'] === 'true' ) echo 'checked'; ?>>
				<span><?php _e( 'Enable Fast Mode programmatically', 'flatpm_l10n' ); ?> (category, tag or term description)</span>
			</label>
		</p>
		<div class="col s12">

...
<div id="tab-styles" class="col s12 white">
	...
	<div class="col s12">
		...
		<p>
			<label>
				<input type="checkbox" id="post_types_post" name="flat_pm_stylization[cross][overlay]" <?php if( isset( $flat_pm_stylization['cross']['overlay'] ) && $flat_pm_stylization['cross']['overlay'] === 'true' ) echo 'checked'; ?>>
				<span><?php _e( 'Allow closing a popup by clicking on the overlay', 'flatpm_l10n' ); ?></span>
			</label>
			<div class="col s12">
				<?php _e( 'By default, clicking on an overlay does not close popups.', 'flatpm_l10n' ); ?>
			</div>
		</p>

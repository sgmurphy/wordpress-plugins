		...
		<div class="row">
			<div class="col s12 white" style="border-radius:10px">
				<div class="col s12 l6">
					...
					<textarea class="default" name="flat_pm_css" placeholder="<?php _e( 'Paste your custom css here', 'flatpm_l10n' ); ?>" style="min-height:500px"><?php echo esc_html( stripslashes( $flat_pm_css ) ); ?></textarea>

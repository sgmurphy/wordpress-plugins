...
<div class="collapsible-body">
	<div class="switch">
		<label>
			Off
			<input class="hidden" type="checkbox" name="view[preroll][enabled]" <?php if( $preroll['enabled'] === 'true') echo 'checked'; ?>>
	...
	<div class="row">
		<div class="input-field col s12 l6 xl5">
			<input type="text" name="view[preroll][selector]" id="view_preroll_selector" value="<?php echo esc_attr( $preroll['selector'] ); ?>">
		...
		<div class="input-field col s12 l4 xl3 hidden">
			<input type="text" name="view[preroll][xpath]" value="<?php echo esc_attr( $preroll['xpath'] ); ?>">
	...
	<div class="row">
		<div class="col s12">
			<label>
				<input type="checkbox" name="view[preroll][timer]" <?php if( $preroll['timer'] === 'true') echo 'checked'; ?>>
				<span>
			...
			<div class="input-field col">
				<input id="view_preroll_timer_count" type="number" class="validate" min="0"
					name="view[preroll][timeout]"
					value="<?php echo esc_attr( $preroll['timeout'] ); ?>"
				>
	...
	<div class="row">
		<div class="col s12">
			<label>
				<input type="checkbox" name="view[preroll][cross]" <?php if( $preroll['cross'] === 'true') echo 'checked'; ?>>
				<span>
	...
	<div class="row">
		<div class="col s12">
			<label>
				<input type="checkbox" name="view[preroll][cross_offset]" <?php if( isset( $preroll['cross_offset'] ) && $preroll['cross_offset'] === 'true') echo 'checked'; ?>>
				<span>
	...
	<div class="row">
		<div class="col s12">
			<label>
				<input type="checkbox" name="view[preroll][once]" <?php if( $preroll['once'] === 'true') echo 'checked'; ?>>
				<span>

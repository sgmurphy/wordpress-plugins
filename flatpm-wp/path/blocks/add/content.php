...
<div id="tab-content" class="col s12 white">
					...
					<p>
						<label>
							<input type="checkbox"
								...
								' . esc_html( ( in_array( $type->name, array( 'post', 'page' ) ) ) ? 'checked' : '' ) . '
							>
	...
	<div class="row">
		...
		<div class="input-field col s12 m6">
			<input id="content_restriction_content_less" type="number" class="validate" min="0" step="1" name="content[restriction][content_less]">
			<label for="content_restriction_content_less"><?php _e( 'Hide if the content is less than N characters:', 'flatpm_l10n' ); ?></label>
		</div>

		<div class="input-field col s12 m6">
			<input id="content_restriction_title_less" type="number" class="validate" min="0" step="1" name="content[restriction][title_less]">
			<label for="content_restriction_title_less"><?php _e( 'Hide if there are less than N subheadings:', 'flatpm_l10n' ); ?></label>
		</div>

		<div class="input-field col s12 m6">
			<input id="content_restriction_content_more" type="number" class="validate" min="0" step="1" name="content[restriction][content_more]">
			<label for="content_restriction_content_more"><?php _e( 'Hide if the content is more than N characters:', 'flatpm_l10n' ); ?></label>
		</div>

		<div class="input-field col s12 m6">
			<input id="content_restriction_title_more" type="number" class="validate" min="0" step="1" name="content[restriction][title_more]">
	...
	<div class="row">
		<div class="col s12">
			...
			<div class="col s12 m6">
				<p>
					<label>
						<input type="checkbox" name="content[templates][singular]" checked>
			...
			<div class="col s12 m6">
				<p>
					<label>
						<input type="checkbox" name="content[templates][paged]" checked>

		...
		<li <?php if( isset( $flat_pm_personalization['block']['language'] ) && $flat_pm_personalization['block']['language'] === 'false' ){ echo 'style="display:none"'; } ?>>
			...
			<div class="collapsible-body">
				<div class="switch">
					<label>
						Off
						<input class="hidden" type="checkbox" name="user[language][enabled]">
						<span class="lever"></span>
						On
					</label>
				</div>
				...
				<div class="row">
					...
					<div class="col s12 m6">
						...
						<textarea class="default" name="user[language][allow]" placeholder="<?php esc_attr_e( 'For example: en', 'flatpm_l10n' ); ?>"></textarea>
					</div>
					<div class="col s12 m6">
						<p><?php _e( 'Hide from:', 'flatpm_l10n' ); ?></p>

						<textarea class="default" name="user[language][disallow]" placeholder="<?php esc_attr_e( 'For example: en', 'flatpm_l10n' ); ?>"></textarea>
					</div>
					<div class="col s12">
						<br>
		...
		<li <?php if( isset( $flat_pm_personalization['block']['color-scheme'] ) && $flat_pm_personalization['block']['color-scheme'] === 'false' ){ echo 'style="display:none"'; } ?>>
			...
			<div class="collapsible-body">
				<div class="switch">
					<label>
						Off
						<input class="hidden" type="checkbox" name="user[color-scheme][enabled]">
						<span class="lever"></span>
						On
					</label>
				</div>

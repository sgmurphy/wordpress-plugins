			...
			<div class="sub_block_collapsible_content">
				<div class="col s12 <?php echo ! $is_adblock ? 'm6' : 'm12'; ?>">
					...
					<div class="html_editor_wrapper">
						...
						<button type="button" class="btn btn-small tooltipped encrypt_decrypt"
							data-position="top"
							data-tooltip="<?php esc_attr_e( 'Encrypt/Decrypt', 'flatpm_l10n' ); ?>"
							style="width:32.4px;background:#fff;padding:0;position:absolute;top:-2px;right:0;z-index:99"
						>
							<i class="material-icons" style="color:#2188ab!important;font-size:1rem">security</i>
						</button>
					</div>

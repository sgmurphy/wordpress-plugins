  ...
  constructor(props) {
    ...
    defineProperty_default()(this, "getInputs", () => {
      ...
      if (external_lodash_includes_default()([TICKET_TYPES[SHARED], TICKET_TYPES[INDEPENDENT]], tempCapacityType)) {
        ...
        extraProps.label = tempCapacityType === TICKET_TYPES[SHARED] ? Object(external_wp_i18n_["__"])('Limit sales of this ticket to:', 'event-tickets') : Object(external_wp_i18n_["__"])('Number of tickets available', 'event-tickets');
...
EcommerceOptions.propTypes = {
  ...
  isDisabled: external_tribe_modules_propTypes_default.a.bool,
  provider: external_tribe_modules_propTypes_default.a.oneOf([...PROVIDER_TYPES, '']),
...
const AttendeesRegistration = _ref => {
  let {
...
const Type = _ref => {
  ...
  return wp.element.createElement("div", {
    ...
    forId: "",
    isLabel: true,
    label: Object(external_wp_i18n_["_x"])('Ticket type', 'Block Editor Ticket type label', 'event-tickets'),
...
const type_container_mapStateToProps = (state, ownProps) => {
  ...
  const upsellMessage = !hasEventsPro && currentPostIsEvent ? Object(external_wp_i18n_["_x"])('For more ticket types, <a href="https://evnt.is/tt-ecp" target="_blank" rel="noopener noreferrer">upgrade</a> to Events Calendar Pro', 'Default ticket type upsell description.', 'event-tickets') : null;
...
const ClockIcon = _ref => {
  ...
  return isDisabled ? wp.element.createElement(icons["ClockInactive"], null) : wp.element.createElement(icons["ClockActive"], null);
};
ClockIcon.propTypes = {
  isDisabled: external_tribe_modules_propTypes_default.a.bool.isRequired
};
const TicketIcon = _ref2 => {
  ...
  return isDisabled ? wp.element.createElement(icons["TicketInactive"], null) : wp.element.createElement(icons["TicketActive"], null);
};
...
const move_delete_container_mapDispatchToProps = (dispatch, ownProps) => ({
  ...
  moveTicket: ticketId => dispatch(Object(actions["c" /* showModal */])(ticketId, ownProps.clientId))
});
...
const confirmLabel = hasBeenCreated => hasBeenCreated ? Object(external_wp_i18n_["__"])('Update Ticket', 'event-tickets') : Object(external_wp_i18n_["__"])('Create Ticket', 'event-tickets');
...
const TicketDashboard = _ref => {
  ...
  return wp.element.createElement(external_React_["Fragment"], null, hasBeenCreated && wp.element.createElement(move_delete_container, {
    clientId: clientId
...
const getIsConfirmDisabled = (state, ownProps) => !ticket["f" /* selectors */].isTicketValid(state, ownProps) || !ticket["f" /* selectors */].getTicketHasChanges(state, ownProps) || ticket["f" /* selectors */].isTicketDisabled(state, ownProps) || ticket["f" /* selectors */].getTicketHasDurationError(state, ownProps);
...
function editor_container_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? editor_container_ownKeys(Object(source), !0).forEach(function (key) { defineProperty_default()(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : editor_container_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
/**
 * External dependencies
 */

( function ( $ ) {
    ...
    var redirectionLink = " https://dethemekitaddons.com/pro/?utm_source=wp-menu&utm_medium=wp-dash&utm_campaign=get-pro&utm_term=";
    "use strict";
   ...
   $(".pro-slider").on('click', function(){
    ...
    $( '.pa-rollback-button' ).on( 'click', function( event ) {
				...
				dialogsManager.createWidget( 'confirm', {
					headerMessage: dethemekitRollBackConfirm.i18n.rollback_to_previous_version,
					message: dethemekitRollBackConfirm.i18n.rollback_confirm,
					strings: {
						cancel: dethemekitRollBackConfirm.i18n.cancel,
                        confirm: dethemekitRollBackConfirm.i18n.yes,
					},
					onConfirm: function() {

...
class dtk_Enqueue_Style {
  ...
  public function frontend_styles() {
    ...
    wp_enqueue_style('ecs-styles', DETHEMEKIT_ADDONS_URL . 'assets/css/de_loop/ecs-style.css',array(),DETHEMEKIT_ADDONS_VERSION);
    wp_enqueue_script('ecs-script', DETHEMEKIT_ADDONS_URL . 'assets/js/de_loop/ecs.js',array(),DETHEMEKIT_ADDONS_VERSION);

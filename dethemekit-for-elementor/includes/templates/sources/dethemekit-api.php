...
namespace DethemeKitAddons\Includes\Templates\Sources;
...
class DethemeKit_Templates_Source_Api extends DethemeKit_Templates_Source_Base {
	...
	*/
	public function get_version() {
		...
		if ( ! $version ) {
			$version = Templates\dethemekit_templates()->api->get_info( 'api_version' );
	...
	*/
	...
	public function remote_get_templates( $tab ) {
		...
		$api_url = Templates\dethemekit_templates()->api->api_url( 'templates' );
	...
	public function remote_get_categories( $tab ) {
		...
		$api_url = Templates\dethemekit_templates()->api->api_url( 'categories' );
	...
	public function remote_get_keywords( $tab ) {
		...
		$api_url = Templates\dethemekit_templates()->api->api_url( 'keywords' );
	...
	*/
	public function get_item( $template_id, $tab = false ) {
        ...
        $license_key = Templates\dethemekit_templates()->config->get( 'key' );
        
		$api_url = Templates\dethemekit_templates()->api->api_url( 'template' );

...
abstract class DethemeKit_Templates_Source_Base {
	...
	*/
	...
	public function templates_key() {
		return 'dethemekit_templates_' . $this->get_slug() . '_' . $this->get_version();
	}
	...
	public function categories_key() {
		return 'dethemekit_categories_' . $this->get_slug() . '_' . $this->get_version();
	}
	...
	public function keywords_key() {
		return 'dethemekit_keywords_' . $this->get_slug() . '_' . $this->get_version();
	}
	...
	public function is_debug_active() {
		...
		if ( defined( 'DETHEMEKIT_API_DEBUG' ) && true === DETHEMEKIT_API_DEBUG ) {
			return true;
		} else {
			return false;
		}
	...
	/**
	 * Returns template ID prefix for dethemekit templates
	 *
	 * @return string
	 */

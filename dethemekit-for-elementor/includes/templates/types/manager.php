...
if ( ! class_exists( 'DethemeKit_Templates_Types' ) ) {

	/**
     * DethemeKit Templates Types.
     *
     ...
     * 
     */
	class DethemeKit_Templates_Types {
        ...
        /**
         * DethemeKit_Templates_Types constructor.
         *
		...
		public function register_types() {
			...
			$base_path = DETHEMEKIT_ADDONS_PATH . 'includes/templates/types/';

			require $base_path . 'base.php';

			$temp_types = array(
				__NAMESPACE__ . '\DethemeKit_Structure_Section' => $base_path . 'section.php',
			);
			...
			do_action( 'dethemekit-templates/types/register', $this );

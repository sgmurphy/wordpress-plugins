...
class Maps extends WPML_Elementor_Module_With_Items {
	...
	public function get_items_field() {
		return 'dethemekit_maps_map_pins';
	}
	...
	protected function get_title( $field ) {
        ...
        if ( 'map_latitude' === $field ) {
			return __( 'Maps: Marker Latitude', 'dethemekit-addons-for-elementor' );
		}
        if ( 'map_longitude' === $field ) {
			return __( 'Maps: Marker Longitude', 'dethemekit-addons-for-elementor' );
		}
        if ( 'pin_title' === $field ) {
			return __( 'Maps: Marker Title', 'dethemekit-addons-for-elementor' );
		}
        if ( 'pin_desc' === $field ) {
			return __( 'Maps: Marker Description', 'dethemekit-addons-for-elementor' );
		}

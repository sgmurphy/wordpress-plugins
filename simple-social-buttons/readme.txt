...
= 4.1.0 - 2023-03-20 =
* Bugfix: Twitter share fix for mobile.
* Enhancement: Resolve the PHP 8.1 Warnings.
* Compatibility: Compatible with PHP 8.2
* Compatibility: Compatible with WordPress 6.2

= 4.0.3 - 2023-01-19 =
* Enhancement: Added a filter `ssb_button_attrs` that can be used to update the attributes of social buttons.

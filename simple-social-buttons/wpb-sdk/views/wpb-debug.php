...
<h1>WPB Debug - SDK v.<?php echo WP_WPB__SDK_VERSION; ?></h1>
...
<table id="wpb_sdks" class="widefat">
    ...
    <tbody>
        <tr style="background: #E6FFE6; font-weight: bold">
            <td><?php echo WP_WPB__SDK_VERSION; ?></td>
            <td><?php echo WPB_SDK_DIR; ?></td>
            <td><?php echo WPB_PLUGIN_DIR; ?></td>
            <td>Active</td>
        </tr>
    </tbody>
</table>

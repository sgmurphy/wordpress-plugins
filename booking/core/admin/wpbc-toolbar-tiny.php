            ...
            ?><table class="form-table"><tbody><?php   
                ...
                WPBC_Settings_API::field_textarea_row_static( 'wpbc_booking_options'
                                                            , array(  
                                                                    ...
                                                                    , 'description'       => ''
                                                                    , 'placeholder'       => '{calendar months_num_in_row=2 width=100% cell_height=45px}'
                                                                    , 'description_tag'   => 'span'
                ...
                WPBC_Settings_API::field_html_row_static( 'advanced_section_help2'
                                                        , array(  
                                                              ...
                                                              , 'html'  =>  wpbc_show_message_in_settings( 
                                                                                    ...
                                                                                    . __( 'Calendar have 2 months in a row, the cell height is 30px and calendar max. full width 568px (possible to use percentage for width: 100%)', 'booking' )
                                                                                    . '<br/><strong>' . __( 'Code Example', 'booking' ) . ' : </strong>'
                                                                                    . '<code>{calendar months_num_in_row=2 width=682px cell_height=45px}</code>'
                                                                                    . '<br/><strong>' . __( 'Another Example', 'booking' ) . ' : </strong>'
                                                                                    . '<code>{calendar months_num_in_row=3 width=100% cell_height=45px}</code>'
                                                                                    . '</li>'

...
class DSM_Before_After_Image extends ET_Builder_Module {
	...
	public function get_advanced_fields_config() {
		return array(
			'fonts'          => array(
				'before_label' => array(
					'label'           => esc_html__( 'Before Label', 'dsm-supreme-modules-for-divi' ),
					'css'             => array(
				...
				'after_label'  => array(
					'label'           => esc_html__( 'After Label', 'dsm-supreme-modules-for-divi' ),
					'css'             => array(
	...
	public function get_fields() {
		return array(
			...
			'show_label_hover'              => array(
				'label'            => esc_html__( 'Show Labels on Hover', 'dsm-supreme-modules-for-divi' ),
				'type'             => 'yes_no_button',
			...
			'default_offset_pct'            => array(
				'label'            => esc_html__( 'Default Offset Percentage', 'dsm-supreme-modules-for-divi' ),
				'type'             => 'range',
				'option_category'  => 'configuration',
			...
			'orientation'                   => array(
				'label'            => esc_html__( 'Orientation', 'dsm-supreme-modules-for-divi' ),
				'type'             => 'select',
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		$show_label_hover  = $this->props['show_label_hover'];
		...
		$this->add_classname( 'off' === $show_label_hover ? 'dsm-before-after-image-show-labels' : '' );
		...
		if ( isset( get_option( 'dsm_settings_misc' )['dsm_dynamic_assets'] ) && ! empty( get_option( 'dsm_settings_misc' )['dsm_dynamic_assets'] ) && 'on' === get_option( 'dsm_settings_misc' )['dsm_dynamic_assets'] ) {
			if ( isset( get_option( 'dsm_settings_misc' )['dsm_dynamic_assets_compatibility'] ) && ! empty( get_option( 'dsm_settings_misc' )['dsm_dynamic_assets'] ) && 'on' === get_option( 'dsm_settings_misc' )['dsm_dynamic_assets_compatibility'] ) {
				wp_enqueue_style( 'dsm-before-after-image', plugin_dir_url( __DIR__ ) . 'BeforeAfterImage/style.css', array(), DSM_VERSION, 'all' );
			} else {
	...
	public function dsm_load_required_divi_assets( $assets_list, $assets_args, $instance ) {
		...
		// BeforeAfterImage.
		if ( ! isset( $assets_list['dsm_before_after_image'] ) ) {
			$assets_list['dsm_before_after_image'] = array(
				'css' => plugin_dir_url( __DIR__ ) . 'BeforeAfterImage/style.css',
			);
		}

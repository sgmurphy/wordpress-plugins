...
class HappyForms_Form_Part_Library {
	...
	private $standard_parts = array(
		...
		29 => array( 'HappyForms_Part_HiddenText', 'class-part-hidden-text' ),
		...
		104 => array( 'HappyForms_Part_Image', 'class-part-image' ),
		105 => array( 'HappyForms_Part_Video', 'class-part-video' ),
		106 => array( 'HappyForms_Part_Audio', 'class-part-audio' ),
		108 => array( 'HappyForms_Part_Divider', 'class-part-divider' ),
	);

...
class HappyForms_Part_Audio extends HappyForms_Form_Part {

	public $type = 'audio';

	public function __construct() {
		$this->label = __( 'Audio', 'happyforms' );
		$this->description = __( 'For adding a single audio.', 'happyforms' );
	...
	public function customize_templates() {
		$template_path = happyforms_get_core_folder() . '/templates/parts/customize-audio.php';
	...
	public function frontend_template( $part_data = array(), $form_data = array() ) {
		...
		include( happyforms_get_core_folder() . '/templates/parts/frontend-audio.php' );
	}
	...
	public function customize_enqueue_scripts( $deps = array() ) {
		...
		wp_enqueue_script(
			'happyforms-audio-handle',
			happyforms_get_plugin_url() . 'core/assets/js/customize/audio.js',
		...
		wp_enqueue_script(
			'part-audio',
			happyforms_get_plugin_url() . 'core/assets/js/parts/part-audio.js',

...
class HappyForms_Part_Image extends HappyForms_Form_Part {

	public $type = 'image';

	public function __construct() {
		$this->label = __( 'Image', 'happyforms' );
		$this->description = __( 'For adding a single image.', 'happyforms' );
	...
	public function customize_templates() {
		$template_path = happyforms_get_core_folder() . '/templates/parts/customize-image.php';
	...
	public function frontend_template( $part_data = array(), $form_data = array() ) {
		...
		include( happyforms_get_core_folder() . '/templates/parts/frontend-image.php' );
	}
	...
	public function customize_enqueue_scripts( $deps = array() ) {
		...
		wp_enqueue_script(
			'happyforms-image-handle',
			happyforms_get_plugin_url() . 'core/assets/js/customize/image.js',
		...
		wp_enqueue_script(
			'part-image',
			happyforms_get_plugin_url() . 'core/assets/js/parts/part-image.js',

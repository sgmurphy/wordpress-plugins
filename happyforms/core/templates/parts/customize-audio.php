<script type="text/template" id="happyforms-customize-audio-template">
	...
	<div class="happyforms-media-upload happyforms-audio-upload" data-overlay-title="<?php _e( 'Select audio', 'happyforms' ); ?>" data-overlay-button-text="<?php _e( 'Select Audio', 'happyforms' ); ?>">
		<p><% if ( instance.label ) { %><label><?php _e( 'Audio', 'happyforms' ); ?></label><% } %></p>
		<div class="attachment-media-view">
			...
			<button type="button" class="upload-button happyforms-upload-button button-add-media<%= ( ! instance.attachment ) ? ' show' : '' %>" data-upload-target="attachment"><?php _e( 'Select audio', 'happyforms' ); ?></button>
			<input type="hidden" data-bind="attachment" value="<%= instance.attachment %>">

			<div class="actions happyforms-upload-actions">
				<button type="button" class="button happyforms-change-button upload-button<%= ( 0 != instance.attachment ) ? ' show' : '' %>"><?php _e( 'Replace Audio', 'happyforms' ); ?></button>
			</div>
		</div>
	</div>

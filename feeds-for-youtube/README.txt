...
* Fix: Emoji in video descriptions would break our backup feed system when an older version of MySQL was in use.
* Fix: Fixed PHP deprecation warning "Passing null to parameter" for PHP 8.2+

= 2.0.7 =
* Fix: Fixed a broken link in the admin area.
* Fix: Removed a CSS property causing a 404 error in some circumstances.
...
* Fix: Fixed a separate rare PHP error "Uncaught Error: Class ‘Smashballoon\Customizer\Container’ not found".

= 2.0.5 =
* Fix: Fixed a conflict with the All in One SEO plugin causing menu tabs to not work properly.
* Fix: Fixed rare PHP error "Uncaught Error: Class ‘Smashballoon\Customizer\Container’ not found".

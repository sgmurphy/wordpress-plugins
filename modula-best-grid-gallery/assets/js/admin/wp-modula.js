...
wp.Modula.modalChildViews =
	'undefined' === typeof wp.Modula.modalChildViews
		...
		: wp.Modula.modalChildViews;
wp.Modula.previewer =
	'undefined' === typeof wp.Modula.previewer ? {} : wp.Modula.previewer;
...
wp.Modula.upload =
	'undefined' === typeof wp.Modula.upload ? {} : wp.Modula.upload;
...
(function ($) {
	...
	if (
		'undefined' == typeof wp.Modula.Resizer &&
		wp.Modula.previewer['resizer']
	) {
	...
	jQuery(document).on(
		...
		'.modula-link input[name="link"]',
		function () {
			var url =
				modulaHelper.ajax_url +
				'?action=modula_autocomplete&nonce=' +
	...
	$('#modula-image-loaded-effects ').on(
		'click',
		'#test-scaling-preview',
		function (e) {
			e.preventDefault();
	...
	$('tr[data-container="emailMessage"] td .modula-placeholders').on(
		'click',
		'span',
		function () {
	...
	var inputs = $(
		'#modula-hover-effect .modula-hover-effect-item input[type="radio"]'
	);
	$('#modula-hover-effect .modula-hover-effect-item').on(
		'click',
		function () {

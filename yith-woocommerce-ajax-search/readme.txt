...
== Changelog ==
= 2.7.1 - Released on 02 September 2024 =
* Update: YITH plugin framework
* Fix: XSS issue by leveraging HTML API for adding block attribute data.

= 2.7.0 - Released on 14 August 2024 =
* New: support for WooCommerce 9.2
* Update: YITH plugin framework

= 2.6.0 - Released on 11 July 2024 =
* New: support for WordPress 6.6
* New: support for WooCommerce 9.1
* Update: YITH plugin framework

= 2.5.1 - Released on 11 June 2024 =
* Update: YITH plugin framework
* Fix: Fatal error on esc_url

= 2.5.0 - Released on 6 June 2024 =
* New: support for WooCommerce 9.0
* Update: YITH plugin framework

= 2.4.1 - Released on 23 May 2024 =
* Update: YITH plugin framework
* Fix: Security patch Unauthenticated Stored Cross-Site Scripting

= 2.4.0 - Released on 13 May 2024 =
...
= 1.37.0 - Released on 14 November 2023 =
* New: support for WordPress 6.4
* New: support for WooCommerce 8.3
* Update: YITH plugin framework

= 1.36.0 - Released on 13 October 2023 =
* New: support for WooCommerce 8.2
* Update: YITH plugin framework

= 1.35.0 - Released on 13 September 2023 =
* New: support for WooCommerce 8.1
* Update: YITH plugin framework

= 1.34.0 - Released on 02 August 2023 =

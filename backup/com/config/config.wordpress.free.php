...
//JetBackup Support URL
define('SG_BACKUP_SUPPORT_URL', 'https://billing.jetapps.com/submitticket.php?step=2&deptid=1');
define('BG_UPGRADE_URL', 'https://jetbackup.com/pricing/');

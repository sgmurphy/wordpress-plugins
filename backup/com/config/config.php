...
define('SG_BACKUP_FILE_NAME_DEFAULT_PREFIX', isset($_SERVER['SERVER_NAME']) ? $_SERVER['SERVER_NAME'] : 'jetbackup' . '_');

//Default folder name for storage upload
define('SG_BACKUP_DEFAULT_FOLDER_NAME', 'jetbackup');
...
define('SG_RESTORE_STATE_FILE_NAME', 'restore_state.json');
define('SG_EXTRACT_STATE_FILE_NAME', 'extract_state.json');
define('SG_STATE_FILE_NAME_UPLOAD', 'state_upload.json');
define('SG_BACKUP_ACTION_ID_FILE', '_actionId.ini');
define('SG_BACKUP_PROCESS_ID_FILE', '_processId.ini');
define('SG_BACKUP_CRON_LAST_FILE', 'cron.last');

define('SG_BACKUP_TREE_FILE_COUNT', '_tree_file_count.ini');
define('SG_BACKUP_DIR_OFFSET', '_dir_offset.ini');
define('SG_BACKUP_TREE_GENERATOR_DONE', '_tree_done.loc');
define('SG_BACKUP_OFFSET_ALL_POS_FILE', '_offsetAll.ini');



define('SG_BACKUP_TREE_FILES', '_tree_files.ini');
define('SG_BACKUP_DB_LOCK', '_dump_db.lock');


define('JBWP_DIRECTORY_STATE_FILE_NAME', 'dir_state.json');
...
define('SG_ACTION_STATUS_TREE', 22);
...
define('SG_ACTION_STATUS_NULL', 8);
define('SG_ACTION_STATUS_IMPORTED', 9);
define('SG_ACTION_STATUS_MIGRATION', 10);
define('SG_ACTION_TYPE_BACKUP', 1);
define('SG_ACTION_TYPE_RESTORE', 2);
define('SG_ACTION_TYPE_UPLOAD', 3);
define('SG_ACTION_TYPE_EXTRACT', 4);
...
define('SG_BADGE_SILVER_PLUS_TEXT', "Solo +");
define('SG_BADGE_GOLD_PLUS_TEXT', "Admin +");
define('SG_BADGE_PLATINUM_TEXT', "Pro");

define('SG_SILVER_TOOLTIP_TEXT', "This is a pro feature and it’s available starting from the Solo version!");
define('SG_GOLD_TOOLTIP_TEXT', "This is a pro feature and it’s available starting from the Admin version!");
define('SG_PLATINUM_TOOLTIP_TEXT', "This is a pro feature and it’s available only in Pro version!");
...
define('SG_BACKUP_FOLDER_NAME', 'jetbackup');
define('SG_BACKUP_OLD_FOLDER_NAME', 'backup-guard');

define('JBWP_LICENSE_KEY_STATUS_EXPIRED', 'expired');

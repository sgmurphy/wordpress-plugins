...
<div class="sg-error-notice-wrapper">
    ...
    <p class="sg-red-color sg-notice-error-p">
        Seems one of the files needed for backup process doesn't have a writable permission. <br>The file can be found in the wp-content/uploads directory, <?php echo SG_BACKUP_FOLDER_NAME ?> folder. You should give full permission (777) to that directory.
    </p>
    <p class="sg-red-color sg-notice-error-p">

...
$banerText  = "You're running the Free version of the plugin.<br>If you're interested in website migration, backup to cloud, scheduled backups, mail notifications, then don't wait to buy JetBackup Pro <b>NOW!</b>";
...
<div id="sg-banner">
    ...
    <div id="sg-center-column">
        <?php if (empty($banner)) : ?>
            ...
            <p>
                <a id="sg-buy-now" target="_blank" href="https://jetbackup.com/pricing/">
                ...
                <?php if ($pluginCapabilities == BACKUP_GUARD_CAPABILITIES_FREE) : ?>
                    <span id="sg-banner-clarification">*Solo package</span>
                <?php endif; ?>
            </p>
        <?php else : ?>
            <?php echo $banner; ?>
    ...
    <div id="sg-right-column">
        ...
        <ul>
            ...
            <li id="sg-social-buttons">
                <a class="sg-banner-social-button" id="sg-facebook" target="_blank"
                   href="https://www.facebook.com/jetapps1"></a>
                <a class="sg-banner-social-button" id="sg-twitter" target="_blank"
                   href="https://twitter.com/jetapps"></a>
                <a class="sg-banner-social-button" id="sg-youtube" target="_blank"
                   href="https://www.youtube.com/@jetapps5069"></a>
            </li>
            <br>
            <li id="sg-rate-us">

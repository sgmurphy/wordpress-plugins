...
<input type="text" class="input-sm col-md-4" ng-model="query_params.Amazon.associate_tag"
       ng-init="query_params.Amazon.associate_tag = ''" placeholder="Custom tag" title="Custom associate tag"/>
...
<?php if ( $search_index && $search_index != 'All' ): ?>
    ...
    <select class="input-sm col-md-4" ng-model="query_params.<?php echo esc_attr($module_id); ?>.min_percentage_off">
        <option value=""><?php esc_html_e( 'Discount', 'content-egg' ); ?></option>
    ...
    <input type="text" class="input-sm col-md-4" ng-model="query_params.Amazon.minimum_price"
           ...
           title="<?php esc_html_e( 'Min. price.', 'content-egg' ) ?> <?php esc_html_e( 'It require that you specify a category.', 'content-egg' ) ?>"/>
    <input type="text" class="input-sm col-md-4" ng-model="query_params.Amazon.maximum_price"
           ...
           title="<?php esc_html_e( 'Max. price.', 'content-egg' ) ?> <?php esc_html_e( 'It require that you specify a category.', 'content-egg' ) ?>"/>
<?php endif; ?>

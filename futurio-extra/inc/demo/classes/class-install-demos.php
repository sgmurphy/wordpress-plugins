    ...
    public function create_admin_page() {
        ...
        <div class="fwp-demo-wrap wrap">
            ...
            <p>
                ...
                <a href="<?php echo esc_url(wp_nonce_url(admin_url( 'themes.php?page=futurio' ), 'futurio_extra_page', 'futurio_extra_nonce')); ?>" class="button action-btn">
            ...
            <div class="theme-browser rendered">
                ...
                <div class="themes wp-clearfix">
                    ...
                    foreach ($demos as $demo => $key) {
						...
						$required_theme = isset($key['required_theme']) ? $key['required_theme'] : '' ;
						$demo_img = isset($key['demo_img']) ? $key['demo_img'] : '' ;
						$theme = wp_get_theme();
                        ?>
                        ...
                        <div class="theme-wrap" data-categories="<?php echo esc_attr($item_categories); ?>" data-name="<?php echo esc_attr(strtolower($demo)); ?>">
                            ...
                            <div class="theme fwp-open-popup" data-demo-id="<?php echo esc_attr($demo); ?>">
                                ...
                                <div class="theme-screenshot">
                                    <img src="<?php echo esc_url($demo_img); ?>" />
                                    ...
                                    <?php } ?>
									<?php if ((isset($required_theme) && !empty($required_theme)) && ($theme->template != $required_theme) ) { ?>
										<div class="pro-badge theme-badge">
                                            <?php esc_html_e(ucwords(str_replace('-',' ',$required_theme))); ?>
                                        </div>
									<?php } ?>	
                                </div>

...
Kirki::add_field( 'futurio_extra', array(
	...
	'default'     => '<p><img src="' . esc_url( plugin_dir_url( dirname(__FILE__) ) ) . '/admin/img/futurio-sites.png' .'"></p><a href="' . esc_url( admin_url( 'themes.php?page=futurio-panel-install-demos' ) ) . '" class="button action-btn view-site-library">' . esc_html__( 'See Library', 'futurio-extra' ) . '</a>',
	'priority'    => 10,
) );
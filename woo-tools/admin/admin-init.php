...
function tfwctool_options_menu(){
    ...
    add_menu_page(
        __('WooCommerce Tools','woocommerce-tools'), 
        __('WooCommerce Tools','woocommerce-tools'), 
        'manage_options', 
        'tfwctool', 
    ...
    add_submenu_page( 'tfwctool', esc_html__('Dashboard', 'woocommerce-tools'), esc_html__('Dashboard', 'woocommerce-tools'), 'manage_options', 'woocommerce-tools', 'tfwctool_dashboard_page' );

    ...
    <div class="tfwctool-setting-container">
        <form action="options.php" method="post">
            <?php
                ...
                $w_loop_location      = isset($options['loop_location'])?$options['loop_location']:'after_add_to_cart';
                $w_single_location      = isset($options['single_location'])?$options['single_location']:'after_add_to_cart';
            ...
            <table class="form-table">
                ...
                <!-- <tr valign="top">
                    <th scope="row"><?php esc_html_e('Button Location in product list', 'woocommerce-tools'); ?></th>
                    <td>
                        <select name="tfwctool_wishlist[loop_location]">
                            <option value="before_image" <?php selected($w_loop_location, 'before_image') ?>>Before Image</option>
                            <option value="before_add_to_cart" <?php selected($w_loop_location, 'before_add_to_cart') ?>>Before Add To Cart</option>
                            <option value="after_add_to_cart" <?php selected($w_loop_location, 'after_add_to_cart') ?>>After Add To Cart</option>
                        </select>
                    </td>
                </tr> -->
                <tr><td colspan="2"><hr></td></tr>
                ...
                <!-- <tr valign="top">
                    <th scope="row"><?php esc_html_e('Button Location on single product', 'woocommerce-tools'); ?></th>
                    <td>
                        <select name="tfwctool_wishlist[single_location]">
                            <option value="before_image" <?php selected($w_single_location, 'before_image') ?>>Before Image</option>
                            <option value="before_add_to_cart" <?php selected($w_single_location, 'before_add_to_cart') ?>>Before Add To Cart</option>
                            <option value="after_add_to_cart" <?php selected($w_single_location, 'after_add_to_cart') ?>>After Add To Cart</option>
                        </select>
                    </td>
                </tr> -->
                <tr><td colspan="2"><hr></td></tr>

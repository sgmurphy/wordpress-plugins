	...
	<table class="shop_table shop_table_responsive cart">
		<thead>
			<tr>
				...
				<th class="product-name"><?php esc_html_e( 'Product Name', 'woocommerce-tools' ); ?></th>
				<th class="product-price"><?php esc_html_e( 'Price', 'woocommerce-tools' ); ?></th>
				<th class="product-quantity"><?php esc_html_e( 'Stock Status', 'woocommerce-tools' ); ?></th>
			...
			<?php 
				if($product_ids): 
					foreach ($product_ids as $key => $product_id): 
						...
						<td class="product-name" data-title="<?php esc_attr_e( 'Product', 'woocommerce-tools' ); ?>">
						<?php
							if ( ! $product_permalink ) {
						...
						<td class="product-price" data-title="<?php esc_attr_e( 'Price', 'woocommerce-tools' ); ?>">

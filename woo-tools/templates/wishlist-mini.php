...
<div class="widget_tfwctool_wishlist_content">
	...
	<div class="tfwctool-mini-wishlist-bottom-container">
		<div class="tfwctool-mini-wishlist-total">
			<span class="tfwctool-lable"><?php esc_html_e( 'Items', 'woocommerce-tools' ); ?></span><span class="tfwctool-value"><?php echo count($product_ids) ?></span>
		</div>
		<div class="tfwctool-mini-wishlist-actions">
			<a class="btn button tfwctool-wishlist-btn" href="<?php echo esc_url( tfwctool_get_wishlist_url() ); ?>"><?php esc_html_e( 'View Wishlist', 'woocommerce-tools' ); ?></a>
		</div>
	</div>
	<?php else: ?>

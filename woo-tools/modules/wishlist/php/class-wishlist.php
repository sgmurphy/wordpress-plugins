...
class TFWC_TOOL_Wishilst {
	...
	public function __construct() {
		...
		/*if ($show_in_prodict_list) {
			...
			if($w_loop_location == 'after_add_to_cart'){
				add_action('woocommerce_after_shop_loop_item', 'tfwctool_add_to_wishlist_button', 30);
			}elseif($w_loop_location == 'before_add_to_cart'){
				add_action('woocommerce_after_shop_loop_item', 'tfwctool_add_to_wishlist_button', 11);
			}else{

<div class="cbb-edit-field-container">
	<div class="ccb-edit-field-header">
		<span class="ccb-edit-field-title ccb-heading-3 ccb-bold"><?php esc_html_e( 'Html element', 'cost-calculator-builder' ); ?></span>
		<div class="ccb-field-actions">
			...
			<button class="ccb-button success" @click.prevent="$emit( 'save', htmlField, id, index, htmlField.alias )"><?php esc_html_e( 'Save', 'cost-calculator-builder' ); ?></button>
		</div>
	</div>
	<div class="ccb-grid-box">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="calc-html-textarea">
						<span class="ccb-input-label"><?php esc_html_e( 'HTML5 Code', 'cost-calculator-builder' ); ?></span>
						<textarea rows="14" class="ccb-heading-5 ccb-light" v-model="htmlField.htmlContent" placeholder="<?php esc_attr_e( 'Put HTML code here', 'cost-calculator-builder' ); ?>"></textarea>
					</div>
				</div>
			</div>

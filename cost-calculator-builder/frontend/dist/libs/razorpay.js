  ...
  var e = {
      ...
      50668: function (e, t, n) {
        ...
        function f(e) {
          var t =
            ...
            i = t.onEmpty || s,
            a = t.onPause || s,
            c = l({ max: r, queue: n, interval: o, handler: e, onEmpty: i });
          return (
            n.length && c.schedule(),
            {
              flush: function () {
        ...
        function v(e, t, n) {
          ...
          Object.keys(r)
            ...
            'function' == typeof r &&
              ((null != e && e.loaded()) || n === a.INITIALIZE
                ? r(c, o)
                : (function (e, t, n, r) {
                    e.pendingQ ||
                      (e.pendingQ = f(
            ...
            function e(t) {
              ...
              var n = t.app,
                ...
                s = {
                  ...
                  platform: (0, c.getDevice)(),
                };
              (this.flattenedContext = (0, y.xH)(s)),
                (this.userIdKey = ''.concat(n, '_user_id')),
                (this.anonIdKey = ''.concat(n, '_anon_id')),
                _.Z.getItem(this.anonIdKey) || this.setAnonymousId((0, g.D)()),
                (this.state = {
                  app: n,
                  anonymousId: _.Z.getItem(this.anonIdKey) || '',
                  userId: _.Z.getItem(this.userIdKey) || '',
                  context: s,
                  plugins: u(i),
              ...
              (0, i.Z)(e, [
                {
                  key: 'setAnonymousId',
                  value: function (e) {
                    _.Z.setItem(this.anonIdKey, e),
                      this.state &&
                        ((this.state.anonymousId = e),
                        b(this.state.subscriptions, m.ANON_ID_UPDATED, e));
                  },
                },
                {
                  key: 'setUserId',
                  value: function (e) {
                    _.Z.setItem(this.userIdKey, e),
                      this.state &&
                        ((this.state.userId = e),
                        b(this.state.subscriptions, m.USER_ID_UPDATED, e));
                  },
                },
                {
                  key: 'on',
                ...
                },
                {
                  key: 'reset',
                  value: function () {
                    this.setAnonymousId((0, g.D)()), this.setUserId('');
                  },
                },
                {
                  key: 'getState',
              ...
              F(
                F(
                  ...
                  (W = !0),
                  {
                    ...
                    initialize: function () {
                      (Y = f(
                        ...
                        window.addEventListener('beforeunload', function () {
                          var e;
                          (W = !0),
                            null === (e = Y) || void 0 === e || e.flush(!0);
                        }),
                        window.addEventListener('offline', function () {
                          var e;
                          null === (e = Y) || void 0 === e || e.pause();
                        }),
                        window.addEventListener('online', function () {
                          var e;
                          null === (e = Y) || void 0 === e || e.resume();
                        });
                    },
                    pause: function () {
                      var e;
                    ...
                    track: function (e, t) {
                      var n, r;
                      null === (n = Y) || void 0 === n || n.push(e),
                        t.isImmediate &&
                          (null === (r = Y) || void 0 === r || r.flush());
                    },
                    identify: function (e) {
                      (function (e) {
                        var t = e.url,
                      ...
                      })({ url: z, key: G, payload: e }).catch(k.returnAsIs);
                    },
                    loaded: function () {
                      return !0;
                    },
        ...
        S.Z.subscribe('syncContext', function (e) {
          var t, n;
          e.data && ((t = e.data.key), (n = e.data.value)),
            t && V.setContext(t, n);
        }),
          S.Z.subscribe('syncAnonymousId', function (e) {
            var t;
            null !== (t = e.data) &&
              void 0 !== t &&
              t.anonymousId &&
              V.setAnonymousId(e.data.anonymousId);
          }),
          S.Z.subscribe('syncUserId', function (e) {
            var t;
            null !== (t = e.data) &&
              void 0 !== t &&
              t.userId &&
              V.setUserId(e.data.userId);
          });
        var $ = V,
          J = n(84679),
          X = n(39547);
              ...
              c[t] = (function (e, t, n, r) {
                return function () {
                  if (!n) {
                    ...
                    if ('string' == typeof o) $.track(o, i, a);
                    else if (o.name) {
                      var c = o.name;
                      o.type && (c = ''.concat(o.type, ' ').concat(c)),
                        o.type !== X.ERROR && (ee = { event: c, funnel: r }),
                        $.track(c, i, a);
                    }
                  }
                };
            ...
            setContext: function (e, t) {
              ...
              $.setContext(e, t),
                n &&
                  ...
                  (function (e, t) {
                    J.isIframe
                      ? S.Z.publishToParent('syncContext', { key: e, value: t })
                      : $.setContext(e, t);
                  })(e, t);
            },
            getState: function () {
              return q(q({}, $.getState()), {}, { last: ee });
            },
            Identify: $.identify.bind($),
            Reset: $.reset.bind($),
            configurePlugin: $.configurePlugin.bind($),
            createTrackMethodForModule: te,
          },
          re = (0, i.Z)(function e() {
            (0, o.Z)(this, e);
          });
        (0, r.Z)(re, 'selectedBlock', {}),
          (0, r.Z)(re, 'selectedInstrumentForPayment', {
            method: {},
            instrument: {},
          }),
          (0, r.Z)(re, 'checkoutInvokedTime', Date.now()),
          (0, r.Z)(re, 'personalisationVersionId', ''),
          (0, r.Z)(re, 'submitScreenName', ''),
          (0, r.Z)(re, 'cardFlow', ''),
          (0, r.Z)(re, 'emiMode', ''),
          (0, r.Z)(re, 'flow', ''),
          (0, r.Z)(re, 'personalisationAPIType', ''),
          (0, r.Z)(re, 'contactPrefillSource', ''),
          (0, r.Z)(re, 'emailPrefillSource', ''),
          (0, r.Z)(re, 'user_aggregates_available', !1),
          (0, r.Z)(re, 'p13n_v3_reco_source', ''),
          (0, r.Z)(re, 'prec_improvement_exp', '');
      },
      ...
      28533: function (e, t, n) {
          ...
          D = function () {
            ...
            if (
              ...
              t.forEach(function (e) {
                ('open' === e.event ||
                  ('submit' === e.event && 'razorpayjs' === P.props.library)) &&
            ...
            ? 'test' !== (b = e.getMode()) &&
              setTimeout(function () {
                ...
                R(l),
                  c && i
                    ? D(void 0, [
                        { event: t, properties: m, timestamp: s.zO() },
                      ])
                    : S({ event: t, properties: m, timestamp: s.zO() }),
                  i && D();
              })
            : w.push([t, n, i]);
        }
        setInterval(function () {
          ...
          (P.dispatchPendingEvents = function (e) {
            if (e) {
              var t = P.bind(P, e);
          ...
          (P.parseAnalyticsData = function (e) {
            s.s$(e) &&
              a.VX(e, function (e, t) {
                _[t] = e;
              });
      ...
      84679: function (e, t, n) {
        ...
        var r,
          ...
          b = 7609675205,
          O = 'production',
          E = 'ce13891165f5b5b2c96f21998fb67123e17a439c',
          w =
          ...
          window.addEventListener('message', function (e) {
            ...
            if (
              ...
              (e.origin &&
                ...
                c.iframeReference &&
                e.source ===
                  (null === (t = c.iframeReference) || void 0 === t
                    ? void 0
                    : t.contentWindow))
            ) {
              var r = n || {},
              ...
              o &&
                c.subscriptions[o] &&
                c.subscriptions[o].forEach(function (e) {
                  e(i);
                });
            }
          }),
      ...
      63379: function (e, t, n) {
        ...
        var R = function (e) {
          ...
          P = function () {
            return (n.g.innerWidth && n.g.innerWidth < 485) || w || D();
          },
          T = (function () {
            var e = (0, r.Z)(
              i().mark(function e() {
      ...
      92063: function (e, t, n) {
        ...
        var r = n(71002),
          ...
          s = (n(38111), n(39547)),
          l = n(50668),
          f = { TRIGGERED: { name: 'triggered', type: s.ERROR } },
          m = (0, l.Dw)(f),
          d = n(71985),
          p = n(63379);
        function h(e, t) {
      ...
      23016: function (e, t, n) {
        'use strict';
        n(94656), n(36919), n(73084), n(88921), n(63379);
      },
        ...
        var O = {
          ...
          call: function () {
            var e,
              ...
              y = this.options.url;
            y = g(y);
            var _ = new ((null == v ? void 0 : v.XMLHttpRequest) || m)();
            this.setReq('ajax', _),
              _.open(u, y, !0),
  ...
  (n.n = function (e) {
    ...
    (function () {
      ...
      var Y = n(84679),
        W = (0, e.vl)();
      function V() {
        return (0, T.U2)(window, 'webkit.messageHandlers.CheckoutBridge')
          ? { platform: 'ios' }
          : {
              platform: W.platform || 'web',
              library: 'checkoutjs',
              version: (W.version || Y.BUILD_NUMBER) + '',
            };
      }
      function $(e, t) {
        var n = Object.keys(e);
      ...
      var Q = n(50668),
        ...
        re = (0, Q.Dw)(ee, { funnel: Q.Yi.HIGH_LEVEL }),
        oe =
          ((0, Q.Dw)(te, { funnel: Q.Yi.RETRY }),
          (0, Q.Dw)(ne, { funnel: Q.Yi.P13N_ALGO }),
          n(15671)),
        ie = n(43144),
        ae = n(7005),
        ce = n(54041),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  Object.assign(u, {
                    ...
                    ae.appendTo(u, document.documentElement);
                },
              },
            ]),
            t
      ...
      function se(e) {
        var t,
          r = this;
        if (!A.is(this, se)) return new se(e);
        k.call(this),
          (this.id = R.fQ.makeUid()),
          Q.kK.setContext(Q.Lk.CHECKOUT_ID, this.id),
          R.ZP.setR(this);
        try {
          (t = (function (e) {
            (e && 'object' === (0, S.Z)(e)) || A.kz('Invalid options');
            var t = new x(e);
            return (
              (function (e) {
                var t =
        ...
        try {
          R.fQ.props.library === Y.RAZORPAYJS &&
            ...
            re.CUSTOM_CHECKOUT_INITIALISED({ key: e.key }));
        } catch (e) {}
        B.ZPm.updateInstance(this), this.postInit();
      }
      (0, y.Z)(ue, 'jsonp_cb', 0),
        (se.sendMessage = function (e) {
          throw new Error('override missing for event - '.concat(e.event));
        });
      var le = (se.prototype = new k());
      (le.postInit = P.returnAsIs),
        (le.onNew = function (e, t) {
          var n,
            r,
            o,
            i = this;
          if ('ready' === e) {
            ...
            try {
              R.zW.TrackMetric(Y.CUSTOM_EVENTS.CUSTOM_CHECKOUT_PREFS, {
                ...
                re.CUSTOM_CHECKOUT_PREF({ key: this.get('key') });
            } catch (e) {}
          }
        }),
        (se.emi = {
      ...
      var fe,
        me = {
          notes: function (e) {
            if (T.s$(e) && A.Tk(Object.keys(e)) > 15)
          ...
          display_currency: function (e) {
            if (
              ...
              e !== se.defaults.display_currency
            )
      ...
      (se.configure = function (e) {
        ...
        T.VX(M(e, j), function (e, t) {
          ...
          t.library &&
            ...
            Q.kK.setContext(Q.Lk.LIBRARY, t.library)),
          t.referer &&
            ((R.fQ.props.referer = t.referer),
            Q.kK.setContext(Q.Lk.REFERRER, t.referer));
      }),
        (se.defaults = j),
        (se.enableLite = Boolean(Z.Z.merchant_key || Z.Z.magic_shop_id)),
        ...
        (j.modal = {
          ...
          animation:
            ...
            !(
              null !==
                (fe = n.g.matchMedia('(prefers-reduced-motion: reduce)')) &&
              void 0 !== fe &&
              fe.matches
            ),
          backdropclose: !1,
      ...
      var be = n(41025),
        Oe = function (e) {
          ...
          switch (e) {
            case 'mWebAndroid':
              return 'web' === t.platform && I.android;
            case 'mWebiOS':
              return 'web' === t.platform && I.iOS;
            case 'androidSDK':
      ...
      var Ee = { 'checkout.js': 'checkout.js' };
      function we(e, t) {
        var n = Object.keys(e);
        if (Object.getOwnPropertySymbols) {
          var r = Object.getOwnPropertySymbols(e);
      ...
      var Pe,
        ...
        Le = {
          ...
          resize: function () {
            var e = n.g.innerHeight || Ne.height;
            (Ke.container.style.position = e < 450 ? 'absolute' : 'fixed'),
          ...
          scroll: function () {
            if ('number' == typeof n.g.pageYOffset)
              if (n.g.innerHeight < 460) {
                ...
                n.g.pageYOffset > e + 120 && (0, ye.smoothScrollTo)(e);
      ...
      function xe() {
        return (
          Le.metas ||
            (Le.metas = (0, ye.querySelectorAll)(
      ...
      function Be(e) {
        try {
          Ke.backdrop.style.background = e;
        } catch (e) {}
      }
      function Ke() {
        (Pe = document.body),
      ...
      Ke.prototype = {
        getEl: function () {
          if (!this.el) {
            ...
            this.el = ae.setAttributes(ae.create('iframe'), e);
          }
          return this.el;
        },
        openRzp: function (e) {
          var t = ae.setStyles(this.el, { width: '100%', height: '100%' }),
            n = e.get('parent');
          n && (n = (0, ye.resolveElement)(n));
          var r = n || Ke.container;
          ke ||
            (ke = (function () {
              var e =
                  arguments.length > 0 && void 0 !== arguments[0]
            ...
            e !== this.rzp &&
              (ae.parent(t) !== r && ae.append(r, t), (this.rzp = e)),
            this.rzp &&
              setTimeout(function () {
                Me || R.zW.Track(R.pz.FRAME_NOT_LOADED);
              }, 1e4),
            (function (e) {
              var t = (0, B.RlS)('prefill.contact'),
                n = (0, B.RlS)('prefill.email');
              t && Q.kK.setContext(Q.Lk.TRAITS_CONTACT, t),
                n && Q.kK.setContext(Q.Lk.TRAITS_EMAIL, n),
                (0, B.NOx)() && Q.kK.setContext(Q.Lk.ORDER_ID, (0, B.NOx)()),
                e && Q.kK.setContext(Q.Lk.MODE, e);
              var r = (0, B.RlS)('_.integration');
              r && Q.kK.setContext(Q.Lk.INTEGRATION_NAME, r);
              var o = (0, B.RlS)('_.integration_version');
              o && Q.kK.setContext(Q.Lk.INTEGRATION_VERSION, o);
              var i = Q.cj.INTEGRATION,
                a = Q.B5.WEB,
                c = (0, B.RlS)('_.integration_type');
              c &&
                (c === Q.cj.RZP_APP
                  ? (i = Q.cj.RZP_APP)
                  : c === Q.B5.PLUGIN && (a = Q.B5.PLUGIN),
                Q.kK.setContext(Q.Lk.INTEGRATION_TYPE, c)),
                Q.kK.setContext(Q.Lk.REFERRER_TYPE, i);
              try {
                Oe('androidSDK') ||
                  Oe('iosSDK') ||
                  Q.kK.setContext(Q.Lk.INTEGRATION_PLATFORM, a);
              } catch (e) {}
              var u = (0, B.RlS)('_.integration_parent_version');
              u && Q.kK.setContext(Q.Lk.INTEGRATION_PARENT_VERSION, u);
            })(this.rzp.getMode()),
            n
              ? (ae.setStyle(t, 'minHeight', '530px'), (this.embedded = !0))
              : (ae.offsetWidth(ae.setStyle(r, 'display', 'block')),
                Be(e.get('theme.backdrop_color')),
                /^rzp_t/.test(e.get('key')) &&
                  Ke.ribbon &&
                  (Ke.ribbon.style.opacity = 1),
        ...
        close: function () {
          Be(''),
            Ke.ribbon && (Ke.ribbon.style.opacity = 0),
            (function (e) {
              e && e.forEach(ae.detach);
              var t = xe();
              t &&
                t.forEach(function (e) {
                  return ae.appendTo(e, Te);
                });
            })(this.$metas),
            (Ae.overflow = Le.overflow),
            this.unbind(),
            Ce && je(0, Le.oldY),
            R.fQ.flush();
        },
        bind: function () {
          ...
          if (!this.listeners) {
            ...
            var t = {};
            Ce &&
              ((t.orientationchange = Le.orientationchange),
              this.rzp.get('parent') || (t.resize = Le.resize)),
              T.VX(t, function (t, n) {
                e.listeners.push(ae.on(n, t.bind(e))(window));
              });
          }
        },
        unbind: function () {
        ...
        setMetaAndOverflow: function () {
          Te &&
            ...
            (this.$metas = [
              ae.setAttributes(ae.create('meta'), {
                name: 'viewport',
                content:
            ...
            (Le.overflow = Ae.overflow),
            (Ae.overflow = 'hidden'),
            Ce &&
              ((Le.oldY = n.g.pageYOffset),
              n.g.scrollTo(0, 0),
        ...
        onload: function (e) {
          if (
            ...
            if (n && !r) return;
            this.postMessage(t),
              null === (o = de.parentNode) || void 0 === o || o.removeChild(de);
          }
          var o;
        },
        onfocus: function () {
        ...
        onrender: function () {
          ke && (ae.detach(ke), (ke = null)), this.rzp.emit('render');
        },
        onevent: function (e) {
        ...
        onfailure: function (e) {
          ...
          r && this.ongaevent({ event: he, category: ve }),
            o && this.onfbaevent({ event: he, category: ve }),
            this.ondismiss(),
        ...
        onfault: function (e) {
          ...
          (this.rzp.get('redirect') || I.shouldRedirect) && r
            ? (0, _e.R2)({ url: r, params: { error: e }, method: 'POST' })
            : n.g.alert('Oops! Something went wrong.\n' + t),
            this.afterClose();
        },
        afterClose: function () {
          Ke.container.style.display = 'none';
        },
        onflush: function (e) {
          R.fQ.flush(e);
        },
      ...
      var ze,
        Ge = 'is_one_click_checkout_enabled_lite',
        Ye = 'abandoned_cart',
        We = n(90345),
        Ve = n(49274),
        $e = A.wH(se);
      function Je(e) {
        return function t() {
          return ze ? e.call(this) : (setTimeout(t.bind(this), 99), this);
        };
      }
      !(function e() {
        (ze = document.body || document.getElementsByTagName('body')[0]) ||
          setTimeout(e, 99);
      })(),
        (function () {
          try {
            ...
            var t =
              null === (e = Q.ZP.getPluginState(Ve.B.LUMBERJACK_PLUGIN)) ||
              void 0 === e
                ? void 0
                : e.config;
            null == t || t.pause();
        ...
        (0, U.P_)(function (e, t) {
          try {
            if (t.pauseTracking && !e.pauseTracking) {
              var n,
                r =
                  null === (n = Q.ZP.getPluginState(Ve.B.LUMBERJACK_PLUGIN)) ||
                  void 0 === n
                    ? void 0
                    : n.config;
              null == r || r.resume();
      ...
      var Xe,
        Qe =
          document.currentScript ||
          (Xe = (0, ye.querySelectorAll)('script'))[Xe.length - 1];
      function qe(e) {
        var t = ae.parent(Qe);
        (0, _e.VG)({ form: t, data: (0, _e.xH)(e) }),
      ...
      function rt() {
        if (!et) {
          ...
          var t = (function (e) {
            ...
            return ae.setStyles(t, n), ae.appendTo(t, e);
          })(et);
          Ke.backdrop = t;
          var n =
            ((r = t),
            ...
            ((a = ae.create('span')).textContent = 'Test Mode'),
            ae.setStyles(a, {
      ...
      function at() {
        if (!tt) {
          var e;
          (tt = new Ke()), (Fe.Z.iframeReference = tt.el), Fe.Z.setId(R.fQ.id);
          var t = tt.onmessage.bind(tt);
          null === (e = ae.on('message', t)) || void 0 === e || e(n.g),
            ae.append(et, tt.el);
        }
        return tt;
      }
      (0, I.isBraveBrowser)().then(function (e) {
        ...
        (se.triggerShopifyCheckoutBtnClickEvent = function (e, t) {
          R.zW.setMeta(We.U.BRANDED_BTN_PAGE_TYPE, e || 'unknown'),
      ...
      ($e.onNew = function (e, t) {
        ...
        ($e.open = Je(function () {
            ...
            var e,
              ...
              r =
                ...
                void 0 === t
                  ? void 0
                  : t.getAttribute('lang');
            this.metadata = { isBrave: ot, isPrivate: it, language: r };
          }
          ...
          return (
            ...
            o.openRzp(this),
            R.zW.setMeta(Ye, (0, B.p0H)()),
            R.zW.setMeta(Ge, (0, B.HUG)() && !(0, B.RlS)('order_id')),
      ...
      var ut =
          /^(?:(?:www\.entertainmentportal|mock\.cbtexamportal|w(?:ebview\.loanfront|ww\.(?:nobroker|libas))|foscos\.fssai\.gov|iwbms\.mahabocw)\.in|(?:s(?:ervice\.icicibank|r\.knowlarity)|w(?:ww\.(?:thenewsminute|99acres)|eb\.classplusapp)|client\.indifi|arsmate)\.com|rojgarwithankit\.co\.in|md\.healthplix\.com|www\.pw\.live|localhost|sxx)$/,
        st = Je(function () {
          R.zW.setMeta(R.$J.IS_MOBILE, (0, I.isMobile)()),
            rt(),
            ut.test(location.host) ||
              (window.Intl ? (tt = at()) : R.zW.Track(R.pz.INTL_MISSING)),
            Fe.Z.subscribe(He, function (e) {
              var t = (e.data || {}).url,
                n = Date.now(),
                r = window.onbeforeunload;
              window.onbeforeunload = null;
              try {
                (0, ye.redirectTo)({ method: 'GET', content: '', url: t });
              } catch (e) {}
              setTimeout(function () {
                Fe.Z.sendMessage(''.concat(He, ':finished'), {
      ...
      (R.fQ.props.library = mt),
        (0, U.F$)('library', mt),
        Q.kK.setContext(Q.Lk.LIBRARY, mt),
        Q.kK.setContext(Q.Lk.VERSION, Y.COMMIT_HASH),
        (j.handler = function (e) {
          if (A.is(this, se)) {
            var t = this.get('callback_url');
            t && (0, _e.R2)({ url: t, params: e, method: 'POST' });
          }
        }),
        (j.buttontext = 'Pay Now'),
        (j.parent = null);
      (me.parent = function (e) {
        if (!(0, ye.resolveElement)(e))

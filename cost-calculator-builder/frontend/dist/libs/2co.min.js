...
function ajax2co(a) {
  var b,
    c = !1;
  (a.url = a.url + a.jsonp + '=' + a.jsonpCallback + '&' + a.data),
    (window[a.jsonpCallback] = function () {
      (c = !0), (b = arguments[0]);
    });
  var d,
    e =
...
!(function () {
  ...
  function b(b) {
    ...
    return (
      (n = c(n, escape('@UTC@'), new Date().getTime())),
      (n = c(n, escape('@CT@'), new Date().getTime() - l.getTime())),
      window.f1b5 ? window.f1b5(n) : n
    );
  }
  function c(a, b, c, d) {
    'boolean' != typeof d && (d = !1);
    for (var e, f = !0; (e = a.indexOf(b)) >= 0 && (d || f); )
      (a = a.substr(0, e) + c + a.substr(e + b.length)), (f = !1);
    return a;
  }
  function d(a) {
    var b = Math.min(i, j);
      ...
      try {
        if (navigator.plugins && navigator.plugins.length) {
          ...
          for (f = 0; f < navigator.plugins.length; f++) {
            ...
            null === h && (h = g.exec(navigator.plugins[f].description)),
              h && (c = h[1]);
          }
        } else if (window.ActiveXObject && l[f])
          try {
  ...
  function g(a) {
    var b = '';
    try {
      'undefined' != typeof h.a.getComponentVersion &&
        (b = h.a.getComponentVersion(a, 'ComponentID'));
    } catch (c) {
      (a = c.message.length),
        (a = a > 40 ? 40 : a),
  ...
  try {
    (h.a = document.createElement('span')),
      'undefined' != typeof h.a.addBehavior &&
        h.a.addBehavior('#default#clientCaps');
  } catch (m) {}
  (k = {}),
    (h.jscall = function (a) {
      try {
  ...
  'Gecko' === navigator.product &&
    parseInt(
      n
        .substring(n.indexOf('rv:') + 3, n.indexOf(')', n.indexOf('rv:') + 3))
        .split('.')[0]
    ) <= 2 &&
    window.parm4.jscall();
})(),
  ...
  (System.Type = function () {
    function a() {
      ...
      a &&
        ...
        (this.Namespace = b.slice(0, b.length - 2).join('.')));
    }
  ...
  (System.Type.RegisterNamespace = function (a) {
    if (
      ...
      'function' == typeof Type.registerNamespace
    )
  ...
  (System.Type.RegisterClass = function (a, b, c) {
    if ('undefined' != typeof Type && 'function' == typeof Type.registerClass)
      Type.registerClass(a, b, c);
    else {
  ...
  (System.Type.RegisterInterface = function (a, b) {}),
  (System.Type.RegisterEnum = function (a, b) {
    if ('undefined' != typeof Type && 'function' == typeof Type.registerEnum)
      Type.registerEnum(a, b);
    else {
  ...
  (System.Type.RegisterProperty = function (a) {
    ...
    me[a] = function (b) {
      return 0 == arguments.length
        ? me[a].get()
        : void (1 == arguments.length && me[a].set(b));
    };
  }),
  ...
  (System.Extensions = function () {
    this.Apply = function () {
      ...
      if (('object' == typeof Response && (a = !0), !a)) {
        ...
        try {
          System.Web.UI.HtmlControls.FindControl &&
            (this.d = function () {
              return System.Web.UI.HtmlControls.FindControl.apply(
                this,
                arguments
              );
            });
        ...
        this.$c = function () {
          return System.Web.UI.HtmlControls.FindControlsByClass.apply(
            this,
            arguments
          );
        };
  ...
  (System.Array.Reverse = function (a, b, c) {
    (b = b ? b : 0), (c = c ? c : a.length);
    for (var d = a.slice(b, b + c).reverse(), e = 0; c > e; e++)
      a[e + b] = d[e];
  }),
  ...
  (System.Array.Copy = function () {
    3 == arguments.length && System.Array._Copy1.apply(this, arguments),
      5 == arguments.length && System.Array._Copy2.apply(this, arguments);
  }),
  (System.Array.FillMultiDimensional = function (a, b, c) {
    ...
    else for (d = 0; d < a.length; d++) a[d] = c;
    return a;
  }),
  ...
  (System.Buffer.BlockCopy = function (a, b, c, d, e) {
    for (var f = 0; e > f; f++) c[d + f] = a[b + f];
  }),
  ...
  (System.Text.UTF8Encoder = function () {
    (this.GetBytes = function (a) {
      for (var b = new Array(), c = new Number(), d = 0; d < a.length; d++)
        (c = a.charCodeAt(d)),
          128 > c
            ? b.push(c)
            : 2048 > c
            ? (b.push(192 | (c >> 6)), b.push(128 | (63 & c)))
            : 65536 > c
            ? (b.push(224 | (c >> 12)),
              b.push(128 | ((c >> 6) & 63)),
              b.push(128 | (63 & c)))
  ...
  (System.Convert.Base64Array = function () {
    (this.S =
      ...
      (this.IA = new Array()),
      (this.InitializeClass = function () {
        for (var a = new String(), b = 0; b < this.S.length; b++)
          (a = this.S.charAt(b)), (this.CA[b] = a), (this.IA[a] = b);
      }),
      this.InitializeClass();
  }),
  ...
  (System.Convert.FromBase64String = function (a, b) {
    ...
    for (
      var f,
        g = 0,
        h = e - 1,
        i = '=' == a.charAt(h) ? ('=' == a.charAt(h - 1) ? 2 : 1) : 0,
        j = h - g + 1,
        k = '\r' == a.charAt(76) ? j / 78 : 0,
        l = e > 76 ? k << 1 : 0,
        m = ((6 * (j - l)) >> 3) - i,
        n = new Array(m),
        o = 0,
  ...
  (System.BigInt._Utils = function () {
    ...
    function e(a, b, c) {
      ...
      for (k = f > e + c ? e + c : f, d = f - 1 - c; e > d && d >= 0; d++)
        if (a[d] > 0) return 1;
      for (d = e - 1 + c; f > d; d++) if (b[d] > 0) return 0;
      for (d = k - 1; d >= c; d--) {
    ...
    function f(a, b) {
      ...
      for (c = a.length; c < b.length; c++) if (b[c]) return 0;
      for (c = b.length; c < a.length; c++) if (a[c]) return 1;
      for (c = d - 1; c >= 0; c--) {
        if (a[c] > b[c]) return 1;
        if (a[c] < b[c]) return 0;
      }
    ...
    function g(a, b, c, f) {
      ...
      for (i = g - 1; i >= h; i--) {
        for (
          f[i] == b[h - 1]
            ? (c[i - h] = C)
            : (c[i - h] = Math.floor((f[i] * D + f[i - 1]) / b[h - 1]));
          (k = (h > 1 ? b[h - 2] : 0) * c[i - h]),
            (l = k >> B),
            (k &= C),
            (j = l + c[i - h] * b[h - 1]),
    ...
    function l(a) {
      var b;
      for (b = 0; b < a.length; b++) if (a[b]) return 0;
      return 1;
    }
    function m(a) {
    ...
    function u(a, b) {
      var c,
        ...
        e = 0;
      for (c = a.length - 1; c >= 0; c--)
        (d = e * D + a[c]), (a[c] = Math.floor(d / b)), (e = d % b);
      return e;
    }
    function v(a, b, c, d) {
      var e, f, g, h;
      for (
        g = a.length < d + b.length ? a.length : d + b.length,
          h = a.length,
          f = 0,
          e = d;
        g > e;
        ...
        (f += a[e] + c * b[e - d]), (a[e] = f & C), (f >>= B);
      for (e = g; f && h > e; e++) (f += a[e]), (a[e] = f & C), (f >>= B);
    }
    function w(a, b) {
      s4.length != a.length ? (s4 = m(a)) : n(s4, a),
        s5.length != a.length && (s5 = m(a)),
        g(s4, b, s5, a);
    }
    function x(a, b, c) {
      var d;
      for (
        s0.length != 2 * a.length && (s0 = new Array(2 * a.length)),
          o(s0, 0),
          d = 0;
        d < b.length;
        d++
      ...
      if ((s7.length != d.length && (s7 = m(d)), 0 != (1 & d[0]))) {
        ...
        for (
          h = D - c(i(d, D), D),
            s7[g] = 1,
            x(a, s7, d),
            s3.length != a.length ? (s3 = m(a)) : n(s3, a),
            e = b.length - 1;
          (e > 0) & !b[e];
          e--
        );
        ...
        for (n(s7, a), o(a, 1); !equalsInt(b, 0); )
          1 & b[0] && x(a, s7, d), u(b, 2), squareMod_(s7, d);
    }
    function A(a, b, c, d) {
      var e,
        g,
        ...
        m = b.length;
      for (
        sa.length != l && (sa = new Array(l)), o(sa, 0);
        l > 0 && 0 == c[l - 1];
        l--
      );
      for (; m > 0 && 0 == b[m - 1]; m--);
    ...
    (t = new Array(0)),
      ...
      (this.ToArray = function (a, b) {
        ...
        else for (; !l(s6); ) (d = u(s6, b)), e.push(d);
    ...
    (f = function (a, b) {
      ...
      (this._initialize = function () {
        ...
        (B >>= 1),
          ...
          (this.Expand = a),
          (this.MoreThan = f),
          (this.MoreThanShitf = e),
          (this.FromInt = j),
          (this.InverseModInt = c),
          (this.IsZero = l),
          (this.ModInt = i),
          (this.IsNegative = d),
          (this.PowMod = b),
          ...
          (this.DivideInt_ = u),
          (this.LeftShift_ = r),
          (this.LinCombShift_ = v),
          (this.MontMultiply_ = A),
          (this.MultiplyInt_ = s),
          (this.RightShift_ = q);
      }),
  ...
  (System.Security.Cryptography.CryptographicException = function (a) {
    this.message = a;
    var b = Error.create(this.message, { name: this.GetType().FullName });
    return b.popStackFrame(), b;
  }),
  System.Type.RegisterClass(
  ...
  (System.Security.Cryptography.ICryptoTransform = function (a, b, c) {
    function d(a, b) {
      var c;
      l
        ? ((c = k.Encrypt(
          ...
          System.Buffer.BlockCopy(c, 0, b, 0, m))
        : ((c = k.Decrypt(
            k.Key,
            a,
            System.Security.Cryptography.CipherMode.ECB
    ...
    function e(a, b) {
      ...
      if (l) {
        ...
        for (System.Buffer.BlockCopy(a, 0, o, 0, m), d(a, b), c = 0; m > c; c++)
          b[c] ^= n[c];
    ...
    function f(a, b) {
      ...
      if (l)
        for (c = 0; q > c; c++) {
          ...
          System.Buffer.BlockCopy(n, p, n, 0, m - p),
            System.Buffer.BlockCopy(b, c, n, m - p, p);
        }
      else
        for (c = 0; q > c; c++)
          for (
            l = !0,
              ...
              l = !1,
              System.Buffer.BlockCopy(n, p, n, 0, m - p),
              System.Buffer.BlockCopy(a, c, n, m - p, p),
              e = 0;
            p > e;
            e++
          )
    ...
    function i(a, b, c, d) {
      null == j &&
        (j = new System.Security.Cryptography.RNGCryptoServiceProvider());
      var e = new System.Byte(c);
      d ? j.GetBytes(e) : j.GetNonZeroBytes(e),
        System.Buffer.BlockCopy(e, 0, a, b, c);
    }
    var j,
      k = null,
      l = !1,
    ...
    (this.InputBlockSize = 0),
      ...
      (this.CanTransformMultipleBlocks = !0),
      (this.CanReuseTransform = !1),
      (this._Transform = function (a, b) {
        switch (k.Mode) {
      ...
      (this._Padding = function (a, b, c) {
        ...
        0 == h.length
          ? (System.Buffer.BlockCopy(a, b, q, 0, c),
            (d > 0 || (0 == d && 2 == g)) &&
              System.Buffer.BlockCopy(f, 0, q, c, e))
          : System.Buffer.BlockCopy(h, b, q, 0, c + e);
        var s = {};
      ...
      (this.Initialize = function (a, b) {
        (k = a),
          ...
          k &&
            ((m = k.BlockSize >> 3),
            (this.InputBlockSize = m),
            (this.OutputBlockSize = m),
            (n = new System.Byte(m)),
            System.Buffer.BlockCopy(k.IV, 0, n, 0, Math.min(m, k.IV.length)),
            (o = new System.Byte(m)),
            (p = k.FeedbackSize >> 3),
            0 != p && (q = m / p),
            (workBuff = new System.Byte(m)),
            (workout = new System.Byte(m)));
      }),
  ...
  (System.Security.Cryptography.RSAParameters = function () {
    (this.Exponent = new Array()),
      ...
      (this.Clone = function (a) {
        ...
        return (
          System.Array.Copy(this.Exponent, b.Exponent, this.Exponent.length),
          System.Array.Copy(this.Modulus, b.Modulus, this.Modulus.length),
          a &&
            (this.D && System.Array.Copy(this.D, b.D, this.D.length),
            this.DP && System.Array.Copy(this.DP, b.DP, this.DP.length),
            this.DQ && System.Array.Copy(this.DQ, b.DQ, this.DQ.length),
            this.InverseQ &&
              System.Array.Copy(
                this.InverseQ,
                b.InverseQ,
            ...
            this.P && System.Array.Copy(this.P, b.P, this.P.length),
            this.Q && System.Array.Copy(this.Q, b.Q, this.Q.length)),
          b
        );
      }),
      (this.Initialize = function () {}),
  ...
  (System.Security.Cryptography.RSACryptoServiceProvider = function () {
    ...
    function c(a, b, c) {
      ...
      var d = new System.Security.Cryptography.ICryptoTransform(this, !0),
        e = c
          ? d._Padding(a, 0, a.length).iBuffer
          : d._PaddingRemove(a, 0, a.length);
      return e;
    }
    function d(a, b) {
      ...
      for (
        var d = h.FromBytes(b.Exponent),
          e = h.FromBytes(b.Modulus),
          f = (h.FromBytes(b.D), h.FromBytes(c)),
          g = h.PowMod(f, d, e),
          i = h.ToBytes(g),
          j = this.KeySize / 8,
          k = i.length;
    ...
    function e(a, b, e) {
      for (
        var f, g = this.KeySize / 8 - (e ? 41 : 11), h = new Array(), i = 0;
        i < b.length / g;
        i++
      ) {
    ...
    (this.ImportParameters = function (a) {
      (f = a.Clone(!0)),
        (g = null),
        (this.KeySize = 8 * f.Modulus.length),
      ...
      (this.FromXmlString = function (a) {
        var c = new System.Security.Cryptography.RSAParameters(),
          d = new RegExp('\\s', 'gi');
        (a = a.replace(d, '')),
          (c.Exponent = b(a, 'Exponent')),
          (c.Modulus = b(a, 'Modulus')),
          (c.D = b(a, 'D')),
          (c.DP = b(a, 'DP')),
          (c.DQ = b(a, 'DQ')),
          (c.InverseQ = b(a, 'InverseQ')),
          (c.P = b(a, 'P')),
          (c.Q = b(a, 'Q')),
          this.ImportParameters(c);
      }),
      (this.Encrypt = function (b, c) {
        ...
        if (!c && b.length > g - 11)
          throw (
            ((d =
              'The data to be encrypted exceeds the maximum for this modulus of ' +
              f.digitSize +
              ' bytes. Maximum data size is ' +
              (f.digitSize - 11) +
              ' bytes.'),
            Trace.Write(d),
            new System.Security.Cryptography.CryptographicException(d))
          );
        if (c && b.length > g - 42)
          throw (
            ((d =
...
var TCO = new (function () {
  (this.loadPubKey = function (a, b) {
    ...
    'sandbox' === a
      ? (d.src =
          'https://sandbox.2checkout.com/checkout/api/script/publickey/' + c)
      : (d.src =
          'https://www.2checkout.com/checkout/api/script/publickey/' + c),
      (d.onload = d.onreadystatechange =
        function () {
          (!d.readyState || /loaded|complete/.test(d.readyState)) &&
            ((d.onload = d.onreadystatechange = null),
        ...
        l(n, o, p, k) ||
          ...
          ajax2co({
            ...
            success: function (b, f, g) {
              null !== b.response
                ? ((h.preToken = b.response.preToken), a(d, e, h))
                : null !== b.exception
                ? c(e, b.exception.errorMsg, b.exception.errorCode)
                : c(e);
            },
            error: function (a) {
              c(e);
  ...
  var a = function (a, b, d) {
        ...
        ajax2co({
          ...
          success: function (d, e, f) {
            null !== d.response
              ? a(d, e, f)
              : null !== d.exception
              ? c(b, d.exception.errorMsg, d.exception.errorCode)
              : c(b);
          },
          error: function (a) {
            c(b);
    ...
    b = function (a, b) {
      ...
      return (
        (a.expMonth =
          1 === a.expMonth.toString().length ? '0' + a.expMonth : a.expMonth),
        (a.expYear =
          a.expYear.toString().length < 4 ? '20' + a.expYear : a.expYear),
        (a.cardNum = a.cardNum.replace(/[^0-9]+/g, '')),
        (a.cvv = a.cvv.replace(/[^0-9]+/g, '')),
        d(a.cardNum) && d(a.cvv) && d(a.expMonth) && d(a.expYear)
          ? 'undefined' == typeof publicKey &&
            ((e = !1), c(b, 'Missing publicKey.js', 401))
          : ((e = !1), c(b, 'Missing Card Data', 401)),
        e
      );
    },
    c = function (a, b, c) {
      'undefined' == typeof b &&
        'undefined' == typeof c &&
        ((b = 'Unable to process the request'), (c = 200)),
        (data = { errorCode: c, errorMsg: b }),
        a(data);
    },
    d = function (a) {
    ...
    h = function (a) {
      var b = '2048',
        ...
        d = new System.Security.Cryptography.RSACryptoServiceProvider(
          parseInt(b, 10)
        );
      d.FromXmlString(c);
    ...
    j = function () {
      if (!document.getElementById('2co_user_prefs')) {
        ...
        b.setAttribute('type', 'hidden'),
          b.setAttribute('id', '2co_user_prefs'),
          a.appendChild(b);
      }
    },
    k = function () {
    ...
    m = function () {
      (this.tcoUrl = tokenRequestUrl),
        ...
        (this.cvv = ''),
        (this.preToken = ''),
        (this.generatePaymentDetail = function () {
          var a =
          ...
          if ('object' == typeof a)
            ...
            a.cvv
              ? ((this.sellerId = a.sellerId),
                (this.publishableKey = a.publishableKey),
                (this.cardNum = a.ccNo),
                (this.expMonth = a.expMonth),
                (this.expYear = a.expYear),
                (this.cvv = a.cvv))
              : c(b, 'Missing Form Fields', 401);
          else {
            ...
            d.expYear &&
            d.cvv
              ? ((this.sellerId = d.sellerId.value),
                (this.publishableKey = d.publishableKey.value),
                (this.cardNum = d.ccNo.value),
                (this.expMonth = d.expMonth.value),
                (this.expYear = d.expYear.value),
                (this.cvv = d.cvv.value))
              : c(b, 'Missing Form Fields', 401);
          }
        });
    },

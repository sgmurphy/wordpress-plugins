...
The [Timely All-in-One Events Calendar](https://time.ly/solutions/all-in-one-event-calendar-wordpress-plugin/) is a FREE events calendar plugin, trusted by 150,000+ event creators around the globe, including UPS, AT&T, Harvard University, Commscope, Avon, Stanford University, Adobe, and the University of Bristol. 
...
Our plugin is known in the WP community for its **great UI/UX** and **attractive visuals**, and considered by experts as **one of the most advanced WP calendar plugins**.
...
The [All-in-One Event Calendar](https://time.ly/solutions/all-in-one-event-calendar-wordpress-plugin/) is a service provided by [Time.ly](https://time.ly/). After installing the plugin, you will need to create and activate a Timely account in order to use it.

= ❤️ The Events Calendar Most Loved by Event Creators Around the World =
Timely’s [All-in-One Event Calendar](https://time.ly/solutions/all-in-one-event-calendar-wordpress-plugin/) is made for freelancers and bootstrapped entrepreneurs, who are looking for a free but powerful event calendar to start or power up their event-related business.

If you are an event planner or event manager, and work for a small, medium or large organization that needs more sophisticated event management tools, **check out our [Event Calendar Software](https://time.ly/solutions/event-calendar-software/) and our [enterprise level features](https://time.ly/event-management-software-features/)**.
...
* Several out of the box calendar themes to choose from.
...
* Create **in-person, virtual and hybrid events**.
* **Single day, multiple days, all day, never end events, and recurring events**, including complex patterns.
* **Duplicate events** with ease.
...
* **Search box** to search for events by keyword, as well as by date, month and year.
* **Filtering** events by categories, tags, organizers and venues.
* **Colour-coded** events based on category.
* **Media library** to facilitate media upload.
* Featured event images and category images.
* Allow or disallow your audience to subscribe to your calendar.
* Easy importing events using CSV or ICS files. 
...
What are you waiting for? Download [Timely All-in-One Event Calendar Plugin](https://time.ly/solutions/all-in-one-event-calendar-wordpress-plugin/) now and sign up for a free account!

= 🔌 Add-ons =

Upgrade your free Timely events calendar for WordPress and get the following additional features:

* [**RSVP / Ticketing**](https://time.ly/solutions/all-in-one-event-calendar-wordpress-plugin/): easily manage RSVPs and sell event tickets directly from your event calendar.

If you are looking for more advanced features, like more calendar view options, more importing events functionalities, integrated event submission form, and social media integrations, check our [feature list](https://time.ly/event-management-software-features) and consider upgrading to one of our [premium paid plans](https://time.ly/pricing/).
...
Timely's events calendar public interface has been translated into the following languages(in alphabetical order): Arabic | Chinese | Danish | Dutch | English | French | German | Italian | Japanese | Korean | Polish | Portuguese | Spanish | Turkish | Swedish. Other languages are available upon request.
...
* Timely [Demo Events Calendar](https://time.ly/demo/)
* Timely Official [Homepage](https://time.ly/)
* Timely [Help Center](https://help.time.ly/event-management/all-in-one-event-calendar-wp-plugin-v-3-up/)
...
* Timely [Software Comparisons](https://time.ly/blog/category/software-comparison/)
...
**Please note that we DO NOT provide live support to free users**. Free WordPress calendar plugin users are only supported with self service user documentation and basic video tutorials that can be found on our [Help Center](https://help.time.ly/). You can also check the [All-in-One Event Calendar forum here on WordPress.org](https://wordpress.org/support/plugin/all-in-one-event-calendar/), which is the place where community members help one another.  

If you need official customer support from us, consider upgrading to a [premium paid plan](https://time.ly/pricing/).

Please note that **we no longer support Timely’s WP events calendar version 3.0.0 (old platform), 2.6.8 or older (deprecated / superseded)**. If you are having issues with these versions, we recommend migrating to the new platform by downloading and installing the plugin again. Do not forget to create a back up of your WP installation database before doing that.

Still have questions about our event management software solutions? Please [contact us](https://time.ly/contact/).

= ⚖️ Legal =

By creating or activating an account and/or embedding the code into a website, you agree to Timely's [Terms of Service](https://time.ly/terms-of-service/) and policies. Please note that to provide you with our services, we sometimes send you service announcements and other information. 

To learn more about what personal data we collect from you and how we use it, please check our [Privacy Policy](https://time.ly/privacy-policy/).

== Frequently Asked Questions ==

= Where can I get support for my Timely All-in-One Event Calendar WordPress plugin? =
WordPress clients can access the plugin written documentation on our [Help Center](https://help.time.ly/event-management/all-in-one-event-calendar-wp-plugin-v-3-up/). 
...
If you need official and timely support from us, consider upgrading to a premium paid plan. As a paying client, you will have access to our advanced training videos, and get live support via support ticket and email. Please [contact us](https://time.ly/contact/) to learn more.

Please note that we no longer support Timely’s WP events calendar version 3.0.0 (old platform), 2.6.8 or older (deprecated / superseded). If you are having issues with these versions, we recommend migrating to the new platform by downloading and installing the plugin again. Do not forget to create a back up of your WP installation database before doing that.

= Can I export events from my Timely calendar? =
Yes! With [Timely All-in-One Event Calendar](https://time.ly/solutions/all-in-one-event-calendar-wordpress-plugin/), you can easily export events from your events calendar by downloading an XML or ICS file directly from the public view of your calendar.

= Can I import events to my Timely calendar?=
Yes! [Timely All-in-One Event Calendar](https://time.ly/solutions/all-in-one-event-calendar-wordpress-plugin/) has a built-in tool to import events with ease. In the menu **Import Events** in your Timely dashboard, you can upload a CSV or an ICS file to import events to your calendar. More advanced features to import events are available on paid plans only. Please [contact us](https://time.ly/contact/) to learn more.
...
* [**RSVP / Ticketing**](https://time.ly/solutions/all-in-one-event-calendar-wordpress-plugin/): for managing RSVPs and selling tickets for events.
...
For small, medium and larger organizations that need more advanced tools, Timely offers a myriad of event management software solutions. Our premium solutions include [Event Calendar Software](https://time.ly/solutions/event-calendar-software/), [Event Registration Software] (https://time.ly/solutions/event-registration-software/), [Event Ticketing Software](https://time.ly/solutions/event-ticketing-software/), [Event Booking Software](https://time.ly/solutions/event-booking-software/), [Online Training Software](https://time.ly/solutions/online-training-software/) and [Room Scheduling Software](https://time.ly/solutions/room-scheduling-software/). We also offer [Professional Services] (https://time.ly/professional-managed-event-services-solutions/) for clients who need an extra help to implement and use Timely event software solutions.
...
3. Week view
4. Agenda view
5. Extended views add-on: Stream view
6. Extended Views Add-on: Tile view
7. Extended Views Add-on: Posterboard view
8. Single event details with RSVP/Ticket Add-on
9. Event calendar dashboard
10. General settings
11. Design settings
12. Embed code settings
13. Events admin creation
14. Filters: categories, tags, venues and organizers
15. Import Events: calendar feed, upload and event finder
16. RSVP/Ticket Add-On: Reports for Tickets & Invoices

...
if ( ! function_exists( 'cleverfox_boostify_lite_service' ) ) :
	...
	$service_title			= get_theme_mod('service_title',__('Outstanding <span class="av-heading animate-7"><span class="av-text-wrapper"><b class="is-show">Services</b>                                   <b>Services</b><b>Services</b></span></span>','clever-fox'));

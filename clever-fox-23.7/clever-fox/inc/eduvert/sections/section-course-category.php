...
$course_category_title 		= get_theme_mod('course_category_title',__('course categories','clever-fox'));
$course_category_description= get_theme_mod('course_category_description',__('popular topics to learn','clever-fox')); 
...
$course_category_btn_lbl 	= get_theme_mod('course_category_btn_lbl',__('All Categories','clever-fox'));

<?php 
if ( ! function_exists( 'cleverfox_avenza_lite_funfact' ) ) :
	function cleverfox_avenza_lite_funfact() {
	...
	$funfact_bg_setting			= get_theme_mod('funfact_bg_setting',CLEVERFOX_PLUGIN_URL .'inc/avenza/images/fun-fact-bg.jpg');
...
<?php
	...
	if ( function_exists( 'cleverfox_avenza_lite_funfact' ) ) {
		...
		add_action( 'avril_sections', 'cleverfox_avenza_lite_funfact', absint( $section_priority ) );
	}		
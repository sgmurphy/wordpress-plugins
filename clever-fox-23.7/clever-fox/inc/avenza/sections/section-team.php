<?php 
if ( ! function_exists( 'cleverfox_avenza_lite_team' ) ) :
	function cleverfox_avenza_lite_team() {
...
<?php
	...
	if ( function_exists( 'cleverfox_avenza_lite_team' ) ) {
		...
		add_action( 'avril_sections', 'cleverfox_avenza_lite_team', absint( $section_priority ) );
	}	
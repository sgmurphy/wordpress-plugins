...
class SlackRecord
{
     ...
     */
    public function __construct(?string $channel = null, ?string $username = null, bool $useAttachment = \true, ?string $userIcon = null, bool $useShortAttachment = \false, bool $includeContextAndExtra = \false, array $excludeFields = array(), ?\FcfVendor\Monolog\Formatter\FormatterInterface $formatter = null)
    {
    ...
    public function stringify(array $fields) : string
    {
        ...
        return $hasSecondDimension || $hasNonNumericKeys ? \FcfVendor\Monolog\Utils::jsonEncode($normalized, \JSON_PRETTY_PRINT | \FcfVendor\Monolog\Utils::DEFAULT_JSON_FLAGS) : \FcfVendor\Monolog\Utils::jsonEncode($normalized, \FcfVendor\Monolog\Utils::DEFAULT_JSON_FLAGS);
    }
    /**
    ...
    public function setFormatter(?\FcfVendor\Monolog\Formatter\FormatterInterface $formatter = null) : self
    {

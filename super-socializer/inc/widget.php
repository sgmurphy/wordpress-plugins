...
class TheChampFollowWidget extends WP_Widget { 
	...
	private function follow_icons($instance){
		...
		$bottomSharingAlignment = ! isset($instance['bottom_sharing_alignment']) || $instance['bottom_sharing_alignment'] == 'left' ? 'left' : 'right';
		$bottomSharingAlignmentInverse = $bottomSharingAlignment == 'left' ? 'right' : 'left';
		...
		if(isset($instance['type']) && $instance['type'] == 'floating' && isset($instance['bottom_sharing_position_radio']) && $instance['bottom_sharing_position_radio'] == 'responsive'){
			$bottomSharingResponsiveCss = 'div.heateor_ss_bottom_follow{width:100%!important;left:0!important;}div.heateor_ss_bottom_follow a{margin:0!important;width:' . (100/($numFollowIcons)) . '%!important;}div.heateor_ss_bottom_follow .the_champ_svg{width:100%!important}';
		}
		if(isset($instance['type']) && $instance['type'] == 'floating' && isset($instance['bottom_mobile_sharing']) && $instance['horizontal_screen_width'] != '' && isset($instance['bottom_sharing_position_radio']) && $instance['bottom_sharing_position_radio'] == 'responsive'){
			$bottomSharingPosition = isset($instance['bottom_sharing_position']) ? $instance['bottom_sharing_position'] : '0';
			$html .= '<style>div.the_champ_mobile_footer{display:none;}@media screen and (max-width:' . (isset($instance['horizontal_screen_width']) ? intval($instance['horizontal_screen_width']) : 786) . 'px){' . $bottomSharingResponsiveCss . 'div.the_champ_mobile_footer{display:block;height:' . intval($instance['size']) . 'px;}.heateor_ss_bottom_follow{padding:0!important;' . (isset($instance['bottom_sharing_position_radio']) && $instance['bottom_sharing_position_radio'] == 'nonresponsive' ? $bottomSharingAlignment . ':' . $bottomSharingPosition . 'px!important;' . $bottomSharingAlignmentInverse . ':auto!important;' : '') . 'display:block!important;width:auto!important;bottom:0px!important;top:auto!important;}}</style>';
		}
	...
	public function form($instance){ 
		...
		<p>
			...
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('flickr')); ?>" name="<?php echo esc_attr($this->get_field_name('flickr')); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['flickr'])); ?>" /><br/>
			...
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('foursquare')); ?>" name="<?php echo esc_attr($this->get_field_name('foursquare')); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['foursquare'])); ?>" /><br/>
			<span>https://foursquare.com/ID</span><br/><br/>
			<label for="<?php echo esc_attr($this->get_field_id('gab')); ?>"><?php _e('Gab URL:', 'super-socializer'); ?></label> 
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('gab')); ?>" name="<?php echo esc_attr($this->get_field_name('gab')); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['gab'])); ?>" /><br/>
			<span>https://gab.com/ID</span><br/><br/>
			<label for="<?php echo esc_attr($this->get_field_id('gettr')); ?>"><?php _e('Gettr URL:', 'super-socializer'); ?></label> 
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('gettr')); ?>" name="<?php echo esc_attr($this->get_field_name('gettr')); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['gettr'])); ?>" /><br/>
			...
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('github')); ?>" name="<?php echo esc_attr($this->get_field_name('github')); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['github'])); ?>" /><br/>
			...
			<input style="width: 95%" class="widefat" id="<?php echo $this->get_field_id('google_maps'); ?>" name="<?php echo $this->get_field_name('google_maps'); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['google_maps'])); ?>" /><br/><br/>
			<label for="<?php echo esc_attr($this->get_field_id('google_news')); ?>"><?php _e('Google News URL:', 'super-socializer'); ?></label> 
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('google_news')); ?>" name="<?php echo esc_attr($this->get_field_name('google_news')); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['google_news'])); ?>" /><br/><br/>
			<label for="<?php echo esc_attr($this->get_field_id('instagram')); ?>"><?php _e('Instagram URL:', 'super-socializer'); ?></label> 
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('instagram')); ?>" name="<?php echo esc_attr($this->get_field_name('instagram')); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['instagram'])); ?>" /><br/>
			<span>https://www.instagram.com/ID</span><br/><br/>
			<label for="<?php echo $this->get_field_id('line'); ?>"><?php _e('Line URL:', 'super-socializer'); ?></label> 
			...
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('linkedin')); ?>" name="<?php echo esc_attr($this->get_field_name('linkedin')); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['linkedin'])); ?>" /><br/>
			...
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('linkedin_company')); ?>" name="<?php echo esc_attr($this->get_field_name('linkedin_company')); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['linkedin_company'])); ?>" /><br/>
			<span>https://www.linkedin.com/company/ID</span><br/><br/>
			<label for="<?php echo $this->get_field_id('mastodon'); ?>"><?php _e('Mastodon URL:', 'super-socializer'); ?></label> 
			...
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('medium')); ?>" name="<?php echo esc_attr($this->get_field_name('medium')); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['medium'])); ?>" /><br/>
			...
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('parler')); ?>" name="<?php echo esc_attr($this->get_field_name('parler')); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['parler'])); ?>" /><br/>
			...
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('pinterest')); ?>" name="<?php echo esc_attr($this->get_field_name('pinterest')); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['pinterest'])); ?>" /><br/>
			...
			<input style="width: 95%" class="widefat" id="<?php echo $this->get_field_id('threads'); ?>" name="<?php echo $this->get_field_name('threads'); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['threads'])); ?>" /><br/>
			...
			<input style="width: 95%" class="widefat" id="<?php echo $this->get_field_id('tiktok'); ?>" name="<?php echo $this->get_field_name('tiktok'); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['tiktok'])); ?>" /><br/>
			...
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('tumblr')); ?>" name="<?php echo esc_attr($this->get_field_name('tumblr')); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['tumblr'])); ?>" /><br/>
			...
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('twitter')); ?>" name="<?php echo esc_attr($this->get_field_name('twitter')); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['twitter'])); ?>" /><br/>
			...
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('vimeo')); ?>" name="<?php echo esc_attr($this->get_field_name('vimeo')); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['vimeo'])); ?>" /><br/>
			...
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('vkontakte')); ?>" name="<?php echo esc_attr($this->get_field_name('vkontakte')); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['vkontakte'])); ?>" /><br/>
			...
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('whatsapp')); ?>" name="<?php echo esc_attr($this->get_field_name('whatsapp')); ?>" type="text" value="<?php esc_attr(wp_strip_all_tags($instance['whatsapp'])); ?>" /><br/>
			<span>https://wa.me/PHONE_NUMBER</span><br/><br/>
			<label for="<?php echo $this->get_field_id('x'); ?>"><?php _e('X URL:', 'super-socializer'); ?></label> 
			<input style="width: 95%" class="widefat" id="<?php echo $this->get_field_id('x'); ?>" name="<?php echo $this->get_field_name('x'); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['x'])); ?>" /><br/>
			<span>https://x.com/ID</span><br/><br/>
			<label for="<?php echo esc_attr($this->get_field_id('xing')); ?>"><?php _e('Xing URL:', 'super-socializer'); ?></label> 
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('xing')); ?>" name="<?php echo esc_attr($this->get_field_name('xing')); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['xing'])); ?>" /><br/>
			...
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('youtube')); ?>" name="<?php echo esc_attr($this->get_field_name('youtube')); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['youtube'])); ?>" /><br/>
			...
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('youtube_channel')); ?>" name="<?php echo esc_attr($this->get_field_name('youtube_channel')); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['youtube_channel'])); ?>" /><br/>
			...
			<input style="width: 95%" class="widefat" id="<?php echo esc_attr($this->get_field_id('yelp')); ?>" name="<?php echo esc_attr($this->get_field_name('yelp')); ?>" type="text" value="<?php echo esc_attr(wp_strip_all_tags($instance['yelp'])); ?>" /><br/>
